...
public final class HashSetSerializer<E> extends CollectionSerializer<E, Set<? extends E>, HashSet<E>> {
    ...
    public void insert(HashSet<E> hashSet, int i10, E e2) {
        Intrinsics.checkNotNullParameter(hashSet, "<this>");
        hashSet.add(e2);
    }
