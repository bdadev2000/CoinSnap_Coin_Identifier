    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof InlineClassDescriptor) {
            ...
            if (Intrinsics.areEqual(getSerialName(), serialDescriptor.getSerialName())) {
                ...
                if (inlineClassDescriptor.getIsInline() && Arrays.equals(getTypeParameterDescriptors$kotlinx_serialization_core(), inlineClassDescriptor.getTypeParameterDescriptors$kotlinx_serialization_core())) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z10 && getElementsCount() == serialDescriptor.getElementsCount()) {
