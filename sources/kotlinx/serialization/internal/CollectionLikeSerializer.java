    ...
    public final void readAll(CompositeDecoder decoder, Builder builder, int startIndex, int size) {
        ...
        if (z10) {
            for (int i10 = 0; i10 < size; i10++) {
                readElement(decoder, startIndex + i10, builder, false);
            }
            return;
        }
