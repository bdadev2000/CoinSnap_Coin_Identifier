...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    public void serialize(Encoder encoder, Collection value) {
        ...
        while (collectionIterator.hasNext()) {
            ...
            beginCollection.encodeSerializableElement(getDescriptor(), i11, getValueSerializer(), value2);
            i10 = i11 + 1;
        }
    ...
    public final void readAll(CompositeDecoder decoder, Builder builder, int startIndex, int size) {
        ...
        if (size >= 0) {
            step = RangesKt___RangesKt.step(RangesKt.until(0, size * 2), 2);
    ...
    public final void readElement(CompositeDecoder decoder, int index, Builder builder, boolean checkIndex) {
        ...
        if (checkIndex) {
            ...
            if (!(i10 == index + 1)) {
                throw new IllegalArgumentException(j.e("Value must follow key in a map, index for key: ", index, ", returned index for value: ", i10).toString());
            }
        } else {
            i10 = index + 1;
        }
        ...
        if (builder.containsKey(decodeSerializableElement$default2) && !(this.valueSerializer.getDescriptor().getKind() instanceof PrimitiveKind)) {
            decodeSerializableElement$default = decoder.decodeSerializableElement(getDescriptor(), i11, this.valueSerializer, MapsKt.getValue(builder, decodeSerializableElement$default2));
        } else {
            decodeSerializableElement$default = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), i11, this.valueSerializer, null, 8, null);
        }
