...
public final class Platform_commonKt {
    ...
    public static final <T, K> int elementsHashCodeBy(Iterable<? extends T> iterable, Function1<? super T, ? extends K> function1) {
        ...
        while (q10.hasNext()) {
            int i12 = i11 * 31;
            K invoke = function1.invoke((Object) q10.next());
            if (invoke != null) {
                i10 = invoke.hashCode();
            } else {
                i10 = 0;
