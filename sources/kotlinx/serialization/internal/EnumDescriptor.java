...
public final class EnumDescriptor extends PluginGeneratedSerialDescriptor {
        ...
        this.elementDescriptors = LazyKt.lazy(new Function0<SerialDescriptor[]>() { // from class: kotlinx.serialization.internal.EnumDescriptor$elementDescriptors$2
            ...
            public final SerialDescriptor[] invoke() {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    serialDescriptorArr[i12] = SerialDescriptorsKt.buildSerialDescriptor$default(name + '.' + this.getElementName(i12), StructureKind.OBJECT.INSTANCE, new SerialDescriptor[0], null, 8, null);
                }
    ...
    public String toString() {
        ...
        joinToString$default = CollectionsKt___CollectionsKt.joinToString$default(SerialDescriptorKt.getElementNames(this), ", ", getSerialName() + '(', ")", 0, null, null, 56, null);
