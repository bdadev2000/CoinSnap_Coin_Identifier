                ...
                if (decodeElementIndex != -1) {
                    if (decodeElementIndex != 0) {
                        ...
                        if (t10 != 0) {
                            ...
                            t5 = (T) CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), decodeElementIndex, PolymorphicSerializerKt.findPolymorphicSerializer(this, beginStructure, (String) t10), null, 8, null);
                        } else {
