...
public final class CachingKt {
    ...
    static {
        ...
        try {
            ...
            m145constructorimpl = Result.m145constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th2) {
        ...
        if (Result.m152isSuccessimpl(m145constructorimpl)) {
            m145constructorimpl = Boolean.TRUE;
        }
        Object m145constructorimpl2 = Result.m145constructorimpl(m145constructorimpl);
        Boolean bool = Boolean.FALSE;
        if (Result.m151isFailureimpl(m145constructorimpl2)) {
            m145constructorimpl2 = bool;
        }
        useClassValue = ((Boolean) m145constructorimpl2).booleanValue();
    }
