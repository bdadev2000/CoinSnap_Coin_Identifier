...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m1730computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m145constructorimpl = Result.m145constructorimpl(producer.invoke());
            } catch (Throwable th2) {
            ...
            Object putIfAbsent = concurrentHashMap.putIfAbsent(types, m144boximpl);
            if (putIfAbsent == null) {
                obj = m144boximpl;
            } else {
                obj = putIfAbsent;
