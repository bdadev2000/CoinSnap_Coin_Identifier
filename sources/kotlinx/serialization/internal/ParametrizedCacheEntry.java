...
public final class ParametrizedCacheEntry<T> {
    ...
    public final Object m9863computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m8274constructorimpl = Result.m8274constructorimpl(producer.invoke());
            } catch (Throwable th) {
            ...
            Object putIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, m8273boximpl);
