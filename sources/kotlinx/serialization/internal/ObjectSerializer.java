...
public final class ObjectSerializer<T> implements KSerializer<T> {
    ...
    public T deserialize(Decoder decoder) {
        ...
        throw new SerializationException(j.i("Unexpected index ", decodeElementIndex));
    }
