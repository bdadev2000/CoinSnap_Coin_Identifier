...
public interface Decoder {
    ...
    @ExperimentalSerializationApi
    <T> T decodeNullableSerializableValue(DeserializationStrategy<T> deserializer);

    <T> T decodeSerializableValue(DeserializationStrategy<T> deserializer);
