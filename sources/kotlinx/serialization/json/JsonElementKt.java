...
public final class JsonElementKt {
    ...
    public static final Void unexpectedJson(String key, String expected) {
        ...
        throw new IllegalArgumentException(j.l("Element ", key, " is not a ", expected));
    }
