...
public final class JsonDecoderForUnsignedTypes extends AbstractDecoder {
    ...
    public byte decodeByte() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, a.l("Failed to parse type 'UByte' for input '", consumeStringLenient, '\''), 0, null, 6, null);
    ...
    public int decodeInt() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, a.l("Failed to parse type 'UInt' for input '", consumeStringLenient, '\''), 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public long decodeLong() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, a.l("Failed to parse type 'ULong' for input '", consumeStringLenient, '\''), 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public short decodeShort() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, a.l("Failed to parse type 'UShort' for input '", consumeStringLenient, '\''), 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
