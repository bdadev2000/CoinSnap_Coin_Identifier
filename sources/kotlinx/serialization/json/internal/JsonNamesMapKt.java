...
public final class JsonNamesMapKt {
    ...
    private static final void buildAlternativeNamesMap$putOrThrow(Map<String, Integer> map, SerialDescriptor serialDescriptor, String str, int i10) {
        ...
        StringBuilder o10 = j.o("The suggested name '", str, "' for property ");
        o10.append(serialDescriptor.getElementName(i10));
        o10.append(" is already one of the names for property ");
        o10.append(serialDescriptor.getElementName(((Number) MapsKt.getValue(map, str)).intValue()));
        o10.append(" in ");
    ...
    public static /* synthetic */ boolean tryCoerceValue$default(Json json, SerialDescriptor elementDescriptor, Function0 peekNull, Function0 peekString, Function0 onEnumCoercing, int i10, Object obj) {
        String str;
        if ((i10 & 8) != 0) {
