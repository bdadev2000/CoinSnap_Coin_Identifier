...
public final class ChannelSegment<E> extends Segment<ChannelSegment<E>> {
    ...
    public ChannelSegment(long j3, ChannelSegment<E> channelSegment, BufferedChannel<E> bufferedChannel, int i10) {
        super(j3, channelSegment, i10);
    ...
    public final boolean casState$kotlinx_coroutines_core(int index, Object from, Object to) {
        ...
        int i10 = (index * 2) + 1;
        while (!atomicReferenceArray.compareAndSet(i10, from, to)) {
            if (atomicReferenceArray.get(i10) != from) {
                return false;
            }
        }
        return true;
