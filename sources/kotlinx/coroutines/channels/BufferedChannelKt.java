...
public final class BufferedChannelKt {
    ...
    public static final long constructEBCompletedAndPauseFlag(long j3, boolean z10) {
        return (z10 ? EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT : 0L) + j3;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long constructSendersAndCloseStatus(long j3, int i10) {
        return (i10 << 60) + j3;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final <E> ChannelSegment<E> createSegment(long j3, ChannelSegment<E> channelSegment) {
    ...
    private static final long getEbCompletedCounter(long j3) {
        return j3 & 4611686018427387903L;
    }

    private static final boolean getEbPauseExpandBuffers(long j3) {
        return (j3 & EB_COMPLETED_PAUSE_EXPAND_BUFFERS_BIT) != 0;
    }

    private static final int getSendersCloseStatus(long j3) {
        return (int) (j3 >> 60);
    }

    private static final long getSendersCounter(long j3) {
        return j3 & SENDERS_COUNTER_MASK;
    }
