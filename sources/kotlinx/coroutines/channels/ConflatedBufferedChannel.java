...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m9819trySendImplMj0NB7M = conflatedBufferedChannel.m9819trySendImplMj0NB7M(e, true);
        if (m9819trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m9805exceptionOrNullimpl(m9819trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m9819trySendImplMj0NB7M = conflatedBufferedChannel.m9819trySendImplMj0NB7M(e, true);
        if (!(m9819trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo9791trySendJP2dKIU(E element) {
        return m9819trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m9819trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m9817trySendDropLatestMj0NB7M(element, isSendOp) : m9818trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m9817trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo9791trySendJP2dKIU = super.mo9791trySendJP2dKIU(element);
        if (ChannelResult.m9811isSuccessimpl(mo9791trySendJP2dKIU) || ChannelResult.m9809isClosedimpl(mo9791trySendJP2dKIU)) {
            return mo9791trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m9816successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m9818trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m9814closedJP2dKIU(getSendException());
                }
            } else {
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo9791trySendJP2dKIU = mo9791trySendJP2dKIU(element);
        if (!(mo9791trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo9791trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m9805exceptionOrNullimpl(mo9791trySendJP2dKIU);
