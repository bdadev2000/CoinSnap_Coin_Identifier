...
public interface SendChannel<E> {
    ...
    Object mo9791trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo9791trySendJP2dKIU = sendChannel.mo9791trySendJP2dKIU(e);
            if (ChannelResult.m9811isSuccessimpl(mo9791trySendJP2dKIU)) {
                return true;
            }
            Throwable m9805exceptionOrNullimpl = ChannelResult.m9805exceptionOrNullimpl(mo9791trySendJP2dKIU);
