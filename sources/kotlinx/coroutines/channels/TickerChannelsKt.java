...
public final class TickerChannelsKt {
    ...
    */
    ...
    public static final ReceiveChannel<Unit> ticker(long j3, long j10, CoroutineContext coroutineContext, TickerMode tickerMode) {
        boolean z10;
        boolean z11 = true;
        if (j3 >= 0) {
            z10 = true;
        ...
        if (z10) {
            ...
            if (z11) {
                return ProduceKt.produce(GlobalScope.INSTANCE, Dispatchers.getUnconfined().plus(coroutineContext), 0, new TickerChannelsKt$ticker$3(tickerMode, j3, j10, null));
            }
    ...
    public static /* synthetic */ ReceiveChannel ticker$default(long j3, long j10, CoroutineContext coroutineContext, TickerMode tickerMode, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            j10 = j3;
        }
        if ((i10 & 4) != 0) {
        ...
        return ticker(j3, j10, coroutineContext, tickerMode);
    }
}
