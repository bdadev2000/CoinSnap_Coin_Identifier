...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public BroadcastChannelImpl(int i10) {
        ...
        throw new IllegalArgumentException(a.i("BroadcastChannel capacity must be positive or Channel.CONFLATED, but ", i10, " was specified").toString());
    }
    ...
    public final void removeSubscriber(ReceiveChannel<? extends E> s5) {
        boolean z10;
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            symbol = BroadcastChannelKt.NO_ELEMENT;
            if (obj2 != symbol) {
                ((BufferedChannel) subscriberBuffered).mo1659trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo1659trySendJP2dKIU(E element) {
        ...
        try {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo1659trySendJP2dKIU(element);
            }
