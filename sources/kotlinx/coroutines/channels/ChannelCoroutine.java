...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo9795receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo9795receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo9796tryReceivePtdJZtk() {
        return this._channel.mo9796tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo9791trySendJP2dKIU(E element) {
        return this._channel.mo9791trySendJP2dKIU(element);
    }
