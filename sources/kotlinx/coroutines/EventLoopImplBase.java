...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public final class DelayedResumeTask extends DelayedTask {
        ...
        public DelayedResumeTask(long j3, CancellableContinuation<? super Unit> cancellableContinuation) {
            super(j3);
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (obj == null) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = _queue$FU;
                while (true) {
                    if (atomicReferenceFieldUpdater2.compareAndSet(this, null, task)) {
                        z10 = true;
                        break;
                    }
    ...
    public long getNextTime() {
        ...
        return RangesKt.coerceAtLeast(j3 - nanoTime, 0L);
    }
