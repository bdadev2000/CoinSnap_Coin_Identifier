...
public final class StackTraceRecoveryKt {
    private static final StackTraceElement ARTIFICIAL_FRAME = k.c(c.class.getSimpleName(), new Exception());
    ...
    static {
        ...
        try {
            ...
            m145constructorimpl = Result.m145constructorimpl(BaseContinuationImpl.class.getCanonicalName());
        } catch (Throwable th2) {
        ...
        if (Result.m148exceptionOrNullimpl(m145constructorimpl) != null) {
            m145constructorimpl = baseContinuationImplClass;
        }
        baseContinuationImplClassName = (String) m145constructorimpl;
        try {
            m145constructorimpl2 = Result.m145constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th3) {
            Result.Companion companion3 = Result.INSTANCE;
            m145constructorimpl2 = Result.m145constructorimpl(ResultKt.createFailure(th3));
        }
        if (Result.m148exceptionOrNullimpl(m145constructorimpl2) != null) {
            m145constructorimpl2 = stackTraceRecoveryClass;
        }
        stackTraceRecoveryClassName = (String) m145constructorimpl2;
    }
    ...
    private static final <E extends Throwable> E sanitizeStackTrace(E e2) {
        ...
        if (firstFrameIndex == -1) {
            ...
            i10 = length - firstFrameIndex;
        }
        int i13 = (length - length2) - i10;
    ...
    public static final <E extends Throwable> E unwrapImpl(E e2) {
        E e10 = (E) e2.getCause();
        if (e10 != null && Intrinsics.areEqual(e10.getClass(), e2.getClass())) {
            StackTraceElement[] stackTrace = e2.getStackTrace();
            int length = stackTrace.length;
            boolean z10 = false;
            int i10 = 0;
