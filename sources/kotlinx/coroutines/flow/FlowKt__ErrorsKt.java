...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    */
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j3, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        throw new IllegalArgumentException(a.k("Expected positive amount of retries, but had ", j3).toString());
    }

    public static /* synthetic */ Flow retry$default(Flow flow, long j3, Function2 function2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j3 = Long.MAX_VALUE;
        }
        if ((i10 & 2) != 0) {
        ...
        return FlowKt.retry(flow, j3, function2);
    }
