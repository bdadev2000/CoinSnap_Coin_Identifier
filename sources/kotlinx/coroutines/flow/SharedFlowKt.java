...
public final class SharedFlowKt {
    ...
    public static final <T> MutableSharedFlow<T> MutableSharedFlow(int i10, int i11, BufferOverflow bufferOverflow) {
        ...
        if (z10) {
            ...
            throw new IllegalArgumentException(j.i("extraBufferCapacity cannot be negative, but was ", i11).toString());
        }
        throw new IllegalArgumentException(j.i("replay cannot be negative, but was ", i10).toString());
    }
    ...
    public static final <T> Flow<T> fuseSharedFlow(SharedFlow<? extends T> sharedFlow, CoroutineContext coroutineContext, int i10, BufferOverflow bufferOverflow) {
        if ((i10 == 0 || i10 == -3) && bufferOverflow == BufferOverflow.SUSPEND) {
            return sharedFlow;
        }
        return new ChannelFlowOperatorImpl(sharedFlow, coroutineContext, i10, bufferOverflow);
    }
