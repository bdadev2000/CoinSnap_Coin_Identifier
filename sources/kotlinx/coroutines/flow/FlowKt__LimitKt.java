...
public final /* synthetic */ class FlowKt__LimitKt {
    ...
    */
    ...
    public static final <T> Flow<T> drop(final Flow<? extends T> flow, final int i10) {
        ...
        if (z10) {
            return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$$inlined$unsafeFlow$1
                ...
                public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
                    Object collect = Flow.this.collect(new FlowKt__LimitKt$drop$2$1(new Ref.IntRef(), i10, flowCollector), continuation);
        ...
        throw new IllegalArgumentException(j.i("Drop count should be non-negative, but had ", i10).toString());
    }
    ...
    */
    ...
    public static final <T> Flow<T> take(Flow<? extends T> flow, int i10) {
        ...
        throw new IllegalArgumentException(a.i("Requested element count ", i10, " should be positive").toString());
    }
