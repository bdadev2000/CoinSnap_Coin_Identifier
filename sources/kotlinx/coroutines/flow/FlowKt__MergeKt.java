...
public final /* synthetic */ class FlowKt__MergeKt {
    ...
    public static final <T, R> Flow<R> flatMapConcat(final Flow<? extends T> flow, final Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt.flattenConcat(new Flow<Flow<? extends R>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapConcat$$inlined$map$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapConcat$$inlined$map$1$2", f = "Merge.kt", i = {}, l = {g.STALE_CACHED_RESPONSE_VALUE, g.STALE_CACHED_RESPONSE_VALUE}, m = "emit", n = {}, s = {})
    ...
    @ExperimentalCoroutinesApi
    public static final <T, R> Flow<R> flatMapMerge(final Flow<? extends T> flow, int i10, final Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt.flattenMerge(new Flow<Flow<? extends R>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapMerge$$inlined$map$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
                @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapMerge$$inlined$map$1$2", f = "Merge.kt", i = {}, l = {g.STALE_CACHED_RESPONSE_VALUE, g.STALE_CACHED_RESPONSE_VALUE}, m = "emit", n = {}, s = {})
                @SourceDebugExtension({"SMAP\nEmitters.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$1$1$emit$1\n*L\n1#1,222:1\n*E\n"})
    ...
    public static /* synthetic */ Flow flatMapMerge$default(Flow flow, int i10, Function2 function2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i10 = DEFAULT_CONCURRENCY;
        }
        return FlowKt.flatMapMerge(flow, i10, function2);
    }
    ...
    public static final <T> Flow<T> flattenMerge(Flow<? extends Flow<? extends T>> flow, int i10) {
        ...
        throw new IllegalArgumentException(j.i("Expected positive concurrency level, but had ", i10).toString());
    }
