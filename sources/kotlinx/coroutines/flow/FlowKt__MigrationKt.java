...
public final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> flow, long j3) {
        return FlowKt.onEach(flow, new FlowKt__MigrationKt$delayEach$1(j3, null));
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "Use 'onStart { delay(timeMillis) }'", replaceWith = @ReplaceWith(expression = "onStart { delay(timeMillis) }", imports = {}))
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j3) {
        return FlowKt.onStart(flow, new FlowKt__MigrationKt$delayFlow$1(j3, null));
    }
    ...
    public static /* synthetic */ Flow onErrorReturn$default(Flow flow, Object obj, Function1 function1, int i10, Object obj2) {
        if ((i10 & 2) != 0) {
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t5, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m1688catch(flow, new FlowKt__MigrationKt$onErrorReturn$2(function1, t5, null));
    }
