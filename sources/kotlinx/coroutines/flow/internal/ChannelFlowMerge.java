...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        Object collect = this.flow.collect(new ChannelFlowMerge$collectTo$2((Job) continuation.get$context().get(Job.INSTANCE), Semaphore$default, producerScope, sendingCollector), continuation);
    ...
    public ChannelFlowMerge(Flow<? extends Flow<? extends T>> flow, int i10, CoroutineContext coroutineContext, int i11, BufferOverflow bufferOverflow) {
