...
public final class ChannelFlowKt {
    ...
    public static final <T, V> Object withContextUndispatched(CoroutineContext coroutineContext, V v10, Object obj, Function2<? super V, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
    ...
    public static final <T> FlowCollector<T> withUndispatchedContextCollector(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext) {
        ...
        if (flowCollector instanceof SendingCollector) {
            ...
            z10 = flowCollector instanceof NopCollector;
        }
        if (!z10) {
