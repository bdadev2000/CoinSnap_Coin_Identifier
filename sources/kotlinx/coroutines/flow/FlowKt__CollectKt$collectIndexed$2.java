...
@Metadata(d1 = {"\u0000\u0019\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0007R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u000e¢\u0006\u0002\n\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\b"}, d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collectIndexed$2", "Lkotlinx/coroutines/flow/FlowCollector;", "index", "", "emit", "", AppMeasurementSdk.ConditionalUserProperty.VALUE, "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 8, 0}, xi = 176)
...
public final class FlowKt__CollectKt$collectIndexed$2<T> implements FlowCollector<T> {
    ...
    public Object emit(T t5, Continuation<? super Unit> continuation) {
        ...
        this.index = i10 + 1;
        if (i10 >= 0) {
            Object invoke = function3.invoke(Boxing.boxInt(i10), t5, continuation);
    ...
    public Object emit$$forInline(T t5, final Continuation<? super Unit> continuation) {
        InlineMarker.mark(4);
        ...
        this.index = i10 + 1;
        if (i10 >= 0) {
            function3.invoke(Integer.valueOf(i10), t5, continuation);
            return Unit.INSTANCE;
        }
        throw new ArithmeticException("Index overflow has happened");
    }
