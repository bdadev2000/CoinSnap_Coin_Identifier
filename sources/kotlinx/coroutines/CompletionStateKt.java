...
public final class CompletionStateKt {
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m145constructorimpl(ResultKt.createFailure(((CompletedExceptionally) obj).cause));
        }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        Throwable m148exceptionOrNullimpl = Result.m148exceptionOrNullimpl(obj);
        return m148exceptionOrNullimpl == null ? obj : new CompletedExceptionally(m148exceptionOrNullimpl, false, 2, null);
    }
}
