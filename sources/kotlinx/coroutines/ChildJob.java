...
public interface ChildJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(ChildJob childJob, R r6, Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) Job.DefaultImpls.fold(childJob, r6, function2);
        }
