...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo9848scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m9779delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9780toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9780toDelayMillisLRDsOJo(long j) {
        if (Duration.m9614compareToLRDsOJo(j, Duration.INSTANCE.m9718getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m9633getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
