...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j3, Continuation<? super Unit> continuation) {
        if (j3 <= 0) {
        ...
        if (j3 < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getContext()).mo1715scheduleResumeAfterDelay(j3, cancellableContinuationImpl);
        }
    ...
    public static final Object m1648delayVtjQ1oo(long j3, Continuation<? super Unit> continuation) {
        Object delay = delay(m1649toDelayMillisLRDsOJo(j3), continuation);
    ...
    public static final long m1649toDelayMillisLRDsOJo(long j3) {
        if (Duration.m1483compareToLRDsOJo(j3, Duration.INSTANCE.m1587getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1502getInWholeMillisecondsimpl(j3), 1L);
        }
        return 0L;
    }
}
