...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m8274constructorimpl = Result.m8274constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8274constructorimpl = Result.m8274constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m8280isFailureimpl(m8274constructorimpl) ? null : m8274constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo9847dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
