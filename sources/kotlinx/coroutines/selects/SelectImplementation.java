...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    private final void checkClauseObject(Object clauseObject) {
        ...
        if (z11) {
            ...
            throw new IllegalStateException(j.j("Cannot use select clauses on the same object: ", clauseObject).toString());
        }
    }
    ...
    */
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuation) {
                ...
                if (Intrinsics.areEqual(obj, symbol3)) {
                    List listOf = CollectionsKt.listOf(clauseObject);
                    while (true) {
                        if (atomicReferenceFieldUpdater.compareAndSet(this, obj, listOf)) {
                            z11 = true;
                            break;
                        }
                        if (atomicReferenceFieldUpdater.get(this) != obj) {
                    ...
                    List plus = CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject);
                    while (true) {
                        if (atomicReferenceFieldUpdater.compareAndSet(this, obj, plus)) {
                            z11 = true;
                            break;
                        }
                        if (atomicReferenceFieldUpdater.get(this) != obj) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0082, code lost:
        ...
        if (r0 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L32;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r8 = this;
        ...
        L59:
            ...
            goto L59
        L67:
            boolean r1 = r3 instanceof kotlinx.coroutines.selects.SelectImplementation.ClauseData
            if (r1 == 0) goto L91
            ...
            kotlin.jvm.functions.Function1 r2 = r3.createOnCancellationAction(r8, r2)
            r0.resume(r1, r2)
        L7a:
    ...
    public void onTimeout(long j3, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        SelectBuilder.DefaultImpls.onTimeout(this, j3, function1);
    }
    ...
    @Override // kotlinx.coroutines.selects.SelectBuilder
    public <P, Q> void invoke(SelectClause2<? super P, ? extends Q> selectClause2, P p10, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        register$default(this, new ClauseData(selectClause2.getClauseObject(), selectClause2.getRegFunc(), selectClause2.getProcessResFunc(), p10, function2, selectClause2.getOnCancellationConstructor()), false, 1, null);
    }
