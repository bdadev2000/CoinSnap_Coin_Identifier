...
public final class SelectOldKt {
    ...
    public static final <T> void resumeUndispatched(CancellableContinuation<? super T> cancellableContinuation, T t5) {
        ...
        if (coroutineDispatcher != null) {
            cancellableContinuation.resumeUndispatched(coroutineDispatcher, t5);
        } else {
            cancellableContinuation.resumeWith(Result.m145constructorimpl(t5));
        }
    }
