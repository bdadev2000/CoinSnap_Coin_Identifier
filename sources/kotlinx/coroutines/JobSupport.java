...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final Object finalizeFinishingState(Finishing state, Object proposedUpdate) {
        ...
        if (finalRootCause != null && finalRootCause != th2) {
            proposedUpdate = new CompletedExceptionally(finalRootCause, z10, 2, defaultConstructorMarker);
        }
        if (finalRootCause != null) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Finishing) {
                synchronized (state$kotlinx_coroutines_core) {
                    ...
                    if (cause != null || !isCancelling) {
                        if (th3 == null) {
                            th3 = createCauseException(cause);
                        }
            ...
            if (state$kotlinx_coroutines_core instanceof Incomplete) {
                ...
                if (incomplete.getIsActive()) {
                    if (tryMakeCancelling(incomplete, th3)) {
                        return JobSupportKt.access$getCOMPLETING_ALREADY$p();
                    }
                } else {
                    Object tryMakeCompleting = tryMakeCompleting(state$kotlinx_coroutines_core, new CompletedExceptionally(th3, false, 2, b3 == true ? 1 : 0));
    ...
    private final int startInternal(Object state) {
        ...
        if (state instanceof Empty) {
            ...
            while (true) {
                if (atomicReferenceFieldUpdater.compareAndSet(this, state, access$getEMPTY_ACTIVE$p)) {
                    z10 = true;
                    break;
                }
        ...
        while (true) {
            if (atomicReferenceFieldUpdater2.compareAndSet(this, state, list)) {
                z10 = true;
                break;
            }
    ...
    public <R> R fold(R r6, Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return (R) Job.DefaultImpls.fold(this, r6, function2);
    }
    ...
    public final String toDebugString() {
        ...
        return e.g(sb2, stateString(getState$kotlinx_coroutines_core()), AbstractJsonLexerKt.END_OBJ);
    }
