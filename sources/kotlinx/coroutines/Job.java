...
public interface Job extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        ...
        public static <R> R fold(Job job, R r6, Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) CoroutineContext.Element.DefaultImpls.fold(job, r6, function2);
        }
