...
public final class DebugProbesImpl {
    ...
    static {
        ...
        ARTIFICIAL_FRAME = k.c(d.class.getSimpleName(), new Exception());
    ...
    private final void build(Job job, Map<Job, DebugCoroutineInfoImpl> map, StringBuilder sb2, String str) {
        ...
        if (debugCoroutineInfoImpl == null) {
            ...
            m11.append(getDebugString(job));
            m11.append(", continuation is ");
            m11.append(str2);
            m11.append(" at line ");
            m11.append(stackTraceElement);
            m11.append('\n');
        ...
        if (isInstalled$kotlinx_coroutines_debug()) {
            ...
            for (CoroutineOwner coroutineOwner : SequencesKt.sortedWith(SequencesKt.filter(CollectionsKt.asSequence(getCapturedCoroutines()), new Function1<CoroutineOwner<?>, Boolean>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$2
                ...
                public final int compare(T t5, T t10) {
                    return ComparisonsKt.compareValues(Long.valueOf(((DebugProbesImpl.CoroutineOwner) t5).info.sequenceNumber), Long.valueOf(((DebugProbesImpl.CoroutineOwner) t10).info.sequenceNumber));
                }
            })) {
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                ...
                m145constructorimpl = Result.m145constructorimpl(thread.getStackTrace());
            } catch (Throwable th2) {
            ...
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m145constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            m145constructorimpl = Result.m145constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.INSTANCE;
            m145constructorimpl = Result.m145constructorimpl(ResultKt.createFailure(th2));
        }
        ...
        return (Function1) m145constructorimpl;
    }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        for (DebugCoroutineInfo debugCoroutineInfo : dumpCoroutinesInfo) {
            ...
            o10.append(str2);
            o10.append(",\n                    \"sequenceNumber\": ");
            o10.append(debugCoroutineInfo.getSequenceNumber());
            o10.append(",\n                    \"state\": \"");
            o10.append(debugCoroutineInfo.getState());
            o10.append("\"\n                } \n                ");
            arrayList3.add(StringsKt.trimIndent(o10.toString()));
        ...
        return new Object[]{e.g(sb2, joinToString$default, AbstractJsonLexerKt.END_LIST), arrayList.toArray(new Thread[0]), arrayList2.toArray(new CoroutineStackFrame[0]), dumpCoroutinesInfo.toArray(new DebugCoroutineInfo[0])};
    }
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        return e.g(sb3, joinToString$default, AbstractJsonLexerKt.END_LIST);
    }
