...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m8274constructorimpl = Result.m8274constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m8274constructorimpl = Result.m8274constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m8280isFailureimpl(m8274constructorimpl) ? null : m8274constructorimpl);
