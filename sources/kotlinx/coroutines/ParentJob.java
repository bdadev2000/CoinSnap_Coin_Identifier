...
public interface ParentJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(ParentJob parentJob, R r6, Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) Job.DefaultImpls.fold(parentJob, r6, function2);
        }
