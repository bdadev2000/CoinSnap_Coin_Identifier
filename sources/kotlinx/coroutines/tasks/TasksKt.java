...
public final class TasksKt {
    public static /* synthetic */ void a(CompletableDeferred completableDeferred, Task task) {
    ...
    private static final <T> Deferred<T> asDeferredImpl(Task<T> task, final CancellationTokenSource cancellationTokenSource) {
        ...
        if (task.isComplete()) {
            ...
            task.addOnCompleteListener(DirectExecutor.INSTANCE, new h(CompletableDeferred$default, 4));
        }
        ...
        task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$awaitImpl$2$1
            ...
            public final void onComplete(Task<T> task2) {
                ...
                if (exception2 == null) {
                    ...
                    continuation2.resumeWith(Result.m145constructorimpl(task2.getResult()));
                    return;
                }
                Continuation continuation3 = cancellableContinuationImpl;
                Result.Companion companion2 = Result.INSTANCE;
                continuation3.resumeWith(Result.m145constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
        if (cancellationTokenSource != null) {
