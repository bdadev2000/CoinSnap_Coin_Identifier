...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i10, int i11, long j3, String str, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, i11, j3, (i12 & 8) != 0 ? "CoroutineScheduler" : str);
    }
    ...
    public final CoroutineDispatcher blocking(int parallelism) {
        ...
        throw new IllegalArgumentException(j.i("Expected positive parallelism level, but have ", parallelism).toString());
    }
    ...
    public ExperimentalCoroutineDispatcher(int i10, int i11, long j3, String str) {
