...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public CoroutineScheduler(int i10, int i11, long j3, String str) {
        this.corePoolSize = i10;
        this.maxPoolSize = i11;
        this.idleWorkerKeepAliveNs = j3;
        this.schedulerName = str;
        if (!(i10 >= 1)) {
            throw new IllegalArgumentException(a.i("Core pool size ", i10, " should be at least 1").toString());
        }
        if (!(i11 >= i10)) {
            throw new IllegalArgumentException(j.e("Max pool size ", i11, " should be greater than or equals to core pool size ", i10).toString());
        }
        if (!(i11 <= 2097150)) {
            throw new IllegalArgumentException(a.i("Max pool size ", i11, " should not exceed maximal supported number of threads 2097150").toString());
        }
        if (j3 > 0) {
        ...
        throw new IllegalArgumentException(j.f("Idle worker keep alive time ", j3, " must be positive").toString());
    }
    ...
    private final int createNewWorker() {
        ...
        synchronized (this.workers) {
            ...
            boolean z11 = false;
            int coerceAtLeast = RangesKt.coerceAtLeast(i10 - ((int) ((j3 & BLOCKING_MASK) >> 21)), 0);
    ...
    public static /* synthetic */ void dispatch$default(CoroutineScheduler coroutineScheduler, Runnable runnable, TaskContext taskContext, boolean z10, int i10, Object obj) {
        if ((i10 & 2) != 0) {
    ...
    private final Worker parkedWorkersStackPop() {
        ...
        while (true) {
            ...
            long j10 = (2097152 + j3) & PARKED_VERSION_MASK;
            int parkedWorkersStackNextIndex = parkedWorkersStackNextIndex(worker);
            if (parkedWorkersStackNextIndex >= 0 && parkedWorkersStack$FU.compareAndSet(this, j3, parkedWorkersStackNextIndex | j10)) {
    ...
    public static /* synthetic */ boolean tryCreateWorker$default(CoroutineScheduler coroutineScheduler, long j3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j3 = controlState$FU.get(coroutineScheduler);
        }
    ...
    public final void dispatch(Runnable block, TaskContext taskContext, boolean tailDispatch) {
        ...
        if (z10) {
            j3 = controlState$FU.addAndGet(this, 2097152L);
        } else {
            j3 = 0;
        }
        ...
        if (submitToLocalQueue != null && !addToGlobalQueue(submitToLocalQueue)) {
            throw new RejectedExecutionException(e.h(new StringBuilder(), this.schedulerName, " was terminated"));
        }
        if (tailDispatch && currentWorker != null) {
            z11 = true;
        }
        if (z10) {
            signalBlockingWork(j3, z11);
        } else {
            if (z11) {
                return;
            }
    ...
    public final boolean parkedWorkersStackPush(Worker worker) {
        ...
        do {
            j3 = atomicLongFieldUpdater.get(this);
            j10 = (2097152 + j3) & PARKED_VERSION_MASK;
            indexInArray = worker.getIndexInArray();
            worker.setNextParkedWorker(this.workers.get((int) (2097151 & j3)));
        } while (!parkedWorkersStack$FU.compareAndSet(this, j3, j10 | indexInArray));
        return true;
    }
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            if (i10 == oldIndex) {
                if (newIndex == 0) {
                    i10 = parkedWorkersStackNextIndex(worker);
                } else {
                    i10 = newIndex;
                }
            }
            if (i10 >= 0 && parkedWorkersStack$FU.compareAndSet(this, j3, j10 | i10)) {
                return;
            }
        }
    }
    ...
    public final void shutdown(long timeout) {
        ...
        Worker currentWorker = currentWorker();
        synchronized (this.workers) {
            i10 = (int) (controlState$FU.get(this) & 2097151);
        }
        if (1 <= i10) {
            int i11 = 1;
            while (true) {
    ...
    public String toString() {
        ...
        long j3 = controlState$FU.get(this);
        ...
        sb5.append(", max = ");
        j.y(sb5, this.maxPoolSize, "}, Worker States {CPU = ", i10, ", blocking = ");
        j.y(sb5, i11, ", parked = ", i12, ", dormant = ");
        j.y(sb5, i13, ", terminated = ", i14, "}, running workers queues = ");
        ...
        sb5.append((int) ((BLOCKING_MASK & j3) >> 21));
        sb5.append(", CPUs acquired = ");
        sb5.append(this.corePoolSize - ((int) ((CPU_PERMITS_MASK & j3) >> 42)));
        sb5.append("}]");
        return sb5.toString();
    }
    ...
    public final class Worker extends Thread {
        ...
        private final Task trySteal(int stealingMode) {
            int i10 = (int) (CoroutineScheduler.controlState$FU.get(CoroutineScheduler.this) & 2097151);
            if (i10 < 2) {
                return null;
            }
        ...
        public final int nextInt(int upperBound) {
            ...
            return (i13 & Integer.MAX_VALUE) % upperBound;
        }
        ...
        public final long runSingleTask() {
            ...
            if (findBlockingTask == null) {
                long j3 = this.minDelayUntilStealableTaskNs;
                if (j3 == 0) {
                    return -1L;
                }
                return j3;
    ...
    public /* synthetic */ CoroutineScheduler(int i10, int i11, long j3, String str, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, i11, (i12 & 4) != 0 ? TasksKt.IDLE_WORKER_KEEP_ALIVE_NS : j3, (i12 & 8) != 0 ? TasksKt.DEFAULT_SCHEDULER_NAME : str);
    }
}
