...
public class SchedulerCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ SchedulerCoroutineDispatcher(int i10, int i11, long j3, String str, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? TasksKt.CORE_POOL_SIZE : i10, (i12 & 2) != 0 ? TasksKt.MAX_POOL_SIZE : i11, (i12 & 4) != 0 ? TasksKt.IDLE_WORKER_KEEP_ALIVE_NS : j3, (i12 & 8) != 0 ? "CoroutineScheduler" : str);
    }

    public SchedulerCoroutineDispatcher(int i10, int i11, long j3, String str) {
