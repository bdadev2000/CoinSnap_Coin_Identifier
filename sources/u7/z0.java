...
public final class z0 extends b0 {
    ...
    public final n b(n nVar) {
        ...
        if (i10 != 2) {
            return new n(nVar.a, nVar.f25593b, 2);
        }
        return n.f25592e;
    }
    ...
    */
    public final void queueInput(java.nio.ByteBuffer r10) {
        /*
            r9 = this;
            int r0 = r10.position()
            int r1 = r10.limit()
        ...
        L2d:
            int r2 = r2 * 2
        L2f:
            java.nio.ByteBuffer r2 = r9.f(r2)
            u7.n r3 = r9.f25542b
            int r3 = r3.f25594c
            if (r3 == r8) goto Laf
            if (r3 == r7) goto L8a
        ...
        Lc4:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: u7.z0.queueInput(java.nio.ByteBuffer):void");
    }
}
