...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    private boolean isFragmentViewBound(long j) {
        ...
        return (fragment == null || (rootView = fragment.getRootView()) == null || rootView.getParent() == null) ? false : true;
    }
    ...
    void placeFragmentInViewHolder(final FragmentViewHolder fragmentViewHolder) {
        ...
        if (!fragment.isAdded() && rootView != null) {
            throw new IllegalStateException("Design assumption violated.");
        }
        if (fragment.isAdded() && rootView == null) {
        ...
        if (fragment.isAdded() && rootView.getParent() != null) {
            if (rootView.getParent() != container) {
                addViewToContainer(rootView, container);
                return;
            }
            return;
        }
    ...
    private void removeFragment(long j) {
        ...
        if (fragment.getRootView() != null && (parent = fragment.getRootView().getParent()) != null) {
