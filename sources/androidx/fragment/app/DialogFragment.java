    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public final View b(int i2) {
                ...
                return fragmentContainer.c() ? fragmentContainer.b(i2) : DialogFragment.this.onFindViewById(i2);
            }

            @Override // androidx.fragment.app.FragmentContainer
            public final boolean c() {
                return createFragmentContainer.c() || DialogFragment.this.onHasView();
            }
        };
    }
    ...
    public final void g(boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            ...
            if (i2 < 0) {
                ...
                throw new IllegalArgumentException(android.support.v4.media.d.i("Bad id: ", i2));
            }
            ...
            if (i3 < 0) {
                throw new IllegalArgumentException(android.support.v4.media.d.i("Bad id: ", i3));
            }
            parentFragmentManager3.w(new FragmentManager.PopBackStackState(i3), z2);
        }
        this.mBackStackId = -1;
    }
