...
public class FragmentStateManager {
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle m7530lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m7530lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!m7530lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, m7530lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
