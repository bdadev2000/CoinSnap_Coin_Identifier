...
public final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            String replaceFirst = str.replaceFirst(LogEvents.exportemptyalert_close_click_type_get, "");
            ...
            if (((java.lang.reflect.Method) hashMap2.get("set" + replaceFirst)) != null && (!replaceFirst.endsWith(BYTES_SUFFIX) || !hashMap.containsKey(LogEvents.exportemptyalert_close_click_type_get + replaceFirst.substring(0, replaceFirst.length() - 5)))) {
                String str4 = replaceFirst.substring(0, 1).toLowerCase() + replaceFirst.substring(1);
                java.lang.reflect.Method method4 = (java.lang.reflect.Method) hashMap.get(LogEvents.exportemptyalert_close_click_type_get + replaceFirst);
