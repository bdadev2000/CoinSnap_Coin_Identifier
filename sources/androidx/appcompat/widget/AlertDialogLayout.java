    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            androidx.appcompat.widget.c2 r6 = (androidx.appcompat.widget.c2) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i21 = 0; i21 < childCount; i21++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c2Var).width == -1) {
                        int i22 = ((LinearLayout.LayoutParams) c2Var).height;
                        ((LinearLayout.LayoutParams) c2Var).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i11, 0);
                        ((LinearLayout.LayoutParams) c2Var).height = i22;
                    }
                }
            }
        }
