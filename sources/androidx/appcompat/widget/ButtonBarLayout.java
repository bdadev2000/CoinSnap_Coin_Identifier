...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f1085c = -1;
        int[] iArr = R.styleable.f319k;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        ViewCompat.z(this, context, iArr, attributeSet, obtainStyledAttributes, 0);
        this.f1083a = obtainStyledAttributes.getBoolean(0, true);
        obtainStyledAttributes.recycle();
        if (getOrientation() == 1) {
            setStacked(this.f1083a);
        }
    }
    ...
    private void setStacked(boolean z2) {
        if (this.f1084b != z2) {
            if (!z2 || this.f1083a) {
                ...
                View findViewById = findViewById(com.cooldev.gba.emulator.gameboy.R.id.spacer);
    ...
    */
    public final void onMeasure(int r7, int r8) {
        /*
            ...
            boolean r1 = r6.f1083a
            r2 = 0
            if (r1 == 0) goto L16
            int r1 = r6.f1085c
            if (r0 <= r1) goto L14
            boolean r1 = r6.f1084b
            if (r1 == 0) goto L14
            r6.setStacked(r2)
        L14:
            r6.f1085c = r0
        ...
        L2d:
            ...
            boolean r0 = r6.f1083a
            if (r0 == 0) goto L47
            boolean r0 = r6.f1084b
            if (r0 != 0) goto L47
