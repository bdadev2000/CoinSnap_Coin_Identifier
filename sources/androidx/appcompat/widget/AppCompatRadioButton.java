...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public final void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.f1003b = mapObject;
            mapObject2 = propertyMapper.mapObject("backgroundTintMode", R.attr.backgroundTintMode);
            this.f1004c = mapObject2;
        ...
        public final void readProperties(Object obj, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f1003b, appCompatRadioButton.getBackgroundTintList());
            propertyReader.readObject(this.f1004c, appCompatRadioButton.getBackgroundTintMode());
            ...
            propertyReader.readObject(this.f1005f, appCompatRadioButton.getCompoundDrawableTintList());
            propertyReader.readObject(this.f1006g, appCompatRadioButton.getCompoundDrawableTintMode());
        }
    }
