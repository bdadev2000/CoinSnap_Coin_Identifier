...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static int resolveGravity(int i) {
        ...
        return (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) == 0 ? i | 48 : i;
    }
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i5 = absoluteGravity & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA;
        int i6 = absoluteGravity2 & 7;
        int i7 = absoluteGravity2 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA;
        if (i6 == 1) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (i != 0 || view.getVisibility() != 8) {
                ...
                if (layoutParams.insetEdge != 0 && !acquireTempRect2.isEmpty()) {
                    ...
                    int i4 = absoluteGravity & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA;
                    if (i4 == 48) {
