...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public WindowMetrics computeCurrentWindowMetrics(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            computeWindowBoundsP$window_release = ActivityCompatHelperApi30.INSTANCE.currentWindowBounds(activity);
        ...
        return new WindowMetrics(computeWindowBoundsP$window_release);
    }
