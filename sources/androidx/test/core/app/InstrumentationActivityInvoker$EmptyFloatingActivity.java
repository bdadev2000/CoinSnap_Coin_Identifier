...
public class InstrumentationActivityInvoker$EmptyFloatingActivity extends Activity {
    ...
    public final BroadcastReceiver f2107b = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker$EmptyFloatingActivity.1
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BroadcastReceiver broadcastReceiver = this.f2107b;
