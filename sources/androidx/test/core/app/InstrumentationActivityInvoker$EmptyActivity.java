...
public class InstrumentationActivityInvoker$EmptyActivity extends Activity {
    ...
    public final BroadcastReceiver f2106b = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker$EmptyActivity.1
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BroadcastReceiver broadcastReceiver = this.f2106b;
