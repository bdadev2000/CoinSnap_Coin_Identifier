...
public abstract class ObjectLongMap<K> {
    ...
    public final int a(Object obj) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - 72340172838076673L) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (a.g(this.f1554b[numberOfTrailingZeros], obj)) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (objectLongMap.e != this.e) {
            return false;
        }
        Object[] objArr = this.f1554b;
        long[] jArr = this.f1555c;
        long[] jArr2 = this.f1553a;
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j2) < 128) {
                            int i5 = (i2 << 3) + i4;
                            if (jArr[i5] != objectLongMap.b(objArr[i5])) {
                                return false;
                            }
                        }
                        j2 >>= 8;
