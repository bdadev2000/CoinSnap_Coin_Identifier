...
@e(c = "androidx.collection.ScatterMap$MapWrapper$values$1$iterator$1", f = "ScatterMap.kt", l = {746}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class ScatterMap$MapWrapper$values$1$iterator$1 extends h implements p {
    ...
    public /* synthetic */ Object f1588j;

    /* renamed from: k, reason: collision with root package name */
    public final /* synthetic */ ScatterMap f1589k;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScatterMap$MapWrapper$values$1$iterator$1(ScatterMap scatterMap, g gVar) {
        super(gVar);
        this.f1589k = scatterMap;
    }

    @Override // j0.a
    public final g create(Object obj, g gVar) {
        ScatterMap$MapWrapper$values$1$iterator$1 scatterMap$MapWrapper$values$1$iterator$1 = new ScatterMap$MapWrapper$values$1$iterator$1(this.f1589k, gVar);
        scatterMap$MapWrapper$values$1$iterator$1.f1588j = obj;
        return scatterMap$MapWrapper$values$1$iterator$1;
    }

    @Override // q0.p
    public final Object invoke(Object obj, Object obj2) {
        return ((ScatterMap$MapWrapper$values$1$iterator$1) create((l) obj, (g) obj2)).invokeSuspend(b0.f30125a);
    }
