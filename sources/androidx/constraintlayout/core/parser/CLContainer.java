...
public class CLContainer extends CLElement {
    ...
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* renamed from: clone */
    public CLContainer mo7479clone() {
        CLContainer cLContainer = (CLContainer) super.mo7479clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo7479clone = it.next().mo7479clone();
            mo7479clone.setContainer(cLContainer);
            arrayList.add(mo7479clone);
        }
