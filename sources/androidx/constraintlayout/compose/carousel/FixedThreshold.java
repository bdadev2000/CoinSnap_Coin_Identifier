...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m7475copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m7476copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m7476copy0680j_4(float offset) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m7002equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m7003hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m7008toStringimpl(this.offset)) + ')';
    }
