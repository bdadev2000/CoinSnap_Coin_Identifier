...
public final class KeyPositionScope extends BaseKeyFrameScope {
    ...
    public KeyPositionScope() {
        ...
        this.percentX = BaseKeyFrameScope.addOnPropertyChange$default(keyPositionScope, valueOf, null, 2, null);
        this.percentY = BaseKeyFrameScope.addOnPropertyChange$default(keyPositionScope, valueOf, null, 2, null);
        this.percentWidth = BaseKeyFrameScope.addOnPropertyChange$default(keyPositionScope, valueOf, null, 2, null);
