...
public final class ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo342measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        ...
        long m7398performMeasure2eBlSMk = this.$measurer.m7398performMeasure2eBlSMk(j, measureScope.getLayoutDirection(), this.$constraintSet, list, this.$optimizationLevel);
        this.$remeasureRequesterState.getValue();
        int m7167getWidthimpl = IntSize.m7167getWidthimpl(m7398performMeasure2eBlSMk);
        int m7166getHeightimpl = IntSize.m7166getHeightimpl(m7398performMeasure2eBlSMk);
        final Measurer measurer = this.$measurer;
        return MeasureScope.layout$default(measureScope, m7167getWidthimpl, m7166getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.constraintlayout.compose.ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1.1
