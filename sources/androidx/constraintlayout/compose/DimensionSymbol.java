...
public final class DimensionSymbol {
    ...
    public final void m7359update0680j_4(float dp) {
        this.value = Dp.m6995boximpl(dp);
        this.symbol = null;
    }
    ...
    public final CLElement asCLElement() {
        Dp dp = this.value;
        if (dp != null) {
            return new CLNumber(dp.m7011unboximpl());
        }
