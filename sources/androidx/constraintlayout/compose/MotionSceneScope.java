...
public final class MotionSceneScope {
    ...
    public final void customFloat(ConstrainScope constrainScope, String str, float f) {
        if (!constrainScope.getContainerObject().has(SchedulerSupport.CUSTOM)) {
            constrainScope.getContainerObject().put(SchedulerSupport.CUSTOM, new CLObject(new char[0]));
        }
        CLObject objectOrNull = constrainScope.getContainerObject().getObjectOrNull(SchedulerSupport.CUSTOM);
    ...
    public final void m7441customColormxwnekA(ConstrainScope constrainScope, String str, long j) {
        if (!constrainScope.getContainerObject().has(SchedulerSupport.CUSTOM)) {
            constrainScope.getContainerObject().put(SchedulerSupport.CUSTOM, new CLObject(new char[0]));
        }
        CLObject objectOrNull = constrainScope.getContainerObject().getObjectOrNull(SchedulerSupport.CUSTOM);
        ...
        objectOrNull.putString(str, m7440toJsonHexString8_81llA(j));
    }
    ...
    public final void m7443customDistancewH6b6FI(ConstrainScope constrainScope, String str, float f) {
        customFloat(constrainScope, str, f);
    }

    /* renamed from: customFontSize-kncR6DU, reason: not valid java name */
    public final void m7445customFontSizekncR6DU(ConstrainScope constrainScope, String str, long j) {
        customFloat(constrainScope, str, TextUnit.m7190getValueimpl(j));
    }
    ...
    /* renamed from: customColor-mxwnekA, reason: not valid java name */
    public final void m7442customColormxwnekA(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, m7440toJsonHexString8_81llA(j));
    }
    ...
    /* renamed from: customDistance-wH6b6FI, reason: not valid java name */
    public final void m7444customDistancewH6b6FI(KeyAttributeScope keyAttributeScope, String str, float f) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(f));
    }

    /* renamed from: customFontSize-kncR6DU, reason: not valid java name */
    public final void m7446customFontSizekncR6DU(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(TextUnit.m7190getValueimpl(j)));
    }

    /* renamed from: toJsonHexString-8_81llA, reason: not valid java name */
    private final String m7440toJsonHexString8_81llA(long j) {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String format = String.format("#%08X", Arrays.copyOf(new Object[]{Integer.valueOf(ColorKt.m4569toArgb8_81llA(j))}, 1));
