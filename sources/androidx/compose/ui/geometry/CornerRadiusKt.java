...
public final class CornerRadiusKt {
    ...
    public static final long m4260lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m4249getXimpl(j), CornerRadius.m4249getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m4250getYimpl(j), CornerRadius.m4250getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m4243constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
}
