...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m4604getAutoNrFUSI();
    ...
    public void mo6202setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4600equalsimpl0(i, CompositingStrategy.INSTANCE.m4606getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4600equalsimpl0(i, CompositingStrategy.INSTANCE.m4605getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4600equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4606getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m4486clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
