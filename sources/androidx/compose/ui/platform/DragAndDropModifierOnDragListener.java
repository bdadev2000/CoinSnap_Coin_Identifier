...
public final class DragAndDropModifierOnDragListener implements View.OnDragListener, DragAndDropManager {
    ...
    public boolean mo4145drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        return this.startDrag.invoke(transferData, Size.m4331boximpl(decorationSize), drawDragDecoration).booleanValue();
    }
