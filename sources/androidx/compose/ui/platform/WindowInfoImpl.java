...
public final class WindowInfoImpl implements WindowInfo {
    ...
    public static /* synthetic */ void m6251getKeyboardModifiersk7X9c1A$annotations() {
    }
    ...
    public int mo6250getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m6252setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m5784boximpl(i));
    }
    ...
    static {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m5784boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
