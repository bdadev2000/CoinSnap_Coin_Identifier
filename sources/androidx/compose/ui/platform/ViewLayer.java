...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m4906getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m4901getPivotFractionXimpl(transformOrigin) * getWidth());
            setPivotY(TransformOrigin.m4902getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (z2 != z4 || (z4 && m6242updateS_szKao)) {
            invalidate();
        }
        ...
        if ((mutatedFields & 64) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m4569toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m4569toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((mutatedFields & 32768) != 0) {
            ...
            if (CompositingStrategy.m4600equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4606getOffscreenNrFUSI())) {
                setLayerType(2, null);
            } else if (CompositingStrategy.m4600equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m4605getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
    ...
    public boolean mo6134isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= m4274getXimpl && m4274getXimpl < ((float) getWidth()) && 0.0f <= m4275getYimpl && m4275getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mo6137resizeozmzZPI(long size) {
        ...
        if (m7167getWidthimpl == getWidth() && m7166getHeightimpl == getHeight()) {
            return;
        }
        setPivotX(TransformOrigin.m4901getPivotFractionXimpl(this.mTransformOrigin) * m7167getWidthimpl);
        setPivotY(TransformOrigin.m4902getPivotFractionYimpl(this.mTransformOrigin) * m7166getHeightimpl);
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m7167getWidthimpl, getTop() + m7166getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo6136movegyyYBs(long position) {
        ...
        if (m7125getXimpl != getLeft()) {
            offsetLeftAndRight(m7125getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m7126getYimpl = IntOffset.m7126getYimpl(position);
        if (m7126getYimpl != getTop()) {
            offsetTopAndBottom(m7126getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo6135mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m6218calculateInverseMatrixbWbORWo = this.matrixCache.m6218calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m4752mapMKHz9U(this.matrixCache.m6219calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m4754mapimpl(this.matrixCache.m6219calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo6138transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m4763timesAssign58bKbWc(matrix, this.matrixCache.m6219calculateMatrixGrdbGEg(this));
    }
