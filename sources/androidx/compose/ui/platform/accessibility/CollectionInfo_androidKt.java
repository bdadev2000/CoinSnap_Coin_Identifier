    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m4263boximpl(OffsetKt.Offset(Math.abs(Offset.m4274getXimpl(semanticsNode4.getBoundsInRoot().m4304getCenterF1C5BW0()) - Offset.m4274getXimpl(semanticsNode3.getBoundsInRoot().m4304getCenterF1C5BW0())), Math.abs(Offset.m4275getYimpl(semanticsNode4.getBoundsInRoot().m4304getCenterF1C5BW0()) - Offset.m4275getYimpl(semanticsNode3.getBoundsInRoot().m4304getCenterF1C5BW0())))));
        ...
        if (emptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m4263boximpl(Offset.m4279plusMKHz9U(((Offset) first).getPackedValue(), ((Offset) emptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m4275getYimpl(packedValue) < Offset.m4274getXimpl(packedValue);
    }
