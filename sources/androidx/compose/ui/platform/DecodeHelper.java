...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m6230setFontSizeR2X_6o(m6200decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m6231setFontStylemLjRB2g(FontStyle.m6567boximpl(m6198decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m6227setBackground8_81llA(m6197decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m6228setBaselineShift_isdbwI(BaselineShift.m6748boximpl(m6195decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m6233setLetterSpacingR2X_6o(m6200decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m6232setFontSynthesistDdu0R4(FontSynthesis.m6578boximpl(m6199decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m6229setColor8_81llA(m6197decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m6197decodeColor0d7_KjU() {
        return Color.m4511constructorimpl(m6196decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m6200decodeTextUnitXSAIIZE() {
        long m7224getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m7224getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7223getSpUIouoOA();
        } else if (decodeByte == 2) {
            m7224getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7222getEmUIouoOA();
        } else {
            m7224getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7224getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m7218equalsimpl0(m7224getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m7224getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m7201getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m7202TextUnitanM5pPY(decodeFloat(), m7224getUnspecifiedUIouoOA);
    }
    ...
    public final int m6198decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.INSTANCE.m6577getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.INSTANCE.m6576getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m6577getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m6199decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.INSTANCE.m6588getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.INSTANCE.m6587getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.INSTANCE.m6589getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.INSTANCE.m6590getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m6588getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m6195decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6749constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m6197decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m6196decodeULongsVKNKU() {
        return ULong.m8448constructorimpl(this.parcel.readLong());
    }
