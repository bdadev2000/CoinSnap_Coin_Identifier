...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int round = Math.round(Offset.m4274getXimpl(positionInRoot));
        int round2 = Math.round(Offset.m4275getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.INSTANCE.m5617getUserInputWNlRxjI();
        }
        return NestedScrollSource.INSTANCE.m5616getSideEffectWNlRxjI();
    }
}
