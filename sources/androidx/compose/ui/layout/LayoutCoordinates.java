...
public interface LayoutCoordinates {
    ...
    long mo5860localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo5862localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo5864localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo5868windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static long m5872screenToLocalMKHz9U(LayoutCoordinates layoutCoordinates, long j) {
            return LayoutCoordinates.super.mo5865screenToLocalMKHz9U(j);
        }

        @Deprecated
        /* renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
        public static long m5871localToScreenMKHz9U(LayoutCoordinates layoutCoordinates, long j) {
            return LayoutCoordinates.super.mo5863localToScreenMKHz9U(j);
        }

        @Deprecated
        /* renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
        public static long m5869localPositionOfS_NoaFU(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
            return LayoutCoordinates.super.mo5861localPositionOfS_NoaFU(layoutCoordinates2, j, z);
        }

        @Deprecated
        /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m5873transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, float[] fArr) {
            LayoutCoordinates.super.mo5866transformFromEL8BTi8(layoutCoordinates2, fArr);
        }

        @Deprecated
        /* renamed from: transformToScreen-58bKbWc, reason: not valid java name */
        public static void m5874transformToScreen58bKbWc(LayoutCoordinates layoutCoordinates, float[] fArr) {
            LayoutCoordinates.super.mo5867transformToScreen58bKbWc(fArr);
        }
    }

    /* renamed from: screenToLocal-MK-Hz9U, reason: not valid java name */
    default long mo5865screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
    }

    /* renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    default long mo5863localToScreenMKHz9U(long relativeToLocal) {
        return Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
    }

    /* renamed from: localPositionOf-S_NoaFU$default, reason: not valid java name */
    static /* synthetic */ long m5858localPositionOfS_NoaFU$default(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return layoutCoordinates.mo5861localPositionOfS_NoaFU(layoutCoordinates2, j, z);
    }

    /* renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
    default long mo5861localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
    ...
    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo5866transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        throw new UnsupportedOperationException("transformFrom is not implemented on this LayoutCoordinates");
    }

    /* renamed from: transformToScreen-58bKbWc, reason: not valid java name */
    default void mo5867transformToScreen58bKbWc(float[] matrix) {
