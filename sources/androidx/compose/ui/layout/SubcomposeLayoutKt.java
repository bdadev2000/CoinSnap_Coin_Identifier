...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            int i5 = i3 << 3;
            SubcomposeLayout(subcomposeLayoutState, modifier, function2, startRestartGroup, (i5 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i5 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m4015setimpl(m4008constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
            Updater.m4015setimpl(m4008constructorimpl, rememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
            Updater.m4015setimpl(m4008constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
