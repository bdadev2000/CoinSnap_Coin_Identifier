...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m4275getYimpl(targetCoordinates.mo5860localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m7167getWidthimpl(sourceCoordinates.mo5859getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
