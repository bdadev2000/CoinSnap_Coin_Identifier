...
public interface ContentScale {
    ...
    long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5844access$computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5844access$computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5844access$computeFillMaxDimensioniLBOSCw, m5844access$computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5845access$computeFillMinDimensioniLBOSCw = ContentScaleKt.m5845access$computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5845access$computeFillMinDimensioniLBOSCw, m5845access$computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5843access$computeFillHeightiLBOSCw = ContentScaleKt.m5843access$computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5843access$computeFillHeightiLBOSCw, m5843access$computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5846access$computeFillWidthiLBOSCw = ContentScaleKt.m5846access$computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5846access$computeFillWidthiLBOSCw, m5846access$computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m4343getWidthimpl(srcSize) <= Size.m4343getWidthimpl(dstSize) && Size.m4340getHeightimpl(srcSize) <= Size.m4340getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5842computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m5846access$computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m5843access$computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
