...
public final class KeyEventType {
    ...
    private static final int Unknown = m5571constructorimpl(0);
    private static final int KeyUp = m5571constructorimpl(1);
    private static final int KeyDown = m5571constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m5570boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m5572equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5574hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m5575toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5575toStringimpl(int i) {
        return m5573equalsimpl0(i, KeyUp) ? "KeyUp" : m5573equalsimpl0(i, KeyDown) ? "KeyDown" : m5573equalsimpl0(i, Unknown) ? "Unknown" : "Invalid";
    }
