...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m5255boximpl(i), null, 2, null);
    ...
    public int mo5264getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode.getValue()).getValue();
    }

    /* renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m5266setInputModeiuPiT84(int i) {
        this.inputMode.setValue(InputMode.m5255boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo5265requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m5255boximpl(inputMode)).booleanValue();
    }
}
