...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5655constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m5785constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m5661calculatePointerEventType7fucELk();
    }
    ...
    public final void m5665setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5661calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m5680getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m5675getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m5676getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m5681getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.INSTANCE.m5677getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m5679getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m5678getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m5651activeHoverEvent0FcD4WY(pointerInputChange.getId())) {
