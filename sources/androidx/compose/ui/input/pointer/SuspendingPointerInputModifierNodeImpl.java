...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Object obj, Object obj2, Object[] objArr, Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.boundsSize = IntSize.INSTANCE.m7172getZeroYbymL2g();
    }
    ...
    public long mo668getExtendedTouchPaddingNHjbRc() {
        long j = mo678toSizeXkaWNTQ(getViewConfiguration().mo6007getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m4343getWidthimpl(j) - IntSize.m7167getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m4340getHeightimpl(j) - IntSize.m7166getHeightimpl(boundsSize)) / 2.0f);
    }
    ...
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo5632getExtendedTouchPaddingNHjbRc() {
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m8274constructorimpl(event));
        }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            createCoroutine.resumeWith(Result.m8274constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
