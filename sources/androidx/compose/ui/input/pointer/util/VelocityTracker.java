...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m4290getZeroF1C5BW0();
    }
    ...
    public final void m5824setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5820addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m4274getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m4275getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m5821calculateVelocity9UxMQ8M() {
        return m5822calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m5822calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m7234getXimpl(maximumVelocity) > 0.0f && Velocity.m7235getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m7241toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m7234getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m7235getYimpl(maximumVelocity)));
    }
