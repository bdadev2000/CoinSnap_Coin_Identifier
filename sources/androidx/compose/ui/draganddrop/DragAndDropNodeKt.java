...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m4148containsUv8p0NA(DragAndDropModifierNode dragAndDropModifierNode, long j) {
        ...
        int m7167getWidthimpl = IntSize.m7167getWidthimpl(mo5859getSizeYbymL2g);
        int m7166getHeightimpl = IntSize.m7166getHeightimpl(mo5859getSizeYbymL2g);
        long positionInRoot = LayoutCoordinatesKt.positionInRoot(coordinates);
        float m4274getXimpl = Offset.m4274getXimpl(positionInRoot);
        float m4275getYimpl = Offset.m4275getYimpl(positionInRoot);
        float f = m7167getWidthimpl + m4274getXimpl;
        float f2 = m7166getHeightimpl + m4275getYimpl;
        float m4274getXimpl2 = Offset.m4274getXimpl(j);
        if (m4274getXimpl > m4274getXimpl2 || m4274getXimpl2 > f) {
            return false;
        }
        float m4275getYimpl2 = Offset.m4275getYimpl(j);
        return m4275getYimpl <= m4275getYimpl2 && m4275getYimpl2 <= f2;
    }
