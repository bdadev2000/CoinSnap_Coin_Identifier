...
final class DistanceAndInLayer {
    ...
    public static final /* synthetic */ DistanceAndInLayer m5984boximpl(long j) {
    ...
    public static boolean m5987equalsimpl(long j, Object obj) {
        return (obj instanceof DistanceAndInLayer) && j == ((DistanceAndInLayer) obj).m5993unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5988equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static final boolean m5991isInLayerimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m5987equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m5990hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5992toStringimpl(this.packedValue);
    }
    ...
    public static final int m5985compareToS_HNhKs(long j, long j2) {
        boolean m5991isInLayerimpl = m5991isInLayerimpl(j);
        if (m5991isInLayerimpl != m5991isInLayerimpl(j2)) {
            return m5991isInLayerimpl ? -1 : 1;
        }
        return (int) Math.signum(m5989getDistanceimpl(j) - m5989getDistanceimpl(j2));
    }

    /* renamed from: getDistance-impl, reason: not valid java name */
    public static final float m5989getDistanceimpl(long j) {
