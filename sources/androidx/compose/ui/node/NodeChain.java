...
public final class NodeChain {
    ...
    */
    ...
    private final Differ getDiffer(Modifier.Node r9, int r10, MutableVector<Modifier.Element> r11, MutableVector<Modifier.Element> r12, boolean shouldAttachOnInsert) {
        Differ differ = this.cachedDiffer;
        if (differ == null) {
            Differ differ2 = new Differ(r9, r10, r11, r12, shouldAttachOnInsert);
            this.cachedDiffer = differ2;
            return differ2;
        }
        differ.setNode(r9);
        differ.setOffset(r10);
        differ.setBefore(r11);
        differ.setAfter(r12);
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        ...
        for (Modifier.Node parent = start.getParent(); parent != null; parent = parent.getParent()) {
            ...
            if (parent == nodeChainKt$SentinelHead$1) {
                ...
                if ((NodeKind.m6086constructorimpl(2) & parent.getKindSet()) != 0) {
                    return;
                }
    ...
    public final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((NodeKind.m6086constructorimpl(2) & child.getKindSet()) != 0) {
                NodeCoordinator coordinator = child.getCoordinator();
                Intrinsics.checkNotNull(coordinator);
    ...
    private final void structuralUpdate(int r7, MutableVector<Modifier.Element> r8, MutableVector<Modifier.Element> r9, Modifier.Node tail, boolean shouldAttachOnInsert) {
        MyersDiffKt.executeDiff(r8.getSize() - r7, r9.getSize() - r7, getDiffer(tail, r7, r8, r9, shouldAttachOnInsert));
    ...
    public final boolean m6047hasH91voCI$ui_release(int type) {
    ...
    public final /* synthetic */ <T> T m6046firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
    ...
    public final /* synthetic */ <T> void m6049headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Modifier.Node node = head;
    ...
    public final /* synthetic */ <T> void m6051tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
    ...
    public final /* synthetic */ <T> T m6050tailH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
                if ((tail.getKindSet() & type) != 0) {
                    Object obj = (T) tail;
    ...
    public final /* synthetic */ <T> T m6048headH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Object obj = (T) head;
