...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5958calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            Offset = mo5958calculatePositionInParentR5De75A(initialCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            m4274getXimpl = Offset.m4275getYimpl(Offset);
        } else {
            m4274getXimpl = Offset.m4274getXimpl(Offset);
        }
        int round = Math.round(m4274getXimpl);
