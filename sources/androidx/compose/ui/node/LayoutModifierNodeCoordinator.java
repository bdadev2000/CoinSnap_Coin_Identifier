...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet() & NodeKind.m6086constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & NodeKind.m6086constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final void m5998setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo5851measureBRTryo0(long constraints) {
            ...
            LookaheadDelegate.m6030access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, constraints);
            layoutModifierNodeCoordinator.m5998setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m6938boximpl(constraints));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo395measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    */
    public androidx.compose.ui.layout.Placeable mo5851measureBRTryo0(long r9) {
        /*
            r8 = this;
        ...
        L1b:
            ...
            androidx.compose.ui.node.NodeCoordinator.m6054access$setMeasurementConstraintsBRTryo0(r0, r9)
            ...
            long r2 = r0.mo5826getLookaheadSizeYbymL2g()
            ...
            boolean r2 = androidx.compose.ui.unit.Constraints.m6942equalsimpl(r9, r2)
            if (r2 != 0) goto L42
            goto L44
        L42:
            r2 = r3
        ...
        L8c:
            ...
            long r4 = r0.mo5859getSizeYbymL2g()
            androidx.compose.ui.node.NodeCoordinator r0 = r8.getWrappedNonNull()
            androidx.compose.ui.node.LookaheadDelegate r0 = r0.getLookaheadDelegate()
            if (r0 == 0) goto Lad
            long r6 = r0.m6033getSizeYbymL2g$ui_release()
            androidx.compose.ui.unit.IntSize r0 = androidx.compose.ui.unit.IntSize.m7159boximpl(r6)
            goto Lae
        Lad:
            r0 = 0
        Lae:
            boolean r0 = androidx.compose.ui.unit.IntSize.m7164equalsimpl(r4, r0)
            if (r0 == 0) goto Lbe
            if (r3 != 0) goto Lbe
        ...
        Ld1:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutModifierNodeCoordinator.mo5851measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
    }
    ...
    public void mo5912placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo5912placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    public void mo5852placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo5852placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long j = mo5859getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m7164equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m7159boximpl(lookaheadDelegate2.m6033getSizeYbymL2g$ui_release()) : null)) {
                    long mo5859getSizeYbymL2g = getWrappedNonNull().mo5859getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                    if (IntSize.m7164equalsimpl(mo5859getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m7159boximpl(lookaheadDelegate3.m6033getSizeYbymL2g$ui_release()) : null)) {
                        z = true;
    ...
    static {
        ...
        Paint.mo4394setColor8_81llA(Color.INSTANCE.m4542getBlue0d7_KjU());
