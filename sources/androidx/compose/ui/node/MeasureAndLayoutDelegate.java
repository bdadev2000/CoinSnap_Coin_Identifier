...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m6041updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m6943equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            InlineClassHelperKt.throwIllegalArgumentException("updateRootConstraints called while measuring");
        }
        this.rootConstraints = Constraints.m6938boximpl(constraints);
    ...
    private final boolean m6038doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m6001lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m6001lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m6005lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m6001lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m6001lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m6001lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m6001lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA */
    private final boolean m6039doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m6002remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m6002remeasure_Sx5XlM$ui_release$default = layoutNode.m6006remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m6002remeasure_Sx5XlM$ui_release$default = LayoutNode.m6002remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m6002remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m6002remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m6040measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m6038doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6938boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m6039doRemeasuresdFAvZA(layoutNode, Constraints.m6938boximpl(constraints));
    ...
    public final void registerOnLayoutCompletedListener(Owner.OnLayoutCompletedListener r2) {
        this.onLayoutCompletedListeners.add(r2);
    }
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                r1 = layoutNode.getLookaheadMeasurePending$ui_release() ? m6038doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                ...
                boolean m6039doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m6039doRemeasuresdFAvZA(layoutNode, constraints) : false;
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m6038doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m6039doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
