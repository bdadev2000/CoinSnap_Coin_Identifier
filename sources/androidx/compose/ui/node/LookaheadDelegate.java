...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public static final /* synthetic */ void m6030access$setMeasurementConstraintsBRTryo0(LookaheadDelegate lookaheadDelegate, long j) {
        lookaheadDelegate.m5914setMeasurementConstraintsBRTryo0(j);
    }
    ...
    public void m6037setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m6033getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release */
    public final long m6032getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m5913setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m5913setMeasuredSizeozmzZPI(IntSize.INSTANCE.m7172getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5852placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo5852placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m6031placeSelfgyyYBs(position);
    ...
    private final void m6031placeSelfgyyYBs(long position) {
        if (!IntOffset.m7124equalsimpl0(getPosition(), position)) {
            m6037setPositiongyyYBs(position);
    ...
    public final void m6035placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m6031placeSelfgyyYBs(IntOffset.m7129plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m6034performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m6036positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long m7135getZeronOccac = IntOffset.INSTANCE.m7135getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                m7135getZeronOccac = IntOffset.m7129plusqkQi6aY(m7135getZeronOccac, lookaheadDelegate.getPosition());
            }
