...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m4868getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m4879getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m5142getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m5143getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4864equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4874equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4865hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4875hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4866toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m4876toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
