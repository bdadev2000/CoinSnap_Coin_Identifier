...
public final class RenderIntent {
    ...
    private static final int Perceptual = m4943constructorimpl(0);
    private static final int Relative = m4943constructorimpl(1);
    private static final int Saturation = m4943constructorimpl(2);
    private static final int Absolute = m4943constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m4942boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4943constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4944equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4945equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4946hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m4946hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4947toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4947toStringimpl(int i) {
        return m4945equalsimpl0(i, Perceptual) ? "Perceptual" : m4945equalsimpl0(i, Relative) ? "Relative" : m4945equalsimpl0(i, Saturation) ? ExifInterface.TAG_SATURATION : m4945equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
