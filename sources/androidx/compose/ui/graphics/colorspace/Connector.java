...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m4922equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m4929getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m4922equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m4929getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m4939computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r9, androidx.compose.ui.graphics.colorspace.Rgb r10, int r11) {
            /*
                ...
                r8.mSource = r9
                r8.mDestination = r10
                float[] r9 = r8.m4940computeTransformYBCOT_4(r9, r10, r11)
                r8.mTransform = r9
                return
            */
        ...
        private final float[] m4940computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m4945equalsimpl0(intent, RenderIntent.INSTANCE.m4949getAbsoluteuksYyKA())) {
        ...
        public long mo4937transformToColorl2rxGTc$ui_graphics_release(long color) {
            float m4521getRedimpl = Color.m4521getRedimpl(color);
            float m4520getGreenimpl = Color.m4520getGreenimpl(color);
            float m4518getBlueimpl = Color.m4518getBlueimpl(color);
            float m4517getAlphaimpl = Color.m4517getAlphaimpl(color);
            float invoke = (float) this.mSource.getEotfFunc().invoke(m4521getRedimpl);
            float invoke2 = (float) this.mSource.getEotfFunc().invoke(m4520getGreenimpl);
            float invoke3 = (float) this.mSource.getEotfFunc().invoke(m4518getBlueimpl);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc().invoke((fArr[0] * invoke) + (fArr[3] * invoke2) + (fArr[6] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[1] * invoke) + (fArr[4] * invoke2) + (fArr[7] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[2] * invoke) + (fArr[5] * invoke2) + (fArr[8] * invoke3)), m4517getAlphaimpl, this.mDestination);
        }
    }

    /* compiled from: Connector.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0014\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J,\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tH\u0002ø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000bJ\u0015\u0010\f\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u0006H\u0000¢\u0006\u0002\b\u000e\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\u000f"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/Connector$Companion;", "", "()V", "computeTransform", "", "source", "Landroidx/compose/ui/graphics/colorspace/ColorSpace;", FirebaseAnalytics.Param.DESTINATION, "intent", "Landroidx/compose/ui/graphics/colorspace/RenderIntent;", "computeTransform-YBCOT_4", "(Landroidx/compose/ui/graphics/colorspace/ColorSpace;Landroidx/compose/ui/graphics/colorspace/ColorSpace;I)[F", "identity", "Landroidx/compose/ui/graphics/colorspace/Connector;", "identity$ui_graphics_release", "ui-graphics_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes8.dex */
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m4939computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m4945equalsimpl0(intent, RenderIntent.INSTANCE.m4949getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m4922equalsimpl0 = ColorModel.m4922equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4929getRgbxdoWZVw());
            boolean m4922equalsimpl02 = ColorModel.m4922equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4929getRgbxdoWZVw());
            if (m4922equalsimpl0 && m4922equalsimpl02) {
                return null;
            }
            if (!m4922equalsimpl0 && !m4922equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m4922equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m4922equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int m4951getRelativeuksYyKA = RenderIntent.INSTANCE.m4951getRelativeuksYyKA();
            return new Connector(source, m4951getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    return v;
                }
                ...
                {
                    super(source, source, m4951getRelativeuksYyKA, null);
                }
            };
        }
    }
    ...
    public long mo4937transformToColorl2rxGTc$ui_graphics_release(long color) {
        ...
        float m4518getBlueimpl = Color.m4518getBlueimpl(color);
        float m4517getAlphaimpl = Color.m4517getAlphaimpl(color);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(m4521getRedimpl, m4520getGreenimpl, m4518getBlueimpl);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(m4521getRedimpl, m4520getGreenimpl, m4518getBlueimpl);
        float[] fArr = this.transform;
        if (fArr != null) {
        ...
        return this.transformDestination.mo4932xyzaToColorJlNiLsg$ui_graphics_release(f, intBitsToFloat2, z$ui_graphics_release, m4517getAlphaimpl, this.destination);
    }
}
