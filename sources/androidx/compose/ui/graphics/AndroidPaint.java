...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4457getSrcOver0nO6VwU();
    }
    ...
    public long mo4388getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo4394setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4400setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo4393setBlendModes9anfk8(int i) {
        if (BlendMode.m4426equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m4399setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4392getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo4398setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4404setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo4390getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo4396setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4402setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4391getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo4397setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4403setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo4389getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo4395setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4401setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
