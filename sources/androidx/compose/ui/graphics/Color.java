...
public final class Color {
    ...
    public static final /* synthetic */ Color m4505boximpl(long j) {
        return new Color(j);
    }

    /* renamed from: constructor-impl */
    public static long m4511constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl */
    public static boolean m4515equalsimpl(long j, Object obj) {
        return (obj instanceof Color) && j == ((Color) obj).m4525unboximpl();
    }

    /* renamed from: equals-impl0 */
    public static final boolean m4516equalsimpl0(long j, long j2) {
        return ULong.m8455equalsimpl0(j, j2);
    }
    ...
    public static int m4522hashCodeimpl(long j) {
        return ULong.m8460hashCodeimpl(j);
    }
    ...
    public final /* synthetic */ long m4525unboximpl() {
        return this.value;
    }
    ...
    public static final ColorSpace m4519getColorSpaceimpl(long j) {
        ColorSpaces colorSpaces = ColorSpaces.INSTANCE;
        return colorSpaces.getColorSpacesArray$ui_graphics_release()[(int) ULong.m8448constructorimpl(j & 63)];
    }

    /* renamed from: convert-vNxB06k */
    public static final long m4512convertvNxB06k(long j, ColorSpace colorSpace) {
        return ColorSpaceKt.m4934connectYBCOT_4$default(m4519getColorSpaceimpl(j), colorSpace, 0, 2, null).mo4937transformToColorl2rxGTc$ui_graphics_release(j);
    }

    /* renamed from: getRed-impl */
    public static final float m4521getRedimpl(long j) {
        int i;
        int i2;
        int i3;
        if (ULong.m8448constructorimpl(63 & j) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 48) & 255))) / 255.0f;
        }
        short m8448constructorimpl = (short) ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 48) & 65535);
        int i4 = 32768 & m8448constructorimpl;
        int i5 = ((65535 & m8448constructorimpl) >>> 10) & 31;
        int i6 = m8448constructorimpl & 1023;
        if (i5 != 0) {
            int i7 = i6 << 13;
            if (i5 == 31) {
                i = 255;
    ...
    public static final float m4520getGreenimpl(long j) {
        int i;
        int i2;
        int i3;
        if (ULong.m8448constructorimpl(63 & j) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 40) & 255))) / 255.0f;
        }
        short m8448constructorimpl = (short) ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 32) & 65535);
        int i4 = 32768 & m8448constructorimpl;
        int i5 = ((65535 & m8448constructorimpl) >>> 10) & 31;
        int i6 = m8448constructorimpl & 1023;
        if (i5 != 0) {
    ...
    public static final float m4518getBlueimpl(long j) {
        int i;
        int i2;
        int i3;
        if (ULong.m8448constructorimpl(63 & j) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 32) & 255))) / 255.0f;
        }
        short m8448constructorimpl = (short) ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 16) & 65535);
        int i4 = 32768 & m8448constructorimpl;
        int i5 = ((65535 & m8448constructorimpl) >>> 10) & 31;
        int i6 = m8448constructorimpl & 1023;
        if (i5 != 0) {
    ...
    public static final float m4517getAlphaimpl(long j) {
        float ulongToDouble;
        float f;
        if (ULong.m8448constructorimpl(63 & j) == 0) {
            ulongToDouble = (float) UnsignedKt.ulongToDouble(ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 56) & 255));
            f = 255.0f;
        } else {
            ulongToDouble = (float) UnsignedKt.ulongToDouble(ULong.m8448constructorimpl(ULong.m8448constructorimpl(j >>> 6) & 1023));
            f = 1023.0f;
        }
    ...
    public static final float m4506component1impl(long j) {
        return m4521getRedimpl(j);
    }

    /* renamed from: component2-impl */
    public static final float m4507component2impl(long j) {
        return m4520getGreenimpl(j);
    }

    /* renamed from: component3-impl */
    public static final float m4508component3impl(long j) {
        return m4518getBlueimpl(j);
    }

    /* renamed from: component4-impl */
    public static final float m4509component4impl(long j) {
        return m4517getAlphaimpl(j);
    }

    /* renamed from: component5-impl */
    public static final ColorSpace m4510component5impl(long j) {
        return m4519getColorSpaceimpl(j);
    }

    /* renamed from: copy-wmQWz5c$default */
    public static /* synthetic */ long m4514copywmQWz5c$default(long j, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m4517getAlphaimpl(j);
        }
        float f5 = f;
        if ((i & 2) != 0) {
            f2 = m4521getRedimpl(j);
        }
        float f6 = f2;
        if ((i & 4) != 0) {
            f3 = m4520getGreenimpl(j);
        }
        float f7 = f3;
        if ((i & 8) != 0) {
            f4 = m4518getBlueimpl(j);
        }
        return m4513copywmQWz5c(j, f5, f6, f7, f4);
    }

    /* renamed from: copy-wmQWz5c */
    public static final long m4513copywmQWz5c(long j, float f, float f2, float f3, float f4) {
        return ColorKt.Color(f2, f3, f4, f, m4519getColorSpaceimpl(j));
    }
    ...
    public static String m4523toStringimpl(long j) {
        return "Color(" + m4521getRedimpl(j) + ", " + m4520getGreenimpl(j) + ", " + m4518getBlueimpl(j) + ", " + m4517getAlphaimpl(j) + ", " + m4519getColorSpaceimpl(j).getName() + ')';
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4526getBlack0d7_KjU$annotations() {
        }

        /* renamed from: getBlue-0d7_KjU$annotations */
        public static /* synthetic */ void m4527getBlue0d7_KjU$annotations() {
        }

        /* renamed from: getCyan-0d7_KjU$annotations */
        public static /* synthetic */ void m4528getCyan0d7_KjU$annotations() {
        }

        /* renamed from: getDarkGray-0d7_KjU$annotations */
        public static /* synthetic */ void m4529getDarkGray0d7_KjU$annotations() {
        }

        /* renamed from: getGray-0d7_KjU$annotations */
        public static /* synthetic */ void m4530getGray0d7_KjU$annotations() {
        }

        /* renamed from: getGreen-0d7_KjU$annotations */
        public static /* synthetic */ void m4531getGreen0d7_KjU$annotations() {
        }

        /* renamed from: getLightGray-0d7_KjU$annotations */
        public static /* synthetic */ void m4532getLightGray0d7_KjU$annotations() {
        }

        /* renamed from: getMagenta-0d7_KjU$annotations */
        public static /* synthetic */ void m4533getMagenta0d7_KjU$annotations() {
        }

        /* renamed from: getRed-0d7_KjU$annotations */
        public static /* synthetic */ void m4534getRed0d7_KjU$annotations() {
        }

        /* renamed from: getTransparent-0d7_KjU$annotations */
        public static /* synthetic */ void m4535getTransparent0d7_KjU$annotations() {
        }

        /* renamed from: getUnspecified-0d7_KjU$annotations */
        public static /* synthetic */ void m4536getUnspecified0d7_KjU$annotations() {
        }

        /* renamed from: getWhite-0d7_KjU$annotations */
        public static /* synthetic */ void m4537getWhite0d7_KjU$annotations() {
        }

        /* renamed from: getYellow-0d7_KjU$annotations */
        public static /* synthetic */ void m4538getYellow0d7_KjU$annotations() {
        }
        ...
        public final long m4544getDarkGray0d7_KjU() {
            return Color.DarkGray;
        }

        /* renamed from: getGray-0d7_KjU */
        public final long m4545getGray0d7_KjU() {
            return Color.Gray;
        }

        /* renamed from: getLightGray-0d7_KjU */
        public final long m4547getLightGray0d7_KjU() {
            return Color.LightGray;
        }

        /* renamed from: getWhite-0d7_KjU */
        public final long m4552getWhite0d7_KjU() {
            return Color.White;
        }

        /* renamed from: getRed-0d7_KjU */
        public final long m4549getRed0d7_KjU() {
            return Color.Red;
        }

        /* renamed from: getGreen-0d7_KjU */
        public final long m4546getGreen0d7_KjU() {
            return Color.Green;
        }

        /* renamed from: getBlue-0d7_KjU */
        public final long m4542getBlue0d7_KjU() {
            return Color.Blue;
        }

        /* renamed from: getYellow-0d7_KjU */
        public final long m4553getYellow0d7_KjU() {
            return Color.Yellow;
        }

        /* renamed from: getCyan-0d7_KjU */
        public final long m4543getCyan0d7_KjU() {
            return Color.Cyan;
        }

        /* renamed from: getMagenta-0d7_KjU */
        public final long m4548getMagenta0d7_KjU() {
            return Color.Magenta;
        }

        /* renamed from: getTransparent-0d7_KjU */
        public final long m4550getTransparent0d7_KjU() {
            return Color.Transparent;
        }

        /* renamed from: getUnspecified-0d7_KjU */
        public final long m4551getUnspecified0d7_KjU() {
            return Color.Unspecified;
        }

        /* renamed from: hsv-JlNiLsg$default */
        public static /* synthetic */ long m4540hsvJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            if ((i & 8) != 0) {
                f4 = 1.0f;
            }
            float f5 = f4;
            ...
            return companion.m4555hsvJlNiLsg(f, f2, f3, f5, rgb);
        }

        /* renamed from: hsv-JlNiLsg */
        public final long m4555hsvJlNiLsg(float hue, float saturation, float value, float alpha, Rgb colorSpace) {
        ...
        public static /* synthetic */ long m4539hslJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            if ((i & 8) != 0) {
                f4 = 1.0f;
            }
            float f5 = f4;
            ...
            return companion.m4554hslJlNiLsg(f, f2, f3, f5, rgb);
        }

        /* renamed from: hsl-JlNiLsg */
        public final long m4554hslJlNiLsg(float hue, float saturation, float lightness, float alpha, Rgb colorSpace) {
