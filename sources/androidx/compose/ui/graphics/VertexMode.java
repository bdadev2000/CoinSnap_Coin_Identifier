...
public final class VertexMode {
    ...
    private static final int Triangles = m4908constructorimpl(0);
    private static final int TriangleStrip = m4908constructorimpl(1);
    private static final int TriangleFan = m4908constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m4907boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4908constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4909equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4910equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4911hashCodeimpl(int i) {
    ...
    public static String m4912toStringimpl(int i) {
        return m4910equalsimpl0(i, Triangles) ? "Triangles" : m4910equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m4910equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
