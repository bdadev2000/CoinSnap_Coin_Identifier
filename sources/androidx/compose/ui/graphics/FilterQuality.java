...
public final class FilterQuality {
    ...
    private static final int None = m4608constructorimpl(0);
    private static final int Low = m4608constructorimpl(1);
    private static final int Medium = m4608constructorimpl(2);
    private static final int High = m4608constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4607boximpl(int i) {
        return new FilterQuality(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4608constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4609equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4613unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4617getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I, reason: not valid java name */
        public final int m4615getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I, reason: not valid java name */
        public final int m4616getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I, reason: not valid java name */
        public final int m4614getHighfv9h1I() {
    ...
    public static String m4612toStringimpl(int i) {
        return m4610equalsimpl0(i, None) ? "None" : m4610equalsimpl0(i, Low) ? "Low" : m4610equalsimpl0(i, Medium) ? "Medium" : m4610equalsimpl0(i, High) ? "High" : "Unknown";
    }
}
