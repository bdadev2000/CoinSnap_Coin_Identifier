...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m5234rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long m4551getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m4551getUnspecified0d7_KjU() : j;
        int m4455getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m4455getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m5235rememberVectorPaintervIP8VLU = m5235rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m4551getUnspecified0d7_KjU, m4455getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m5235rememberVectorPaintervIP8VLU;
    }
    ...
    */
    public static final androidx.compose.ui.graphics.vector.VectorPainter m5235rememberVectorPaintervIP8VLU(float r18, float r19, float r20, float r21, java.lang.String r22, long r23, int r25, boolean r26, kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, androidx.compose.runtime.Composer r28, int r29, int r30) {
        /*
            Method dump skipped, instructions count: 449
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.vector.VectorPainterKt.m5235rememberVectorPaintervIP8VLU(float, float, float, float, java.lang.String, long, int, boolean, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):androidx.compose.ui.graphics.vector.VectorPainter");
    }
    ...
    private static final long m5232obtainSizePxVpY3zN4(Density density, float f, float f2) {
        return SizeKt.Size(density.mo677toPx0680j_4(f), density.mo677toPx0680j_4(f2));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m5233obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
            f = Size.m4343getWidthimpl(j);
        }
        if (Float.isNaN(f2)) {
            f2 = Size.m4340getHeightimpl(j);
        }
        return SizeKt.Size(f, f2);
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m5231createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m4559tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m5229configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m5227setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m5228setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long m5232obtainSizePxVpY3zN4 = m5232obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m5229configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), m5232obtainSizePxVpY3zN4, m5233obtainViewportSizePq9zytI(m5232obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m5231createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m5213setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m5214setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m5215setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
