...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4868getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4879getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4455getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4550getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4798getNonZeroRgk1Os();
    ...
    public static final boolean m5223rgbEqualOWjLjI(long j, long j2) {
        return Color.m4521getRedimpl(j) == Color.m4521getRedimpl(j2) && Color.m4520getGreenimpl(j) == Color.m4520getGreenimpl(j2) && Color.m4518getBlueimpl(j) == Color.m4518getBlueimpl(j2);
    }

    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        if (colorFilter instanceof BlendModeColorFilter) {
            BlendModeColorFilter blendModeColorFilter = (BlendModeColorFilter) colorFilter;
            if (BlendMode.m4426equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4455getSrcIn0nO6VwU()) || BlendMode.m4426equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4457getSrcOver0nO6VwU())) {
                return true;
            }
