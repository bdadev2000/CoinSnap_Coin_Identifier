...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4331boximpl(Size.INSTANCE.m4352getZeroNHjbRc()), null, 2, null);
        this.viewportSize = mutableStateOf$default2;
        this.previousDrawSize = Size.INSTANCE.m4351getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long m4290getZeroF1C5BW0 = Offset.INSTANCE.m4290getZeroF1C5BW0();
                DrawContext drawContext = drawScope.getDrawContext();
                long mo4992getSizeNHjbRc = drawContext.mo4992getSizeNHjbRc();
                drawContext.getCanvas().save();
                try {
                    drawContext.getTransform().mo4999scale0AR0LA0(f, f2, m4290getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m5216getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo4382getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4736getArgb8888_sVssgQ();
    }
    ...
    public final long m5217getViewportSizeNHjbRc$ui_release() {
        return ((Size) this.viewportSize.getValue()).getPackedValue();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m5218setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m4331boximpl(j));
    }

    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        int m4736getArgb8888_sVssgQ;
        if (this.root.getIsTintable() && this.root.getTintColor() != 16 && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui_release()) && VectorKt.tintableWithAlphaMask(colorFilter)) {
            m4736getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4735getAlpha8_sVssgQ();
        } else {
            m4736getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4736getArgb8888_sVssgQ();
        }
        int i = m4736getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m4339equalsimpl0(this.previousDrawSize, drawScope.mo5071getSizeNHjbRc()) || !ImageBitmapConfig.m4731equalsimpl0(i, m5216getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m4731equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4735getAlpha8_sVssgQ()) ? ColorFilter.Companion.m4556tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Size.m4343getWidthimpl(drawScope.mo5071getSizeNHjbRc()) / Size.m4343getWidthimpl(m5217getViewportSizeNHjbRc$ui_release());
            this.rootScaleY = Size.m4340getHeightimpl(drawScope.mo5071getSizeNHjbRc()) / Size.m4340getHeightimpl(m5217getViewportSizeNHjbRc$ui_release());
            this.cacheDrawScope.m5199drawCachedImageFqjB98A(i, IntSizeKt.IntSize((int) Math.ceil(Size.m4343getWidthimpl(drawScope.mo5071getSizeNHjbRc())), (int) Math.ceil(Size.m4340getHeightimpl(drawScope.mo5071getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo5071getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        ...
        sb.append(Size.m4343getWidthimpl(m5217getViewportSizeNHjbRc$ui_release())).append("\n\tviewportHeight: ");
        sb.append(Size.m4340getHeightimpl(m5217getViewportSizeNHjbRc$ui_release())).append("\n");
