...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5240getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4868getButtKaPHkGw();
        }
        return m5239getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m5239getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4868getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4870getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4869getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m5242getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4879getMiterLxFBmk8();
        }
        return m5241getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m5241getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m4879getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m4878getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m4880getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        long m4551getUnspecified0d7_KjU;
        int m4455getSrcIn0nO6VwU;
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m4551getUnspecified0d7_KjU = Color.INSTANCE.m4551getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m4551getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m4551getUnspecified0d7_KjU = Color.INSTANCE.m4551getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m4551getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4455getSrcIn0nO6VwU();
        } else if (i == 3) {
            m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4457getSrcOver0nO6VwU();
        } else if (i == 5) {
            m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4455getSrcIn0nO6VwU();
        } else if (i == 9) {
            m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4454getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4446getModulate0nO6VwU();
                    break;
                case 15:
                    m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4451getScreen0nO6VwU();
                    break;
                case 16:
                    m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4449getPlus0nO6VwU();
                    break;
                default:
                    m4455getSrcIn0nO6VwU = BlendMode.INSTANCE.m4455getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m4455getSrcIn0nO6VwU;
        float m6997constructorimpl = Dp.m6997constructorimpl(dimension / resources.getDisplayMetrics().density);
        float m6997constructorimpl2 = Dp.m6997constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m6997constructorimpl, m6997constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m5239getStrokeLineCapCSYIeUk = m5239getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4868getButtKaPHkGw());
        int m5241getStrokeLineJoinkLtJ_vA = m5241getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m4878getBevelLxFBmk8());
        ...
        builder.m5207addPathoIyEayM(list, namedInt == 0 ? companion.m4798getNonZeroRgk1Os() : companion.m4797getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m5239getStrokeLineCapCSYIeUk, m5241getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
    ...
    public static final void parseGroup(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) {
        ...
        float namedFloat = androidVectorParser.getNamedFloat(obtainAttributes, Key.ROTATION, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_GROUP_ROTATION(), 0.0f);
