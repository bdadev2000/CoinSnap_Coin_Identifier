...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m7172getZeroYbymL2g();
        ...
        create.setClipToBounds(false);
        m5186applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5151getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m5151getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m4457getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m4541getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m4541getBlack0d7_KjU();
    ...
    public void mo5181setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m5186applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m5147equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5147equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5152getModulateAlphake2Ky5w())) {
    ...
    public void mo5180setBlendModes9anfk8(int i) {
        if (BlendMode.m4426equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        obtainLayerPaint().setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4367toPorterDuffModes9anfk8(i)));
        updateLayerProperties();
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m5147equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w()) && BlendMode.m4426equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4457getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5186applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w());
        } else {
            m5186applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo5183setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
        if (OffsetKt.m4295isUnspecifiedk4lQ0M(j)) {
            this.shouldManuallySetCenterPivot = true;
            this.renderNode.setPivotX(IntSize.m7167getWidthimpl(this.size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m7166getHeightimpl(this.size) / 2.0f);
        } else {
            this.shouldManuallySetCenterPivot = false;
            this.renderNode.setPivotX(Offset.m4274getXimpl(j));
            this.renderNode.setPivotY(Offset.m4275getYimpl(j));
        }
    }
    ...
    public void mo5179setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    public void mo5185setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    public void mo5184setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setLeftTopRightBottom(x, y, IntSize.m7167getWidthimpl(size) + x, IntSize.m7166getHeightimpl(size) + y);
        if (IntSize.m7165equalsimpl0(this.size, size)) {
            return;
        }
        if (this.shouldManuallySetCenterPivot) {
            this.renderNode.setPivotX(IntSize.m7167getWidthimpl(size) / 2.0f);
            this.renderNode.setPivotY(IntSize.m7166getHeightimpl(size) / 2.0f);
        }
        this.size = size;
    }
    ...
    public void mo5182setOutlineO0kMr_c(Outline outline, long outlineSize) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        Canvas start = this.renderNode.start(Math.max(IntSize.m7167getWidthimpl(this.size), IntSize.m7167getWidthimpl(this.outlineSize)), Math.max(IntSize.m7166getHeightimpl(this.size), IntSize.m7166getHeightimpl(this.outlineSize)));
        try {
            ...
            drawContext.mo4993setSizeuvyYCjk(m7179toSizeozmzZPI);
    ...
    /* compiled from: GraphicsLayerV23.android.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0005\u001a\u00020\u0006X\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Landroidx/compose/ui/graphics/layer/GraphicsLayerV23$Companion;", "", "()V", "needToValidateAccess", "Ljava/util/concurrent/atomic/AtomicBoolean;", "testFailCreateRenderNode", "", "getTestFailCreateRenderNode$ui_graphics_release", "()Z", "setTestFailCreateRenderNode$ui_graphics_release", "(Z)V", "ui-graphics_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes8.dex */
