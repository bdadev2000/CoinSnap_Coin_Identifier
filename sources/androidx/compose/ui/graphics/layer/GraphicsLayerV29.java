...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m4352getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m5187applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m5151getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5180setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m4366toAndroidBlendModes9anfk8(i));
    ...
    public void mo5179setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    public void mo5185setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    private final void m5187applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m5147equalsimpl0(i, CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5147equalsimpl0(i, CompositingStrategy.INSTANCE.m5152getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5187applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w());
        } else {
            m5187applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo5184setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m7167getWidthimpl(size) + x, IntSize.m7166getHeightimpl(size) + y);
        this.size = IntSizeKt.m7179toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo4993setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5147equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
