...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4290getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m5188applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5188applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w());
        } else {
            m5188applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5147equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5153getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4426equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4457getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo5183setPivotOffsetk4lQ0M(long j) {
        ...
        this.viewLayer.setPivotX(Offset.m4274getXimpl(j));
        this.viewLayer.setPivotY(Offset.m4275getYimpl(j));
    }
    ...
    public void mo5179setAmbientShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    public void mo5185setSpotShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4569toArgb8_81llA(j));
    }
    ...
    public void mo5184setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m7165equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m7167getWidthimpl(size) + x, IntSize.m7166getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m7167getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m7166getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas beginRecording = picture.beginRecording(IntSize.m7167getWidthimpl(this.size), IntSize.m7166getHeightimpl(this.size));
                try {
                    ...
                    if (canvasHolder2 != null) {
                        ...
                        if (canvasDrawScope != null) {
                            ...
                            drawParams2.m4991setSizeuvyYCjk(m7179toSizeozmzZPI);
                            androidCanvas.save();
    ...
    /* compiled from: GraphicsViewLayer.android.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Landroidx/compose/ui/graphics/layer/GraphicsViewLayer$Companion;", "", "()V", "PlaceholderCanvas", "Landroid/graphics/Canvas;", "getPlaceholderCanvas", "()Landroid/graphics/Canvas;", "mayRenderInSoftware", "", "getMayRenderInSoftware", "()Z", "ui-graphics_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes8.dex */
