...
public final class AndroidPath implements Path {
    ...
    public int mo4406getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4797getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4798getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4408setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4793equalsimpl0(i, PathFillType.INSTANCE.m4797getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = CornerRadius.m4249getXimpl(roundRect.m4324getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m4250getYimpl(roundRect.m4324getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m4249getXimpl(roundRect.m4325getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m4250getYimpl(roundRect.m4325getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m4249getXimpl(roundRect.m4323getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m4250getYimpl(roundRect.m4323getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m4249getXimpl(roundRect.m4322getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m4250getYimpl(roundRect.m4322getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo4405addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m4274getXimpl(offset), Offset.m4275getYimpl(offset));
            return;
        }
    ...
    public void mo4410translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m4274getXimpl(offset), Offset.m4275getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo4409transform58bKbWc(float[] matrix) {
    ...
    public boolean mo4407opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4803equalsimpl0(operation, PathOperation.INSTANCE.m4807getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4803equalsimpl0(operation, PathOperation.INSTANCE.m4808getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4803equalsimpl0(operation, PathOperation.INSTANCE.m4809getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4803equalsimpl0(operation, PathOperation.INSTANCE.m4810getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
