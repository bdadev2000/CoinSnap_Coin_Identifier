...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m4729constructorimpl(0);
    private static final int Alpha8 = m4729constructorimpl(1);
    private static final int Rgb565 = m4729constructorimpl(2);
    private static final int F16 = m4729constructorimpl(3);
    private static final int Gpu = m4729constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m4728boximpl(int i) {
    ...
    public static boolean m4730equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m4734unboximpl();
    }
    ...
    public final /* synthetic */ int m4734unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m4736getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ, reason: not valid java name */
        public final int m4735getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ, reason: not valid java name */
        public final int m4739getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ, reason: not valid java name */
        public final int m4737getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ, reason: not valid java name */
        public final int m4738getGpu_sVssgQ() {
    ...
    public static String m4733toStringimpl(int i) {
        return m4731equalsimpl0(i, Argb8888) ? "Argb8888" : m4731equalsimpl0(i, Alpha8) ? "Alpha8" : m4731equalsimpl0(i, Rgb565) ? "Rgb565" : m4731equalsimpl0(i, F16) ? "F16" : m4731equalsimpl0(i, Gpu) ? "Gpu" : "Unknown";
    }
}
