...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4604getAutoNrFUSI();
    private long size = Size.INSTANCE.m4351getUnspecifiedNHjbRc();
    ...
    public void mo4705setAmbientShadowColor8_81llA(long j) {
        if (Color.m4516equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo4707setSpotShadowColor8_81llA(long j) {
        if (Color.m4516equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo4708setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m4900equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo4706setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4600equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m4827setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo4705setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4707setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4708setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4906getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo4706setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4604getAutoNrFUSI());
        m4827setSizeuvyYCjk(Size.INSTANCE.m4351getUnspecifiedNHjbRc());
        this.outline = null;
