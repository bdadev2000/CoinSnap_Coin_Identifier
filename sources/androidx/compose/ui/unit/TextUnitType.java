...
public final class TextUnitType {
    ...
    private static final long Unspecified = m7216constructorimpl(0);
    private static final long Sp = m7216constructorimpl(4294967296L);
    private static final long Em = m7216constructorimpl(8589934592L);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextUnitType m7215boximpl(long j) {
    ...
    public static boolean m7217equalsimpl(long j, Object obj) {
        return (obj instanceof TextUnitType) && j == ((TextUnitType) obj).getType();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7218equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m7219hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m7217equalsimpl(this.type, obj);
    }

    public int hashCode() {
        return m7219hashCodeimpl(this.type);
    }
    ...
    public String toString() {
        return m7220toStringimpl(this.type);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m7220toStringimpl(long j) {
        return m7218equalsimpl0(j, Unspecified) ? "Unspecified" : m7218equalsimpl0(j, Sp) ? "Sp" : m7218equalsimpl0(j, Em) ? "Em" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final long m7224getUnspecifiedUIouoOA() {
            return TextUnitType.Unspecified;
        }

        /* renamed from: getSp-UIouoOA, reason: not valid java name */
        public final long m7223getSpUIouoOA() {
            return TextUnitType.Sp;
        }

        /* renamed from: getEm-UIouoOA, reason: not valid java name */
        public final long m7222getEmUIouoOA() {
