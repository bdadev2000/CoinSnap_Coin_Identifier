...
public interface FontScalingLinear {
    ...
    public static final class DefaultImpls {
        ...
        public static long m7115toSp0xMU5do(FontScalingLinear fontScalingLinear, float f) {
            return FontScalingLinear.super.m7113toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m7114toDpGaN1DYA(FontScalingLinear fontScalingLinear, long j) {
            return FontScalingLinear.super.m7112toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do, reason: not valid java name */
    default long m7113toSp0xMU5do(float f) {
        return TextUnitKt.getSp(f / getFontScale());
    }

    /* renamed from: toDp-GaN1DYA, reason: not valid java name */
    default float m7112toDpGaN1DYA(long j) {
        if (!TextUnitType.m7218equalsimpl0(TextUnit.m7189getTypeUIouoOA(j), TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
            throw new IllegalStateException("Only Sp can convert to Px".toString());
        }
        return Dp.m6997constructorimpl(TextUnit.m7190getValueimpl(j) * getFontScale());
    }
}
