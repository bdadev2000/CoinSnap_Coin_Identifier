...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m7143getSizeYbymL2g$annotations() {
    }
    ...
    public final long m7151getSizeYbymL2g() {
    ...
    public final IntRect m7155translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m7125getXimpl(offset), this.top + IntOffset.m7126getYimpl(offset), this.right + IntOffset.m7125getXimpl(offset), this.bottom + IntOffset.m7126getYimpl(offset));
    }
