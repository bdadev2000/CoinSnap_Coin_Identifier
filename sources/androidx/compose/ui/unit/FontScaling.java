...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m7109toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.mo679toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m7108toDpGaN1DYA(FontScaling fontScaling, long j) {
    ...
    default float mo672toDpGaN1DYA(long j) {
        ...
        FontScaleConverter forScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        float m7190getValueimpl = TextUnit.m7190getValueimpl(j);
        return Dp.m6997constructorimpl(forScale == null ? m7190getValueimpl * getFontScale() : forScale.convertSpToDp(m7190getValueimpl));
    }
}
