...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4226customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4195getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4193getEnterdhqQ8s())) {
                return fetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m4183boximpl(i));
            }
            if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4194getExitdhqQ8s())) {
                return fetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m4183boximpl(i));
            }
    ...
    public static final Boolean m4227focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int m4198getRightdhqQ8s;
        if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4196getNextdhqQ8s()) || FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4197getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m4230oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4195getLeftdhqQ8s()) || FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4198getRightdhqQ8s()) || FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4199getUpdhqQ8s()) || FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4192getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m4239twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4193getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m4198getRightdhqQ8s = FocusDirection.INSTANCE.m4198getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                m4198getRightdhqQ8s = FocusDirection.INSTANCE.m4195getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (findActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m4239twoDimensionalFocusSearchsMXa3k8(findActiveFocusNode, m4198getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m4186equalsimpl0(i, FocusDirection.INSTANCE.m4194getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m4188toStringimpl(i))).toString());
    }
