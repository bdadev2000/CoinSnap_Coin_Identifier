...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    private TargetState<T> state = new TargetState<>(getAnimation().m6921getAnimationObject().getCurrentState(), getAnimation().m6921getAnimationObject().getTargetState());
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        List<Transition<?>.TransitionAnimationState<?, ?>> allAnimations = Utils_androidKt.allAnimations(getAnimation().m6921getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return Utils_androidKt.nanosToMillis(getAnimation().m6921getAnimationObject().getTotalDurationNanos());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m6921getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
