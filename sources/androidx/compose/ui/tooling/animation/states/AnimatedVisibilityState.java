...
public final class AnimatedVisibilityState implements ComposeAnimationState {
    ...
    private static final String Enter = m6930constructorimpl("Enter");
    private static final String Exit = m6930constructorimpl("Exit");
    private final String value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AnimatedVisibilityState m6929boximpl(String str) {
        return new AnimatedVisibilityState(str);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static String m6930constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6931equalsimpl(String str, Object obj) {
        return (obj instanceof AnimatedVisibilityState) && Intrinsics.areEqual(str, ((AnimatedVisibilityState) obj).m6935unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6932equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6933hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6934toStringimpl(String str) {
        return str;
    }

    public boolean equals(Object obj) {
        return m6931equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m6933hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ String m6935unboximpl() {
        return this.value;
    }
    ...
    public String toString() {
        return m6934toStringimpl(this.value);
    }
