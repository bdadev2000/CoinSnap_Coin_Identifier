...
public final /* data */ class ViewInfo {
    ...
    public ViewInfo(String str, int i, IntRect intRect, SourceLocation sourceLocation, List<ViewInfo> list, Object obj) {
        this.fileName = str;
        this.lineNumber = i;
        this.bounds = intRect;
    ...
    public String toString() {
        String str;
        StringBuilder append = new StringBuilder("(").append(this.fileName).append(':').append(this.lineNumber).append(",\n            |bounds=(top=").append(this.bounds.getTop()).append(", left=").append(this.bounds.getLeft()).append(",\n            |location=");
        SourceLocation sourceLocation = this.location;
