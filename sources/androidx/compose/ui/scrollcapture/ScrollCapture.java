...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long m7153getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m7153getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(boundsInRoot)), new Point(IntOffset.m7125getXimpl(m7153getTopLeftnOccac), IntOffset.m7126getYimpl(m7153getTopLeftnOccac)), composeScrollCaptureCallback);
