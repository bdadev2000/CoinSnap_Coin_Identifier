...
public final class Placeholder {
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m7208isUnspecifiedR2X_6o(j))) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (!(!TextUnitKt.m7208isUnspecifiedR2X_6o(j2))) {
    ...
    public static /* synthetic */ Placeholder m6370copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m6371copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m6371copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m7187equalsimpl0(this.width, placeholder.width) && TextUnit.m7187equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m6378equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m7191hashCodeimpl(this.width) * 31) + TextUnit.m7191hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m6379hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m7197toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m7197toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m6380toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
