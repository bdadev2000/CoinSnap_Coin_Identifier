...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6524getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m6570equalsimpl0(i, FontStyle.INSTANCE.m6576getItalic_LCdwA()));
    }
}
