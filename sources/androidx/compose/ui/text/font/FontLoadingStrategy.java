...
public final class FontLoadingStrategy {
    ...
    private static final int Blocking = m6555constructorimpl(0);
    private static final int OptionalLocal = m6555constructorimpl(1);
    private static final int Async = m6555constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontLoadingStrategy m6554boximpl(int i) {
        return new FontLoadingStrategy(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m6555constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6556equalsimpl(int i, Object obj) {
        return (obj instanceof FontLoadingStrategy) && i == ((FontLoadingStrategy) obj).m6560unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6557equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6558hashCodeimpl(int i) {
    ...
    public final /* synthetic */ int m6560unboximpl() {
        return this.value;
    }
    ...
    public String toString() {
        return m6559toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6559toStringimpl(int i) {
        return m6557equalsimpl0(i, Blocking) ? "Blocking" : m6557equalsimpl0(i, OptionalLocal) ? "Optional" : m6557equalsimpl0(i, Async) ? "Async" : "Invalid(value=" + i + ')';
    }
    ...
    public static final class Companion {
        ...
        public final int m6562getBlockingPKNRLFQ() {
            return FontLoadingStrategy.Blocking;
        }

        /* renamed from: getOptionalLocal-PKNRLFQ, reason: not valid java name */
        public final int m6563getOptionalLocalPKNRLFQ() {
            return FontLoadingStrategy.OptionalLocal;
        }

        /* renamed from: getAsync-PKNRLFQ, reason: not valid java name */
        public final int m6561getAsyncPKNRLFQ() {
