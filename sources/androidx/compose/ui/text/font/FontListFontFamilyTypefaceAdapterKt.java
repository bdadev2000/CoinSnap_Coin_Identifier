    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!FontLoadingStrategy.m6557equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6562getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m6557equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6563getOptionalLocalPKNRLFQ())) {
                    if (FontLoadingStrategy.m6557equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6561getAsyncPKNRLFQ())) {
                        AsyncTypefaceCache.AsyncTypefaceResult m6526get1ASDuI8 = asyncTypefaceCache.m6526get1ASDuI8(font, platformFontLoader);
                        if (m6526get1ASDuI8 == null) {
                            if (list2 == null) {
                                list2 = CollectionsKt.mutableListOf(font);
                            } else {
                                list2.add(font);
                            }
                        } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m6532isPermanentFailureimpl(m6526get1ASDuI8.m6534unboximpl()) && m6526get1ASDuI8.m6534unboximpl() != null) {
                            return TuplesKt.to(list2, FontSynthesis_androidKt.m6591synthesizeTypefaceFxwP2eA(typefaceRequest.m6616getFontSynthesisGVVA2EU(), m6526get1ASDuI8.m6534unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m6615getFontStyle_LCdwA()));
                        }
                    } else {
                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            m8274constructorimpl = asyncTypefaceResult.m6534unboximpl();
                        } else {
                            Unit unit = Unit.INSTANCE;
                            try {
                                Result.Companion companion = Result.INSTANCE;
                                m8274constructorimpl = Result.m8274constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                m8274constructorimpl = Result.m8274constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m8280isFailureimpl(m8274constructorimpl)) {
                                m8274constructorimpl = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, m8274constructorimpl, false, 8, null);
                        }
                    }
                    if (m8274constructorimpl != null) {
                        return TuplesKt.to(list2, FontSynthesis_androidKt.m6591synthesizeTypefaceFxwP2eA(typefaceRequest.m6616getFontSynthesisGVVA2EU(), m8274constructorimpl, font, typefaceRequest.getFontWeight(), typefaceRequest.m6615getFontStyle_LCdwA()));
                    }
                }
            } else {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult2 != null) {
                        loadBlocking = asyncTypefaceResult2.m6534unboximpl();
                    } else {
                ...
                return TuplesKt.to(list2, FontSynthesis_androidKt.m6591synthesizeTypefaceFxwP2eA(typefaceRequest.m6616getFontSynthesisGVVA2EU(), loadBlocking, font, typefaceRequest.getFontWeight(), typefaceRequest.m6615getFontStyle_LCdwA()));
            }
        }
