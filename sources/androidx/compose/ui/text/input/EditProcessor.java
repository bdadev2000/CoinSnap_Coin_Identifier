...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m6465getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m6619getCompositionMzsxiRA$ui_text_release());
        boolean z3 = false;
        ...
        } else if (TextRange.m6453equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m6458getMinimpl(value.getSelection()), TextRange.m6457getMaximpl(value.getSelection()));
            z3 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m6454getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m6458getMinimpl(value.getComposition().getPackedValue()), TextRange.m6457getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z3 && z2)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m6702copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder append = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m6619getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m6463toStringimpl(this.mBuffer.m6620getSelectiond9O1mEE$ui_text_release())) + "):");
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long m6620getSelectiond9O1mEE$ui_text_release = this.mBuffer.m6620getSelectiond9O1mEE$ui_text_release();
            TextRange m6448boximpl = TextRange.m6448boximpl(m6620getSelectiond9O1mEE$ui_text_release);
            m6448boximpl.getPackedValue();
            TextRange textRange = TextRange.m6459getReversedimpl(this.mBufferState.getSelection()) ? null : m6448boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text_release, textRange != null ? textRange.getPackedValue() : TextRangeKt.TextRange(TextRange.m6457getMaximpl(m6620getSelectiond9O1mEE$ui_text_release), TextRange.m6458getMinimpl(m6620getSelectiond9O1mEE$ui_text_release)), this.mBuffer.m6619getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
