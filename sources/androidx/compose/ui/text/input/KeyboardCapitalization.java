...
public final class KeyboardCapitalization {
    ...
    private static final int Unspecified = m6659constructorimpl(-1);
    private static final int None = m6659constructorimpl(0);
    private static final int Characters = m6659constructorimpl(1);
    private static final int Words = m6659constructorimpl(2);
    private static final int Sentences = m6659constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m6658boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m6659constructorimpl(int i) {
        return i;
    }
    ...
    public String toString() {
        return m6663toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6663toStringimpl(int i) {
        return m6661equalsimpl0(i, Unspecified) ? "Unspecified" : m6661equalsimpl0(i, None) ? "None" : m6661equalsimpl0(i, Characters) ? "Characters" : m6661equalsimpl0(i, Words) ? "Words" : m6661equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6665getCharactersIUNYP9k$annotations() {
        }

        /* renamed from: getNone-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m6666getNoneIUNYP9k$annotations() {
        }

        /* renamed from: getSentences-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m6667getSentencesIUNYP9k$annotations() {
        }

        /* renamed from: getUnspecified-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m6668getUnspecifiedIUNYP9k$annotations() {
        }

        /* renamed from: getWords-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m6669getWordsIUNYP9k$annotations() {
        }
        ...
        public final int m6673getUnspecifiedIUNYP9k() {
            return KeyboardCapitalization.Unspecified;
        }

        /* renamed from: getNone-IUNYP9k, reason: not valid java name */
        public final int m6671getNoneIUNYP9k() {
            return KeyboardCapitalization.None;
        }

        /* renamed from: getCharacters-IUNYP9k, reason: not valid java name */
        public final int m6670getCharactersIUNYP9k() {
            return KeyboardCapitalization.Characters;
        }

        /* renamed from: getWords-IUNYP9k, reason: not valid java name */
        public final int m6674getWordsIUNYP9k() {
            return KeyboardCapitalization.Words;
        }

        /* renamed from: getSentences-IUNYP9k, reason: not valid java name */
        public final int m6672getSentencesIUNYP9k() {
