...
public final /* data */ class ParagraphInfo {
    ...
    public final long m6341toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m4274getXimpl(j), Offset.m4275getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m4311translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo4410translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6339toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6340toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6340toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m6453equalsimpl0(j, TextRange.INSTANCE.m6465getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6465getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6460getStartimpl(j)), toGlobalIndex(TextRange.m6455getEndimpl(j)));
    }
}
