...
public final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6763copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m6765copy8_81llA(j);
    }
    ...
    public final ColorStyle m6765copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m4516equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m4523toStringimpl(this.value)) + ')';
    }
    ...
    public final long m6766getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m4517getAlphaimpl(mo6762getColor0d7_KjU());
    }
}
