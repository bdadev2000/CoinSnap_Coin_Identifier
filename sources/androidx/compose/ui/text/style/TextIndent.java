...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m6886copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m6887copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m6887copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m7187equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m7187equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m7191hashCodeimpl(this.firstLine) * 31) + TextUnit.m7191hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m7197toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m7197toStringimpl(this.restLine)) + ')';
    }
}
