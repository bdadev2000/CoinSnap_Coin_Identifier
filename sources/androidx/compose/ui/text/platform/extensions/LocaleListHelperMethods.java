...
public final class LocaleListHelperMethods {
    ...
    public static final LocaleListHelperMethods f17439a = new Object();
    ...
    @DoNotInline
    @RequiresApi
    public final void b(@NotNull AndroidTextPaint androidTextPaint, @NotNull LocaleList localeList) {
        ArrayList arrayList = new ArrayList(q.M(localeList, 10));
        Iterator<Locale> it = localeList.iterator();
        while (it.hasNext()) {
            arrayList.add(it.next().f17400a);
