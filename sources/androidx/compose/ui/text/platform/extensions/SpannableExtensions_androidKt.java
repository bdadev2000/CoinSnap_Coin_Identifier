...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m7190getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m7187equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m7187equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m7208isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m7208isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long m7189getTypeUIouoOA = TextUnit.m7189getTypeUIouoOA(textIndent.getFirstLine());
            float f2 = 0.0f;
            if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
                m7190getValueimpl = density.mo676toPxR2X_6o(textIndent.getFirstLine());
            } else {
                m7190getValueimpl = TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7222getEmUIouoOA()) ? TextUnit.m7190getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long m7189getTypeUIouoOA2 = TextUnit.m7189getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA2, TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
                f2 = density.mo676toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA2, TextUnitType.INSTANCE.m7222getEmUIouoOA())) {
                f2 = TextUnit.m7190getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m7190getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m6741setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float m6736resolveLineHeightInPxo2QH7mI = m6736resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m6736resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(m6736resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m6849isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m6850isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m6742setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float m6736resolveLineHeightInPxo2QH7mI = m6736resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m6736resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(m6736resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m6736resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float m7190getValueimpl;
        long m7189getTypeUIouoOA = TextUnit.m7189getTypeUIouoOA(j);
        if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo676toPxR2X_6o(j);
            }
            m7190getValueimpl = TextUnit.m7190getValueimpl(j) / TextUnit.m7190getValueimpl(density.mo680toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7222getEmUIouoOA())) {
                return Float.NaN;
            }
            m7190getValueimpl = TextUnit.m7190getValueimpl(j);
        }
        return m7190getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan m6735createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m6735createLetterSpacingSpaneAf_CNQ = m6735createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, m6735createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m6738setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m6739setColorRPmYEkk(spannable, item.m6410getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m6740setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m6737setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m6735createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m7189getTypeUIouoOA = TextUnit.m7189getTypeUIouoOA(j);
        if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo676toPxR2X_6o(j));
        }
        if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7222getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m7190getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m7218equalsimpl0(TextUnit.m7189getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7223getSpUIouoOA()) || TextUnitType.m7218equalsimpl0(TextUnit.m7189getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m7222getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m4569toArgb8_81llA(shadow.getColor()), Offset.m4274getXimpl(shadow.getOffset()), Offset.m4275getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m6737setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m4569toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m6740setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long m7189getTypeUIouoOA = TextUnit.m7189getTypeUIouoOA(j);
        if (TextUnitType.m7218equalsimpl0(m7189getTypeUIouoOA, TextUnitType.INSTANCE.m7223getSpUIouoOA())) {
            ...
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m7190getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m6739setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m4569toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m6738setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m6754unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m6739setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m6493getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m6492getFontStyle4Lr2A7w(), textStyle.m6493getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m6567boximpl, FontSynthesis.m6578boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6587getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }
}
