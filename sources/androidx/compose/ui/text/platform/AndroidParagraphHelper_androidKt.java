...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (z && EmojiCompat.isConfigured()) {
            ...
            EmojiSupportMatch m6312boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m6312boximpl(paragraphStyle.getEmojiSupportMatch());
            str2 = EmojiCompat.get().process(str, 0, str.length(), Integer.MAX_VALUE, m6312boximpl == null ? 0 : EmojiSupportMatch.m6315equalsimpl0(m6312boximpl.getValue(), EmojiSupportMatch.INSTANCE.m6319getAll_3YsG6Y()));
            Intrinsics.checkNotNull(str2);
        } else {
            str2 = str;
        }
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m7208isUnspecifiedR2X_6o(textStyle.m6499getLineHeightXSAIIZE())) {
            return str2;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m6742setLineHeightr9BaKPg(spannableString, textStyle.m6499getLineHeightXSAIIZE(), f, density);
        } else {
            LineHeightStyle lineHeightStyle = textStyle.getLineHeightStyle();
            if (lineHeightStyle == null) {
                lineHeightStyle = LineHeightStyle.INSTANCE.getDefault();
            }
            SpannableExtensions_androidKt.m6741setLineHeightKmRG4DE(spannableString, textStyle.m6499getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
