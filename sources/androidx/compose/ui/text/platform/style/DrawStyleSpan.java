...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m6745toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m6744toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m6745toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m4874equalsimpl0(i, StrokeJoin.INSTANCE.m4879getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m4874equalsimpl0(i, StrokeJoin.INSTANCE.m4880getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m4874equalsimpl0(i, StrokeJoin.INSTANCE.m4878getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m6744toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m4864equalsimpl0(i, StrokeCap.INSTANCE.m4868getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m4864equalsimpl0(i, StrokeCap.INSTANCE.m4869getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m4864equalsimpl0(i, StrokeCap.INSTANCE.m4870getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
