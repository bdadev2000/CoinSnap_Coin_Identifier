...
public final class AndroidFontListTypeface implements AndroidTypeface {
    ...
    */
    ...
    public Typeface mo6712getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        Font font = (Font) CollectionsKt.firstOrNull((List) this.fontMatcher.m6566matchFontRetOiIg(new ArrayList(this.loadedTypefaces.keySet()), fontWeight, fontStyle));
        if (font == null) {
        ...
        Object m6591synthesizeTypefaceFxwP2eA = FontSynthesis_androidKt.m6591synthesizeTypefaceFxwP2eA(synthesis, typeface, font, fontWeight, fontStyle);
        Intrinsics.checkNotNull(m6591synthesizeTypefaceFxwP2eA, "null cannot be cast to non-null type android.graphics.Typeface");
        return (Typeface) m6591synthesizeTypefaceFxwP2eA;
    }
}
