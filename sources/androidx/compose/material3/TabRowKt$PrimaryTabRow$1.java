...
final class TabRowKt$PrimaryTabRow$1 extends r implements q {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f11832a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TabRowKt$PrimaryTabRow$1(int i2) {
        super(3);
        this.f11832a = i2;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if ((intValue & 19) == 18 && composer.i()) {
            ...
            TabRowDefaults.f11797a.a(Float.NaN, 0.0f, 196656, 28, 0L, composer, tabIndicatorScope.a(this.f11832a, true), null);
        }
        return b0.f30125a;
    }
}
