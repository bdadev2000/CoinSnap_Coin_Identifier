...
public class FloatingActionButtonElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(InteractionSource interactionSource, Composer composer, int i) {
        ...
        State<Dp> animateElevation = animateElevation(interactionSource, composer, (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 14));
        if (ComposerKt.isTraceInProgress()) {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        boolean changedInstance = composer.changedInstance(floatingActionButtonElevationAnimatable) | ((((i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) ^ 48) > 32 && composer.changed(this)) || (i & 48) == 32);
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m7002equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m7002equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m7002equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m7002equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m7003hashCodeimpl(this.defaultElevation) * 31) + Dp.m7003hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7003hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7003hashCodeimpl(this.hoveredElevation);
    }
}
