...
public final class NavigationBarItemColors {
    ...
    public final long m2586getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationBarItemColors m2581copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2590iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2591textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m4516equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m4516equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m4516equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m4516equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m4516equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m4516equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
