...
public final class ButtonDefaults {
    ...
    public final float m2139getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m2138getMinHeightD9Ej5fM() {
        return MinHeight;
    }
    ...
    public final float m2137getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m2130buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m2125copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2125copyjRlVdoo(m4551getUnspecified0d7_KjU, m4551getUnspecified0d7_KjU2, m4551getUnspecified0d7_KjU3, m4551getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors m2132elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m2125copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2125copyjRlVdoo(m4551getUnspecified0d7_KjU, m4551getUnspecified0d7_KjU2, m4551getUnspecified0d7_KjU3, m4551getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getLabelTextColor()), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledContainerColor()), ElevatedButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor()), ElevatedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m2134filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m2125copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2125copyjRlVdoo(m4551getUnspecified0d7_KjU, m4551getUnspecified0d7_KjU2, m4551getUnspecified0d7_KjU3, m4551getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getLabelTextColor()), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m2140outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m2125copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2125copyjRlVdoo(m4551getUnspecified0d7_KjU, m4551getUnspecified0d7_KjU2, m4551getUnspecified0d7_KjU3, m4551getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4550getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4550getTransparent0d7_KjU(), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m2141textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m2125copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2125copyjRlVdoo(m4551getUnspecified0d7_KjU, m4551getUnspecified0d7_KjU2, m4551getUnspecified0d7_KjU3, m4551getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4550getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4550getTransparent0d7_KjU(), Color.m4514copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        colorScheme.setDefaultTextButtonColorsCached$material3_release(buttonColors);
        return buttonColors;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m2131buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m3561getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m3561getContainerElevationD9Ej5fM() : f;
        float m3567getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m3567getPressedContainerElevationD9Ej5fM() : f2;
        float m3564getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m3564getFocusContainerElevationD9Ej5fM() : f3;
        float m3565getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m3565getHoverContainerElevationD9Ej5fM() : f4;
        float m3563getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m3563getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:802)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(m3561getContainerElevationD9Ej5fM, m3567getPressedContainerElevationD9Ej5fM, m3564getFocusContainerElevationD9Ej5fM, m3565getHoverContainerElevationD9Ej5fM, m3563getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonElevation m2133elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m3480getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m3480getContainerElevationD9Ej5fM() : f;
        float m3486getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m3486getPressedContainerElevationD9Ej5fM() : f2;
        float m3483getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m3483getFocusContainerElevationD9Ej5fM() : f3;
        float m3484getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m3484getHoverContainerElevationD9Ej5fM() : f4;
        float m3482getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m3482getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m3480getContainerElevationD9Ej5fM, m3486getPressedContainerElevationD9Ej5fM, m3483getFocusContainerElevationD9Ej5fM, m3484getHoverContainerElevationD9Ej5fM, m3482getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonElevation m2135filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float m3584getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m3584getContainerElevationD9Ej5fM() : f;
        float m3590getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m3590getPressedContainerElevationD9Ej5fM() : f2;
        float m3587getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m3587getFocusContainerElevationD9Ej5fM() : f3;
        float m3588getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m3588getHoverContainerElevationD9Ej5fM() : f4;
        float m6997constructorimpl = (i2 & 16) != 0 ? Dp.m6997constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(m3584getContainerElevationD9Ej5fM, m3590getPressedContainerElevationD9Ej5fM, m3587getFocusContainerElevationD9Ej5fM, m3588getHoverContainerElevationD9Ej5fM, m6997constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m567BorderStrokecXLIe8U = BorderStrokeKt.m567BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3666getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke outlinedButtonBorder(boolean z, Composer composer, int i, int i2) {
        ...
        float m3666getOutlineWidthD9Ej5fM = OutlinedButtonTokens.INSTANCE.m3666getOutlineWidthD9Ej5fM();
        if (z) {
            composer.startReplaceGroup(-855870548);
            ComposerKt.sourceInformation(composer, "893@41926L5");
            m4514copywmQWz5c$default = ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-855783004);
            ComposerKt.sourceInformation(composer, "895@42011L5");
            m4514copywmQWz5c$default = Color.m4514copywmQWz5c$default(ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        BorderStroke m567BorderStrokecXLIe8U = BorderStrokeKt.m567BorderStrokecXLIe8U(m3666getOutlineWidthD9Ej5fM, m4514copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        float m6997constructorimpl = Dp.m6997constructorimpl(24);
        ...
        float f2 = 16;
        float m6997constructorimpl3 = Dp.m6997constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = m6997constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m981PaddingValuesa9UjIt4(m6997constructorimpl3, m6997constructorimpl2, m6997constructorimpl, m6997constructorimpl2);
        float m6997constructorimpl4 = Dp.m6997constructorimpl(12);
        TextButtonHorizontalPadding = m6997constructorimpl4;
        TextButtonContentPadding = PaddingKt.m981PaddingValuesa9UjIt4(m6997constructorimpl4, m981PaddingValuesa9UjIt4.getTop(), m6997constructorimpl4, m981PaddingValuesa9UjIt4.getBottom());
        float m6997constructorimpl5 = Dp.m6997constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = m6997constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m981PaddingValuesa9UjIt4(m6997constructorimpl4, m981PaddingValuesa9UjIt4.getTop(), m6997constructorimpl5, m981PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m6997constructorimpl(58);
        MinHeight = Dp.m6997constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m3566getIconSizeD9Ej5fM();
