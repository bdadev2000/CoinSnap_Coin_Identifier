...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m6997constructorimpl(40);
    private static final float MaxSmallItemSize = Dp.m6997constructorimpl(56);
    private static final float AnchorSize = Dp.m6997constructorimpl(10);
    ...
    public final TargetedFlingBehavior singleAdvanceFlingBehavior(CarouselState carouselState, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        AnimationSpec<Float> spring$default = (i2 & 2) != 0 ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : animationSpec;
        ...
        TargetedFlingBehavior flingBehavior = PagerDefaults.INSTANCE.flingBehavior(carouselState.getPagerState(), PagerSnapDistance.INSTANCE.atMost(1), null, spring$default, 0.0f, composer, ((i << 6) & 7168) | (PagerDefaults.$stable << 15), 20);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TargetedFlingBehavior multiBrowseFlingBehavior(CarouselState carouselState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        }, rememberSplineBasedDecay, spring$default, 0.0f, composer, (i3 & 7168) | (i3 & 896) | (PagerDefaults.$stable << 15), 16);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
