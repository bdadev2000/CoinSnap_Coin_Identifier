...
public final class KeylineListKt {
    ...
    public static final KeylineList m3208keylineListOfWNYm7Xg(float f, float f2, int i, Function1<? super KeylineListScope, Unit> function1) {
        KeylineListScopeImpl keylineListScopeImpl = new KeylineListScopeImpl();
        function1.invoke(keylineListScopeImpl);
        return keylineListScopeImpl.m3209createWithAlignmentwaks0t8(f, f2, i);
    }
