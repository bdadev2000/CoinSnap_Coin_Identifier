...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m3218copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m3220copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m3220copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m7057equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m7062hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m7065toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int mo671roundToPx0680j_4 = density.mo671roundToPx0680j_4(DpOffset.m7058getXD9Ej5fM(j));
        this.startToAnchorStart = MenuPosition.INSTANCE.startToAnchorStart(mo671roundToPx0680j_4);
        this.endToAnchorEnd = MenuPosition.INSTANCE.endToAnchorEnd(mo671roundToPx0680j_4);
        ...
        int mo671roundToPx0680j_42 = density.mo671roundToPx0680j_4(DpOffset.m7060getYD9Ej5fM(j));
        this.topToAnchorBottom = MenuPosition.INSTANCE.topToAnchorBottom(mo671roundToPx0680j_42);
        this.bottomToAnchorTop = MenuPosition.INSTANCE.bottomToAnchorTop(mo671roundToPx0680j_42);
        this.centerToAnchorTop = MenuPosition.INSTANCE.centerToAnchorTop(mo671roundToPx0680j_42);
    ...
    public final long m3221getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, AnonymousClass2 anonymousClass2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo671roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider.2
    ...
    public long mo649calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntOffset.m7125getXimpl(anchorBounds.m7148getCenternOccac()) < IntSize.m7167getWidthimpl(windowSize) / 2) {
        ...
        while (true) {
            ...
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo3212position95KtPRI(anchorBounds, windowSize, IntSize.m7167getWidthimpl(popupContentSize), layoutDirection);
            if (i3 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m7167getWidthimpl(popupContentSize) + i <= IntSize.m7167getWidthimpl(windowSize))) {
                break;
            }
            i3++;
        }
        ...
        if (IntOffset.m7126getYimpl(anchorBounds.m7148getCenternOccac()) < IntSize.m7166getHeightimpl(windowSize) / 2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            int mo3213positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i4)).mo3213positionJVtK1S4(anchorBounds, windowSize, IntSize.m7166getHeightimpl(popupContentSize));
            if (i4 == CollectionsKt.getLastIndex(listOf2) || (mo3213positionJVtK1S4 >= this.verticalMargin && IntSize.m7166getHeightimpl(popupContentSize) + mo3213positionJVtK1S4 <= IntSize.m7166getHeightimpl(windowSize) - this.verticalMargin)) {
                i2 = mo3213positionJVtK1S4;
                break;
            }
        }
        long IntOffset = IntOffsetKt.IntOffset(i, i2);
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m7157IntRectVbeCjmY(IntOffset, popupContentSize));
        return IntOffset;
    }
}
