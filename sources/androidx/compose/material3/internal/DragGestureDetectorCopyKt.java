...
public final class DragGestureDetectorCopyKt {
    ...
    */
    public static final java.lang.Object m3214awaitHorizontalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope r20, long r21, int r23, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.PointerInputChange, ? super java.lang.Float, kotlin.Unit> r24, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r25) {
        /*
            Method dump skipped, instructions count: 388
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.internal.DragGestureDetectorCopyKt.m3214awaitHorizontalPointerSlopOrCancellationgDDlDlE(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: awaitPointerSlopOrCancellation-pn7EDYM, reason: not valid java name */
    private static final Object m3215awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        PointerInputChange pointerInputChange2;
        if (m3216isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
            return null;
        }
        float m3217pointerSlopE8SPZFQ = m3217pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float floatValue = f + (function1.invoke(Offset.m4263boximpl(pointerInputChange3.getPosition())).floatValue() - function1.invoke(Offset.m4263boximpl(pointerInputChange3.getPreviousPosition())).floatValue());
                if (Math.abs(floatValue) < m3217pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(floatValue - (Math.signum(floatValue) * m3217pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {
    ...
    private static final boolean m3216isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        PointerInputChange pointerInputChange;
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        boolean z = false;
    ...
    public static final float m3217pointerSlopE8SPZFQ(ViewConfiguration viewConfiguration, int i) {
