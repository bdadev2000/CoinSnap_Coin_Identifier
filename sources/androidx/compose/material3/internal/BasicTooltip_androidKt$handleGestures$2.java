...
final class BasicTooltip_androidKt$handleGestures$2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* loaded from: classes8.dex */
        public static final class C00721 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00721(CoroutineScope coroutineScope, TooltipState tooltipState, Continuation<? super C00721> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00721 c00721 = new C00721(this.$$this$coroutineScope, this.$state, continuation);
                c00721.L$0 = obj;
                return c00721;
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r12) {
                ...
                L39:
                    ...
                    int r5 = r5.m5799getMouseT8wyACA()
                    boolean r4 = androidx.compose.ui.input.pointer.PointerType.m5794equalsimpl0(r4, r5)
                    if (r4 == 0) goto L29
                    int r12 = r12.getType()
                    ...
                    int r4 = r4.m5675getEnter7fucELk()
                    boolean r4 = androidx.compose.ui.input.pointer.PointerEventType.m5671equalsimpl0(r12, r4)
                    if (r4 == 0) goto L7a
                ...
                L7a:
                    androidx.compose.ui.input.pointer.PointerEventType$Companion r4 = androidx.compose.ui.input.pointer.PointerEventType.INSTANCE
                    int r4 = r4.m5676getExit7fucELk()
                    boolean r12 = androidx.compose.ui.input.pointer.PointerEventType.m5671equalsimpl0(r12, r4)
                    if (r12 == 0) goto L29
                    androidx.compose.material3.TooltipState r12 = r11.$state
                    r12.dismiss()
                    goto L29
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.internal.BasicTooltip_androidKt$handleGestures$2.AnonymousClass1.C00721.invokeSuspend(java.lang.Object):java.lang.Object");
            }
            ...
            public static final class C00731 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C00731(TooltipState tooltipState, Continuation<? super C00731> continuation) {
                    super(2, continuation);
                    this.$state = tooltipState;
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00731(this.$state, continuation);
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$$this$pointerInput.awaitPointerEventScope(new C00721(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
