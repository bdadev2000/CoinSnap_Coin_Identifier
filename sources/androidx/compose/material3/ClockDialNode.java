...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState analogTimePickerState, boolean z, int i) {
        ...
        this.selection = i;
        this.center = IntOffset.INSTANCE.m7135getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return requireDensity.mo677toPx0680j_4(f);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo667onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m7173getCenterozmzZPI(size);
    }
    ...
    public final void m2204updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (TimePickerSelectionMode.m3068equalsimpl0(this.selection, selection)) {
            return;
        }
