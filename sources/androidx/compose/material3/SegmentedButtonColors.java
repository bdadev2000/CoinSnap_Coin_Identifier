...
public final class SegmentedButtonColors {
    ...
    public final long m2755borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeBorderColor;
        }
        if (enabled && !active) {
    ...
    public final long m2757contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
        if (enabled && checked) {
            return this.activeContentColor;
        }
        if (enabled && !checked) {
    ...
    public final long m2756containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeContainerColor;
        }
        if (enabled && !active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m4516equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m4516equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m4516equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m4516equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m4516equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m4516equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m4516equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m4516equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m4516equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m4516equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m4516equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4522hashCodeimpl(this.activeBorderColor) * 31) + Color.m4522hashCodeimpl(this.activeContentColor)) * 31) + Color.m4522hashCodeimpl(this.activeContainerColor)) * 31) + Color.m4522hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m4522hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m4522hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m4522hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m4522hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
