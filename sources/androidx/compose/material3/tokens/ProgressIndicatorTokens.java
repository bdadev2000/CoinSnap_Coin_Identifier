...
public final class ProgressIndicatorTokens {
    ...
    private static final float Size = Dp.m6997constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveThickness = Dp.m6997constructorimpl(f);
        ActiveTrackSpace = Dp.m6997constructorimpl(f);
        StopShape = Dp.m6997constructorimpl(f);
        StopSize = Dp.m6997constructorimpl(f);
        TrackThickness = Dp.m6997constructorimpl(f);
    }
    ...
    public final float m3784getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM, reason: not valid java name */
    public final float m3785getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3787getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM, reason: not valid java name */
    public final float m3788getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3789getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* renamed from: getSize-D9Ej5fM, reason: not valid java name */
    public final float m3786getSizeD9Ej5fM() {
        return Size;
    }
}
