...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6997constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6997constructorimpl((float) 24.0d);
    ...
    public final float m3675getContainerSizeD9Ej5fM() {
    ...
    public final float m3676getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3677getUnselectedOutlineWidthD9Ej5fM() {
