...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m6997constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m6997constructorimpl((float) 6.0d);
    ...
    public final float m3335getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3336getSizeD9Ej5fM() {
        return Size;
    }
}
