        ...
        if (i == 0) {
            ...
            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.1
                ...
                public static final class C00541 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00541(ClockDialNode clockDialNode, Continuation<? super C00541> continuation) {
                        super(2, continuation);
                        this.this$0 = clockDialNode;
                    }
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            if (z) {
                                ...
                                analogTimePickerState2.mo2081setSelection6_8s6DQ(TimePickerSelectionMode.INSTANCE.m3073getMinuteyecRtBI());
                            }
                ...
                public final void invoke2() {
                    BuildersKt__Builders_commonKt.launch$default(ClockDialNode.this.getCoroutineScope(), null, null, new C00541(ClockDialNode.this, null), 3, null);
                }
            };
            ...
            if (DragGestureDetectorKt.detectDragGestures$default(pointerInputScope, null, function0, null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m2205invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                    return Unit.INSTANCE;
                }
                ...
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            clockDialNode.offsetX = f + Offset.m4274getXimpl(this.$dragAmount);
                            ClockDialNode clockDialNode2 = this.this$0;
                            f2 = clockDialNode2.offsetY;
                            clockDialNode2.offsetY = f2 + Offset.m4275getYimpl(this.$dragAmount);
                            analogTimePickerState = this.this$0.state;
                            f3 = this.this$0.offsetY;
                            j = this.this$0.center;
                            float m7126getYimpl = f3 - IntOffset.m7126getYimpl(j);
                            f4 = this.this$0.offsetX;
                            j2 = this.this$0.center;
                            atan = TimePickerKt.atan(m7126getYimpl, f4 - IntOffset.m7125getXimpl(j2));
                            this.label = 1;
                ...
                public final void m2205invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    AnalogTimePickerState analogTimePickerState;
                    float f;
                    float f2;
                    float maxDist;
                    ...
                    TimePickerKt.m3050moveSelectord3b8Pxo(analogTimePickerState, f, f2, maxDist, j2);
                }
