...
public final class SelectableChipColors {
    ...
    public final long m2780containerColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2782labelColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2783leadingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public final long m2784trailingIconContentColorWaAFU9c$material3_release(boolean enabled, boolean selected) {
        if (!enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m4516equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m4516equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m4516equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m4516equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m4516equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m4516equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m4516equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m4516equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m4516equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m4516equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m4516equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m4516equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m4522hashCodeimpl(this.containerColor) * 31) + Color.m4522hashCodeimpl(this.labelColor)) * 31) + Color.m4522hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m4522hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.selectedTrailingIconColor);
    }
}
