...
final class RippleNodeFactory implements IndicationNodeFactory {
    ...
    private RippleNodeFactory(boolean z, float f, ColorProducer colorProducer) {
        this(z, f, colorProducer, Color.INSTANCE.m4551getUnspecified0d7_KjU());
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.bounded == rippleNodeFactory.bounded && Dp.m7002equalsimpl0(this.radius, rippleNodeFactory.radius) && Intrinsics.areEqual(this.colorProducer, rippleNodeFactory.colorProducer)) {
            return Color.m4516equalsimpl0(this.color, rippleNodeFactory.color);
        }
        return false;
    }
    ...
    @Override // androidx.compose.foundation.IndicationNodeFactory
    public int hashCode() {
        int hashCode = ((Boolean.hashCode(this.bounded) * 31) + Dp.m7003hashCodeimpl(this.radius)) * 31;
        ColorProducer colorProducer = this.colorProducer;
        return ((hashCode + (colorProducer != null ? colorProducer.hashCode() : 0)) * 31) + Color.m4522hashCodeimpl(this.color);
    }
}
