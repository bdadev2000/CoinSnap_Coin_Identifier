...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        long j;
        State<Color> m418animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            m418animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(j2), composer, 0);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-828241443);
            ComposerKt.sourceInformation(composer, "917@44710L88");
            m418animateColorAsStateeuL9pac = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        return m418animateColorAsStateeuL9pac;
    }
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            m4550getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m4550getTransparent0d7_KjU = Color.INSTANCE.m4550getTransparent0d7_KjU();
        }
        long j = m4550getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceGroup(-217363149);
            ComposerKt.sourceInformation(composer, "941@45516L88");
            rememberUpdatedState = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-217247953);
            ComposerKt.sourceInformation(composer, "943@45634L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(j), composer, 0);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> m418animateColorAsStateeuL9pac = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            m4550getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            m4550getTransparent0d7_KjU = Color.INSTANCE.m4550getTransparent0d7_KjU();
        }
        State<Color> m418animateColorAsStateeuL9pac = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(m4550getTransparent0d7_KjU, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m4516equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m4516equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m4516equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m4516equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m4516equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m4516equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m4516equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m4516equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m4516equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m4516equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m4516equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m4516equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m4516equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m4516equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m4516equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m4516equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m4516equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m4516equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m4516equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m4516equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m4516equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m4522hashCodeimpl(this.containerColor) * 31) + Color.m4522hashCodeimpl(this.titleContentColor)) * 31) + Color.m4522hashCodeimpl(this.headlineContentColor)) * 31) + Color.m4522hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m4522hashCodeimpl(this.subheadContentColor)) * 31) + Color.m4522hashCodeimpl(this.yearContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m4522hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m4522hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m4522hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m4522hashCodeimpl(this.dayContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m4522hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m4522hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m4522hashCodeimpl(this.todayContentColor)) * 31) + Color.m4522hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m4522hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m4522hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
