...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long m2716scaleToUserValueowVgs5E = m2716scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), SliderRange);
        if (SliderRange.m2838equalsimpl0(m2716scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2840getStartimpl(m2716scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2839getEndInclusiveimpl(m2716scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2835boximpl(m2716scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2716scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m2824access$scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
