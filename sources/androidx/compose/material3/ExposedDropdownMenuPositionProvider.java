...
public final class ExposedDropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public /* synthetic */ ExposedDropdownMenuPositionProvider(Density density, int i, State state, int i2, AnonymousClass2 anonymousClass2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(density, i, (i3 & 4) != 0 ? null : state, (i3 & 8) != 0 ? density.mo671roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i2, (i3 & 16) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuPositionProvider.2
    ...
    public long mo649calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        long IntSize = IntSizeKt.IntSize(IntSize.m7167getWidthimpl(windowSize), IntSize.m7166getHeightimpl(windowSize) + this.topWindowInsets);
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        int i2 = 0;
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        if (IntOffset.m7125getXimpl(anchorBounds.m7148getCenternOccac()) < IntSize.m7167getWidthimpl(IntSize) / 2) {
        ...
        while (true) {
            ...
            int i4 = i3;
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo3212position95KtPRI(anchorBounds, IntSize, IntSize.m7167getWidthimpl(popupContentSize), layoutDirection);
            if (i4 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m7167getWidthimpl(popupContentSize) + i <= IntSize.m7167getWidthimpl(IntSize))) {
                break;
            }
            i3 = i4 + 1;
        }
        ...
        if (IntOffset.m7126getYimpl(anchorBounds.m7148getCenternOccac()) < IntSize.m7166getHeightimpl(IntSize) / 2) {
        ...
        for (int i5 = 0; i5 < size2; i5++) {
            int mo3213positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i5)).mo3213positionJVtK1S4(anchorBounds, IntSize, IntSize.m7166getHeightimpl(popupContentSize));
            if (i5 == CollectionsKt.getLastIndex(listOf2) || (mo3213positionJVtK1S4 >= 0 && IntSize.m7166getHeightimpl(popupContentSize) + mo3213positionJVtK1S4 <= IntSize.m7166getHeightimpl(IntSize))) {
