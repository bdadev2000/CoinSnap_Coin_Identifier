...
public final class ClockDialNode$pointerInputTapNode$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, anonymousClass1, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputTapNode$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m2207invokek4lQ0M(offset.getPackedValue());
                ...
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            float m4274getXimpl = Offset.m4274getXimpl(this.$it);
                            float m4275getYimpl = Offset.m4275getYimpl(this.$it);
                            maxDist = this.this$0.getMaxDist();
                            z = this.this$0.autoSwitchToMinute;
                            j = this.this$0.center;
                            this.label = 1;
                            m3052onTaprOwcSBo = TimePickerKt.m3052onTaprOwcSBo(analogTimePickerState, m4274getXimpl, m4275getYimpl, maxDist, z, j, this);
                ...
                public final void m2207invokek4lQ0M(long j) {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m2206invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m2206invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            long j = this.J$0;
            this.this$0.offsetX = Offset.m4274getXimpl(j);
            this.this$0.offsetY = Offset.m4275getYimpl(j);
            return Unit.INSTANCE;
        }
    }
}
