...
public final class NavigationItemIconPosition {
    ...
    private static final int Top = m2624constructorimpl(0);
    private static final int Start = m2624constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationItemIconPosition m2623boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2624constructorimpl(int i) {
        return i;
    }
    ...
    public static String m2628toStringimpl(int i) {
        return m2626equalsimpl0(i, Top) ? "Top" : m2626equalsimpl0(i, Start) ? "Start" : "Unknown";
    }
}
