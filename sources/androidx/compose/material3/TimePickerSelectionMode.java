...
public final class TimePickerSelectionMode {
    ...
    private static final int Hour = m3066constructorimpl(0);
    private static final int Minute = m3066constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerSelectionMode m3065boximpl(int i) {
    ...
    public static boolean m3067equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m3071unboximpl();
    }
    ...
    public static String m3070toStringimpl(int i) {
        return m3068equalsimpl0(i, Hour) ? "Hour" : m3068equalsimpl0(i, Minute) ? "Minute" : "";
    }
}
