...
public final class MenuAnchorType {
    ...
    private static final String PrimaryNotEditable = m2539constructorimpl("PrimaryNotEditable");
    private static final String PrimaryEditable = m2539constructorimpl("PrimaryEditable");
    private static final String SecondaryEditable = m2539constructorimpl("SecondaryEditable");

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MenuAnchorType m2538boximpl(String str) {
        return new MenuAnchorType(str);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static String m2539constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2540equalsimpl(String str, Object obj) {
        return (obj instanceof MenuAnchorType) && Intrinsics.areEqual(str, ((MenuAnchorType) obj).getName());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2541equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2542hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2543toStringimpl(String str) {
        return str;
    }

    public boolean equals(Object obj) {
        return m2540equalsimpl(this.name, obj);
    }

    public int hashCode() {
        return m2542hashCodeimpl(this.name);
    }
    ...
    public String toString() {
        return m2543toStringimpl(this.name);
    }
}
