...
public final class RadioButtonColors {
    ...
    public final RadioButtonColors m2710copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m4516equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m4516equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m4516equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m4522hashCodeimpl(this.selectedColor) * 31) + Color.m4522hashCodeimpl(this.unselectedColor)) * 31) + Color.m4522hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m4522hashCodeimpl(this.disabledUnselectedColor);
    }
}
