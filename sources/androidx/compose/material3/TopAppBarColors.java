...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m3171copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m3170containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4566lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m4516equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m4516equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m4516equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m4516equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m4522hashCodeimpl(this.containerColor) * 31) + Color.m4522hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4522hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4522hashCodeimpl(this.titleContentColor)) * 31) + Color.m4522hashCodeimpl(this.actionIconContentColor);
    }
}
