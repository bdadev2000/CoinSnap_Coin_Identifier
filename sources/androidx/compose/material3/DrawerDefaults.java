...
public final class DrawerDefaults {
    ...
    private static final float ModalDrawerElevation = ElevationTokens.INSTANCE.m3494getLevel0D9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m3649getStandardContainerElevationD9Ej5fM();
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m3649getStandardContainerElevationD9Ej5fM();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m3646getContainerWidthD9Ej5fM();
    ...
    public final float m2396getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m1056onlybOOhFvg = WindowInsetsKt.m1056onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m1068plusgK_yJZ4(WindowInsetsSides.INSTANCE.m1083getVerticalJoeWqyM(), WindowInsetsSides.INSTANCE.m1081getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
