...
public final class ChipColors {
    ...
    public final ChipColors m2177copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
    ...
    public final long m2176containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2186labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2187leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2188trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m4516equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m4516equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m4516equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m4516equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m4516equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m4516equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m4516equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m4522hashCodeimpl(this.containerColor) * 31) + Color.m4522hashCodeimpl(this.labelColor)) * 31) + Color.m4522hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4522hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
