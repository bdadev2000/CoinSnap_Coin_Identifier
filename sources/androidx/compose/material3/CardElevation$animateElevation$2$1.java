            ...
            if (!Dp.m7002equalsimpl0(this.$animatable.getTargetValue().m7011unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    if (Dp.m7002equalsimpl0(m7011unboximpl, f)) {
                        start = new PressInteraction.Press(Offset.INSTANCE.m4290getZeroF1C5BW0(), null);
                    } else {
                        ...
                        if (Dp.m7002equalsimpl0(m7011unboximpl, f2)) {
                            ...
                            if (Dp.m7002equalsimpl0(m7011unboximpl, f3)) {
                                ...
                                if (Dp.m7002equalsimpl0(m7011unboximpl, f4)) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m3222animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
