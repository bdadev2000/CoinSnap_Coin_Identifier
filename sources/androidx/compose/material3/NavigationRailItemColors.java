...
public final class NavigationRailItemColors {
    ...
    public final long m2648getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2643copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2652iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2653textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m4516equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m4516equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m4516equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m4516equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m4516equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m4516equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m4522hashCodeimpl(this.selectedIconColor) * 31) + Color.m4522hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4522hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4522hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4522hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m4522hashCodeimpl(this.disabledIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledTextColor);
    }
}
