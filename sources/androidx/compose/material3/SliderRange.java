...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2835boximpl(long j) {
        return new SliderRange(j);
    }

    /* renamed from: constructor-impl */
    public static long m2836constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl */
    public static boolean m2837equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2843unboximpl();
    }

    /* renamed from: equals-impl0 */
    public static final boolean m2838equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2841hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m2837equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2841hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl */
    public final /* synthetic */ long m2843unboximpl() {
    ...
    public static final float m2840getStartimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m2839getEndInclusiveimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2844getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2845getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    public String toString() {
        return m2842toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl */
    public static String m2842toStringimpl(long j) {
        if (SliderKt.m2826isSpecifiedIf1S1O4(j)) {
            return m2840getStartimpl(j) + ".." + m2839getEndInclusiveimpl(j);
        }
