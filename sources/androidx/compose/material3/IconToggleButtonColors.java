...
public final class IconToggleButtonColors {
    ...
    public final IconToggleButtonColors m2475copytNS2XkQ(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor, long checkedContainerColor, long checkedContentColor) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m4516equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m4516equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m4516equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m4516equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m4516equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m4522hashCodeimpl(this.containerColor) * 31) + Color.m4522hashCodeimpl(this.contentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4522hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.checkedContentColor);
    }
}
