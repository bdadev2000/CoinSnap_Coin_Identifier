...
public final class NavigationDrawer_androidKt {
    private static final float PredictiveBackDrawerMaxScaleXDistanceGrow = Dp.m6997constructorimpl(12);
    private static final float PredictiveBackDrawerMaxScaleXDistanceShrink = Dp.m6997constructorimpl(24);
    private static final float PredictiveBackDrawerMaxScaleYDistance = Dp.m6997constructorimpl(48);
    ...
    public static final void DrawerPredictiveBackHandler(final DrawerState drawerState, Function3<? super DrawerPredictiveBackState, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i5 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            floatRef.element = density.mo677toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceGrow);
            floatRef2.element = density.mo677toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceShrink);
            floatRef3.element = density.mo677toPx0680j_4(PredictiveBackDrawerMaxScaleYDistance);
            ...
            function32.invoke(drawerPredictiveBackState2, startRestartGroup, Integer.valueOf((i5 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | 6));
            if (ComposerKt.isTraceInProgress()) {
