...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u000f\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\u0010\u0000\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00152\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\u0015B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u001b\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0000H\u0096\u0002ø\u0001\u0000¢\u0006\u0004\b\b\u0010\tJ\u001a\u0010\n\u001a\u00020\u000b2\b\u0010\u0007\u001a\u0004\u0018\u00010\fHÖ\u0003¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u000f\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\u0010\u0010\u0005J\u000f\u0010\u0011\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0013\u0010\u0014R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006\u0016"}, d2 = {"Landroidx/compose/material3/windowsizeclass/WindowHeightSizeClass;", "", "value", "", "constructor-impl", "(I)I", "compareTo", "other", "compareTo-pav6bQQ", "(II)I", "equals", "", "", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(I)Ljava/lang/String;", "Companion", "material3-window-size-class_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@JvmInline
...
public final class WindowHeightSizeClass implements Comparable<WindowHeightSizeClass> {
    ...
    public static final /* synthetic */ WindowHeightSizeClass m3937boximpl(int i) {
        return new WindowHeightSizeClass(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3939constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3940equalsimpl(int i, Object obj) {
        return (obj instanceof WindowHeightSizeClass) && i == ((WindowHeightSizeClass) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3941equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3942hashCodeimpl(int i) {
    ...
    public /* bridge */ /* synthetic */ int compareTo(WindowHeightSizeClass windowHeightSizeClass) {
        return m3944compareTopav6bQQ(windowHeightSizeClass.getValue());
    }
    ...
    public int m3944compareTopav6bQQ(int i) {
        return m3938compareTopav6bQQ(this.value, i);
    }

    /* renamed from: compareTo-pav6bQQ, reason: not valid java name */
    public static int m3938compareTopav6bQQ(int i, int i2) {
        Companion companion = INSTANCE;
        return Dp.m6996compareTo0680j_4(companion.m3947breakpointsr04XMo(i), companion.m3947breakpointsr04XMo(i2));
    }
    ...
    public static final class Companion {
        ...
        public final float m3947breakpointsr04XMo(int i) {
            if (!WindowHeightSizeClass.m3941equalsimpl0(i, m3950getExpandedPt018CI())) {
                if (WindowHeightSizeClass.m3941equalsimpl0(i, m3951getMediumPt018CI())) {
                    return Dp.m6997constructorimpl(480);
                }
                return Dp.m6997constructorimpl(0);
            }
            return Dp.m6997constructorimpl(900);
        }

        /* renamed from: fromHeight-BkRwncw$material3_window_size_class_release, reason: not valid java name */
        public final int m3948fromHeightBkRwncw$material3_window_size_class_release(float height, Set<WindowHeightSizeClass> supportedSizeClasses) {
            if (Dp.m6996compareTo0680j_4(height, Dp.m6997constructorimpl(0)) < 0) {
                throw new IllegalArgumentException("Width must not be negative".toString());
            }
            if (!(!supportedSizeClasses.isEmpty())) {
                throw new IllegalArgumentException("Must support at least one size class".toString());
            }
            int m3950getExpandedPt018CI = m3950getExpandedPt018CI();
            List list = WindowHeightSizeClass.AllSizeClassList;
            int size = list.size();
            for (int i = 0; i < size; i++) {
                int value = ((WindowHeightSizeClass) list.get(i)).getValue();
                if (supportedSizeClasses.contains(WindowHeightSizeClass.m3937boximpl(value))) {
                    if (Dp.m6996compareTo0680j_4(height, WindowHeightSizeClass.INSTANCE.m3947breakpointsr04XMo(value)) >= 0) {
                        return value;
                    }
                    m3950getExpandedPt018CI = value;
                }
            }
            return m3950getExpandedPt018CI;
        }
    }

    static {
        int m3939constructorimpl = m3939constructorimpl(0);
        Compact = m3939constructorimpl;
        int m3939constructorimpl2 = m3939constructorimpl(1);
        Medium = m3939constructorimpl2;
        int m3939constructorimpl3 = m3939constructorimpl(2);
        Expanded = m3939constructorimpl3;
        DefaultSizeClasses = SetsKt.setOf((Object[]) new WindowHeightSizeClass[]{m3937boximpl(m3939constructorimpl), m3937boximpl(m3939constructorimpl2), m3937boximpl(m3939constructorimpl3)});
        List<WindowHeightSizeClass> listOf = CollectionsKt.listOf((Object[]) new WindowHeightSizeClass[]{m3937boximpl(m3939constructorimpl3), m3937boximpl(m3939constructorimpl2), m3937boximpl(m3939constructorimpl)});
