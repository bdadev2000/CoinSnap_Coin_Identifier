...
public final class NavigationItemKt {
    ...
    public static final void m2632NavigationItemSHbi2eg(final boolean z, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final Shape shape, final float f, final float f2, final float f3, final float f4, final float f5, final float f6, final NavigationItemColors navigationItemColors, final Modifier modifier, final boolean z2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final int i, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        ...
        if ((i4 & 306783379) != 306783378 || (4793491 & i6) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            final ComposableLambda rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-44329638, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledIcon$1
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        long m2621iconColorWaAFU9c = NavigationItemColors.this.m2621iconColorWaAFU9c(z, z2);
                        ...
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4505boximpl(m2621iconColorWaAFU9c)), function24, composer2, ProvidedValue.$stable);
            ...
            ComposableLambda rememberComposableLambda2 = function22 == null ? null : ComposableLambdaKt.rememberComposableLambda(-254668050, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$styledLabel$1$1
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        ProvideContentColorTextStyleKt.m3224ProvideContentColorTextStyle3JVO9M(NavigationItemColors.this.m2622textColorWaAFU9c(z, z2), textStyle, function22, composer2, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
            ...
            Modifier m1014defaultMinSizeVpY3zN4 = SizeKt.m1014defaultMinSizeVpY3zN4(SelectableKt.m1236selectableO2vRcR0(modifier, z, mutableInteractionSource, null, z2, Role.m6263boximpl(Role.INSTANCE.m6276getTabo7Vup1c()), function0), NavigationItemMinWidth, NavigationItemMinHeight);
            ...
            if (rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                        m2641invokeozmzZPI(intSize.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                    public final void m2641invokeozmzZPI(long j) {
                        MutableIntState.this.setIntValue(IntSize.m7167getWidthimpl(j));
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier onSizeChanged = OnRemeasuredModifierKt.onSizeChanged(m1014defaultMinSizeVpY3zN4, (Function1) rememberedValue2);
            ...
            if (NavigationItemIconPosition.m2626equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m2631getTopxw1Ddg())) {
                ProvidableCompositionLocal<Density> localDensity = CompositionLocalsKt.getLocalDensity();
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                Object consume = startRestartGroup.consume(localDensity);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                long Offset = OffsetKt.Offset((NavigationItem_SHbi2eg$lambda$2(mutableIntState) - r1.mo671roundToPx0680j_4(f)) / 2, ((Density) consume).mo677toPx0680j_4(IndicatorVerticalOffset));
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            int i8 = i7 << 3;
            m2633NavigationItemLayoutKmRXDg(interactionSource, selectedIndicatorColor, shape, composableLambda, i, rememberComposableLambda2, (Function0) rememberedValue4, f2, f3, f4, f5, f6, startRestartGroup, ((i7 >> 6) & 896) | ((i6 >> 6) & 57344) | (29360128 & i8) | (234881024 & i8) | (i8 & 1879048192), ((i7 >> 27) & 14) | ((i6 << 3) & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItem$3
                ...
                public final void invoke(Composer composer2, int i9) {
                    NavigationItemKt.m2632NavigationItemSHbi2eg(z, function0, function2, textStyle, shape, f, f2, f3, f4, f5, f6, navigationItemColors, modifier, z2, function22, function23, i, mutableInteractionSource, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void m2633NavigationItemLayoutKmRXDg(final InteractionSource interactionSource, final long j, final Shape shape, final Function2<? super Composer, ? super Integer, Unit> function2, final int i, final Function2<? super Composer, ? super Integer, Unit> function22, final Function0<Float> function0, final float f, final float f2, final float f3, final float f4, final float f5, Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        int i6;
        Composer composer2;
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            if (function22 == null || NavigationItemIconPosition.m2626equalsimpl0(i, NavigationItemIconPosition.INSTANCE.m2631getTopxw1Ddg())) {
                i6 = i4;
            ...
            Composer m4008constructorimpl = Updater.m4008constructorimpl(composer2);
            Updater.m4015setimpl(m4008constructorimpl, obj, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m4015setimpl(m4008constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
            if (m4008constructorimpl.getInserting() || !Intrinsics.areEqual(m4008constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                m4008constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            ...
            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.INSTANCE, IndicatorRippleLayoutIdTag), shape), interactionSource, RippleKt.m2728rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7)), composer2, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer2);
            BoxKt.Box(BackgroundKt.m539backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue), j, shape), composer2, 0);
            ...
            if (function22 != null) {
                Modifier layoutId3 = LayoutIdKt.layoutId(Modifier.INSTANCE, "label");
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$NavigationItemLayout$2
                ...
                public final void invoke(Composer composer3, int i7) {
                    NavigationItemKt.m2633NavigationItemLayoutKmRXDg(InteractionSource.this, j, shape, function2, i, function22, function0, f, f2, f3, f4, f5, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final MeasureResult m2638placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        int m6967constrainWidthK40F9xA = ConstraintsKt.m6967constrainWidthK40F9xA(j, placeable2.getWidth());
        int m6966constrainHeightK40F9xA = ConstraintsKt.m6966constrainHeightK40F9xA(j, placeable2.getHeight());
        final int width = (m6967constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height = (m6966constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        final int width2 = (m6967constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height2 = (m6966constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width3 = (m6967constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height3 = (m6966constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m6967constrainWidthK40F9xA, m6966constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    public static final MeasureResult m2640placeLabelAndTopIconqoqLrGI(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f, float f2, float f3) {
        int m6967constrainWidthK40F9xA = ConstraintsKt.m6967constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), placeable3.getWidth()));
        int m6966constrainHeightK40F9xA = ConstraintsKt.m6966constrainHeightK40F9xA(j, MathKt.roundToInt(placeable3.getHeight() + measureScope.mo677toPx0680j_4(f) + placeable.getHeight() + (measureScope.mo677toPx0680j_4(f3) * 2)));
        final int i = measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(f3 + f2));
        final int width = (m6967constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width2 = (m6967constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int i2 = i - measureScope.mo671roundToPx0680j_4(f2);
        final int width3 = (m6967constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = i + placeable2.getHeight() + measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(f + f2));
        final int width4 = (m6967constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        return MeasureScope.layout$default(measureScope, m6967constrainWidthK40F9xA, m6966constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndTopIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    public static final MeasureResult m2639placeLabelAndStartIconnru01g4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, float f) {
        int m6967constrainWidthK40F9xA = ConstraintsKt.m6967constrainWidthK40F9xA(j, placeable3.getWidth());
        int m6966constrainHeightK40F9xA = ConstraintsKt.m6966constrainHeightK40F9xA(j, placeable3.getHeight());
        final int width = (m6967constrainWidthK40F9xA - placeable4.getWidth()) / 2;
        final int height = (m6966constrainHeightK40F9xA - placeable4.getHeight()) / 2;
        final int height2 = (m6966constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        final int height3 = (m6966constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (m6967constrainWidthK40F9xA - ((placeable2.getWidth() + measureScope.mo671roundToPx0680j_4(f)) + placeable.getWidth())) / 2;
        final int width3 = placeable2.getWidth() + width2 + measureScope.mo671roundToPx0680j_4(f);
        final int width4 = (m6967constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int height4 = (m6966constrainHeightK40F9xA - placeable3.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m6967constrainWidthK40F9xA, m6966constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationItemKt$placeLabelAndStartIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
