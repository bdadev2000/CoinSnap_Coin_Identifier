...
public final class TimePickerColors {
    ...
    public final long m3034periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m3035periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m3036timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m3037timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m3018clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m4516equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m4516equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m4516equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m4516equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m4516equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m4516equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m4516equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m4516equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m4516equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m4516equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m4516equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4522hashCodeimpl(this.clockDialColor) * 31) + Color.m4522hashCodeimpl(this.selectorColor)) * 31) + Color.m4522hashCodeimpl(this.containerColor)) * 31) + Color.m4522hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m4522hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m4522hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m4522hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m4522hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m4522hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
