...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
            rememberedValue4 = new Animatable(Dp.m6995boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m6995boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m7002equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m7002equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m7002equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m7002equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m7003hashCodeimpl(this.elevation) * 31) + Dp.m7003hashCodeimpl(this.pressedElevation)) * 31) + Dp.m7003hashCodeimpl(this.focusedElevation)) * 31) + Dp.m7003hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m7003hashCodeimpl(this.disabledElevation);
    }
}
