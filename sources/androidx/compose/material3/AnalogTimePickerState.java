...
public final class AnalogTimePickerState implements TimePickerState {
    ...
    public int mo2080getSelectionyecRtBI() {
        return this.state.mo2080getSelectionyecRtBI();
    }
    ...
    public void mo2081setSelection6_8s6DQ(int i) {
        this.state.mo2081setSelection6_8s6DQ(i);
    }
    ...
    public final Object animateToCurrent(Continuation<? super Unit> continuation) {
        ...
        if (TimePickerSelectionMode.m3068equalsimpl0(mo2080getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3072getHouryecRtBI())) {
    ...
    private final boolean isUpdated() {
        if (TimePickerSelectionMode.m3068equalsimpl0(mo2080getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3072getHouryecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.hourAngle)) {
            return false;
        }
        return (TimePickerSelectionMode.m3068equalsimpl0(mo2080getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3073getMinuteyecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.minuteAngle)) ? false : true;
    }

    public final IntList getClockFaceValues() {
        IntList intList;
        IntList intList2;
        if (TimePickerSelectionMode.m3068equalsimpl0(mo2080getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m3073getMinuteyecRtBI())) {
