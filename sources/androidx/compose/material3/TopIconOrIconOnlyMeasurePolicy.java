...
public final class TopIconOrIconOnlyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2638placeIconX9ElhV4;
        MeasureResult m2640placeLabelAndTopIconqoqLrGI;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                float f = 2;
                Placeable mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(ConstraintsKt.m6969offsetNN6EwU(m6941copyZbe2FdA$default, -measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(this.indicatorVerticalPadding * f))));
                int width = mo5851measureBRTryo0.getWidth() + measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(this.indicatorHorizontalPadding * f));
                int height = mo5851measureBRTryo0.getHeight() + measureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(this.indicatorVerticalPadding * f));
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        Placeable mo5851measureBRTryo02 = measurable2.mo5851measureBRTryo0(ConstraintsKt.m6965constrainN9IONVI(m6941copyZbe2FdA$default, Constraints.INSTANCE.m6960fixedJhjzzOo(width, height)));
                        int size3 = list.size();
                        for (int i3 = 0; i3 < size3; i3++) {
                            Measurable measurable3 = list.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicator")) {
                                Placeable mo5851measureBRTryo03 = measurable3.mo5851measureBRTryo0(ConstraintsKt.m6965constrainN9IONVI(m6941copyZbe2FdA$default, Constraints.INSTANCE.m6960fixedJhjzzOo(roundToInt, height)));
                                if (!this.hasLabel) {
                                    m2638placeIconX9ElhV4 = NavigationItemKt.m2638placeIconX9ElhV4(measureScope, mo5851measureBRTryo0, mo5851measureBRTryo02, mo5851measureBRTryo03, j);
                                    return m2638placeIconX9ElhV4;
                                }
                                int size4 = list.size();
                                for (int i4 = 0; i4 < size4; i4++) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), Constants.ScionAnalytics.PARAM_LABEL)) {
                                        m2640placeLabelAndTopIconqoqLrGI = NavigationItemKt.m2640placeLabelAndTopIconqoqLrGI(measureScope, measurable4.mo5851measureBRTryo0(ConstraintsKt.m6970offsetNN6EwU$default(m6941copyZbe2FdA$default, 0, -(mo5851measureBRTryo03.getHeight() + measureScope.mo671roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null)), mo5851measureBRTryo0, mo5851measureBRTryo02, mo5851measureBRTryo03, j, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                        return m2640placeLabelAndTopIconqoqLrGI;
                                    }
                                }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "icon")) {
                ...
                float f = 2;
                return maxIntrinsicHeight + maxIntrinsicHeight2 + intrinsicMeasureScope.mo671roundToPx0680j_4(Dp.m6997constructorimpl(Dp.m6997constructorimpl(Dp.m6997constructorimpl(this.topIconItemVerticalPadding * f) + Dp.m6997constructorimpl(this.indicatorVerticalPadding * f)) + this.indicatorToLabelVerticalPadding));
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
