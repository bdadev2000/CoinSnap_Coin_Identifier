...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo1061onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m4275getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m4290getZeroF1C5BW0();
        }
        float heightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m4275getYimpl(available));
        if (heightOffset != this.this$0.getState().getHeightOffset()) {
            return Offset.m4268copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m4290getZeroF1C5BW0();
    }
    ...
    public long mo787onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Offset.m4275getYimpl(available) < 0.0f || Offset.m4275getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
        ...
        if (Offset.m4275getYimpl(consumed) == 0.0f && Offset.m4275getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m4275getYimpl(available) > 0.0f) {
