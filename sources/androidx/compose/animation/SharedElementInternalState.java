...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset m4263boximpl = currentBounds != null ? Offset.m4263boximpl(currentBounds.m4309getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(m4263boximpl);
            long packedValue = m4263boximpl.getPackedValue();
            float m4274getXimpl = Offset.m4274getXimpl(packedValue);
            float m4275getYimpl = Offset.m4275getYimpl(packedValue);
    ...
    public final long m411getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m7179toSizeozmzZPI(invoke.mo5859getSizeYbymL2g());
    }
    ...
    public final long m410calculateLookaheadOffsetF1C5BW0() {
        ...
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5860localPositionOfR5De75A(invoke, Offset.INSTANCE.m4290getZeroF1C5BW0());
    }
