...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m4314Recttz77jQw(sharedElementInternalState.m410calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m411getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m409onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            ...
            Offset m4263boximpl = rect != null ? Offset.m4263boximpl(rect.m4309getTopLeftF1C5BW0()) : null;
            if (m4263boximpl != null && Offset.m4271equalsimpl0(m4263boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size m4331boximpl = rect2 != null ? Size.m4331boximpl(rect2.m4307getSizeNHjbRc()) : null;
                if (m4331boximpl != null && Size.m4339equalsimpl0(m4331boximpl.getPackedValue(), lookaheadSize)) {
                    return;
                }
            }
            Rect m4314Recttz77jQw = RectKt.m4314Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(m4314Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, m4314Recttz77jQw);
            }
        }
    }
