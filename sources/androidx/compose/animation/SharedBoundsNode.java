...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final long Size = SizeKt.Size(mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measureScope, mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    ...
                    long mo5860localPositionOfR5De75A = rootLookaheadCoords.mo5860localPositionOfR5De75A(coordinates, Offset.INSTANCE.m4290getZeroF1C5BW0());
                    ...
                    if (sharedElement2.getCurrentBounds() == null) {
                        ...
                        sharedElement3.setCurrentBounds(RectKt.m4314Recttz77jQw(mo5860localPositionOfR5De75A, j2));
                    }
                    offset = Offset.m4263boximpl(mo5860localPositionOfR5De75A);
                } else {
                    offset = null;
                }
                ...
                if (offset != null) {
                    ...
                    sharedElement.m409onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), j3, packedValue);
                }
            }
        }, 4, null);
    }
    ...
    private final MeasureResult place(MeasureScope measureScope, final Placeable placeable) {
        long mo412calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo412calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5859getSizeYbymL2g(), IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default(measureScope, IntSize.m7167getWidthimpl(mo412calculateSizeJyjRU_E), IntSize.m7166getHeightimpl(mo412calculateSizeJyjRU_E), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$place$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (sharedElement.getFoundMatch()) {
                    ...
                    if (coordinates2 != null) {
                        ...
                        offset = Offset.m4263boximpl(rootCoords.mo5860localPositionOfR5De75A(coordinates2, Offset.INSTANCE.m4290getZeroF1C5BW0()));
                    } else {
                        offset = null;
                    }
                    if (value != null) {
                        ...
                        m4309getTopLeftF1C5BW0 = value.m4309getTopLeftF1C5BW0();
                    } else {
                        ...
                        m4309getTopLeftF1C5BW0 = currentBounds2.m4309getTopLeftF1C5BW0();
                    }
                    long m4278minusMKHz9U = offset != null ? Offset.m4278minusMKHz9U(m4309getTopLeftF1C5BW0, offset.getPackedValue()) : Offset.INSTANCE.m4290getZeroF1C5BW0();
                    Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Offset.m4274getXimpl(m4278minusMKHz9U)), Math.round(Offset.m4275getYimpl(m4278minusMKHz9U)), 0.0f, 4, null);
                    return;
                }
    ...
    public MeasureResult mo407approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long m7175roundToIntSizeuvyYCjk = IntSizeKt.m7175roundToIntSizeuvyYCjk(value.m4307getSizeNHjbRc());
                int m7167getWidthimpl = IntSize.m7167getWidthimpl(m7175roundToIntSizeuvyYCjk);
                int m7166getHeightimpl = IntSize.m7166getHeightimpl(m7175roundToIntSizeuvyYCjk);
                if (m7167getWidthimpl == Integer.MAX_VALUE || m7166getHeightimpl == Integer.MAX_VALUE) {
                ...
                j = Constraints.INSTANCE.m6960fixedJhjzzOo(RangesKt.coerceAtLeast(m7167getWidthimpl, 0), RangesKt.coerceAtLeast(m7166getHeightimpl, 0));
            }
        }
        return place(approachMeasureScope, measurable.mo5851measureBRTryo0(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        getSharedElement().setCurrentBounds(RectKt.m4314Recttz77jQw(getRootCoords().mo5860localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4290getZeroF1C5BW0()), SizeKt.Size(IntSize.m7167getWidthimpl(layoutCoordinates.mo5859getSizeYbymL2g()), IntSize.m7166getHeightimpl(layoutCoordinates.mo5859getSizeYbymL2g()))));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m5069recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$draw$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
