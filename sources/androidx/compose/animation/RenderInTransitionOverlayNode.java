...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    public final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long mo5860localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5860localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m4290getZeroF1C5BW0());
                float m4274getXimpl = Offset.m4274getXimpl(mo5860localPositionOfR5De75A);
                float m4275getYimpl = Offset.m4275getYimpl(mo5860localPositionOfR5De75A);
                ...
                if (invoke != null) {
                    ...
                    try {
                        drawContext.getTransform().mo4994clipPathmtrdDE(invoke, m4504getIntersectrtfAjoo);
                        drawScope.getDrawContext().getTransform().translate(m4274getXimpl, m4275getYimpl);
                        try {
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m5069recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode$draw$1
