...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public final long m396sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i == 2) {
            ChangeSize changeSize = this.enter.getData().getChangeSize();
            return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m7159boximpl(fullSize)).getPackedValue();
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        ChangeSize changeSize2 = this.exit.getData().getChangeSize();
        return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m7159boximpl(fullSize)).getPackedValue();
    }
    ...
    public final long m398targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m7159boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long mo4120alignKFBX0sM = alignment.mo4120alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m7128minusqkQi6aY(mo4120alignKFBX0sM, alignment2.mo4120alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m7135getZeronOccac();
        }
        return IntOffset.INSTANCE.m7135getZeronOccac();
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long IntSize = IntSizeKt.IntSize(mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight());
            this.lookaheadSize = IntSize;
            m394setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, IntSize.m7167getWidthimpl(IntSize), IntSize.m7166getHeightimpl(IntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable mo5851measureBRTryo02 = measurable.mo5851measureBRTryo0(j);
            long IntSize2 = IntSizeKt.IntSize(mo5851measureBRTryo02.getWidth(), mo5851measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m372isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : IntSize2;
            ...
            State<IntSize> animate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m7159boximpl(m399invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m399invokeYEO4UFw(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m396sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (animate3 != null) {
                IntSize2 = animate3.getValue().getPackedValue();
            }
            long m6964constrain4WqzIAM = ConstraintsKt.m6964constrain4WqzIAM(j, IntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long m7135getZeronOccac = (deferredAnimation2 == null || (animate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    SpringSpec springSpec;
                    springSpec = EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7116boximpl(m400invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m400invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m398targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7135getZeronOccac() : animate2.getValue().getPackedValue();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long m7135getZeronOccac2 = (deferredAnimation3 == null || (animate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7116boximpl(m401invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m401invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m397slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7135getZeronOccac() : animate.getValue().getPackedValue();
            Alignment alignment2 = this.currentAlignment;
            final long m7129plusqkQi6aY = IntOffset.m7129plusqkQi6aY(alignment2 != null ? alignment2.mo4120alignKFBX0sM(j2, m6964constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m7135getZeronOccac(), m7135getZeronOccac2);
            return MeasureScope.layout$default(measureScope, IntSize.m7167getWidthimpl(m6964constrain4WqzIAM), IntSize.m7166getHeightimpl(m6964constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(Placeable.this, IntOffset.m7125getXimpl(m7135getZeronOccac) + IntOffset.m7125getXimpl(m7129plusqkQi6aY), IntOffset.m7126getYimpl(m7135getZeronOccac) + IntOffset.m7126getYimpl(m7129plusqkQi6aY), 0.0f, init);
                }
            }, 4, null);
        }
        final Placeable mo5851measureBRTryo03 = measurable.mo5851measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo5851measureBRTryo03.getWidth(), mo5851measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final long m397slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long m7135getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7135getZeronOccac() : slideOffset2.invoke(IntSize.m7159boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long m7135getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7135getZeronOccac() : slideOffset.invoke(IntSize.m7159boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m7135getZeronOccac();
        }
        if (i == 2) {
            return m7135getZeronOccac;
        }
        if (i == 3) {
            return m7135getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }
}
