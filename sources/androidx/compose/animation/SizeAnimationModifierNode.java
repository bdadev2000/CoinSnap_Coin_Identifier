...
public final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final long m420targetConstraintsZezNO4M(long r2) {
    ...
    public static final /* data */ class AnimData {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m7165equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7168hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m7170toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long m6964constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m419setLookaheadConstraintsBRTryo0(j);
            mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(j);
        } else {
            mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(m420targetConstraintsZezNO4M(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            m6964constrain4WqzIAM = IntSize;
        } else {
            m6964constrain4WqzIAM = ConstraintsKt.m6964constrain4WqzIAM(j, m421animateTomzRDjE0(AnimationModifierKt.m372isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : IntSize));
        }
        final int m7167getWidthimpl = IntSize.m7167getWidthimpl(m6964constrain4WqzIAM);
        final int m7166getHeightimpl = IntSize.m7166getHeightimpl(m6964constrain4WqzIAM);
        return MeasureScope.layout$default(measureScope, m7167getWidthimpl, m7166getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5915place70tqf50$default(placementScope, placeable, SizeAnimationModifierNode.this.getAlignment().mo4120alignKFBX0sM(IntSize, IntSizeKt.IntSize(m7167getWidthimpl, m7166getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }
    ...
    public final long m421animateTomzRDjE0(long targetSize) {
        ...
        if (animData != null) {
            boolean z = (IntSize.m7165equalsimpl0(targetSize, animData.getAnim().getValue().getPackedValue()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m7165equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue()) || z) {
                animData.m426setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m7159boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m7159boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
