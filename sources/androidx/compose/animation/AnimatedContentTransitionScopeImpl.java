...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public EnterTransition mo345slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m364isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                long m363getCurrentSizeYbymL2g;
                long m363getCurrentSizeYbymL2g2;
                long m362calculateOffsetemnUabE;
                Function1<Integer, Integer> function1 = initialOffset;
                m363getCurrentSizeYbymL2g = this.m363getCurrentSizeYbymL2g();
                int m7167getWidthimpl = IntSize.m7167getWidthimpl(m363getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m363getCurrentSizeYbymL2g2 = this.m363getCurrentSizeYbymL2g();
                m362calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m362calculateOffsetemnUabE(IntSize, m363getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m7167getWidthimpl - IntOffset.m7125getXimpl(m362calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                long IntSize = IntSizeKt.IntSize(i, i);
                m363getCurrentSizeYbymL2g = this.m363getCurrentSizeYbymL2g();
                m362calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m362calculateOffsetemnUabE(IntSize, m363getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m7125getXimpl(m362calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m363getCurrentSizeYbymL2g = this.m363getCurrentSizeYbymL2g();
                int m7166getHeightimpl = IntSize.m7166getHeightimpl(m363getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m363getCurrentSizeYbymL2g2 = this.m363getCurrentSizeYbymL2g();
                m362calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m362calculateOffsetemnUabE(IntSize, m363getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m7166getHeightimpl - IntOffset.m7126getYimpl(m362calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                m363getCurrentSizeYbymL2g = this.m363getCurrentSizeYbymL2g();
                m362calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m362calculateOffsetemnUabE(IntSize, m363getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m7126getYimpl(m362calculateOffsetemnUabE)) - i));
            }
    ...
    public final long m362calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo4120alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo346slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m364isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m7172getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m362calculateOffsetemnUabE = this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m7125getXimpl(m362calculateOffsetemnUabE)) - i));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m362calculateOffsetemnUabE = this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m7125getXimpl(m362calculateOffsetemnUabE)) + IntSize.m7167getWidthimpl(packedValue)));
            }
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m362calculateOffsetemnUabE = this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m7126getYimpl(m362calculateOffsetemnUabE)) + IntSize.m7166getHeightimpl(packedValue)));
            }
    ...
    public final void m367setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m7159boximpl(j));
    }
    ...
    public final long m363getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().getPackedValue() : m366getMeasuredSizeYbymL2g$animation_release();
    }
        ...
        public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> mo427createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long packedValue2 = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m7172getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue3 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m7172getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo427createAnimationSpecTemP2vQ = value.mo427createAnimationSpecTemP2vQ(packedValue2, packedValue3)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo427createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m7159boximpl(m369invokeYEO4UFw(obj));
                }
                ...
                public final long m369invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m7172getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(animate);
            if (measureScope.isLookingAhead()) {
                packedValue = IntSizeKt.IntSize(mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight());
            } else {
                packedValue = animate.getValue().getPackedValue();
            }
            int m7167getWidthimpl = IntSize.m7167getWidthimpl(packedValue);
            int m7166getHeightimpl = IntSize.m7166getHeightimpl(packedValue);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.layout$default(measureScope, m7167getWidthimpl, m7166getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m5915place70tqf50$default(placementScope, mo5851measureBRTryo0, animatedContentTransitionScopeImpl3.getContentAlignment().mo4120alignKFBX0sM(IntSizeKt.IntSize(mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight()), packedValue, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
