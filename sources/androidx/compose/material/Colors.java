...
public final class Colors {
    ...
    private Colors(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, boolean z) {
        this.primary = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j), SnapshotStateKt.structuralEqualityPolicy());
        this.primaryVariant = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j2), SnapshotStateKt.structuralEqualityPolicy());
        this.secondary = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j3), SnapshotStateKt.structuralEqualityPolicy());
        this.secondaryVariant = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j4), SnapshotStateKt.structuralEqualityPolicy());
        this.background = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j5), SnapshotStateKt.structuralEqualityPolicy());
        this.surface = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j6), SnapshotStateKt.structuralEqualityPolicy());
        this.error = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j7), SnapshotStateKt.structuralEqualityPolicy());
        this.onPrimary = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j8), SnapshotStateKt.structuralEqualityPolicy());
        this.onSecondary = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j9), SnapshotStateKt.structuralEqualityPolicy());
        this.onBackground = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j10), SnapshotStateKt.structuralEqualityPolicy());
        this.onSurface = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j11), SnapshotStateKt.structuralEqualityPolicy());
        this.onError = SnapshotStateKt.mutableStateOf(Color.m4505boximpl(j12), SnapshotStateKt.structuralEqualityPolicy());
    ...
    public String toString() {
        ...
        sb.append((Object) Color.m4523toStringimpl(m1799getPrimary0d7_KjU())).append(", primaryVariant=").append((Object) Color.m4523toStringimpl(m1800getPrimaryVariant0d7_KjU())).append(", secondary=").append((Object) Color.m4523toStringimpl(m1801getSecondary0d7_KjU())).append(", secondaryVariant=").append((Object) Color.m4523toStringimpl(m1802getSecondaryVariant0d7_KjU())).append(", background=").append((Object) Color.m4523toStringimpl(m1792getBackground0d7_KjU())).append(", surface=").append((Object) Color.m4523toStringimpl(m1803getSurface0d7_KjU())).append(", error=").append((Object) Color.m4523toStringimpl(m1793getError0d7_KjU())).append(", onPrimary=").append((Object) Color.m4523toStringimpl(m1796getOnPrimary0d7_KjU())).append(", onSecondary=").append((Object) Color.m4523toStringimpl(m1797getOnSecondary0d7_KjU())).append(", onBackground=").append((Object) Color.m4523toStringimpl(m1794getOnBackground0d7_KjU())).append(", onSurface=").append((Object) Color.m4523toStringimpl(m1798getOnSurface0d7_KjU())).append(", onError=");
        sb.append((Object) Color.m4523toStringimpl(m1795getOnError0d7_KjU())).append(", isLight=").append(isLight()).append(')');
        return sb.toString();
    }
}
