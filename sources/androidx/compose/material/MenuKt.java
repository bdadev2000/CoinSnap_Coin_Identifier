...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m6997constructorimpl(16);
    ...
    */
    ...
    static {
        float f = 8;
        MenuElevation = Dp.m6997constructorimpl(f);
        float f2 = 48;
        MenuVerticalMargin = Dp.m6997constructorimpl(f2);
        DropdownMenuVerticalPadding = Dp.m6997constructorimpl(f);
        DropdownMenuItemDefaultMinHeight = Dp.m6997constructorimpl(f2);
    }
}
