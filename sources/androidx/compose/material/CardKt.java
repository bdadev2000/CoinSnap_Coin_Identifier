...
public final class CardKt {
    ...
    public static final void m1775CardFjzlyU(Modifier modifier, Shape shape, long j, long j2, BorderStroke borderStroke, float f, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2) {
        ...
        long m1803getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU() : j;
        long m1817contentColorForek8zF_U = (i2 & 8) != 0 ? ColorsKt.m1817contentColorForek8zF_U(m1803getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        BorderStroke borderStroke2 = (i2 & 16) != 0 ? null : borderStroke;
        float m6997constructorimpl = (i2 & 32) != 0 ? Dp.m6997constructorimpl(1) : f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1956755640, i, -1, "androidx.compose.material.Card (Card.kt:66)");
        }
        SurfaceKt.m1978SurfaceFjzlyU(companion, medium, m1803getSurface0d7_KjU, m1817contentColorForek8zF_U, borderStroke2, m6997constructorimpl, function2, composer, (i & 14) | (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1776CardLPr_se0(Function0<Unit> function0, Modifier modifier, boolean z, Shape shape, long j, long j2, BorderStroke borderStroke, float f, MutableInteractionSource mutableInteractionSource, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2) {
        ...
        long m1803getSurface0d7_KjU = (i2 & 16) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU() : j;
        long m1817contentColorForek8zF_U = (i2 & 32) != 0 ? ColorsKt.m1817contentColorForek8zF_U(m1803getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        BorderStroke borderStroke2 = (i2 & 64) != 0 ? null : borderStroke;
        float m6997constructorimpl = (i2 & 128) != 0 ? Dp.m6997constructorimpl(1) : f;
        if ((i2 & 256) != 0) {
        ...
        SurfaceKt.m1979SurfaceLPr_se0(function0, companion, z2, medium, m1803getSurface0d7_KjU, m1817contentColorForek8zF_U, borderStroke2, m6997constructorimpl, mutableInteractionSource2, function2, composer, (i & 14) | (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (3670016 & i) | (29360128 & i) | (234881024 & i) | (i & 1879048192), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void m1774Card9VG74zQ(Function0<Unit> function0, Modifier modifier, Shape shape, long j, long j2, BorderStroke borderStroke, float f, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z, String str, Role role, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ...
        long m1803getSurface0d7_KjU = (i3 & 8) != 0 ? MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU() : j;
        long m1817contentColorForek8zF_U = (i3 & 16) != 0 ? ColorsKt.m1817contentColorForek8zF_U(m1803getSurface0d7_KjU, composer, (i >> 9) & 14) : j2;
        BorderStroke borderStroke2 = (i3 & 32) != 0 ? null : borderStroke;
        float m6997constructorimpl = (i3 & 64) != 0 ? Dp.m6997constructorimpl(1) : f;
        if ((i3 & 128) != 0) {
            composer.startReplaceableGroup(-492369756);
            ComposerKt.sourceInformation(composer, "CC(remember):Composables.kt#9igjgp");
            Object rememberedValue = composer.rememberedValue();
        ...
        SurfaceKt.m1977Surface9VG74zQ(function0, companion, medium, m1803getSurface0d7_KjU, m1817contentColorForek8zF_U, borderStroke2, m6997constructorimpl, mutableInteractionSource2, indication2, z2, str2, role2, function2, composer, (i & 14) | (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (3670016 & i) | (29360128 & i) | (234881024 & i) | (i & 1879048192), (i2 & 14) | (i2 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i2 & 896), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
