...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.backgroundColor, defaultSelectableChipColors.backgroundColor) && Color.m4516equalsimpl0(this.contentColor, defaultSelectableChipColors.contentColor) && Color.m4516equalsimpl0(this.leadingIconColor, defaultSelectableChipColors.leadingIconColor) && Color.m4516equalsimpl0(this.disabledBackgroundColor, defaultSelectableChipColors.disabledBackgroundColor) && Color.m4516equalsimpl0(this.disabledContentColor, defaultSelectableChipColors.disabledContentColor) && Color.m4516equalsimpl0(this.disabledLeadingIconColor, defaultSelectableChipColors.disabledLeadingIconColor) && Color.m4516equalsimpl0(this.selectedBackgroundColor, defaultSelectableChipColors.selectedBackgroundColor) && Color.m4516equalsimpl0(this.selectedContentColor, defaultSelectableChipColors.selectedContentColor) && Color.m4516equalsimpl0(this.selectedLeadingIconColor, defaultSelectableChipColors.selectedLeadingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((Color.m4522hashCodeimpl(this.backgroundColor) * 31) + Color.m4522hashCodeimpl(this.contentColor)) * 31) + Color.m4522hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4522hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4522hashCodeimpl(this.selectedLeadingIconColor);
    }
}
