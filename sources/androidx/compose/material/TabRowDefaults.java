...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m6997constructorimpl(1);
    private static final float IndicatorHeight = Dp.m6997constructorimpl(2);
    private static final float ScrollableTabRowPadding = Dp.m6997constructorimpl(52);
    ...
    public final void m2002Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Divider)P(1,2:c#ui.unit.Dp,0:c#ui.graphics.Color)370@16453L7,372@16532L66:TabRow.kt#jmzs0o");
        int i6 = i2 & 1;
        if (i6 != 0) {
            i3 = i | 6;
            modifier2 = modifier;
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((i2 & 4) != 0) {
                    ...
                    j2 = Color.m4514copywmQWz5c$default(((Color) consume).m4525unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
                    i3 &= -897;
                }
            } else {
            ...
            DividerKt.m1840DivideroMI9zvI(companion, j3, f3, 0.0f, startRestartGroup, (i7 & 14) | ((i7 >> 3) & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | ((i7 << 3) & 896), 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.TabRowDefaults$Divider$1
                ...
                public final void invoke(Composer composer2, int i8) {
                    TabRowDefaults.this.m2002Divider9IZ8Weo(companion, f3, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public final Modifier tabIndicatorOffset(Modifier modifier, final TabPosition tabPosition) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.material.TabRowDefaults$tabIndicatorOffset$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                State<Dp> m432animateDpAsStateAjpBEmI = AnimateAsStateKt.m432animateDpAsStateAjpBEmI(TabPosition.this.getWidth(), AnimationSpecKt.tween$default(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, composer, 0, 12);
                Modifier m1035width3ABfNKs = SizeKt.m1035width3ABfNKs(OffsetKt.m946offsetVpY3zN4$default(SizeKt.wrapContentSize$default(SizeKt.fillMaxWidth$default(modifier2, 0.0f, 1, null), Alignment.INSTANCE.getBottomStart(), false, 2, null), invoke$lambda$1(AnimateAsStateKt.m432animateDpAsStateAjpBEmI(TabPosition.this.getLeft(), AnimationSpecKt.tween$default(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, composer, 0, 12)), 0.0f, 2, null), invoke$lambda$0(m432animateDpAsStateAjpBEmI));
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
