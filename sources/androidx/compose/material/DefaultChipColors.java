...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> leadingIconContentColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(z ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.backgroundColor, defaultChipColors.backgroundColor) && Color.m4516equalsimpl0(this.contentColor, defaultChipColors.contentColor) && Color.m4516equalsimpl0(this.leadingIconContentColor, defaultChipColors.leadingIconContentColor) && Color.m4516equalsimpl0(this.disabledBackgroundColor, defaultChipColors.disabledBackgroundColor) && Color.m4516equalsimpl0(this.disabledContentColor, defaultChipColors.disabledContentColor) && Color.m4516equalsimpl0(this.disabledLeadingIconContentColor, defaultChipColors.disabledLeadingIconContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m4522hashCodeimpl(this.backgroundColor) * 31) + Color.m4522hashCodeimpl(this.contentColor)) * 31) + Color.m4522hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4522hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}
