...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1942colorsRGew2ao(long j, long j2, long j3, Composer composer, int i, int i2) {
        ...
        long m4514copywmQWz5c$default2 = (i2 & 4) != 0 ? Color.m4514copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1798getOnSurface0d7_KjU(), ContentAlpha.INSTANCE.getDisabled(composer, 6), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1370708026, i, -1, "androidx.compose.material.RadioButtonDefaults.colors (RadioButton.kt:166)");
        }
        Color m4505boximpl = Color.m4505boximpl(m1801getSecondary0d7_KjU);
        Color m4505boximpl2 = Color.m4505boximpl(m4514copywmQWz5c$default);
        Color m4505boximpl3 = Color.m4505boximpl(m4514copywmQWz5c$default2);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new DefaultRadioButtonColors(m1801getSecondary0d7_KjU, m4514copywmQWz5c$default, m4514copywmQWz5c$default2, null);
