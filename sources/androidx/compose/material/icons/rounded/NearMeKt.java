...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_nearMe", "Landroidx/compose/ui/graphics/vector/ImageVector;", "NearMe", "Landroidx/compose/material/icons/Icons$Rounded;", "getNearMe", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class NearMeKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNearMe(androidx.compose.material.icons.Icons.Rounded r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.rounded.NearMeKt._nearMe
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Rounded.NearMe"
            ...
            r7.<init>()
            r0 = 1100349440(0x41960000, float:18.75)
            r1 = 1081878774(0x407c28f6, float:3.94)
            r7.moveTo(r0, r1)
            r0 = 1082277233(0x40823d71, float:4.07)
            r1 = 1092700078(0x412147ae, float:10.08)
            r7.lineTo(r0, r1)
            r5 = 1017370378(0x3ca3d70a, float:0.02)
            r6 = 1072483533(0x3feccccd, float:1.85)
            r1 = -1084982559(0xffffffffbf547ae1, float:-0.83)
            r2 = 1051931443(0x3eb33333, float:0.35)
            r3 = -1085318103(0xffffffffbf4f5c29, float:-0.81)
            r4 = 1069799178(0x3fc3d70a, float:1.53)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1092018504(0x4116e148, float:9.43)
            r1 = 1096810496(0x41600000, float:14.0)
            r7.lineTo(r0, r1)
            r5 = 1058139013(0x3f11eb85, float:0.57)
            r6 = 1058139013(0x3f11eb85, float:0.57)
            ...
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1073993482(0x4003d70a, float:2.06)
            r1 = 1084919644(0x40aa8f5c, float:5.33)
            r7.lineToRelative(r0, r1)
            r5 = 1072567419(0x3fee147b, float:1.86)
            ...
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1086639309(0x40c4cccd, float:6.15)
            r1 = -1049970606(0xffffffffc16ab852, float:-14.67)
            r7.lineToRelative(r0, r1)
            r5 = -1079446077(0xffffffffbfa8f5c3, float:-1.32)
            r6 = -1079446077(0xffffffffbfa8f5c3, float:-1.32)
            r1 = 1051260355(0x3ea8f5c3, float:0.33)
            r2 = -1084982559(0xffffffffbf547ae1, float:-0.83)
            r3 = -1090519040(0xffffffffbf000000, float:-0.5)
            r4 = -1076593951(0xffffffffbfd47ae1, float:-1.66)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r7.close()
            ...
            androidx.compose.material.icons.rounded.NearMeKt._nearMe = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
