...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_label", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Label", "Landroidx/compose/material/icons/Icons$AutoMirrored$Sharp;", "getLabel", "(Landroidx/compose/material/icons/Icons$AutoMirrored$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class LabelKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        Caused by: java.util.ConcurrentModificationException
        	...
        	... 1 more
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getLabel(androidx.compose.material.icons.Icons.AutoMirrored.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.automirrored.sharp.LabelKt._label
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "AutoMirrored.Sharp.Label"
            ...
            r0.<init>()
            r1 = 1099447665(0x41883d71, float:17.03)
            r2 = 1084227584(0x40a00000, float:5.0)
            r0.moveTo(r1, r2)
            r1 = 1077936128(0x40400000, float:3.0)
            r2 = 1084248556(0x40a051ec, float:5.01)
            r0.lineTo(r1, r2)
            r1 = 1096789524(0x415fae14, float:13.98)
            r0.verticalLineToRelative(r1)
            r1 = 1096841953(0x41607ae1, float:14.03)
            r2 = 1008981770(0x3c23d70a, float:0.01)
            r0.lineToRelative(r1, r2)
            r1 = 1102053376(0x41b00000, float:22.0)
            r2 = 1094713344(0x41400000, float:12.0)
            r0.lineTo(r1, r2)
            r1 = -1063318979(0xffffffffc09f0a3d, float:-4.97)
            ...
            androidx.compose.material.icons.automirrored.sharp.LabelKt._label = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.automirrored.sharp.LabelKt.getLabel(androidx.compose.material.icons.Icons$AutoMirrored$Sharp):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
