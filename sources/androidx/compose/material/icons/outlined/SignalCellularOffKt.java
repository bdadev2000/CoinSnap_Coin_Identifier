...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_signalCellularOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SignalCellularOff", "Landroidx/compose/material/icons/Icons$Outlined;", "getSignalCellularOff", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SignalCellularOffKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSignalCellularOff(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
        ...
        L8:
            ...
            r4 = 1090844099(0x4104f5c3, float:8.31)
            r0.lineToRelative(r3, r4)
            r3 = 1090833613(0x4104cccd, float:8.3)
            r0.lineToRelative(r4, r3)
            r0.close()
            r3 = 1084038840(0x409d1eb8, float:4.91)
            r4 = 1082885407(0x408b851f, float:4.36)
            r0.moveTo(r3, r4)
            r3 = 1080033280(0x40600000, float:3.5)
            r4 = 1085842391(0x40b8a3d7, float:5.77)
            r0.lineTo(r3, r4)
            r3 = 1087079711(0x40cb851f, float:6.36)
            r4 = 1087100682(0x40cbd70a, float:6.37)
            r0.lineToRelative(r3, r4)
            r0.lineTo(r2, r1)
