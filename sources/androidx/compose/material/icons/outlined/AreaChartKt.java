...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_areaChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AreaChart", "Landroidx/compose/material/icons/Icons$Outlined;", "getAreaChart", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class AreaChartKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getAreaChart(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.AreaChartKt._areaChart
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.AreaChart"
            ...
            r3 = 1099405722(0x4187999a, float:16.95)
            r0.moveTo(r2, r3)
            r4 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r5 = -1062312346(0xffffffffc0ae6666, float:-5.45)
            r0.lineToRelative(r4, r5)
            r4 = 1090519040(0x41000000, float:8.0)
            r0.lineTo(r4, r1)
            r1 = -1069547520(0xffffffffc0400000, float:-3.0)
            r4 = -1072064102(0xffffffffc019999a, float:-2.4)
            r0.lineToRelative(r1, r4)
            r1 = 1093664768(0x41300000, float:11.0)
            r0.verticalLineTo(r1)
            r1 = 1075587318(0x401c28f6, float:2.44)
            r4 = 1072315761(0x3fea3d71, float:1.83)
            r0.lineToRelative(r1, r4)
            r1 = 1084143698(0x409eb852, float:4.96)
            r4 = -1059166618(0xffffffffc0de6666, float:-6.95)
            r0.lineToRelative(r1, r4)
            r1 = 1099064934(0x41826666, float:16.3)
            ...
            androidx.compose.material.icons.outlined.AreaChartKt._areaChart = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
