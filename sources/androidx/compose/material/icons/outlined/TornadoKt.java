...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_tornado", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Tornado", "Landroidx/compose/material/icons/Icons$Outlined;", "getTornado", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class TornadoKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getTornado(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.TornadoKt._tornado
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.Tornado"
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1100758385(0x419c3d71, float:19.53)
            r3 = 1084227584(0x40a00000, float:5.0)
            r0.moveTo(r1, r3)
            r4 = -1075922862(0xffffffffbfdeb852, float:-1.74)
            r0.lineToRelative(r4, r2)
            r2 = 1086765138(0x40c6b852, float:6.21)
            r0.horizontalLineTo(r2)
            r2 = 1083116093(0x408f0a3d, float:4.47)
            r0.lineTo(r2, r3)
            r0.horizontalLineTo(r1)
            r0.close()
            r1 = 1092888822(0x412428f6, float:10.26)
            r2 = 1097859072(0x41700000, float:15.0)
            r0.moveTo(r1, r2)
            r3 = 1079949394(0x405eb852, float:3.48)
            r0.horizontalLineToRelative(r3)
            r3 = 1094713344(0x41400000, float:12.0)
            r5 = 1099961467(0x4190147b, float:18.01)
            r0.lineTo(r3, r5)
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1097754214(0x416e6666, float:14.9)
            ...
            r3 = 1091850732(0x411451ec, float:9.27)
            r0.horizontalLineToRelative(r3)
            r0.lineTo(r1, r2)
            r0.close()
            ...
            androidx.compose.material.icons.outlined.TornadoKt._tornado = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
