...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_spellcheck", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Spellcheck", "Landroidx/compose/material/icons/Icons$Outlined;", "getSpellcheck", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SpellcheckKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSpellcheck(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.SpellcheckKt._spellcheck
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.Spellcheck"
            ...
            r0.<init>()
            r1 = 1095185203(0x41473333, float:12.45)
            r2 = 1098907648(0x41800000, float:16.0)
            r0.moveTo(r1, r2)
            r1 = 1074119311(0x4005c28f, float:2.09)
            r0.horizontalLineToRelative(r1)
            r3 = 1092018504(0x4116e148, float:9.43)
            r4 = 1077936128(0x40400000, float:3.0)
            r0.lineTo(r3, r4)
            r3 = 1089617265(0x40f23d71, float:7.57)
            r0.lineTo(r3, r4)
            r3 = 1075671204(0x401d70a4, float:2.46)
            r0.lineTo(r3, r2)
            r0.horizontalLineToRelative(r1)
            r1 = 1066359849(0x3f8f5c29, float:1.12)
            r3 = -1069547520(0xffffffffc0400000, float:-3.0)
            r0.lineToRelative(r1, r3)
            r1 = 1085569761(0x40b47ae1, float:5.64)
            r0.horizontalLineToRelative(r1)
            r1 = 1066527621(0x3f91eb85, float:1.14)
            r0.lineToRelative(r1, r4)
            r0.close()
            r1 = 1087226511(0x40cdc28f, float:6.43)
            r3 = 1093664768(0x41300000, float:11.0)
            r0.moveTo(r1, r3)
            r4 = 1091043328(0x41080000, float:8.5)
            r5 = 1085234217(0x40af5c29, float:5.48)
            r0.lineTo(r4, r5)
            r4 = 1093213880(0x41291eb8, float:10.57)
            r0.lineTo(r4, r3)
            r0.lineTo(r1, r3)
            r0.close()
            r1 = 1101838418(0x41acb852, float:21.59)
            r3 = 1094283428(0x413970a4, float:11.59)
            r0.moveTo(r1, r3)
            r1 = -1056870236(0xffffffffc10170a4, float:-8.09)
            r3 = 1090613412(0x410170a4, float:8.09)
            r0.lineToRelative(r1, r3)
            r1 = 1092437934(0x411d47ae, float:9.83)
            r0.lineTo(r1, r2)
            r1 = 1068792545(0x3fb47ae1, float:1.41)
            r2 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r0.lineToRelative(r2, r1)
            r1 = 1084416328(0x40a2e148, float:5.09)
            ...
            androidx.compose.material.icons.outlined.SpellcheckKt._spellcheck = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
