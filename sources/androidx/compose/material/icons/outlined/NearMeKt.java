...
public final class NearMeKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNearMe(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
        ...
        L8:
            ...
            r2 = 1087855657(0x40d75c29, float:6.73)
            r0.moveTo(r1, r2)
            r1 = -1064849900(0xffffffffc087ae14, float:-4.24)
            r2 = 1092752507(0x4122147b, float:10.13)
            ...
            r3 = -1096558838(0xffffffffbea3d70a, float:-0.32)
            r0.lineToRelative(r3, r1)
            r1 = -1085150331(0xffffffffbf51eb85, float:-0.82)
            r0.lineToRelative(r1, r3)
            r1 = -1067743969(0xffffffffc05b851f, float:-3.43)
            r3 = -1079362191(0xffffffffbfaa3d71, float:-1.33)
            r0.lineToRelative(r1, r3)
            r1 = -1064870871(0xffffffffc0875c29, float:-4.23)
            r0.lineToRelative(r2, r1)
            r1 = 1101529088(0x41a80000, float:21.0)
            r2 = 1077936128(0x40400000, float:3.0)
            r0.moveTo(r1, r2)
            r3 = 1093171937(0x41287ae1, float:10.53)
            r0.lineTo(r2, r3)
            r3 = 1065017672(0x3f7ae148, float:0.98)
            r0.verticalLineToRelative(r3)
            r4 = 1088086344(0x40dae148, float:6.84)
            r5 = 1076468122(0x4029999a, float:2.65)
            r0.lineToRelative(r4, r5)
            r4 = 1095216660(0x4147ae14, float:12.48)
            r0.lineTo(r4, r1)
