...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"_undo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Undo", "Landroidx/compose/material/icons/Icons$Outlined;", "getUndo$annotations", "(Landroidx/compose/material/icons/Icons$Outlined;)V", "getUndo", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class UndoKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getUndo(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.UndoKt._undo
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.Undo"
            ...
            r7.moveTo(r0, r1)
            r5 = -1059271475(0xffffffffc0dccccd, float:-6.9)
            r6 = 1076258406(0x40266666, float:2.6)
            r1 = -1071015526(0xffffffffc029999a, float:-2.65)
            r2 = 0
            r3 = -1063151206(0xffffffffc0a1999a, float:-5.05)
            ...
            r0 = -1066947052(0xffffffffc067ae14, float:-3.62)
            r7.lineToRelative(r0, r0)
            r5 = 1084479242(0x40a3d70a, float:5.12)
            r6 = -1074748457(0xffffffffbff0a3d7, float:-1.88)
            r1 = 1068624773(0x3fb1eb85, float:1.39)
            r2 = -1080788255(0xffffffffbf947ae1, float:-1.16)
            r3 = 1078607217(0x404a3d71, float:3.16)
            r4 = -1074748457(0xffffffffbff0a3d7, float:-1.88)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = 1089680179(0x40f33333, float:7.6)
            r6 = 1085276160(0x40b00000, float:5.5)
            r1 = 1080201052(0x40628f5c, float:3.54)
            r2 = 0
            r3 = 1087478170(0x40d1999a, float:6.55)
            r4 = 1075042058(0x4013d70a, float:2.31)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1075293716(0x4017ae14, float:2.37)
            r1 = -1085821420(0xffffffffbf47ae14, float:-0.78)
            r7.lineToRelative(r0, r1)
            r5 = 1095237632(0x41480000, float:12.5)
            r6 = 1090519040(0x41000000, float:8.0)
            r1 = 1101571031(0x41a8a3d7, float:21.08)
            r2 = 1093696225(0x41307ae1, float:11.03)
            r3 = 1099510579(0x41893333, float:17.15)
            ...
            androidx.compose.material.icons.outlined.UndoKt._undo = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
