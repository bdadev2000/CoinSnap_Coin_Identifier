...
public final class HexagonKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getHexagon(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
        ...
        L8:
            ...
            r0.moveTo(r1, r2)
            r3 = 1088002458(0x40d9999a, float:6.8)
            r0.horizontalLineTo(r3)
            r3 = -1062836634(0xffffffffc0a66666, float:-5.2)
            r4 = 1091567616(0x41100000, float:9.0)
            r0.lineToRelative(r3, r4)
            r3 = 1084647014(0x40a66666, float:5.2)
            r0.lineToRelative(r3, r4)
            r4 = 1093035622(0x41266666, float:10.4)
            r0.horizontalLineToRelative(r4)
            r4 = -1055916032(0xffffffffc1100000, float:-9.0)
            r0.lineToRelative(r3, r4)
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1098933862(0x41806666, float:16.05)
            r2 = 1100480512(0x41980000, float:19.0)
            r0.moveTo(r1, r2)
            r3 = 1090414182(0x40fe6666, float:7.95)
            r0.horizontalLineTo(r3)
            r3 = -1065269330(0xffffffffc08147ae, float:-4.04)
            r4 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r0.lineToRelative(r3, r4)
            r3 = 1082214318(0x408147ae, float:4.04)
            r0.lineToRelative(r3, r4)
            r4 = 1090613412(0x410170a4, float:8.09)
            r0.horizontalLineToRelative(r4)
