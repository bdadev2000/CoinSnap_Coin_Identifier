...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_landscape", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Landscape", "Landroidx/compose/material/icons/Icons$Outlined;", "getLandscape", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class LandscapeKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getLandscape(androidx.compose.material.icons.Icons.Outlined r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.LandscapeKt._landscape
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.Landscape"
            ...
            r0.moveTo(r1, r2)
            r3 = -1064891843(0xffffffffc0870a3d, float:-4.22)
            r4 = 1085548790(0x40b428f6, float:5.63)
            r0.lineToRelative(r3, r4)
            r3 = 1067450368(0x3fa00000, float:1.25)
            r4 = 1070973583(0x3fd5c28f, float:1.67)
            r0.lineToRelative(r3, r4)
            r3 = 1091913646(0x411547ae, float:9.33)
            r0.lineTo(r1, r3)
            r3 = 1100480512(0x41980000, float:19.0)
            r4 = 1098907648(0x41800000, float:16.0)
            r0.lineTo(r3, r4)
            r3 = -1056482263(0xffffffffc1075c29, float:-8.46)
            r0.horizontalLineToRelative(r3)
            r3 = -1065332244(0xffffffffc08051ec, float:-4.01)
            r5 = -1062480118(0xffffffffc0abd70a, float:-5.37)
            ...
            r0.moveTo(r1, r4)
            r2 = 1069715292(0x3fc28f5c, float:1.52)
            r3 = -1073615995(0xffffffffc001eb85, float:-2.03)
            r0.lineToRelative(r2, r3)
            r2 = 1090560983(0x4100a3d7, float:8.04)
            r0.lineTo(r2, r4)
            ...
            androidx.compose.material.icons.outlined.LandscapeKt._landscape = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
