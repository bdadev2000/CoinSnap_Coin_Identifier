...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dangerous", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Dangerous", "Landroidx/compose/material/icons/Icons$Filled;", "getDangerous", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class DangerousKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getDangerous(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.DangerousKt._dangerous
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Dangerous"
            ...
            r0.<init>()
            r1 = 1098624532(0x417bae14, float:15.73)
            r2 = 1077936128(0x40400000, float:3.0)
            r0.moveTo(r1, r2)
            r3 = 1090802156(0x410451ec, float:8.27)
            r0.horizontalLineTo(r3)
            r0.lineTo(r2, r3)
            r4 = 1089386578(0x40eeb852, float:7.46)
            ...
            r2 = 1098635018(0x417bd70a, float:15.74)
            r0.moveTo(r1, r2)
            r0.lineTo(r2, r1)
            r3 = 1094713344(0x41400000, float:12.0)
            r4 = 1096034550(0x415428f6, float:13.26)
            r0.lineTo(r3, r4)
            r5 = 1090791670(0x410428f6, float:8.26)
            r0.lineTo(r5, r1)
            r6 = 1088421888(0x40e00000, float:7.0)
            r0.lineTo(r6, r2)
            r7 = 1093392138(0x412bd70a, float:10.74)
            r0.lineTo(r7, r3)
            r0.lineTo(r6, r5)
            r0.lineTo(r5, r6)
            r0.lineTo(r3, r7)
            ...
            androidx.compose.material.icons.filled.DangerousKt._dangerous = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.DangerousKt.getDangerous(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
