...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_nature", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Nature", "Landroidx/compose/material/icons/Icons$Filled;", "getNature", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class NatureKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNature(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.NatureKt._nature
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Nature"
            ...
            r1 = 1098970563(0x4180f5c3, float:16.12)
            r7.moveTo(r0, r1)
            r5 = 1086681252(0x40c570a4, float:6.17)
            r6 = -1059166618(0xffffffffc0de6666, float:-6.95)
            r1 = 1079907451(0x405e147b, float:3.47)
            r2 = -1093538939(0xffffffffbed1eb85, float:-0.41)
            r3 = 1086681252(0x40c570a4, float:6.17)
            r4 = -1068037571(0xffffffffc0570a3d, float:-3.36)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r6 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r1 = 0
            r2 = -1065898476(0xffffffffc077ae14, float:-3.87)
            r3 = -1069002260(0xffffffffc04851ec, float:-3.13)
            r4 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1078481388(0x404851ec, float:3.13)
            r1 = 1088421888(0x40e00000, float:7.0)
            r2 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r7.reflectiveCurveToRelative(r2, r0, r2, r1)
            r5 = 1085968220(0x40ba8f5c, float:5.83)
            r6 = 1088191201(0x40dc7ae1, float:6.89)
            r1 = 0
            r2 = 1079907451(0x405e147b, float:3.47)
            r3 = 1075922862(0x402147ae, float:2.52)
            ...
            r7.horizontalLineToRelative(r0)
            r0 = -1065856532(0xffffffffc07851ec, float:-3.88)
            r7.verticalLineToRelative(r0)
            r7.close()
            ...
            androidx.compose.material.icons.filled.NatureKt._nature = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.NatureKt.getNature(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
