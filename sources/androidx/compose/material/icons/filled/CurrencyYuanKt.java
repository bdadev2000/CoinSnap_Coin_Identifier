...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_currencyYuan", "Landroidx/compose/ui/graphics/vector/ImageVector;", "CurrencyYuan", "Landroidx/compose/material/icons/Icons$Filled;", "getCurrencyYuan", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class CurrencyYuanKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getCurrencyYuan(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.CurrencyYuanKt._currencyYuan
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.CurrencyYuan"
            ...
            r0.<init>()
            r1 = 1096055521(0x41547ae1, float:13.28)
            r2 = 1094713344(0x41400000, float:12.0)
            r0.moveTo(r1, r2)
            r1 = 1083640381(0x40970a3d, float:4.72)
            r2 = 0
            ...
            r0.lineToRelative(r2, r4)
            r0.lineToRelative(r1, r2)
            r1 = -1061746115(0xffffffffc0b70a3d, float:-5.72)
            r3 = -1055916032(0xffffffffc1100000, float:-9.0)
            r0.lineToRelative(r1, r3)
            r1 = 1075293716(0x4017ae14, float:2.37)
            r0.lineToRelative(r1, r2)
            r3 = 1089030062(0x40e947ae, float:7.29)
            r4 = 1083451638(0x409428f6, float:4.63)
            r0.lineToRelative(r4, r3)
            r3 = -1058453586(0xffffffffc0e947ae, float:-7.29)
            r0.lineToRelative(r4, r3)
            r0.lineToRelative(r1, r2)
            r0.close()
            ...
            androidx.compose.material.icons.filled.CurrencyYuanKt._currencyYuan = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.CurrencyYuanKt.getCurrencyYuan(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
