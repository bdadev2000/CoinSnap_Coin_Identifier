...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_highlight", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Highlight", "Landroidx/compose/material/icons/Icons$Filled;", "getHighlight", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class HighlightKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getHighlight(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.HighlightKt._highlight
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Highlight"
            ...
            r2 = 1086073078(0x40bc28f6, float:5.88)
            r0.moveTo(r1, r2)
            r3 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r4 = 1068792545(0x3fb47ae1, float:1.41)
            r0.lineToRelative(r4, r3)
            r3 = 1074245140(0x4007ae14, float:2.12)
            r0.lineToRelative(r3, r3)
            r5 = 1085527818(0x40b3d70a, float:5.62)
            r6 = 1090519040(0x41000000, float:8.0)
            r0.lineTo(r5, r6)
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1099410964(0x4187ae14, float:16.96)
            r2 = 1087562056(0x40d2e148, float:6.59)
            r0.moveTo(r1, r2)
            r5 = -1073238508(0xffffffffc007ae14, float:-2.12)
            r0.lineToRelative(r3, r5)
            r0.lineToRelative(r4, r4)
            r3 = 1100155453(0x41930a3d, float:18.38)
            r0.lineTo(r3, r6)
            r0.lineTo(r1, r2)
            r0.close()
            ...
            androidx.compose.material.icons.filled.HighlightKt._highlight = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.HighlightKt.getHighlight(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
