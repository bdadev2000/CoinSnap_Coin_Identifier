...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_houseSiding", "Landroidx/compose/ui/graphics/vector/ImageVector;", "HouseSiding", "Landroidx/compose/material/icons/Icons$Filled;", "getHouseSiding", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class HouseSidingKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getHouseSiding(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.HouseSidingKt._houseSiding
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.HouseSiding"
            ...
            r0.close()
            r6 = 1088862290(0x40e6b852, float:7.21)
            r0.moveTo(r6, r5)
            r7 = 1092175790(0x411947ae, float:9.58)
            r0.horizontalLineToRelative(r7)
            r7 = 1099431936(0x41880000, float:17.0)
            r8 = 1092815421(0x41230a3d, float:10.19)
            r0.lineTo(r7, r8)
            r0.verticalLineTo(r2)
            r7 = 1088421888(0x40e00000, float:7.0)
            r0.horizontalLineTo(r7)
            r8 = -1075335660(0xffffffffbfe7ae14, float:-1.81)
            r0.verticalLineToRelative(r8)
            r0.lineTo(r6, r5)
            r0.close()
            r6 = 1097408184(0x41691eb8, float:14.57)
            r0.moveTo(r6, r1)
            r8 = 1092018504(0x4116e148, float:9.43)
            r0.horizontalLineTo(r8)
            r8 = 1085674619(0x40b6147b, float:5.69)
            r0.lineTo(r2, r8)
            r0.lineTo(r6, r1)
            r0.close()
            ...
            androidx.compose.material.icons.filled.HouseSidingKt._houseSiding = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.HouseSidingKt.getHouseSiding(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
