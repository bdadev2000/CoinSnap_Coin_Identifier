...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_textRotateVertical", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TextRotateVertical", "Landroidx/compose/material/icons/Icons$Filled;", "getTextRotateVertical", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class TextRotateVerticalKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getTextRotateVertical(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.TextRotateVerticalKt._textRotateVertical
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.TextRotateVertical"
            ...
            r0.<init>()
            r1 = 1098645504(0x417c0000, float:15.75)
            ...
            r0.horizontalLineToRelative(r3)
            r4 = -1072902963(0xffffffffc00ccccd, float:-2.2)
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1095898235(0x4152147b, float:13.13)
            r3 = 1094713344(0x41400000, float:12.0)
            r0.moveTo(r1, r3)
            r1 = 1097859072(0x41700000, float:15.0)
            r4 = 1088379945(0x40df5c29, float:6.98)
            r0.lineTo(r1, r4)
            r1 = 1099363779(0x4186f5c3, float:16.87)
            r0.lineTo(r1, r3)
            r1 = -1066443735(0xffffffffc06f5c29, float:-3.74)
            r0.horizontalLineToRelative(r1)
            r0.close()
            r1 = 1086324736(0x40c00000, float:6.0)
            r3 = 1100873728(0x419e0000, float:19.75)
            r0.moveTo(r1, r3)
            r1 = -1069547520(0xffffffffc0400000, float:-3.0)
            r3 = 1077936128(0x40400000, float:3.0)
            r0.lineToRelative(r3, r1)
            r1 = 1088421888(0x40e00000, float:7.0)
            r4 = 1099300864(0x41860000, float:16.75)
            r0.lineTo(r1, r4)
            r5 = 1082654720(0x40880000, float:4.25)
            r0.lineTo(r1, r5)
            r0.lineTo(r2, r5)
            ...
            androidx.compose.material.icons.filled.TextRotateVerticalKt._textRotateVertical = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
