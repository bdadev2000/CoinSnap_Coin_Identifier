...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_brightness2", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Brightness2", "Landroidx/compose/material/icons/Icons$Filled;", "getBrightness2", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class Brightness2Kt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.RegisterArg.getParentInsn()" because "reg" is null
        	...
        	... 1 more
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getBrightness2(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.Brightness2Kt._brightness2
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Brightness2"
            ...
            r6 = 1068289229(0x3faccccd, float:1.35)
            r1 = -1075251773(0xffffffffbfe8f5c3, float:-1.82)
            r2 = 0
            r3 = -1067324539(0xffffffffc061eb85, float:-3.53)
            ...
            r2 = 1084395356(0x40a28f5c, float:5.08)
            r3 = 1092616192(0x41200000, float:10.0)
            r4 = 1090833613(0x4104cccd, float:8.3)
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r0 = -1063256064(0xffffffffc0a00000, float:-5.0)
            r1 = 1091200614(0x410a6666, float:8.65)
            r2 = -1073699881(0xffffffffc000a3d7, float:-2.01)
            r3 = 1088254116(0x40dd70a4, float:6.92)
            r7.reflectiveCurveToRelative(r2, r3, r0, r1)
            r6 = 1102053376(0x41b00000, float:22.0)
            r1 = 1087310397(0x40cf0a3d, float:6.47)
            r2 = 1101791232(0x41ac0000, float:21.5)
            r3 = 1090707784(0x4102e148, float:8.18)
            r4 = 1102053376(0x41b00000, float:22.0)
            r0 = r7
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r6 = -1054867456(0xffffffffc1200000, float:-10.0)
            r1 = 1085318103(0x40b0a3d7, float:5.52)
            r2 = 0
            r3 = 1092616192(0x41200000, float:10.0)
            r4 = -1064346583(0xffffffffc08f5c29, float:-4.48)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1098404332(0x417851ec, float:15.52)
            ...
            androidx.compose.material.icons.filled.Brightness2Kt._brightness2 = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.Brightness2Kt.getBrightness2(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
