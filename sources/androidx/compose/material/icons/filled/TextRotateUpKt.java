...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_textRotateUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TextRotateUp", "Landroidx/compose/material/icons/Icons$Filled;", "getTextRotateUp", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class TextRotateUpKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getTextRotateUp(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.TextRotateUpKt._textRotateUp
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.TextRotateUp"
            ...
            r3 = -1073322394(0xffffffffc0066666, float:-2.1)
            r0.verticalLineToRelative(r3)
            r4 = -1072902963(0xffffffffc00ccccd, float:-2.2)
            r5 = -1083808154(0xffffffffbf666666, float:-0.9)
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r2 = 1097460613(0x4169eb85, float:14.62)
            r3 = 1092616192(0x41200000, float:10.0)
            r0.moveTo(r3, r2)
            r2 = -1063214121(0xffffffffc0a0a3d7, float:-5.02)
            r4 = -1074832343(0xffffffffbfef5c29, float:-1.87)
            r0.lineToRelative(r2, r4)
            r2 = 1093538939(0x412e147b, float:10.88)
            r0.lineTo(r3, r2)
            r2 = 1081039913(0x406f5c29, float:3.74)
            r0.verticalLineToRelative(r2)
            r0.close()
            r2 = 1099956224(0x41900000, float:18.0)
            r3 = 1082654720(0x40880000, float:4.25)
            r0.moveTo(r2, r3)
            ...
            androidx.compose.material.icons.filled.TextRotateUpKt._textRotateUp = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
