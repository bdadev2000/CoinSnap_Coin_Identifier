...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_formatColorText", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FormatColorText", "Landroidx/compose/material/icons/Icons$Filled;", "getFormatColorText", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class FormatColorTextKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFormatColorText(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.FormatColorTextKt._formatColorText
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.FormatColorText"
            ...
            r0.close()
            r1 = 1085255188(0x40afae14, float:5.49)
            r2 = 1099431936(0x41880000, float:17.0)
            r0.moveTo(r1, r2)
            r3 = 1075503432(0x401ae148, float:2.42)
            r0.horizontalLineToRelative(r3)
            r4 = 1067618140(0x3fa28f5c, float:1.27)
            r5 = -1067114824(0xffffffffc0651eb8, float:-3.58)
            r0.lineToRelative(r4, r5)
            r4 = 1085590733(0x40b4cccd, float:5.65)
            r0.horizontalLineToRelative(r4)
            r4 = 1098954834(0x4180b852, float:16.09)
            r0.lineTo(r4, r2)
            r0.horizontalLineToRelative(r3)
            r3 = 1096024064(0x41540000, float:13.25)
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1094073713(0x41363d71, float:11.39)
            r2 = 1092521820(0x411e8f5c, float:9.91)
            r0.moveTo(r2, r1)
            r1 = -1061599314(0xffffffffc0b947ae, float:-5.79)
            r3 = 1073867653(0x4001eb85, float:2.03)
            r0.lineToRelative(r3, r1)
            r1 = 1039516303(0x3df5c28f, float:0.12)
            r0.horizontalLineToRelative(r1)
            r1 = 1085884334(0x40b947ae, float:5.79)
            r0.lineToRelative(r3, r1)
            ...
            androidx.compose.material.icons.filled.FormatColorTextKt._formatColorText = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.FormatColorTextKt.getFormatColorText(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
