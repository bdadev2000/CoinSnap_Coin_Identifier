...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_swipeDownAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SwipeDownAlt", "Landroidx/compose/material/icons/Icons$Filled;", "getSwipeDownAlt", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SwipeDownAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSwipeDownAlt(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.SwipeDownAltKt._swipeDownAlt
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.SwipeDownAlt"
            ...
            r9 = 1096705638(0x415e6666, float:13.9)
            r7.moveTo(r8, r9)
            r5 = 1082130432(0x40800000, float:4.0)
            r6 = -1063465779(0xffffffffc09ccccd, float:-4.9)
            r1 = 1074916229(0x4011eb85, float:2.28)
            r2 = -1091861217(0xffffffffbeeb851f, float:-0.46)
            r3 = 1082130432(0x40800000, float:4.0)
            r4 = -1071728558(0xffffffffc01eb852, float:-2.48)
            r0 = r7
            ...
            r3 = -1072735191(0xffffffffc00f5c29, float:-2.24)
            r4 = -1063256064(0xffffffffc0a00000, float:-5.0)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1086828052(0x40c7ae14, float:6.24)
            r1 = 1091567616(0x41100000, float:9.0)
            r2 = 1088421888(0x40e00000, float:7.0)
            r7.reflectiveCurveTo(r2, r0, r2, r1)
            r5 = 1082130432(0x40800000, float:4.0)
            r6 = 1084017869(0x409ccccd, float:4.9)
            r1 = 0
            r2 = 1075503432(0x401ae148, float:2.42)
            r3 = 1071393014(0x3fdc28f6, float:1.72)
            r4 = 1083053179(0x408e147b, float:4.44)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1082696663(0x4088a3d7, float:4.27)
            r7.verticalLineToRelative(r0)
            r0 = -1077181153(0xffffffffbfcb851f, float:-1.59)
            ...
            androidx.compose.material.icons.filled.SwipeDownAltKt._swipeDownAlt = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
