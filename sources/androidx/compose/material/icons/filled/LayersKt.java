...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_layers", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Layers", "Landroidx/compose/material/icons/Icons$Filled;", "getLayers", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class LayersKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getLayers(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.LayersKt._layers
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Layers"
            ...
            r2 = 1100239340(0x419451ec, float:18.54)
            r0.moveTo(r1, r2)
            r1 = -1058285814(0xffffffffc0ebd70a, float:-7.37)
            r2 = -1061725143(0xffffffffc0b75c29, float:-5.73)
            r0.lineToRelative(r1, r2)
            r1 = 1077936128(0x40400000, float:3.0)
            r3 = 1096883896(0x41611eb8, float:14.07)
            r0.lineTo(r1, r3)
            ...
            r5 = -1076845609(0xffffffffbfd0a3d7, float:-1.63)
            r6 = -1079865508(0xffffffffbfa28f5c, float:-1.27)
            r0.lineToRelative(r5, r6)
            r5 = -1058264842(0xffffffffc0ec28f6, float:-7.38)
            r6 = 1085779476(0x40b7ae14, float:5.74)
            r0.lineToRelative(r5, r6)
            r0.close()
            r5 = 1094713344(0x41400000, float:12.0)
            r6 = 1098907648(0x41800000, float:16.0)
            r0.moveTo(r5, r6)
            r7 = 1089176863(0x40eb851f, float:7.36)
            r0.lineToRelative(r7, r2)
            r2 = 1101529088(0x41a80000, float:21.0)
            r0.lineTo(r2, r1)
            r1 = -1055916032(0xffffffffc1100000, float:-9.0)
            r0.lineToRelative(r1, r4)
            r0.lineToRelative(r1, r3)
            r1 = 1070638039(0x3fd0a3d7, float:1.63)
            ...
            androidx.compose.material.icons.filled.LayersKt._layers = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.LayersKt.getLayers(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
