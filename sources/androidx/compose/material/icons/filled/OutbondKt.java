...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_outbond", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Outbond", "Landroidx/compose/material/icons/Icons$Filled;", "getOutbond", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class OutbondKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getOutbond(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.OutbondKt._outbond
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.Outbond"
            ...
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r7.close()
            r0 = 1096684667(0x415e147b, float:13.88)
            r1 = 1094230999(0x4138a3d7, float:11.54)
            r7.moveTo(r0, r1)
            r2 = -1063339950(0xffffffffc09eb852, float:-4.96)
            r3 = 1084143698(0x409eb852, float:4.96)
            r7.lineToRelative(r2, r3)
            r4 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r7.lineToRelative(r4, r4)
            r7.lineToRelative(r3, r2)
            r2 = 1092972708(0x412570a4, float:10.34)
            r3 = 1090519040(0x41000000, float:8.0)
            r7.lineTo(r2, r3)
            r2 = 1085590733(0x40b4cccd, float:5.65)
            r3 = 1008981770(0x3c23d70a, float:0.01)
            r7.lineToRelative(r2, r3)
            r2 = 1098907648(0x41800000, float:16.0)
            r3 = 1096453980(0x415a8f5c, float:13.66)
            r7.lineTo(r2, r3)
            r7.lineTo(r0, r1)
            r7.close()
            ...
            androidx.compose.material.icons.filled.OutbondKt._outbond = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
