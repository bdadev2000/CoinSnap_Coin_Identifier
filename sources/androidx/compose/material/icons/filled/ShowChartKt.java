...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u001e\u0010\u0002\u001a\u00020\u0001*\u00020\u00038FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0004\u0010\u0005\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"_showChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ShowChart", "Landroidx/compose/material/icons/Icons$Filled;", "getShowChart$annotations", "(Landroidx/compose/material/icons/Icons$Filled;)V", "getShowChart", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class ShowChartKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getShowChart(androidx.compose.material.icons.Icons.Filled r30) {
        /*
        ...
        L8:
            ...
            r2 = 1100213125(0x4193eb85, float:18.49)
            r0.moveTo(r1, r2)
            r1 = 1086324736(0x40c00000, float:6.0)
            r2 = -1061137940(0xffffffffc0c051ec, float:-6.01)
            r0.lineToRelative(r1, r2)
            r1 = 1082130432(0x40800000, float:4.0)
            r0.lineToRelative(r1, r1)
            r1 = 1102053376(0x41b00000, float:22.0)
            r2 = 1088254116(0x40dd70a4, float:6.92)
            r0.lineTo(r1, r2)
            r1 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r0.lineToRelative(r1, r1)
            r1 = -1058873016(0xffffffffc0e2e148, float:-7.09)
            r2 = 1090456125(0x40ff0a3d, float:7.97)
            r0.lineToRelative(r1, r2)
            r1 = -1065353216(0xffffffffc0800000, float:-4.0)
            r0.lineToRelative(r1, r1)
            r1 = 1073741824(0x40000000, float:2.0)
            r2 = 1099426693(0x4187eb85, float:16.99)
            r0.lineTo(r1, r2)
            r0.close()
