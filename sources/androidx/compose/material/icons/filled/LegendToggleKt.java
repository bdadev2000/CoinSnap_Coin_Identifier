...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_legendToggle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LegendToggle", "Landroidx/compose/material/icons/Icons$Filled;", "getLegendToggle", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class LegendToggleKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getLegendToggle(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.LegendToggleKt._legendToggle
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.LegendToggle"
            ...
            r0.horizontalLineToRelative(r4)
            r0.verticalLineTo(r5)
            r0.close()
            r4 = 1093664768(0x41300000, float:11.0)
            r0.moveTo(r2, r4)
            r5 = -1067240653(0xffffffffc0633333, float:-3.55)
            r6 = 1084227584(0x40a00000, float:5.0)
            r0.lineToRelative(r6, r5)
            r0.lineTo(r1, r6)
            r1 = -1063256064(0xffffffffc0a00000, float:-5.0)
            r5 = 1080242995(0x40633333, float:3.55)
            r0.lineToRelative(r1, r5)
            r1 = 1092616192(0x41200000, float:10.0)
            r0.lineTo(r1, r6)
            r1 = 1091211100(0x410a8f5c, float:8.66)
            r0.lineTo(r3, r1)
            r0.lineTo(r3, r4)
            r1 = 1086156964(0x40bd70a4, float:5.92)
            r3 = -1066988995(0xffffffffc0670a3d, float:-3.61)
            ...
            androidx.compose.material.icons.filled.LegendToggleKt._legendToggle = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.LegendToggleKt.getLegendToggle(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
