...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_swipeLeftAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SwipeLeftAlt", "Landroidx/compose/material/icons/Icons$Filled;", "getSwipeLeftAlt", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SwipeLeftAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSwipeLeftAlt(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.SwipeLeftAltKt._swipeLeftAlt
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.SwipeLeftAlt"
            ...
            r7.<init>()
            r8 = 1092721050(0x4121999a, float:10.1)
            r9 = 1095761920(0x41500000, float:13.0)
            r7.moveTo(r8, r9)
            r5 = 1084017869(0x409ccccd, float:4.9)
            r6 = 1082130432(0x40800000, float:4.0)
            r1 = 1055622431(0x3eeb851f, float:0.46)
            r2 = 1074916229(0x4011eb85, float:2.28)
            r3 = 1075755090(0x401eb852, float:2.48)
            ...
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = -1072735191(0xffffffffc00f5c29, float:-2.24)
            r1 = -1063256064(0xffffffffc0a00000, float:-5.0)
            r7.reflectiveCurveToRelative(r0, r1, r1, r1)
            r5 = -1063465779(0xffffffffc09ccccd, float:-4.9)
            r6 = 1082130432(0x40800000, float:4.0)
            r1 = -1071980216(0xffffffffc01ae148, float:-2.42)
            r3 = -1064430469(0xffffffffc08e147b, float:-4.44)
            r4 = 1071393014(0x3fdc28f6, float:1.72)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1085968220(0x40ba8f5c, float:5.83)
            r7.horizontalLineTo(r0)
            r1 = 1070302495(0x3fcb851f, float:1.59)
            r2 = -1077181153(0xffffffffbfcb851f, float:-1.59)
            ...
            androidx.compose.material.icons.filled.SwipeLeftAltKt._swipeLeftAlt = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
