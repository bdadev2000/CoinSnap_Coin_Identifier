...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wineBar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WineBar", "Landroidx/compose/material/icons/Icons$Filled;", "getWineBar", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class WineBarKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getWineBar(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.WineBarKt._wineBar
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.WineBar"
            ...
            r7.moveTo(r8, r0)
            r9 = 0
            r7.lineToRelative(r9, r8)
            r5 = 1084227584(0x40a00000, float:5.0)
            r6 = 1086135992(0x40bd1eb8, float:5.91)
            r1 = 0
            r2 = 1077810299(0x403e147b, float:2.97)
            r3 = 1074412913(0x400a3d71, float:2.16)
            r4 = 1085129359(0x40adc28f, float:5.43)
            r0 = r7
            ...
            r7.horizontalLineTo(r10)
            r0 = 1073741824(0x40000000, float:2.0)
            r7.verticalLineToRelative(r0)
            r7.horizontalLineToRelative(r10)
            r0 = -1073741824(0xffffffffc0000000, float:-2.0)
            r7.verticalLineToRelative(r0)
            r11 = -1069547520(0xffffffffc0400000, float:-3.0)
            r7.horizontalLineToRelative(r11)
            r0 = -1065164472(0xffffffffc082e148, float:-4.09)
            r7.verticalLineToRelative(r0)
            r6 = -1061347656(0xffffffffc0bd1eb8, float:-5.91)
            r1 = 1077265039(0x4035c28f, float:2.84)
            r2 = -1091190129(0xffffffffbef5c28f, float:-0.48)
            r3 = 1084227584(0x40a00000, float:5.0)
            r4 = -1069799178(0xffffffffc03c28f6, float:-2.94)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            ...
            androidx.compose.material.icons.filled.WineBarKt._wineBar = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
