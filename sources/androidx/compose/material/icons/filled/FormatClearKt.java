...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_formatClear", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FormatClear", "Landroidx/compose/material/icons/Icons$Filled;", "getFormatClear", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class FormatClearKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFormatClear(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.FormatClearKt._formatClear
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.FormatClear"
            ...
            r4 = 1086890967(0x40c8a3d7, float:6.27)
            r0.lineTo(r3, r4)
            r3 = 1088358973(0x40df0a3d, float:6.97)
            ...
            r3 = 1070134723(0x3fc8f5c3, float:1.57)
            r4 = -1066779279(0xffffffffc06a3d71, float:-3.66)
            r0.lineToRelative(r3, r4)
            r3 = 1099290378(0x4185d70a, float:16.73)
            r4 = 1101529088(0x41a80000, float:21.0)
            r0.lineTo(r3, r4)
            r3 = 1099956224(0x41900000, float:18.0)
            r4 = 1100863242(0x419dd70a, float:19.73)
            r0.lineTo(r3, r4)
            r3 = 1080242995(0x40633333, float:3.55)
            r4 = 1084793815(0x40a8a3d7, float:5.27)
            r0.lineTo(r3, r4)
            r0.lineTo(r1, r2)
            r0.close()
            ...
            r3 = 1091378872(0x410d1eb8, float:8.82)
            r4 = 1090519040(0x41000000, float:8.0)
            r0.lineTo(r3, r4)
            r3 = 1075419546(0x4019999a, float:2.4)
            r0.horizontalLineToRelative(r3)
            r3 = -1086828052(0xffffffffbf3851ec, float:-0.72)
            r5 = 1071057469(0x3fd70a3d, float:1.68)
            r0.lineToRelative(r3, r5)
            r3 = 1074161254(0x40066666, float:2.1)
            r0.lineToRelative(r3, r3)
            r3 = 1097030697(0x41635c29, float:14.21)
            r0.lineTo(r3, r4)
            ...
            androidx.compose.material.icons.filled.FormatClearKt._formatClear = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.icons.filled.FormatClearKt.getFormatClear(androidx.compose.material.icons.Icons$Filled):androidx.compose.ui.graphics.vector.ImageVector");
    }
}
