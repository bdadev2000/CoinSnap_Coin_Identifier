...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_viewModule", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ViewModule", "Landroidx/compose/material/icons/Icons$Filled;", "getViewModule", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class ViewModuleKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getViewModule(androidx.compose.material.icons.Icons.Filled r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.filled.ViewModuleKt._viewModule
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Filled.ViewModule"
            ...
            r4 = 1091913646(0x411547ae, float:9.33)
            r0.horizontalLineTo(r4)
            r0.verticalLineTo(r2)
            r0.horizontalLineTo(r1)
            r0.close()
            r5 = 1098561618(0x417ab852, float:15.67)
            ...
            r0.horizontalLineToRelative(r8)
            r0.verticalLineTo(r6)
            r0.close()
            r8 = 1100480512(0x41980000, float:19.0)
            r0.moveTo(r1, r8)
            r9 = -1060110336(0xffffffffc0d00000, float:-6.5)
            r0.verticalLineToRelative(r9)
            r0.horizontalLineTo(r4)
            ...
            r0.close()
            r4 = 1090865070(0x410547ae, float:8.33)
            r0.moveTo(r4, r1)
            r5 = 1077936128(0x40400000, float:3.0)
            r0.horizontalLineTo(r5)
            r0.verticalLineTo(r8)
            r7 = 1084919644(0x40aa8f5c, float:5.33)
            ...
            androidx.compose.material.icons.filled.ViewModuleKt._viewModule = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
