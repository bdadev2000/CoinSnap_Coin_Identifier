...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_webAssetOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WebAssetOff", "Landroidx/compose/material/icons/Icons$Sharp;", "getWebAssetOff", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class WebAssetOffKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getWebAssetOff(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.WebAssetOffKt._webAssetOff
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.WebAssetOff"
            ...
            r4 = -1055737774(0xffffffffc112b852, float:-9.17)
            r0.horizontalLineToRelative(r4)
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1101261701(0x41a3eb85, float:20.49)
            r4 = 1102740193(0x41ba7ae1, float:23.31)
            r0.moveTo(r1, r4)
            r5 = 1099521065(0x41895c29, float:17.17)
            r6 = 1101004800(0x41a00000, float:20.0)
            r0.lineTo(r5, r6)
            r5 = 1073741824(0x40000000, float:2.0)
            r0.horizontalLineTo(r5)
            r5 = 1083871068(0x409a8f5c, float:4.83)
            r0.verticalLineTo(r5)
            r5 = 1060152279(0x3f30a3d7, float:0.69)
            r6 = 1080075223(0x4060a3d7, float:3.51)
            r0.lineTo(r5, r6)
            r5 = 1074161254(0x40066666, float:2.1)
            r0.lineTo(r5, r5)
            r5 = 1100899942(0x419e6666, float:19.8)
            ...
            androidx.compose.material.icons.sharp.WebAssetOffKt._webAssetOff = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
