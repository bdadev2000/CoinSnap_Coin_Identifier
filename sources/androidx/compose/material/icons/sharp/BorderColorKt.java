...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_borderColor", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BorderColor", "Landroidx/compose/material/icons/Icons$Sharp;", "getBorderColor", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class BorderColorKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getBorderColor(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.BorderColorKt._borderColor
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.BorderColor"
            ...
            r4 = 1089994752(0x40f80000, float:7.75)
            r5 = 1099956224(0x41900000, float:18.0)
            r1.lineTo(r4, r5)
            r4 = 1082130432(0x40800000, float:4.0)
            r1.horizontalLineTo(r4)
            r4 = -1066401792(0xffffffffc0700000, float:-3.75)
            r1.verticalLineToRelative(r4)
            r1.lineTo(r0, r2)
            r1.close()
            r0 = 1099893309(0x418f0a3d, float:17.88)
            r2 = 1090246410(0x40fbd70a, float:7.87)
            r1.moveTo(r0, r2)
            r1.lineToRelative(r4, r4)
            r4 = 1075964805(0x4021eb85, float:2.53)
            r5 = -1071476900(0xffffffffc0228f5c, float:-2.54)
            ...
            androidx.compose.material.icons.sharp.BorderColorKt._borderColor = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
