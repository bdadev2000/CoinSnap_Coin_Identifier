...
public final class BookmarkRemoveKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getBookmarkRemove(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.BookmarkRemoveKt._bookmarkRemove
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.BookmarkRemove"
            ...
            r10 = 1093559910(0x412e6666, float:10.9)
            r7.moveTo(r0, r10)
            r5 = -1073657938(0xffffffffc00147ae, float:-2.02)
            r6 = 0
            r1 = -1088170230(0xffffffffbf23d70a, float:-0.64)
            r2 = 1040522936(0x3e051eb8, float:0.13)
            r3 = -1079446077(0xffffffffbfa8f5c3, float:-1.32)
            r4 = 1041194025(0x3e0f5c29, float:0.14)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = -1065898476(0xffffffffc077ae14, float:-3.87)
            r6 = -1066066248(0xffffffffc0751eb8, float:-3.83)
            r1 = -1074496799(0xffffffffbff47ae1, float:-1.91)
            r2 = -1094545572(0xffffffffbec28f5c, float:-0.38)
            r3 = -1067576197(0xffffffffc05e147b, float:-3.47)
            r4 = -1074412913(0xffffffffbff5c28f, float:-1.92)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = 1096810496(0x41600000, float:14.0)
            r6 = 1077936128(0x40400000, float:3.0)
            r1 = 1095541719(0x414ca3d7, float:12.79)
            r2 = 1085360046(0x40b147ae, float:5.54)
            r3 = 1095950664(0x4152e148, float:13.18)
            ...
            androidx.compose.material.icons.sharp.BookmarkRemoveKt._bookmarkRemove = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
