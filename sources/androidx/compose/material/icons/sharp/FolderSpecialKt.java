...
public final class FolderSpecialKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFolderSpecial(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.FolderSpecialKt._folderSpecial
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.FolderSpecial"
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1099924767(0x418f851f, float:17.94)
            r2 = 1099431936(0x41880000, float:17.0)
            r0.moveTo(r1, r2)
            r1 = 1098152673(0x41747ae1, float:15.28)
            r3 = 1097859072(0x41700000, float:15.0)
            r0.lineTo(r3, r1)
            r1 = 1094776259(0x4140f5c3, float:12.06)
            r0.lineTo(r1, r2)
            r1 = -1068163400(0xffffffffc0551eb8, float:-3.33)
            r2 = 1061662228(0x3f47ae14, float:0.78)
            r0.lineToRelative(r2, r1)
            r1 = -1072735191(0xffffffffc00f5c29, float:-2.24)
            r4 = -1071267185(0xffffffffc025c28f, float:-2.59)
            r0.lineToRelative(r4, r1)
            r1 = -1097565471(0xffffffffbe947ae1, float:-0.29)
            r5 = 1079655793(0x405a3d71, float:3.41)
            r0.lineToRelative(r5, r1)
            r1 = 1090519040(0x41000000, float:8.0)
            r0.lineTo(r3, r1)
            r1 = 1068205343(0x3fab851f, float:1.34)
            r3 = 1078523331(0x4048f5c3, float:3.14)
            r0.lineToRelative(r1, r3)
            r1 = 1049918177(0x3e947ae1, float:0.29)
            r0.lineToRelative(r5, r1)
            r1 = 1074748457(0x400f5c29, float:2.24)
            r0.lineToRelative(r4, r1)
            ...
            androidx.compose.material.icons.sharp.FolderSpecialKt._folderSpecial = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
