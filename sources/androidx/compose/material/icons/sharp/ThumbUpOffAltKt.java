...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_thumbUpOffAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ThumbUpOffAlt", "Landroidx/compose/material/icons/Icons$Sharp;", "getThumbUpOffAlt", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class ThumbUpOffAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getThumbUpOffAlt(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
        ...
        L8:
            ...
            r4 = 1090707784(0x4102e148, float:8.18)
            r0.lineTo(r3, r4)
            r3 = 1101529088(0x41a80000, float:21.0)
            r0.verticalLineTo(r3)
            r3 = 1095038403(0x4144f5c3, float:12.31)
            r0.horizontalLineToRelative(r3)
            r3 = 1102577664(0x41b80000, float:23.0)
            r4 = 1095132774(0x41466666, float:12.4)
            r0.lineTo(r3, r4)
            r3 = 1090519040(0x41000000, float:8.0)
            r0.verticalLineTo(r3)
            r3 = -1056639549(0xffffffffc104f5c3, float:-8.31)
            r0.horizontalLineToRelative(r3)
            r3 = 1066359849(0x3f8f5c29, float:1.12)
            r4 = -1062459146(0xffffffffc0ac28f6, float:-5.38)
