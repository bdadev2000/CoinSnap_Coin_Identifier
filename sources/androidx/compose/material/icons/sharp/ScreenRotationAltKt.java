...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_screenRotationAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ScreenRotationAlt", "Landroidx/compose/material/icons/Icons$Sharp;", "getScreenRotationAlt", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class ScreenRotationAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getScreenRotationAlt(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.ScreenRotationAltKt._screenRotationAlt
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.ScreenRotationAlt"
            ...
            r2 = 1089659208(0x40f2e148, float:7.59)
            r0.moveTo(r1, r2)
            r3 = 1087184568(0x40cd1eb8, float:6.41)
            r4 = -1060299080(0xffffffffc0cd1eb8, float:-6.41)
            r0.lineToRelative(r3, r4)
            r3 = 1101130629(0x41a1eb85, float:20.24)
            ...
            r0.horizontalLineToRelative(r1)
            r1 = -1063277036(0xffffffffc09fae14, float:-4.99)
            r0.lineToRelative(r1, r3)
            r1 = -1059040788(0xffffffffc0e051ec, float:-7.01)
            r3 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r0.lineToRelative(r1, r3)
            r1 = 1081123799(0x4070a3d7, float:3.76)
            r0.horizontalLineTo(r1)
            r1 = 1092437934(0x411d47ae, float:9.83)
            r0.lineToRelative(r1, r1)
            r1 = 1099122606(0x418347ae, float:16.41)
            r0.lineTo(r2, r1)
            ...
            androidx.compose.material.icons.sharp.ScreenRotationAltKt._screenRotationAlt = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
