...
public final class PanoramaHorizontalSelectKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPanoramaHorizontalSelect(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.PanoramaHorizontalSelectKt._panoramaHorizontalSelect
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.PanoramaHorizontalSelect"
            ...
            r6 = -1074412913(0xffffffffbff5c28f, float:-1.92)
            r1 = -1062731776(0xffffffffc0a80000, float:-5.25)
            r2 = 0
            r3 = -1055905546(0xffffffffc11028f6, float:-9.01)
            r4 = -1077600584(0xffffffffbfc51eb8, float:-1.54)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1073741824(0x40000000, float:2.0)
            r1 = 1101214515(0x41a33333, float:20.4)
            r7.lineTo(r0, r1)
            r5 = 1092616192(0x41200000, float:10.0)
            r6 = -1074580685(0xffffffffbff33333, float:-1.9)
            r1 = 1074412913(0x400a3d71, float:2.16)
            r2 = -1086156964(0xffffffffbf428f5c, float:-0.76)
            r3 = 1084667986(0x40a6b852, float:5.21)
            r4 = -1074580685(0xffffffffbff33333, float:-1.9)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r6 = 1072902963(0x3ff33333, float:1.9)
            r1 = 1083766211(0x4098f5c3, float:4.78)
            r2 = 0
            r3 = 1090330296(0x40fd1eb8, float:7.91)
            r4 = 1066779279(0x3f95c28f, float:1.17)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            ...
            r1 = 1100957614(0x419f47ae, float:19.91)
            r2 = 1082822492(0x408a8f5c, float:4.33)
            r3 = 1099311350(0x418628f6, float:16.77)
            ...
            androidx.compose.material.icons.sharp.PanoramaHorizontalSelectKt._panoramaHorizontalSelect = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
