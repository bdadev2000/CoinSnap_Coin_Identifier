...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_thumbsUpDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ThumbsUpDown", "Landroidx/compose/material/icons/Icons$Sharp;", "getThumbsUpDown", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class ThumbsUpDownKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getThumbsUpDown(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.ThumbsUpDownKt._thumbsUpDown
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.ThumbsUpDown"
            ...
            r4 = -1066275963(0xffffffffc071eb85, float:-3.78)
            r1.lineToRelative(r3, r4)
            r3 = 1085024502(0x40ac28f6, float:5.38)
            r4 = 0
            r1.lineTo(r3, r4)
            r1.lineTo(r4, r3)
            r3 = 1096810496(0x41600000, float:14.0)
            r1.lineTo(r4, r3)
            r3 = 1091819274(0x4113d70a, float:9.24)
            r1.horizontalLineToRelative(r3)
            r3 = 1089554350(0x40f147ae, float:7.54)
            r1.lineTo(r2, r3)
            r1.close()
            r3 = 1097607414(0x416c28f6, float:14.76)
            r4 = 1092616192(0x41200000, float:10.0)
            r1.moveTo(r3, r4)
            r3 = 1099148820(0x4183ae14, float:16.46)
            r1.lineTo(r2, r3)
            r3 = 1100480512(0x41980000, float:19.0)
            r1.lineTo(r2, r3)
            r2 = 1086702223(0x40c5c28f, float:6.18)
            r1.horizontalLineToRelative(r2)
            r2 = -1085821420(0xffffffffbf47ae14, float:-0.78)
            r3 = 1081207685(0x4071eb85, float:3.78)
            r1.lineToRelative(r2, r3)
            r2 = 1100281283(0x4194f5c3, float:18.62)
            r1.lineTo(r2, r0)
            r1.lineTo(r0, r2)
            r1.lineTo(r0, r4)
            r1.close()
            ...
            androidx.compose.material.icons.sharp.ThumbsUpDownKt._thumbsUpDown = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
