...
public final class NoSimKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNoSim(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r1 = 1081249628(0x40728f5c, float:3.79)
            r2 = 1081039913(0x406f5c29, float:3.74)
            r0.moveTo(r1, r2)
            r1 = 1075335660(0x401851ec, float:2.38)
            r2 = 1084542157(0x40a4cccd, float:5.15)
            r0.lineTo(r1, r2)
            r1 = 1076845609(0x402f5c29, float:2.74)
            r0.lineToRelative(r1, r1)
            r1 = -1107967345(0xffffffffbdf5c28f, float:-0.12)
            r2 = 1039516303(0x3df5c28f, float:0.12)
            r0.lineToRelative(r1, r2)
            r1 = 1101529088(0x41a80000, float:21.0)
            r0.verticalLineTo(r1)
            r1 = 1096045036(0x415451ec, float:13.27)
            r0.horizontalLineToRelative(r1)
            r1 = 1070218609(0x3fca3d71, float:1.58)
            r2 = 1070554153(0x3fcf5c29, float:1.62)
            r0.lineToRelative(r1, r2)
            ...
            r2 = 1098965320(0x4180e148, float:16.11)
            r0.moveTo(r1, r2)
            r1 = 1077936128(0x40400000, float:3.0)
            r0.verticalLineTo(r1)
            r1 = -1055926518(0xffffffffc10fd70a, float:-8.99)
            r0.horizontalLineToRelative(r1)
            r1 = 1090414182(0x40fe6666, float:7.95)
            r2 = 1084353413(0x40a1eb85, float:5.06)
            r0.lineTo(r1, r2)
            r0.close()
