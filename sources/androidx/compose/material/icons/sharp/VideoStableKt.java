...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_videoStable", "Landroidx/compose/ui/graphics/vector/ImageVector;", "VideoStable", "Landroidx/compose/material/icons/Icons$Sharp;", "getVideoStable", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class VideoStableKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getVideoStable(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.VideoStableKt._videoStable
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.VideoStable"
            ...
            r5 = 1077726413(0x403ccccd, float:2.95)
            r0.horizontalLineToRelative(r5)
            r5 = -1072357704(0xffffffffc0151eb8, float:-2.33)
            r6 = 1091284500(0x410bae14, float:8.73)
            r0.lineToRelative(r5, r6)
            r5 = 1099337564(0x41868f5c, float:16.82)
            r0.lineTo(r5, r1)
            r0.horizontalLineTo(r2)
            r0.close()
            r0.moveTo(r3, r1)
            r2 = -1069757235(0xffffffffc03ccccd, float:-2.95)
            r0.horizontalLineToRelative(r2)
            r2 = 1075167887(0x4015c28f, float:2.34)
            r5 = -1056199148(0xffffffffc10bae14, float:-8.73)
            r0.lineToRelative(r2, r5)
            r2 = 1088799375(0x40e5c28f, float:7.18)
            r0.lineTo(r2, r4)
            ...
            androidx.compose.material.icons.sharp.VideoStableKt._videoStable = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
