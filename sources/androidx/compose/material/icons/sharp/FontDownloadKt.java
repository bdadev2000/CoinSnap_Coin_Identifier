...
public final class FontDownloadKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFontDownload(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.FontDownloadKt._fontDownload
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.FontDownload"
            ...
            r0.<init>()
            r1 = 1092542792(0x411ee148, float:9.93)
            r2 = 1096286208(0x41580000, float:13.5)
            r0.moveTo(r1, r2)
            r3 = 1082424033(0x40847ae1, float:4.14)
            r0.horizontalLineToRelative(r3)
            r3 = 1094713344(0x41400000, float:12.0)
            r4 = 1090477097(0x40ff5c29, float:7.98)
            r0.lineTo(r3, r4)
            r0.lineTo(r1, r2)
            r0.close()
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r1 = 1098855219(0x417f3333, float:15.95)
            r2 = 1100218368(0x41940000, float:18.5)
            r0.moveTo(r1, r2)
            r1 = -1080956027(0xffffffffbf91eb85, float:-1.14)
            ...
            r0.lineTo(r1, r3)
            r1 = -1081123799(0xffffffffbf8f5c29, float:-1.12)
            r3 = 1077936128(0x40400000, float:3.0)
            r0.lineToRelative(r1, r3)
            r1 = 1086240850(0x40beb852, float:5.96)
            r0.lineTo(r1, r2)
            r1 = -1051721728(0xffffffffc1500000, float:-13.0)
            r2 = 1084458271(0x40a3851f, float:5.11)
            r0.lineToRelative(r2, r1)
            r1 = 1072567419(0x3fee147b, float:1.86)
            r0.horizontalLineToRelative(r1)
            r1 = 1095761920(0x41500000, float:13.0)
            r0.lineToRelative(r2, r1)
            r1 = -1073364337(0xffffffffc005c28f, float:-2.09)
            r0.horizontalLineToRelative(r1)
            r0.close()
            ...
            androidx.compose.material.icons.sharp.FontDownloadKt._fontDownload = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
