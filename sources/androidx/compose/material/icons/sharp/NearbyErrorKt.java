...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_nearbyError", "Landroidx/compose/ui/graphics/vector/ImageVector;", "NearbyError", "Landroidx/compose/material/icons/Icons$Sharp;", "getNearbyError", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class NearbyErrorKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNearbyError(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.NearbyErrorKt._nearbyError
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.NearbyError"
            ...
            r2 = 1089638236(0x40f28f5c, float:7.58)
            r0.moveTo(r1, r2)
            r3 = 1099127849(0x41835c29, float:16.42)
            r0.lineTo(r3, r1)
            r0.lineTo(r1, r3)
            r0.lineTo(r2, r1)
            r0.lineTo(r1, r2)
            r0.close()
            r2 = 1100585370(0x4199999a, float:19.2)
            r0.moveTo(r1, r2)
            ...
            r3 = 1088778404(0x40e570a4, float:7.17)
            r0.verticalLineTo(r3)
            r3 = -1061179884(0xffffffffc0bfae14, float:-5.99)
            r0.lineToRelative(r3, r3)
            r3 = 1066863165(0x3f970a3d, float:1.18)
            r4 = 1094723830(0x414028f6, float:12.01)
            r0.lineTo(r3, r4)
            r3 = 1093486510(0x412d47ae, float:10.83)
            r0.lineToRelative(r3, r3)
            r3 = 1099956224(0x41900000, float:18.0)
            r4 = 1099342807(0x4186a3d7, float:16.83)
            r0.lineTo(r3, r4)
            r3 = 1095971635(0x41533333, float:13.2)
            r0.verticalLineTo(r3)
            r0.lineTo(r1, r2)
            r0.close()
            ...
            androidx.compose.material.icons.sharp.NearbyErrorKt._nearbyError = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
