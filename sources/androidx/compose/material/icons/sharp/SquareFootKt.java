...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_squareFoot", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SquareFoot", "Landroidx/compose/material/icons/Icons$Sharp;", "getSquareFoot", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class SquareFootKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSquareFoot(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.SquareFootKt._squareFoot
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.SquareFoot"
            ...
            r0.<init>()
            r1 = 1099777966(0x418d47ae, float:17.66)
            r0.moveTo(r1, r1)
            r2 = -1081627116(0xffffffffbf87ae14, float:-1.06)
            r3 = 1065856532(0x3f87ae14, float:1.06)
            r0.lineToRelative(r2, r3)
            r4 = -1086995825(0xffffffffbf35c28f, float:-0.71)
            r0.lineToRelative(r4, r4)
            r0.lineToRelative(r3, r2)
            r5 = -1074245140(0xffffffffbff851ec, float:-1.94)
            ...
            r0.lineToRelative(r4, r4)
            r0.lineToRelative(r3, r2)
            r5 = 1092301619(0x411b3333, float:9.7)
            r0.lineTo(r5, r5)
            r0.lineToRelative(r2, r3)
            r0.lineToRelative(r4, r4)
            r0.lineToRelative(r3, r2)
            ...
            r0.lineTo(r4, r4)
            r4 = 1086303764(0x40bfae14, float:5.99)
            r5 = 1090634383(0x4101c28f, float:8.11)
            r0.lineTo(r4, r5)
            r4 = 1084814787(0x40a8f5c3, float:5.28)
            r5 = 1089260749(0x40eccccd, float:7.4)
            r0.lineTo(r4, r5)
            r0.lineToRelative(r3, r2)
            ...
            r0.moveTo(r1, r2)
            r3 = -1061662228(0xffffffffc0b851ec, float:-5.76)
            r0.verticalLineToRelative(r3)
            r3 = 1095510262(0x414c28f6, float:12.76)
            r0.lineTo(r3, r2)
            ...
            androidx.compose.material.icons.sharp.SquareFootKt._squareFoot = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
