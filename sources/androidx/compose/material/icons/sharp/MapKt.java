...
public final class MapKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getMap(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.MapKt._map
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r0.lineTo(r1, r2)
            r0.close()
            r2 = 1100422840(0x41971eb8, float:18.89)
            r0.moveTo(r1, r2)
            r1 = -1061158912(0xffffffffc0c00000, float:-6.0)
            r2 = -1073280451(0xffffffffc0070a3d, float:-2.11)
            r0.lineToRelative(r1, r2)
            r1 = 1084458271(0x40a3851f, float:5.11)
            r0.lineTo(r3, r1)
            r1 = 1074203197(0x40070a3d, float:2.11)
            ...
            androidx.compose.material.icons.sharp.MapKt._map = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
