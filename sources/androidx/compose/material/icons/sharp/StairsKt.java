...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stairs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stairs", "Landroidx/compose/material/icons/Icons$Sharp;", "getStairs", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class StairsKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getStairs(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.StairsKt._stairs
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.Stairs"
            ...
            r0.moveTo(r2, r1)
            r3 = -1071980216(0xffffffffc01ae148, float:-2.42)
            r0.horizontalLineToRelative(r3)
            r3 = 1079320248(0x40551eb8, float:3.33)
            r0.verticalLineToRelative(r3)
            r4 = 1095761920(0x41500000, float:13.0)
            r0.horizontalLineTo(r4)
            r0.verticalLineToRelative(r3)
            r3 = -1071309128(0xffffffffc0251eb8, float:-2.58)
            r0.horizontalLineToRelative(r3)
            ...
            r4 = 1075503432(0x401ae148, float:2.42)
            r0.horizontalLineToRelative(r4)
            r4 = -1068163400(0xffffffffc0551eb8, float:-3.33)
            r0.verticalLineToRelative(r4)
            r4 = 1093664768(0x41300000, float:11.0)
            r0.horizontalLineTo(r4)
            r4 = 1091913646(0x411547ae, float:9.33)
            r0.verticalLineTo(r4)
            r4 = 1076174520(0x40251eb8, float:2.58)
            r0.horizontalLineToRelative(r4)
            ...
            androidx.compose.material.icons.sharp.StairsKt._stairs = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
