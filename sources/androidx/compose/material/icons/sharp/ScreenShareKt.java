...
public final class ScreenShareKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getScreenShare(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
        ...
        L8:
            ...
            r8.horizontalLineToRelative(r0)
            r8.close()
            r1 = 1097303327(0x4167851f, float:14.47)
            r10 = 1095761920(0x41500000, float:13.0)
            r8.moveTo(r10, r1)
            r1 = -1072944906(0xffffffffc00c28f6, float:-2.19)
            r8.verticalLineToRelative(r1)
            r6 = -1061158912(0xffffffffc0c00000, float:-6.0)
            r7 = 1076761723(0x402e147b, float:2.72)
            r2 = -1070470267(0xffffffffc031eb85, float:-2.78)
            r3 = 0
            r4 = -1064073953(0xffffffffc093851f, float:-4.61)
            r5 = 1062836634(0x3f59999a, float:0.85)
            r1 = r8
            r1.curveToRelative(r2, r3, r4, r5, r6, r7)
            r6 = 1086324736(0x40c00000, float:6.0)
            r7 = -1061431542(0xffffffffc0bbd70a, float:-5.87)
            r2 = 1057971241(0x3f0f5c29, float:0.56)
            r3 = -1070931640(0xffffffffc02ae148, float:-2.67)
            r4 = 1074203197(0x40070a3d, float:2.11)
            r5 = -1062564004(0xffffffffc0aa8f5c, float:-5.33)
            r1.curveToRelative(r2, r3, r4, r5, r6, r7)
            r1 = 1088421888(0x40e00000, float:7.0)
            r8.lineTo(r10, r1)
            r1 = 1080997970(0x406eb852, float:3.73)
            r8.lineToRelative(r9, r1)
            r1 = 1081039913(0x406f5c29, float:3.74)
            r8.lineToRelative(r0, r1)
            r8.close()
