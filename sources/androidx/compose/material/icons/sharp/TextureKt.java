...
public final class TextureKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getTexture(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
        ...
        L8:
            ...
            r3 = 1078229729(0x40447ae1, float:3.07)
            r0.lineTo(r3, r1)
            r1 = 1101529088(0x41a80000, float:21.0)
            r0.lineTo(r3, r1)
            r4 = 1068792545(0x3fb47ae1, float:1.41)
            r0.horizontalLineToRelative(r4)
            r4 = 1083011236(0x408d70a4, float:4.42)
            r5 = 1101565788(0x41a88f5c, float:21.07)
            r0.lineTo(r5, r4)
            r0.lineTo(r5, r2)
            r0.close()
            r4 = 1094660915(0x413f3333, float:11.95)
            r0.moveTo(r4, r2)
            r4 = -1056041861(0xffffffffc10e147b, float:-8.88)
            r6 = 1091441787(0x410e147b, float:8.88)
            r0.lineToRelative(r4, r6)
            r7 = 1077223096(0x40351eb8, float:2.83)
            r0.verticalLineToRelative(r7)
            r7 = 1097628385(0x416c7ae1, float:14.78)
            r0.lineTo(r7, r2)
            r0.close()
            r0.moveTo(r3, r2)
            ...
            r0.close()
            r2 = 1094912573(0x41430a3d, float:12.19)
            r0.moveTo(r2, r1)
            r0.lineToRelative(r6, r4)
            r2 = 1091871703(0x4114a3d7, float:9.29)
            r0.lineTo(r5, r2)
            r2 = 1091945103(0x4115c28f, float:9.36)
            r0.lineTo(r2, r1)
            r0.close()
