...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_panToolAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PanToolAlt", "Landroidx/compose/material/icons/Icons$Sharp;", "getPanToolAlt", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class PanToolAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPanToolAlt(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.PanToolAltKt._panToolAlt
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.PanToolAlt"
            ...
            r7.<init>()
            r8 = 1101099172(0x41a170a4, float:20.18)
            r9 = 1096181350(0x41566666, float:13.4)
            r7.moveTo(r8, r9)
            r0 = 1100532941(0x4198cccd, float:19.1)
            r1 = 1101529088(0x41a80000, float:21.0)
            r7.lineTo(r0, r1)
            r0 = -1055916032(0xffffffffc1100000, float:-9.0)
            r7.horizontalLineToRelative(r0)
            r0 = 1084227584(0x40a00000, float:5.0)
            r1 = 1098509189(0x4179eb85, float:15.62)
            r7.lineTo(r0, r1)
            r0 = 1067198710(0x3f9c28f6, float:1.22)
            r1 = -1080201052(0xffffffffbf9d70a4, float:-1.23)
            r7.lineToRelative(r0, r1)
            r0 = 1092616192(0x41200000, float:10.0)
            r1 = 1098110730(0x4173d70a, float:15.24)
            r7.lineTo(r0, r1)
            ...
            r2 = 1080746312(0x406ae148, float:3.67)
            r3 = 1093318738(0x412ab852, float:10.67)
            r4 = 1077936128(0x40400000, float:3.0)
            r0 = r7
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r0 = 1080746312(0x406ae148, float:3.67)
            r1 = 1095761920(0x41500000, float:13.0)
            r7.reflectiveCurveTo(r1, r0, r1, r10)
            ...
            androidx.compose.material.icons.sharp.PanToolAltKt._panToolAlt = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
