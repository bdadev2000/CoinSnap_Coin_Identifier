...
public final class WbCloudyKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getWbCloudy(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.sharp.WbCloudyKt._wbCloudy
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Sharp.WbCloudy"
            ...
            r7.<init>()
            r0 = 1100674499(0x419af5c3, float:19.37)
            r1 = 1092658135(0x4120a3d7, float:10.04)
            r7.moveTo(r0, r1)
            r5 = 1094723830(0x414028f6, float:12.01)
            r6 = 1082130432(0x40800000, float:4.0)
            r1 = 1100312740(0x419570a4, float:18.68)
            r2 = 1087562056(0x40d2e148, float:6.59)
            r3 = 1098540646(0x417a6666, float:15.65)
            r4 = 1082130432(0x40800000, float:4.0)
            r0 = r7
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r5 = -1059795763(0xffffffffc0d4cccd, float:-6.65)
            r6 = 1082214318(0x408147ae, float:4.04)
            r1 = -1070008893(0xffffffffc038f5c3, float:-2.89)
            r2 = 0
            r3 = -1062417203(0xffffffffc0accccd, float:-5.4)
            r4 = 1070721925(0x3fd1eb85, float:1.64)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = 1008981770(0x3c23d70a, float:0.01)
            r6 = 1096810496(0x41600000, float:14.0)
            r1 = 1075209830(0x40166666, float:2.35)
            ...
            androidx.compose.material.icons.sharp.WbCloudyKt._wbCloudy = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
