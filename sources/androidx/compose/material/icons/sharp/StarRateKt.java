...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_starRate", "Landroidx/compose/ui/graphics/vector/ImageVector;", "StarRate", "Landroidx/compose/material/icons/Icons$Sharp;", "getStarRate", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class StarRateKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getStarRate(androidx.compose.material.icons.Icons.Sharp r30) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r1 = 1097261384(0x4166e148, float:14.43)
            ...
            r0.lineToRelative(r2, r1)
            r1 = -1057866383(0xffffffffc0f23d71, float:-7.57)
            r2 = 0
            r0.lineToRelative(r1, r2)
            r1 = 1082990264(0x408d1eb8, float:4.41)
            r2 = 1086702223(0x40c5c28f, float:6.18)
            r0.lineToRelative(r2, r1)
            r1 = 1089659208(0x40f2e148, float:7.59)
            r3 = -1072273818(0xffffffffc0166666, float:-2.35)
            r0.lineToRelative(r3, r1)
            r1 = -1063906181(0xffffffffc096147b, float:-4.69)
            r4 = 1086681252(0x40c570a4, float:6.17)
            r0.lineToRelative(r4, r1)
            r1 = 1083577467(0x4096147b, float:4.69)
            r0.lineToRelative(r2, r1)
