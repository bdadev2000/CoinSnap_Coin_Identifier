...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_textRotateUp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TextRotateUp", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTextRotateUp", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class TextRotateUpKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getTextRotateUp(androidx.compose.material.icons.Icons.TwoTone r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.TextRotateUpKt._textRotateUp
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.TextRotateUp"
            ...
            r0.close()
            r1 = 1094503629(0x413ccccd, float:11.8)
            ...
            r0.lineTo(r1, r5)
            r1 = 1094975488(0x41440000, float:12.25)
            r0.lineTo(r2, r1)
            r1 = 1069547520(0x3fc00000, float:1.5)
            r0.verticalLineToRelative(r1)
            r1 = 1093664768(0x41300000, float:11.0)
            r2 = 1083703296(0x40980000, float:4.75)
            r0.lineToRelative(r1, r2)
            r1 = -1073322394(0xffffffffc0066666, float:-2.1)
            r0.verticalLineToRelative(r1)
            r1 = -1072902963(0xffffffffc00ccccd, float:-2.2)
            r0.lineToRelative(r1, r3)
            r0.close()
            r1 = 1084185641(0x409f5c29, float:4.98)
            r0.moveTo(r1, r4)
            r2 = 1092616192(0x41200000, float:10.0)
            r3 = 1093801083(0x4132147b, float:11.13)
            r0.lineTo(r2, r3)
            ...
            androidx.compose.material.icons.twotone.TextRotateUpKt._textRotateUp = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
