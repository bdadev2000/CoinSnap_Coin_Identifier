...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bolt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Bolt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBolt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class BoltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getBolt(androidx.compose.material.icons.Icons.TwoTone r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.BoltKt._bolt
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.Bolt"
            ...
            r5 = -1096894382(0xffffffffbe9eb852, float:-0.31)
            r6 = -1085821420(0xffffffffbf47ae14, float:-0.78)
            r1 = -1084143698(0xffffffffbf6147ae, float:-0.88)
            r2 = 0
            r3 = -1096223293(0xffffffffbea8f5c3, float:-0.33)
            r4 = -1086324736(0xffffffffbf400000, float:-0.75)
            r0 = r7
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r5 = 1095772406(0x415028f6, float:13.01)
            r6 = 1077936128(0x40400000, float:3.0)
            r1 = 1091022356(0x4107ae14, float:8.48)
            r2 = 1093601853(0x412f0a3d, float:10.94)
            r3 = 1093056594(0x4126b852, float:10.42)
            r4 = 1089554350(0x40f147ae, float:7.54)
            r0.curveTo(r1, r2, r3, r4, r5, r6)
            r7.horizontalLineToRelative(r9)
            r0 = 1088421888(0x40e00000, float:7.0)
            r7.lineToRelative(r8, r0)
            r0 = 1080075223(0x4060a3d7, float:3.51)
            ...
            r1 = 1095730463(0x414f851f, float:12.97)
            r2 = 1099720294(0x418c6666, float:17.55)
            ...
            androidx.compose.material.icons.twotone.BoltKt._bolt = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
