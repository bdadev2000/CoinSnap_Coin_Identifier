...
public final class NightlightRoundKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNightlightRound(androidx.compose.material.icons.Icons.TwoTone r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.NightlightRoundKt._nightlightRound
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.NightlightRound"
            ...
            r7.<init>()
            r8 = 1098383360(0x41780000, float:15.5)
            r9 = 1102053376(0x41b00000, float:22.0)
            r7.moveTo(r8, r9)
            r5 = 1077936128(0x40400000, float:3.0)
            r6 = -1091861217(0xffffffffbeeb851f, float:-0.46)
            r1 = 1065772646(0x3f866666, float:1.05)
            r2 = 0
            r3 = 1073951539(0x40033333, float:2.05)
            r4 = -1104947446(0xffffffffbe23d70a, float:-0.16)
            r0 = r7
            ...
            r1 = -1065227387(0xffffffffc081eb85, float:-4.06)
            r2 = -1079865508(0xffffffffbfa28f5c, float:-1.27)
            r3 = -1059061760(0xffffffffc0e00000, float:-7.0)
            r4 = -1063130235(0xffffffffc0a1eb85, float:-5.06)
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1088421888(0x40e00000, float:7.0)
            r1 = -1055349801(0xffffffffc118a3d7, float:-9.54)
            r2 = 1077684470(0x403c28f6, float:2.94)
            r3 = -1056681492(0xffffffffc10451ec, float:-8.27)
            r7.reflectiveCurveToRelative(r2, r3, r0, r1)
            r5 = 1098383360(0x41780000, float:15.5)
            r6 = 1073741824(0x40000000, float:2.0)
            r1 = 1099720294(0x418c6666, float:17.55)
            r2 = 1074412913(0x400a3d71, float:2.16)
            r3 = 1099196006(0x41846666, float:16.55)
            ...
            r0.curveToRelative(r1, r2, r3, r4, r5, r6)
            r0 = 1092595220(0x411fae14, float:9.98)
            ...
            androidx.compose.material.icons.twotone.NightlightRoundKt._nightlightRound = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
