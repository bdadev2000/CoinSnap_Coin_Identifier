...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stackedLineChart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "StackedLineChart", "Landroidx/compose/material/icons/Icons$TwoTone;", "getStackedLineChart", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended_release"}, k = 2, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class StackedLineChartKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getStackedLineChart(androidx.compose.material.icons.Icons.TwoTone r30) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.StackedLineChartKt._stackedLineChart
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.StackedLineChart"
            ...
            r2 = 1100999557(0x419feb85, float:19.99)
            r0.moveTo(r1, r2)
            r3 = 1089470464(0x40f00000, float:7.5)
            r4 = -1057992212(0xffffffffc0f051ec, float:-7.51)
            r0.lineToRelative(r3, r4)
            r3 = 1082130432(0x40800000, float:4.0)
            r0.lineToRelative(r3, r3)
            r4 = 1088610632(0x40e2e148, float:7.09)
            r5 = -1057027523(0xffffffffc0ff0a3d, float:-7.97)
            r0.lineToRelative(r4, r5)
            r4 = 1092532306(0x411eb852, float:9.92)
            r5 = 1102053376(0x41b00000, float:22.0)
            r0.lineTo(r5, r4)
            r4 = -1056440320(0xffffffffc1080000, float:-8.5)
            r6 = 1092154819(0x4118f5c3, float:9.56)
            ...
            r7 = 1086345708(0x40c051ec, float:6.01)
            r0.lineToRelative(r6, r7)
            r0.lineTo(r1, r2)
            r0.close()
            r2 = 1080033280(0x40600000, float:3.5)
            r6 = 1098372874(0x4177d70a, float:15.49)
            r0.moveTo(r2, r6)
            r7 = 1086324736(0x40c00000, float:6.0)
            r8 = -1061137940(0xffffffffc0c051ec, float:-6.01)
            r0.lineToRelative(r7, r8)
            r0.lineToRelative(r3, r3)
            r3 = 1081794888(0x407ae148, float:3.92)
            r0.lineTo(r5, r3)
            r3 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r0.lineToRelative(r3, r3)
            r3 = -1058873016(0xffffffffc0e2e148, float:-7.09)
            r5 = 1090456125(0x40ff0a3d, float:7.97)
            r0.lineToRelative(r3, r5)
            r0.lineToRelative(r4, r4)
            r3 = 1096800010(0x415fd70a, float:13.99)
            r0.lineTo(r1, r3)
            r0.lineTo(r2, r6)
            r0.close()
            ...
            androidx.compose.material.icons.twotone.StackedLineChartKt._stackedLineChart = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
