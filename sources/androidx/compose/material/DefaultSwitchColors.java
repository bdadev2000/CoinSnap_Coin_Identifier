...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.checkedThumbColor, defaultSwitchColors.checkedThumbColor) && Color.m4516equalsimpl0(this.checkedTrackColor, defaultSwitchColors.checkedTrackColor) && Color.m4516equalsimpl0(this.uncheckedThumbColor, defaultSwitchColors.uncheckedThumbColor) && Color.m4516equalsimpl0(this.uncheckedTrackColor, defaultSwitchColors.uncheckedTrackColor) && Color.m4516equalsimpl0(this.disabledCheckedThumbColor, defaultSwitchColors.disabledCheckedThumbColor) && Color.m4516equalsimpl0(this.disabledCheckedTrackColor, defaultSwitchColors.disabledCheckedTrackColor) && Color.m4516equalsimpl0(this.disabledUncheckedThumbColor, defaultSwitchColors.disabledUncheckedThumbColor) && Color.m4516equalsimpl0(this.disabledUncheckedTrackColor, defaultSwitchColors.disabledUncheckedTrackColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m4522hashCodeimpl(this.checkedThumbColor) * 31) + Color.m4522hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4522hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4522hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4522hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4522hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4522hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4522hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}
