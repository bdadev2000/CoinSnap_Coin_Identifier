...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m6997constructorimpl(56);
    private static final float HeaderHeight = Dp.m6997constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m6997constructorimpl(1);
    ...
    public final Shape getFrontLayerShape(Composer composer, int i) {
        ...
        float f = 16;
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m1260CornerSize0680j_4(Dp.m6997constructorimpl(f)), CornerSizeKt.m1260CornerSize0680j_4(Dp.m6997constructorimpl(f)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getFrontLayerScrimColor(Composer composer, int i) {
        ...
        long m4514copywmQWz5c$default = Color.m4514copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
