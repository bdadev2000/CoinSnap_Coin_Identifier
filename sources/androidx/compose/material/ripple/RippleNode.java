...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2056addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m4352getZeroNHjbRc();
    ...
    public final long m2068getRippleColor0d7_KjU() {
        return this.color.mo2041invoke0d7_KjU();
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo667onRemeasuredozmzZPI(long size) {
        float mo677toPx0680j_4;
        this.hasValidSize = true;
        Density requireDensity = DelegatableNodeKt.requireDensity(this);
        this.rippleSize = IntSizeKt.m7179toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            mo677toPx0680j_4 = RippleAnimationKt.m2060getRippleEndRadiuscSwnlzA(requireDensity, this.bounded, this.rippleSize);
        } else {
            mo677toPx0680j_4 = requireDensity.mo677toPx0680j_4(this.radius);
        }
        this.targetRadius = mo677toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo2056addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m2073drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2068getRippleColor0d7_KjU());
        }
