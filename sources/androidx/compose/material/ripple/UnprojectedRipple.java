...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2075setColorDxMtmZc(long color, float alpha) {
        long m2074calculateRippleColor5vOe2sY = m2074calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m4516equalsimpl0(color2.m4525unboximpl(), m2074calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m4505boximpl(m2074calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m4569toArgb8_81llA(m2074calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2074calculateRippleColor5vOe2sY(long color, float alpha) {
        return Color.m4514copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
