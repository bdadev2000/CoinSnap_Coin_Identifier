...
public final class RippleHostView extends View {
    ...
    public final void m2063addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m2064setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            unprojectedRipple.setHotspot(Offset.m4274getXimpl(interaction.getPressPosition()), Offset.m4275getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m2064setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.m2075setColorDxMtmZc(color, alpha);
        Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m4343getWidthimpl(size)), MathKt.roundToInt(Size.m4340getHeightimpl(size)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
