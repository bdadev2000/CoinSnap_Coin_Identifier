...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo2056addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m2063addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m2068getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleNode$addRipple$1$1$1
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m2064setRippleProperties07v42R4(getRippleSize(), m2068getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
