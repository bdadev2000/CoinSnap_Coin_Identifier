...
public final class CommonRippleNode extends RippleNode {
    ...
    public void mo2056addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(getBounded() ? Offset.m4263boximpl(interaction.getPressPosition()) : null, targetRadius, getBounded(), null);
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((j2 & 255) < 128) {
                        ...
                        f2 = pressedAlpha;
                        i3 = i5;
                        ((RippleAnimation) objArr2[i8]).m2059draw4WTKRHQ(drawScope, Color.m4514copywmQWz5c$default(m2068getRippleColor0d7_KjU(), f3, 0.0f, 0.0f, 0.0f, 14, null));
                    } else {
                        f2 = pressedAlpha;
                        i = i7;
                        i2 = i6;
