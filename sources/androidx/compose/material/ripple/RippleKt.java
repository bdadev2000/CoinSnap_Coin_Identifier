...
public final class RippleKt {
    ...
    public static final DelegatableNode m2066createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m2072createPlatformRippleNodeTDGSqEk(interactionSource, z, f, colorProducer, function0);
    }
    ...
    public static final Indication m2067rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(j), composer, (i >> 6) & 14);
        ...
        if ((((i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) ^ 48) <= 32 || !composer.changed(f)) && (i & 48) != 32) {
            z2 = false;
        }
        boolean z4 = z3 | z2;
