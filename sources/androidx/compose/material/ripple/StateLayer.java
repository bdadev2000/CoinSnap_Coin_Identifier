...
public final class StateLayer {
    ...
    public final void m2073drawStateLayermxwnekA(DrawScope drawScope, float f, long j) {
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m4514copywmQWz5c$default = Color.m4514copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m5052drawCircleVaOC9Bg$default(drawScope, m4514copywmQWz5c$default, f, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
