...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1893defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m2071defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2071defaultRippleColor5vOe2sY(Color.INSTANCE.m4541getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m2070defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2070defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4541getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
