    ...
    public BottomDrawerState(BottomDrawerValue bottomDrawerValue, Function1<? super BottomDrawerValue, Boolean> function1) {
        ...
        AnchoredDraggableState<BottomDrawerValue> anchoredDraggableState = new AnchoredDraggableState<>(bottomDrawerValue, new Function1<Float, Float>() { // from class: androidx.compose.material.BottomDrawerState$anchoredDraggableState$1
            ...
            public final Float invoke(float f) {
                ...
                return Float.valueOf(requireDensity.mo677toPx0680j_4(f2));
            }
            ...
            public final Float invoke() {
                ...
                return Float.valueOf(requireDensity.mo677toPx0680j_4(f));
            }
        }, tweenSpec, function1);
        ...
        public final Saver<BottomDrawerState, BottomDrawerValue> Saver(final Density density, final Function1<? super BottomDrawerValue, Boolean> confirmStateChange) {
            return SaverKt.Saver(new Function2<SaverScope, BottomDrawerState, BottomDrawerValue>() { // from class: androidx.compose.material.BottomDrawerState$Companion$Saver$1
                ...
                public final BottomDrawerState invoke(BottomDrawerValue bottomDrawerValue) {
                    return DrawerKt.BottomDrawerState(bottomDrawerValue, Density.this, confirmStateChange);
                }
            });
        }
