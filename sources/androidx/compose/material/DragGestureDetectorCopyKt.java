...
public final class DragGestureDetectorCopyKt {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:38:0x011c -> B:17:0x0166). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:45:0x015a -> B:11:0x015c). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:49:0x0180 -> B:17:0x0166). Please report as a decompilation issue!!! */
    ...
    */
    ...
    private static final Object m1842awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        ...
        float m1844pointerSlopE8SPZFQ = m1844pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                if (Math.abs(floatValue) < m1844pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(floatValue - (Math.signum(floatValue) * m1844pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {
