...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m2027animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        State<Color> indicatorColor = textFieldColors.indicatorColor(z, z2, interactionSource, composer, (i & 14) | (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 896) | (i & 7168));
        ...
        if (z) {
            ...
            rememberUpdatedState = AnimateAsStateKt.m432animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1685713720);
            ComposerKt.sourceInformation(composer, "899@40002L46");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m6995boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().m7011unboximpl(), new SolidColor(indicatorColor.getValue().m4525unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
