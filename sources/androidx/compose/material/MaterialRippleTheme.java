...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1893defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m2071defaultRippleColor5vOe2sY = companion.m2071defaultRippleColor5vOe2sY(((Color) consume).m4525unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2071defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        Object consume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        RippleAlpha m2070defaultRippleAlphaDxMtmZc = companion.m2070defaultRippleAlphaDxMtmZc(((Color) consume).m4525unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2070defaultRippleAlphaDxMtmZc;
    }
}
