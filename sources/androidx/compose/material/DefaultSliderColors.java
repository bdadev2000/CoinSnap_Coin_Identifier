...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m4516equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m4516equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m4516equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m4516equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m4516equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m4516equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m4516equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m4516equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m4516equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m4522hashCodeimpl(this.thumbColor) * 31) + Color.m4522hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4522hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4522hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4522hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4522hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4522hashCodeimpl(this.activeTickColor)) * 31) + Color.m4522hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4522hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4522hashCodeimpl(this.disabledInactiveTickColor);
    }
}
