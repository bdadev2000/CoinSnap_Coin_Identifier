...
final class DefaultButtonElevation implements ButtonElevation {
    ...
    public State<Dp> elevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect(interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue2, composer, ((i >> 3) & 14) | 64);
        ...
        EffectsKt.LaunchedEffect(Dp.m6995boximpl(f2), new DefaultButtonElevation$elevation$2(animatable, f2, z, this, interaction, null), composer, 64);
