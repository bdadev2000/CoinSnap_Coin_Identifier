...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColors {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m418animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(182315262);
            ComposerKt.sourceInformation(composer, "640@27972L33");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public State<Color> backgroundColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(this.backgroundColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public State<Color> placeholderColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(z ? this.placeholderColor : this.disabledPlaceholderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public State<Color> textColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(z ? this.textColor : this.disabledTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public State<Color> cursorColor(boolean z, Composer composer, int i) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4505boximpl(z ? this.errorCursorColor : this.cursorColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.textColor, defaultTextFieldForExposedDropdownMenusColors.textColor) && Color.m4516equalsimpl0(this.disabledTextColor, defaultTextFieldForExposedDropdownMenusColors.disabledTextColor) && Color.m4516equalsimpl0(this.cursorColor, defaultTextFieldForExposedDropdownMenusColors.cursorColor) && Color.m4516equalsimpl0(this.errorCursorColor, defaultTextFieldForExposedDropdownMenusColors.errorCursorColor) && Color.m4516equalsimpl0(this.focusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.focusedIndicatorColor) && Color.m4516equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedIndicatorColor) && Color.m4516equalsimpl0(this.errorIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.errorIndicatorColor) && Color.m4516equalsimpl0(this.disabledIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.disabledIndicatorColor) && Color.m4516equalsimpl0(this.leadingIconColor, defaultTextFieldForExposedDropdownMenusColors.leadingIconColor) && Color.m4516equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledLeadingIconColor) && Color.m4516equalsimpl0(this.errorLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorLeadingIconColor) && Color.m4516equalsimpl0(this.trailingIconColor, defaultTextFieldForExposedDropdownMenusColors.trailingIconColor) && Color.m4516equalsimpl0(this.focusedTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.focusedTrailingIconColor) && Color.m4516equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledTrailingIconColor) && Color.m4516equalsimpl0(this.errorTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorTrailingIconColor) && Color.m4516equalsimpl0(this.backgroundColor, defaultTextFieldForExposedDropdownMenusColors.backgroundColor) && Color.m4516equalsimpl0(this.focusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.focusedLabelColor) && Color.m4516equalsimpl0(this.unfocusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedLabelColor) && Color.m4516equalsimpl0(this.disabledLabelColor, defaultTextFieldForExposedDropdownMenusColors.disabledLabelColor) && Color.m4516equalsimpl0(this.errorLabelColor, defaultTextFieldForExposedDropdownMenusColors.errorLabelColor) && Color.m4516equalsimpl0(this.placeholderColor, defaultTextFieldForExposedDropdownMenusColors.placeholderColor) && Color.m4516equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldForExposedDropdownMenusColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m4522hashCodeimpl(this.textColor) * 31) + Color.m4522hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4522hashCodeimpl(this.cursorColor)) * 31) + Color.m4522hashCodeimpl(this.errorCursorColor)) * 31) + Color.m4522hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m4522hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m4522hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m4522hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m4522hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m4522hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m4522hashCodeimpl(this.backgroundColor)) * 31) + Color.m4522hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m4522hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m4522hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m4522hashCodeimpl(this.errorLabelColor)) * 31) + Color.m4522hashCodeimpl(this.placeholderColor)) * 31) + Color.m4522hashCodeimpl(this.disabledPlaceholderColor);
    }
