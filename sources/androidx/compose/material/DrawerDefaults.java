...
public final class DrawerDefaults {
    ...
    private static final float Elevation = Dp.m6997constructorimpl(16);
    ...
    public final long getScrimColor(Composer composer, int i) {
        ...
        long m4514copywmQWz5c$default = Color.m4514copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1798getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
