...
public final class FloatingActionButtonDefaults {
    ...
    public final /* synthetic */ FloatingActionButtonElevation m1881elevationixp7dh8(float f, float f2, Composer composer, int i, int i2) {
        ...
        float m6997constructorimpl = (i2 & 1) != 0 ? Dp.m6997constructorimpl(6) : f;
        float m6997constructorimpl2 = (i2 & 2) != 0 ? Dp.m6997constructorimpl(12) : f2;
        ...
        float f3 = 8;
        FloatingActionButtonElevation m1882elevationxZ9QkE = m1882elevationxZ9QkE(m6997constructorimpl, m6997constructorimpl2, Dp.m6997constructorimpl(f3), Dp.m6997constructorimpl(f3), composer, (i & 14) | 3456 | (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | ((i << 6) & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1882elevationxZ9QkE;
    }
    ...
    public final FloatingActionButtonElevation m1882elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = Dp.m6997constructorimpl(6);
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = Dp.m6997constructorimpl(12);
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = Dp.m6997constructorimpl(8);
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Dp.m6997constructorimpl(8);
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object[] objArr = {Dp.m6995boximpl(f5), Dp.m6995boximpl(f6), Dp.m6995boximpl(f7), Dp.m6995boximpl(f8)};
