...
public final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1839apply7g2Lkgo(long j, float f, Composer composer, int i) {
        long m1864calculateForegroundColorCLU3JFs;
        ...
        if (Dp.m6996compareTo0680j_4(f, Dp.m6997constructorimpl(0)) > 0 && !colors.isLight()) {
            m1864calculateForegroundColorCLU3JFs = ElevationOverlayKt.m1864calculateForegroundColorCLU3JFs(j, f, composer, (i & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) | (i & 14));
            j = ColorKt.m4560compositeOverOWjLjI(m1864calculateForegroundColorCLU3JFs, j);
        }
        if (ComposerKt.isTraceInProgress()) {
