...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(Composer composer, int i) {
        ...
        long m4560compositeOverOWjLjI = ColorKt.m4560compositeOverOWjLjI(Color.m4514copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1798getOnSurface0d7_KjU(), 0.8f, 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m4560compositeOverOWjLjI;
    }

    public final long getPrimaryActionColor(Composer composer, int i) {
        long m1800getPrimaryVariant0d7_KjU;
        ...
        if (colors.isLight()) {
            m1800getPrimaryVariant0d7_KjU = ColorKt.m4560compositeOverOWjLjI(Color.m4514copywmQWz5c$default(colors.m1803getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), colors.m1799getPrimary0d7_KjU());
        } else {
            m1800getPrimaryVariant0d7_KjU = colors.m1800getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1800getPrimaryVariant0d7_KjU;
    }
}
