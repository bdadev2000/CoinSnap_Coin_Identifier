...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4263boximpl(Offset.INSTANCE.m4290getZeroF1C5BW0()), null, 2, null);
    ...
    public final void m1235setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m4263boximpl(j));
    }
    ...
    */
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        if (getLayoutInfo().getOrientation() != Orientation.Vertical ? Math.signum(scrollDelta) != Math.signum(-Offset.m4274getXimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) : Math.signum(scrollDelta) != Math.signum(-Offset.m4275getYimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release()))) {
    ...
    private final boolean isNotGestureAction() {
        return ((int) Offset.m4274getXimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m4275getYimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
