...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m6997constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        boolean z = ((((i2 & 14) ^ 6) > 4 && composer.changed(i)) || (i2 & 6) == 4) | ((((i2 & StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA) ^ 48) > 32 && composer.changed(f)) || (i2 & 48) == 32) | ((((i2 & 896) ^ 384) > 256 && composer.changed(function0)) || (i2 & 384) == 256);
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m4101rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int m7167getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m7167getWidthimpl(pagerLayoutInfo.mo1224getViewportSizeYbymL2g()) : IntSize.m7166getHeightimpl(pagerLayoutInfo.mo1224getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (m7167getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(m7167getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, m7167getWidthimpl)), 0L);
    }

    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int m7167getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m7167getWidthimpl(pagerMeasureResult.mo1224getViewportSizeYbymL2g()) : IntSize.m7166getHeightimpl(pagerMeasureResult.mo1224getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(m7167getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, m7167getWidthimpl);
    }
