...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m1220getOffsetBjo55l4 = m1220getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int m7125getXimpl = this.isVertical ? IntOffset.m7125getXimpl(m1220getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m7125getXimpl(m1220getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m7126getYimpl = (this.mainAxisLayoutSize - IntOffset.m7126getYimpl(m1220getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m7126getYimpl = IntOffset.m7126getYimpl(m1220getOffsetBjo55l4);
                }
                m1220getOffsetBjo55l4 = IntOffsetKt.IntOffset(m7125getXimpl, m7126getYimpl);
            }
            long m7129plusqkQi6aY = IntOffset.m7129plusqkQi6aY(m1220getOffsetBjo55l4, this.visualOffset);
            if (this.isVertical) {
                Placeable.PlacementScope.m5919placeWithLayeraW9wM$default(scope, placeable, m7129plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            } else {
                Placeable.PlacementScope.m5917placeRelativeWithLayeraW9wM$default(scope, placeable, m7129plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final long m1219copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int m7125getXimpl = this.isVertical ? IntOffset.m7125getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7125getXimpl(j))).intValue();
        boolean z = this.isVertical;
