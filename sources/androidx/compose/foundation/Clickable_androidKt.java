...
public final class Clickable_androidKt {
    ...
    public static final boolean m587isPressZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m5573equalsimpl0(KeyEvent_androidKt.m5581getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m5577getKeyDownCS__XNY()) && m586isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m585isClickZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m5573equalsimpl0(KeyEvent_androidKt.m5581getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m5578getKeyUpCS__XNY()) && m586isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m586isEnterZmokQxo(KeyEvent keyEvent) {
        int m5587getNativeKeyCodeYVgTNJs = Key_androidKt.m5587getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m5580getKeyZmokQxo(keyEvent));
        return m5587getNativeKeyCodeYVgTNJs == 23 || m5587getNativeKeyCodeYVgTNJs == 66 || m5587getNativeKeyCodeYVgTNJs == 160;
    }
}
