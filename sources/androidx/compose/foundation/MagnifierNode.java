...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m7104getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
    }
        ...
        if (this.anchorPositionInRootState == null) {
            this.anchorPositionInRootState = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode$anchorPositionInRoot$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m4263boximpl(m605invokeF1C5BW0());
                }
                ...
                public final long m605invokeF1C5BW0() {
                    ...
                    return layoutCoordinates != null ? LayoutCoordinatesKt.positionInRoot(layoutCoordinates) : Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
                }
            });
        }
        State<Offset> state = this.anchorPositionInRootState;
        return state != null ? state.getValue().getPackedValue() : Offset.INSTANCE.m4289getUnspecifiedF1C5BW0();
    }
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo631createnHHXs2Y(view2, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density2, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        ...
        Ld:
            ...
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m4293isSpecifiedk4lQ0M(r1)
            if (r3 == 0) goto L7d
            long r3 = r8.m597getAnchorPositionInRootF1C5BW0()
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m4293isSpecifiedk4lQ0M(r3)
            if (r3 == 0) goto L7d
            long r3 = r8.m597getAnchorPositionInRootF1C5BW0()
            long r1 = androidx.compose.ui.geometry.Offset.m4279plusMKHz9U(r3, r1)
            ...
            boolean r1 = androidx.compose.ui.geometry.OffsetKt.m4293isSpecifiedk4lQ0M(r1)
            if (r1 == 0) goto L50
            goto L51
        L50:
            r0 = 0
        L51:
            ...
            long r0 = androidx.compose.ui.geometry.Offset.m4279plusMKHz9U(r2, r0)
            goto L66
        L60:
            androidx.compose.ui.geometry.Offset$Companion r0 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r0 = r0.m4289getUnspecifiedF1C5BW0()
        L66:
            r5 = r0
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m7164equalsimpl(platformMagnifier.mo629getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m7083boximpl(density.mo675toDpSizekrfVVM(IntSizeKt.m7179toSizeozmzZPI(platformMagnifier.mo629getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m7159boximpl(platformMagnifier.mo629getSizeYbymL2g());
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m9801boximpl(channel.mo9791trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode$applySemantics$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m4263boximpl(m606invokeF1C5BW0());
            }
