...
public final class ContentInViewNode extends Modifier.Node implements BringIntoViewResponder, LayoutAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private long viewportSize = IntSize.INSTANCE.m7172getZeroYbymL2g();
    ...
    public Rect calculateRectForParent(Rect localRect) {
        if (!(!IntSize.m7165equalsimpl0(this.viewportSize, IntSize.INSTANCE.m7172getZeroYbymL2g()))) {
    ...
    public Object bringChildIntoView(Function0<Rect> function0, Continuation<? super Unit> continuation) {
        ...
        if (invoke == null || m703isMaxVisibleO0kMr_c$default(this, invoke, 0L, 1, null)) {
    ...
    public final float calculateScrollDelta(BringIntoViewSpec bringIntoViewSpec) {
        ...
        long m7179toSizeozmzZPI = IntSizeKt.m7179toSizeozmzZPI(this.viewportSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return bringIntoViewSpec.calculateScrollDistance(findBringIntoViewRequest.getTop(), findBringIntoViewRequest.getBottom() - findBringIntoViewRequest.getTop(), Size.m4340getHeightimpl(m7179toSizeozmzZPI));
        }
        if (i == 2) {
            return bringIntoViewSpec.calculateScrollDistance(findBringIntoViewRequest.getLeft(), findBringIntoViewRequest.getRight() - findBringIntoViewRequest.getLeft(), Size.m4343getWidthimpl(m7179toSizeozmzZPI));
        }
    ...
    private final Rect findBringIntoViewRequest() {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (invoke != null) {
                    if (m700compareToiLBOSCw(invoke.m4307getSizeNHjbRc(), IntSizeKt.m7179toSizeozmzZPI(this.viewportSize)) > 0) {
    ...
    private final Rect m701computeDestinationO0kMr_c(Rect childBounds, long containerSize) {
        return childBounds.m4311translatek4lQ0M(Offset.m4283unaryMinusF1C5BW0(m704relocationOffsetBMxPBkI(childBounds, containerSize)));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: isMaxVisible-O0kMr_c$default, reason: not valid java name */
    public static /* synthetic */ boolean m703isMaxVisibleO0kMr_c$default(ContentInViewNode contentInViewNode, Rect rect, long j, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    private final boolean m702isMaxVisibleO0kMr_c(Rect rect, long j) {
        long m704relocationOffsetBMxPBkI = m704relocationOffsetBMxPBkI(rect, j);
        return Math.abs(Offset.m4274getXimpl(m704relocationOffsetBMxPBkI)) <= 0.5f && Math.abs(Offset.m4275getYimpl(m704relocationOffsetBMxPBkI)) <= 0.5f;
    }

    /* renamed from: relocationOffset-BMxPBkI, reason: not valid java name */
    private final long m704relocationOffsetBMxPBkI(Rect childBounds, long containerSize) {
        long m7179toSizeozmzZPI = IntSizeKt.m7179toSizeozmzZPI(containerSize);
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return OffsetKt.Offset(0.0f, requireBringIntoViewSpec().calculateScrollDistance(childBounds.getTop(), childBounds.getBottom() - childBounds.getTop(), Size.m4340getHeightimpl(m7179toSizeozmzZPI)));
        }
        if (i == 2) {
            return OffsetKt.Offset(requireBringIntoViewSpec().calculateScrollDistance(childBounds.getLeft(), childBounds.getRight() - childBounds.getLeft(), Size.m4343getWidthimpl(m7179toSizeozmzZPI)), 0.0f);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final int m699compareToTemP2vQ(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Intrinsics.compare(IntSize.m7166getHeightimpl(j), IntSize.m7166getHeightimpl(j2));
        }
        if (i == 2) {
            return Intrinsics.compare(IntSize.m7167getWidthimpl(j), IntSize.m7167getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final int m700compareToiLBOSCw(long j, long j2) {
        int i = WhenMappings.$EnumSwitchMapping$0[this.orientation.ordinal()];
        if (i == 1) {
            return Float.compare(Size.m4340getHeightimpl(j), Size.m4340getHeightimpl(j2));
        }
        if (i == 2) {
            return Float.compare(Size.m4343getWidthimpl(j), Size.m4343getWidthimpl(j2));
        }
        throw new NoWhenBranchMatchedException();
    }
