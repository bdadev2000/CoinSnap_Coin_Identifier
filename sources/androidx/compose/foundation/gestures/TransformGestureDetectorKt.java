...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long m4278minusMKHz9U = Offset.m4278minusMKHz9U(pointerInputChange2.getPreviousPosition(), calculateCentroid2);
                long m4278minusMKHz9U2 = Offset.m4278minusMKHz9U(position, calculateCentroid);
                float m812anglek4lQ0M = m812anglek4lQ0M(m4278minusMKHz9U2) - m812anglek4lQ0M(m4278minusMKHz9U);
                float m4272getDistanceimpl = Offset.m4272getDistanceimpl(Offset.m4279plusMKHz9U(m4278minusMKHz9U2, m4278minusMKHz9U)) / 2.0f;
                if (m812anglek4lQ0M > 180.0f) {
                    m812anglek4lQ0M -= 360.0f;
                } else if (m812anglek4lQ0M < -180.0f) {
                    m812anglek4lQ0M += 360.0f;
                }
                f2 += m812anglek4lQ0M * m4272getDistanceimpl;
                f += m4272getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m812anglek4lQ0M(long j) {
        if (Offset.m4274getXimpl(j) == 0.0f && Offset.m4275getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m4274getXimpl(j), Offset.m4275getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m4271equalsimpl0(calculateCentroid, Offset.INSTANCE.m4289getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m4290getZeroF1C5BW0();
        }
        return Offset.m4278minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m4272getDistanceimpl(Offset.m4278minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m4290getZeroF1C5BW0 = Offset.m4279plusMKHz9U(m4290getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m4269divtuRUvjQ(m4290getZeroF1C5BW0, i);
    }
}
