...
public final class DraggableKt {
    ...
    public static final float m750toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m4275getYimpl(j) : Offset.m4274getXimpl(j);
    }

    /* renamed from: toFloat-sF-c-tU */
    public static final float m751toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7235getYimpl(j) : Velocity.m7234getXimpl(j);
    }

    /* renamed from: toValidVelocity-TH1AsA0 */
    public static final long m752toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m7234getXimpl(j)) ? 0.0f : Velocity.m7234getXimpl(j), Float.isNaN(Velocity.m7235getYimpl(j)) ? 0.0f : Velocity.m7235getYimpl(j));
    }
}
