...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo698calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        ...
        Offset m4263boximpl = Offset.m4263boximpl(Offset.INSTANCE.m4290getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m4263boximpl = Offset.m4263boximpl(Offset.m4279plusMKHz9U(m4263boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m4281timestuRUvjQ(m4263boximpl.getPackedValue(), -density.mo677toPx0680j_4(Dp.m6997constructorimpl(64)));
    }
}
