...
final class Draggable2DNode$onDragStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public Draggable2DNode$onDragStarted$1(Draggable2DNode draggable2DNode, long j, Continuation<? super Draggable2DNode$onDragStarted$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Offset m4263boximpl = Offset.m4263boximpl(this.$startedPosition);
            this.label = 1;
            if (function3.invoke(coroutineScope, m4263boximpl, this) == coroutine_suspended) {
