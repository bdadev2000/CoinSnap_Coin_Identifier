...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        float m795toFloatTH1AsA0;
        Ref.LongRef longRef;
        ScrollingLogic scrollingLogic2;
        long j;
        long m796updateQWom1Mo;
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m802toFloatk4lQ0M(nestedScrollScope.mo759scrollByWithOverscrollOzD1aCk(scrollingLogic4.m800reverseIfNeededMKHz9U(scrollingLogic4.m803toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5616getSideEffectWNlRxjI())));
                }
            };
            ...
            m795toFloatTH1AsA0 = scrollingLogic.m795toFloatTH1AsA0(j2);
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(m795toFloatTH1AsA0);
        ...
        m796updateQWom1Mo = scrollingLogic.m796updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
        longRef.element = m796updateQWom1Mo;
