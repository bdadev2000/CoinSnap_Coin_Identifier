...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/foundation/gestures/Drag2DScope;"}, k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        if (i == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode$drag$2.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    long m746reverseIfNeededMKHz9U;
                    Drag2DScope drag2DScope2 = Drag2DScope.this;
                    m746reverseIfNeededMKHz9U = draggable2DNode.m746reverseIfNeededMKHz9U(dragDelta.getDelta());
                    drag2DScope2.mo707dragByk4lQ0M(m746reverseIfNeededMKHz9U);
                }
            };
            this.label = 1;
