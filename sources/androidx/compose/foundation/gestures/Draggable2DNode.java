...
public final class Draggable2DNode extends DragGestureNode {
    ...
    */
    ...
    public void mo694onDragStartedk4lQ0M(long startedPosition) {
        ...
        this.onDragStart.invoke(Offset.m4263boximpl(startedPosition));
        if (getIsAttached()) {
    ...
    public void mo695onDragStoppedTH1AsA0(long velocity) {
        ...
        this.onDragStop.invoke(Velocity.m7225boximpl(velocity));
        if (getIsAttached()) {
    ...
    public final long m745reverseIfNeededAH228Gc(long j) {
        return Velocity.m7240timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m746reverseIfNeededMKHz9U(long j) {
        return Offset.m4281timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
