...
public final class BorderKt {
    ...
    public static final DrawResult m554drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m4290getZeroF1C5BW0 = z ? Offset.INSTANCE.m4290getZeroF1C5BW0() : j;
        final long m4164getSizeNHjbRc = z ? cacheDrawScope.m4164getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m5064drawRectAsUm42w$default(contentDrawScope, Brush.this, m4290getZeroF1C5BW0, m4164getSizeNHjbRc, 0.0f, stroke, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo4407opN5in7k0(path, Path, PathOperation.INSTANCE.m4807getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m555shrinkKibmq7A(roundRect.m4324getTopLeftCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4325getTopRightCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4323getBottomRightCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4322getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m555shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m4249getXimpl(j) - f), Math.max(0.0f, CornerRadius.m4250getYimpl(j) - f));
    }
}
