...
public final class OverscrollConfiguration {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4516equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
    }

    public int hashCode() {
        return (Color.m4522hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m4523toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}
