...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }

    public int hashCode() {
        return (Dp.m7003hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m7008toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
