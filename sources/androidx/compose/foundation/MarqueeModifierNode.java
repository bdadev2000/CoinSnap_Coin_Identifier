...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m611boximpl(i2), null, 2, null);
    ...
    public final void m627updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        ...
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m7002equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m6967constrainWidthK40F9xA(j, mo5851measureBRTryo0.getWidth()));
        setContentWidth(mo5851measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), mo5851measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m4340getHeightimpl = Size.m4340getHeightimpl(contentDrawScope2.mo5071getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo4995clipRectN_I0leg(floatValue, 0.0f, containerWidth, m4340getHeightimpl, m4504getIntersectrtfAjoo);
            if (z) {
