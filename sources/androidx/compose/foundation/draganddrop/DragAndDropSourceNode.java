    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                C00121 c00121 = new C00121(pointerInputScope, this.$dragAndDropModifierNode, DragAndDropSourceNode.this);
                this.label = 1;
                if (dragAndDropSourceHandler.invoke(c00121, this) == coroutine_suspended) {
        ...
        /* loaded from: classes.dex */
        public static final class C00121 implements DragAndDropSourceScope, PointerInputScope {
            ...
            C00121(PointerInputScope pointerInputScope, DragAndDropModifierNode dragAndDropModifierNode, DragAndDropSourceNode dragAndDropSourceNode) {
                this.$dragAndDropModifierNode = dragAndDropModifierNode;
            ...
            public void startTransfer(DragAndDropTransferData transferData) {
                this.$dragAndDropModifierNode.mo4146drag12SF9DM(transferData, IntSizeKt.m7179toSizeozmzZPI(getBoundsSize()), this.this$0.getDrawDragDecoration());
            }
        }
    }
