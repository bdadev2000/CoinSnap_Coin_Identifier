...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(Constraints.m6941copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m6950getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m6949getMaxHeightimpl(j), 5, null));
        int coerceAtMost = RangesKt.coerceAtMost(mo5851measureBRTryo0.getWidth(), Constraints.m6950getMaxWidthimpl(j));
        int coerceAtMost2 = RangesKt.coerceAtMost(mo5851measureBRTryo0.getHeight(), Constraints.m6949getMaxHeightimpl(j));
        final int height = mo5851measureBRTryo0.getHeight() - coerceAtMost2;
        int width = mo5851measureBRTryo0.getWidth() - coerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
