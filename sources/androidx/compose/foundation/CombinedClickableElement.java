...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m6267hashCodeimpl = (((hashCode3 + (role != null ? Role.m6267hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode4 = (m6267hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
