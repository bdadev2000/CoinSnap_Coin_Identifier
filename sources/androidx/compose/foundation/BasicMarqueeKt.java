...
public final class BasicMarqueeKt {
    ...
    public static final AnimationSpec<Float> m547createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo677toPx0680j_4(f2)), f, i3);
        long m478constructorimpl$default = StartOffset.m478constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m443infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m478constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m445repeatable91I0pcU$default(i, velocityBasedTween, null, m478constructorimpl$default, 4, null);
    }
