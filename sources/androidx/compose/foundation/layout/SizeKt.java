...
public final class SizeKt {
    ...
    public static final Modifier m1035width3ABfNKs(Modifier modifier, final float f) {
        return modifier.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m6995boximpl(f));
            }
    ...
    public static final Modifier m1031size6HolHcs(Modifier modifier, long j) {
        return m1032sizeVpY3zN4(modifier, DpSize.m7095getWidthD9Ej5fM(j), DpSize.m7093getHeightD9Ej5fM(j));
    }
    ...
    public static final Modifier m1036widthInVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m6995boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m6995boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }
    ...
    public static /* synthetic */ Modifier m1034sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM();
        }
    ...
    public static final Modifier m1033sizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m6995boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m6995boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m6995boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m6995boximpl(f4));
            }
    ...
    public static final Modifier m1023requiredSize6HolHcs(Modifier modifier, long j) {
        return m1024requiredSizeVpY3zN4(modifier, DpSize.m7095getWidthD9Ej5fM(j), DpSize.m7093getHeightD9Ej5fM(j));
    }
    ...
    public static final Modifier m1030size3ABfNKs(Modifier modifier, final float f) {
        return modifier.then(new SizeElement(f, f, f, f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(LogEventArguments.ARG_SIZE);
                inspectorInfo.setValue(Dp.m6995boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }
    ...
    public static final Modifier m1032sizeVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName(LogEventArguments.ARG_SIZE);
                inspectorInfo.getProperties().set("width", Dp.m6995boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m6995boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }
