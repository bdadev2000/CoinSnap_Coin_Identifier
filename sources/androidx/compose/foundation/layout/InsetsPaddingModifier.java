...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(ConstraintsKt.m6969offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m6967constrainWidthK40F9xA(j, mo5851measureBRTryo0.getWidth() + right), ConstraintsKt.m6966constrainHeightK40F9xA(j, mo5851measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
