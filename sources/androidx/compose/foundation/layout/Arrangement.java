...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m6997constructorimpl(0);
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m6997constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m6997constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m6997constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m7002equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            int m7003hashCodeimpl = ((Dp.m7003hashCodeimpl(this.space) * 31) + Boolean.hashCode(this.rtlMirror)) * 31;
            Function2<Integer, LayoutDirection, Integer> function2 = this.alignment;
            return m7003hashCodeimpl + (function2 == null ? 0 : function2.hashCode());
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            int mo671roundToPx0680j_4 = density.mo671roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i4 < length) {
                    ...
                    iArr2[i5] = min;
                    int min2 = Math.min(mo671roundToPx0680j_4, (i - min) - i6);
                ...
                for (int length2 = iArr.length - 1; -1 < length2; length2--) {
                    ...
                    iArr2[length2] = min3;
                    i3 = Math.min(mo671roundToPx0680j_4, (i - min3) - i8);
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m7008toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
