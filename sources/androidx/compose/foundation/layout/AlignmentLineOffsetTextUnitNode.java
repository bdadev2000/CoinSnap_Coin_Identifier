...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m834alignmentLineOffsetMeasuretjqqzMA;
        m834alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m834alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m7208isUnspecifiedR2X_6o(this.before) ? measureScope.mo672toDpGaN1DYA(this.before) : Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM(), !TextUnitKt.m7208isUnspecifiedR2X_6o(this.after) ? measureScope.mo672toDpGaN1DYA(this.after) : Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM(), measurable, j);
        return m834alignmentLineOffsetMeasuretjqqzMA;
    }
}
