...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.x, offsetElement.x) && Dp.m7002equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m7003hashCodeimpl(this.x) * 31) + Dp.m7003hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m7008toStringimpl(this.x)) + ", y=" + ((Object) Dp.m7008toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
