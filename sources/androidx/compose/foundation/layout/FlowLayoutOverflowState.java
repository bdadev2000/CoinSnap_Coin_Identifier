...
public final /* data */ class FlowLayoutOverflowState {
    ...
    public final void m915setOverflowMeasurableshBUhpc$foundation_layout_release(IntrinsicMeasurable seeMoreMeasurable, IntrinsicMeasurable collapseMeasurable, boolean isHorizontal, long constraints) {
        long m954constructorimpl = OrientationIndependentConstraints.m954constructorimpl(constraints, isHorizontal ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (seeMoreMeasurable != null) {
            int mainAxisMin = FlowLayoutKt.mainAxisMin(seeMoreMeasurable, isHorizontal, Constraints.m6949getMaxHeightimpl(m954constructorimpl));
            this.seeMoreSize = IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(mainAxisMin, FlowLayoutKt.crossAxisMin(seeMoreMeasurable, isHorizontal, mainAxisMin)));
        ...
        if (collapseMeasurable != null) {
            int mainAxisMin2 = FlowLayoutKt.mainAxisMin(collapseMeasurable, isHorizontal, Constraints.m6949getMaxHeightimpl(m954constructorimpl));
            this.collapseSize = IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(mainAxisMin2, FlowLayoutKt.crossAxisMin(collapseMeasurable, isHorizontal, mainAxisMin2)));
    ...
    public final void m914setOverflowMeasurableshBUhpc$foundation_layout_release(final FlowLineMeasurePolicy measurePolicy, Measurable seeMoreMeasurable, Measurable collapseMeasurable, long constraints) {
        ...
        long m967toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m967toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m956copyyUG9Ft0$default(OrientationIndependentConstraints.m954constructorimpl(constraints, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (seeMoreMeasurable != null) {
            FlowLayoutKt.m911measureAndCacherqJ1uqs(seeMoreMeasurable, measurePolicy, m967toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$3$1
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    FlowLayoutOverflowState.this.seeMoreSize = IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(i, i2));
        ...
        if (collapseMeasurable != null) {
            FlowLayoutKt.m911measureAndCacherqJ1uqs(collapseMeasurable, measurePolicy, m967toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$setOverflowMeasurables$4$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final void invoke2(Placeable placeable) {
                    ...
                    FlowLayoutOverflowState.this.collapseSize = IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(i, i2));
