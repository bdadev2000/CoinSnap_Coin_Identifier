...
final class IntrinsicHeightNode extends IntrinsicSizeModifier {
    ...
    public long mo939calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.height == IntrinsicSize.Min) {
            maxIntrinsicHeight = measurable.minIntrinsicHeight(Constraints.m6950getMaxWidthimpl(j));
        } else {
            maxIntrinsicHeight = measurable.maxIntrinsicHeight(Constraints.m6950getMaxWidthimpl(j));
        }
        if (maxIntrinsicHeight < 0) {
            maxIntrinsicHeight = 0;
        }
        return Constraints.INSTANCE.m6961fixedHeightOenEA2s(maxIntrinsicHeight);
    }
