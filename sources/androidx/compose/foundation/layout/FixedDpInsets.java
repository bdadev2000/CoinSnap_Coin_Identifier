...
final class FixedDpInsets implements WindowInsets {
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m7008toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m7008toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m7008toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m7008toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m7002equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m7002equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m7002equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m7003hashCodeimpl(this.leftDp) * 31) + Dp.m7003hashCodeimpl(this.topDp)) * 31) + Dp.m7003hashCodeimpl(this.rightDp)) * 31) + Dp.m7003hashCodeimpl(this.bottomDp);
    }
}
