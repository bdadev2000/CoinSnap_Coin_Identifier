...
public final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m7017getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m7002equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m7002equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m7002equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m7003hashCodeimpl(this.minWidth) * 31) + Dp.m7003hashCodeimpl(this.minHeight)) * 31) + Dp.m7003hashCodeimpl(this.maxWidth)) * 31) + Dp.m7003hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
