...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m7002equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m7002equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m7002equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m7003hashCodeimpl(this.start) * 31) + Dp.m7003hashCodeimpl(this.top)) * 31) + Dp.m7003hashCodeimpl(this.end)) * 31) + Dp.m7003hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m7008toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7008toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7008toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7008toStringimpl(this.bottom)) + ')';
    }
