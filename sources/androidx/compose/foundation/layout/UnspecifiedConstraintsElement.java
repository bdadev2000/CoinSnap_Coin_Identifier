...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m6995boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m6995boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7002equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m7002equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7003hashCodeimpl(this.minWidth) * 31) + Dp.m7003hashCodeimpl(this.minHeight);
    }
}
