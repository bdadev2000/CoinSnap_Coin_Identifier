...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    private final long m1199childConstraintsJhjzzOo(int slot, int span) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6962fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m6961fixedHeightOenEA2s(i);
    }
    ...
    public final LazyStaggeredGridMeasuredItem m1200getAndMeasurejy6DScQ(int index, long span) {
        ...
        long m1199childConstraintsJhjzzOo = m1199childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return mo1193createItempitSLOA(index, coerceAtMost, coerceAtMost2, key, contentType, this.measureScope.mo1156measure0kLqBqw(index, m1199childConstraintsJhjzzOo), m1199childConstraintsJhjzzOo);
    }
