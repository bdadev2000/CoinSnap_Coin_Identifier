...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m7125getXimpl(getOffset()) : IntOffset.m7126getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope, LazyStaggeredGridMeasureContext context) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (animation != null) {
                ...
                if ((m1202getMainAxisgyyYBs(offset) <= height && m1202getMainAxisgyyYBs(m7129plusqkQi6aY) <= height) || (m1202getMainAxisgyyYBs(offset) >= i2 && m1202getMainAxisgyyYBs(m7129plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    m7125getXimpl = IntOffset.m7125getXimpl(offset);
                } else {
                    m7125getXimpl = (this.mainAxisLayoutSize - IntOffset.m7125getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    m7126getYimpl = IntOffset.m7126getYimpl(offset);
                } else {
                    m7126getYimpl = (this.mainAxisLayoutSize - IntOffset.m7126getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffsetKt.IntOffset(m7125getXimpl, m7126getYimpl);
            }
            long m7129plusqkQi6aY2 = IntOffset.m7129plusqkQi6aY(offset, context.getContentOffset());
            if (animation != null) {
