...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int m6952getMinWidthimpl = round != Integer.MAX_VALUE ? round : Constraints.m6952getMinWidthimpl(j);
        int m6951getMinHeightimpl = round2 != Integer.MAX_VALUE ? round2 : Constraints.m6951getMinHeightimpl(j);
        if (round == Integer.MAX_VALUE) {
            round = Constraints.m6950getMaxWidthimpl(j);
        }
        if (round2 == Integer.MAX_VALUE) {
            round2 = Constraints.m6949getMaxHeightimpl(j);
        }
        final Placeable mo5851measureBRTryo0 = measurable.mo5851measureBRTryo0(ConstraintsKt.Constraints(m6952getMinWidthimpl, round, m6951getMinHeightimpl, round2));
        return MeasureScope.layout$default(measureScope, mo5851measureBRTryo0.getWidth(), mo5851measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
