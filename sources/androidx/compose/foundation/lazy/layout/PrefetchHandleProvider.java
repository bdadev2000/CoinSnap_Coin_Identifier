...
public final class PrefetchHandleProvider {
    ...
    public final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m6954isZeroimpl(this.constraints)) {
        ...
        private final void m1171performMeasureBRTryo0(long constraints) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo5877premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m6955toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
