...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo1138layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        T t = null;
        while (t == null && m1135hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t2 = (T) m1134addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    boolean m1135hasMoreContentFR3nfPY;
                    m1135hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierLocal.this.m1135hasMoreContentFR3nfPY(objectRef.element, direction);
                    return m1135hasMoreContentFR3nfPY;
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1136isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5837getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5836getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5835getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5838getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5839getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5840getRighthoxUOeE())) {
    ...
    private final boolean m1137isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5835getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5838getBelowhoxUOeE())) {
            if (this.orientation == Orientation.Horizontal) {
                return true;
            }
        } else if (BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5839getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5840getRighthoxUOeE())) {
            if (this.orientation == Orientation.Vertical) {
                return true;
            }
        } else if (!BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5837getBeforehoxUOeE()) && !BeyondBoundsLayout.LayoutDirection.m5831equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5836getAfterhoxUOeE())) {
            LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
            throw new KotlinNothingValueException();
        }
        return false;
