...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m7135getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m7116boximpl(IntOffset.INSTANCE.m7135getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        ...
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7116boximpl(IntOffset.INSTANCE.m7135getZeronOccac()), null, 2, null);
    ...
    public final void m1140setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m7116boximpl(j));
    }
    ...
    public final void m1141animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        ...
        long m7128minusqkQi6aY = IntOffset.m7128minusqkQi6aY(m1144getPlacementDeltanOccac(), delta);
        m1140setPlacementDeltagyyYBs(m7128minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, m7128minusqkQi6aY, null), 3, null);
    }
    ...
    public final void release() {
        ...
        m1140setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7135getZeronOccac());
