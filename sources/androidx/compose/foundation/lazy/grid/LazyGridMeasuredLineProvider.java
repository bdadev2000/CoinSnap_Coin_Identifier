...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1130childConstraintsJhjzzOo$foundation_release(int startSlot, int span) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6962fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.INSTANCE.m6961fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int m1108getCurrentLineSpanimpl = GridItemSpan.m1108getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem m1129getAndMeasurem8Kt_7k = this.measuredItemProvider.m1129getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m1130childConstraintsJhjzzOo$foundation_release(i2, m1108getCurrentLineSpanimpl), i2, m1108getCurrentLineSpanimpl, i);
            i2 += m1108getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = m1129getAndMeasurem8Kt_7k;
        }
