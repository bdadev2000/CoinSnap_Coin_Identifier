...
public abstract class LazyGridMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public final LazyGridMeasuredItem m1129getAndMeasurem8Kt_7k(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        ...
        List<Placeable> mo1156measure0kLqBqw = this.measureScope.mo1156measure0kLqBqw(index, constraints);
        if (Constraints.m6948getHasFixedWidthimpl(constraints)) {
            m6951getMinHeightimpl = Constraints.m6952getMinWidthimpl(constraints);
        } else {
        ...
        return mo1124createItemO3s9Psw(index, key, contentType, m6951getMinHeightimpl, mainAxisSpacing, mo1156measure0kLqBqw, constraints, lane, span);
    }
