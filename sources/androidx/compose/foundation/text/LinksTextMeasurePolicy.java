...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6950getMaxWidthimpl(j), Constraints.m6949getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (access$measureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        Placeable.PlacementScope.m5915place70tqf50$default(placementScope, placeable, function02 != null ? ((IntOffset) function02.invoke()).getPackedValue() : IntOffset.INSTANCE.m7135getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
