...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6465getZerod9O1mEE();
    ...
    public final int m1386getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6460getStartimpl(selection) != TextRange.m6460getStartimpl(this.previousSelection) ? TextRange.m6460getStartimpl(selection) : TextRange.m6455getEndimpl(selection) != TextRange.m6455getEndimpl(this.previousSelection) ? TextRange.m6455getEndimpl(selection) : TextRange.m6458getMinimpl(selection);
    }
