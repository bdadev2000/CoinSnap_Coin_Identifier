...
public final class TextLayoutResultProxy {
    ...
    public final int m1395getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        return this.value.m6432getOffsetForPositionk4lQ0M(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m4275getYimpl(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1393coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m1396isPositionOnTextk4lQ0M(long r4) {
        long m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1393coercedInVisibleBoundsOfInputTextMKHz9U(r4));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m4275getYimpl(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release));
        return Offset.m4274getXimpl(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m4274getXimpl(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release */
    public final long m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long r5) {
        ...
        return layoutCoordinates3 == null ? r5 : layoutCoordinates2.mo5860localPositionOfR5De75A(layoutCoordinates3, r5);
    }

    /* renamed from: translateInnerToDecorationCoordinates-MK-Hz9U$foundation_release */
    public final long m1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long r5) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 == null) {
            return r5;
        ...
        LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
        return layoutCoordinates3 == null ? r5 : layoutCoordinates3.mo5860localPositionOfR5De75A(layoutCoordinates2, r5);
    }
