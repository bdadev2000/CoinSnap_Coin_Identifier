...
final class BasicTextFieldKt$DefaultTextFieldDecorator$1 implements TextFieldDecorator {
    ...
    public final void Decoration(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Decoration)487@23326L4:BasicTextField.kt#423gt5");
        if ((i & 6) == 0) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.BasicTextFieldKt$DefaultTextFieldDecorator$1$Decoration$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    BasicTextFieldKt$DefaultTextFieldDecorator$1.this.Decoration(function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
