...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m1372layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            TextLayoutResult m1359layoutNN6EwU = textDelegate.m1359layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m7167getWidthimpl(m1359layoutNN6EwU.getSize())), Integer.valueOf(IntSize.m7166getHeightimpl(m1359layoutNN6EwU.getSize())), m1359layoutNN6EwU);
        }
        ...
        public final void m1371drawQ1vqE60$foundation_release(Canvas canvas, TextFieldValue value, long selectionPreviewHighlightRange, long deletionPreviewHighlightRange, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint highlightPaint, long selectionBackgroundColor) {
            if (!TextRange.m6454getCollapsedimpl(selectionPreviewHighlightRange)) {
                highlightPaint.mo4394setColor8_81llA(selectionBackgroundColor);
                m1368drawHighlightLepunE(canvas, selectionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m6454getCollapsedimpl(deletionPreviewHighlightRange)) {
                Color m4505boximpl = Color.m4505boximpl(textLayoutResult.getLayoutInput().getStyle().m6490getColor0d7_KjU());
                if (m4505boximpl.m4525unboximpl() == 16) {
                    m4505boximpl = null;
                }
                long m4525unboximpl = m4505boximpl != null ? m4505boximpl.m4525unboximpl() : Color.INSTANCE.m4541getBlack0d7_KjU();
                highlightPaint.mo4394setColor8_81llA(Color.m4514copywmQWz5c$default(m4525unboximpl, Color.m4517getAlphaimpl(m4525unboximpl) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null));
                m1368drawHighlightLepunE(canvas, deletionPreviewHighlightRange, offsetMapping, textLayoutResult, highlightPaint);
            } else if (!TextRange.m6454getCollapsedimpl(value.getSelection())) {
                highlightPaint.mo4394setColor8_81llA(selectionBackgroundColor);
        ...
        private final void m1368drawHighlightLepunE(Canvas canvas, long range, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint paint) {
            int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m6458getMinimpl(range));
            int originalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m6457getMaximpl(range));
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            Rect rect;
            if (hasFocus) {
                int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m6457getMaximpl(value.getSelection()));
                ...
                long mo5862localToRootMKHz9U = layoutCoordinates.mo5862localToRootMKHz9U(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                textInputSession.notifyFocusedRect(RectKt.m4314Recttz77jQw(OffsetKt.Offset(Offset.m4274getXimpl(mo5862localToRootMKHz9U), Offset.m4275getYimpl(mo5862localToRootMKHz9U)), SizeKt.Size(rect.getWidth(), rect.getHeight())));
            }
        }
        ...
        public final void updateTextLayoutResult$foundation_release(TextInputSession textInputSession, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResult) {
            ...
            textInputSession.updateTextLayoutResult(textFieldValue, offsetMapping, textLayoutResult.getValue(), new Function1<Matrix, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$updateTextLayoutResult$1$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                    m1374invoke58bKbWc(matrix.m4767unboximpl());
                ...
                public final void m1374invoke58bKbWc(float[] fArr) {
                    if (LayoutCoordinates.this.isAttached()) {
                        LayoutCoordinatesKt.findRootCoordinates(LayoutCoordinates.this).mo5866transformFromEL8BTi8(LayoutCoordinates.this, fArr);
                    }
                }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.m6702copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
        ...
        public final TransformedText m1370applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            int originalToTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m6460getStartimpl(compositionRange));
            int originalToTransformed2 = transformed.getOffsetMapping().originalToTransformed(TextRange.m6455getEndimpl(compositionRange));
