...
public final class LegacyTextFieldState {
    ...
    public LegacyTextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope, SoftwareKeyboardController softwareKeyboardController) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6995boximpl(Dp.m6997constructorimpl(0)), null, 2, null);
        ...
        this.onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
            ...
            public final void invoke2(TextFieldValue textFieldValue) {
                ...
                LegacyTextFieldState.this.m1325setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6465getZerod9O1mEE());
                LegacyTextFieldState.this.m1322setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6465getZerod9O1mEE());
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
            ...
            public final void m1327invokeKlQnJC8(int i) {
                ...
                keyboardActionRunner.m1303runActionKlQnJC8(i);
            }
        };
        this.highlightPaint = AndroidPaint_androidKt.Paint();
        this.selectionBackgroundColor = Color.INSTANCE.m4551getUnspecified0d7_KjU();
        mutableStateOf$default10 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6448boximpl(TextRange.INSTANCE.m6465getZerod9O1mEE()), null, 2, null);
        this.selectionPreviewHighlightRange = mutableStateOf$default10;
        mutableStateOf$default11 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m6448boximpl(TextRange.INSTANCE.m6465getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1319getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m7011unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1323setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m6995boximpl(f));
    }
    ...
    public final void m1325setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m6448boximpl(j));
    }
    ...
    public final void m1322setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m6448boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m6454getCollapsedimpl(m1321getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m6454getCollapsedimpl(m1318getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }
    ...
    public final void m1326updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate m1361updateTextDelegaterm0N8CA$default = TextDelegateKt.m1361updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != m1361updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m1361updateTextDelegaterm0N8CA$default;
    }
}
