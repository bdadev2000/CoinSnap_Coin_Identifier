...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m6697getPasswordPjHm6EE(), 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6673getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? null : bool, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6700getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6646getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool2, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    /* compiled from: KeyboardOptions.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007R\u001c\u0010\b\u001a\u00020\u00048\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\t\u0010\u0002\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, d2 = {"Landroidx/compose/foundation/text/KeyboardOptions$Companion;", "", "()V", Profile.DEFAULT_PROFILE_NAME, "Landroidx/compose/foundation/text/KeyboardOptions;", "getDefault$annotations", "getDefault", "()Landroidx/compose/foundation/text/KeyboardOptions;", "SecureTextField", "getSecureTextField$foundation_release$annotations", "getSecureTextField$foundation_release", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6673getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6700getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6646getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6673getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6700getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6638getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6671getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6699getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6638getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1308getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization m6658boximpl = KeyboardCapitalization.m6658boximpl(this.capitalization);
        if (KeyboardCapitalization.m6661equalsimpl0(m6658boximpl.getValue(), KeyboardCapitalization.INSTANCE.m6673getUnspecifiedIUNYP9k())) {
            m6658boximpl = null;
        }
        return m6658boximpl != null ? m6658boximpl.getValue() : KeyboardCapitalization.INSTANCE.m6671getNoneIUNYP9k();
    }
    ...
    private final int m1309getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType m6675boximpl = KeyboardType.m6675boximpl(this.keyboardType);
        if (KeyboardType.m6678equalsimpl0(m6675boximpl.getValue(), KeyboardType.INSTANCE.m6700getUnspecifiedPjHm6EE())) {
            m6675boximpl = null;
        }
        return m6675boximpl != null ? m6675boximpl.getValue() : KeyboardType.INSTANCE.m6699getTextPjHm6EE();
    }
    ...
    public final int m1316getImeActionOrDefaulteUduSuo$foundation_release() {
        ImeAction m6622boximpl = ImeAction.m6622boximpl(this.imeAction);
        if (ImeAction.m6625equalsimpl0(m6622boximpl.getValue(), ImeAction.INSTANCE.m6646getUnspecifiedeUduSuo())) {
            m6622boximpl = null;
        }
        return m6622boximpl != null ? m6622boximpl.getValue() : ImeAction.INSTANCE.m6638getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m6661equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m6673getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m6678equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m6700getUnspecifiedPjHm6EE()) && ImeAction.m6625equalsimpl0(this.imeAction, ImeAction.INSTANCE.m6646getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m6661equalsimpl0(this.capitalization, keyboardOptions.capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, keyboardOptions.autoCorrectEnabled) && KeyboardType.m6678equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m6625equalsimpl0(this.imeAction, keyboardOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, keyboardOptions.platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, keyboardOptions.showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, keyboardOptions.hintLocales);
    }

    public int hashCode() {
        int m6662hashCodeimpl = KeyboardCapitalization.m6662hashCodeimpl(this.capitalization) * 31;
        Boolean bool = this.autoCorrectEnabled;
        int hashCode = (((((m6662hashCodeimpl + (bool != null ? bool.hashCode() : 0)) * 31) + KeyboardType.m6679hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m6626hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m6663toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m6680toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m6627toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation_release(KeyboardOptions other) {
        ...
        if (m6658boximpl != null) {
            i = m6658boximpl.getValue();
        } else {
        ...
        if (m6675boximpl != null) {
            i2 = m6675boximpl.getValue();
        } else {
            i2 = other.keyboardType;
        }
        int i5 = i2;
        ImeAction m6622boximpl = ImeAction.m6622boximpl(this.imeAction);
        ImeAction imeAction = ImeAction.m6625equalsimpl0(m6622boximpl.getValue(), ImeAction.INSTANCE.m6646getUnspecifiedeUduSuo()) ? null : m6622boximpl;
        if (imeAction != null) {
        ...
        Boolean bool4 = bool3;
        LocaleList localeList = this.hintLocales;
        return new KeyboardOptions(i4, bool2, i5, i6, platformImeOptions2, bool4, localeList == null ? other.hintLocales : localeList, (DefaultConstructorMarker) null);
    }
}
