...
public final class SelectionHandlesKt {
    ...
    public static final long m1647getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m4274getXimpl(j), Offset.m4275getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m6997constructorimpl(f);
