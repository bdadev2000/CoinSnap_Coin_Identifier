...
final class SelectionManager_androidKt$selectionMagnifier$1 extends r implements q {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ SelectionManager f7265a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SelectionManager_androidKt$selectionMagnifier$1(SelectionManager selectionManager) {
        super(3);
        this.f7265a = selectionManager;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        SelectionManager selectionManager = this.f7265a;
        boolean w = composer.w(selectionManager);
        Object u3 = composer.u();
        if (w || u3 == composer$Companion$Empty$1) {
            u3 = new SelectionManager_androidKt$selectionMagnifier$1$1$1(selectionManager, mutableState);
            composer.o(u3);
        }
        q0.a aVar = (q0.a) u3;
        ...
        if (I || u4 == composer$Companion$Empty$1) {
            u4 = new SelectionManager_androidKt$selectionMagnifier$1$2$1(density, mutableState);
            composer.o(u4);
        }
