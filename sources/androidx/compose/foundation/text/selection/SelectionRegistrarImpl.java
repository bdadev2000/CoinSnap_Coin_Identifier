...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    /* compiled from: SelectionRegistrarImpl.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001d\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Landroidx/compose/foundation/text/selection/SelectionRegistrarImpl$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/selection/SelectionRegistrarImpl;", "", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$sort$1
                ...
                public final Integer invoke(Selectable selectable, Selectable selectable2) {
                    ...
                    if (layoutCoordinates != null) {
                        m4290getZeroF1C5BW0 = LayoutCoordinates.this.mo5860localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4290getZeroF1C5BW0());
                    } else {
                        m4290getZeroF1C5BW0 = Offset.INSTANCE.m4290getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        m4290getZeroF1C5BW02 = LayoutCoordinates.this.mo5860localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m4290getZeroF1C5BW0());
                    } else {
                        m4290getZeroF1C5BW02 = Offset.INSTANCE.m4290getZeroF1C5BW0();
                    }
                    if (Offset.m4275getYimpl(m4290getZeroF1C5BW0) == Offset.m4275getYimpl(m4290getZeroF1C5BW02)) {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m4274getXimpl(m4290getZeroF1C5BW0)), Float.valueOf(Offset.m4274getXimpl(m4290getZeroF1C5BW02)));
                    } else {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Offset.m4275getYimpl(m4290getZeroF1C5BW0)), Float.valueOf(Offset.m4275getYimpl(m4290getZeroF1C5BW02)));
                    }
    ...
    public void mo1694notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4263boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1693notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4263boximpl(newPosition), Offset.m4263boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
