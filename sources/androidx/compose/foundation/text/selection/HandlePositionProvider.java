...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m4290getZeroF1C5BW0();
    ...
    public long mo649calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long mo1275provideF1C5BW0 = this.positionProvider.mo1275provideF1C5BW0();
        if (!OffsetKt.m4293isSpecifiedk4lQ0M(mo1275provideF1C5BW0)) {
            mo1275provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = mo1275provideF1C5BW0;
        return IntOffset.m7129plusqkQi6aY(IntOffset.m7129plusqkQi6aY(anchorBounds.m7153getTopLeftnOccac(), IntOffsetKt.m7141roundk4lQ0M(mo1275provideF1C5BW0)), this.handleReferencePoint.mo4120alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m7172getZeroYbymL2g(), layoutDirection));
    }
}
