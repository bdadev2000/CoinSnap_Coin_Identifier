...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m6913getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1357layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        int m6952getMinWidthimpl = Constraints.m6952getMinWidthimpl(constraints);
        int m6950getMaxWidthimpl = ((this.softWrap || TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6914getEllipsisgIe3tQ8())) && Constraints.m6946getHasBoundedWidthimpl(constraints)) ? Constraints.m6950getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6914getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (m6952getMinWidthimpl != m6950getMaxWidthimpl) {
            m6950getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), m6952getMinWidthimpl, m6950getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m6959fitPrioritizingWidthZbe2FdA(0, m6950getMaxWidthimpl, 0, Constraints.m6949getMaxHeightimpl(constraints)), i, TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6914getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m1359layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1392canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m6431copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m6964constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph m1357layoutTextK40F9xA = m1357layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), m1357layoutTextK40F9xA, ConstraintsKt.m6964constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m1357layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m1357layoutTextK40F9xA.getHeight()))), null);
    }
