...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1303runActionKlQnJC8(int imeAction) {
        ...
        Unit unit = null;
        if (ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6639getDoneeUduSuo())) {
            ...
            if (!ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6638getDefaulteUduSuo()) && !ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6642getNoneeUduSuo())) {
    ...
    public void mo1302defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6641getNexteUduSuo())) {
            getFocusManager().mo4201moveFocus3ESFkO8(FocusDirection.INSTANCE.m4196getNextdhqQ8s());
            return;
        }
        if (ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6643getPreviouseUduSuo())) {
            getFocusManager().mo4201moveFocus3ESFkO8(FocusDirection.INSTANCE.m4197getPreviousdhqQ8s());
            return;
        }
        if (ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6639getDoneeUduSuo())) {
        ...
        if (ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6640getGoeUduSuo()) || ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6644getSearcheUduSuo()) || ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6645getSendeUduSuo()) || ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6638getDefaulteUduSuo())) {
            return;
        }
        ImeAction.m6625equalsimpl0(imeAction, ImeAction.INSTANCE.m6642getNoneeUduSuo());
    }
}
