    ...
    */
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m1032sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final float m4343getWidthimpl = Size.m4343getWidthimpl(cacheDrawScope.m4164getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap createHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, m4343getWidthimpl);
                            ...
                            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    try {
                                        ...
                                        transform.mo4998rotateUv8p0NA(45.0f, Offset.INSTANCE.m4290getZeroF1C5BW0());
    ...
    static {
        float m6997constructorimpl = Dp.m6997constructorimpl(25);
        CursorHandleHeight = m6997constructorimpl;
        CursorHandleWidth = Dp.m6997constructorimpl(Dp.m6997constructorimpl(m6997constructorimpl * 2.0f) / 2.4142137f);
    }
}
