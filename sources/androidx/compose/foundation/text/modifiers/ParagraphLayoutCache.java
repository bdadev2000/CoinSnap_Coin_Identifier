...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m6960fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6913getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density density) {
        ...
        long m1594constructorimpl = density != null ? InlineDensity.m1594constructorimpl(density) : InlineDensity.INSTANCE.m1602getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = m1594constructorimpl;
        } else if (density == null || !InlineDensity.m1596equalsimpl0(this.lastDensity, m1594constructorimpl)) {
            this.density = density;
            this.lastDensity = m1594constructorimpl;
            markDirty();
        }
    ...
    public final boolean m1617layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            constraints = from.m1606coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m1615newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m6943equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m6964constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6915getVisiblegIe3tQ8()) || (IntSize.m7167getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m7166getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph m1614layoutTextK40F9xA = m1614layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m6964constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m1614layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m1614layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6915getVisiblegIe3tQ8()) && (IntSize.m7167getWidthimpl(r9) < m1614layoutTextK40F9xA.getWidth() || IntSize.m7166getHeightimpl(r9) < m1614layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = m1614layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int ceilToIntPx = TextDelegateKt.ceilToIntPx(m1614layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    private final Paragraph m1614layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return ParagraphKt.m6344Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1603finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1604finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6914getEllipsisgIe3tQ8()));
    }
    ...
    private final boolean m1615newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m6950getMaxWidthimpl(constraints) != Constraints.m6950getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m6949getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long m6941copyZbe2FdA$default = Constraints.m6941copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, m6941copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), m6941copyZbe2FdA$default, this.maxLines, TextOverflow.m6906equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6914getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : "null") + ", lastDensity=" + ((Object) InlineDensity.m1600toStringimpl(this.lastDensity)) + ')';
    }
}
