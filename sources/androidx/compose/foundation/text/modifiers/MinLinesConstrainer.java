...
public final class MinLinesConstrainer {
    ...
    public final long m1606coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m6342ParagraphUdtVg6A;
        String str2;
        Paragraph m6342ParagraphUdtVg6A2;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m6342ParagraphUdtVg6A = ParagraphKt.m6342ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            f = m6342ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m6342ParagraphUdtVg6A2 = ParagraphKt.m6342ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            f2 = m6342ParagraphUdtVg6A2.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (minLines != 1) {
            m6951getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(f + (f2 * (minLines - 1))), 0), Constraints.m6949getMaxHeightimpl(inConstraints));
        } else {
            m6951getMinHeightimpl = Constraints.m6951getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m6952getMinWidthimpl(inConstraints), Constraints.m6950getMaxWidthimpl(inConstraints), m6951getMinHeightimpl, Constraints.m6949getMaxHeightimpl(inConstraints));
    }
}
