...
public final class TextFieldBuffer implements Appendable {
    ...
    public final boolean hasSelection() {
        return !TextRange.m6454getCollapsedimpl(getSelectionInChars());
    }
    ...
    */
    private final void onTextWillChange(int r4, int r5, int r6) {
        ...
        Le:
            ...
            int r5 = androidx.compose.ui.text.TextRange.m6458getMinimpl(r1)
            long r1 = r3.getSelectionInChars()
            int r1 = androidx.compose.ui.text.TextRange.m6457getMaximpl(r1)
            if (r1 >= r0) goto L29
            return
        L29:
            if (r5 > r0) goto L32
    ...
    private final void m1403requireValidRange5zctL8(long range) {
        ...
        if (!TextRange.m6450contains5zctL8(TextRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m6463toStringimpl(range)) + " to be in " + ((Object) TextRange.m6463toStringimpl(TextRange))).toString());
        }
    }
}
