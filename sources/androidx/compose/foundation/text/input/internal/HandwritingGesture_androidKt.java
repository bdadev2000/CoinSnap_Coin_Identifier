...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1465adjustHandwritingDeleteGestureRange72CqOWE(long j, CharSequence charSequence) {
        int m6460getStartimpl = TextRange.m6460getStartimpl(j);
        int m6455getEndimpl = TextRange.m6455getEndimpl(j);
        int codePointBefore = m6460getStartimpl > 0 ? Character.codePointBefore(charSequence, m6460getStartimpl) : 10;
        int codePointAt = m6455getEndimpl < charSequence.length() ? Character.codePointAt(charSequence, m6455getEndimpl) : 10;
        if (isWhitespaceExceptNewline(codePointBefore) && (isWhitespace(codePointAt) || isPunctuation(codePointAt))) {
            do {
                m6460getStartimpl -= Character.charCount(codePointBefore);
                if (m6460getStartimpl == 0) {
                    break;
                }
                codePointBefore = Character.codePointBefore(charSequence, m6460getStartimpl);
            } while (isWhitespaceExceptNewline(codePointBefore));
            return TextRangeKt.TextRange(m6460getStartimpl, m6455getEndimpl);
        }
        ...
        do {
            m6455getEndimpl += Character.charCount(codePointAt);
            if (m6455getEndimpl == charSequence.length()) {
                break;
            }
            codePointAt = Character.codePointAt(charSequence, m6455getEndimpl);
    ...
    public static final long m1476getRangeForScreenRectsO048IG0(TextLayoutState textLayoutState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1474getRangeForScreenRectOH9lIzo = m1474getRangeForScreenRectOH9lIzo(textLayoutState, rect, i, textInclusionStrategy);
        if (TextRange.m6454getCollapsedimpl(m1474getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m6465getZerod9O1mEE();
        }
        long m1474getRangeForScreenRectOH9lIzo2 = m1474getRangeForScreenRectOH9lIzo(textLayoutState, rect2, i, textInclusionStrategy);
        return TextRange.m6454getCollapsedimpl(m1474getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m6465getZerod9O1mEE() : m1466enclosurepWDy79M(m1474getRangeForScreenRectOH9lIzo, m1474getRangeForScreenRectOH9lIzo2);
    }
    ...
    public static final long m1475getRangeForScreenRectsO048IG0(LegacyTextFieldState legacyTextFieldState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1473getRangeForScreenRectOH9lIzo = m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect, i, textInclusionStrategy);
        if (TextRange.m6454getCollapsedimpl(m1473getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m6465getZerod9O1mEE();
        }
        long m1473getRangeForScreenRectOH9lIzo2 = m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect2, i, textInclusionStrategy);
        return TextRange.m6454getCollapsedimpl(m1473getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m6465getZerod9O1mEE() : m1466enclosurepWDy79M(m1473getRangeForScreenRectOH9lIzo, m1473getRangeForScreenRectOH9lIzo2);
    }
    ...
    private static final long m1472getRangeForScreenRectO048IG0(MultiParagraph multiParagraph, Rect rect, LayoutCoordinates layoutCoordinates, int i, TextInclusionStrategy textInclusionStrategy) {
        ...
        return multiParagraph.m6327getRangeForRect86BmAI(rect.m4311translatek4lQ0M(layoutCoordinates.mo5865screenToLocalMKHz9U(Offset.INSTANCE.m4290getZeroF1C5BW0())), i, textInclusionStrategy);
    }
    ...
    private static final int m1470getOffsetForHandwritingGestureubNVwUQ(MultiParagraph multiParagraph, long j, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long mo5865screenToLocalMKHz9U;
        int m1467getLineForHandwritingGestured4ec7I;
        if (layoutCoordinates == null || (m1467getLineForHandwritingGestured4ec7I = m1467getLineForHandwritingGestured4ec7I(multiParagraph, (mo5865screenToLocalMKHz9U = layoutCoordinates.mo5865screenToLocalMKHz9U(j)), viewConfiguration)) == -1) {
            return -1;
        }
        return multiParagraph.m6326getOffsetForPositionk4lQ0M(Offset.m4268copydBAh8RU$default(mo5865screenToLocalMKHz9U, 0.0f, (multiParagraph.getLineTop(m1467getLineForHandwritingGestured4ec7I) + multiParagraph.getLineBottom(m1467getLineForHandwritingGestured4ec7I)) / 2.0f, 1, null));
    }
    ...
    public static final long m1471getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult textLayoutResult, long j, long j2, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        ...
        long mo5865screenToLocalMKHz9U = layoutCoordinates.mo5865screenToLocalMKHz9U(j);
        long mo5865screenToLocalMKHz9U2 = layoutCoordinates.mo5865screenToLocalMKHz9U(j2);
        int m1467getLineForHandwritingGestured4ec7I = m1467getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo5865screenToLocalMKHz9U, viewConfiguration);
        int m1467getLineForHandwritingGestured4ec7I2 = m1467getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo5865screenToLocalMKHz9U2, viewConfiguration);
        if (m1467getLineForHandwritingGestured4ec7I != -1) {
            if (m1467getLineForHandwritingGestured4ec7I2 != -1) {
                m1467getLineForHandwritingGestured4ec7I = Math.min(m1467getLineForHandwritingGestured4ec7I, m1467getLineForHandwritingGestured4ec7I2);
            }
            m1467getLineForHandwritingGestured4ec7I2 = m1467getLineForHandwritingGestured4ec7I;
        } else if (m1467getLineForHandwritingGestured4ec7I2 == -1) {
            return TextRange.INSTANCE.m6465getZerod9O1mEE();
        }
        float lineTop = (textLayoutResult.getLineTop(m1467getLineForHandwritingGestured4ec7I2) + textLayoutResult.getLineBottom(m1467getLineForHandwritingGestured4ec7I2)) / 2;
        return textLayoutResult.getMultiParagraph().m6327getRangeForRect86BmAI(new Rect(Math.min(Offset.m4274getXimpl(mo5865screenToLocalMKHz9U), Offset.m4274getXimpl(mo5865screenToLocalMKHz9U2)), lineTop - 0.1f, Math.max(Offset.m4274getXimpl(mo5865screenToLocalMKHz9U), Offset.m4274getXimpl(mo5865screenToLocalMKHz9U2)), lineTop + 0.1f), TextGranularity.INSTANCE.m6424getCharacterDRrd7Zo(), TextInclusionStrategy.INSTANCE.getAnyOverlap());
    }
    ...
    private static final int m1467getLineForHandwritingGestured4ec7I(MultiParagraph multiParagraph, long j, ViewConfiguration viewConfiguration) {
        ...
        int lineForVerticalPosition = multiParagraph.getLineForVerticalPosition(Offset.m4275getYimpl(j));
        if (Offset.m4275getYimpl(j) < multiParagraph.getLineTop(lineForVerticalPosition) - handwritingGestureLineMargin || Offset.m4275getYimpl(j) > multiParagraph.getLineBottom(lineForVerticalPosition) + handwritingGestureLineMargin || Offset.m4274getXimpl(j) < (-handwritingGestureLineMargin) || Offset.m4274getXimpl(j) > multiParagraph.getWidth() + handwritingGestureLineMargin) {
            return -1;
        }
    ...
    private static final long m1466enclosurepWDy79M(long j, long j2) {
        return TextRangeKt.TextRange(Math.min(TextRange.m6460getStartimpl(j), TextRange.m6460getStartimpl(j)), Math.max(TextRange.m6455getEndimpl(j2), TextRange.m6455getEndimpl(j2)));
    }
}
