...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        String obj = TextRange.m6454getCollapsedimpl(getText().getSelection()) ? null : TextFieldCharSequenceKt.getSelectedText(getText()).toString();
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m6458getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1440onImeActionKlQnJC8(m6638getDefaulteUduSuo);
        return true;
    }
