    ...
    public static final class MeasureInputs {
        ...
        private static final SnapshotMutationPolicy<MeasureInputs> mutationPolicy = new SnapshotMutationPolicy<MeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$MeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a2, TextFieldLayoutStateCache.MeasureInputs b) {
                ...
                } else if (a2.getDensityValue() == b.getDensityValue() && a2.getFontScale() == b.getFontScale() && a2.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a2.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m6943equalsimpl0(a2.getConstraints(), b.getConstraints())) {
                    return true;
                }
                return false;
            }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m6955toStringimpl(this.constraints)) + ')';
        }
