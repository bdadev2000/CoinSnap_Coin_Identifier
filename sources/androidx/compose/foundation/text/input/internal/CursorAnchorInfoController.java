...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4746constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4755resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo5867transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m4385setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1443buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m4311translatek4lQ0M(textLayoutNodeCoordinates.mo5860localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m4290getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m4311translatek4lQ0M(textLayoutNodeCoordinates.mo5860localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m4290getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
