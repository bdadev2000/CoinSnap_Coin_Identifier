...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m6460getStartimpl(j);
        this.selectionEnd = TextRange.m6455getEndimpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        checkRange(TextRange.m6460getStartimpl(j), TextRange.m6455getEndimpl(j));
    }
    ...
    public final void delete(int start, int end) {
        ...
        PartialGapBuffer.replace$default(this.gapBuffer, TextRange.m6458getMinimpl(TextRange), TextRange.m6457getMaximpl(TextRange), "", 0, 0, 24, null);
        long m1448updateRangeAfterDeletepWDy79M = EditingBufferKt.m1448updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m6460getStartimpl(m1448updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m6455getEndimpl(m1448updateRangeAfterDeletepWDy79M));
        if (hasComposition()) {
            long m1448updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m1448updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m6454getCollapsedimpl(m1448updateRangeAfterDeletepWDy79M2)) {
                commitComposition();
            } else {
                this.compositionStart = TextRange.m6458getMinimpl(m1448updateRangeAfterDeletepWDy79M2);
                this.compositionEnd = TextRange.m6457getMaximpl(m1448updateRangeAfterDeletepWDy79M2);
            }
        }
        this.highlight = null;
    }
    ...
    public final void m1447setHighlightK7f2yys(int type, int start, int end) {
        ...
        this.highlight = new Pair<>(TextHighlightType.m1417boximpl(type), TextRange.m6448boximpl(TextRangeKt.TextRange(RangesKt.coerceIn(start, 0, getLength()), RangesKt.coerceIn(end, 0, getLength()))));
    }
