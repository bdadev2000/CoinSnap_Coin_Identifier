...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo m1443buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        builder.setSelectionRange(m6458getMinimpl, TextRange.m6457getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, m6458getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int m6458getMinimpl2 = textRange != null ? TextRange.m6458getMinimpl(textRange.getPackedValue()) : -1;
            int m6457getMaximpl = textRange != null ? TextRange.m6457getMaximpl(textRange.getPackedValue()) : -1;
            if (m6458getMinimpl2 >= 0 && m6458getMinimpl2 < m6457getMaximpl) {
                builder.setComposingText(m6458getMinimpl2, charSequence.subSequence(m6458getMinimpl2, m6457getMaximpl));
                addCharacterBounds(builder, m6458getMinimpl2, m6457getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r14, int r15, int r16, androidx.compose.ui.text.TextLayoutResult r17, androidx.compose.ui.geometry.Rect r18) {
        /*
            ...
            r6 = 0
            r3.m6325fillBoundingBoxes8ffj60Q(r4, r2, r6)
            r3 = r15
        L17:
            if (r3 >= r0) goto L77
            int r4 = r3 - r15
