...
public final class TextLayoutState {
    ...
    public TextLayoutState() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6995boximpl(Dp.m6997constructorimpl(0)), null, 2, null);
    ...
    public final TextLayoutResult m1522layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult m1511layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1511layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
        ...
        return m1511layoutWithNewMeasureInputshBUhpc;
    }
    ...
    public final int m1520getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        return layoutResult.m6432getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1525fromDecorationToTextLayoutUv8p0NA(this, position));
    }
    ...
    public final boolean m1521isPositionOnTextk4lQ0M(long offset) {
        ...
        long m1525fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1525fromDecorationToTextLayoutUv8p0NA(this, m1518coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Offset.m4275getYimpl(m1525fromDecorationToTextLayoutUv8p0NA));
        return Offset.m4274getXimpl(m1525fromDecorationToTextLayoutUv8p0NA) >= layoutResult.getLineLeft(lineForVerticalPosition) && Offset.m4274getXimpl(m1525fromDecorationToTextLayoutUv8p0NA) <= layoutResult.getLineRight(lineForVerticalPosition);
    }
