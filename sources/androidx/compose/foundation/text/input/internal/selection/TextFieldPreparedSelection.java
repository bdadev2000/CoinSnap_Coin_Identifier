...
public final class TextFieldPreparedSelection {
    ...
    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m6454getCollapsedimpl(getSelection())) {
        ...
        if (invoke != null) {
            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(this.state, "", invoke.getPackedValue(), null, !this.isFromSoftKeyboard, 4, null);
        }
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int m6455getEndimpl = TextRange.m6455getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return m6455getEndimpl;
        }
        Rect translate = this.textLayoutResult.getCursorRect(m6455getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(translate.getTop() - lineBottom) > Math.abs(translate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m6432getOffsetForPositionk4lQ0M(translate.m4309getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m6432getOffsetForPositionk4lQ0M(translate.m4302getBottomLeftF1C5BW0());
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m6455getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m6455getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m6455getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6455getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long m6434getWordBoundaryjx7JFs = textLayoutResult.m6434getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m6455getEndimpl(m6434getWordBoundaryjx7JFs) > i) {
                return TextRange.m6455getEndimpl(m6434getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long m6434getWordBoundaryjx7JFs = textLayoutResult.m6434getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m6460getStartimpl(m6434getWordBoundaryjx7JFs) < i) {
                return TextRange.m6460getStartimpl(m6434getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6458getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6457getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int m6455getEndimpl = TextRange.m6455getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(m6455getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(m6455getEndimpl) + i;
        if (lineForOffset < 0) {
            return 0;
        }
        ...
        return textLayoutResult.m6432getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX, lineBottom));
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            setCursor(TextRange.m6455getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m6454getCollapsedimpl(this.selection)) {
                or.invoke(this);
            } else if (isLtr()) {
                setCursor(TextRange.m6458getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m6457getMaximpl(this.selection));
            }
        }
        return this;
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (calculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (m6455getEndimpl = TextRange.m6455getEndimpl(this.selection)), false, this.state)) != m6455getEndimpl) {
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        int calculateAdjacentCursorPosition;
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (calculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (m6455getEndimpl = TextRange.m6455getEndimpl(this.selection)), true, this.state)) != m6455getEndimpl) {
            setCursor(calculateAdjacentCursorPosition);
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int findParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m6458getMinimpl(this.selection));
            if (findParagraphStart == TextRange.m6458getMinimpl(this.selection) && findParagraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m6457getMaximpl(this.selection));
            if (findParagraphEnd == TextRange.m6457getMaximpl(this.selection) && findParagraphEnd != this.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m6460getStartimpl(this.initialValue.getSelection()), TextRange.m6455getEndimpl(this.selection));
        }
        return this;
    }
}
