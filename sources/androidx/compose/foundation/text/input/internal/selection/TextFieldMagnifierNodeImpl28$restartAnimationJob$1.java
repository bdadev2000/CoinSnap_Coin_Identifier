...
@DebugMetadata(c = "androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1", f = "AndroidTextFieldMagnifier.android.kt", i = {}, l = {TsExtractor.TS_STREAM_TYPE_SPLICE_INFO}, m = "invokeSuspend", n = {}, s = {})
        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m4263boximpl(m1556invokeF1C5BW0());
                }
                ...
                public final long m1556invokeF1C5BW0() {
                    ...
                    long m1552getMagnifierSizeYbymL2g;
                    ...
                    m1552getMagnifierSizeYbymL2g = TextFieldMagnifierNodeImpl28.this.m1552getMagnifierSizeYbymL2g();
                    return TextFieldMagnifierKt.m1549calculateSelectionMagnifierCenterAndroidhUlJWOE(transformedTextFieldState, textFieldSelectionState, textLayoutState, m1552getMagnifierSizeYbymL2g);
                }
            });
            ...
            if (snapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m1557emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                }
                ...
                public final Object m1557emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    ...
                    if (OffsetKt.m4293isSpecifiedk4lQ0M(((Offset) animatable.getValue()).getPackedValue()) && OffsetKt.m4293isSpecifiedk4lQ0M(j)) {
                        animatable3 = TextFieldMagnifierNodeImpl28.this.animatable;
                        if (Offset.m4275getYimpl(((Offset) animatable3.getValue()).getPackedValue()) != Offset.m4275getYimpl(j)) {
                    ...
                    Object snapTo = animatable2.snapTo(Offset.m4263boximpl(j), continuation);
                ...
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            this.label = 1;
                            if (Animatable.animateTo$default(animatable, Offset.m4263boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
