...
public final class TextFieldSelectionState$selectionHandleGestures$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
            ...
            if (i == 0) {
                ...
                TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                    ...
                    public final void mo1544onEventk4lQ0M(long j) {
                        Handle handle;
                        long m1564getHandlePositiontuRUvjQ;
                        ...
                        m1564getHandlePositiontuRUvjQ = TextFieldSelectionState.this.m1564getHandlePositiontuRUvjQ(z);
                        textFieldSelectionState2.m1574updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(m1564getHandlePositiontuRUvjQ));
                    }
                };
    ...
    /* compiled from: TextFieldSelectionState.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$selectionHandleGestures$2$3", f = "TextFieldSelectionState.kt", i = {}, l = {Constants.FAILED_PRECONDITION_STATUS_CODE}, m = "invokeSuspend", n = {}, s = {})
