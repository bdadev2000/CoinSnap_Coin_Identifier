...
public final class LegacyCursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.localToScreen.invoke(Matrix.m4744boximpl(this.matrix));
        ...
        Matrix.m4765translateimpl(fArr, f, -rect2.getTop(), 0.0f);
