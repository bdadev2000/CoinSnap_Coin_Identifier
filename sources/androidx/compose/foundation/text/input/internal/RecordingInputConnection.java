...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m6458getMinimpl = composition != null ? TextRange.m6458getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m6458getMinimpl(state.getSelection()), TextRange.m6457getMaximpl(state.getSelection()), m6458getMinimpl, composition2 != null ? TextRange.m6457getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m6454getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m6458getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int m6638getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6638getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6640getGoeUduSuo();
                    break;
                case 3:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6644getSearcheUduSuo();
                    break;
                case 4:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6645getSendeUduSuo();
                    break;
                case 5:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6641getNexteUduSuo();
                    break;
                case 6:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6639getDoneeUduSuo();
                    break;
                case 7:
                    m6638getDefaulteUduSuo = ImeAction.INSTANCE.m6643getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo1477onImeActionKlQnJC8(m6638getDefaulteUduSuo);
        return true;
    }
