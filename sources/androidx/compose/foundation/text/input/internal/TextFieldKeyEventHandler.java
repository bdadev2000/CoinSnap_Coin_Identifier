...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1438onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m6454getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1300cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1437onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange m6448boximpl;
        Integer m1299consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m5573equalsimpl0(KeyEvent_androidKt.m5581getTypeZmokQxo(event), KeyEventType.INSTANCE.m5577getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1383isTypedEventZmokQxo(event) && (m1299consumeZmokQxo = this.deadKeyCombiner.m1299consumeZmokQxo(event)) != null) {
            String sb = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), m1299consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
        ...
        KeyCommand mo1301mapZmokQxo = this.keyMapping.mo1301mapZmokQxo(event);
        if (mo1301mapZmokQxo != null && (!mo1301mapZmokQxo.getEditsText() || editable)) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[mo1301mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer valueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (valueOf.intValue() == -1) {
                            valueOf = null;
                        }
                        m6448boximpl = valueOf != null ? TextRange.m6448boximpl(TextRangeKt.TextRange(valueOf.intValue(), TextRange.m6455getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (m6448boximpl != null) {
                            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", m6448boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 21:
                    if (TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        m6448boximpl = valueOf2 != null ? TextRange.m6448boximpl(TextRangeKt.TextRange(TextRange.m6460getStartimpl(textFieldPreparedSelection.getSelection()), valueOf2.intValue())) : null;
                        if (m6448boximpl != null) {
                            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", m6448boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m6455getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m6460getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m6455getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m6454getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m6460getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
                ...
                case 27:
                    if (!singleLine) {
                        ...
                        EditCommandKt.commitText(mainBuffer3, TSVReader.splitSymbols, 1);
            ...
            if (!TextRange.m6453equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
    ...
    private final float getVisibleTextLayoutHeight(TextLayoutState textLayoutState) {
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (rect != null) {
                    return Size.m4340getHeightimpl(rect.m4307getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
