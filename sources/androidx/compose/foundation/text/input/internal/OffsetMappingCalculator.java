...
public final class OffsetMappingCalculator {
    ...
    public final void recordEditOperation(int sourceStart, int sourceEnd, int newLength) {
        ...
        if (max >= 2 || max != newLength) {
            ...
            OpArray.m1495setimpl(this.ops, this.opsSize, min, max, newLength);
            this.opsSize = i;
        }
    }
    ...
    private final long m1481mapfzxv0v0(int offset, boolean fromSource) {
        ...
        if (i2 < 0) {
            ...
            while (-1 < i3) {
                ...
                int i7 = iArr[i5 + 1];
                int i8 = iArr[i5 + 2];
                long m1482mapStepC6uMEY = m1482mapStepC6uMEY(i4, i6, i7, i8, fromSource);
                long m1482mapStepC6uMEY2 = m1482mapStepC6uMEY(offset, i6, i7, i8, fromSource);
                i3--;
                i4 = Math.min(TextRange.m6460getStartimpl(m1482mapStepC6uMEY), TextRange.m6460getStartimpl(m1482mapStepC6uMEY2));
                offset = Math.max(TextRange.m6455getEndimpl(m1482mapStepC6uMEY), TextRange.m6455getEndimpl(m1482mapStepC6uMEY2));
            }
            i = offset;
            offset = i4;
        } else {
            ...
            while (i9 < i2) {
                ...
                int i13 = iArr[i11 + 1];
                int i14 = iArr[i11 + 2];
                long m1482mapStepC6uMEY3 = m1482mapStepC6uMEY(i10, i12, i13, i14, fromSource);
                long m1482mapStepC6uMEY4 = m1482mapStepC6uMEY(offset, i12, i13, i14, fromSource);
                i9++;
                i10 = Math.min(TextRange.m6460getStartimpl(m1482mapStepC6uMEY3), TextRange.m6460getStartimpl(m1482mapStepC6uMEY4));
                offset = Math.max(TextRange.m6455getEndimpl(m1482mapStepC6uMEY3), TextRange.m6455getEndimpl(m1482mapStepC6uMEY4));
            }
            i = offset;
            offset = i10;
        }
