...
public final class Pending {
    ...
    public Pending(List<KeyInfo> list, int i) {
        ...
        this.keyMap = LazyKt.lazy(new Function0<MutableScatterMultiMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MutableScatterMultiMap<Object, KeyInfo> invoke() {
                return MutableScatterMultiMap.m3988boximpl(m3998invokeSAeQiB4());
            }

            /* renamed from: invoke-SAeQiB4, reason: not valid java name */
            public final MutableScatterMap<K, Object> m3998invokeSAeQiB4() {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    MutableScatterMultiMap.m3994putimpl(multiMap, joinedKey, keyInfo2);
                }
                return multiMap;
            }
        });
    ...
    public final MutableScatterMap<K, Object> m3997getKeyMapSAeQiB4() {
        return ((MutableScatterMultiMap) this.keyMap.getValue()).getMap();
    }

    public final KeyInfo getNext(int key, Object dataKey) {
        return (KeyInfo) MutableScatterMultiMap.m3993popimpl(m3997getKeyMapSAeQiB4(), dataKey != null ? new JoinedKey(Integer.valueOf(key), dataKey) : Integer.valueOf(key));
    }
