...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m4007boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m4008constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4009equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4010equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m4011hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4016toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m4009equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m4011hashCodeimpl(this.composer);
    }

    public String toString() {
        return m4016toStringimpl(this.composer);
    }
    ...
    public static final void m4014setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m4015setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m4017updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m4018updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m4012initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m4013reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
