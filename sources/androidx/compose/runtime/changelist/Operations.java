...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> function1) {
        pushOp(operation);
        function1.invoke(WriteScope.m4090boximpl(WriteScope.m4091constructorimpl(this)));
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & this.pushedIntMask) != 0) {
                ...
                sb.append(operation.mo4020intParamNamew8GmfQM(Operation.IntParameter.m4048constructorimpl(i2)));
                i++;
            }
        }
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) != 0) {
                ...
                sb3.append(operation.mo4021objectParamName31yXWZQ(Operation.ObjectParameter.m4059constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m4090boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl */
        public static Operations m4091constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl */
        public static boolean m4092equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).getStack());
        }

        /* renamed from: equals-impl0 */
        public static final boolean m4093equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl */
        public static int m4095hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl */
        public static String m4098toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m4092equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m4095hashCodeimpl(this.stack);
        }

        public String toString() {
            return m4098toStringimpl(this.stack);
        }
        ...
        public static final Operation m4094getOperationimpl(Operations operations) {
            return operations.peekOperation();
        }

        /* renamed from: setInt-A6tL2VI */
        public static final void m4096setIntA6tL2VI(Operations operations, int i, int i2) {
            int i3 = 1 << i;
            if (!((operations.pushedIntMask & i3) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m4094getOperationimpl(operations).mo4020intParamNamew8GmfQM(i));
            }
            operations.pushedIntMask |= i3;
            operations.intArgs[operations.m4088topIntIndexOfw8GmfQM(i)] = i2;
        }

        /* renamed from: setObject-DKhxnng */
        public static final <T> void m4097setObjectDKhxnng(Operations operations, int i, T t) {
            int i2 = 1 << i;
            if (!((operations.pushedObjectMask & i2) == 0)) {
                PreconditionsKt.throwIllegalStateException("Already pushed argument " + m4094getOperationimpl(operations).mo4021objectParamName31yXWZQ(i));
            }
            operations.pushedObjectMask |= i2;
            operations.objectArgs[operations.m4089topObjectIndexOf31yXWZQ(i)] = t;
        }
    }
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public int mo4084getIntw8GmfQM(int parameter) {
            return Operations.this.intArgs[this.intIdx + parameter];
        }

        @Override // androidx.compose.runtime.changelist.OperationArgContainer
        /* renamed from: getObject-31yXWZQ */
        public <T> T mo4085getObject31yXWZQ(int parameter) {
    ...
    private final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        for (int i = 0; i < ints; i++) {
            int m4048constructorimpl = Operation.IntParameter.m4048constructorimpl(i);
            String mo4020intParamNamew8GmfQM = operation.mo4020intParamNamew8GmfQM(m4048constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            sb.append(indent);
            sb.append(mo4020intParamNamew8GmfQM);
            sb.append(" = ");
            sb.append(opIterator.mo4084getIntw8GmfQM(m4048constructorimpl));
        }
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int m4059constructorimpl = Operation.ObjectParameter.m4059constructorimpl(i2);
            String mo4021objectParamName31yXWZQ = operation.mo4021objectParamName31yXWZQ(m4059constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append('\\n')");
            sb.append(indent);
            sb.append(mo4021objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo4085getObject31yXWZQ(m4059constructorimpl), indent));
        }
        Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append('\\n')");
        sb.append(str);
        sb.append(")");
