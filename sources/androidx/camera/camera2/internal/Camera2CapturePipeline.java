...
public class Camera2CapturePipeline {
    ...
    public static class CameraCapturePipelineImpl implements CameraCapturePipeline {
        ...
        public ListenableFuture<Void> invokePostCapture() {
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$CameraCapturePipelineImpl$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.CameraCapturePipelineImpl.this.m36x44fc0440(completer);
                }
            });
        }
        ...
        public /* synthetic */ Object m36x44fc0440(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public static class Pipeline {
        ...
        ListenableFuture<List<Void>> executeCapture(final List<CaptureConfig> list, final int i) {
            FutureChain transformAsync = FutureChain.from(executePreCapture(i)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda1
                ...
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m37xe4aaa129(list, i, (TotalCaptureResult) obj);
                }
            }, this.mExecutor);
        ...
        public /* synthetic */ ListenableFuture m37xe4aaa129(List list, int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        public ListenableFuture<TotalCaptureResult> executePreCapture(final int i) {
            ...
            return FutureChain.from(this.mPipelineSubTask.isCaptureResultNeeded() ? Camera2CapturePipeline.waitForResult(this.mCameraControl, null) : Futures.immediateFuture(null)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda3
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m38xc852b1db(i, (TotalCaptureResult) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m39x9cb1c219((Boolean) obj);
                }
            }, this.mExecutor);
        }
        ...
        public /* synthetic */ ListenableFuture m38xc852b1db(int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        public /* synthetic */ ListenableFuture m39x9cb1c219(Boolean bool) throws Exception {
        ...
        ListenableFuture<List<Void>> submitConfigsInternal(List<CaptureConfig> list, int i) {
            ...
            for (CaptureConfig captureConfig : list) {
                ...
                arrayList.add(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CapturePipeline.Pipeline.this.m40x1f41775a(from, completer);
                    }
                }));
        ...
        public /* synthetic */ Object m40x1f41775a(CaptureConfig.Builder builder, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public static class TorchTask implements PipelineTask {
            ...
            if (Camera2CapturePipeline.isFlashRequired(this.mFlashMode, totalCaptureResult)) {
                if (this.mCameraControl.isTorchOn()) {
                    ...
                    return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda1
                        @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return Camera2CapturePipeline.TorchTask.this.m50x3ebf0c8c(completer);
                        }
                        ...
                        @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                        public final ListenableFuture apply(Object obj) {
                            return Camera2CapturePipeline.TorchTask.this.m51x1a80884d((Void) obj);
                        }
                        ...
                        @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                        public final ListenableFuture apply(Object obj) {
                            return Camera2CapturePipeline.TorchTask.this.m52xd2037fcf((Void) obj);
                        }
        ...
        public /* synthetic */ Object m50x3ebf0c8c(CallbackToFutureAdapter.Completer completer) throws Exception {
            this.mCameraControl.getTorchControl().m87xbd10d892(completer, true);
            return "TorchOn";
        }
        ...
        public /* synthetic */ ListenableFuture m51x1a80884d(Void r1) throws Exception {
        ...
        public /* synthetic */ ListenableFuture m52xd2037fcf(Void r5) throws Exception {
        ...
        public void postCapture() {
            if (this.mIsExecuted) {
                this.mCameraControl.getTorchControl().m87xbd10d892(null, false);
    ...
    public static class AePreCaptureTask implements PipelineTask {
        ...
        public ListenableFuture<Boolean> preCapture(TotalCaptureResult totalCaptureResult) {
            if (Camera2CapturePipeline.isFlashRequired(this.mFlashMode, totalCaptureResult)) {
                ...
                return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$AePreCaptureTask$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CapturePipeline.AePreCaptureTask.this.m35x78c3ed41(completer);
                    }
        ...
        public /* synthetic */ Object m35x78c3ed41(CallbackToFutureAdapter.Completer completer) throws Exception {
            this.mCameraControl.getFocusMeteringControl().m72xcc3739a4(completer);
    ...
    public static class ScreenFlashTask implements PipelineTask {
        ...
        public ListenableFuture<Boolean> preCapture(TotalCaptureResult totalCaptureResult) {
            ...
            return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda9
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m44x6ffc4037(atomicReference, completer);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m45x37082738((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m47xc51ff53a((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m48x8c2bdc3b(future, obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m49x5337c33c((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m42x8e5210ab((Void) obj);
                }
        ...
        public /* synthetic */ Object m44x6ffc4037(final AtomicReference atomicReference, final CallbackToFutureAdapter.Completer completer) throws Exception {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CapturePipeline.ScreenFlashTask.this.m43xa8f05936(atomicReference, completer);
                }
            });
        ...
        public /* synthetic */ void m43xa8f05936(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
        ...
        public /* synthetic */ ListenableFuture m45x37082738(Void r2) throws Exception {
        ...
        public /* synthetic */ ListenableFuture m47xc51ff53a(Void r1) throws Exception {
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda0
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m46xfe140e39(completer);
                }
            });
        }
        ...
        public /* synthetic */ Object m46xfe140e39(CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        public /* synthetic */ ListenableFuture m48x8c2bdc3b(ListenableFuture listenableFuture, Object obj) throws Exception {
        ...
        public /* synthetic */ ListenableFuture m49x5337c33c(Void r1) throws Exception {
            return this.mCameraControl.getFocusMeteringControl().triggerAePrecapture();
        }
        ...
        public /* synthetic */ ListenableFuture m42x8e5210ab(Void r5) throws Exception {
        ...
        public void postCapture() {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static class ResultListener implements Camera2CameraControlImpl.CaptureResultListener {
        ...
        private final ListenableFuture<TotalCaptureResult> mFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ResultListener$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CapturePipeline.ResultListener.this.m41xaa6bbe23(completer);
            }
        });
        ...
        public /* synthetic */ Object m41xaa6bbe23(CallbackToFutureAdapter.Completer completer) throws Exception {
