...
public class SmallDisplaySizeQuirk implements Quirk {
    ...
    static {
        ...
        hashMap.put("REDMI NOTE 8", new Size(AppViewModel.PICTURE_WIDTH, 2340));
        hashMap.put("REDMI NOTE 7", new Size(AppViewModel.PICTURE_WIDTH, 2340));
        hashMap.put("SM-A207M", new Size(720, 1560));
        hashMap.put("REDMI NOTE 7S", new Size(AppViewModel.PICTURE_WIDTH, 2340));
        hashMap.put("SM-A127F", new Size(720, 1600));
        hashMap.put("SM-A536E", new Size(AppViewModel.PICTURE_WIDTH, 2400));
        hashMap.put("220233L2I", new Size(720, 1600));
        hashMap.put("V2149", new Size(720, 1600));
        hashMap.put("VIVO 1920", new Size(AppViewModel.PICTURE_WIDTH, 2340));
        hashMap.put("CPH2223", new Size(AppViewModel.PICTURE_WIDTH, 2400));
        ...
        hashMap.put("SM-A146U", new Size(AppViewModel.PICTURE_WIDTH, 2408));
        hashMap.put("CPH1909", new Size(720, 1520));
        hashMap.put("NOKIA 4.2", new Size(720, 1520));
        hashMap.put("SM-G960U1", new Size(1440, 2960));
        hashMap.put("SM-A137F", new Size(AppViewModel.PICTURE_WIDTH, 2408));
        ...
        hashMap.put("INFINIX X670", new Size(AppViewModel.PICTURE_WIDTH, 2400));
    }
