...
public final class SurfaceOutputImpl implements SurfaceOutput {
    ...
    public SurfaceOutputImpl(Surface surface, int i, int i2, Size size, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Matrix matrix) {
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return SurfaceOutputImpl.this.m201lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(completer);
            }
        });
    }
    ...
    public /* synthetic */ Object m201lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
            ...
            try {
                executor.execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        SurfaceOutputImpl.this.m202x4fbd8e2d(atomicReference);
                    }
                });
    ...
    public /* synthetic */ void m202x4fbd8e2d(AtomicReference atomicReference) {
