...
public class StreamSharing extends UseCase {
    ...
    public /* synthetic */ ListenableFuture m218lambda$new$0$androidxcameracorestreamsharingStreamSharing(int i, int i2) {
    ...
    private List<SessionConfig> createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig<?> useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            m2 = Preview$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build()});
            return m2;
        }
        ...
        m = Preview$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
        return m;
    }
    ...
    public /* synthetic */ void m217x83a3b685(String str, String str2, UseCaseConfig useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
        clearPipeline();
