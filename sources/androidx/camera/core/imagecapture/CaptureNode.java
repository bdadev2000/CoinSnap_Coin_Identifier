...
public class CaptureNode implements Node<In, ProcessingNode.In> {
    ...
    public ProcessingNode.In transform(In in) {
        ...
        boolean z = !in.isVirtualCamera();
        CameraCaptureCallback anonymousClass1 = new AnonymousClass1();
        if (z && in.getImageReaderProxyProvider() == null) {
    ...
    public class AnonymousClass1 extends CameraCaptureCallback {
        ...
        public /* synthetic */ void m153xc251443c() {
        ...
        public /* synthetic */ void m152xa945b317(int i) {
            if (CaptureNode.this.mCurrentRequest != null) {
    ...
    public /* synthetic */ void m149lambda$transform$0$androidxcameracoreimagecaptureCaptureNode(ProcessingRequest processingRequest) {
    ...
    public /* synthetic */ void m150lambda$transform$1$androidxcameracoreimagecaptureCaptureNode(ImageReaderProxy imageReaderProxy) {
        try {
    ...
    public /* synthetic */ void m151lambda$transform$2$androidxcameracoreimagecaptureCaptureNode(ImageReaderProxy imageReaderProxy) {
        try {
            ImageProxy acquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (acquireLatestImage != null) {
    ...
    public static abstract class In {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static In of(Size size, int i, int i2, boolean z, ImageReaderProxyProvider imageReaderProxyProvider, Size size2, int i3) {
