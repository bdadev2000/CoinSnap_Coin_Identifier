...
public final class AudioSource {
    ...
    public void setBufferProvider(final BufferProvider<? extends InputBuffer> bufferProvider) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda1
            ...
            public final void run() {
                AudioSource.this.m258x885db6e2(bufferProvider);
            }
        });
    }
    ...
    public /* synthetic */ void m258x885db6e2(BufferProvider bufferProvider) {
    ...
    public /* synthetic */ void m259lambda$start$1$androidxcameravideointernalaudioAudioSource() {
        start(this.mMuted);
    }
    ...
    public void start() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m259lambda$start$1$androidxcameravideointernalaudioAudioSource();
            }
        });
    }
    ...
    public void start(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m260lambda$start$2$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }
    ...
    public /* synthetic */ void m260lambda$start$2$androidxcameravideointernalaudioAudioSource(boolean z) {
        int ordinal = this.mState.ordinal();
        if (ordinal != 0) {
            if (ordinal == 2) {
                throw new AssertionError("AudioSource is released");
    ...
    public void stop() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m261lambda$stop$3$androidxcameravideointernalaudioAudioSource();
            }
        });
    }
    ...
    public /* synthetic */ void m261lambda$stop$3$androidxcameravideointernalaudioAudioSource() {
        int ordinal = this.mState.ordinal();
        if (ordinal == 1) {
    ...
    public ListenableFuture<Void> release() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda5
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return AudioSource.this.m256xa561a489(completer);
            }
        });
    }
    ...
    public /* synthetic */ Object m256xa561a489(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m255xb3b7fe6a(completer);
            }
        });
    ...
    public /* synthetic */ void m255xb3b7fe6a(CallbackToFutureAdapter.Completer completer) {
        try {
            int ordinal = this.mState.ordinal();
            if (ordinal == 0 || ordinal == 1) {
    ...
    public void setAudioSourceCallback(final Executor executor, final AudioSourceCallback audioSourceCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m257xcbe526c1(executor, audioSourceCallback);
            }
        });
    }
    ...
    public /* synthetic */ void m257xcbe526c1(Executor executor, AudioSourceCallback audioSourceCallback) {
        int ordinal = this.mState.ordinal();
        if (ordinal == 0) {
    ...
    public void mute(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                AudioSource.this.m253lambda$mute$7$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }
    ...
    public /* synthetic */ void m253lambda$mute$7$androidxcameravideointernalaudioAudioSource(boolean z) {
        int ordinal = this.mState.ordinal();
        if (ordinal != 0 && ordinal != 1) {
            if (ordinal == 2) {
                throw new AssertionError("AudioSource is released");
    ...
    void postMaxAmplitude(ByteBuffer byteBuffer) {
        ...
        if (this.mAudioFormat == 2) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
                    AudioSource.this.m254xdf9dee1c(audioSourceCallback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m254xdf9dee1c(AudioSourceCallback audioSourceCallback) {
