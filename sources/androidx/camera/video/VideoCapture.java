...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
        ...
        this.mStreamInfoObserver = new Observable.Observer<StreamInfo>() { // from class: androidx.camera.video.VideoCapture.1
            ...
            public void onNewData(StreamInfo streamInfo) {
                ...
                if ((streamInfo2.getId() != -1 && streamInfo.getId() == -1) || (streamInfo2.getId() == -1 && streamInfo.getId() != -1)) {
                    ...
                    m2 = Preview$$ExternalSyntheticBackport0.m(new Object[]{videoCapture2.mSessionConfigBuilder.build()});
                ...
                if (streamInfo2.getStreamState() != streamInfo.getStreamState()) {
                    ...
                    m = Preview$$ExternalSyntheticBackport0.m(new Object[]{videoCapture4.mSessionConfigBuilder.build()});
    ...
    public void onStateAttached() {
        ...
        m = Preview$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build()});
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m242lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, resolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m243lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                VideoCapture.this.m244lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    public /* synthetic */ void m243lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    public /* synthetic */ void m244lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onAppEdgeInvalidated, reason: merged with bridge method [inline-methods] */
    public void m242lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return VideoCapture.this.m245xc7537f7(builder, completer);
            }
        });
    ...
    public /* synthetic */ Object m245xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.AnonymousClass2.this.m246lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }
        ...
        public /* synthetic */ void m246lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
