...
public class PendingValue<T> {
    ...
    public ListenableFuture<Void> setValue(final T t) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.PendingValue$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return PendingValue.this.m297lambda$setValue$0$androidxcameraviewPendingValue(t, completer);
            }
        });
    }
    ...
    public /* synthetic */ Object m297lambda$setValue$0$androidxcameraviewPendingValue(Object obj, CallbackToFutureAdapter.Completer completer) throws Exception {
