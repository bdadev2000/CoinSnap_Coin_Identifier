...
public abstract class CameraController {
    ...
    public CameraController(Context context, ListenableFuture<ProcessCameraProviderWrapper> listenableFuture) {
        ...
        this.mInitializationFuture = Futures.transform(listenableFuture, new Function() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda3
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return CameraController.this.m292lambda$new$0$androidxcameraviewCameraController((ProcessCameraProviderWrapper) obj);
            }
        ...
        this.mDeviceRotationListener = new RotationProvider.Listener() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda4
            ...
            public final void onRotationChanged(int i) {
                CameraController.this.m293lambda$new$1$androidxcameraviewCameraController(i);
            }
        };
    }
    ...
    public /* synthetic */ Void m292lambda$new$0$androidxcameraviewCameraController(ProcessCameraProviderWrapper processCameraProviderWrapper) {
    ...
    public /* synthetic */ void m293lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    public void setEnabledUseCases(int i) {
        ...
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda6
            ...
            public final void run() {
                CameraController.this.m295x2318c9a7(i2);
            }
        });
    }
    ...
    public /* synthetic */ void m295x2318c9a7(int i) {
        this.mEnabledUseCases = i;
    }
    ...
    public void takePicture(ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        ...
        this.mImageCapture.m140lambda$takePicture$2$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
    }
    ...
    public void takePicture(Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
        ...
        Preconditions.checkState(isImageCaptureEnabled(), IMAGE_CAPTURE_DISABLED);
        throwExceptionForInvalidScreenFlashCapture();
        this.mImageCapture.m139lambda$takePicture$1$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
    }
    ...
    public class AnonymousClass2 implements Consumer<VideoRecordEvent> {
            ...
            if (videoRecordEvent instanceof VideoRecordEvent.Finalize) {
                if (!Threads.isMainThread()) {
                    this.val$mainExecutor.execute(new Runnable() { // from class: androidx.camera.view.CameraController$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraController.AnonymousClass2.this.m296lambda$accept$0$androidxcameraviewCameraController$2();
                        }
                    });
                } else {
        ...
        public /* synthetic */ void m296lambda$accept$0$androidxcameraviewCameraController$2() {
            CameraController.this.deactivateRecordingByListener(this);
        }
    }
    ...
    public void setCameraSelector(CameraSelector cameraSelector) {
        ...
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                CameraController.this.m294lambda$setCameraSelector$3$androidxcameraviewCameraController(cameraSelector2);
            }
        });
    }
    ...
    public /* synthetic */ void m294lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
