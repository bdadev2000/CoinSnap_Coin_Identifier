...
final class DialogHostKt$PopulateVisibleList$1$1$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public DialogHostKt$PopulateVisibleList$1$1$1(NavBackStackEntry navBackStackEntry, boolean z, List<NavBackStackEntry> list) {
        super(1);
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        ...
        this.$entry.getLifecycleRegistry().addObserver(lifecycleEventObserver);
