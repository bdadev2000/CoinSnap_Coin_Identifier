...
class MarkwonBuilderImpl implements Markwon.Builder {
    ...
    public Markwon build() {
        ...
        return new MarkwonImpl(this.bufferType, this.textSetter, builder.build(), MarkwonVisitorFactory.create(builderImpl, build), build, Collections.unmodifiableList(preparePlugins));
    }
