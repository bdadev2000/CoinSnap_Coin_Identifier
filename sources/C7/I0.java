...
public final class I0 implements e8.D {
    ...
    static {
        I0 i02 = new I0();
        INSTANCE = i02;
        e8.Y y4 = new e8.Y("com.vungle.ads.internal.model.ConfigPayload.ReportIncentivizedSettings", i02, 1);
        y4.l("enabled", false);
        descriptor = y4;
    }
    ...
    @Override // a8.b
    public K0 deserialize(d8.c cVar) {
        G7.j.e(cVar, "decoder");
    ...
    @Override // a8.b
    public void serialize(d8.d dVar, K0 k02) {
        G7.j.e(dVar, "encoder");
        G7.j.e(k02, AppMeasurementSdk.ConditionalUserProperty.VALUE);
        c8.g descriptor2 = getDescriptor();
        d8.b b = dVar.b(descriptor2);
        K0.write$Self(k02, b, descriptor2);
        b.c(descriptor2);
    }
