...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String m10 = a.m(name, getArguments().isEmpty() ? "" : CollectionsKt___CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        if (Intrinsics.areEqual(asString, m10)) {
            return m10;
        }
        if (Intrinsics.areEqual(asString, m10 + '?')) {
            return m10 + '!';
    ...
    public String toString() {
        return e.h(new StringBuilder(), asString(false), " (Kotlin reflection is not available)");
    }
