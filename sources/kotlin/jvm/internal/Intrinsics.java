...
public class Intrinsics {
    ...
    public static void checkExpressionValueIsNotNull(Object obj, String str) {
        if (obj != null) {
            ...
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(j.k(str, " must not be null"))));
        }
    }

    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(j.l("Field specified as non-null is null: ", str, ".", str2))));
        }
    }
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(e.f("Class ", replace, " is not found. Please update the Kotlin runtime to the latest version"), e2)));
        }
    }
    ...
    public static void checkNotNullExpressionValue(Object obj, String str) {
        if (obj != null) {
            ...
            throw ((NullPointerException) sanitizeStackTrace(new NullPointerException(j.k(str, " must not be null"))));
        }
    }
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(j.l("Method specified as non-null returned null: ", str, ".", str2))));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        StringBuilder p10 = a4.j.p("Parameter specified as non-null is null: method ", stackTraceElement.getClassName(), ".", stackTraceElement.getMethodName(), ", parameter ");
        p10.append(str);
        return p10.toString();
    }
    ...
    public static int compare(long j3, long j10) {
        if (j3 < j10) {
            return -1;
        }
        return j3 == j10 ? 0 : 1;
    ...
    public static void checkHasClass(String str, String str2) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(j.l("Class ", replace, " is not found: this code requires the Kotlin runtime of version at least ", str2), e2)));
        }
    }
}
