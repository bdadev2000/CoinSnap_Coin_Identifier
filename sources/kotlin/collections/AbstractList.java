    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int startIndex, int endIndex, int size) {
            if (startIndex >= 0 && endIndex <= size) {
                if (startIndex <= endIndex) {
                    ...
                    throw new IllegalArgumentException(j.e("startIndex: ", startIndex, " > endIndex: ", endIndex));
                }
            } else {
                StringBuilder n10 = j.n("startIndex: ", startIndex, ", endIndex: ", endIndex, ", size: ");
                n10.append(size);
        ...
        public final void checkElementIndex$kotlin_stdlib(int index, int size) {
            if (index >= 0 && index < size) {
                ...
                throw new IndexOutOfBoundsException(j.e("index: ", index, ", size: ", size));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int fromIndex, int toIndex, int size) {
            if (fromIndex >= 0 && toIndex <= size) {
                if (fromIndex <= toIndex) {
                    ...
                    throw new IllegalArgumentException(j.e("fromIndex: ", fromIndex, " > toIndex: ", toIndex));
                }
            } else {
                StringBuilder n10 = j.n("fromIndex: ", fromIndex, ", toIndex: ", toIndex, ", size: ");
                n10.append(size);
                throw new IndexOutOfBoundsException(n10.toString());
            }
        }
