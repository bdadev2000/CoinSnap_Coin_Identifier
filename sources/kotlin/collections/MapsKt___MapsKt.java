...
public class MapsKt___MapsKt extends MapsKt___MapsJvmKt {
    ...
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEach(M m10, Function1<? super Map.Entry<? extends K, ? extends V>, Unit> action) {
    ...
    @SinceKotlin(version = "1.4")
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEachIndexed(M m10, Function2<? super Integer, ? super Map.Entry<? extends K, ? extends V>, Unit> action) {
        Intrinsics.checkNotNullParameter(m10, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
