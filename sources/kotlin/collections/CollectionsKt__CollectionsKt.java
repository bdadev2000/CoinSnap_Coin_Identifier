...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(List<? extends T> list, T t5, int i10, int i11) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        rangeCheck$CollectionsKt__CollectionsKt(list.size(), i10, i11);
        int i12 = i11 - 1;
        while (i10 <= i12) {
            int i13 = (i10 + i12) >>> 1;
            int compareValues = ComparisonsKt.compareValues(list.get(i13), t5);
            if (compareValues < 0) {
                i10 = i13 + 1;
            } else {
                if (compareValues <= 0) {
    ...
    public static <T> List<T> listOfNotNull(T t5) {
        return t5 != null ? CollectionsKt__CollectionsJVMKt.listOf(t5) : emptyList();
    }
        ...
        if (i11 <= i12) {
            if (i11 >= 0) {
                if (i12 <= i10) {
                    ...
                    throw new IndexOutOfBoundsException(a.j("toIndex (", i12, ") is greater than size (", i10, ")."));
                }
            }
            throw new IndexOutOfBoundsException(a.i("fromIndex (", i11, ") is less than zero."));
        }
        throw new IllegalArgumentException(a.j("fromIndex (", i11, ") is greater than toIndex (", i12, ")."));
    }
    ...
    public static final <T> int binarySearch(List<? extends T> list, T t5, Comparator<? super T> comparator, int i10, int i11) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i10 <= i12) {
            int i13 = (i10 + i12) >>> 1;
            int compare = comparator.compare(list.get(i13), t5);
            if (compare < 0) {
                i10 = i13 + 1;
            } else {
                if (compare <= 0) {
