...
public class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    @InlineOnly
    private static final <T> void minusAssign(Collection<? super T> collection, T t5) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
    ...
    @InlineOnly
    private static final <T> void plusAssign(Collection<? super T> collection, T t5) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        collection.add(t5);
    }

    @InlineOnly
    private static final <T> boolean remove(Collection<? extends T> collection, T t5) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        return TypeIntrinsics.asMutableCollection(collection).remove(t5);
    }
    ...
    private static final <T> boolean filterInPlace$CollectionsKt__MutableCollectionsKt(List<T> list, Function1<? super T, Boolean> function1, boolean z10) {
        ...
        while (it.hasNext()) {
            ...
            if (function1.invoke(t5).booleanValue() != z10) {
                if (i10 != nextInt) {
                    list.set(i10, t5);
                }
                i10++;
