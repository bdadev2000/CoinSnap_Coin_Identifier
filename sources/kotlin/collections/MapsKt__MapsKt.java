...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> map, K k10, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v10 = map.get(k10);
    ...
    public static final <K, V> V getOrPut(Map<K, V> map, K k10, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v10 = map.get(k10);
        if (v10 == null) {
    ...
    private static final <K, V> Map<K, V> buildMap(int i10, @BuilderInference Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map createMapBuilder = MapsKt__MapsJVMKt.createMapBuilder(i10);
        builderAction.invoke(createMapBuilder);
        return MapsKt__MapsJVMKt.build(createMapBuilder);
    }
