...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final long max(long j3, long j10) {
        return Math.max(j3, j10);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final long min(long j3, long j10) {
