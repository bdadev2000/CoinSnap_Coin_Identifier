...
public final class UShortKt {
    ...
    @InlineOnly
    private static final short toUShort(byte b3) {
        return UShort.m426constructorimpl(b3);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final short toUShort(short s5) {
        return UShort.m426constructorimpl(s5);
    }
    ...
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final short toUShort(long j3) {
