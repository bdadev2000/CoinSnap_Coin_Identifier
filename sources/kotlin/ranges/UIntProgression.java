...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1369fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb2.append((Object) UInt.m286toStringimpl(this.first));
            sb2.append("..");
            sb2.append((Object) UInt.m286toStringimpl(this.last));
            sb2.append(" step ");
            i10 = this.step;
        } else {
            sb2 = new StringBuilder();
    ...
    private UIntProgression(int i10, int i11, int i12) {
        ...
        if (i12 != Integer.MIN_VALUE) {
            this.first = i10;
            this.last = UProgressionUtilKt.m1353getProgressionLastElementNkh28Cs(i10, i11, i12);
            this.step = i12;
            return;
        }
