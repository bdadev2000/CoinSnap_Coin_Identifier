...
public final class TimersKt {
    @InlineOnly
    private static final Timer fixedRateTimer(String str, boolean z10, long j3, long j10, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z10);
        timer.scheduleAtFixedRate(new TimersKt$timerTask$1(action), j3, j10);
        return timer;
    }

    public static /* synthetic */ Timer fixedRateTimer$default(String str, boolean z10, long j3, long j10, Function1 action, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = null;
        }
        if ((i10 & 2) != 0) {
    ...
    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(Timer timer, long j3, long j10, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        TimersKt$timerTask$1 timersKt$timerTask$1 = new TimersKt$timerTask$1(action);
        timer.scheduleAtFixedRate(timersKt$timerTask$1, j3, j10);
        return timersKt$timerTask$1;
    }
    ...
    public static /* synthetic */ Timer timer$default(String str, boolean z10, long j3, long j10, Function1 action, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = null;
        }
        if ((i10 & 2) != 0) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z10);
        timer.schedule(new TimersKt$timerTask$1(action), j3, j10);
        return timer;
    }
    ...
    @InlineOnly
    private static final Timer timer(String str, boolean z10, long j3, long j10, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z10);
        timer.schedule(new TimersKt$timerTask$1(action), j3, j10);
        return timer;
    ...
    @InlineOnly
    private static final Timer fixedRateTimer(String str, boolean z10, Date startAt, long j3, Function1<? super TimerTask, Unit> action) {
    ...
    public static /* synthetic */ Timer fixedRateTimer$default(String str, boolean z10, Date startAt, long j3, Function1 action, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = null;
        }
        if ((i10 & 2) != 0) {
    ...
    @InlineOnly
    private static final Timer timer(String str, boolean z10, Date startAt, long j3, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter(startAt, "startAt");
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z10);
    ...
    public static /* synthetic */ Timer timer$default(String str, boolean z10, Date startAt, long j3, Function1 action, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = null;
        }
        if ((i10 & 2) != 0) {
    ...
    @InlineOnly
    private static final TimerTask schedule(Timer timer, long j3, long j10, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        TimersKt$timerTask$1 timersKt$timerTask$1 = new TimersKt$timerTask$1(action);
        timer.schedule(timersKt$timerTask$1, j3, j10);
        return timersKt$timerTask$1;
    }
