...
class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb2, short s5) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append((int) s5);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        sb2.append('\n');
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb2, byte b3) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append((int) b3);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        sb2.append('\n');
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb2, long j3) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append(j3);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        sb2.append('\n');
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb2, short s5) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append((int) s5);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        return appendln(sb2);
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb2, byte b3) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append((int) b3);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        return appendln(sb2);
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb2, long j3) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append(j3);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(...)");
        return appendln(sb2);
