...
final class MatcherMatchResult implements MatchResult {
    ...
    public MatchResult next() {
        ...
        if (i11 <= this.input.length()) {
            ...
            return RegexKt.access$findNext(matcher, i11, this.input);
        }
        return null;
    }
}
