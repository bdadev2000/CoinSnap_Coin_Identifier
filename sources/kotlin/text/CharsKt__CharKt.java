...
public class CharsKt__CharKt extends CharsKt__CharJVMKt {
    ...
    public static final char digitToChar(int i10) {
        ...
        throw new IllegalArgumentException(a.i("Int ", i10, " is not a decimal digit"));
    }
    ...
    public static final char digitToChar(int i10, int i11) {
        if (!new IntRange(2, 36).contains(i11)) {
            throw new IllegalArgumentException(a.i("Invalid radix: ", i11, ". Valid radix values are in range 2..36"));
        }
        if (i10 < 0 || i10 >= i11) {
            throw new IllegalArgumentException(j.e("Digit ", i10, " does not represent a valid digit in radix ", i11));
        }
