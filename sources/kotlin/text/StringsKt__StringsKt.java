...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i10, boolean z10, boolean z11) {
        ...
        if (!z10 && collection.size() == 1) {
            ...
            if (!z11) {
                lastIndexOf$default = indexOf$default(charSequence, str, i10, false, 4, (Object) null);
            } else {
                lastIndexOf$default = lastIndexOf$default(charSequence, str, i10, false, 4, (Object) null);
            }
        ...
        if (!z11) {
            ...
            downTo = RangesKt.downTo(RangesKt.coerceAtMost(i10, getLastIndex(charSequence)), 0);
        }
    ...
    public static final boolean hasSurrogatePairAt(CharSequence charSequence, int i10) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (!new IntRange(0, charSequence.length() - 2).contains(i10) || !Character.isHighSurrogate(charSequence.charAt(i10)) || !Character.isLowSurrogate(charSequence.charAt(i10 + 1))) {
            return false;
        }
        return true;
    }
    ...
    public static final int indexOf(CharSequence charSequence, char c10, int i10, boolean z10) {
        ...
        return indexOfAny(charSequence, new char[]{c10}, i10, z10);
    }
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i10, int i11, boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            downTo = RangesKt.downTo(RangesKt.coerceAtMost(i10, getLastIndex(charSequence)), RangesKt.coerceAtLeast(i11, 0));
        }
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            int first = downTo.getFirst();
            int last = downTo.getLast();
            int step = downTo.getStep();
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                while (!StringsKt__StringsJVMKt.regionMatches((String) charSequence2, 0, (String) charSequence, first, charSequence2.length(), z10)) {
                    if (first != last) {
                        first += step;
                    } else {
                        return -1;
    ...
    public static final int indexOfAny(CharSequence charSequence, char[] chars, int i10, boolean z10) {
        ...
        ?? it = new IntRange(RangesKt.coerceAtLeast(i10, 0), getLastIndex(charSequence)).iterator();
        while (it.hasNext()) {
            ...
            while (true) {
                ...
                if (CharsKt__CharKt.equals(chars[i11], charAt, z10)) {
                    z11 = true;
                    break;
                }
                i11++;
    ...
    public static final int lastIndexOf(CharSequence charSequence, char c10, int i10, boolean z10) {
        ...
        return lastIndexOfAny(charSequence, new char[]{c10}, i10, z10);
    }
    ...
    public static final CharSequence padEnd(CharSequence charSequence, int i10, char c10) {
        ...
        throw new IllegalArgumentException(a.i("Desired length ", i10, " is less than zero."));
    }
    ...
    public static final CharSequence removeRange(CharSequence charSequence, int i10, int i11) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (i11 < i10) {
            throw new IndexOutOfBoundsException(a.j("End index (", i11, ") is less than start index (", i10, ")."));
        }
        if (i11 == i10) {
            return charSequence.subSequence(0, charSequence.length());
        }
    ...
    public static final boolean toBooleanStrict(String str) {
        ...
        throw new IllegalArgumentException(e.e("The string doesn't represent a boolean value: ", str));
    }
    ...
    public static final CharSequence trim(CharSequence charSequence, Function1<? super Character, Boolean> predicate) {
        ...
        boolean z10 = false;
        while (i10 <= length) {
            boolean booleanValue = ((Boolean) a.g(charSequence, !z10 ? i10 : length, predicate)).booleanValue();
            if (z10) {
                if (!booleanValue) {
                    break;
                }
    ...
    public static final CharSequence trimStart(CharSequence charSequence, Function1<? super Character, Boolean> function1) {
        int f10 = a.f(charSequence, "<this>", function1, "predicate");
        for (int i10 = 0; i10 < f10; i10++) {
            if (!((Boolean) a.g(charSequence, i10, function1)).booleanValue()) {
    ...
    public static final CharSequence removeRange(CharSequence charSequence, IntRange range) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(range, "range");
        return removeRange(charSequence, range.getStart().intValue(), j.d(range, 1));
    }
    ...
    public static final CharSequence replaceRange(CharSequence charSequence, IntRange range, CharSequence replacement) {
        ...
        Intrinsics.checkNotNullParameter(range, "range");
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        return replaceRange(charSequence, range.getStart().intValue(), j.d(range, 1), replacement);
    }
