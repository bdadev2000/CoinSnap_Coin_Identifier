...
public final class HexExtensionsKt {
    ...
    private static final long charsPerSet(long j3, int i10, int i11) {
        if (!(i10 > 0)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        long j10 = i10;
        return ((j10 - 1) * i11) + (j3 * j10);
    }

    private static final int checkContainsAt(String str, String str2, int i10, int i11, String str3) {
        int length = str2.length() + i10;
        if (length <= i11 && StringsKt__StringsJVMKt.regionMatches(str, i10, str2, 0, str2.length(), true)) {
            return length;
        }
        StringBuilder p10 = j.p("Expected ", str3, " \"", str2, "\" at index ");
        p10.append(i10);
        p10.append(", but was ");
    ...
    private static final int checkNewLineAt(String str, int i10, int i11) {
        ...
        StringBuilder m10 = j.m("Expected a new line at index ", i10, ", but was ");
    ...
    private static final int decimalFromHexDigitAt(String str, int i10) {
        ...
        StringBuilder m10 = j.m("Expected a hexadecimal digit at index ", i10, ", but was ");
        m10.append(str.charAt(i10));
        throw new NumberFormatException(m10.toString());
    }
    ...
    public static final int formattedStringLength(int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        if (z10) {
            ...
            long j3 = ((i15 + 2 + i16) * i10) + (((i17 - i18) - i21) * i14) + (i21 * i13) + i18;
            intRangeContains = RangesKt___RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(0, Integer.MAX_VALUE), j3);
            if (intRangeContains) {
                return (int) j3;
            }
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m365toStringimpl(ULong.m319constructorimpl(j3))));
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }
    ...
    private static final long hexToLongImpl(String str, int i10, int i11, HexFormat hexFormat, int i12) {
        ...
        if (suffix.length() + prefix.length() < i11 - i10) {
            ...
            while (checkContainsAt < length) {
                j3 = (j3 << 4) | decimalFromHexDigitAt(str, checkContainsAt);
                checkContainsAt++;
            }
            return j3;
        }
        StringBuilder p10 = j.p("Expected a hexadecimal number with prefix \"", prefix, "\" and suffix \"", suffix, "\", but was ");
        Intrinsics.checkNotNull(str, "null cannot be cast to non-null type java.lang.String");
        String substring = str.substring(i10, i11);
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        p10.append(substring);
    ...
    public static final int parsedByteArrayMaxSize(int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        if (z10) {
            long j3 = i15 + 2 + i16;
            long charsPerSet2 = charsPerSet(j3, i12, i14);
            if (i11 <= i12) {
                charsPerSet = charsPerSet(j3, i11, i14);
            } else {
                charsPerSet = charsPerSet(charsPerSet2, i11 / i12, i13);
                int i18 = i11 % i12;
                if (i18 != 0) {
                    charsPerSet = charsPerSet + i13 + charsPerSet(j3, i18, i14);
                }
            }
            long j10 = i10;
            long wholeElementsPerSet = wholeElementsPerSet(j10, charsPerSet, 1);
            long j11 = j10 - ((charsPerSet + 1) * wholeElementsPerSet);
            long wholeElementsPerSet2 = wholeElementsPerSet(j11, charsPerSet2, i13);
            long j12 = j11 - ((charsPerSet2 + i13) * wholeElementsPerSet2);
            long wholeElementsPerSet3 = wholeElementsPerSet(j12, j3, i14);
            if (j12 - ((j3 + i14) * wholeElementsPerSet3) > 0) {
                i17 = 1;
            } else {
                i17 = 0;
            }
            return (int) ((wholeElementsPerSet2 * i12) + (wholeElementsPerSet * i11) + wholeElementsPerSet3 + i17);
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }
    ...
    @ExperimentalStdlibApi
    private static final String toHexStringImpl(long j3, HexFormat hexFormat, int i10) {
        boolean z10;
        String str;
        if ((i10 & 3) == 0) {
            z10 = true;
        ...
        if (z10) {
            if (hexFormat.getUpperCase()) {
                str = UPPER_CASE_HEX_DIGITS;
            } else {
                str = LOWER_CASE_HEX_DIGITS;
            }
            String prefix = hexFormat.getNumber().getPrefix();
            String suffix = hexFormat.getNumber().getSuffix();
            int length = suffix.length() + prefix.length() + (i10 >> 2);
            boolean removeLeadingZeros = hexFormat.getNumber().getRemoveLeadingZeros();
            StringBuilder sb2 = new StringBuilder(length);
            sb2.append(prefix);
            while (i10 > 0) {
                i10 -= 4;
                int i11 = (int) ((j3 >> i10) & 15);
                if (removeLeadingZeros && i11 == 0 && i10 > 0) {
    ...
    private static final long wholeElementsPerSet(long j3, long j10, int i10) {
        if (j3 <= 0 || j10 <= 0) {
            return 0L;
        }
        long j11 = i10;
        return (j3 + j11) / (j10 + j11);
    }
    ...
    private static final byte[] hexToByteArray(String str, int i10, int i11, HexFormat hexFormat) {
        ...
        while (i12 < i11) {
            if (i14 == bytesPerLine) {
                ...
                int i16 = checkContainsAt + 1;
                bArr[i13] = (byte) ((decimalFromHexDigitAt(str, checkContainsAt) << 4) | decimalFromHexDigitAt(str, i16));
                i12 = checkContainsAt(str, byteSuffix, i16 + 1, i11, "byte suffix");
                i13++;
                str2 = str2;
            }
            i15 = 0;
            ...
            int i162 = checkContainsAt2 + 1;
            bArr[i13] = (byte) ((decimalFromHexDigitAt(str, checkContainsAt2) << 4) | decimalFromHexDigitAt(str, i162));
            i12 = checkContainsAt(str, byteSuffix, i162 + 1, i11, "byte suffix");
            i13++;
            str2 = str2;
        }
    ...
    */
    ...
    public static /* synthetic */ String toHexString$default(byte b3, HexFormat hexFormat, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            hexFormat = HexFormat.INSTANCE.getDefault();
        }
    ...
    public static /* synthetic */ String toHexString$default(short s5, HexFormat hexFormat, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            hexFormat = HexFormat.INSTANCE.getDefault();
        }
        return toHexString(s5, hexFormat);
    }
    ...
    public static /* synthetic */ String toHexString$default(long j3, HexFormat hexFormat, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            hexFormat = HexFormat.INSTANCE.getDefault();
        }
    ...
    @SinceKotlin(version = "1.9")
    @ExperimentalStdlibApi
    public static final String toHexString(byte b3, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl(b3, format, 8);
    }

    @SinceKotlin(version = "1.9")
    @ExperimentalStdlibApi
    public static final String toHexString(short s5, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl(s5, format, 16);
    }

    @SinceKotlin(version = "1.9")
    @ExperimentalStdlibApi
    public static final String toHexString(int i10, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    @SinceKotlin(version = "1.9")
    @ExperimentalStdlibApi
    public static final String toHexString(long j3, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl(j3, format, 64);
    }
}
