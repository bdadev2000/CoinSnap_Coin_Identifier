...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m9755boximpl(m9749markNowz9LOYto());
    }
    ...
    public long m9749markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m9758constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m9748elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m9747differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m9746adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m9758constructorimpl(LongSaturatedMathKt.m9744saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
