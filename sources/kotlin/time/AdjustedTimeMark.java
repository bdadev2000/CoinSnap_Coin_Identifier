...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1474elapsedNowUwyO8pc() {
        return Duration.m1519minusLRDsOJo(this.mark.mo1474elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo1475minusLRDsOJo(long j3) {
        return TimeMark.DefaultImpls.m1621minusLRDsOJo(this, j3);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1477plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1520plusLRDsOJo(this.adjustment, duration), null);
    }
