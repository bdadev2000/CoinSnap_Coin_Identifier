...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(TimeMark timeMark) {
            return Duration.m1517isNegativeimpl(timeMark.mo1474elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m1621minusLRDsOJo(TimeMark timeMark, long j3) {
            return timeMark.mo1477plusLRDsOJo(Duration.m1537unaryMinusUwyO8pc(j3));
        }

        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1622plusLRDsOJo(TimeMark timeMark, long j3) {
            return new AdjustedTimeMark(timeMark, j3, null);
        }
    }

    /* renamed from: elapsedNow-UwyO8pc */
    long mo1474elapsedNowUwyO8pc();
    ...
    TimeMark mo1475minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1477plusLRDsOJo(long duration);
}
