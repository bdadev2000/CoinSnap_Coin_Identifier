...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            ...
            return Duration.m1483compareToLRDsOJo(comparableTimeMark.mo1476minusUwyO8pc(other), Duration.INSTANCE.m1587getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m1479minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j3) {
            return comparableTimeMark.mo1477plusLRDsOJo(Duration.m1537unaryMinusUwyO8pc(j3));
        }
    }
    ...
    ComparableTimeMark mo1475minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1476minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1477plusLRDsOJo(long duration);
}
