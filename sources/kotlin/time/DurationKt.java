...
public final class DurationKt {
    ...
    private static final long m9742timesmvk6XK0(int i, long j) {
        return Duration.m9653timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m9741timeskIfJnKk(double d, long j) {
        return Duration.m9652timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m9718getZEROUwyO8pc = Duration.INSTANCE.m9718getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m9651plusLRDsOJo = Duration.m9651plusLRDsOJo(m9718getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m9718getZEROUwyO8pc = Duration.m9651plusLRDsOJo(m9651plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m9718getZEROUwyO8pc = Duration.m9651plusLRDsOJo(m9718getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    obj2 = obj;
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m9718getZEROUwyO8pc = Duration.INSTANCE.m9716getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m9651plusLRDsOJo2 = Duration.m9651plusLRDsOJo(m9718getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m9718getZEROUwyO8pc = Duration.m9651plusLRDsOJo(m9651plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m9718getZEROUwyO8pc = Duration.m9651plusLRDsOJo(m9718getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m9668unaryMinusUwyO8pc(m9718getZEROUwyO8pc) : m9718getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m9615constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m9615constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m9615constructorimpl((j << 1) + i);
    }
