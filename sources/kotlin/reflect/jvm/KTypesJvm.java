    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo9553getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo9553getDeclarationDescriptor();
                classDescriptor = mo9553getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo9553getDeclarationDescriptor : null;
