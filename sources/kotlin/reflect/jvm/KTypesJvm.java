    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo1423getDeclarationDescriptor();
                classDescriptor = mo1423getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo1423getDeclarationDescriptor : null;
