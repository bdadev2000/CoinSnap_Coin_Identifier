...
public final class UtilKt {
    ...
    */
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            if (value2 instanceof KClassValue.Value.LocalClass) {
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1423getDeclarationDescriptor();
            ...
            if (constantValue instanceof ErrorValue) {
                ...
                z10 = constantValue instanceof NullValue;
            }
            if (!z10) {
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i10) {
        ...
        return ReflectJavaClassFinderKt.tryLoadClass(classLoader, sb3);
    }
}
