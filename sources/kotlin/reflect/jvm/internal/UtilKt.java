...
public final class UtilKt {
    ...
    private static final List<Annotation> unwrapRepeatableAnnotations(List<? extends Annotation> list) {
        ...
        while (it.hasNext()) {
            if (Intrinsics.areEqual(JvmClassMappingKt.getJavaClass(JvmClassMappingKt.getAnnotationClass((Annotation) it.next())).getSimpleName(), TextFieldImplKt.ContainerId)) {
                ArrayList arrayList = new ArrayList();
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor mo9553getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo9553getDeclarationDescriptor();
