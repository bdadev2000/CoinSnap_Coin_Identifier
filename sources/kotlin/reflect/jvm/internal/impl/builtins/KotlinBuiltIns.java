...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo1425getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1425getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo1425getContributedClassifier != null) {
                    ...
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo1425getContributedClassifier);
                }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(mo1423getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo1423getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo1423getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1423getDeclarationDescriptor = kotlinType.getConstructor().mo1423getDeclarationDescriptor();
        if (mo1423getDeclarationDescriptor != null && getPrimitiveArrayType(mo1423getDeclarationDescriptor) != null) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1423getDeclarationDescriptor = kotlinType.getConstructor().mo1423getDeclarationDescriptor();
        if ((mo1423getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo1423getDeclarationDescriptor)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        if ((mo1423getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo1423getDeclarationDescriptor, fqNameUnsafe)) {
            return true;
        }
        return false;
    }
