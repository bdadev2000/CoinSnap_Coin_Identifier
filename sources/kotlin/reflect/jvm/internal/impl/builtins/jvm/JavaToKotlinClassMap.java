...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        ClassId classId8 = ClassId.topLevel(StandardNames.FqNames.map);
        ...
        PlatformMutabilityMapping platformMutabilityMapping7 = new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Map.class), classId8, new ClassId(packageFqName13, FqNamesUtilKt.tail(fqName7, packageFqName14), false));
        ...
        FqName tail = FqNamesUtilKt.tail(fqName8, packageFqName16);
