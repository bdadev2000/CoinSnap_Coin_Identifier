...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (mo9553getDeclarationDescriptor != null) {
            return getFunctionTypeKind(mo9553getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo9553getDeclarationDescriptor = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        return mo9553getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo9553getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo9548findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo9548findAnnotation = kotlinType.getAnnotations().mo9548findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo9548findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo9548findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo9548findAnnotation = kotlinType.getAnnotations().mo9548findAnnotation(StandardNames.FqNames.parameterName);
        if (mo9548findAnnotation == null) {
            return null;
        }
