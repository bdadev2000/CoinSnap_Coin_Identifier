...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo9553getDeclarationDescriptor = typeConstructor.mo9553getDeclarationDescriptor();
        if ((mo9553getDeclarationDescriptor instanceof TypeParameterDescriptor) || (mo9553getDeclarationDescriptor instanceof ClassDescriptor) || (mo9553getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(mo9553getDeclarationDescriptor);
        }
        if (mo9553getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo9553getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo9553getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo9547getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo9547getUnsubstitutedPrimaryConstructor = annotationClass.mo9547getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo9547getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderReceiver(CallableDescriptor callableDescriptor, StringBuilder sb) {
        ...
        if (extensionReceiverParameter != null) {
            ...
            KotlinType type = extensionReceiverParameter.getType();
            Intrinsics.checkNotNullExpressionValue(type, "getType(...)");
            sb.append(renderForReceiver(type)).append(InstructionFileId.DOT);
        }
    }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (mo9549getCompileTimeInitializer = variableDescriptor.mo9549getCompileTimeInitializer()) == null || (renderConstant = renderConstant(mo9549getCompileTimeInitializer)) == null) {
            return;
        }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo9547getUnsubstitutedPrimaryConstructor = classDescriptor.mo9547getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo9547getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo9547getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo9547getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, mo9547getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo9554getSupertypes = classDescriptor.getTypeConstructor().mo9554getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo9554getSupertypes, "getSupertypes(...)");
        if (mo9554getSupertypes.isEmpty()) {
            return;
        }
        if (mo9554getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo9554getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo9554getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
