...
public class Flags {
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        ...
        public Boolean get(int i10) {
            Boolean valueOf = Boolean.valueOf((i10 & (1 << this.offset)) != 0);
            if (valueOf == null) {
                $$$reportNull$$$0(0);
            }
            return valueOf;
    ...
    */
    ...
    public static int getAccessorFlags(boolean z10, ProtoBuf.Visibility visibility, ProtoBuf.Modality modality, boolean z11, boolean z12, boolean z13) {
        if (visibility == null) {
            $$$reportNull$$$0(10);
        }
        if (modality == null) {
