...
public final class DescriptorUtilKt {
    ...
    public static final ClassDescriptor resolveClassByFqName(ModuleDescriptor moduleDescriptor, FqName fqName, LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor mo1425getContributedClassifier = memberScope.mo1425getContributedClassifier(shortName, lookupLocation);
        ...
        if (resolveClassByFqName != null && (unsubstitutedInnerClassesScope = resolveClassByFqName.getUnsubstitutedInnerClassesScope()) != null) {
            ...
            classifierDescriptor = unsubstitutedInnerClassesScope.mo1425getContributedClassifier(shortName2, lookupLocation);
        } else {
