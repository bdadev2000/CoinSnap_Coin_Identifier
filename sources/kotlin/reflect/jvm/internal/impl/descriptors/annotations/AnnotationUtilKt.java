...
public final class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(final KotlinBuiltIns kotlinBuiltIns, String message, String replaceWith, String level, boolean z) {
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt.mapOf(pair, pair2, TuplesKt.to(name, new EnumValue(classId, identifier))), z);
    }

    static {
        Name identifier = Name.identifier(LogEventArguments.ARG_MESSAGE);
        Intrinsics.checkNotNullExpressionValue(identifier, "identifier(...)");
