...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo1426reportSupertypeLoopError(kotlinType);
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z10, int i10, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> mo1424getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo1424getSupertypes();
        if (mo1424getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
    ...
    public abstract void mo1426reportSupertypeLoopError(KotlinType kotlinType);
