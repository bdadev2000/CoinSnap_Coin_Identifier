...
public abstract class DeserializedPackageFragmentImpl extends DeserializedPackageFragment {
    ...
    public void initialize(DeserializationComponents components) {
        ...
        if (packageFragment != null) {
            ...
            this._memberScope = new DeserializedPackageMemberScope(this, r42, this.nameResolver, this.metadataVersion, this.containerSource, components, "scope of " + this, new Function0<Collection<? extends Name>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializedPackageFragmentImpl$initialize$1
                {
                    super(0);
                }
