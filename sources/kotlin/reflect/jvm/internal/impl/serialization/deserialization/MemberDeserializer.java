...
public final class MemberDeserializer {
    ...
    public final PropertyDescriptor loadProperty(ProtoBuf.Property proto) {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(toContextReceiver((ProtoBuf.Type) next, childContext$default, deserializedPropertyDescriptor, i));
            it = it;
            i = i2;
        }
        ...
        deserializedPropertyDescriptor.initialize(propertyGetterDescriptorImpl2, propertySetterDescriptorImpl, new FieldDescriptorImpl(getPropertyFieldAnnotations(property2, false), deserializedPropertyDescriptor2), new FieldDescriptorImpl(getPropertyFieldAnnotations(property2, true), deserializedPropertyDescriptor2));
