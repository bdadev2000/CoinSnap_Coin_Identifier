...
public final class CompositeSyntheticJavaPartsProvider implements SyntheticJavaPartsProvider {
    ...
    public List<Name> getMethodNames(LazyJavaResolverContext _context_receiver_0, ClassDescriptor thisDescriptor) {
        ...
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getMethodNames(_context_receiver_0, thisDescriptor));
        }
        return arrayList;
    }
    ...
    public List<Name> getNestedClassNames(LazyJavaResolverContext _context_receiver_0, ClassDescriptor thisDescriptor) {
        ...
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getNestedClassNames(_context_receiver_0, thisDescriptor));
        }
        return arrayList;
    }
    ...
    public List<Name> getStaticFunctionNames(LazyJavaResolverContext _context_receiver_0, ClassDescriptor thisDescriptor) {
        ...
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getStaticFunctionNames(_context_receiver_0, thisDescriptor));
        }
        return arrayList;
    }
}
