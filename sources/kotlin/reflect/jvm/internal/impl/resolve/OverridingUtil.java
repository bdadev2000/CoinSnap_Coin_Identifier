...
public class OverridingUtil {
        ...
        KotlinTypeChecker.TypeConstructorEquality typeConstructorEquality = new KotlinTypeChecker.TypeConstructorEquality() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.1
            private static /* synthetic */ void $$$reportNull$$$0(int i10) {
                ...
                if (i10 != 1) {
                    ...
                    objArr[0] = DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B;
                }
    ...
    */
    ...
    public static boolean isVisibleForOverride(MemberDescriptor memberDescriptor, MemberDescriptor memberDescriptor2, boolean z10) {
    ...
    public static <D extends CallableDescriptor> boolean overrides(D d10, D d11, boolean z10, boolean z11) {
        if (d10 == null) {
            $$$reportNull$$$0(13);
        }
        if (d11 == null) {
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z10) {
        ...
        for (int i12 = 0; i12 < compiledValueParameters.size(); i12++) {
            if (!areTypesEquivalent(compiledValueParameters.get(i12), compiledValueParameters2.get(i12), createTypeCheckerState)) {
        ...
        if (z10) {
            ...
            if (returnType != null && returnType2 != null) {
                ...
                if (i10 == 0 && !AbstractTypeChecker.INSTANCE.isSubtypeOf(createTypeCheckerState, returnType2.unwrap(), returnType.unwrap())) {
