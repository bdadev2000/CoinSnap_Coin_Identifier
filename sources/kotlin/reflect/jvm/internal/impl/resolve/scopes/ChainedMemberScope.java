...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1425getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor mo1425getContributedClassifier = memberScope.mo1425getContributedClassifier(name, location);
            if (mo1425getContributedClassifier != null) {
                if ((mo1425getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) && ((ClassifierDescriptorWithTypeParameters) mo1425getContributedClassifier).isExpect()) {
                    if (classifierDescriptor == null) {
                        classifierDescriptor = mo1425getContributedClassifier;
                    }
                } else {
    ...
    public void mo1429recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo1429recordLookup(name, location);
        }
    }
