...
public final class SubstitutingScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1425getContributedClassifier(Name name, LookupLocation location) {
        ...
        if (mo1425getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute((SubstitutingScope) mo1425getContributedClassifier);
        }
        return null;
    }
    ...
    public void mo1429recordLookup(Name name, LookupLocation lookupLocation) {
