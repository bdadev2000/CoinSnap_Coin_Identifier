...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo1425getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor mo1425getContributedClassifier = this.workerScope.mo1425getContributedClassifier(name, location);
        if (mo1425getContributedClassifier == null) {
            return null;
        }
        if (mo1425getContributedClassifier instanceof ClassDescriptor) {
            classDescriptor = (ClassDescriptor) mo1425getContributedClassifier;
        } else {
        ...
        if (!(mo1425getContributedClassifier instanceof TypeAliasDescriptor)) {
            return null;
        }
        return (TypeAliasDescriptor) mo1425getContributedClassifier;
    }
    ...
    public void mo1429recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo1429recordLookup(name, location);
    }
