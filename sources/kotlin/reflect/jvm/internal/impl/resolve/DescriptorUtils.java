...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(D d10, Set<D> set) {
        if (d10 == null) {
            $$$reportNull$$$0(73);
        }
        if (set == 0) {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo1423getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo1423getDeclarationDescriptor);
    }
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z10) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo1424getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        ClassifierDescriptor mo1423getDeclarationDescriptor = kotlinType.getConstructor().mo1423getDeclarationDescriptor();
        if (mo1423getDeclarationDescriptor != null) {
            DeclarationDescriptor original = mo1423getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo1424getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends DeclarationDescriptor> D getParentOfType(DeclarationDescriptor declarationDescriptor, Class<D> cls, boolean z10) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
