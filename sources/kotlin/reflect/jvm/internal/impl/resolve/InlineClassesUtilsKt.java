...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (mo9553getDeclarationDescriptor != null) {
            return isInlineClass(mo9553getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo9553getDeclarationDescriptor = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        if (mo9553getDeclarationDescriptor != null) {
            return isValueClass(mo9553getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo9553getDeclarationDescriptor = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        return (mo9553getDeclarationDescriptor == null || !isMultiFieldValueClass(mo9553getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
