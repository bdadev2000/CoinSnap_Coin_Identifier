...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a2, final CallableDescriptor b, final boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality(z, a2, b) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$0
            ...
            return create.isOverridableBy(a2, b, null, z3 ^ true).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE && create.isOverridableBy(b, a2, null, z3 ^ true).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE;
        }
        return false;
    }
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a2, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo9553getDeclarationDescriptor = c1.mo9553getDeclarationDescriptor();
        ClassifierDescriptor mo9553getDeclarationDescriptor2 = c2.mo9553getDeclarationDescriptor();
        if ((mo9553getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo9553getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo9553getDeclarationDescriptor, (TypeParameterDescriptor) mo9553getDeclarationDescriptor2, z, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1
