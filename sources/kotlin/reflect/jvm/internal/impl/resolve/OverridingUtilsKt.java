        ...
        while (true) {
            ...
            if (!linkedList2.isEmpty()) {
                ...
                if (extractMembersOverridableInBothWays.size() == 1 && create2.isEmpty()) {
                    ...
                    for (ArtificialStackFrames artificialStackFrames2 : extractMembersOverridableInBothWays) {
                        Intrinsics.checkNotNull(artificialStackFrames2);
                        if (!OverridingUtil.isMoreSpecific(invoke, descriptorByHandle.invoke(artificialStackFrames2))) {
                            create2.add(artificialStackFrames2);
                        }
                    }
