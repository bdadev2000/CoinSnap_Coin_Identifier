...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo9555getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo9555getContributedClassifier = this.javaScope.mo9555getContributedClassifier(name, location);
        if (mo9555getContributedClassifier != null) {
            return mo9555getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo9555getContributedClassifier(name, location);
