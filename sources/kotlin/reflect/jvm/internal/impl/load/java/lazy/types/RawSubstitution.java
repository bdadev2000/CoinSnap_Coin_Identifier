...
public final class RawSubstitution extends TypeSubstitution {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.TypeSubstitution
    /* renamed from: get */
    public TypeProjectionImpl mo9558get(KotlinType key) {
    ...
    private final KotlinType eraseType(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (mo9553getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return eraseType(this.typeParameterUpperBoundEraser.getErasedUpperBound((TypeParameterDescriptor) mo9553getDeclarationDescriptor, javaTypeAttributes.markIsRaw(true)), javaTypeAttributes);
        }
        if (mo9553getDeclarationDescriptor instanceof ClassDescriptor) {
            ClassifierDescriptor mo9553getDeclarationDescriptor2 = FlexibleTypesKt.upperIfFlexible(kotlinType).getConstructor().mo9553getDeclarationDescriptor();
            if (!(mo9553getDeclarationDescriptor2 instanceof ClassDescriptor)) {
                throw new IllegalStateException(("For some reason declaration for upper bound is not a class but \"" + mo9553getDeclarationDescriptor2 + "\" while for lower it's \"" + mo9553getDeclarationDescriptor + Typography.quote).toString());
            }
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.lowerIfFlexible(kotlinType), (ClassDescriptor) mo9553getDeclarationDescriptor, lowerTypeAttr);
            ...
            Pair<SimpleType, Boolean> eraseInflexibleBasedOnClassDescriptor2 = eraseInflexibleBasedOnClassDescriptor(FlexibleTypesKt.upperIfFlexible(kotlinType), (ClassDescriptor) mo9553getDeclarationDescriptor2, upperTypeAttr);
        ...
        throw new IllegalStateException(("Unexpected declaration kind: " + mo9553getDeclarationDescriptor).toString());
    }
