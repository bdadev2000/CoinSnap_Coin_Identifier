...
public final class TypeEnhancementUtilsKt {
    ...
    */
    ...
    private static final <T> T select(Set<? extends T> set, T t5, T t10, T t11, boolean z10) {
        Set<? extends T> set2;
        if (z10) {
            T t12 = set.contains(t5) ? t5 : set.contains(t10) ? t10 : null;
            if (Intrinsics.areEqual(t12, t5) && Intrinsics.areEqual(t11, t10)) {
                return null;
            }
