...
public final class AnnotationQualifiersFqNamesKt {
    ...
    static {
        ...
        Map<FqName, JavaDefaultQualifiers> mapOf = MapsKt.mapOf(TuplesKt.to(jspecify_old_null_marked, new JavaDefaultQualifiers(new NullabilityQualifierWithMigrationStatus(nullabilityQualifier, z10, i10, defaultConstructorMarker), listOf, false)), TuplesKt.to(JvmAnnotationNamesKt.getJSPECIFY_NULL_MARKED(), new JavaDefaultQualifiers(new NullabilityQualifierWithMigrationStatus(nullabilityQualifier, z10, i10, defaultConstructorMarker), listOf, false)));
        JSPECIFY_DEFAULT_ANNOTATIONS = mapOf;
        boolean z11 = false;
        int i11 = 4;
        DefaultConstructorMarker defaultConstructorMarker2 = null;
        BUILT_IN_TYPE_QUALIFIER_DEFAULT_ANNOTATIONS = MapsKt.plus(MapsKt.mapOf(TuplesKt.to(new FqName("javax.annotation.ParametersAreNullableByDefault"), new JavaDefaultQualifiers(new NullabilityQualifierWithMigrationStatus(NullabilityQualifier.NULLABLE, z10, i10, defaultConstructorMarker), CollectionsKt.listOf(annotationQualifierApplicabilityType), z11, i11, defaultConstructorMarker2)), TuplesKt.to(new FqName("javax.annotation.ParametersAreNonnullByDefault"), new JavaDefaultQualifiers(new NullabilityQualifierWithMigrationStatus(nullabilityQualifier, z10, i10, defaultConstructorMarker), CollectionsKt.listOf(annotationQualifierApplicabilityType), z11, i11, defaultConstructorMarker2))), mapOf);
