...
public interface ClassicTypeSystemContext extends TypeSystemCommonBackendContext, TypeSystemInferenceExtensionContext {
    ...
    public static final class DefaultImpls {
        ...
        public static TypeArgumentListMarker asArgumentList(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker receiver) {
            ...
            StringBuilder p10 = a.p("ClassicTypeSystemContext couldn't handle: ", receiver, ", ");
        ...
        public static SimpleTypeMarker captureFromArguments(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker type, CaptureStatus status) {
            ...
            StringBuilder p10 = a.p("ClassicTypeSystemContext couldn't handle: ", type, ", ");
        ...
        public static FqNameUnsafe getClassFqNameUnsafe(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((TypeConstructor) receiver).mo1423getDeclarationDescriptor();
                ...
                return DescriptorUtilsKt.getFqNameUnsafe((ClassDescriptor) mo1423getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static PrimitiveType getPrimitiveArrayType(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((TypeConstructor) receiver).mo1423getDeclarationDescriptor();
                Intrinsics.checkNotNull(mo1423getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveArrayType((ClassDescriptor) mo1423getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static PrimitiveType getPrimitiveType(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((TypeConstructor) receiver).mo1423getDeclarationDescriptor();
                Intrinsics.checkNotNull(mo1423getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveType((ClassDescriptor) mo1423getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static TypeParameterMarker getTypeParameterClassifier(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ...
                if (mo1423getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                    return (TypeParameterDescriptor) mo1423getDeclarationDescriptor;
                }
                return null;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        ...
        public static boolean identicalArguments(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker a, SimpleTypeMarker b3) {
            Intrinsics.checkNotNullParameter(a, "a");
            Intrinsics.checkNotNullParameter(b3, "b");
            if (a instanceof SimpleType) {
                if (b3 instanceof SimpleType) {
                    if (((SimpleType) a).getArguments() == ((SimpleType) b3).getArguments()) {
                        return true;
                    }
                    return false;
                }
                StringBuilder p10 = a.p("ClassicTypeSystemContext couldn't handle: ", b3, ", ");
                p10.append(Reflection.getOrCreateKotlinClass(b3.getClass()));
                throw new IllegalArgumentException(p10.toString().toString());
            }
            StringBuilder p11 = a.p("ClassicTypeSystemContext couldn't handle: ", a, ", ");
            p11.append(Reflection.getOrCreateKotlinClass(a.getClass()));
        ...
        public static boolean isClassTypeConstructor(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                return ((TypeConstructor) receiver).mo1423getDeclarationDescriptor() instanceof ClassDescriptor;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static boolean isUnderKotlinPackage(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor mo1423getDeclarationDescriptor = ((TypeConstructor) receiver).mo1423getDeclarationDescriptor();
                if (mo1423getDeclarationDescriptor == null || !KotlinBuiltIns.isUnderKotlinPackage(mo1423getDeclarationDescriptor)) {
                    return false;
                }
                return true;
            }
        ...
        public static TypeCheckerState.SupertypesPolicy substitutionSupertypePolicy(final ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker type) {
            ...
            if (type instanceof SimpleType) {
                ...
                return new TypeCheckerState.SupertypesPolicy.DoCustomTransform() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeSystemContext$substitutionSupertypePolicy$2
                    ...
                    public SimpleTypeMarker mo1427transformType(TypeCheckerState state, KotlinTypeMarker type2) {
        ...
        public static Collection<KotlinTypeMarker> supertypes(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                Collection<KotlinType> mo1424getSupertypes = ((TypeConstructor) receiver).mo1424getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1424getSupertypes, "this.supertypes");
