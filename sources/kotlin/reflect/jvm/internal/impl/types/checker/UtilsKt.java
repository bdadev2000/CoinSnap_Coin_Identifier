...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo9554getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor mo9553getDeclarationDescriptor = typeConstructor.mo9553getDeclarationDescriptor(); mo9553getDeclarationDescriptor != null; mo9553getDeclarationDescriptor = mo9553getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(mo9553getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + mo9553getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
