    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo9554getSupertypes = capturedTypeConstructorImpl.mo9554getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo9554getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo9554getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo9554getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo9554getSupertypes2, 10));
            Iterator<T> it2 = mo9554getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo9554getSupertypes3 = intersectionTypeConstructor2.mo9554getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo9554getSupertypes3, 10));
        Iterator<T> it3 = mo9554getSupertypes3.iterator();
        while (it3.hasNext()) {
