...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ClassifierDescriptor mo9553getDeclarationDescriptor = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        if (mo9553getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(mo9553getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) mo9553getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor mo9553getDeclarationDescriptor2 = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo9553getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo9553getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo9553getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor mo9553getDeclarationDescriptor = kotlinType.getConstructor().mo9553getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo9553getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo9553getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$containsTypeAliasParameters$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo9553getDeclarationDescriptor = it.getConstructor().mo9553getDeclarationDescriptor();
                return Boolean.valueOf(mo9553getDeclarationDescriptor != null ? TypeUtilsKt.isTypeAliasParameter(mo9553getDeclarationDescriptor) : false);
            }
        });
    }
    ...
    public static final boolean requiresTypeAliasExpansion(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$requiresTypeAliasExpansion$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo9553getDeclarationDescriptor = it.getConstructor().mo9553getDeclarationDescriptor();
                boolean z = false;
                if (mo9553getDeclarationDescriptor != null && ((mo9553getDeclarationDescriptor instanceof TypeAliasDescriptor) || (mo9553getDeclarationDescriptor instanceof TypeParameterDescriptor))) {
                    z = true;
                }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor mo9553getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo9553getDeclarationDescriptor();
            ClassDescriptor classDescriptor = mo9553getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo9553getDeclarationDescriptor : null;
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo9553getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo9553getDeclarationDescriptor() != null) {
            ...
            if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo9553getDeclarationDescriptor() != null) {
