...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1423getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z10) {
        DeclarationDescriptor containingDeclaration = mo1423getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo1416getCompanionObjectDescriptor = classDescriptor.mo1416getCompanionObjectDescriptor();
        if (z10 && mo1416getCompanionObjectDescriptor != null) {
            smartList.add(mo1416getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1423getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo1423getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        if ((classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo1423getDeclarationDescriptor(), classifierDescriptor)) {
            return true;
        }
        return false;
    }
