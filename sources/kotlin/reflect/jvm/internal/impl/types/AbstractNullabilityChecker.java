                ...
                if (supertypesSet.size() <= 1000) {
                    ...
                    if (supertypesSet.add(current)) {
                        ...
                        if (supertypesPolicy2 == null) {
                            ...
                            while (it.hasNext()) {
                                SimpleTypeMarker mo1427transformType = supertypesPolicy2.mo1427transformType(typeCheckerState, it.next());
                                if ((typeSystemContext.isClassType(mo1427transformType) && !typeSystemContext.isMarkedNullable(mo1427transformType)) || typeSystemContext.isDefinitelyNotNullType(mo1427transformType)) {
                                    z11 = true;
                                } else {
                                    z11 = false;
                                }
                    ...
                    StringBuilder p10 = a.p("Too many supertypes for type: ", type, ". Supertypes = ");
            ...
            if (supertypesSet.size() <= 1000) {
                ...
                if (supertypesSet.add(current)) {
                    ...
                    if (supertypesPolicy == null) {
                        ...
                        Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current)).iterator();
                        while (it.hasNext()) {
                            SimpleTypeMarker mo1427transformType = supertypesPolicy.mo1427transformType(state, it.next());
                            if (INSTANCE.isApplicableAsEndNode(state, mo1427transformType, end)) {
                                state.clear();
                                return true;
                            }
                            supertypesDeque.add(mo1427transformType);
                ...
                StringBuilder p10 = a.p("Too many supertypes for type: ", start, ". Supertypes = ");
                joinToString$default = CollectionsKt___CollectionsKt.joinToString$default(supertypesSet, null, null, null, 0, null, null, 63, null);
                p10.append(joinToString$default);
                throw new IllegalStateException(p10.toString().toString());
            }
