...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public Data() {
            ...
            this.objectInstance = ReflectProperties.lazy(new Function0<T>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$objectInstance$2
                ...
                public final T invoke() {
                    ...
                    Intrinsics.checkNotNull(t5, "null cannot be cast to non-null type T of kotlin.reflect.jvm.internal.KClassImpl");
                    return t5;
                }
            });
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo1424getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1424getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo1424getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(mo1424getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo1424getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo1423getDeclarationDescriptor = KotlinType.this.getConstructor().mo1423getDeclarationDescriptor();
                                if (mo1423getDeclarationDescriptor instanceof ClassDescriptor) {
                                    Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo1423getDeclarationDescriptor);
                                    if (javaClass != null) {
                                        ...
                                        throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo1423getDeclarationDescriptor);
                                    }
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo1423getDeclarationDescriptor);
                                }
                                throw new KotlinReflectionInternalError("Supertype not a class: " + mo1423getDeclarationDescriptor);
                            }
                        }));
                    }
            ...
            this.allNonStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allNonStaticMembers$2
                ...
                public final List<? extends KCallableImpl<?>> invoke() {
                    ...
                    return kotlin.collections.CollectionsKt.plus((Collection) declaredNonStaticMembers, (Iterable) inheritedNonStaticMembers);
                }
            });
            this.allStaticMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allStaticMembers$2
                ...
                public final List<? extends KCallableImpl<?>> invoke() {
                    ...
                    return kotlin.collections.CollectionsKt.plus(declaredStaticMembers, (Iterable) inheritedStaticMembers);
                }
            });
            this.declaredMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$declaredMembers$2
                ...
                public final List<? extends KCallableImpl<?>> invoke() {
                    ...
                    Collection<KCallableImpl<?>> declaredNonStaticMembers = this.this$0.getDeclaredNonStaticMembers();
                    declaredStaticMembers = this.this$0.getDeclaredStaticMembers();
                    return kotlin.collections.CollectionsKt.plus((Collection) declaredNonStaticMembers, (Iterable) declaredStaticMembers);
                }
            });
            this.allMembers = ReflectProperties.lazySoft(new Function0<List<? extends KCallableImpl<?>>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$allMembers$2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final List<? extends KCallableImpl<?>> invoke() {
                    return kotlin.collections.CollectionsKt.plus((Collection) this.this$0.getAllNonStaticMembers(), (Iterable) this.this$0.getAllStaticMembers());
                }
            });
        }
        ...
        public final String calculateLocalClassName(Class<?> jClass) {
            ...
            Intrinsics.checkNotNullExpressionValue(name, "name");
            substringAfter$default = StringsKt__StringsKt.substringAfter$default(name, Typography.dollar, (String) null, 2, (Object) null);
