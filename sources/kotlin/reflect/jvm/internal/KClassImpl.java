...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data() {
            ...
            this.descriptor = ReflectProperties.lazySoft(new Function0<ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$descriptor$2
                ...
                public final ClassDescriptor invoke() {
                    ...
                    if (classId.isLocal() && r1.getJClass().isAnnotationPresent(Metadata.class)) {
                    ...
                    createSyntheticClassOrFail = r1.createSyntheticClassOrFail(classId, moduleData);
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo9554getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo9554getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo9554getSupertypes, "getSupertypes(...)");
                    ArrayList arrayList = new ArrayList(mo9554getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo9554getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo9553getDeclarationDescriptor = KotlinType.this.getConstructor().mo9553getDeclarationDescriptor();
                                if (!(mo9553getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo9553getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo9553getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo9553getDeclarationDescriptor);
                                }
                                ...
                                if (indexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo9553getDeclarationDescriptor);
                                }
    ...
    public String toString() {
        ...
        Intrinsics.checkNotNullExpressionValue(asString, "asString(...)");
        return sb.append(str + StringsKt.replace$default(asString, '.', Typography.dollar, false, 4, (Object) null)).toString();
    }
