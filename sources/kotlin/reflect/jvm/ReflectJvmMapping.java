...
public final class ReflectJvmMapping {
    ...
    public static final <T> KFunction<T> getKotlinFunction(Constructor<T> constructor) {
        ...
        while (true) {
            ...
            t5 = it.next();
            if (Intrinsics.areEqual(getJavaConstructor((KFunction) t5), constructor)) {
                break;
            }
        }
        return (KFunction) t5;
