...
public final class UIntKt {
    ...
    @InlineOnly
    private static final int toUInt(byte b3) {
        return UInt.m240constructorimpl(b3);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final int toUInt(short s5) {
        return UInt.m240constructorimpl(s5);
    }
    ...
    private static final int toUInt(int i10) {
        return UInt.m240constructorimpl(i10);
    }

    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final int toUInt(long j3) {
