...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return onFailure.invoke(m148exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r6) {
        return Result.m151isFailureimpl(obj) ? r6 : obj;
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        if (Result.m152isSuccessimpl(obj)) {
            return Result.m145constructorimpl(transform.invoke(obj));
        }
        return Result.m145constructorimpl(obj);
    }
    ...
    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        if (Result.m152isSuccessimpl(obj)) {
            try {
                ...
                return Result.m145constructorimpl(createFailure(th2));
            }
        }
        return Result.m145constructorimpl(obj);
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable m148exceptionOrNullimpl = Result.m148exceptionOrNullimpl(obj);
        if (m148exceptionOrNullimpl != null) {
            action.invoke(m148exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Throwable m148exceptionOrNullimpl = Result.m148exceptionOrNullimpl(obj);
        if (m148exceptionOrNullimpl != null) {
            return Result.m145constructorimpl(transform.invoke(m148exceptionOrNullimpl));
        }
        return obj;
    }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m145constructorimpl(block.invoke());
        } catch (Throwable th2) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T, R> Object runCatching(T t5, Function1<? super T, ? extends R> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m145constructorimpl(block.invoke(t5));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m145constructorimpl(createFailure(th2));
        }
