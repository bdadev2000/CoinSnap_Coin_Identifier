...
public final class FileVisitorBuilderImpl implements FileVisitorBuilder {
    ...
    private final void checkNotDefined(Object function, String name) {
        if (function == null) {
            ...
            throw new IllegalStateException(j.k(name, " was already defined"));
        }
    }
    ...
    public final FileVisitor<Path> build() {
        checkIsNotBuilt();
        this.isBuilt = true;
        return d2.a.p(new FileVisitorImpl(this.onPreVisitDirectory, this.onVisitFile, this.onVisitFileFailed, this.onPostVisitDirectory));
    }
