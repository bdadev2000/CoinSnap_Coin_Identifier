...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    private static final void forEachDirectoryEntry(Path path, String glob, Function1<? super Path, Unit> action) throws IOException {
        ...
        try {
            DirectoryStream f10 = b.f(newDirectoryStream);
    ...
    */
    public static final java.lang.String getExtension(java.nio.file.Path r1) {
        /*
            ...
            java.nio.file.Path r1 = kotlin.io.path.a.m(r1)
            if (r1 == 0) goto L17
            java.lang.String r1 = r1.toString()
            if (r1 == 0) goto L17
            java.lang.String r1 = kotlin.text.StringsKt.E(r1)
            if (r1 != 0) goto L19
        L17:
            java.lang.String r1 = ""
        L19:
    ...
    */
    public static final java.lang.String getNameWithoutExtension(java.nio.file.Path r1) {
        /*
            ...
            java.lang.String r1 = r1.toString()
            if (r1 == 0) goto L17
            java.lang.String r1 = kotlin.text.StringsKt.J(r1)
            if (r1 != 0) goto L19
        L17:
            java.lang.String r1 = ""
        L19:
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream f10 = b.f(newDirectoryStream);
            Intrinsics.checkNotNull(f10);
            List<Path> list = CollectionsKt.toList(f10);
            CloseableKt.closeFinally(newDirectoryStream, null);
            return list;
        } finally {
        }
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream f10 = b.f(newDirectoryStream);
            Intrinsics.checkNotNull(f10);
            T invoke = block.invoke(CollectionsKt.asSequence(f10));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(newDirectoryStream, null);
            } else if (newDirectoryStream != null) {
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i10, Object obj) throws IOException {
        ...
        try {
            DirectoryStream f10 = b.f(newDirectoryStream);
            Intrinsics.checkNotNull(f10);
            Object invoke = block.invoke(CollectionsKt.asSequence(f10));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(newDirectoryStream, null);
            } else if (newDirectoryStream != null) {
    ...
    @SinceKotlin(version = "1.7")
    @ExperimentalPathApi
    public static final void visitFileTree(Path path, int i10, boolean z10, Function1<? super FileVisitorBuilder, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
