...
class NumbersKt__NumbersJVMKt extends NumbersKt__FloorDivModKt {
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final long rotateLeft(long j3, int i10) {
        return Long.rotateLeft(j3, i10);
    }

    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final long rotateRight(long j3, int i10) {
        return Long.rotateRight(j3, i10);
    }
