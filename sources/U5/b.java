...
public abstract class b {
    ...
    public static WindowManager f3341a;
    public static final String[] b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    public static float f3342c = Resources.getSystem().getDisplayMetrics().density;

    public static JSONObject a(int i9, int i10, int i11, int i12) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("x", i9 / f3342c);
            jSONObject.put("y", i10 / f3342c);
            jSONObject.put("width", i11 / f3342c);
            jSONObject.put("height", i12 / f3342c);
        } catch (JSONException e4) {
            m.c("Error with creating viewStateObject", e4);
        }
        return jSONObject;
    }
    ...
    public static void b(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            m.c("JSONException during JSONObject.put for name [" + str + "]", e4);
        }
    }
    ...
    public static void d(JSONObject jSONObject) {
        ...
        if (f3341a != null) {
            ...
            f3341a.getDefaultDisplay().getRealSize(point);
            float f11 = point.x;
            float f12 = f3342c;
            f9 = f11 / f12;
            f10 = point.y / f12;
