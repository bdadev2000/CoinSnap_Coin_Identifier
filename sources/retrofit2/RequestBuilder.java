...
public final class RequestBuilder {
    ...
    public void addHeader(String str, String str2) {
        ...
        try {
            ...
            throw new IllegalArgumentException(j.b("Malformed content type: ", str2), e);
        }
    }
    ...
    public void addPathParam(String str, String str2, boolean z2) {
        ...
        if (PATH_TRAVERSAL.matcher(replace).matches()) {
            throw new IllegalArgumentException(j.b("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
