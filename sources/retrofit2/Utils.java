...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return d.r(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static Type getParameterUpperBound(int i2, ParameterizedType parameterizedType) {
        ...
        StringBuilder t2 = d.t("Index ", i2, " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, int i2, String str, Object... objArr) {
        StringBuilder B = androidx.compose.foundation.text.input.a.B(str, " (parameter #");
        B.append(i2 + 1);
        B.append(")");
        return methodError(method, B.toString(), objArr);
    }
    ...
    */
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder B = androidx.compose.foundation.text.input.a.B(String.format(str, objArr), "\n    for method ");
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i2, String str, Object... objArr) {
        ...
        B.append(i2 + 1);
        B.append(")");
        return methodError(method, th, B.toString(), objArr);
    }
}
