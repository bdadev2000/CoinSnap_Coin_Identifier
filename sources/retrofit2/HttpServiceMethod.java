...
public abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            try {
                return this.isNullable ? KotlinExtensions.awaitNullable(adapt, gVar) : KotlinExtensions.await(adapt, gVar);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, gVar);
            }
        }
    }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            g gVar = (g) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(adapt, gVar);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, gVar);
            }
        }
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        return !z3 ? new CallAdapted(requestFactory, factory, createResponseConverter, createCallAdapter) : z2 ? new SuspendForResponse(requestFactory, factory, createResponseConverter, createCallAdapter) : new SuspendForBody(requestFactory, factory, createResponseConverter, createCallAdapter, false);
    }
