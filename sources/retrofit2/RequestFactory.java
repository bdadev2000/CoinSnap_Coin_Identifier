...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof POST) {
                parseHttpMethodAndPath(g.f29074c, ((POST) annotation).value(), true);
                return;
            }
            if (annotation instanceof PUT) {
                parseHttpMethodAndPath(g.d, ((PUT) annotation).value(), true);
                return;
            }
        ...
        private ParameterHandler<?> parseParameter(int i2, Type type, Annotation[] annotationArr, boolean z2) {
            ...
            if (z2) {
                try {
                    if (Utils.getRawType(type) == h0.g.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i2, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers of = Headers.of(HttpHeaders.CONTENT_DISPOSITION, androidx.compose.foundation.text.input.a.A("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
            ...
            if (annotation instanceof Body) {
                ...
                try {
                    ...
                    throw Utils.parameterError(this.method, e, i2, "Unable to create @Body converter for %s", type);
                }
            }
        ...
        public RequestFactory build() {
            ...
            int i3 = 0;
            while (i3 < length) {
                this.parameterHandlers[i3] = parseParameter(i3, this.parameterTypes[i3], this.parameterAnnotationsArray[i3], i3 == i2);
                i3++;
            }
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        if (length != parameterHandlerArr.length) {
            throw new IllegalArgumentException(androidx.compose.foundation.text.input.a.n(d.t("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
        }
