...
public final class GlPurchaseView8Parameter extends ComponentViewParameter {
    ...
    private ColorParameter limitedColor;
    ...
    private ImageFile mainSkuSelectedRightTopIv;
    ...
    private ImageFile otherSkuSelectedRightTopIv;
    ...
    public final ImageFile getMainSkuSelectedRightTopIv() {
        return this.mainSkuSelectedRightTopIv;
    }

    public final void setMainSkuSelectedRightTopIv(ImageFile imageFile) {
        this.mainSkuSelectedRightTopIv = imageFile;
    }

    public final ImageFile getOtherSkuSelectedRightTopIv() {
        return this.otherSkuSelectedRightTopIv;
    }

    public final void setOtherSkuSelectedRightTopIv(ImageFile imageFile) {
        this.otherSkuSelectedRightTopIv = imageFile;
    }

    public final ColorParameter getLimitedColor() {
        return this.limitedColor;
    }

    public final void setLimitedColor(ColorParameter colorParameter) {
        this.limitedColor = colorParameter;
    }
    ...
    public List<String> multiStateName() {
        return CollectionsKt.mutableListOf("GlPurchaseView8_main_selected", "GlPurchaseView8_other_selected");
    }

    @Override // com.glority.android.uimaker.parameter.baseview.ViewParameter, com.glority.android.uimaker.parameter.baseview.BaseUiMakerParameter
    public String getViewName() {
        return "GlPurchaseView8";
    }
}
