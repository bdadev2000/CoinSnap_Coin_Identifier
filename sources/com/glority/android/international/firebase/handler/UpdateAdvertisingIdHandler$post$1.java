...
final class UpdateAdvertisingIdHandler$post$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.$request instanceof UpdateAdvertisingIdRequest) {
            if (AdUtil.INSTANCE.getAdId() == null) {
                try {
                    AdUtil.INSTANCE.setAdId(AdvertisingIdClient.getAdvertisingIdInfo(AppContext.INSTANCE.peekContext().getApplicationContext()).getId());
                } catch (Exception unused) {
                    LogUtils.e("err  get advertisingId ");
                }
            }
            ...
            new DataCollectMessageRequest(result, AdUtil.INSTANCE.getAdId()).post();
        }
