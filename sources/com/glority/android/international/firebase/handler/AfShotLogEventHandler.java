...
public final class AfShotLogEventHandler implements RouteHandler<Boolean> {
    ...
    public String getUrl() {
        return UrlUtils.INSTANCE.getAF_SHOT_TIMES_LOG_EVENT();
    }

    @Override // com.glority.android.core.route.RouteHandler
    public void post(RouteRequest<Boolean> request) {
        Intrinsics.checkNotNullParameter(request, "request");
        boolean z = request instanceof AfShotLogEventRequest;
    }
}
