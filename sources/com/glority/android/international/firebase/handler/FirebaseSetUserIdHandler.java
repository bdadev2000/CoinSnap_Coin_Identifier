...
public final class FirebaseSetUserIdHandler implements RouteHandler<Boolean> {
    ...
    public String getUrl() {
        return UrlTracking.INSTANCE.getURL_LOG_SET_USER_ID();
    }
    ...
    public void post(RouteRequest<Boolean> request) {
        ...
        if (!(request instanceof FirebaseSetUserIdRequest) || (userId = ((FirebaseSetUserIdRequest) request).getUserId()) == null) {
            return;
        }
