...
public final class LogExceptionHandler implements RouteHandler<Boolean> {
    ...
    public String getUrl() {
        return UrlTracking.INSTANCE.getURL_LOG_EXCEPTION();
    }
    ...
    public void post(RouteRequest<Boolean> request) {
        ...
        if (!(request instanceof LogExceptionRequest) || (throwable = ((LogExceptionRequest) request).getThrowable()) == null) {
            return;
        }
