...
public final class UpdateAdvertisingIdHandler implements RouteHandler<Boolean> {
    ...
    public String getUrl() {
        return UrlTracking.INSTANCE.getURL_UPDATE_ADVERTISING_ID();
    }

    @Override // com.glority.android.core.route.RouteHandler
    public void post(RouteRequest<Boolean> request) {
        Intrinsics.checkNotNullParameter(request, "request");
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new UpdateAdvertisingIdHandler$post$1(request, null), 3, null);
    }
}
