...
/* compiled from: Detain26893BActivity.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007H\u0014J \u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\b\u0010\u000f\u001a\u00020\u000eH\u0014J\b\u0010\u0010\u001a\u00020\u000bH\u0014J\b\u0010\u0011\u001a\u00020\u0004H\u0016¨\u0006\u0012"}, d2 = {"Lcom/glority/android/detain/memo26893/activity/Detain26893BActivity;", "Lcom/glority/android/detain/base/BaseDetainActivity;", "()V", "changePrice", "", "doCreateView", "savedInstanceState", "Landroid/os/Bundle;", "getBoldAndColorText", "Landroid/text/SpannableStringBuilder;", "text", "", "content", "color", "", "getLayoutId", "getLogPageName", "onBackPressed", "detain-ui_release"}, k = 1, mv = {1, 1, 16})
/* loaded from: classes13.dex */
public final class Detain26893BActivity extends BaseDetainActivity {
    ...
    public void doCreateView(Bundle savedInstanceState) {
        ...
        changePrice();
        ((TextView) _$_findCachedViewById(R.id.detain_memo26893_tv_restore)).setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.detain.memo26893.activity.Detain26893BActivity$doCreateView$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Detain26893BActivity.this.restoreClick();
            }
        });
        ((TextView) _$_findCachedViewById(R.id.detain_memo26893_iv_close)).setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.detain.memo26893.activity.Detain26893BActivity$doCreateView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Detain26893BActivity.this.closeClick();
            }
        });
        ((TextView) _$_findCachedViewById(R.id.detain_memo26893_tv_detain_continue)).setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.detain.memo26893.activity.Detain26893BActivity$doCreateView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                new GuidePurchaseRequest(Detain26893BActivity.this.getCurrentSku(), null, 2, null).post();
                Detain26893BActivity.this.trackContinue();
            }
        });
    }
