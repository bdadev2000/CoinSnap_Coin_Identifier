...
public final class SkinActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        ...
        if (activity instanceof AppCompatActivity) {
            ((AppCompatActivity) activity).setTheme(R.style.AppTheme);
        }
    }
}
