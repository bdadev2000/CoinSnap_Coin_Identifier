...
public class LayoutResetPasswordBindingImpl extends LayoutResetPasswordBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.text_input_reset_pwd_email, 1);
        sparseIntArray.put(R.id.et_email, 2);
        sparseIntArray.put(R.id.bt_continue, 3);
    }

    public LayoutResetPasswordBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    private LayoutResetPasswordBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (Button) objArr[3], (TextInputEditText) objArr[2], (TextInputLayout) objArr[1]);
        this.mDirtyFlags = -1L;
