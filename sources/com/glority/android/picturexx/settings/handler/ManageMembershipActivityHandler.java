...
import com.glority.base.utils.MembershipABUtil;
import io.reactivex.Observable;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

/* compiled from: ManageMembershipActivityHandler.kt */
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0016\u0010\t\u001a\u00020\n2\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00020\fH\u0016R\u0014\u0010\u0005\u001a\u00020\u00068VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0007\u0010\b¨\u0006\r"}, d2 = {"Lcom/glority/android/picturexx/settings/handler/ManageMembershipActivityHandler;", "Lcom/glority/android/core/route/RouteHandler;", "", "<init>", "()V", "url", "", "getUrl", "()Ljava/lang/String;", "post", "", "request", "Lcom/glority/android/core/route/RouteRequest;", "settings_release"}, k = 1, mv = {2, 0, 0}, xi = 82)
...
public final class ManageMembershipActivityHandler implements RouteHandler<Boolean> {
    ...
    public void post(RouteRequest<Boolean> request) {
        ...
        if (request instanceof OpenManageMembershipActivityRequest) {
            ...
            if (abtestingVariable$default == null || (str = abtestingVariable$default.getVariable()) == null) {
                str = "262841";
            }
            MembershipABUtil.start$default(MembershipABUtil.INSTANCE, str, 0, ((OpenManageMembershipActivityRequest) request).getFrom(), 2, null);
        }
    }
}
