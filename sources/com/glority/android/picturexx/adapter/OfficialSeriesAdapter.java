...
/* compiled from: OfficialSeriesAdapter.kt */
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0005\u0018\u0000 \n2\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001:\u0002\n\u000bB\u0007¢\u0006\u0004\b\u0004\u0010\u0005J\u0018\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\u0002H\u0014¨\u0006\f"}, d2 = {"Lcom/glority/android/picturexx/adapter/OfficialSeriesAdapter;", "Lcom/glority/android/adapterhelper/BaseMultiItemQuickAdapter;", "Lcom/glority/base/entity/BaseMultiEntity;", "Lcom/glority/android/adapterhelper/BaseViewHolder;", "<init>", "()V", "convert", "", "helper", "entity", "Companion", "LabelItem", "businessMod_release"}, k = 1, mv = {2, 0, 0}, xi = 82)
/* loaded from: classes2.dex */
public final class OfficialSeriesAdapter extends BaseMultiItemQuickAdapter<BaseMultiEntity, BaseViewHolder> {
    ...
    /* compiled from: OfficialSeriesAdapter.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\r\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0014\u0010\u0004\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0014\u0010\b\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007R\u0014\u0010\n\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\u0007R\u0014\u0010\f\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u0007R\u0014\u0010\u000e\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0007R\u0014\u0010\u0010\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0007¨\u0006\u0012"}, d2 = {"Lcom/glority/android/picturexx/adapter/OfficialSeriesAdapter$Companion;", "", "<init>", "()V", "typeItemMySeries", "", "getTypeItemMySeries", "()I", "typeItemAvailableSeries", "getTypeItemAvailableSeries", "typeLabel", "getTypeLabel", "typeAvailableEmpty", "getTypeAvailableEmpty", "labelMySeries", "getLabelMySeries", "labelAvailableSeries", "getLabelAvailableSeries", "businessMod_release"}, k = 1, mv = {2, 0, 0}, xi = 82)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final int getTypeItemMySeries() {
            return OfficialSeriesAdapter.typeItemMySeries;
        }

        public final int getTypeItemAvailableSeries() {
            return OfficialSeriesAdapter.typeItemAvailableSeries;
        }

        public final int getTypeLabel() {
            return OfficialSeriesAdapter.typeLabel;
        }

        public final int getTypeAvailableEmpty() {
            return OfficialSeriesAdapter.typeAvailableEmpty;
        }

        public final int getLabelMySeries() {
            return OfficialSeriesAdapter.labelMySeries;
        }

        public final int getLabelAvailableSeries() {
            return OfficialSeriesAdapter.labelAvailableSeries;
        }
    }

    public OfficialSeriesAdapter() {
        super(null);
        ...
        addItemType(typeLabel, R.layout.item_collect_by_series_label);
        addItemType(typeAvailableEmpty, R.layout.item_official_sets_empty);
    }

    /* compiled from: OfficialSeriesAdapter.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u000e\u0018\u00002\u00020\u0001B+\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\b\u0010\b\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u001e\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0086\u000e¢\u0006\u0010\n\u0002\u0010\u0013\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u0013\u0010\b\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0014\u0010\u000e¨\u0006\u0015"}, d2 = {"Lcom/glority/android/picturexx/adapter/OfficialSeriesAdapter$LabelItem;", "", "type", "", "name", "", "expand", "", "description", "<init>", "(ILjava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;)V", "getType", "()I", "getName", "()Ljava/lang/String;", "getExpand", "()Ljava/lang/Boolean;", "setExpand", "(Ljava/lang/Boolean;)V", "Ljava/lang/Boolean;", "getDescription", "businessMod_release"}, k = 1, mv = {2, 0, 0}, xi = 82)
    /* loaded from: classes2.dex */
    public static final class LabelItem {
        ...
        public LabelItem(int i, String name, Boolean bool, String str) {
    ...
    public void convert(BaseViewHolder helper, BaseMultiEntity entity) {
        ...
        if (item instanceof LabelItem) {
            ...
            AppCompatTextView appCompatTextView = (AppCompatTextView) helper.getView(R.id.option_tv);
            appCompatTextView.setVisibility((labelItem.getExpand() != null) != false ? 0 : 8);
            if (Intrinsics.areEqual((Object) labelItem.getExpand(), (Object) true)) {
                appCompatTextView.setText(appCompatTextView.getResources().getString(R.string.offseries_list_hide));
            ...
            } else if (Intrinsics.areEqual((Object) labelItem.getExpand(), (Object) false)) {
                appCompatTextView.setText(appCompatTextView.getResources().getString(R.string.offseries_list_show));
            ...
            if (labelItem.getDescription() != null) {
                helper.setText(R.id.desc_tv, labelItem.getDescription());
            }
