...
public class FragmentHomeBindingImpl extends FragmentHomeBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.search_iv, 2);
        sparseIntArray.put(R.id.rv, 3);
        sparseIntArray.put(R.id.back_to_top_ll, 4);
    }
    ...
    private FragmentHomeBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (LinearLayout) bindings[4], (ImageView) bindings[1], (RecyclerView) bindings[3], (ImageView) bindings[2]);
        this.mDirtyFlags = -1L;
