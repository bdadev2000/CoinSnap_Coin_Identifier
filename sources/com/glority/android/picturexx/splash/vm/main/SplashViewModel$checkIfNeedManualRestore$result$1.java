...
@DebugMetadata(c = "com.glority.android.picturexx.splash.vm.main.SplashViewModel$checkIfNeedManualRestore$result$1", f = "SplashViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes5.dex */
public final class SplashViewModel$checkIfNeedManualRestore$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    int label;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public SplashViewModel$checkIfNeedManualRestore$result$1(Continuation<? super SplashViewModel$checkIfNeedManualRestore$result$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SplashViewModel$checkIfNeedManualRestore$result$1(continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
        return ((SplashViewModel$checkIfNeedManualRestore$result$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
