...
public final class UpdateCredentialsHandler implements RouteHandler<Boolean> {
    ...
    public String getUrl() {
        return UrlFileUpload.INSTANCE.getURL_UPDATE_CREDENTIALS();
    }

    @Override // com.glority.android.core.route.RouteHandler
    public void post(RouteRequest<Boolean> request) {
        Intrinsics.checkNotNullParameter(request, "request");
        if (request instanceof UpdateCredentialsRequest) {
