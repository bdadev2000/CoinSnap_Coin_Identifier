...
public final class WelcomeView2 implements IChatbotAdapterView {
    ...
    public int getLayout() {
        return R.layout.chatbot_item_welcome2;
    }
    ...
    public void convert(BaseViewHolder helper, Object item, ChatbotUiConfig uiConfig) {
        ...
        int i = R.id.tv;
        if (item == null) {
            throw new NullPointerException("null cannot be cast to non-null type com.glority.android.chatbot2.entity.ChatbotWelcome2Entity");
        }
        helper.setText(i, ((ChatbotWelcome2Entity) item).getText());
    ...
    public Class<? extends BaseChatbotEntity> entityClass() {
        return ChatbotWelcome2Entity.class;
    }
}
