...
public final class Vip10005AActivity extends BasePurchaseActivity {
    ...
    public Vip10005AActivity() {
        ...
        this.infoTexts = CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(R.string.conversion_officialsetstatus_caption_spec1), Integer.valueOf(R.string.conversion_officialsetstatus_caption_spec2), Integer.valueOf(R.string.conversion_officialsetstatus_caption_spec3), Integer.valueOf(R.string.conversion_officialsetstatus_caption_spec4)});
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ComponentActivityKt.setContent$default(this, null, ComposableLambdaKt.composableLambdaInstance(348500671, true, new Vip10005AActivity$onCreate$1(this)), 1, null);
    }
    ...
    public final void LoadingPage(final Function1<? super Float, Unit> finishedListener, Composer composer, final int i) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(-1447353593);
        if ((i & 14) == 0) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1447353593, i2, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.LoadingPage (Vip10005AActivity.kt:152)");
            }
            ...
            final State<Float> animateFloatAsState = AnimateAsStateKt.animateFloatAsState(LoadingPage$lambda$1(mutableState) ? 1.0f : 2.2f, AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$LoadingPage$scale$2
            ...
            startRestartGroup.startReplaceableGroup(-717024222);
            boolean changed = startRestartGroup.changed(animateFloatAsState);
            Object rememberedValue2 = startRestartGroup.rememberedValue();
            if (changed || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$LoadingPage$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayer) {
                        ...
                        LoadingPage$lambda$3 = Vip10005AActivity.LoadingPage$lambda$3(animateFloatAsState);
                        graphicsLayer.setScaleY(LoadingPage$lambda$3);
                        LoadingPage$lambda$32 = Vip10005AActivity.LoadingPage$lambda$3(animateFloatAsState);
            ...
            startRestartGroup.startReplaceableGroup(-1842981832);
            ...
            composer2.startReplaceableGroup(-717022982);
            boolean changed2 = composer2.changed(mutableState);
            Vip10005AActivity$LoadingPage$3$1 rememberedValue3 = composer2.rememberedValue();
            if (changed2 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                rememberedValue3 = new Vip10005AActivity$LoadingPage$3$1(mutableState, null);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$LoadingPage$4
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer composer3, int i3) {
                    Vip10005AActivity.this.LoadingPage(finishedListener, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public final void purchasePage(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(-552024093);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-552024093, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.purchasePage (Vip10005AActivity.kt:201)");
        }
        ...
        MaterialThemeKt.MaterialTheme(ColorScheme.m2209copyCXl9yA$default(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable), ColorKt.Color(4294618905L), 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, -2, 15, null), null, null, ComposableLambdaKt.composableLambda(startRestartGroup, 2019810487, true, new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$purchasePage$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i2) {
                ...
                if ((i2 & 11) != 2 || !composer2.getSkipping()) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(2019810487, i2, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.purchasePage.<anonymous> (Vip10005AActivity.kt:206)");
                    }
                    Modifier fillMaxSize$default = SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null);
                    ScrollState scrollState = ScrollState.this;
                    Vip10005AActivity vip10005AActivity = this;
                    ...
                    ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
                    vip10005AActivity.HeaderImage(composer2, 8);
                    ...
                    vip10005AActivity.DescriptionView(composer2, 8);
                    vip10005AActivity.PurchaseView(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, Dp.m6997constructorimpl(16), 0.0f, 0.0f, 13, null), composer2, 70, 0);
                    float f = 10;
                    ...
                    mutableState = vip10005AActivity.isTrialSkuSelected;
                    vip10005AActivity.ReminderBar(m989paddingqDBjuR0$default, mutableState, composer2, 518, 0);
                    vip10005AActivity.ContinueButton(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, Dp.m6997constructorimpl(f), 0.0f, 0.0f, 13, null), composer2, 70, 0);
                    SpacerKt.Spacer(ColumnScope.weight$default(columnScopeInstance, Modifier.INSTANCE, 1.0f, false, 2, null), composer2, 0);
                    vip10005AActivity.PolicyView(scrollState, null, composer2, 512, 2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    vip10005AActivity.restoreAndCloseBar(composer2, 8);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$purchasePage$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i2) {
                    Vip10005AActivity.this.purchasePage(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public final void restoreAndCloseBar(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(704844175);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(704844175, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.restoreAndCloseBar (Vip10005AActivity.kt:243)");
        }
        ...
        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.md5_6a2d1ce47e05102d914a6d21126966ac, startRestartGroup, 0), "", ClickableKt.m573clickableXHw0xAI$default(AlphaKt.alpha(rowScopeInstance.align(SizeKt.m1030size3ABfNKs(Modifier.INSTANCE, Dp.m6997constructorimpl(12)), Alignment.INSTANCE.getCenterVertically()), 0.5f), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$restoreAndCloseBar$1$2
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Vip10005AActivity.this.trackClose();
                Vip10005AActivity.this.postUiCloseRequest();
            }
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$restoreAndCloseBar$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i2) {
                    Vip10005AActivity.this.restoreAndCloseBar(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public final void HeaderImage(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(1434779521);
        if ((i & 1) != 0 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1434779521, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.HeaderImage (Vip10005AActivity.kt:280)");
            }
            ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = startRestartGroup.consume(localConfiguration);
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                MediaItem fromUri = MediaItem.fromUri(RawResourceDataSource.buildRawResourceUri(R.raw.video_100051));
            ...
            AndroidView_androidKt.AndroidView(new Function1<Context, PlayerView>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$HeaderImage$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
            ...
            }, BoxScopeInstance.INSTANCE.align(SizeKt.fillMaxWidth$default(SizeKt.m1016height3ABfNKs(Modifier.INSTANCE, m7011unboximpl), 0.0f, 1, null), Alignment.INSTANCE.getTopCenter()), null, startRestartGroup, 0, 4);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            EffectsKt.DisposableEffect(Unit.INSTANCE, new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$HeaderImage$2
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
                ...
                public final DisposableEffectResult invoke(DisposableEffectScope DisposableEffect) {
                    ...
                    return new DisposableEffectResult() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$HeaderImage$2$invoke$$inlined$onDispose$1
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$HeaderImage$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i2) {
                    Vip10005AActivity.this.HeaderImage(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public final void DescriptionView(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(722022382);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(722022382, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.DescriptionView (Vip10005AActivity.kt:317)");
        }
        ...
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -384784025, "C88@4444L9:Column.kt#2w3rfo");
        ColumnScopeInstance columnScopeInstance = ColumnScopeInstance.INSTANCE;
        startRestartGroup.startReplaceableGroup(-996512374);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$DescriptionView$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer4, int i5) {
                    Vip10005AActivity.this.DescriptionView(composer4, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public final void PurchaseView(Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(761772132);
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(761772132, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.PurchaseView (Vip10005AActivity.kt:347)");
        }
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)86@4330L61,87@4396L133:Column.kt#2w3rfo");
        ...
        Modifier m573clickableXHw0xAI$default = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m540backgroundbw27NRU$default(ClipKt.clip(BorderKt.m551borderxT4_qwU(weight$default, m6997constructorimpl, m4550getTransparent0d7_KjU, RoundedCornerShapeKt.RoundedCornerShape(10)), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), null, 2, null), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$PurchaseView$1$1$1
            ...
            public final void invoke2() {
                String str;
                MutableState mutableState;
                Vip10005AActivity vip10005AActivity = Vip10005AActivity.this;
                str = vip10005AActivity.weeklySKU;
                vip10005AActivity.setCurrentSku(str);
                mutableState = Vip10005AActivity.this.isTrialSkuSelected;
                mutableState.setValue(false);
                Vip10005AActivity.this.startPurchase();
            }
        }, 7, null);
        Alignment.Horizontal centerHorizontally = Alignment.INSTANCE.getCenterHorizontally();
        ...
        Modifier m573clickableXHw0xAI$default2 = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m540backgroundbw27NRU$default(ClipKt.clip(RowScope.weight$default(rowScopeInstance, BorderKt.m551borderxT4_qwU(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, Dp.m6997constructorimpl(f), 0.0f, Dp.m6997constructorimpl(f), 0.0f, 10, null), Dp.m6997constructorimpl(f3), Intrinsics.areEqual(getCurrentSku(), this.yearlySKU) ? ColorKt.Color(4294618905L) : ColorKt.Color(4290624957L), RoundedCornerShapeKt.RoundedCornerShape(10)), 120.0f, false, 2, null), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), null, 2, null), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$PurchaseView$1$1$3
            ...
            public final void invoke2() {
                ...
                MutableState mutableState;
                Vip10005AActivity vip10005AActivity = Vip10005AActivity.this;
                str3 = vip10005AActivity.yearlySKU;
                vip10005AActivity.setCurrentSku(str3);
                mutableState = Vip10005AActivity.this.isTrialSkuSelected;
        ...
        Modifier m573clickableXHw0xAI$default3 = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m539backgroundbw27NRU(ClipKt.clip(BorderKt.m551borderxT4_qwU(weight$default2, m6997constructorimpl2, m4550getTransparent0d7_KjU2, RoundedCornerShapeKt.RoundedCornerShape(10)), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), RoundedCornerShapeKt.RoundedCornerShape(10)), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$PurchaseView$1$1$5
            ...
            public final void invoke2() {
                ...
                MutableState mutableState;
                Vip10005AActivity vip10005AActivity = Vip10005AActivity.this;
                str3 = vip10005AActivity.monthlySKU;
                vip10005AActivity.setCurrentSku(str3);
                mutableState = Vip10005AActivity.this.isTrialSkuSelected;
                mutableState.setValue(false);
                Vip10005AActivity.this.startPurchase();
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$PurchaseView$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i3) {
                    Vip10005AActivity.this.PurchaseView(modifier3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public final void ReminderBar(Modifier modifier, final MutableState<Boolean> mutableState, Composer composer, final int i, final int i2) {
        Composer startRestartGroup = composer.startRestartGroup(1175244004);
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1175244004, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.ReminderBar (Vip10005AActivity.kt:529)");
        }
        ...
        SwitchKt.Switch(getReminderOpen(), new Function1<Boolean, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$ReminderBar$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke(boolean z) {
                ...
                Vip10005AActivity.this.setReminderOpen(z);
                bundle1 = Vip10005AActivity.this.getBundle1();
                Vip10005AActivity vip10005AActivity = Vip10005AActivity.this;
                reminderOpen = vip10005AActivity.getReminderOpen();
                if (reminderOpen) {
                    try {
                        bundle1.putString("status", NotificationManagerCompat.from(vip10005AActivity).areNotificationsEnabled() ? ExifInterface.GPS_MEASUREMENT_2D : "1");
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$ReminderBar$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i3) {
                    Vip10005AActivity.this.ReminderBar(modifier3, mutableState, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public final void ContinueButton(Modifier modifier, Composer composer, final int i, final int i2) {
        Composer startRestartGroup = composer.startRestartGroup(-2108131119);
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2108131119, i, -1, "com.glority.android.guide.memo10005.activity.Vip10005AActivity.ContinueButton (Vip10005AActivity.kt:571)");
        }
        ...
        startRestartGroup.startReplaceableGroup(-717006497);
        boolean changed = startRestartGroup.changed(animateLottieCompositionAsState2);
        Object rememberedValue = startRestartGroup.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function0) new Function0<Float>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$ContinueButton$2$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
                ...
                public final Float invoke() {
                    ...
                    ContinueButton$lambda$26 = Vip10005AActivity.ContinueButton$lambda$26(LottieAnimationState.this);
        ...
        startRestartGroup.startReplaceableGroup(-717005322);
        boolean changed2 = startRestartGroup.changed(animateLottieCompositionAsState);
        Object rememberedValue2 = startRestartGroup.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = (Function0) new Function0<Float>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$ContinueButton$2$2$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
                ...
                public final Float invoke() {
                    ...
                    ContinueButton$lambda$24 = Vip10005AActivity.ContinueButton$lambda$24(LottieAnimationState.this);
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo10005.activity.Vip10005AActivity$ContinueButton$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i3) {
                    Vip10005AActivity.this.ContinueButton(modifier3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    */
    public final void PolicyView(final androidx.compose.foundation.ScrollState r63, androidx.compose.ui.Modifier r64, androidx.compose.runtime.Composer r65, final int r66, final int r67) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.android.guide.memo10005.activity.Vip10005AActivity.PolicyView(androidx.compose.foundation.ScrollState, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
