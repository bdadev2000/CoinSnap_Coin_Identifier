package com.glority.android.guide.memo27266.activity;
...
import com.glority.android.guide.memo27266.R;
...
/* compiled from: Vip27266AActivity.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\r\u001a\u00020\u000eH\u0016J\u0012\u0010\u000f\u001a\u00020\u000e2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011H\u0014J\b\u0010\u0012\u001a\u00020\u0013H\u0014J\u0012\u0010\u0014\u001a\u00020\u000e2\b\u0010\u0015\u001a\u0004\u0018\u00010\u0016H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082D¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082.¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lcom/glority/android/guide/memo27266/activity/Vip27266AActivity;", "Lcom/glority/android/guide/base/BasePurchaseActivity;", "()V", "jsonFile", "", "monthlySKU", "purchaseView", "Landroid/view/View;", "rootView", "uiMaker", "Lcom/glority/android/uimaker/UIMaker;", "weeklySKU", "yearlySKU", "changePrice", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "showBackPressedCloseRetain", "", "smartTextList", "billingDescGroup", "Landroid/view/ViewGroup;", "guide-ui_release"}, k = 1, mv = {1, 4, 2})
/* loaded from: classes13.dex */
public final class Vip27266AActivity extends BasePurchaseActivity {
    ...
    private final String jsonFile = "272661.json";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View view = uIMaker.toView(TextStreamsKt.readText(new InputStreamReader(open, Charsets.UTF_8)), new UiMakerOnClickListener() { // from class: com.glority.android.guide.memo27266.activity.Vip27266AActivity$onCreate$1
            ...
            public void onClick(ClickEnum clickEnum) {
                ...
                if (clickEnum == ClickEnum.restore) {
                    ...
                    Vip27266AActivity.this.trackClose();
                    Vip27266AActivity.this.postUiCloseRequest();
                }
            }
        });
        this.rootView = view;
        ...
        Vip27266AActivity vip27266AActivity = this;
        new BillingUISetPolicyClickRequest(vip27266AActivity, policyContentView).post();
        ...
        if (findViewWithTag != null) {
            ...
            int i = R.layout.bui_memo27266_purchase_layout;
            ...
            if (view4 != null && (findViewById = view4.findViewById(R.id.purchase_tv)) != null) {
                findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo27266.activity.Vip27266AActivity$onCreate$$inlined$apply$lambda$1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view5) {
                        String str;
                        str = Vip27266AActivity.this.yearlySKU;
        ...
        Glide.with((FragmentActivity) vip27266AActivity).load(Integer.valueOf(R.drawable.md5_cc82e26963a6f180fac522f7c307df58)).centerCrop().into((ImageView) view5.findViewWithTag("bg"));
    }
