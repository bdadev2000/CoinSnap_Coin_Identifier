package com.glority.android.guide.memo50643.activity;
...
import com.glority.android.guide.memo50643.R;
...
public final class Vip50643AActivity extends BasePurchaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bui_506431_purchase_layout);
        ...
        ViewExtensionsKt.setSingleClickListener$default(findViewById3, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$onCreate$1
        ...
        ViewExtensionsKt.setSingleClickListener$default(findViewById4, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$onCreate$2
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                Vip50643AActivity.this.trackClose();
                Vip50643AActivity.this.postUiCloseRequest();
            }
        }, 1, (Object) null);
        initReminder();
        initSplashAnimation();
    ...
    private final void initSplashAnimation() {
        ...
        scaleAnimation.setAnimationListener(new Vip50643AActivity$initSplashAnimation$2(findViewById));
    ...
    private final void initReminder() {
        ...
        switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$initReminder$1
            ...
            public final void onCheckedChanged(CompoundButton buttonView, boolean z) {
                ...
                bundle1 = Vip50643AActivity.this.getBundle1();
                if (!z) {
    ...
    private final void setPurchaseView() {
        ...
        ViewExtensionsKt.setSingleClickListener$default(continueFl, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$setPurchaseView$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                ...
                String str3;
                Intrinsics.checkNotNullParameter(it, "it");
                View findViewById4 = Vip50643AActivity.this.findViewById(R.id.switch1);
                ...
                if (((SwitchCompat) findViewById4).isChecked()) {
                    str2 = Vip50643AActivity.this.currentSku;
                    str3 = Vip50643AActivity.this.yearlySKU;
                    if (Intrinsics.areEqual(str2, str3)) {
                        z = true;
                        str = Vip50643AActivity.this.currentSku;
        ...
        findViewById2.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$setPurchaseView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50643AActivity vip50643AActivity = Vip50643AActivity.this;
                str = vip50643AActivity.yearlySKU;
                vip50643AActivity.changeSKU(str);
                View findViewById4 = Vip50643AActivity.this.findViewById(R.id.switch1);
                Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<SwitchCompat>(R.id.switch1)");
                boolean isChecked = ((SwitchCompat) findViewById4).isChecked();
                str2 = Vip50643AActivity.this.yearlySKU;
                new GuidePurchaseRequest(str2, null, Boolean.valueOf(isChecked), null, 0, 26, null).post();
            }
        });
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$setPurchaseView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50643AActivity vip50643AActivity = Vip50643AActivity.this;
                str = vip50643AActivity.weeklySKU;
                vip50643AActivity.changeSKU(str);
                str2 = Vip50643AActivity.this.weeklySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
        findViewById3.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50643.activity.Vip50643AActivity$setPurchaseView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50643AActivity vip50643AActivity = Vip50643AActivity.this;
                str = vip50643AActivity.monthlySKU;
                vip50643AActivity.changeSKU(str);
                str2 = Vip50643AActivity.this.monthlySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
    }
