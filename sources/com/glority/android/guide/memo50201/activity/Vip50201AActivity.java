package com.glority.android.guide.memo50201.activity;
...
public final class Vip50201AActivity extends BasePurchaseActivity {
    ...
    private final String jsonFile = "502011.json";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View view = uIMaker.toView(TextStreamsKt.readText(new InputStreamReader(open, Charsets.UTF_8)), new UiMakerOnClickListener() { // from class: com.glority.android.guide.memo50201.activity.Vip50201AActivity$onCreate$1
