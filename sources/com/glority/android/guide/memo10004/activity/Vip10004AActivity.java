...
import com.glority.android.picturexx.business.databinding.ActivityPurchase10004aBinding;
...
/* compiled from: Vip10004AActivity.kt */
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0012\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011H\u0014J\b\u0010\u0012\u001a\u00020\u0013H\u0002J\b\u0010\u0014\u001a\u00020\u000fH\u0016J\b\u0010\u0015\u001a\u00020\u000fH\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\b\u001a\u00020\tX\u0086.¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u000b\"\u0004\b\f\u0010\r¨\u0006\u0016"}, d2 = {"Lcom/glority/android/guide/memo10004/activity/Vip10004AActivity;", "Lcom/glority/android/guide/base/BasePurchaseActivity;", "<init>", "()V", "yearlySKU", "", "monthlySKU", "weeklySKU", "binding", "Lcom/glority/android/picturexx/business/databinding/ActivityPurchase10004aBinding;", "getBinding", "()Lcom/glority/android/picturexx/business/databinding/ActivityPurchase10004aBinding;", "setBinding", "(Lcom/glority/android/picturexx/business/databinding/ActivityPurchase10004aBinding;)V", "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;", "getRichText", "Landroid/text/SpannableStringBuilder;", "changePrice", "finish", "businessMod_release"}, k = 1, mv = {2, 0, 0}, xi = 82)
/* loaded from: classes13.dex */
public final class Vip10004AActivity extends BasePurchaseActivity {
    public static final int $stable = 8;
    public ActivityPurchase10004aBinding binding;
    private String yearlySKU = "sub_yearly_7dt";
    private String monthlySKU = "sub_month";
    private String weeklySKU = "sub_week";

    public final ActivityPurchase10004aBinding getBinding() {
        ActivityPurchase10004aBinding activityPurchase10004aBinding = this.binding;
        if (activityPurchase10004aBinding != null) {
            return activityPurchase10004aBinding;
        }
        Intrinsics.throwUninitializedPropertyAccessException("binding");
        return null;
    }

    public final void setBinding(ActivityPurchase10004aBinding activityPurchase10004aBinding) {
        Intrinsics.checkNotNullParameter(activityPurchase10004aBinding, "<set-?>");
        this.binding = activityPurchase10004aBinding;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setBinding(ActivityPurchase10004aBinding.inflate(getLayoutInflater()));
        setContentView(getBinding().getRoot());
        InputStream open = getAssets().open("10004a_purchase.json");
        ...
        try {
            ...
            ViewExtensionsKt.setSingleClickListener$default(tvRestore, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo10004.activity.Vip10004AActivity$onCreate$2
            ...
            ViewExtensionsKt.setSingleClickListener$default(tvCancel, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo10004.activity.Vip10004AActivity$onCreate$3
                ...
                public final void invoke2(View it) {
                    Intrinsics.checkNotNullParameter(it, "it");
                    Vip10004AActivity.this.trackClose();
                    Vip10004AActivity.this.finish();
                }
            }, 1, (Object) null);
    ...
    public void changePrice() {
        ...
        getBinding().gpv3.setUiMakerOnClickListener(new UiMakerOnClickListener() { // from class: com.glority.android.guide.memo10004.activity.Vip10004AActivity$changePrice$2
    ...
    public void finish() {
        ...
        if (AppViewModel.INSTANCE.isVip()) {
            NoteSnapCongratsActivity.INSTANCE.open(this, "100041");
        }
    }
}
