package com.glority.android.guide.memo50824.activity;
...
import com.glority.android.guide.memo50824.R;
...
/* compiled from: Vip50824AActivity.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\b\u001a\u00020\tH\u0016J\u0010\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\u0004H\u0002J\b\u0010\f\u001a\u00020\rH\u0002J\b\u0010\u000e\u001a\u00020\tH\u0002J\b\u0010\u000f\u001a\u00020\tH\u0002J\u0012\u0010\u0010\u001a\u00020\t2\b\u0010\u0011\u001a\u0004\u0018\u00010\rH\u0014J\b\u0010\u0012\u001a\u00020\tH\u0002J\b\u0010\u0013\u001a\u00020\u0014H\u0014J\u001c\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u00042\b\u0010\u0018\u001a\u0004\u0018\u00010\u0004H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Lcom/glority/android/guide/memo50824/activity/Vip50824AActivity;", "Lcom/glority/android/guide/base/BasePurchaseActivity;", "()V", "currentSku", "", "monthlySKU", "weeklySKU", "yearlySKU", "changePrice", "", "changeSKU", LogEventArguments.ARG_SKU, "getBundle1", "Landroid/os/Bundle;", "initReminder", "initSplashAnimation", "onCreate", "savedInstanceState", "setPurchaseView", "showBackPressedCloseRetain", "", "textBold", "Landroid/text/SpannableStringBuilder;", "text", "price", "guide-ui_release"}, k = 1, mv = {1, 4, 2})
/* loaded from: classes3.dex */
public final class Vip50824AActivity extends BasePurchaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bui_50824_purchase_layout);
        ...
        if (Intrinsics.areEqual(language, locale2.getLanguage())) {
            ...
            Intrinsics.checkNotNullExpressionValue(findViewById2, "findViewById<LottieAnimationView>(R.id.header_iv)");
            ((LottieAnimationView) findViewById2).setImageAssetsFolder("images_50824_fr");
        } else {
            Locale locale3 = Locale.ITALY;
            Intrinsics.checkNotNullExpressionValue(locale3, "Locale.ITALY");
            if (Intrinsics.areEqual(language, locale3.getLanguage())) {
                View findViewById3 = findViewById(R.id.header_iv);
                Intrinsics.checkNotNullExpressionValue(findViewById3, "findViewById<LottieAnimationView>(R.id.header_iv)");
                ((LottieAnimationView) findViewById3).setImageAssetsFolder("images_50824_it");
            } else if (Intrinsics.areEqual(language, "es")) {
                View findViewById4 = findViewById(R.id.header_iv);
                Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<LottieAnimationView>(R.id.header_iv)");
                ((LottieAnimationView) findViewById4).setImageAssetsFolder("images_50824_es");
            } else {
                View findViewById5 = findViewById(R.id.header_iv);
                Intrinsics.checkNotNullExpressionValue(findViewById5, "findViewById<LottieAnimationView>(R.id.header_iv)");
                ((LottieAnimationView) findViewById5).setImageAssetsFolder("images_50824_de");
            }
        }
        setPurchaseView();
        TextView policyView = (TextView) findViewById(R.id.policy_tv);
        View findViewById6 = findViewById(R.id.sv);
        Intrinsics.checkNotNullExpressionValue(findViewById6, "findViewById<ScrollView>(R.id.sv)");
        Intrinsics.checkNotNullExpressionValue(policyView, "policyView");
        new BillingUIScrollToDataPolicyRequest((ScrollView) findViewById6, policyView, null, 4, null).post();
        new BillingUISetPolicyClickRequest(this, policyView).post();
        View findViewById7 = findViewById(R.id.tv_restore);
        Intrinsics.checkNotNullExpressionValue(findViewById7, "findViewById<View>(R.id.tv_restore)");
        ViewExtensionsKt.setSingleClickListener$default(findViewById7, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$onCreate$1
        ...
        Intrinsics.checkNotNullExpressionValue(findViewById8, "findViewById<View>(R.id.iv_close)");
        ViewExtensionsKt.setSingleClickListener$default(findViewById8, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$onCreate$2
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                Vip50824AActivity.this.trackClose();
                Vip50824AActivity.this.postUiCloseRequest();
            }
        }, 1, (Object) null);
        initReminder();
        initSplashAnimation();
        TextSizeUtils.INSTANCE.autoSizeAndUnify(CollectionsKt.listOf((Object[]) new TextView[]{(TextView) findViewById(R.id.tv_weekly_price_title), (TextView) findViewById(R.id.tv_monthly_price_title)}), 1, 6.0f);
    }
    ...
    private final void initSplashAnimation() {
        ...
        scaleAnimation.setAnimationListener(new Vip50824AActivity$initSplashAnimation$2(findViewById));
    ...
    private final void initReminder() {
        ...
        switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$initReminder$1
            ...
            public final void onCheckedChanged(CompoundButton buttonView, boolean z) {
                ...
                bundle1 = Vip50824AActivity.this.getBundle1();
                if (!z) {
    ...
    private final void setPurchaseView() {
        ...
        ViewExtensionsKt.setSingleClickListener$default(continueFl, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$setPurchaseView$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                ...
                String str3;
                Intrinsics.checkNotNullParameter(it, "it");
                View findViewById4 = Vip50824AActivity.this.findViewById(R.id.switch1);
                ...
                if (((SwitchCompat) findViewById4).isChecked()) {
                    str2 = Vip50824AActivity.this.currentSku;
                    str3 = Vip50824AActivity.this.yearlySKU;
                    if (Intrinsics.areEqual(str2, str3)) {
                        z = true;
                        str = Vip50824AActivity.this.currentSku;
        ...
        findViewById2.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$setPurchaseView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50824AActivity vip50824AActivity = Vip50824AActivity.this;
                str = vip50824AActivity.yearlySKU;
                vip50824AActivity.changeSKU(str);
                View findViewById4 = Vip50824AActivity.this.findViewById(R.id.switch1);
                Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<SwitchCompat>(R.id.switch1)");
                boolean isChecked = ((SwitchCompat) findViewById4).isChecked();
                str2 = Vip50824AActivity.this.yearlySKU;
                new GuidePurchaseRequest(str2, null, Boolean.valueOf(isChecked), null, 0, 26, null).post();
            }
        });
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$setPurchaseView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50824AActivity vip50824AActivity = Vip50824AActivity.this;
                str = vip50824AActivity.weeklySKU;
                vip50824AActivity.changeSKU(str);
                str2 = Vip50824AActivity.this.weeklySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
        findViewById3.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50824.activity.Vip50824AActivity$setPurchaseView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50824AActivity vip50824AActivity = Vip50824AActivity.this;
                str = vip50824AActivity.monthlySKU;
                vip50824AActivity.changeSKU(str);
                str2 = Vip50824AActivity.this.monthlySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
    }
