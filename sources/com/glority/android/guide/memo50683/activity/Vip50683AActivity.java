...
import com.glority.android.guide.memo50683.R;
...
public final class Vip50683AActivity extends BasePurchaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bui_50683_purchase_layout);
        ...
        ((LottieAnimationView) findViewById2).setImageAssetsFolder("images_50683");
        setPurchaseView();
        TextView policyView = (TextView) findViewById(R.id.policy_tv);
        View findViewById3 = findViewById(R.id.sv);
        Intrinsics.checkNotNullExpressionValue(findViewById3, "findViewById<ScrollView>(R.id.sv)");
        Intrinsics.checkNotNullExpressionValue(policyView, "policyView");
        new BillingUIScrollToDataPolicyRequest((ScrollView) findViewById3, policyView, null, 4, null).post();
        new BillingUISetPolicyClickRequest(this, policyView).post();
        View findViewById4 = findViewById(R.id.tv_restore);
        Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<View>(R.id.tv_restore)");
        ViewExtensionsKt.setSingleClickListener$default(findViewById4, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$onCreate$1
        ...
        Intrinsics.checkNotNullExpressionValue(findViewById5, "findViewById<View>(R.id.iv_close)");
        ViewExtensionsKt.setSingleClickListener$default(findViewById5, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$onCreate$2
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                Vip50683AActivity.this.trackClose();
                Vip50683AActivity.this.postUiCloseRequest();
            }
        }, 1, (Object) null);
        initReminder();
        initSplashAnimation();
    ...
    private final void initSplashAnimation() {
        ...
        scaleAnimation.setAnimationListener(new Vip50683AActivity$initSplashAnimation$2(findViewById));
    ...
    private final void initReminder() {
        ...
        switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$initReminder$1
            ...
            public final void onCheckedChanged(CompoundButton buttonView, boolean z) {
                ...
                bundle1 = Vip50683AActivity.this.getBundle1();
                if (!z) {
    ...
    private final void setPurchaseView() {
        ...
        ViewExtensionsKt.setSingleClickListener$default(continueFl, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$setPurchaseView$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                ...
                String str3;
                Intrinsics.checkNotNullParameter(it, "it");
                View findViewById4 = Vip50683AActivity.this.findViewById(R.id.switch1);
                ...
                if (((SwitchCompat) findViewById4).isChecked()) {
                    str2 = Vip50683AActivity.this.currentSku;
                    str3 = Vip50683AActivity.this.yearlySKU;
                    if (Intrinsics.areEqual(str2, str3)) {
                        z = true;
                        str = Vip50683AActivity.this.currentSku;
        ...
        findViewById2.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$setPurchaseView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50683AActivity vip50683AActivity = Vip50683AActivity.this;
                str = vip50683AActivity.yearlySKU;
                vip50683AActivity.changeSKU(str);
                View findViewById4 = Vip50683AActivity.this.findViewById(R.id.switch1);
                Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<SwitchCompat>(R.id.switch1)");
                boolean isChecked = ((SwitchCompat) findViewById4).isChecked();
                str2 = Vip50683AActivity.this.yearlySKU;
                new GuidePurchaseRequest(str2, null, Boolean.valueOf(isChecked), null, 0, 26, null).post();
            }
        });
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$setPurchaseView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50683AActivity vip50683AActivity = Vip50683AActivity.this;
                str = vip50683AActivity.weeklySKU;
                vip50683AActivity.changeSKU(str);
                str2 = Vip50683AActivity.this.weeklySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
        findViewById3.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50683.activity.Vip50683AActivity$setPurchaseView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50683AActivity vip50683AActivity = Vip50683AActivity.this;
                str = vip50683AActivity.monthlySKU;
                vip50683AActivity.changeSKU(str);
                str2 = Vip50683AActivity.this.monthlySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
    }
