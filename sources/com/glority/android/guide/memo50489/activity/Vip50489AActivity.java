package com.glority.android.guide.memo50489.activity;
...
import com.glority.android.guide.memo50489.R;
...
public final class Vip50489AActivity extends BasePurchaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bui_50489_purchase_layout);
        ...
        ViewExtensionsKt.setSingleClickListener$default(findViewById3, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$onCreate$1
        ...
        ViewExtensionsKt.setSingleClickListener$default(findViewById4, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$onCreate$2
            ...
            public final void invoke2(View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                Vip50489AActivity.this.trackClose();
                Vip50489AActivity.this.postUiCloseRequest();
            }
        }, 1, (Object) null);
        initReminder();
        initSplashAnimation();
    ...
    private final void initSplashAnimation() {
        ...
        scaleAnimation.setAnimationListener(new Vip50489AActivity$initSplashAnimation$2(findViewById));
    ...
    private final void initReminder() {
        ...
        switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$initReminder$1
            ...
            public final void onCheckedChanged(CompoundButton buttonView, boolean z) {
                ...
                bundle1 = Vip50489AActivity.this.getBundle1();
                if (!z) {
    ...
    private final void setPurchaseView() {
        ...
        ViewExtensionsKt.setSingleClickListener$default(continueFl, 0L, new Function1<View, Unit>() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$setPurchaseView$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke2(View it) {
                ...
                String str3;
                Intrinsics.checkNotNullParameter(it, "it");
                View findViewById4 = Vip50489AActivity.this.findViewById(R.id.switch1);
                ...
                if (((SwitchCompat) findViewById4).isChecked()) {
                    str2 = Vip50489AActivity.this.currentSku;
                    str3 = Vip50489AActivity.this.yearlySKU;
                    if (Intrinsics.areEqual(str2, str3)) {
                        z = true;
                        str = Vip50489AActivity.this.currentSku;
        ...
        findViewById2.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$setPurchaseView$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50489AActivity vip50489AActivity = Vip50489AActivity.this;
                str = vip50489AActivity.yearlySKU;
                vip50489AActivity.changeSKU(str);
                View findViewById4 = Vip50489AActivity.this.findViewById(R.id.switch1);
                Intrinsics.checkNotNullExpressionValue(findViewById4, "findViewById<SwitchCompat>(R.id.switch1)");
                boolean isChecked = ((SwitchCompat) findViewById4).isChecked();
                str2 = Vip50489AActivity.this.yearlySKU;
                new GuidePurchaseRequest(str2, null, Boolean.valueOf(isChecked), null, 0, 26, null).post();
            }
        });
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$setPurchaseView$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50489AActivity vip50489AActivity = Vip50489AActivity.this;
                str = vip50489AActivity.weeklySKU;
                vip50489AActivity.changeSKU(str);
                str2 = Vip50489AActivity.this.weeklySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
        findViewById3.setOnClickListener(new View.OnClickListener() { // from class: com.glority.android.guide.memo50489.activity.Vip50489AActivity$setPurchaseView$4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                String str;
                String str2;
                Vip50489AActivity vip50489AActivity = Vip50489AActivity.this;
                str = vip50489AActivity.monthlySKU;
                vip50489AActivity.changeSKU(str);
                str2 = Vip50489AActivity.this.monthlySKU;
                new GuidePurchaseRequest(str2, null, 2, null).post();
            }
        });
    }
