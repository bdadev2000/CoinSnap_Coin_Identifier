...
import com.glority.android.guide.memo50694.R;
...
public final class Vip50694AActivity extends BasePurchaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ComponentActivityKt.setContent$default(this, null, ComposableLambdaKt.composableLambdaInstance(1274135647, true, new Vip50694AActivity$onCreate$1(this)), 1, null);
    }
    ...
    public final void LoadingPage(final Function1<? super Float, Unit> finishedListener, Composer composer, final int i) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(-521718617);
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-521718617, i2, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.LoadingPage (Vip50694AActivity.kt:138)");
            }
            ...
            final State<Float> animateFloatAsState = AnimateAsStateKt.animateFloatAsState(LoadingPage$lambda$1(mutableState) ? 1.0f : 2.2f, AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$LoadingPage$scale$2
            ...
            if (changed || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                rememberedValue2 = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$LoadingPage$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayer) {
                        ...
                        LoadingPage$lambda$3 = Vip50694AActivity.LoadingPage$lambda$3(animateFloatAsState);
                        graphicsLayer.setScaleY(LoadingPage$lambda$3);
                        LoadingPage$lambda$32 = Vip50694AActivity.LoadingPage$lambda$3(animateFloatAsState);
            ...
            startRestartGroup.startReplaceableGroup(-1276000523);
            ...
            Vip50694AActivity$LoadingPage$3$1 rememberedValue3 = composer2.rememberedValue();
            if (changed2 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                rememberedValue3 = new Vip50694AActivity$LoadingPage$3$1(mutableState, null);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$LoadingPage$4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
            ...
            public final void invoke(Composer composer3, int i3) {
                Vip50694AActivity.this.LoadingPage(finishedListener, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public final void purchasePage(Composer composer, final int i) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(373610883);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(373610883, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.purchasePage (Vip50694AActivity.kt:187)");
        }
        ...
        MaterialThemeKt.MaterialTheme(m2212copyG1PFcw, null, null, ComposableLambdaKt.composableLambda(startRestartGroup, -1349521833, true, new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$purchasePage$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i2) {
                ...
                if ((i2 & 11) != 2 || !composer2.getSkipping()) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1349521833, i2, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.purchasePage.<anonymous> (Vip50694AActivity.kt:191)");
                    }
                    Modifier fillMaxSize$default = SizeKt.fillMaxSize$default(Modifier.INSTANCE, 0.0f, 1, null);
                    ScrollState scrollState = ScrollState.this;
                    Vip50694AActivity vip50694AActivity = this;
                    ...
                    vip50694AActivity.HeaderImage(composer2, 8);
                    ...
                    vip50694AActivity.DescriptionView(composer2, 8);
                    vip50694AActivity.PurchaseView(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, Dp.m6997constructorimpl(16), 0.0f, 0.0f, 13, null), composer2, 70, 0);
                    float f2 = 10;
                    ...
                    mutableState = vip50694AActivity.isTrialSkuSelected;
                    vip50694AActivity.ReminderBar(m989paddingqDBjuR0$default, mutableState, composer2, 518, 0);
                    vip50694AActivity.ContinueButton(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, 0.0f, Dp.m6997constructorimpl(f2), 0.0f, 0.0f, 13, null), composer2, 70, 0);
                    SpacerKt.Spacer(ColumnScope.weight$default(columnScopeInstance, Modifier.INSTANCE, 1.0f, false, 2, null), composer2, 0);
                    vip50694AActivity.PolicyView(scrollState, null, composer2, 512, 2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endReplaceableGroup();
                    composer2.endNode();
                    composer2.endReplaceableGroup();
                    ...
                    composer2.endReplaceableGroup();
                    composer2.endReplaceableGroup();
                    vip50694AActivity.restoreAndCloseBar(composer2, 8);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endReplaceableGroup();
                    composer2.endNode();
                    composer2.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$purchasePage$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i2) {
                Vip50694AActivity.this.purchasePage(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public final void restoreAndCloseBar(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(1630479151);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1630479151, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.restoreAndCloseBar (Vip50694AActivity.kt:229)");
        }
        ...
        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.md5_6a2d1ce47e05102d914a6d21126966ac, startRestartGroup, 0), "", ClickableKt.m573clickableXHw0xAI$default(rowScopeInstance.align(SizeKt.m1030size3ABfNKs(Modifier.INSTANCE, Dp.m6997constructorimpl(12)), Alignment.INSTANCE.getCenterVertically()), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$restoreAndCloseBar$1$2
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Vip50694AActivity.this.trackClose();
                Vip50694AActivity.this.postUiCloseRequest();
            }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$restoreAndCloseBar$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i2) {
                Vip50694AActivity.this.restoreAndCloseBar(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }

    public final void HeaderImage(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(-1934552799);
        ComposerKt.sourceInformation(startRestartGroup, "C(HeaderImage)");
        if ((i & 1) != 0 || !startRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1934552799, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.HeaderImage (Vip50694AActivity.kt:265)");
            }
            ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = startRestartGroup.consume(localConfiguration);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$HeaderImage$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i2) {
                Vip50694AActivity.this.HeaderImage(composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public final void DescriptionView(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(1647657358);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1647657358, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.DescriptionView (Vip50694AActivity.kt:293)");
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$DescriptionView$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer4, int i5) {
                Vip50694AActivity.this.DescriptionView(composer4, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public final void PurchaseView(Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        Composer startRestartGroup = composer.startRestartGroup(1687407108);
        ComposerKt.sourceInformation(startRestartGroup, "C(PurchaseView)");
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1687407108, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.PurchaseView (Vip50694AActivity.kt:323)");
        }
        startRestartGroup.startReplaceableGroup(-483455358);
        ComposerKt.sourceInformation(startRestartGroup, "CC(Column)P(2,3,1)75@3779L61,76@3845L133:Column.kt#2w3rfo");
        ...
        Modifier m573clickableXHw0xAI$default = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m540backgroundbw27NRU$default(ClipKt.clip(BorderKt.m551borderxT4_qwU(weight$default, m6997constructorimpl, m4550getTransparent0d7_KjU, RoundedCornerShapeKt.RoundedCornerShape(10)), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), null, 2, null), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$PurchaseView$1$1$1
            ...
            public final void invoke2() {
                String str;
                MutableState mutableState;
                Vip50694AActivity vip50694AActivity = Vip50694AActivity.this;
                str = vip50694AActivity.weeklySKU;
                vip50694AActivity.setCurrentSku(str);
                mutableState = Vip50694AActivity.this.isTrialSkuSelected;
                mutableState.setValue(false);
                Vip50694AActivity.this.startPurchase();
            }
        }, 7, null);
        Alignment.Horizontal centerHorizontally = Alignment.INSTANCE.getCenterHorizontally();
        ...
        Modifier m573clickableXHw0xAI$default2 = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m540backgroundbw27NRU$default(ClipKt.clip(RowScope.weight$default(rowScopeInstance, BorderKt.m551borderxT4_qwU(PaddingKt.m989paddingqDBjuR0$default(Modifier.INSTANCE, Dp.m6997constructorimpl(f), 0.0f, Dp.m6997constructorimpl(f), 0.0f, 10, null), Dp.m6997constructorimpl(f3), Intrinsics.areEqual(getCurrentSku(), this.yearlySKU) ? ColorKt.Color(4294618905L) : ColorKt.Color(4290624957L), RoundedCornerShapeKt.RoundedCornerShape(10)), 120.0f, false, 2, null), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), null, 2, null), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$PurchaseView$1$1$3
            ...
            public final void invoke2() {
                ...
                MutableState mutableState;
                Vip50694AActivity vip50694AActivity = Vip50694AActivity.this;
                str3 = vip50694AActivity.yearlySKU;
                vip50694AActivity.setCurrentSku(str3);
                mutableState = Vip50694AActivity.this.isTrialSkuSelected;
        ...
        Modifier m573clickableXHw0xAI$default3 = ClickableKt.m573clickableXHw0xAI$default(BackgroundKt.m539backgroundbw27NRU(ClipKt.clip(BorderKt.m551borderxT4_qwU(weight$default2, m6997constructorimpl2, m4550getTransparent0d7_KjU2, RoundedCornerShapeKt.RoundedCornerShape(10)), RoundedCornerShapeKt.RoundedCornerShape(10)), ColorKt.Color(818201796), RoundedCornerShapeKt.RoundedCornerShape(10)), false, null, null, new Function0<Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$PurchaseView$1$1$5
            ...
            public final void invoke2() {
                ...
                MutableState mutableState;
                Vip50694AActivity vip50694AActivity = Vip50694AActivity.this;
                str3 = vip50694AActivity.monthlySKU;
                vip50694AActivity.setCurrentSku(str3);
                mutableState = Vip50694AActivity.this.isTrialSkuSelected;
                mutableState.setValue(false);
                Vip50694AActivity.this.startPurchase();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$PurchaseView$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i3) {
                Vip50694AActivity.this.PurchaseView(modifier3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public final void ReminderBar(Modifier modifier, final MutableState<Boolean> mutableState, Composer composer, final int i, final int i2) {
        Composer startRestartGroup = composer.startRestartGroup(2100878980);
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2100878980, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.ReminderBar (Vip50694AActivity.kt:505)");
        }
        ...
        SwitchKt.Switch(getReminderOpen(), new Function1<Boolean, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$ReminderBar$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final void invoke(boolean z) {
                ...
                Vip50694AActivity.this.setReminderOpen(z);
                bundle1 = Vip50694AActivity.this.getBundle1();
                Vip50694AActivity vip50694AActivity = Vip50694AActivity.this;
                reminderOpen = vip50694AActivity.getReminderOpen();
                if (reminderOpen) {
                    try {
                        bundle1.putString("status", NotificationManagerCompat.from(vip50694AActivity).areNotificationsEnabled() ? ExifInterface.GPS_MEASUREMENT_2D : "1");
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$ReminderBar$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i3) {
                Vip50694AActivity.this.ReminderBar(modifier3, mutableState, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    public final void ContinueButton(Modifier modifier, Composer composer, final int i, final int i2) {
        Composer startRestartGroup = composer.startRestartGroup(-1182496143);
        Modifier modifier2 = (i2 & 1) != 0 ? Modifier.INSTANCE : modifier;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1182496143, i, -1, "com.glority.android.guide.memo50694.activity.Vip50694AActivity.ContinueButton (Vip50694AActivity.kt:547)");
        }
        LottieCompositionResult rememberLottieComposition = RememberLottieCompositionKt.rememberLottieComposition(LottieCompositionSpec.RawRes.m7636boximpl(LottieCompositionSpec.RawRes.m7637constructorimpl(R.raw.lottie_50694)), "images", null, null, null, null, startRestartGroup, 48, 60);
        final Modifier modifier3 = modifier2;
        ...
        LottieCompositionResult rememberLottieComposition2 = RememberLottieCompositionKt.rememberLottieComposition(LottieCompositionSpec.RawRes.m7636boximpl(LottieCompositionSpec.RawRes.m7637constructorimpl(R.raw.lottie_50694_1)), null, null, null, null, null, startRestartGroup, 0, 62);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function0) new Function0<Float>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$ContinueButton$2$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
                ...
                public final Float invoke() {
                    ...
                    ContinueButton$lambda$25 = Vip50694AActivity.ContinueButton$lambda$25(LottieAnimationState.this);
        ...
        if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = (Function0) new Function0<Float>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$ContinueButton$2$2$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(0);
                }
                ...
                public final Float invoke() {
                    ...
                    ContinueButton$lambda$23 = Vip50694AActivity.ContinueButton$lambda$23(LottieAnimationState.this);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.glority.android.guide.memo50694.activity.Vip50694AActivity$ContinueButton$3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final void invoke(Composer composer2, int i3) {
                Vip50694AActivity.this.ContinueButton(modifier3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    */
    public final void PolicyView(final androidx.compose.foundation.ScrollState r63, androidx.compose.ui.Modifier r64, androidx.compose.runtime.Composer r65, final int r66, final int r67) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.android.guide.memo50694.activity.Vip50694AActivity.PolicyView(androidx.compose.foundation.ScrollState, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
