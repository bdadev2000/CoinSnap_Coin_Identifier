...
@DebugMetadata(c = "com.glority.android.compose.ui.WebViewKt$WebView$12$2", f = "WebView.kt", i = {}, l = {182}, m = "invokeSuspend", n = {}, s = {})
...
final class WebViewKt$WebView$12$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<WebContent>() { // from class: com.glority.android.compose.ui.WebViewKt$WebView$12$2.1
                {
                    super(0);
                }
            ...
            this.label = 1;
            if (snapshotFlow.collect(new FlowCollector() { // from class: com.glority.android.compose.ui.WebViewKt$WebView$12$2.2
                ...
                public final Object emit(WebContent webContent, Continuation<? super Unit> continuation) {
                    if (webContent instanceof WebContent.Url) {
                        ...
                        webView.loadDataWithBaseURL(data.getBaseUrl(), data.getData(), data.getMimeType(), data.getEncoding(), data.getHistoryUrl());
