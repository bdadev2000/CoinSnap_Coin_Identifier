package com.glority.android.networkconfig.interceptor;
...
import com.glority.android.networkconfig.Host;
import com.glority.android.networkconfig.util.GZipUtils;
import com.glority.android.networkconfig.util.Md5Utils;
...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0012\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000  2\u00020\u0001:\u0001 B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0016\u001a\u00020\u0006H\u0002J\u0018\u0010\u0017\u001a\u00020\u00062\u0006\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\u001bH\u0002J\u0010\u0010\u001c\u001a\u00020\u001d2\u0006\u0010\u001e\u001a\u00020\u001fH\u0016R\u001b\u0010\u0005\u001a\u00020\u00068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u0007\u0010\bR\u001b\u0010\u000b\u001a\u00020\u00068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\r\u0010\n\u001a\u0004\b\f\u0010\bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000e\u001a\u00020\u00068BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\bR\u001b\u0010\u0010\u001a\u00020\u00068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0012\u0010\n\u001a\u0004\b\u0011\u0010\bR\u001b\u0010\u0013\u001a\u00020\u00068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0015\u0010\n\u001a\u0004\b\u0014\u0010\b¨\u0006!"}, d2 = {"Lcom/glority/android/networkconfig/interceptor/ParseInterceptor;", "Lokhttp3/Interceptor;", "enableEncryption", "", "(Z)V", "appName", "", "getAppName", "()Ljava/lang/String;", "appName$delegate", "Lkotlin/Lazy;", "applicationId", "getApplicationId", "applicationId$delegate", "userAgent", "getUserAgent", "versionCode", "getVersionCode", "versionCode$delegate", "versionName", "getVersionName", "versionName$delegate", "get24UUID", "getSignature", "request", "Lokhttp3/Request;", "timestamp", "", "intercept", "Lokhttp3/Response;", "chain", "Lokhttp3/Interceptor$Chain;", "Companion", "base-networkconfig_release"}, k = 1, mv = {1, 4, 2})
...
public final class ParseInterceptor implements Interceptor {
    ...
    public ParseInterceptor(boolean z) {
        ...
        this.appName = LazyKt.lazy(new Function0<String>() { // from class: com.glority.android.networkconfig.interceptor.ParseInterceptor$appName$2
            @Override // kotlin.jvm.functions.Function0
            public final String invoke() {
                return AppContext.INSTANCE.getConfig("APP_NAME");
            }
        });
        this.applicationId = LazyKt.lazy(new Function0<String>() { // from class: com.glority.android.networkconfig.interceptor.ParseInterceptor$applicationId$2
            @Override // kotlin.jvm.functions.Function0
            public final String invoke() {
                return AppContext.INSTANCE.getConfig("APPLICATION_ID");
            }
        });
        this.versionName = LazyKt.lazy(new Function0<String>() { // from class: com.glority.android.networkconfig.interceptor.ParseInterceptor$versionName$2
            @Override // kotlin.jvm.functions.Function0
            public final String invoke() {
                return AppContext.INSTANCE.getConfig("VERSION_NAME");
            }
        });
        this.versionCode = LazyKt.lazy(new Function0<String>() { // from class: com.glority.android.networkconfig.interceptor.ParseInterceptor$versionCode$2
            @Override // kotlin.jvm.functions.Function0
            public final String invoke() {
    ...
    public Response intercept(Interceptor.Chain chain) {
        ...
        if (Intrinsics.areEqual(host, Host.INSTANCE.getHost())) {
            if (result != null) {
                newBuilder.header(KEY_USER_ID, String.valueOf(result.longValue()));
            }
        ...
        if (Host.INSTANCE.getAuthHosts().contains(host)) {
            if (this.enableEncryption) {
                ...
                Intrinsics.checkNotNullExpressionValue(host2, "request.url().host()");
        ...
        if (body != null) {
            if (Intrinsics.areEqual(String.valueOf(body.contentType()), CONTENT_TYPE_ENCRYPTED)) {
                ...
                Intrinsics.checkNotNullExpressionValue(host3, "request.url().host()");
                ...
                Response build = response.newBuilder().body(ResponseBody.create(MediaType.get(CONTENT_TYPE_JSON), str4)).build();
                Intrinsics.checkNotNullExpressionValue(build, "response.newBuilder().bo…      ), result)).build()");
                return build;
            }
    ...
    private final String getSignature(Request request, long timestamp) {
            ...
            if (hashCode == 70454) {
                if (method.equals("GET")) {
                    ...
                    for (String it : paramKeys) {
                        ...
                        treeMap2.put(it, queryParameter);
                        Log.d("ParseInterceptor", "Get name: " + it + ", value: " + ((String) treeMap.get(it)));
                    }
                }
                ...
                if (body instanceof FormBody) {
                    ...
                    for (MultipartBody.Part part : parts) {
                        ...
                        if (type == null || Intrinsics.areEqual(type, "text")) {
                            ...
                            Log.d("ParseInterceptor", "MultipartBody name: " + replace$default2 + ", value: " + str2);
                            if (replace$default2 != null && replace$default2.length() > 0 && str2 != null && str2.length() > 0) {
                                treeMap.put(replace$default2, str2);
                            }
                        }
                    }
                }
        ...
        Intrinsics.checkNotNullExpressionValue(md5, "Md5Utils.md5(encryptedData)");
        return md5;
    }
