...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$3", f = "ApiServer.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
final class ApiServer$sendMessageStreaming$3 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    final /* synthetic */ APIException $e;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApiServer$sendMessageStreaming$3(APIException aPIException, Continuation<? super ApiServer$sendMessageStreaming$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ApiServer$sendMessageStreaming$3(this.$e, continuation);
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$3) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Resource.INSTANCE.error(this.$e.getMessage(), null, this.$e);
