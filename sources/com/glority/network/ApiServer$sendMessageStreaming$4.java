...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$4", f = "ApiServer.kt", i = {}, l = {99}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$4 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$4(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$4 apiServer$sendMessageStreaming$4 = new ApiServer$sendMessageStreaming$4(this.$exception, continuation);
        apiServer$sendMessageStreaming$4.L$0 = obj;
        return apiServer$sendMessageStreaming$4;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$4) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
