...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$9", f = "ApiServer.kt", i = {}, l = {119}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$9 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$9(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$9> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$9 apiServer$sendMessageStreaming$9 = new ApiServer$sendMessageStreaming$9(this.$exception, continuation);
        apiServer$sendMessageStreaming$9.L$0 = obj;
        return apiServer$sendMessageStreaming$9;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$9) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
