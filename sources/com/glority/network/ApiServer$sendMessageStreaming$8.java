...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$8", f = "ApiServer.kt", i = {}, l = {115}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$8 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$8(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$8> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$8 apiServer$sendMessageStreaming$8 = new ApiServer$sendMessageStreaming$8(this.$exception, continuation);
        apiServer$sendMessageStreaming$8.L$0 = obj;
        return apiServer$sendMessageStreaming$8;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$8) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
