...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$11", f = "ApiServer.kt", i = {}, l = {126}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$11 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$11(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$11> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$11 apiServer$sendMessageStreaming$11 = new ApiServer$sendMessageStreaming$11(this.$exception, continuation);
        apiServer$sendMessageStreaming$11.L$0 = obj;
        return apiServer$sendMessageStreaming$11;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$11) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
