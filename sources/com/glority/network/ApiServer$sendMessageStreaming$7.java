...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$7", f = "ApiServer.kt", i = {}, l = {111}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$7 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$7(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$7> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$7 apiServer$sendMessageStreaming$7 = new ApiServer$sendMessageStreaming$7(this.$exception, continuation);
        apiServer$sendMessageStreaming$7.L$0 = obj;
        return apiServer$sendMessageStreaming$7;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$7) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
