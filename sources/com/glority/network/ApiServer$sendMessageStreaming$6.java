...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$6", f = "ApiServer.kt", i = {}, l = {107}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$6 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$6(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$6 apiServer$sendMessageStreaming$6 = new ApiServer$sendMessageStreaming$6(this.$exception, continuation);
        apiServer$sendMessageStreaming$6.L$0 = obj;
        return apiServer$sendMessageStreaming$6;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$6) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
