...
@DebugMetadata(c = "com.glority.network.ApiServer$sendMessageStreaming$1", f = "ApiServer.kt", i = {}, l = {68}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes9.dex */
public final class ApiServer$sendMessageStreaming$1 extends SuspendLambda implements Function2<FlowCollector<? super Resource<? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public ApiServer$sendMessageStreaming$1(RequestFailException requestFailException, Continuation<? super ApiServer$sendMessageStreaming$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ApiServer$sendMessageStreaming$1 apiServer$sendMessageStreaming$1 = new ApiServer$sendMessageStreaming$1(this.$exception, continuation);
        apiServer$sendMessageStreaming$1.L$0 = obj;
        return apiServer$sendMessageStreaming$1;
    }
    ...
    public final Object invoke2(FlowCollector<? super Resource<String>> flowCollector, Continuation<? super Unit> continuation) {
        return ((ApiServer$sendMessageStreaming$1) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
