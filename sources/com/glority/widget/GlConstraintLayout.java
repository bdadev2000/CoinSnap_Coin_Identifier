...
public final class GlConstraintLayout extends ConstraintLayout implements IUIMakerView<ViewGroupParameter> {
    ...
    public void parseParameter(boolean loadLocalResource, ResourceConverter resourceConverter, ViewGroupParameter parameter) {
    ...
    */
    public /* synthetic */ GlConstraintLayout(android.content.Context r1, android.util.AttributeSet r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        /*
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto L8
        ...
        L8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.widget.GlConstraintLayout.<init>(android.content.Context, android.util.AttributeSet, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GlConstraintLayout(Context context, AttributeSet attributeSet) {
