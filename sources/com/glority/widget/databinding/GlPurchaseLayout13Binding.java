...
public final class GlPurchaseLayout13Binding implements ViewBinding {
    ...
    public static GlPurchaseLayout13Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static GlPurchaseLayout13Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.gl_purchase_layout13, viewGroup, false);
        if (z) {
    ...
    public static GlPurchaseLayout13Binding bind(View view) {
                                                        ...
                                                        if (glTextView5 != null) {
                                                            ...
                                                            if (textView3 != null) {
                                                                ...
                                                                if (textView4 != null) {
                                                                    ...
                                                                    if (glTextView6 != null) {
                                                                        return new GlPurchaseLayout13Binding((LinearLayout) view, glTextView, glTextView2, cardView, constraintLayout, cardView2, constraintLayout2, cardView3, constraintLayout3, glTextView3, glTextView4, textView, textView2, glTextView5, textView3, textView4, glTextView6);
                                                                    }
                                                                }
                                                            }
                                                        }
