...
import com.glority.widget.databinding.GlPurchaseLayout6Binding;
...
public final class GlPurchaseView6 extends GlBasePurchaseView<GlPurchaseView6Parameter> {
    ...
    */
    public /* synthetic */ GlPurchaseView6(android.content.Context r1, android.util.AttributeSet r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        /*
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto L8
        ...
        L8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.widget.purchase.purchase.GlPurchaseView6.<init>(android.content.Context, android.util.AttributeSet, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GlPurchaseView6(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        Intrinsics.checkNotNullParameter(context, "context");
        GlPurchaseLayout6Binding inflate = GlPurchaseLayout6Binding.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(inflate, "GlPurchaseLayout6Binding…rom(context), this, true)");
        this.binding = inflate;
        initClick();
    }

    public final GlPurchaseLayout6Binding getBinding() {
        return this.binding;
    }
        ...
        if (StringsKt.contains((CharSequence) purchaseType.name(), (CharSequence) Args.year, true)) {
            ...
            if (parameter != null && parameter.getInfoType() == 1) {
                ...
                if (parameter2 != null && parameter2.getInfoType() == 2) {
                    ...
                    GlPurchaseView6Parameter parameter3 = getParameter();
    ...
    public void parseParameter(boolean loadLocalResource, ResourceConverter resourceConverter, GlPurchaseView6Parameter parameter) {
        ...
        setDrawable(loadLocalResource, parameter.getContinueBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$parseParameter$5
            ...
            public final void invoke2(Drawable drawable) {
                LinearLayout linearLayout = GlPurchaseView6.this.getBinding().llYearly;
                Intrinsics.checkNotNullExpressionValue(linearLayout, "binding.llYearly");
                linearLayout.setBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getWeeklyBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$parseParameter$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                LinearLayout linearLayout = GlPurchaseView6.this.getBinding().llWeekly;
                Intrinsics.checkNotNullExpressionValue(linearLayout, "binding.llWeekly");
                linearLayout.setBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getMonthlyBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$parseParameter$7
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                LinearLayout linearLayout = GlPurchaseView6.this.getBinding().llMonthly;
        ...
        if (parameter.getInfoTextViewParameter() != null) {
            GlTextView glTextView = this.binding.tvInfo;
            TextViewParameter infoTextViewParameter = parameter.getInfoTextViewParameter();
            Intrinsics.checkNotNull(infoTextViewParameter);
            glTextView.parseParameter(loadLocalResource, resourceConverter, infoTextViewParameter);
            return;
        }
        GlTextView glTextView2 = this.binding.tvInfo;
        Intrinsics.checkNotNullExpressionValue(glTextView2, "binding.tvInfo");
    ...
    public void initClick() {
        this.binding.llYearly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$initClick$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView6.this.getUiMakerOnClickListener();
                if (uiMakerOnClickListener != null) {
                    uiMakerOnClickListener.onClick(ClickEnum.buyYearly);
                }
            }
        });
        this.binding.llWeekly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$initClick$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView6.this.getUiMakerOnClickListener();
                if (uiMakerOnClickListener != null) {
        ...
        this.binding.llMonthly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView6$initClick$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView6.this.getUiMakerOnClickListener();
                if (uiMakerOnClickListener != null) {
