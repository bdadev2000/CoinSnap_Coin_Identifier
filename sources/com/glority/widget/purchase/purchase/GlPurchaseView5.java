...
/* compiled from: GlPurchaseView5.kt */
...
public final class GlPurchaseView5 extends GlBasePurchaseView<GlPurchaseView5Parameter> {
    ...
    */
    ...
    public GlPurchaseView5(Context context, AttributeSet attributeSet) {
        ...
        initClick();
        GlTextView glTextView = inflate.purchase3Info;
        Intrinsics.checkNotNullExpressionValue(glTextView, "binding.purchase3Info");
        String string = getResources().getString(R.string.base_widget_text_7_day_free_trial);
        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.st…et_text_7_day_free_trial)");
