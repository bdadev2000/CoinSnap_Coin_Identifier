...
import com.glority.widget.databinding.GlPurchaseLayout1Binding;
...
public final class GlPurchaseView1 extends GlBasePurchaseView<GlPurchaseView1Parameter> {
    ...
    */
    public /* synthetic */ GlPurchaseView1(android.content.Context r1, android.util.AttributeSet r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        /*
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto L8
        ...
        L8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.widget.purchase.purchase.GlPurchaseView1.<init>(android.content.Context, android.util.AttributeSet, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GlPurchaseView1(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        Intrinsics.checkNotNullParameter(context, "context");
        GlPurchaseLayout1Binding inflate = GlPurchaseLayout1Binding.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(inflate, "GlPurchaseLayout1Binding…rom(context), this, true)");
    ...
    public final void setMainSkuSelectedBackground(Drawable drawable) {
        ...
        ConstraintLayout constraintLayout = this.binding.ll7DayFree;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.ll7DayFree");
    ...
    public final void setOtherSkuUnselectedBackground(Drawable drawable) {
        ConstraintLayout constraintLayout = this.binding.llWeekly;
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.llWeekly");
        constraintLayout.setBackground(drawable);
        ConstraintLayout constraintLayout2 = this.binding.llMonthly;
        Intrinsics.checkNotNullExpressionValue(constraintLayout2, "binding.llMonthly");
    ...
    public final int getMainBilledColor() {
        return this.mainBilledColor;
    }

    public final void setMainBilledColor(int i) {
        this.binding.billedYearly.setTextColor(i);
        this.mainBilledColor = i;
    }
    ...
    public void initClick() {
        this.binding.ll7DayFree.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$initClick$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView1.this.getClickListenerMap$mod_release().get(PurchaseType.YEARLY_7DT);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView1.this.getUiMakerOnClickListener();
                if (uiMakerOnClickListener != null) {
                    uiMakerOnClickListener.onClick(ClickEnum.buyYearly);
                }
                GlPurchaseView1.this.dt7Enable(true);
                GlPurchaseView1.this.weekEnable(false);
                GlPurchaseView1.this.monthEnable(false);
            }
        });
        this.binding.llMonthly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$initClick$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView1.this.getClickListenerMap$mod_release().get(PurchaseType.MONTHLY);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView1.this.getUiMakerOnClickListener();
                ...
                GlPurchaseView1.this.dt7Enable(false);
                GlPurchaseView1.this.weekEnable(false);
                GlPurchaseView1.this.monthEnable(true);
            }
        });
        this.binding.llWeekly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$initClick$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView1.this.getClickListenerMap$mod_release().get(PurchaseType.WEEKLY);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView1.this.getUiMakerOnClickListener();
                ...
                GlPurchaseView1.this.dt7Enable(false);
                GlPurchaseView1.this.weekEnable(true);
                GlPurchaseView1.this.monthEnable(false);
            }
        });
    }
    ...
    public void setPrice(PurchaseType purchaseType, String price, String currencyCode) {
        ...
        if (i == 1) {
            ...
            glTextView.setText(textBold(getResources().getString(R.string.base_widget_text_then_s, currencyCode + ' ' + price), price, Integer.valueOf(this.mainPriceColor)));
        }
    }
    ...
    public final void dt7Enable(boolean enable) {
        ...
        ConstraintLayout constraintLayout2 = this.binding.ll7DayFree;
        Intrinsics.checkNotNullExpressionValue(constraintLayout2, "binding.ll7DayFree");
    ...
    public final void weekEnable(boolean enable) {
        if (enable) {
            ...
            ConstraintLayout constraintLayout2 = this.binding.llWeekly;
            Intrinsics.checkNotNullExpressionValue(constraintLayout2, "binding.llWeekly");
    ...
    public final void monthEnable(boolean enable) {
        if (enable) {
            ConstraintLayout constraintLayout = this.binding.llMonthly;
            Intrinsics.checkNotNullExpressionValue(constraintLayout, "binding.llMonthly");
            constraintLayout.setBackground(this.otherSkuSelectedBackground);
        } else {
            ConstraintLayout constraintLayout2 = this.binding.llMonthly;
            Intrinsics.checkNotNullExpressionValue(constraintLayout2, "binding.llMonthly");
    ...
    public void parseParameter(boolean loadLocalResource, ResourceConverter resourceConverter, GlPurchaseView1Parameter parameter) {
        Intrinsics.checkNotNullParameter(resourceConverter, "resourceConverter");
        Intrinsics.checkNotNullParameter(parameter, "parameter");
        setMainBilledColor(getColor(parameter.getMainBilledColorParameter()));
        ...
        setDrawable(loadLocalResource, parameter.getMainSkuSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$1
            ...
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setMainSkuSelectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getMainSkuUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setMainSkuUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getOtherSkuSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setOtherSkuSelectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getOtherSkuUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setOtherSkuUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getContinueUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setContinueUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getContinueSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView1$parseParameter$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView1.this.setContinueSelectedBackground(drawable);
            }
        });
        if (parameter.getBy7DayTrial()) {
            this.binding.tv7DayFreeTrial.setText(R.string.base_widget_text_7_day_free_trial);
        }
    }
