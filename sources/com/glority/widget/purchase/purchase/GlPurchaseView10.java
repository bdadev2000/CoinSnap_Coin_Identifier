...
import com.glority.widget.databinding.GlPurchaseLayout10Binding;
...
public final class GlPurchaseView10 extends GlBasePurchaseView<GlPurchaseView10Parameter> {
    ...
    */
    public /* synthetic */ GlPurchaseView10(android.content.Context r1, android.util.AttributeSet r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        /*
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto L8
        ...
        L8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.glority.widget.purchase.purchase.GlPurchaseView10.<init>(android.content.Context, android.util.AttributeSet, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GlPurchaseView10(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        Intrinsics.checkNotNullParameter(context, "context");
        GlPurchaseLayout10Binding inflate = GlPurchaseLayout10Binding.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(inflate, "GlPurchaseLayout10Bindin…rom(context), this, true)");
    ...
    public void initClick() {
        this.binding.ll7DayFree.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$initClick$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView10.this.getClickListenerMap$mod_release().get(PurchaseType.YEARLY_7DT);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView10.this.getUiMakerOnClickListener();
                if (uiMakerOnClickListener != null) {
                    uiMakerOnClickListener.onClick(ClickEnum.buyYearly);
                }
                GlPurchaseView10.this.dt7Enable(true);
                GlPurchaseView10.this.weekEnable(false);
                GlPurchaseView10.this.monthEnable(false);
            }
        });
        this.binding.llMonthly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$initClick$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView10.this.getClickListenerMap$mod_release().get(PurchaseType.MONTHLY);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView10.this.getUiMakerOnClickListener();
                ...
                GlPurchaseView10.this.dt7Enable(false);
                GlPurchaseView10.this.weekEnable(false);
                GlPurchaseView10.this.monthEnable(true);
            }
        });
        this.binding.llWeekly.setOnClickListener(new View.OnClickListener() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$initClick$3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                View.OnClickListener onClickListener = GlPurchaseView10.this.getClickListenerMap$mod_release().get(PurchaseType.WEEKLY);
                if (onClickListener != null) {
                    onClickListener.onClick(view);
                }
                UiMakerOnClickListener uiMakerOnClickListener = GlPurchaseView10.this.getUiMakerOnClickListener();
                ...
                GlPurchaseView10.this.dt7Enable(false);
                GlPurchaseView10.this.weekEnable(true);
                GlPurchaseView10.this.monthEnable(false);
            }
        });
    }
    ...
    public void parseParameter(boolean loadLocalResource, ResourceConverter resourceConverter, GlPurchaseView10Parameter parameter) {
        ...
        setDrawable(loadLocalResource, parameter.getMainSkuSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$1
            ...
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setMainSkuSelectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getMainSkuUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setMainSkuUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getOtherSkuSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$3
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setOtherSkuSelectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getOtherSkuUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$4
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setOtherSkuUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getContinueUnselectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$5
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setContinueUnselectedBackground(drawable);
            }
        });
        setDrawable(loadLocalResource, parameter.getContinueSelectedBackground(), resourceConverter, new Function1<Drawable, Unit>() { // from class: com.glority.widget.purchase.purchase.GlPurchaseView10$parseParameter$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Drawable drawable) {
                GlPurchaseView10.this.setContinueSelectedBackground(drawable);
            }
        });
    }
