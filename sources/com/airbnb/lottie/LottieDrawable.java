...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public /* synthetic */ void m7589lambda$new$0$comairbnblottieLottieDrawable(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m7590lambda$new$1$comairbnblottieLottieDrawable() {
        CompositionLayer compositionLayer = this.compositionLayer;
        if (compositionLayer == null) {
            return;
        }
    ...
    public LottieDrawable() {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LottieDrawable.this.m7589lambda$new$0$comairbnblottieLottieDrawable(valueAnimator);
            }
        };
        this.progressUpdateListener = animatorUpdateListener;
        this.setProgressDrawLock = new Semaphore(1);
        this.updateProgressRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                LottieDrawable.this.m7590lambda$new$1$comairbnblottieLottieDrawable();
            }
        };
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda14
                ...
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7591lambda$playAnimation$2$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$playAnimation$2$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7591lambda$playAnimation$2$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }
    ...
    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda8
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7592lambda$resumeAnimation$3$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$resumeAnimation$3$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7592lambda$resumeAnimation$3$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }
    ...
    public void setMinFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7601lambda$setMinFrame$4$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMinFrame$4$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7601lambda$setMinFrame$4$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMinFrame(i);
    }
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda15
                ...
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7603lambda$setMinProgress$5$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMinProgress$5$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7603lambda$setMinProgress$5$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
    ...
    public void setMaxFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda4
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7594lambda$setMaxFrame$6$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMaxFrame$6$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7594lambda$setMaxFrame$6$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMaxFrame(i);
    }
    ...
    public void setMaxProgress(final float f) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda7
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7596lambda$setMaxProgress$7$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMaxProgress$7$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7596lambda$setMaxProgress$7$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMinFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda11
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7602lambda$setMinFrame$8$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMinFrame$8$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7602lambda$setMinFrame$8$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda10
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7595lambda$setMaxFrame$9$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMaxFrame$9$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7595lambda$setMaxFrame$9$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7597lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m7597lambda$setMinAndMaxFrame$10$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7598lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(str, str2, z, lottieComposition2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m7598lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final int i, final int i2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda3
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7599lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(i, i2, lottieComposition);
                }
            });
        } else {
    ...
    public /* synthetic */ void m7599lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(int i, int i2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(final float f, final float f2) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m7600lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(f, f2, lottieComposition2);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setMinAndMaxProgress$13$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7600lambda$setMinAndMaxProgress$13$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda1
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7593lambda$setFrame$14$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setFrame$14$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7593lambda$setFrame$14$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setFrame(i);
    }
    ...
    public void setProgress(final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda16
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7604lambda$setProgress$15$comairbnblottieLottieDrawable(f, lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$setProgress$15$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7604lambda$setProgress$15$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, final LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m7588lambda$addValueCallback$16$comairbnblottieLottieDrawable(keyPath, t, lottieValueCallback, lottieComposition);
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$addValueCallback$16$com-airbnb-lottie-LottieDrawable, reason: not valid java name */
    public /* synthetic */ void m7588lambda$addValueCallback$16$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
