...
public final class LottieDynamicPropertiesKt {
        ...
        if (changed2 || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = new LottieDynamicProperty((Object) t, keyPath2, (Function1) new Function1<LottieFrameInfo<T>, T>() { // from class: com.airbnb.lottie.compose.LottieDynamicPropertiesKt$rememberLottieDynamicProperty$2$1
                ...
                public final T invoke(LottieFrameInfo<T> it) {
                    ...
                    rememberLottieDynamicProperty$lambda$4 = LottieDynamicPropertiesKt.rememberLottieDynamicProperty$lambda$4(rememberUpdatedState);
    ...
    public static final <T> LottieDynamicPropertiesKt$toValueCallback$1<T> toValueCallback(final Function1<? super LottieFrameInfo<T>, ? extends T> function1) {
