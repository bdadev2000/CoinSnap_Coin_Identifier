...
public final class LottieDynamicProperties {
    ...
    */
    public LottieDynamicProperties(java.util.List<? extends com.airbnb.lottie.compose.LottieDynamicProperty<?>> r15) {
        /*
    ...
    public final void addTo$lottie_compose_release(LottieDrawable drawable) {
        ...
        while (it.hasNext()) {
            ...
            drawable.addValueCallback(keyPath, (KeyPath) property$lottie_compose_release, (LottieValueCallback<KeyPath>) valueCallback9);
        }
        ...
        while (it2.hasNext()) {
            ...
            drawable.addValueCallback(keyPath2, (KeyPath) property$lottie_compose_release2, (LottieValueCallback<KeyPath>) valueCallback8);
        }
        ...
        while (it3.hasNext()) {
            ...
            drawable.addValueCallback(keyPath3, (KeyPath) property$lottie_compose_release3, (LottieValueCallback<KeyPath>) valueCallback7);
        }
        ...
        while (it4.hasNext()) {
            ...
            drawable.addValueCallback(keyPath4, (KeyPath) property$lottie_compose_release4, (LottieValueCallback<KeyPath>) valueCallback6);
        }
        ...
        while (it5.hasNext()) {
            ...
            drawable.addValueCallback(keyPath5, (KeyPath) property$lottie_compose_release5, (LottieValueCallback<KeyPath>) valueCallback5);
        }
        ...
        while (it6.hasNext()) {
            ...
            drawable.addValueCallback(keyPath6, (KeyPath) property$lottie_compose_release6, (LottieValueCallback<KeyPath>) valueCallback4);
        }
        ...
        while (it7.hasNext()) {
            ...
            drawable.addValueCallback(keyPath7, (KeyPath) property$lottie_compose_release7, (LottieValueCallback<KeyPath>) valueCallback3);
        }
        ...
        while (it8.hasNext()) {
            ...
            drawable.addValueCallback(keyPath8, (KeyPath) property$lottie_compose_release8, (LottieValueCallback<KeyPath>) valueCallback2);
        }
        ...
        while (it9.hasNext()) {
            ...
            drawable.addValueCallback(keyPath9, (KeyPath) property$lottie_compose_release9, (LottieValueCallback<KeyPath>) valueCallback);
        }
    }
