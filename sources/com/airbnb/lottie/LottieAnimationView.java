...
public class LottieAnimationView extends AppCompatImageView {
        ...
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda2
                ...
                public final Object call() {
                    return LottieAnimationView.this.m7587lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
                }
            }, true);
        }
    ...
    public /* synthetic */ LottieResult m7587lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda0
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return LottieAnimationView.this.m7586lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
                }
            }, true);
        }
    ...
    public /* synthetic */ LottieResult m7586lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
