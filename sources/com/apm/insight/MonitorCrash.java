...
public class MonitorCrash {
    ...
    private MonitorCrash(Context context, String str, long j3, String str2) {
        Config config = new Config();
        this.mConfig = config;
        config.mAid = str;
        config.mVersionInt = j3;
        config.mVersionStr = str2;
        h.a(context, this);
    }

    @Nullable
    public static MonitorCrash init(Context context, String str, long j3, String str2) {
        ...
        synchronized (MonitorCrash.class) {
            ...
            return new MonitorCrash(context, str, j3, str2);
        }
    }

    public static MonitorCrash initSDK(Context context, String str, long j3, String str2, String str3) {
        o.a(context, true, true, true, true, 0L);
        MonitorCrash monitorCrash = new MonitorCrash(str, j3, str2, str3);
    ...
    private MonitorCrash(String str, long j3, String str2, String... strArr) {
        Config config = new Config();
        this.mConfig = config;
        config.mAid = str;
        config.mVersionInt = j3;
    ...
    public static MonitorCrash initSDK(Context context, String str, long j3, String str2, String str3, String[] strArr) {
        o.a(context, true, true, true, true, 0L);
        MonitorCrash monitorCrash = new MonitorCrash(str, j3, str2, str3);
    ...
    public static MonitorCrash initSDK(Context context, String str, long j3, String str2, String... strArr) {
        o.a(context, true, true, true, true, 0L);
        MonitorCrash monitorCrash = new MonitorCrash(str, j3, str2, strArr);
        monitorCrash.config().setPackageName(strArr);
        return monitorCrash;
    }

    public static MonitorCrash initSDK(Context context, String str, long j3, String str2, String[] strArr, String[] strArr2) {
        o.a(context, true, true, true, true, 0L);
        MonitorCrash monitorCrash = new MonitorCrash(str, j3, str2, strArr);
