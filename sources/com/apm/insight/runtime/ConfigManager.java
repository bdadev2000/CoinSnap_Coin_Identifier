...
public class ConfigManager {
    ...
    public void setBlockMonitorEnable(boolean z8) {
        this.mBlockMonitorEnable = z8;
    }

    public void setBlockMonitorInterval(long j7) {
        this.mBlockMonitorInterval = j7;
    }
    ...
    public void setEnsureEnable(boolean z8) {
        this.mEnsureEnable = z8;
    }

    public void setEnsureWithLogcat(boolean z8) {
        this.mEnsureWithLogcat = z8;
    }
    ...
    public void setLaunchCrashInterval(long j7) {
        if (j7 > 0) {
            this.mLaunchCrashInterval = j7;
        }
    }
    ...
    public void setLogcatDumpCount(int i9) {
        if (i9 > 0) {
            this.mLogcatDumpCount = i9;
        }
    }

    public void setLogcatLevel(int i9) {
        if (i9 < 0 || i9 > 4) {
            return;
        }
        this.mLogcatLevel = i9;
    }
    ...
    public void setReportErrorEnable(boolean z8) {
        this.reportErrorEnable = z8;
    }
