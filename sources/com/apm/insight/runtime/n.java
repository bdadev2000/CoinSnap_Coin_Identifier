    ...
    public static JSONObject b(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            if (!"configType".equals(next)) {
                ...
                if (optJSONObject == null) {
                    com.apm.insight.c.a().a("NPTH_CATCH", new IllegalArgumentException(vd.e.e("err config with key: ", next)));
                } else {
                    if (a(optJSONObject.optJSONArray("disable"), fVar)) {
                        sb2 = new StringBuilder("match diable ");
                    } else {
                        JSONArray b3 = b(optJSONObject.optJSONArray("enable"), fVar);
                        if (com.apm.insight.l.k.a(b3)) {
                            sb2 = new StringBuilder("not match ");
                        } else {
                            try {
                                jSONObject2.put(next, new JSONObject().put("enable", b3));
                            } catch (JSONException unused) {
                            }
                        }
                    }
