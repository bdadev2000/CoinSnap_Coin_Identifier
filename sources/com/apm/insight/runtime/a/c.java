...
public abstract class c {
    ...
    protected Context f3305b;

    /* renamed from: c, reason: collision with root package name */
    protected ICommonParams f3306c = com.apm.insight.i.a().c();
    ...
    private void i(com.apm.insight.entity.a aVar) {
        List<AttachUserData> a10 = com.apm.insight.i.b().a(this.a);
        ...
        List<AttachUserData> b3 = com.apm.insight.i.b().b(this.a);
        if (b3 != null) {
            ...
            for (int i11 = 0; i11 < b3.size(); i11++) {
                try {
                    AttachUserData attachUserData2 = b3.get(i11);
    ...
    public com.apm.insight.entity.a c(com.apm.insight.entity.a aVar) {
        ...
        if (c() && (bVar = this.f3307d) != null) {
            aVar.a(bVar);
        }
        try {
            aVar.a(this.f3306c.getPatchInfo());
        } catch (Throwable th2) {
            try {
        ...
        aVar.a("is_background", Boolean.valueOf(!com.apm.insight.l.a.a(this.f3305b)));
        return aVar;
    }

    public com.apm.insight.entity.a d(com.apm.insight.entity.a aVar) {
        if (d()) {
            aVar.b(v.a(this.f3305b));
        }
        return aVar;
    }
    ...
    public com.apm.insight.entity.a b(com.apm.insight.entity.a aVar) {
        ...
        try {
            aVar.a(this.f3306c.getPluginInfo());
        } catch (Throwable th2) {
            try {
                HashMap hashMap = new HashMap();
    ...
    public com.apm.insight.entity.a a(@Nullable com.apm.insight.entity.a aVar, @Nullable a aVar2, boolean z10) {
        if (aVar == null) {
            aVar = new com.apm.insight.entity.a();
        }
        ...
        for (int i10 = 0; i10 < b(); i10++) {
            ...
            aVar.b(eb.j.i("step_cost_", i10), String.valueOf(SystemClock.uptimeMillis() - uptimeMillis));
        }
        return a(aVar);
    }
