...
public class b extends a<com.apm.insight.e.a.a> {
    ...
    public ContentValues a(com.apm.insight.e.a.a aVar) {
        ...
        contentValues.put(MBridgeConstans.DYNAMIC_VIEW_WX_PATH, aVar.a);
        contentValues.put("insert_time", Long.valueOf(aVar.f3071b));
    ...
    public void a(SQLiteDatabase sQLiteDatabase, com.apm.insight.e.a.a aVar) {
        ...
        try {
            sQLiteDatabase.execSQL("delete from " + this.f3072b + " where _id in (select _id from " + this.f3072b + " order by insert_time desc limit 1000 offset 500)");
        } catch (Exception e2) {
            p.b((Throwable) e2);
        }
    }
    ...
    */
    public boolean a(android.database.sqlite.SQLiteDatabase r11, java.lang.String r12) {
        ...
        La:
            r1 = 1
            java.lang.String r3 = r10.f3072b     // Catch: java.lang.Throwable -> L26
            r4 = 0
