...
public final class u {
    ...
    public static class a {
        ...
        public JSONObject a() {
            ...
            try {
                ...
                jSONObject.put(TtmlNode.END, this.f3246b);
    ...
    */
    ...
    @NonNull
    public static String a(@NonNull Throwable th2, Thread thread, PrintStream printStream, e.a aVar) {
    ...
    public static JSONArray a(StackTraceElement[] stackTraceElementArr, String[] strArr) {
        ...
        if (aVar.a != -1) {
            aVar.f3246b = stackTraceElementArr.length;
            jSONArray.put(aVar.a());
        }
        return jSONArray;
    }
    ...
    private static void a(Throwable th2, int i10, String str, String str2) {
        ...
        for (Throwable th3 : th2.getSuppressed()) {
            a(th3, i10, "Suppressed: ", eb.j.k(str2, "\t"));
        }
        Throwable cause = th2.getCause();
        if (cause != null) {
    ...
    private static void a(Throwable th2, PrintWriter printWriter) {
        ...
        for (Throwable th3 : th2.getSuppressed()) {
            a(th3, printWriter, stackTrace, "Suppressed: ", "\t", (Set<Throwable>) newSetFromMap, 128);
        }
        Throwable cause = th2.getCause();
        if (cause != null) {
    ...
    private static void a(Throwable th2, PrintWriter printWriter, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i10) {
        ...
        for (Throwable th3 : th2.getSuppressed()) {
            int i13 = i10 / 2;
            a(th3, printWriter, stackTrace, "Suppressed: ", eb.j.k(str2, "\t"), set, i13 > 10 ? i13 : 10);
        }
        Throwable cause = th2.getCause();
        if (cause != null) {
            int i14 = i10 / 2;
    ...
    private static void a(Throwable th2, List<StackTraceElement> list) {
        ...
        for (Throwable th3 : th2.getSuppressed()) {
            a(th3, list, stackTrace, "Suppressed: ", "\t", (Set<Throwable>) newSetFromMap, 128);
        }
        Throwable cause = th2.getCause();
        if (cause != null) {
    ...
    private static void a(Throwable th2, List<StackTraceElement> list, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i10) {
        ...
        for (Throwable th3 : th2.getSuppressed()) {
            int i13 = i10 / 2;
            a(th3, list, stackTrace, "Suppressed: ", eb.j.k(str2, "\t"), set, i13 > 10 ? i13 : 10);
        }
        Throwable cause = th2.getCause();
        if (cause != null) {
            int i14 = i10 / 2;
