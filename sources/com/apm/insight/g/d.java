...
public class d implements c {
    ...
    public void a(final long j7, final Thread thread, final Throwable th, final String str, File file, final String str2, final boolean z8) {
        final File file2 = new File(o.a(this.f5797a), str);
        a.a().a(file2.getName());
        file2.mkdirs();
        i.f(file2);
        final boolean c9 = v.c(th);
        com.apm.insight.entity.a a6 = f.a().a(CrashType.JAVA, null, new c.a() { // from class: com.apm.insight.g.d.1
            ...
            public com.apm.insight.entity.a a(int i9, com.apm.insight.entity.a aVar) {
                String str3;
                String valueOf;
                this.f5798a = SystemClock.uptimeMillis();
                if (i9 == 0) {
                    ...
                    if (c9) {
                        com.apm.insight.l.a.a(d.this.f5797a, aVar.h());
                    }
                    JSONArray c10 = g.b().c();
