...
public class d implements c {
    ...
    public void a(final long j3, final Thread thread, final Throwable th2, final String str, File file, final String str2, final boolean z10) {
        final File file2 = new File(n.a(this.a), str);
        a.a().a(file2.getName());
        file2.mkdirs();
        h.f(file2);
        final boolean c10 = u.c(th2);
        com.apm.insight.entity.a a = f.a().a(CrashType.JAVA, null, new c.a() { // from class: com.apm.insight.g.d.1
            long a = 0;
