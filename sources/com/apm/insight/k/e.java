...
public class e {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x006a, code lost:
        ...
        if (r9.endsWith("?") == false) goto L34;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x0079, code lost:
    
        r9 = eb.j.k(r9, "tt_data=a");
    ...
    */
    public static com.apm.insight.k.l a(long r7, java.lang.String r9, byte[] r10, com.apm.insight.k.e.a r11, java.lang.String r12, boolean r13) {
        ...
        L79:
            ...
            java.lang.String r9 = eb.j.k(r9, r8)
    ...
    public static l a(String str, String str2, boolean z10) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(CacheDataSource.DEFAULT_MAX_CACHE_FILE_SIZE, str, str2.getBytes(), a.GZIP, "application/json; charset=utf-8", z10);
            }
            return new l(201);
        } catch (Throwable th2) {
            p.b(th2);
