...
public class c extends a {
    ...
    @NonNull
    public static c a(@NonNull StackTraceElement stackTraceElement, @NonNull String str, @Nullable String str2, @NonNull String str3, boolean z8, String str4, String str5) {
        c cVar = new c(str5);
        ...
        cVar.a("is_core", Integer.valueOf(z8 ? 1 : 0));
