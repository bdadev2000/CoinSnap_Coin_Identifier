...
public final class b {
    ...
    private static ConcurrentHashMap<Integer, h> f3079b = new ConcurrentHashMap<>();
    ...
    public static JSONArray a(Throwable th2, Thread thread, @Nullable File file) {
        ...
        while (true) {
            ...
            if (com.apm.insight.runtime.a.a(next.b())) {
                JSONArray a10 = next.a(b3, th2, thread != null ? thread.getName() : null);
                if (!k.a(a10)) {
