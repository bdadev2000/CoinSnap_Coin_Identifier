...
public class a {
    ...
    public a a(long j3) {
        try {
            a("app_start_time", Long.valueOf(j3));
            a("app_start_time_readable", (Object) new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss", Locale.getDefault()).format(new Date(j3)));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return this;
    ...
    public static a a(long j3, Context context, String str) {
        a aVar = new a();
    ...
    public static a a(long j3, Context context, @Nullable Thread thread, @NonNull Throwable th2) {
        if (j3 == 0) {
            j3 = System.currentTimeMillis();
        }
        a aVar = new a();
        aVar.a("isJava", (Object) 1);
        aVar.a(DataSchemeDataSource.SCHEME_DATA, (Object) u.a(th2));
        aVar.a("crash_time", Long.valueOf(j3));
        aVar.a("process_name", (Object) com.apm.insight.l.a.c(context));
    ...
    public boolean a() {
        return h().opt(DataSchemeDataSource.SCHEME_DATA) instanceof JSONArray ? !k.a(((JSONArray) r0).optJSONObject(0), "logcat") : !k.a(this.a, "logcat");
    }
