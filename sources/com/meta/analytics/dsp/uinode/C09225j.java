...
public final class C09225j implements NativeAdScrollViewApi {
    ...
    public C09225j(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i9, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i9 > 0) {
                this.A06 = C09155c.A03(context);
    ...
    public final void setInset(int i9) {
        if (i9 > 0) {
            float f9 = LD.A02;
            float density = i9;
