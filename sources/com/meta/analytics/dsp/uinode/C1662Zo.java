...
public class C1662Zo extends AbstractC09024o implements AnonymousClass50 {
    ...
    public static String A0T(int i9, int i10, int i11) {
    ...
    public C1662Zo(Context context) {
        this(context, 1, false);
    }

    public C1662Zo(Context context, int i9, boolean z8) {
        this.A0A = false;
        this.A05 = false;
        this.A0C = false;
        this.A0B = true;
    ...
    private final int A04(int i9, C09094w c09094w, AnonymousClass53 anonymousClass53) {
        if (A0W() == 0 || i9 == 0) {
            return 0;
        }
        this.A07.A0B = true;
        A29();
        int absDy = i9 > 0 ? 1 : -1;
        int consumed = Math.abs(i9);
        A0Y(absDy, consumed, true, anonymousClass53);
        int i10 = this.A07.A07;
        int layoutDirection = A08(c09094w, this.A07, anonymousClass53, false);
        int i11 = i10 + layoutDirection;
        if (i11 < 0) {
            return 0;
        }
        int absDy2 = consumed > i11 ? absDy * i11 : i9;
    ...
    private int A05(int i9, C09094w c09094w, AnonymousClass53 anonymousClass53, boolean z8) {
        int gap = this.A04.A07() - i9;
        if (gap > 0) {
            int i10 = -A04(-gap, c09094w, anonymousClass53);
            int i11 = i9 + i10;
            if (z8) {
    ...
    private int A06(int i9, C09094w c09094w, AnonymousClass53 anonymousClass53, boolean z8) {
        int A0A;
        int gap = i9 - this.A04.A0A();
        if (gap > 0) {
            int i10 = -A04(gap, c09094w, anonymousClass53);
            int i11 = i9 + i10;
            if (z8 && (A0A = i11 - this.A04.A0A()) > 0) {
                this.A04.A0J(-A0A);
                return i10 - A0A;
            }
            return i10;
    ...
    */
    private final int A08(com.meta.analytics.dsp.uinode.C09094w r10, com.meta.analytics.dsp.uinode.C4T r11, com.meta.analytics.dsp.uinode.AnonymousClass53 r12, boolean r13) {
        /*
            r9 = this;
            int r6 = r11.A00
            int r0 = r11.A07
        ...
        L5b:
            ...
            int r8 = r11.A07
            int r7 = r11.A00
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C1662Zo.A0G
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 7
            if (r1 == r0) goto La1
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1662Zo.A0G
        ...
        La1:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1662Zo.A08(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.4T, com.facebook.ads.redexgen.X.53, boolean):int");
    }
    ...
    private final View A0H(int i9, int i10) {
        int next;
        ...
        int preferredBoundsFlag2 = this.A04.A0F(A0t(i9));
        ...
        int next4 = this.A00;
        if (next4 == 0) {
            return super.A04.A00(i9, i10, acceptableBoundsFlag, preferredBoundsFlag);
        }
        return super.A05.A00(i9, i10, acceptableBoundsFlag, preferredBoundsFlag);
    }

    private final View A0J(int i9, int i10, boolean z8, boolean z9) {
        int i11;
        A29();
        int i12 = 0;
        if (z8) {
        ...
        if (i13 == 0) {
            return super.A04.A00(i9, i10, i11, i12);
        }
        return super.A05.A00(i9, i10, i11, i12);
    }

    private View A0K(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return A28(c09094w, anonymousClass53, 0, A0W(), anonymousClass53.A03());
    }

    private View A0L(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return A28(c09094w, anonymousClass53, A0W() - 1, -1, anonymousClass53.A03());
    }

    private View A0M(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0D() : A0E();
    }

    private View A0N(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0E() : A0D();
    }

    private View A0O(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0K(c09094w, anonymousClass53) : A0L(c09094w, anonymousClass53);
    }

    private View A0P(C09094w c09094w, AnonymousClass53 anonymousClass53) {
        return this.A05 ? A0L(c09094w, anonymousClass53) : A0K(c09094w, anonymousClass53);
    }

    private View A0Q(boolean z8, boolean z9) {
        if (this.A05) {
            return A0J(0, A0W(), z8, z9);
        }
        return A0J(A0W() - 1, -1, z8, z9);
    }
    ...
    private void A0W(int i9, int i10) {
    ...
    private void A0X(int i9, int i10) {
    ...
    private void A0Y(int i9, int i10, boolean z8, AnonymousClass53 anonymousClass53) {
        int A0A;
        this.A07.A09 = A0i();
    ...
    private void A0b(C09094w c09094w, int i9) {
        int A0W = A0W();
        if (i9 < 0) {
            return;
        }
        int A06 = this.A04.A06() - i9;
        if (this.A05) {
        ...
        for (int i11 = A0W - 1; i11 >= 0; i11--) {
            ...
            A0d(c09094w, childCount5, i11);
            return;
        }
    }

    private void A0c(C09094w c09094w, int i9) {
        if (i9 < 0) {
            return;
        }
        String[] strArr = A0G;
    ...
    private void A0d(C09094w c09094w, int i9, int i10) {
        if (i9 == i10) {
            return;
        }
        if (i10 > i9) {
    ...
    private void A0e(C09094w c09094w, C4T c4t) {
        if (!c4t.A0B || c4t.A09) {
            return;
        }
        int i9 = c4t.A05;
    ...
    private void A0f(C09094w c09094w, AnonymousClass53 anonymousClass53, int scrapExtraEnd, int scrapExtraEnd2) {
        if (!anonymousClass53.A08() || A0W() == 0 || anonymousClass53.A07() || !A22()) {
            return;
        }
        int i9 = 0;
        int scrapExtraStart = 0;
        List<AnonymousClass56> A0J = c09094w.A0J();
        int i10 = A0J.size();
        int A0p = A0p(A0t(0));
        for (int scrapSize = 0; scrapSize < i10; scrapSize++) {
            ...
            if (!anonymousClass56.A0a()) {
                ...
                if (direction == -1) {
                    i9 += this.A04.A0D(anonymousClass56.A0H);
                } else {
        ...
        if (i9 > 0) {
            ...
            this.A07.A00 = 0;
            this.A07.A04();
            A08(c09094w, this.A07, anonymousClass53, false);
        }
    ...
    private void A0g(C09094w c09094w, AnonymousClass53 anonymousClass53, C4R c4r) {
        if (A0k(anonymousClass53, c4r)) {
            return;
        }
        boolean A0j = A0j(c09094w, anonymousClass53, c4r);
        String[] strArr = A0G;
        if (strArr[2].charAt(4) == strArr[4].charAt(4)) {
            throw new RuntimeException();
        }
    ...
    private boolean A0j(C09094w c09094w, AnonymousClass53 anonymousClass53, C4R c4r) {
        View A0P;
        int A0A;
        if (A0W() == 0) {
            return false;
        ...
        if (c4r.A02) {
            A0P = A0O(c09094w, anonymousClass53);
        } else {
            A0P = A0P(c09094w, anonymousClass53);
        }
        if (A0P == null) {
            return false;
        }
    ...
    private boolean A0k(AnonymousClass53 anonymousClass53, C4R c4r) {
        int i9;
        int startGap;
        if (anonymousClass53.A07() || (i9 = this.A01) == -1) {
            return false;
        }
        if (i9 < 0 || i9 >= anonymousClass53.A03()) {
            this.A01 = -1;
            this.A02 = Integer.MIN_VALUE;
            return false;
        }
    ...
    public int A1d(int i9, C09094w c09094w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 1) {
            return 0;
        }
        return A04(i9, c09094w, anonymousClass53);
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public int A1e(int i9, C09094w c09094w, AnonymousClass53 anonymousClass53) {
        if (this.A00 == 0) {
            return 0;
        }
        int A04 = A04(i9, c09094w, anonymousClass53);
        String[] strArr = A0G;
        if (strArr[6].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public final View A1m(int i9) {
        int firstChild = A0W();
        if (firstChild == 0) {
            return null;
        }
        int childCount = i9 - A0p(A0t(0));
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public View A1n(View view, int i9, C09094w c09094w, AnonymousClass53 anonymousClass53) {
        int A27;
        View A0M;
        View nextCandidate;
        A0U();
        if (A0W() == 0 || (A27 = A27(i9)) == Integer.MIN_VALUE) {
            return null;
        }
        A29();
        A29();
        ...
        this.A07.A07 = Integer.MIN_VALUE;
        this.A07.A0B = false;
        A08(c09094w, this.A07, anonymousClass53, true);
        if (A27 == -1) {
            A0M = A0N(c09094w, anonymousClass53);
        } else {
            A0M = A0M(c09094w, anonymousClass53);
        }
        if (A27 == -1) {
            nextCandidate = A0G();
        } else {
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public C09034p A1o() {
        return new C09034p(-2, -2);
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public void A1p(int i9) {
        this.A01 = i9;
        this.A02 = Integer.MIN_VALUE;
        LinearLayoutManager$SavedState linearLayoutManager$SavedState = this.A03;
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public final void A1q(int i9, int i10, AnonymousClass53 anonymousClass53, InterfaceC09004m interfaceC09004m) {
        if (this.A00 != 0) {
            i9 = i10;
        }
        int delta = A0W();
        ...
        A29();
        int i11 = i9 > 0 ? 1 : -1;
        int delta2 = Math.abs(i9);
        A0Y(i11, delta2, true, anonymousClass53);
        A2E(anonymousClass53, this.A07, interfaceC09004m);
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public final void A1r(int i9, InterfaceC09004m interfaceC09004m) {
        boolean z8;
        int direction;
        LinearLayoutManager$SavedState linearLayoutManager$SavedState = this.A03;
        if (linearLayoutManager$SavedState != null && linearLayoutManager$SavedState.A01()) {
        ...
        int i11 = z8 ? -1 : 1;
        for (int i12 = 0; i12 < this.A06 && direction >= 0 && direction < i9; i12++) {
            interfaceC09004m.A3S(direction, 0);
            direction += i11;
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00b8, code lost:
        ...
        r2 = com.meta.analytics.dsp.uinode.C1662Zo.A0G;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00d8, code lost:
        ...
        com.meta.analytics.dsp.uinode.C1662Zo.A0G[5] = "r3FnQil1r32czyLALUutLd0XCkxYZ4G";
        r3 = r3 - r9.A02;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1u(com.meta.analytics.dsp.uinode.C09094w r10, com.meta.analytics.dsp.uinode.AnonymousClass53 r11) {
        /*
            Method dump skipped, instructions count: 621
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1662Zo.A1u(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.53):void");
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public final void A1w(C1119Eb c1119Eb, C09094w c09094w) {
        super.A1w(c1119Eb, c09094w);
        if (this.A09) {
            A1I(c09094w);
            c09094w.A0P();
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC09024o
    public void A1x(C1119Eb c1119Eb, AnonymousClass53 anonymousClass53, int i9) {
        C1661Zn linearSmoothScroller = new C1661Zn(c1119Eb.getContext());
        linearSmoothScroller.A0A(i9);
    ...
    */
    public final int A27(int r8) {
        ...
        L75:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1662Zo.A27(int):int");
    }

    public View A28(C09094w c09094w, AnonymousClass53 anonymousClass53, int i9, int i10, int i11) {
        A29();
        View view = null;
        View view2 = null;
        int A0A = this.A04.A0A();
        int boundsEnd = this.A04.A07();
        int boundsStart = i10 > i9 ? 1 : -1;
        while (i9 != i10) {
            View outOfBoundsMatch = A0t(i9);
            int A0p = A0p(outOfBoundsMatch);
            if (A0p >= 0 && A0p < i11) {
                if (((C09034p) outOfBoundsMatch.getLayoutParams()).A02()) {
                    if (view == null) {
    ...
    public final void A2A(int i9) {
        if (i9 != 0 && i9 != 1) {
            throw new IllegalArgumentException(A0T(0, 20, 1) + i9);
        }
        if (A0G[1].charAt(30) != 'o') {
            throw new RuntimeException();
        }
    ...
    public final void A2B(int i9, int i10) {
        this.A01 = i9;
        this.A02 = i10;
        LinearLayoutManager$SavedState linearLayoutManager$SavedState = this.A03;
        if (linearLayoutManager$SavedState != null) {
    ...
    public void A2C(C09094w c09094w, AnonymousClass53 anonymousClass53, C4R c4r, int i9) {
    }

    public void A2D(C09094w c09094w, AnonymousClass53 anonymousClass53, C4T c4t, C4S c4s) {
        int A0g;
        int right;
        int i9;
        int i10;
        View A03 = c4t.A03(c09094w);
        if (A03 == null) {
            c4s.A01 = true;
            return;
        }
        C09034p c09034p = (C09034p) A03.getLayoutParams();
        if (c4t.A08 == null) {
        ...
        if (this.A00 == 1) {
            if (A2F()) {
                i10 = A0h() - A0f();
                i9 = i10 - this.A04.A0E(A03);
            } else {
                i9 = A0e();
                i10 = this.A04.A0E(A03) + i9;
            }
            if (c4t.A05 == -1) {
                right = c4t.A06;
                A0g = c4t.A06 - c4s.A00;
        ...
        A1B(A03, i9, A0g, i10, right);
        if (c09034p.A02() || c09034p.A01()) {
            c4s.A03 = true;
        }
        c4s.A02 = A03.hasFocusable();
    }

    public void A2E(AnonymousClass53 anonymousClass53, C4T c4t, InterfaceC09004m interfaceC09004m) {
        int i9 = c4t.A01;
        if (i9 >= 0) {
            int pos = anonymousClass53.A03();
            if (i9 < pos) {
                int pos2 = c4t.A07;
                interfaceC09004m.A3S(i9, Math.max(0, pos2));
            }
        }
    }
    ...
    public final PointF A4O(int i9) {
        if (A0W() == 0) {
            return null;
        }
        int i10 = (i9 < A0p(A0t(0))) != this.A05 ? -1 : 1;
        int i11 = this.A00;
