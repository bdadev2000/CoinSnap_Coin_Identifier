...
public final class C8J {
    ...
    public static void A0A(C09647f c09647f) {
        try {
            c09647f = AbstractC1286Kx.A00(c09647f, null, new IntentFilter(A01(24, 37, 122)));
            if (c09647f == 0) {
                return;
            }
            int intExtra = c09647f.getIntExtra(A01(109, 5, 89), -1);
            int scale = c09647f.getIntExtra(A01(123, 5, 3), -1);
            int level = c09647f.getIntExtra(A01(134, 6, 71), -1);
            ...
            A05.put(A01(77, 7, 113), String.valueOf(f9));
            A05.put(A01(84, 8, 75), z8 ? A01(1, 1, 117) : A01(0, 1, 33));
        } catch (IllegalArgumentException e4) {
            c09647f.A07().A9a(A01(102, 7, 57), C8A.A1T, new C8B(e4));
        }
    }

    public static synchronized void A0B(C09647f c09647f) {
        synchronized (C8J.class) {
            A09(c09647f);
            A0A(c09647f);
            if (A04 == null) {
                SensorManager sensorManager = (SensorManager) c09647f.getSystemService(A01(128, 6, 67));
                A04 = sensorManager;
                if (sensorManager == null) {
                    return;
                }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr != null) {
            ...
            for (int i9 = 0; i9 < min; i9++) {
                map.put(A01(2, 14, 65) + A08[i9], String.valueOf(fArr[i9]));
            }
        }
        if (fArr2 != null) {
            int min2 = Math.min(A08.length, fArr2.length);
            for (int i10 = 0; i10 < min2; i10++) {
                map.put(A01(114, 9, 4) + A08[i10], String.valueOf(fArr2[i10]));
            }
        }
    }
}
