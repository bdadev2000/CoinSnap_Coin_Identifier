...
public final class C1790bu {
    ...
    public static String A01(String str) {
        ...
        String name = C1790bu.class.getName();
        int i9 = 0;
    ...
    public static <T extends Throwable> T A02(T t9) {
        return (T) A03(t9, C1790bu.class.getName());
    }

    public static <T extends Throwable> T A03(T throwable, String str) {
        StackTraceElement[] stackTrace = throwable.getStackTrace();
        int i9 = stackTrace.length;
        int lastIntrinsic = -1;
        for (int size = 0; size < i9; size++) {
            if (str.equals(stackTrace[size].getClassName())) {
                lastIntrinsic = size;
            }
        }
        StackTraceElement[] stackTrace2 = (StackTraceElement[]) Arrays.copyOfRange(stackTrace, lastIntrinsic + 1, i9);
