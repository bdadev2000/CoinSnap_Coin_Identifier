...
public class C09135a implements AdComponentViewApi {
    ...
    public final void addView(View view, int i9) {
        if (!this.A03) {
            ...
            adComponentViewParentApi.addView(view, i9);
        }
    }
    ...
    public final void addView(View view, int i9, int i10) {
        if (!this.A03) {
            this.A02.addView(view, i9, i10);
        }
    }

    @Override // com.facebook.ads.internal.api.AdComponentView
    public final void addView(View view, int i9, ViewGroup.LayoutParams layoutParams) {
        this.A02.addView(view, i9, layoutParams);
    }
    ...
    public void onMeasure(int i9, int i10) {
        this.A02.onMeasure(i9, i10);
    }

    @Override // com.facebook.ads.internal.api.AdComponentViewParentApi
    public void onVisibilityChanged(View view, int i9) {
        this.A02.onVisibilityChanged(view, i9);
    }

    @Override // com.facebook.ads.internal.api.AdComponentView
    public void onWindowFocusChanged(boolean z8) {
        this.A02.onWindowFocusChanged(z8);
    }
    ...
    public final void setMeasuredDimension(int i9, int i10) {
        this.A02.setMeasuredDimension(i9, i10);
    }
}
