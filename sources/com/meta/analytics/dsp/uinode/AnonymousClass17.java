...
public abstract class AnonymousClass17 {
     ...
     */
    public static AnonymousClass14 A01(C1636Yn c1636Yn, JSONObject jSONObject, String str, boolean z8, int i9, int i10) {
        if (jSONObject == null) {
            return new AnonymousClass14();
        }
        L4.A02(c1636Yn, A02(0, 23, 77));
        ...
        Uri A002 = TextUtils.isEmpty(A02) ? null : AbstractC1287Ky.A00(A02);
        ...
        FT A0215 = FT.A02(jSONObject, c1636Yn);
        ...
        EnumC07950j A007 = AbstractC07970l.A00(jSONObject);
        Collection<String> A03 = AbstractC07970l.A03(c1636Yn, jSONObject);
        ...
        try {
            ...
            if (optJSONArray != null && optJSONArray.length() > 0) {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    try {
                        arrayList2.add(A01(c1636Yn, optJSONArray.getJSONObject(i11), str, true, i11, length));
                        ...
                        c1636Yn.A07().A9a(A02(311, 7, 91), C8A.A2A, new C8B(e));
                        Log.e(C1754bK.A0E, A02(23, 30, 50), e);
                        return new AnonymousClass14(A0217, A012, A022, A023, A024, A025, A026, A027, A028, A029, A0210, A0211, A0212, A0213, A0214, A006, A0215, A003, A004, A005, A0218, A0219, optLong, ju, z8, i9, i10, arrayList, str, optString, optInt, optString2, A002, A0216, optBoolean, optBoolean2, optInt3, optInt2, optInt4, optInt5, A007, A03, optInt6, optBoolean3);
                    }
                }
                arrayList = arrayList2;
            }
    ...
    public static AnonymousClass14 A00(C1636Yn c1636Yn, JSONObject jSONObject, String str) {
        return A01(c1636Yn, jSONObject, str, false, -1, 0);
    }
}
