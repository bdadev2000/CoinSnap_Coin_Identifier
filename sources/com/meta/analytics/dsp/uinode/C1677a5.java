...
public final class C1677a5<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC08612y<K, V> A00;
    ...
    private AbstractC08612y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1678a6(this);
        }
        return this.A00;
    }
