...
public final class C3B {
    ...
    private void A01(int i9, ViewParent viewParent) {
        switch (i9) {
            case 0:
                this.A01 = viewParent;
                return;
    ...
    public final void A03(int i9) {
        ViewParent A00 = A00(i9);
        if (A00 != null) {
            AbstractC08723j.A02(A00, this.A04, i9);
            A01(i9, null);
        }
    }
    ...
    public final boolean A07(float f9, float f10) {
        ViewParent A00;
        if (!A06() || (A00 = A00(0)) == null) {
            return false;
        }
        return AbstractC08723j.A06(A00, this.A04, f9, f10);
    }

    public final boolean A08(float f9, float f10, boolean z8) {
        ViewParent A00;
        if (!A06() || (A00 = A00(0)) == null) {
            return false;
        }
        return AbstractC08723j.A07(A00, this.A04, f9, f10, z8);
    }
    ...
    public final boolean A0A(int i9) {
        return A0B(i9, 0);
    }
    ...
    public final boolean A0B(int i9, int i10) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (AbstractC08723j.A08(parent, view, this.A04, i9, i10)) {
                    A01(i10, parent);
                    AbstractC08723j.A05(parent, view, this.A04, i9, i10);
                    return true;
                }
    ...
    public final boolean A0C(int i9, int i10, int i11, int i12, int[] iArr) {
        return A0D(i9, i10, i11, i12, iArr, 0);
    }

    public final boolean A0D(int i9, int i10, int i11, int i12, int[] iArr, int startX) {
        ViewParent A00;
        ...
        if (i9 != 0 || i10 != 0 || i11 != 0 || i12 != 0) {
            ...
            AbstractC08723j.A03(A00, this.A04, i9, i10, i11, i12, startX);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i13;
                iArr[1] = iArr[1] - i14;
    ...
    public final boolean A0E(int i9, int i10, int[] iArr, int[] iArr2) {
        return A0F(i9, i10, iArr, iArr2, 0);
    }
    ...
    */
    public final boolean A0F(int r17, int r18, int[] r19, int[] r20, int r21) {
        ...
        L67:
            ...
            com.meta.analytics.dsp.uinode.AbstractC08723j.A04(r10, r11, r12, r13, r14, r15)
            if (r4 == 0) goto L81
            android.view.View r0 = r3.A04
            r0.getLocationInWindow(r4)
            r0 = r4[r9]
