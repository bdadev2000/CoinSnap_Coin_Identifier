...
public abstract class AbstractC09546u<E> extends H0<E> implements List<E> {
    ...
    public static final C1796c1 A02;
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C1790bu.A0A(it.next(), element)) {
                return i9;
            }
            i9++;
        }
    ...
    public int lastIndexOf(E element) {
        AbstractC09546u<E> abstractC09546u = this;
        ListIterator<E> listIterator = abstractC09546u.listIterator(abstractC09546u.size());
        while (listIterator.hasPrevious()) {
            if (C1790bu.A0A(listIterator.previous(), element)) {
    ...
    public Iterator<E> iterator() {
        return new C1190Gx(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C09556v(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C09556v(this, index);
    }
