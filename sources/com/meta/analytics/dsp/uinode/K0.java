...
public abstract class K0 {
    ...
    public static long A00(String str, EnumC1246Jg enumC1246Jg) {
        if (A01.containsKey(str)) {
            return A01.get(str).longValue();
        }
        switch (C1265Jz.A00[enumC1246Jg.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public static String A02(K1 k12) {
        AbstractC1255Jp.A05(A01(44, 15, 94), A01(22, 22, 87), A01(14, 8, 116));
    ...
    public static void A05(long j7, K1 k12) {
        A01.put(A03(k12), Long.valueOf(j7));
    }
    ...
    public static boolean A08(K1 k12) {
        ...
        A05[6] = "HNdF4hlEpt9Mz";
        return System.currentTimeMillis() - l.longValue() < A00(A032, k12.A06());
    }
}
