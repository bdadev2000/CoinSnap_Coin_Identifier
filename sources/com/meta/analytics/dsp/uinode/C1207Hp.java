...
public final class C1207Hp {
    ...
    public C1207Hp(int i9) {
        this.A01 = new long[i9];
    }
    ...
    public final long A03(int i9) {
        if (i9 >= 0 && i9 < this.A00) {
            return this.A01[i9];
        }
        throw new IndexOutOfBoundsException(A00(10, 14, 44) + i9 + A00(0, 10, 25) + this.A00);
    }

    public final void A04(long j7) {
        int i9 = this.A00;
        long[] jArr = this.A01;
        if (i9 == jArr.length) {
            int i10 = i9 * 2;
            ...
            strArr2[6] = "C4hqpLWZ";
            strArr2[2] = "upiEXy76";
            this.A01 = Arrays.copyOf(jArr, i10);
        }
        long[] jArr2 = this.A01;
        int i11 = this.A00;
        this.A00 = i11 + 1;
