...
public final class JZ {
    ...
    public JZ(C09647f c09647f, JX jx) {
        int nativeViewabilityHistorySamplingRate = Ij.A0D(c09647f);
        if (nativeViewabilityHistorySamplingRate < 1) {
            this.A0F = false;
        } else {
            this.A0F = c09647f.A08().A00() < 1.0d / ((double) nativeViewabilityHistorySamplingRate);
        }
        this.A0B = jx;
    }
    ...
    public final void A0C(C09647f c09647f, String str) {
        if (!this.A0F) {
            return;
        }
        A03(new JY(A01(), 103, A00(), null));
        ExecutorC1308Lt.A06.execute(new JW(this, str, c09647f));
    }
}
