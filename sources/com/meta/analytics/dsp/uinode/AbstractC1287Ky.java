...
public abstract class AbstractC1287Ky {
    ...
    public static String A05(int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < copyOfRange.length; i12++) {
            byte b = (byte) ((copyOfRange[i12] - i11) - 114);
            if (A01[3].length() == 19) {
    ...
    public static void A0B(String str, URI uri, Uri uri2) {
        ...
        if (!A0E2) {
            A05 = A05 + String.format(Locale.US, A05(PsExtractor.AUDIO_STREAM, 56, 58), uri.getSchemeSpecificPart(), uri2.getSchemeSpecificPart());
        }
        throw new SecurityException(String.format(Locale.US, A05(63, 77, 84), uri.toString(), uri2.toString(), A05, str));
    }

    public static void A0C(String str, URI uri, Uri uri2, boolean z8) {
        boolean A0E = A0E(uri.getScheme(), uri2.getScheme());
