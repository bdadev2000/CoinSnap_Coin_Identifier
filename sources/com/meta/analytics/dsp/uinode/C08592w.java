...
public final class C08592w<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public int A00;
    public final /* synthetic */ AbstractC08612y A03;
    ...
    public C08592w(AbstractC08612y abstractC08612y) {
        this.A03 = abstractC08612y;
        this.A00 = abstractC08612y.A04() - 1;
    }
    ...
    public final boolean equals(Object obj) {
        if (this.A02) {
            ...
            return AbstractC08542r.A04(entry.getKey(), this.A03.A0B(this.A01, 0)) && AbstractC08542r.A04(entry.getValue(), this.A03.A0B(this.A01, 1));
        }
    ...
    public final V setValue(V v6) {
        if (this.A02) {
            return (V) this.A03.A0C(this.A01, v6);
        }
        throw new IllegalStateException(A01(1, 59, 24));
    }
