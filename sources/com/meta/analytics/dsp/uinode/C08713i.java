...
public class C08713i {
    ...
    public void A04(ViewParent viewParent, View view, int i9, int i10, int i11, int i12) {
        if (0 != 0) {
            throw new NullPointerException(A00(46, 14, 56));
        }
    }

    public void A05(ViewParent viewParent, View view, int i9, int i10, int[] iArr) {
        if (0 != 0) {
            throw new NullPointerException(A00(29, 17, 108));
        }
    }

    public void A06(ViewParent viewParent, View view, View view2, int i9) {
        if (0 != 0) {
    ...
    public boolean A08(ViewParent viewParent, View view, float f9, float f10, boolean z8) {
        if (0 != 0) {
    ...
    public boolean A09(ViewParent viewParent, View view, View view2, int i9) {
        if (0 != 0) {
