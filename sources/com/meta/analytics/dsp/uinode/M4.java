...
public final class M4 implements SensorEventListener {
    ...
    private void A01() {
        ...
        try {
            ...
            z8 = sensorManager3.registerListener(this, sensorManager3.getDefaultSensor(1), 3);
        } catch (Exception unused) {
            Toast.makeText(this.A08, A00(21, 21, 13), 1).show();
        }
        if (!z8 && (sensorManager = this.A07) != null) {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        long j7 = this.A06;
        if (now - j7 > 100) {
            float speed = (Math.abs(((((sensorEvent.values[0] + sensorEvent.values[1]) + sensorEvent.values[2]) - this.A00) - this.A01) - this.A02) / ((float) (now - j7))) * 10000.0f;
            if (speed > 800.0f) {
                int i9 = this.A03 + 1;
                this.A03 = i9;
                if (i9 >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
