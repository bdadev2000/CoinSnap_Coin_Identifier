...
public final class C1737b3 extends C1F implements Serializable {
    ...
    public int A02;
    public int A03;
    public final List<AbstractC1739b5> A0A;
    ...
    public C1737b3(List<AbstractC1739b5> list) {
        this.A0A = list;
    }

    public static C1737b3 A02(JSONObject jSONObject, C1636Yn c1636Yn) throws JSONException {
        return A03(jSONObject, c1636Yn, false);
    }

    public static C1737b3 A03(JSONObject jSONObject, C1636Yn c1636Yn, boolean z8) throws JSONException {
        JSONArray jSONArray = jSONObject.getJSONArray(A04(0, 3, 35));
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i9 = 0; i9 < jSONArray.length(); i9++) {
            if (z8) {
                arrayList.add(FU.A02(jSONArray.getJSONObject(i9), c1636Yn));
            } else {
                arrayList.add(FS.A02(jSONArray.getJSONObject(i9), c1636Yn));
            }
        }
        C1737b3 c1737b3 = new C1737b3(arrayList);
        JSONObject chainingParams = jSONObject.getJSONObject(A04(3, 12, 43));
        c1737b3.A04 = chainingParams.toString();
        c1737b3.A01 = chainingParams.optInt(A04(15, 17, 120), arrayList.size());
        c1737b3.A03 = chainingParams.optInt(A04(32, 24, 126), 0);
        c1737b3.A02 = chainingParams.optInt(A04(100, 24, 109), 0);
        c1737b3.A00 = chainingParams.optInt(A04(56, 19, 124), 2);
        c1737b3.A0d(chainingParams);
        c1737b3.A07 = chainingParams.optBoolean(A04(174, 16, 45), false);
        c1737b3.A06 = chainingParams.optBoolean(A04(146, 28, 8), false);
        c1737b3.A05 = chainingParams.optBoolean(A04(124, 22, 9), false);
        JSONArray optJSONArray = chainingParams.optJSONArray(A04(75, 25, 10));
        if (optJSONArray != null) {
            for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
                c1737b3.A09.add(Integer.valueOf(optJSONArray.optInt(i10, 0)));
            }
        }
        return c1737b3;
    }
    ...
    public final AbstractC1739b5 A0u() {
        if (!this.A0A.isEmpty()) {
            AbstractC1739b5 abstractC1739b5 = this.A0A.get(0);
            ...
            return abstractC1739b5;
        }
        return null;
    }

    public final AbstractC1739b5 A0v(int i9) {
        return this.A0A.get(i9);
    }
    ...
    public final String A0y() {
        AbstractC1739b5 firstAdDataBundle = A0u();
