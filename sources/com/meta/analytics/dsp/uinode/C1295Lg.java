...
public final class C1295Lg {
    ...
    static {
        A02();
        A0K = C1295Lg.class.getSimpleName();
    }
    ...
    public final Map<String, String> A04() {
        ...
        if (j9 > 0) {
            ...
            if (j10 > j9) {
                ...
                String radius5 = String.valueOf(j7);
        ...
        String radius52 = String.valueOf(j7);
    ...
    public final void A06(C1636Yn c1636Yn, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c1636Yn.A0E().AGu();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                float f9 = this.A00;
                float f10 = f9 - (f9 / this.A09);
                this.A00 = f10;
                float pressure = motionEvent.getPressure();
                int i9 = this.A09;
                this.A00 = f10 + (pressure / i9);
                float f11 = this.A02;
                float f12 = f11 - (f11 / i9);
                this.A02 = f12;
                float size = motionEvent.getSize();
                int i10 = this.A09;
                this.A02 = f12 + (size / i10);
                this.A09 = i10 + 1;
                return;
            default:
                return;
    ...
    public final boolean A09(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(108, 21, 116) + z8 + A01(2, 18, 43) + A06 + A01(0, 2, 119) + A03;
        }
        return z8;
    }
}
