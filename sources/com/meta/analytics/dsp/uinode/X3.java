...
public final class X3 implements InterfaceC1100Cy {
    ...
    private boolean A02(C1217Hz c1217Hz, int i9) {
        if (c1217Hz.A04() == 0) {
            return false;
        }
        if (c1217Hz.A0E() != i9) {
    ...
    public final void A4R(C1217Hz c1217Hz) {
        if (this.A03) {
            if (this.A00 == 2 && !A02(c1217Hz, 32)) {
                return;
            }
            if (this.A00 == 1 && !A02(c1217Hz, 0)) {
                return;
            }
            ...
            int bytesAvailable = c1217Hz.A04();
            for (C4 c42 : this.A05) {
                c1217Hz.A0Y(A062);
                c42.AFR(c1217Hz, bytesAvailable);
            }
    ...
    */
    public final void A4p(com.meta.analytics.dsp.uinode.InterfaceC1076Bu r15, com.meta.analytics.dsp.uinode.DC r16) {
        /*
            r14 = this;
            r2 = 0
        L1:
