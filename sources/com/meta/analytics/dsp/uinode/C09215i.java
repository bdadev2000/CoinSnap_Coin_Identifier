...
public final class C09215i implements NativeAdApi {
    ...
    public C09215i(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        V2.A0L(nativeAdBaseApi).A1Y(EnumC1246Jg.A05);
    }

    public C09215i(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1636Yn A11 = A00().A11();
            C1636Yn downloadContext = C09155c.A03(imageView.getContext());
