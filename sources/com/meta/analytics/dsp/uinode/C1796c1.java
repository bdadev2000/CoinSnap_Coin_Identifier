...
public final class C1796c1 {
    ...
    public /* synthetic */ C1796c1(AbstractC1791bv abstractC1791bv) {
        this();
    }
    ...
    */
    public final int A02(java.util.Collection<?> r7) {
        /*
            ...
            com.meta.analytics.dsp.uinode.C1790bu.A07(r7, r0)
            r3 = 1
            java.util.Iterator r5 = r7.iterator()
        L11:
            boolean r4 = r5.hasNext()
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1796c1.A01
            r0 = 3
            r1 = r2[r0]
            r0 = 2
            r0 = r2[r0]
        ...
        L67:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1796c1.A02(java.util.Collection):int");
    }

    public final void A03(int i9, int i10) {
        if (i9 >= 0 && i9 < i10) {
        } else {
            throw new IndexOutOfBoundsException(A00(43, 7, 51) + i9 + A00(12, 8, 29) + i10);
        }
    }

    public final void A04(int i9, int i10) {
        if (i9 >= 0 && i9 <= i10) {
        } else {
            throw new IndexOutOfBoundsException(A00(43, 7, 51) + i9 + A00(12, 8, 29) + i10);
        }
    ...
    public final void A05(int i9, int i10, int i11) {
        String A002 = A00(32, 11, 87);
        if (i9 >= 0 && i10 <= i11) {
            if (i9 <= i10) {
                return;
            } else {
                throw new IllegalArgumentException(A002 + i9 + A00(0, 12, 49) + i10);
            }
        }
        throw new IndexOutOfBoundsException(A002 + i9 + A00(20, 11, 22) + i10 + A00(12, 8, 29) + i11);
    }

    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C1790bu.A07(collection, A00(31, 1, 116));
        C1790bu.A07(collection2, A00(50, 5, 112));
        ...
        while (it2.hasNext()) {
            if (!C1790bu.A0A(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
