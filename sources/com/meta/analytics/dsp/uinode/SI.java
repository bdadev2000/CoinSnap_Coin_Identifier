...
public final class SI extends LinearLayout implements QB {
    ...
    public SI(C1636Yn c1636Yn, NativeBannerAd nativeBannerAd, JR jr, JS js, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1636Yn);
        ...
        Q8 q82 = new Q8(c1636Yn, nativeBannerAd, js, jr, adOptionsView);
        int i9 = A06;
        q82.setPadding(i9, 0, 0, 0);
        ...
        if (js != JS.A0A) {
            ...
            linearLayout.setPadding(0, 0, 0, i9);
        } else {
            int i10 = A07;
        ...
        int i11 = A07;
        textView.setPadding(i9, i11, i9, i11);
        jr.A05(textView);
