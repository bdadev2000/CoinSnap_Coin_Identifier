...
public final class AJ {
    ...
    private AK A00(AK ak, AH ah) {
        ...
        Object uid = ah2.A0A(i9, this.A04, true).A03;
    ...
    public final C1132Eo A07(int i9) {
        C1132Eo c1132Eo = null;
        AH ah = this.A00;
        if (ah != null) {
            int A00 = ah.A00();
            for (int periodIndex = 0; periodIndex < this.A05.size(); periodIndex++) {
                AK mediaPeriod = this.A05.get(periodIndex);
                C1132Eo match = mediaPeriod.A01;
                int i10 = match.A02;
                if (i10 < A00 && this.A00.A09(i10, this.A04).A00 == i9) {
                    if (c1132Eo != null) {
                        return null;
                    }
                    c1132Eo = mediaPeriod.A01;
                }
            }
        }
        return c1132Eo;
    ...
    public final void A0B(int i9, C1132Eo c1132Eo) {
        this.A05.add(new AK(i9, c1132Eo));
        if (this.A05.size() == 1 && !this.A00.A0E()) {
            A02();
        }
    }

    public final void A0C(int i9, C1132Eo c1132Eo) {
        AK mediaPeriod;
        AK ak = new AK(i9, c1132Eo);
        this.A05.remove(ak);
    ...
    public final void A0D(int i9, C1132Eo c1132Eo) {
        this.A02 = new AK(i9, c1132Eo);
    }
