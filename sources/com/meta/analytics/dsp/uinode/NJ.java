...
public final class NJ extends LinearLayout {
    ...
    public static String A06(int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < copyOfRange.length; i12++) {
            byte b = (byte) ((copyOfRange[i12] ^ i11) ^ 39);
            String[] strArr = A0F;
    ...
    private void A08() {
        int buttonSizePx;
        int i9 = (int) (this.A09 * 50.0f);
        AbstractC1303Lo.A0M(this, -1);
        setGravity(16);
        ...
        if (C1225Ih.A2N(this.A0B) && !this.A0D) {
            LinearLayout linearLayout = new LinearLayout(this.A0B);
            this.A04 = linearLayout;
            linearLayout.setOrientation(1);
            LinearLayout linearLayout2 = this.A04;
            float f9 = this.A09;
            int buttonSizePx2 = (int) (f9 * 2.0f);
            linearLayout2.setPadding(0, (int) (f9 * 2.0f), 0, buttonSizePx2);
            layoutParams2.setMarginStart(0);
            addView(this.A04, layoutParams2);
            ImageView imageView4 = new ImageView(this.A0B);
            imageView4.setScaleType(ImageView.ScaleType.CENTER);
            imageView4.setImageBitmap(AbstractC1312Lx.A01(EnumC1311Lw.HANDLER));
            float f10 = this.A09;
        ...
        if (this.A08 && !C1225Ih.A2N(this.A0B)) {
            ...
            ViewGroup.LayoutParams titleViewsParams2 = new LinearLayout.LayoutParams(i9, i9);
            this.A02.setScaleType(ImageView.ScaleType.CENTER);
            this.A02.setImageBitmap(AbstractC1312Lx.A02(EnumC1311Lw.BACK_ARROW));
        ...
        ViewGroup.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(i9, i9);
            ...
            if (queryIntentActivities.isEmpty()) {
                ...
                if (queryIntentActivities.size() == 1 && queryIntentActivities.get(0).activityInfo != null) {
                    if (A06(72, 18, 95).equals(queryIntentActivities.get(0).activityInfo.packageName)) {
                        bitmap = AbstractC1312Lx.A01(EnumC1311Lw.BROWSER_LAUNCH_CHROME);
                    }
                }
                bitmap = AbstractC1312Lx.A01(EnumC1311Lw.BROWSER_LAUNCH_NATIVE);
            }
        }
        if (C1225Ih.A2N(this.A0B)) {
