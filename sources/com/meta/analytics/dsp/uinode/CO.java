...
public abstract class CO {
    ...
    public static Pair<long[], long[]> A05(XT xt) {
        ...
        C1217Hz c1217Hz = A072.A00;
        c1217Hz.A0Y(8);
        int A012 = CJ.A01(c1217Hz.A08());
        int A0H = c1217Hz.A0H();
        long[] jArr = new long[A0H];
        long[] jArr2 = new long[A0H];
        for (int i9 = 0; i9 < A0H; i9++) {
            jArr[i9] = A012 == 1 ? c1217Hz.A0N() : c1217Hz.A0M();
            jArr2[i9] = A012 == 1 ? c1217Hz.A0L() : c1217Hz.A08();
            if (c1217Hz.A0U() != 1) {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 11 out of bounds for length 11
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static CN A0B(C1217Hz c1217Hz) {
        long A0M;
        c1217Hz.A0Y(8);
        int A012 = CJ.A01(c1217Hz.A08());
        c1217Hz.A0Z(A012 == 0 ? 8 : 16);
        ...
        if (z8) {
            ...
            A0M = A012 == 0 ? c1217Hz.A0M() : c1217Hz.A0N();
            if (A0M == 0) {
                A0M = C.TIME_UNSET;
            }
        }
        ...
        int A084 = c1217Hz.A08();
        c1217Hz.A0Z(4);
        int A085 = c1217Hz.A08();
        int A086 = c1217Hz.A08();
     ...
     */
    public static C1083Ce A0C(XT xt, XS xs, long j7, DrmInitData drmInitData, boolean z8, boolean z9) throws C10259v {
        int i9;
        int i10;
        int i11;
        long j9 = j7;
        ...
        A01[7] = "VRI";
        long A0F = j9 == C.TIME_UNSET ? C.TIME_UNSET : IF.A0F(j9, 1000000L, A042);
        XT A063 = A062.A06(CJ.A0i).A06(CJ.A17);
        Pair<Long, String> A064 = A06(A062.A07(CJ.A0d).A00);
        C1217Hz c1217Hz = A063.A07(CJ.A1B).A00;
        i9 = A0B.A00;
        i10 = A0B.A01;
        CM A0A = A0A(c1217Hz, i9, i10, (String) A064.second, drmInitData, z9);
        long[] jArr = null;
        long[] jArr2 = null;
        if (!z8) {
        ...
        i11 = A0B.A00;
        return new C1083Ce(i11, A022, ((Long) A064.first).longValue(), A042, A0F, A0A.A02, A0A.A01, A0A.A03, A0A.A00, jArr, jArr2);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 19 out of bounds for length 16
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static C1084Cf A0D(C1217Hz c1217Hz, int i9, int i10, String str) {
        int i11 = i9 + 8;
        while (i11 - i9 < i10) {
            c1217Hz.A0Y(i11);
            int A082 = c1217Hz.A08();
            if (c1217Hz.A08() == CJ.A1H) {
                int A012 = CJ.A01(c1217Hz.A08());
                c1217Hz.A0Z(1);
                int i12 = 0;
                int i13 = 0;
                if (A012 == 0) {
                    ...
                    int A0E = c1217Hz.A0E();
                    i12 = (A0E & PsExtractor.VIDEO_STREAM_MASK) >> 4;
                    i13 = A0E & 15;
                }
                boolean z8 = c1217Hz.A0E() == 1;
                ...
                if (z8 && A0E2 == 0) {
                    ...
                    bArr2 = new byte[A0E3];
                    c1217Hz.A0c(bArr2, 0, A0E3);
                }
                return new C1084Cf(z8, str, A0E2, bArr, i12, i13, bArr2);
            }
            i11 += A082;
        }
        return null;
    ...
    */
    public static com.meta.analytics.dsp.uinode.C1086Ch A0E(com.meta.analytics.dsp.uinode.C1083Ce r35, com.meta.analytics.dsp.uinode.XT r36, com.meta.analytics.dsp.uinode.C1078Bw r37) throws com.meta.analytics.dsp.uinode.C10259v {
        /*
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x0124, code lost:
        ...
        com.meta.analytics.dsp.uinode.AbstractC1192Ha.A04(r17);
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0K(com.meta.analytics.dsp.uinode.C1217Hz r23, int r24, int r25, int r26, int r27, int r28, com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmInitData r29, com.meta.analytics.dsp.uinode.CM r30, int r31) throws com.meta.analytics.dsp.uinode.C10259v {
        /*
    ...
    public static float A00(C1217Hz c1217Hz, int i9) {
        c1217Hz.A0Y(i9 + 8);
        int vSpacing = c1217Hz.A0H();
        int hSpacing = c1217Hz.A0H();
        return vSpacing / hSpacing;
    }

    public static int A01(C1217Hz c1217Hz) {
        int A0E = c1217Hz.A0E();
        int size = A0E & 127;
        while ((A0E & 128) == 128) {
            A0E = c1217Hz.A0E();
    ...
    public static int A02(C1217Hz c1217Hz) {
        c1217Hz.A0Y(16);
        int A082 = c1217Hz.A08();
        int trackType = A05;
        if (A082 == trackType) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static int A03(com.meta.analytics.dsp.uinode.C1217Hz r7, int r8, int r9) {
        /*
            int r3 = r7.A06()
        L4:
            int r0 = r3 - r8
        ...
        L29:
            ...
            com.meta.analytics.dsp.uinode.AbstractC1192Ha.A05(r4, r0)
            int r1 = r7.A08()
    ...
    public static long A04(C1217Hz c1217Hz) {
        int fullAtom = 8;
        c1217Hz.A0Y(8);
        if (CJ.A01(c1217Hz.A08()) != 0) {
            fullAtom = 16;
        }
        c1217Hz.A0Z(fullAtom);
    ...
    public static Pair<Long, String> A06(C1217Hz c1217Hz) {
        c1217Hz.A0Y(8);
        int fullAtom = CJ.A01(c1217Hz.A08());
        int languageCode = fullAtom == 0 ? 8 : 16;
        c1217Hz.A0Z(languageCode);
    ...
    public static Pair<String, byte[]> A07(C1217Hz c1217Hz, int i9) {
        c1217Hz.A0Y(i9 + 8 + 4);
        c1217Hz.A0Z(1);
        A01(c1217Hz);
        c1217Hz.A0Z(2);
        ...
        c1217Hz.A0Z(1);
        A01(c1217Hz);
        String mimeType = AbstractC1210Hs.A03(c1217Hz.A0E());
        ...
        c1217Hz.A0Z(12);
        c1217Hz.A0Z(1);
        int flags = A01(c1217Hz);
        byte[] bArr = new byte[flags];
        c1217Hz.A0c(bArr, 0, flags);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00bd, code lost:
        ...
        com.meta.analytics.dsp.uinode.AbstractC1192Ha.A05(r8, A0I(610, 22, 16));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00ce, code lost:
        ...
        com.meta.analytics.dsp.uinode.AbstractC1192Ha.A05(r8, A0I(640, 22, 118));
        r4 = A0D(r10, r6, r5, r4);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x00e1, code lost:
        ...
        com.meta.analytics.dsp.uinode.AbstractC1192Ha.A05(r7, A0I(670, 22, 49));
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.util.Pair<java.lang.Integer, com.meta.analytics.dsp.uinode.C1084Cf> A08(com.meta.analytics.dsp.uinode.C1217Hz r10, int r11, int r12) {
        /*
    ...
    public static Pair<Integer, C1084Cf> A09(C1217Hz c1217Hz, int i9, int i10) {
        Pair<Integer, C1084Cf> A082;
        int A062 = c1217Hz.A06();
        while (true) {
            int i11 = A062 - i9;
            if (A01[3].charAt(18) == 'y') {
            ...
            if (i11 < i10) {
                c1217Hz.A0Y(A062);
                int A083 = c1217Hz.A08();
                AbstractC1192Ha.A05(A083 > 0, A0I(574, 32, 87));
                int childAtomSize = c1217Hz.A08();
                int childPosition = CJ.A14;
                if (childAtomSize == childPosition && (A082 = A08(c1217Hz, A062, A083)) != null) {
                    return A082;
                }
                A062 += A083;
            } else {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.meta.analytics.dsp.uinode.CM A0A(com.meta.analytics.dsp.uinode.C1217Hz r23, int r24, int r25, java.lang.String r26, com.facebook.ads.internal.exoplayer2.thirdparty.drm.DrmInitData r27, boolean r28) throws com.meta.analytics.dsp.uinode.C10259v {
        /*
    ...
    public static Metadata A0F(XS xs, boolean z8) {
        if (z8) {
            return null;
        }
        ...
        c1217Hz.A0Y(8);
        while (c1217Hz.A04() >= 8) {
            int atomPosition = c1217Hz.A06();
            int A082 = c1217Hz.A08();
            if (c1217Hz.A08() == CJ.A0h) {
                c1217Hz.A0Y(atomPosition);
                return A0H(c1217Hz, atomPosition + A082);
            }
            c1217Hz.A0Z(A082 - 8);
        }
        return null;
    ...
    public static Metadata A0G(C1217Hz c1217Hz, int i9) {
        c1217Hz.A0Z(8);
        ArrayList arrayList = new ArrayList();
        while (c1217Hz.A06() < i9) {
            Id3Frame A042 = CW.A04(c1217Hz);
            if (A042 != null) {
                arrayList.add(A042);
            }
        }
    ...
    public static Metadata A0H(C1217Hz c1217Hz, int i9) {
        c1217Hz.A0Z(12);
        while (true) {
            int A062 = c1217Hz.A06();
            if (A01[2].charAt(2) == 't') {
    ...
    public static void A0L(C1217Hz c1217Hz, int i9, int i10, int i11, int i12, String str, CM cm) throws C10259v {
        String A0I;
        c1217Hz.A0Y(i10 + 8 + 8);
        List list = null;
        ...
        cm.A02 = Format.A09(Integer.toString(i12), A0I, null, -1, 0, str, -1, null, j7, list);
    }

    public static void A0M(C1217Hz c1217Hz, int i9, int childPosition, int i10, int i11, String mimeType, boolean z8, DrmInitData drmInitData, CM cm, int i12) throws C10259v {
        int A0I;
        int A0F;
        int A032;
        DrmInitData drmInitData2 = drmInitData;
        int childPosition2 = i9;
        c1217Hz.A0Y(childPosition + 8 + 8);
        int quickTimeSoundDescriptionVersion = 0;
        if (z8) {
            quickTimeSoundDescriptionVersion = c1217Hz.A0I();
            c1217Hz.A0Z(6);
        } else {
            c1217Hz.A0Z(8);
        }
        if (quickTimeSoundDescriptionVersion == 0 || quickTimeSoundDescriptionVersion == 1) {
            ...
            c1217Hz.A0Z(16);
            A0F = (int) Math.round(c1217Hz.A03());
            A0I = c1217Hz.A0H();
            c1217Hz.A0Z(20);
        } else {
            return;
        }
        int channelCount = c1217Hz.A06();
        if (childPosition2 == CJ.A0R) {
            Pair<Integer, C1084Cf> A09 = A09(c1217Hz, childPosition, i10);
            if (A01[2].charAt(2) == 't') {
                throw new RuntimeException();
            }
            A01[1] = "rXJd0uQKTdLTB";
            if (A09 != null) {
                ...
                if (drmInitData2 == null) {
                    ...
                    drmInitData2 = drmInitData2.A02(((C1084Cf) A09.second).A02);
                }
                cm.A03[i12] = (C1084Cf) A09.second;
            }
            c1217Hz.A0Y(channelCount);
        }
        String str = null;
        ...
        while (channelCount - childPosition < i10) {
            c1217Hz.A0Y(channelCount);
            int childAtomSize = c1217Hz.A08();
            AbstractC1192Ha.A05(childAtomSize > 0, A0I(574, 32, 87));
            int atomType4 = c1217Hz.A08();
            if (atomType4 == CJ.A0T || (z8 && atomType4 == CJ.A1W)) {
                if (atomType4 == CJ.A0T) {
                    A032 = channelCount;
                } else {
                    A032 = A03(c1217Hz, channelCount, childAtomSize);
                }
                if (A032 != -1) {
                    Pair<String, byte[]> A072 = A07(c1217Hz, A032);
                    str = (String) A072.first;
                    bArr = (byte[]) A072.second;
                    if (A0I(467, 15, 17).equals(str)) {
                        Pair<Integer, Integer> A033 = AbstractC1196He.A03(bArr);
                ...
                strArr[5] = "M";
                if (atomType4 == i13) {
                    c1217Hz.A0Y(channelCount + 8);
                    cm.A02 = AQ.A07(c1217Hz, Integer.toString(i11), mimeType, drmInitData2);
                } else if (atomType4 == CJ.A0I) {
                    c1217Hz.A0Y(channelCount + 8);
                    cm.A02 = AQ.A08(c1217Hz, Integer.toString(i11), mimeType, drmInitData2);
                } else if (atomType4 == CJ.A0H) {
                    cm.A02 = Format.A07(Integer.toString(i11), str, null, -1, -1, A0I, A0F, null, drmInitData2, 0, mimeType);
                } else if (atomType4 == CJ.A06) {
                    bArr = new byte[childAtomSize];
                    c1217Hz.A0Y(channelCount);
                    c1217Hz.A0c(bArr, 0, childAtomSize);
                }
            }
        ...
        cm.A02 = Format.A06(Integer.toString(i11), str, null, -1, -1, A0I, A0F, atomType5, bArr != null ? Collections.singletonList(bArr) : null, drmInitData2, 0, mimeType);
    }

    public static boolean A0N(long[] jArr, long j7, long j9, long j10) {
        int length = jArr.length - 1;
        int latestDelayIndex = IF.A06(3, 0, length);
        int lastIndex = jArr.length;
        return jArr[0] <= j9 && j9 < jArr[latestDelayIndex] && jArr[IF.A06(lastIndex - 3, 0, length)] < j10 && j10 <= j7;
    }

    public static byte[] A0O(C1217Hz c1217Hz, int i9, int i10) {
        int i11 = i9 + 8;
        while (true) {
            int i12 = i11 - i9;
            String[] strArr = A01;
            ...
            strArr2[5] = "V";
            if (A083 == i13) {
                int childPosition2 = i11 + A082;
                return Arrays.copyOfRange(c1217Hz.A00, i11, childPosition2);
            }
            i11 += A082;
        }
        throw new RuntimeException();
