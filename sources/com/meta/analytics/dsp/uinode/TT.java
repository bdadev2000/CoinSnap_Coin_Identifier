...
public final class TT extends OL {
    ...
    public TextView A0F;
    public AbstractC1739b5 A0G;
    public NJ A0H;
    public NK A0I;
    public U1 A0J;
    public ViewOnClickListenerC1508Tl A0K;
    public OP A0L;
    public C1381Oo A0M;
    public boolean A0N;
    public boolean A0O;
    ...
    public final AbstractC07930h A0c;
    public final JA A0d;
    public final O0 A0e;
    public final O1 A0f;
    public final KP A0g;
    ...
    public static void A0X() {
        A0k = new byte[]{125, 10, 5, 0, 10, 2, 54, Ascii.SUB, 6, Ascii.FS, Ascii.ESC, 10, Ascii.FF, Ascii.VT, 9, Ascii.CAN, 62, Ascii.CR, Ascii.ESC, 36, 9, 5, Ascii.VT, 4, Ascii.CAN, 108, 107, 117, 112, 113, 90, 104, 96, 113, 109, 106, 97, Ascii.CR, Ascii.VT, Ascii.GS, 10, Ascii.ESC, Ascii.DC4, 17, Ascii.ESC, 19, 39, Ascii.RS, 17, Ascii.DC4, Ascii.FF, Ascii.GS, 10, Ascii.GS, Ascii.FS, 102, 120, Ascii.DEL, 117, 126, 102, 2, Ascii.ESC, Ascii.FS, 42, Ascii.SYN, 1, Ascii.DC4, 42, Ascii.ETB, 0, 1, 1, Ascii.SUB, Ascii.ESC, Ascii.DEL, 102, 97, 87, Ascii.DEL, 109, 106, 87, 97, 102, 123, 124, 105, 100, 100, 87, 106, 125, 124, 124, 103, 102, 10};
    }
    ...
    public TT(OP op) {
        ...
        this.A08 = 0;
        this.A01 = 0;
        this.A0i = new RunnableC1373Og(this);
        this.A0P = false;
        ...
        this.A0g = A0A;
        if (A0A != null) {
            AbstractC1303Lo.A0K(A0A);
        }
        View A03 = this.A0L.A03();
        this.A0b = A03;
        this.A0c = C07940i.A01(op.A05(), op.A06(), op.A04().A12(), AbstractC1287Ky.A00(op.A04().A0x().A0F().A05()), new HashMap(), false, true, this.A0G.A0y());
        ...
        if (sa != null && C1225Ih.A18(getAdContextWrapper())) {
            AbstractC1352Nl.A00(sa.getVideoImplView(), C1225Ih.A19(getAdContextWrapper()), new ViewOnClickListenerC1374Oh(this));
        } else if (sa == null && this.A0A != null && C1225Ih.A16(getAdContextWrapper())) {
            AbstractC1352Nl.A00(this.A0A, C1225Ih.A17(getAdContextWrapper()), new ViewOnClickListenerC1375Oi(this));
        }
        this.A0E = null;
        this.A0K = null;
    }

    public TT(OP op, boolean z8) {
        this(op);
        this.A0X = z8;
    ...
    private void A0K() {
        AbstractC1303Lo.A0J(this.A0D);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0D = linearLayout;
        AbstractC1303Lo.A0R(linearLayout, getAdContextWrapper());
    ...
    public void A16() {
        A0d(((C1149Ff) this.A0c).A0G().toString());
        A0g(true);
    }

    private void A0M() {
        ExecutorC1297Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.Oa
            @Override // java.lang.Runnable
            public final void run() {
                TT.this.A15();
            }
    ...
    private void A0P() {
        AbstractC1303Lo.A0J(this.A0C);
        LinearLayout linearLayout = new LinearLayout(this.A0L.A05());
        this.A0C = linearLayout;
        linearLayout.setOrientation(1);
        AbstractC1303Lo.A0K(this.A0C);
        A0U();
    ...
    private void A0R() {
        KP kp = this.A0g;
        if (kp != null) {
            AbstractC1303Lo.A0J(kp);
            KP kp2 = this.A0g;
            int i9 = A0q;
            kp2.setPadding(i9, i9, i9, i9);
            this.A0g.A06(-1, A0o);
    ...
    private void A0T() {
        ...
        if (this.A0G.A0l()) {
            this.A0A.setOnClickListener(new ViewOnClickListenerC1376Oj(this));
        }
        ...
        int i9 = A0r;
        layoutParams2.setMargins(i9, i9 / 2, i9, this.A0g == null ? i9 : A0p);
        addView(this.A0F, layoutParams2);
        AbstractC1303Lo.A0K(this.A0F);
        C1381Oo c1381Oo = new C1381Oo(this.A0L.A05(), this.A0L.A04(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), getColors(), new TU(this));
        this.A0M = c1381Oo;
        c1381Oo.setAutoClickTime(this.A0L.A04(), this.A0L.A08());
        AbstractC1303Lo.A0G(1001, this.A0M);
        addView(this.A0M);
        A0V();
        A0K();
        if (C1225Ih.A0y(this.A0L.A05())) {
            this.A0D.setOnClickListener(new ViewOnClickListenerC1377Ok(this));
            if (this.A0L.A08() != null) {
                this.A0L.A08().setCTAClickListener(new ViewOnClickListenerC1378Ol(this));
            }
        }
    }
    ...
    private void A0V() {
        ...
        if (this.A0Y && this.A0K != null) {
            ...
            RelativeLayout.LayoutParams installButtonLayoutParams = new RelativeLayout.LayoutParams(z8 ? -2 : -1, -2);
            installButtonLayoutParams.addRule(12);
            installButtonLayoutParams.addRule(14);
            int i9 = A0n;
            installButtonLayoutParams.setMargins(i9, 0, i9, i9);
    ...
    public void A0d(String str) {
        ...
        if (this.A0Y) {
            ...
            AbstractC1303Lo.A0J(this.A0K);
        }
        AbstractC1303Lo.A0J(this.A0J);
        TY ty = new TY(this);
        if (this.A0L.A05().A0D() == null) {
            this.A0L.A05().A0E().A8e();
        }
        if (!AbstractC1226Ii.A02(this.A0L.A05()) && this.A0L.A05().A0D() != null) {
        ...
        this.A0J.setOnTouchListener(new ViewOnTouchListenerC1370Od(this));
        setUpBrowserControls(this.A0J);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        layoutParams.weight = 0.9f;
        if (this.A0Y || this.A0G.A0n()) {
            C1636Yn A05 = this.A0L.A05();
            ...
            ViewOnClickListenerC1508Tl viewOnClickListenerC1508Tl = new ViewOnClickListenerC1508Tl(A05, A0L, A00, this.A0L.A04().A0x().A0F().A06(), this.A0L.A06(), this.A0L.A09(), this.A0L.A0B(), this.A0L.A07(), this.A0L.A04().A0y());
            this.A0K = viewOnClickListenerC1508Tl;
            viewOnClickListenerC1508Tl.setCta(this.A0L.A04().A0x().A0F(), this.A0L.A04().A12(), new HashMap());
        }
        if (!this.A0Y || this.A0K == null) {
            ...
            if (this.A0N) {
                ViewOnClickListenerC1508Tl viewOnClickListenerC1508Tl2 = this.A0K;
                int i9 = A0n;
                viewOnClickListenerC1508Tl2.setPadding(i9, 0, i9, 0);
            }
    ...
    public void A0g(boolean z8) {
        ...
        postDelayed(new TX(this, z8), 250L);
        String A0J = A0J(97, 1, 9);
        if (z8) {
            C1381Oo c1381Oo = this.A0M;
            objectAnimator = ObjectAnimator.ofFloat(c1381Oo, A0J, c1381Oo.getY(), this.A05 / 5);
        }
        ...
        duration.addUpdateListener(new C1371Oe(this));
        ...
        animatorSet.addListener(new C1372Of(this, z8));
        animatorSet.start();
    }
    ...
    */
    private void A0h(boolean r8) {
        /*
            ...
            com.meta.analytics.dsp.uinode.AbstractC1303Lo.A0J(r0)
            android.view.View r0 = r7.A0A
            if (r0 != 0) goto L17
            com.facebook.ads.redexgen.X.OP r0 = r7.A0L
            android.view.View r0 = r0.A02()
            r7.A0A = r0
            com.meta.analytics.dsp.uinode.AbstractC1303Lo.A0K(r0)
        L17:
            boolean r4 = r7.A0O
        ...
        L60:
            ...
            boolean r0 = com.meta.analytics.dsp.uinode.C1225Ih.A16(r0)
            if (r0 == 0) goto La2
    ...
    */
    public final void A10(com.meta.analytics.dsp.uinode.C1G r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        ...
        L17:
            ...
            r0 = 8
            com.meta.analytics.dsp.uinode.AbstractC1303Lo.A0N(r1, r0)
    ...
    public final /* synthetic */ void A18(View view) {
        ExecutorC1297Li.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.OX
            @Override // java.lang.Runnable
            public final void run() {
                TT.this.A14();
            }
