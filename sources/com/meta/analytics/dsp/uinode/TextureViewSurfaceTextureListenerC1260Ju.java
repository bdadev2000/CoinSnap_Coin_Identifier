...
public final class TextureViewSurfaceTextureListenerC1260Ju extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, R9 {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C1225Ih.A1X(this.A0N) && this.A06 != null) {
            boolean A07 = A07();
            if (A0P[1].charAt(7) != 'q') {
    ...
    static {
        A04();
        A0Q = TextureViewSurfaceTextureListenerC1260Ju.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC1260Ju(C1636Yn c1636Yn) {
        super(c1636Yn);
        this.A0C = RB.A04;
        this.A0D = RB.A04;
        this.A0J = false;
    ...
    public TextureViewSurfaceTextureListenerC1260Ju(C1636Yn c1636Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC1260Ju(C1636Yn c1636Yn, AttributeSet attributeSet, int i9) {
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A07().A9a(A03(384, 6, 81), C8A.A2H, new C8B(e4));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A07().A9a(A03(384, 6, 81), C8A.A2I, new C8B(e4));
            return false;
        }
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.R9
    public final void ADu(boolean z8, int i9) {
        this.A0N.A0E().A33(i9);
        this.A0D = RB.A05;
        if (this.A06 != null) {
            if (!A06()) {
    ...
    */
    public final void AGS(com.meta.analytics.dsp.uinode.QM r6, int r7) {
        /*
            r5 = this;
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1260Ju.A0P
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 4
            if (r1 == r0) goto L96
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1260Ju.A0P
        ...
        L96:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1260Ju.AGS(com.facebook.ads.redexgen.X.QM, int):void");
    }

    @Override // com.meta.analytics.dsp.uinode.R9
    public final void AGZ(int i9) {
        this.A0N.A0E().A3G(i9);
        this.A0D = RB.A04;
        MediaPlayer mediaPlayer = this.A06;
        if (mediaPlayer != null) {
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i9, int i10) {
        this.A0N.A0E().AAR(A03(390, 11, 119) + i9 + A03(0, 14, 9) + i10 + A03(14, 2, 105));
                ...
                if ((this.A0N.A0F().A01() || C1225Ih.A1c(this.A0N)) && Build.VERSION.SDK_INT >= 24) {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.R5
                        ...
                        public final void run() {
                            TextureViewSurfaceTextureListenerC1260Ju.this.A0C();
                        }
                    }, 1000L);
                    return;
                } else {
    ...
    public void setForeground(Drawable drawable) {
        if (Build.VERSION.SDK_INT < 24) {
            ...
            Log.w(A0Q, A03(g.STALE_CACHED_RESPONSE_VALUE, 94, 7));
        }
    }
