...
public class AnonymousClass53 {
    ...
    public final void A04(int i9) {
        if ((this.A04 & i9) != 0) {
            ...
            throw new IllegalStateException(A01(PsExtractor.AUDIO_STREAM, 30, 67) + Integer.toBinaryString(i9) + A01(0, 11, 52) + Integer.toBinaryString(this.A04));
        }
    }

    public final void A05(AbstractC08904c abstractC08904c) {
        this.A04 = 1;
        this.A03 = abstractC08904c.A0E();
        this.A09 = false;
        this.A0E = false;
        this.A0A = false;
    }
