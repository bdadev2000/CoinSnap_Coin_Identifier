...
public final class C1783bn implements AnonymousClass00 {
    ...
    private File A02(AnonymousClass06 anonymousClass06, String str, String str2, int i9, AnonymousClass09 anonymousClass09) {
        ...
        try {
            ...
            C1779bj c1779bj2 = new C1779bj(file, new GG(C1225Ih.A0N(this.A05)));
            if (c1779bj2.A09()) {
                if (this.A08) {
                    String str4 = A03(49, 22, 106) + c1779bj2.A00.getName();
                }
            ...
            if (this.A08) {
                String str5 = A03(71, 26, 117) + c1779bj2.A00.getName();
            }
            ...
            while (true) {
                ...
                try {
                    A05(this.A05, c1779bj2, str3, i9, i10, currentTimeMillis);
                    break;
                } catch (C0H e9) {
                    e = e9;
                    if (i10 == this.A00 - 1) {
                        A06(c1779bj);
                        if (e instanceof C1780bk) {
                            throw ((C1780bk) e);
                        }
                        if (e instanceof C1777bh) {
                            throw ((C1777bh) e);
                        }
                    }
                    i10++;
            ...
            this.A04.AEP(AEP2, 2113, e10.toString(), null, null, anonymousClass063);
            if (!this.A08) {
                return null;
            }
            Log.e(A0B, A03, e10);
            ...
            this.A04.AEP(AEP, 2119, e11.toString(), null, null, anonymousClass062);
            if (!this.A08) {
                return null;
            }
            Log.e(A0B, A03, e11);
    ...
    static {
        A04();
        A0B = C1783bn.class.getSimpleName();
    }

    public C1783bn(C09647f c09647f, AnonymousClass08 anonymousClass08, C0L c0l) {
        this.A05 = c09647f;
    ...
    public static C1781bl A00(Context context, String str) throws C0H {
        try {
            ...
            while (true) {
                ...
                if (read != -1) {
                    ...
                    return new C1781bl(byteArrayOutputStream.toByteArray());
                }
            }
    ...
    */
    private void A05(android.content.Context r24, com.meta.analytics.dsp.uinode.C1779bj r25, java.lang.String r26, int r27, int r28, long r29) throws com.meta.analytics.dsp.uinode.C0H {
        /*
            Method dump skipped, instructions count: 578
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1783bn.A05(android.content.Context, com.facebook.ads.redexgen.X.bj, java.lang.String, int, int, long):void");
    }

    private void A06(C1779bj c1779bj) {
        try {
            File A04 = c1779bj.A04();
            if (A04.exists()) {
                c1779bj.A06();
    ...
    private boolean A07(C1779bj c1779bj) {
        try {
            c1779bj.A05();
            return true;
        } catch (C1777bh e4) {
    ...
    public final AnonymousClass02<Bitmap> AFH(AnonymousClass06 anonymousClass06, boolean z8) {
        return A08(anonymousClass06, new AnonymousClass09(new C1786bq(anonymousClass06.A01, anonymousClass06.A00, this.A02.A04(), this.A02.A03(), z8)));
    }
    ...
    public final File AFI(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1785bp());
    ...
    public final String AFJ(AnonymousClass06 anonymousClass06) {
        return (String) A08(anonymousClass06, new AnonymousClass09(new C1784bo())).A00();
    }
    ...
    public final String AFK(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1784bo());
        anonymousClass09.A01(true);
        anonymousClass09.A02(false);
