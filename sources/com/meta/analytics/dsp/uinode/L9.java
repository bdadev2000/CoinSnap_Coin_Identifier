...
public final class L9 {
    ...
    public L9(int i9, float f9, long j7, Handler handler, L8 l82) {
        this(i9, l82, handler);
        this.A02 = j7;
        this.A01 = f9;
    }

    public L9(int i9, L8 l82) {
        this(i9, l82, new Handler());
    }

    public L9(int i9, L8 l82, Handler handler) {
        this.A04 = false;
        this.A00 = i9;
        this.A06 = l82;
        this.A05 = handler;
    ...
    public final boolean A07() {
        ...
        if (!A04() && !A05()) {
            ...
            this.A05.postDelayed(new C1532Uj(this), this.A02);
            return true;
        }
        if (A07[4].charAt(25) == 'L') {
            throw new RuntimeException();
