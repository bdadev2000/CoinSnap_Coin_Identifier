...
public class C1676a4<T> implements InterfaceC08622z<T> {
    ...
    public static String A00(int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < copyOfRange.length; i12++) {
            ...
            A03[5] = "P1E265Ge3cQ";
            copyOfRange[i12] = (byte) ((b ^ i11) ^ 106);
        }
    ...
    public C1676a4(int i9) {
        if (i9 > 0) {
            this.A01 = new Object[i9];
            return;
        }
    ...
    */
    private boolean A02(T r6) {
        ...
        L1:
            ...
            r3 = r0[r4]
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1676a4.A03
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L34:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1676a4.A02(java.lang.Object):boolean");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.a4 != com.facebook.ads.internal.androidx.support.v4.util.Pools$SimplePool<T> */
    @Override // com.meta.analytics.dsp.uinode.InterfaceC08622z
    public T A2b() {
        int i9 = this.A00;
        if (i9 <= 0) {
            return null;
