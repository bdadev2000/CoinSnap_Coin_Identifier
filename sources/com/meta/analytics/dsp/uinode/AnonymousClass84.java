...
public final class AnonymousClass84 {
    ...
    public static int A00(String str, int i9, C09647f c09647f) {
        if ((A01(465, 7, 107).equals(str) && C8A.A20 == i9) || A01(422, 5, 56).equals(str) || A01(445, 6, 63).equals(str)) {
            return 200;
        }
    ...
    public static void A05(C09647f c09647f, int i9, int i10) {
        c09647f.A07().A9a(A01(435, 10, 113), C8A.A2X, new C8B(A01(338, 33, 80) + i9, A01(87, 9, 13) + i10));
    }

    @Deprecated
    public static void A06(C09647f c09647f, String str, int i9, C8B c8b) {
        if (c09647f == null) {
            A0F(new RuntimeException(A01(48, 39, 84)));
            return;
        }
        AbstractC09637e.A01(c09647f.A01());
        if (A02 && c8b.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 70) + str + A01(31, 16, 8) + i9, c8b));
        }
        try {
            if (A0J(c09647f, str, i9, Math.random(), c8b)) {
                A09(c09647f, str, i9, c8b);
            }
        } catch (Throwable t9) {
            A0F(t9);
        }
    ...
    @Deprecated
    public static void A07(C09647f c09647f, String str, int i9, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A0A(false);
            c8b.A06(1);
    ...
    @Deprecated
    public static void A08(C09647f c09647f, String str, int i9, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A08(false);
            A06(c09647f, str, i9, c8b);
    ...
    public static void A09(C09647f c09647f, String str, int i9, C8B c8b) {
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                int A012 = Ij.A01(c09647f);
                AtomicInteger atomicInteger = A09;
                int threshold = atomicInteger.getAndIncrement();
                if (threshold < A012 - 1) {
                    A07.add(new AnonymousClass85(str, i9, c8b));
                } else if (atomicInteger.get() == A012) {
                    A07.add(new AnonymousClass85(A01(435, 10, 113), C8A.A2U, new C8B(A01(140, 42, 0) + str + A01(47, 1, 19) + i9)));
                }
            } else {
                A0A(c09647f, str, i9, c8b, true);
            }
        }
    }

    public static void A0A(C09647f c09647f, String str, int i9, C8B c8b, boolean z8) {
        AnonymousClass83 anonymousClass83 = A0B.get();
        boolean z9 = anonymousClass83 != null && anonymousClass83.A9G();
        if (A08.get() || z9) {
            int A012 = c8b.A01();
            String A013 = A01(289, 17, 46);
            String A014 = A01(31, 16, 8);
            if (A012 == 0) {
                Log.e(A013, A01(182, 37, 40) + str + A014 + i9, c8b);
            } else {
                Log.i(A013, A01(306, 32, 116) + str + A014 + i9 + A01(19, 12, 63) + c8b.getMessage() + A01(0, 19, 80) + c8b.A03());
            }
        }
        C1627Ye c1627Ye = new C1627Ye(c09647f, str, i9, c8b, anonymousClass83);
        if (z8) {
            A01.execute(c1627Ye);
        } else {
            c1627Ye.run();
    ...
    public static void A0C(C1635Ym c1635Ym, AnonymousClass83 anonymousClass83, AnonymousClass82 anonymousClass82, boolean z8) {
        ...
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1628Yf(c1635Ym));
            }
        }
    }
    ...
    public static void A0E(Throwable th) {
        if (A02) {
            A0D(new RuntimeException(A01(NotificationCompat.FLAG_LOCAL_ONLY, 33, 121), th));
        }
    }
    ...
    public static boolean A0H(C09647f c09647f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && Ij.A0A(c09647f) != 0;
    }

    public static boolean A0I(C09647f c09647f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        if (shouldSkipFunnelEventsForSession != null && shouldSkipFunnelEventsForSession.booleanValue()) {
            return false;
        }
        double funnelEventLogProbability = 1.0d / Ij.A0A(c09647f);
        return c09647f.A08().A00() <= funnelEventLogProbability;
    }
    ...
    */
    public static boolean A0J(com.meta.analytics.dsp.uinode.C09647f r12, java.lang.String r13, int r14, double r15, com.meta.analytics.dsp.uinode.C8B r17) {
        /*
    ...
    public static boolean A0K(C09647f c09647f, String str, int i9, C8B c8b) {
        if (!Ij.A0P(c09647f)) {
            return true;
        }
        int customLimit = A00.get(i9);
        int eventsLimit = Ij.A00(c09647f);
        if (c8b.A02() != -1) {
            eventsLimit = c8b.A02();
        } else {
            int currentCounter = A00(str, i9, c09647f);
        ...
        if (customLimit >= eventsLimit) {
            if (A06.contains(Integer.valueOf(customLimit))) {
                ...
                if (A0D) {
                    A05(c09647f, i9, customLimit);
                }
            }
            A00.put(i9, customLimit + 1);
            return true;
        }
        A00.put(i9, customLimit + 1);
        return false;
