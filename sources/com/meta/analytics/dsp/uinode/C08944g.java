...
public final class C08944g extends C8 {
    ...
    public C08944g(List<byte[]> list) {
        super(A02(182, 10, 38));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String A0Q = IF.A0Q(list.get(0));
            String formatLine = A02(47, 8, 49);
            AbstractC1192Ha.A03(A0Q.startsWith(formatLine));
            A06(A0Q);
            A04(new C1217Hz(list.get(1)));
            return;
        }
        this.A04 = false;
    }
    ...
    public final WF A0b(byte[] bArr, int i9, boolean z8) {
        ArrayList arrayList = new ArrayList();
        C1207Hp c1207Hp = new C1207Hp();
        C1217Hz c1217Hz = new C1217Hz(bArr, i9);
        if (!this.A04) {
            A04(c1217Hz);
        }
        A05(c1217Hz, arrayList, c1207Hp);
        C1155Fn[] c1155FnArr = new C1155Fn[arrayList.size()];
        arrayList.toArray(c1155FnArr);
        return new WF(c1155FnArr, c1207Hp.A05());
    }

    private void A04(C1217Hz c1217Hz) {
        String A0P;
        do {
            A0P = c1217Hz.A0P();
            if (A0P == null) {
    ...
    private void A05(C1217Hz c1217Hz, List<C1155Fn> list, C1207Hp c1207Hp) {
        while (true) {
    ...
    */
    private void A06(java.lang.String r9) {
        ...
        L90:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C08944g.A06(java.lang.String):void");
    }

    private void A07(String str, List<C1155Fn> list, C1207Hp c1207Hp) {
        int i9 = this.A01;
        ...
        list.add(new C1155Fn(endTimeString.replaceAll(A023, A024).replaceAll(A02(203, 3, 50), A024)));
        c1207Hp.A04(startTimeUs);
        if (j7 != C.TIME_UNSET) {
            list.add(null);
            String[] strArr = A06;
