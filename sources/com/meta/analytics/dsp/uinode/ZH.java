...
public final class ZH extends C09135a implements MediaViewApi, Repairable, InterfaceC09607b {
    ...
    private void A0A(View view, V2 v22) {
        ...
        C1416Px A01 = AbstractC1415Pw.A01(this.A07, A1C);
    ...
    private void A0B(ImageView imageView) {
        if (!this.A0D) {
            ...
            if (imageView2 != null) {
                AbstractC1303Lo.A0J(imageView2);
            }
            imageView.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(imageView, layoutParams);
            imageView.setId(AbstractC1303Lo.A00());
            this.A02 = imageView;
            return;
        }
    ...
    private final void A0C(C1636Yn c1636Yn, AttributeSet attributeSet, int i9, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1636Yn, attributeSet, i9, i10));
        A0H(new C1346Nf(c1636Yn, attributeSet, i9, i10));
        this.A08 = new C3C(c1636Yn, attributeSet, i9);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1636Yn, attributeSet, i9, i10));
        A07();
    }

    private final void A0D(C1636Yn c1636Yn, AttributeSet attributeSet, int i9, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1636Yn, attributeSet, i9));
        A0H(new C1346Nf(c1636Yn, attributeSet, i9));
        this.A08 = new C3C(c1636Yn, attributeSet, i9);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1636Yn, attributeSet, i9));
        A07();
    }

    private final void A0E(C1636Yn c1636Yn, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1636Yn, attributeSet));
        A0H(new C1346Nf(c1636Yn, attributeSet));
        this.A08 = new C3C(c1636Yn, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1636Yn, attributeSet));
        A07();
    }

    private final void A0F(C1636Yn c1636Yn, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1636Yn));
        A0H(new C1346Nf(c1636Yn));
        this.A08 = new C3C(c1636Yn);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1636Yn));
        A07();
    }

    private void A0G(V2 v22, boolean z8, JP jp) {
        AsyncTaskC1513Tq A04 = new AsyncTaskC1513Tq(this.A02, this.A07).A04();
        if (z8) {
    ...
    private void A0H(C1346Nf c1346Nf) {
        if (!this.A0D) {
            C1346Nf c1346Nf2 = this.A09;
            if (c1346Nf2 != null) {
                this.A03.removeView(c1346Nf2);
            }
            c1346Nf.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c1346Nf, layoutParams);
            this.A09 = c1346Nf;
            return;
        }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C09215i) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C09215i) nativeAd.getNativeAdApi()).A02());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:73:0x03b6, code lost:
        ...
        ((com.meta.analytics.dsp.uinode.C1119Eb) r1).setAdapter(null);
     */
    ...
    */
    ...
    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z8) {
        C1636Yn A11 = ((V2) nativeAdBaseApi).A11();
        C1636Yn adObjectContext = this.A07;
        ...
        ((C09205h) this.A05.getMediaViewVideoRendererApi()).A03();
        View view = this.A01;
        if (view != null) {
        ...
        if (adIcon != null) {
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C1636Yn adObjectContext2 = this.A07;
    ...
    public final void bringChildToFront(View view) {
        if (view == this.A01 || view == this.A05 || view == this.A09 || view == this.A02) {
            ...
            C1416Px c1416Px = this.A0B;
            if (c1416Px != null) {
                this.A06.bringChildToFront(c1416Px);
            }
        }
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.C09135a, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C09205h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C09205h) this.A05.getMediaViewVideoRendererApi()).A07(new ZI(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C09205h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            ...
            mediaViewVideoRenderer.setId(AbstractC1303Lo.A00());
            return;
        }
