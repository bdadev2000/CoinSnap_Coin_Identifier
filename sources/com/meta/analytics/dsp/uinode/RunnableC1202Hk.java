...
public final class RunnableC1202Hk implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC1202Hk(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C1200Hi(IF.A0P(A04(0, 67, 61), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }

    public static EGLContext A01(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i9) {
        int[] iArr;
        if (i9 != 0) {
        ...
        throw new C1200Hi(A04(67, 23, 57));
    }

    public static EGLDisplay A02() {
        EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
        if (eglGetDisplay == null) {
            throw new C1200Hi(A04(120, 20, 96));
        }
        int[] iArr = new int[2];
        boolean eglInitialized = EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1);
        if (!eglInitialized) {
            throw new C1200Hi(A04(140, 20, 64));
        }
        return eglGetDisplay;
    }

    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i9) {
        int[] iArr;
        ...
        if (i9 == 1) {
            ...
            if (eglCreatePbufferSurface == null) {
                throw new C1200Hi(A04(90, 30, 107));
            }
        }
        if (!EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            throw new C1200Hi(A04(160, 21, 80));
        }
    ...
    public static void A06(int[] iArr) {
        ...
        if (glGetError == 0) {
            ...
            throw new C1200Hi(A04(181, 29, 20) + Integer.toHexString(glGetError));
        }
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC1192Ha.A01(this.A00);
    }
    ...
    public final void A09(int i9) {
        ...
        EGLContext A01 = A01(this.A02, A00, i9);
        this.A01 = A01;
        this.A03 = A03(this.A02, A00, A01, i9);
        A06(this.A05);
