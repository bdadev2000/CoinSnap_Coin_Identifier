...
public final class C1618Xv implements InterfaceC1031Ab {
    ...
    public ByteBuffer A04 = InterfaceC1031Ab.A00;
    ...
    public final boolean A4Q(int i9, int i10, int i11) throws C1030Aa {
        if (i11 == 3 || i11 == 2 || i11 == Integer.MIN_VALUE || i11 == 1073741824) {
            if (this.A02 != i9 || this.A00 != i10 || this.A01 != i11) {
                this.A02 = i9;
                this.A00 = i10;
                this.A01 = i11;
                return true;
    ...
    public final boolean A91() {
        return this.A05 && this.A04 == InterfaceC1031Ab.A00;
    }
    ...
    public final void AEF(ByteBuffer byteBuffer) {
        int limit;
        int i9 = byteBuffer.position();
        int resampledSize = byteBuffer.limit();
        int limit2 = resampledSize - i9;
        ...
        switch (position5) {
            ...
            case 3:
                while (i9 < resampledSize) {
                    ...
                    int position9 = byteBuffer.get(i9);
