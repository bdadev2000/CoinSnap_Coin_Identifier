...
public final class C4C {
    ...
    private int A00(int i9) {
        ...
        int limit = i9;
        while (limit < offset) {
            int A032 = i9 - (limit - this.A00.A03(limit));
            if (A032 == 0) {
    ...
    public final View A09(int i9) {
        return this.A01.A6M(A00(i9));
    }

    public final View A0A(int i9) {
        return this.A01.A6M(i9);
    }
    ...
    public final void A0H(View view, int i9, ViewGroup.LayoutParams layoutParams, boolean z8) {
        int A00;
        if (i9 < 0) {
            A00 = this.A01.A6N();
        } else {
    ...
    public final void A0I(View view, int i9, boolean z8) {
        int A00;
        if (i9 < 0) {
            A00 = this.A01.A6N();
        } else {
    ...
    public final void A0J(View view, boolean z8) {
        A0I(view, -1, z8);
    }
