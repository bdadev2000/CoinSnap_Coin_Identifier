...
public abstract class C1F implements Serializable {
    ...
    public static String A01(int i9, int i10, int i11) {
        byte[] copyOfRange = Arrays.copyOfRange(A0T, i9, i9 + i10);
    ...
    public static C1F A00(JSONObject jSONObject, C1636Yn c1636Yn) {
        ...
        if (has) {
            try {
                c1f = C1737b3.A02(jSONObject, c1636Yn);
    ...
    private final void A04(long j7) {
        this.A03 = j7;
    }
