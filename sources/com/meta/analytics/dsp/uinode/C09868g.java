...
public final class C09868g {
    ...
    public static synchronized LA A00(C09647f c09647f) {
        LA la;
        synchronized (C09868g.class) {
            if (A01 == null) {
                A01 = LB.A00(c09647f);
            }
            la = A01;
    ...
    public static void A06(C09647f c09647f, String str, Map<String, String> params) {
        String str2;
        if (A0A(c09647f)) {
            str2 = C1268Kc.A03(str);
        } else {
            str2 = A00;
        }
        if (str2 != null) {
    ...
    public static void A07(final C09647f c09647f, boolean z8) {
        if (!A05.compareAndSet(0, 1)) {
            return;
        }
        A00(c09647f);
        try {
            final SharedPreferences A002 = KE.A00(c09647f);
            final C8K c8k = new C8K(c09647f);
            ...
            FutureTask futureTask = new FutureTask(new Callable<Boolean>() { // from class: com.facebook.ads.redexgen.X.8f
                ...
                public static void A02() {
                    A04 = new byte[]{Ascii.CAN, 61, 51, 46, 61, 45, 17, Ascii.GS, Ascii.US, 92, 19, Ascii.FS, Ascii.SYN, 0, Ascii.GS, Ascii.ESC, Ascii.SYN, 92, 4, Ascii.ETB, Ascii.FS, Ascii.SYN, Ascii.ESC, Ascii.FS, Ascii.NAK, 100, 116, 102, 119, 110, 112, 96, Ascii.DEL, 116, 112, 114, 112, 123, 112, 103, 124, 118};
                }
                ...
                */
                public final java.lang.Boolean call() throws java.lang.Exception {
                    /*
                        ...
                        if (r0 == 0) goto L3e
                    L17:
                        com.facebook.ads.redexgen.X.7f r0 = com.meta.analytics.dsp.uinode.C09647f.this
                        ...
                        if (r0 == 0) goto L3e
                        com.facebook.ads.redexgen.X.7f r1 = com.meta.analytics.dsp.uinode.C09647f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r6 = com.meta.analytics.dsp.uinode.LG.A01(r1, r0)
                    L3e:
                        r5 = 1
                        java.lang.String[] r1 = com.meta.analytics.dsp.uinode.CallableC09858f.A05
                        r0 = 7
                        r0 = r1[r0]
                        int r1 = r0.length()
                        r0 = 20
                        ...
                        throw r0
                    L52:
                        java.lang.String[] r2 = com.meta.analytics.dsp.uinode.CallableC09858f.A05
                        ...
                        com.facebook.ads.redexgen.X.7f r1 = com.meta.analytics.dsp.uinode.C09647f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r0 = com.meta.analytics.dsp.uinode.C1268Kc.A02(r1, r0)
                        com.meta.analytics.dsp.uinode.C09868g.A00 = r0
                    L6c:
                        android.content.SharedPreferences r0 = r3
                        android.content.SharedPreferences$Editor r2 = r0.edit()
                        java.lang.String r1 = r4
                        java.lang.String r0 = com.meta.analytics.dsp.uinode.C09868g.A00
                        android.content.SharedPreferences$Editor r0 = r2.putString(r1, r0)
                        r0.apply()
                        java.util.concurrent.atomic.AtomicInteger r1 = com.meta.analytics.dsp.uinode.C09868g.A04()
                        r0 = 2
                        r1.set(r0)
                    ...
                    L8a:
                        ...
                        com.facebook.ads.redexgen.X.7f r1 = com.meta.analytics.dsp.uinode.C09647f.this
                        java.lang.String r0 = r1.getPackageName()
                        java.lang.String r4 = com.meta.analytics.dsp.uinode.C1268Kc.A02(r1, r0)
                        r2 = 1
                        r1 = 5
                        r0 = 33
                        java.lang.String r0 = A01(r2, r1, r0)
                        ...
                        r4.A9b(r0, r3, r7)
                    Le7:
                        com.meta.analytics.dsp.uinode.C09868g.A00 = r6
                        goto L6c
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.CallableC09858f.call():java.lang.Boolean");
                }
            });
    ...
    public static void A08(C09647f c09647f, boolean z8, String str) {
        if (A0A(c09647f)) {
            A09(c09647f, z8, str);
        } else {
            A07(c09647f, z8);
    ...
    public static void A09(C09647f c09647f, boolean z8, final String str) {
        if (str == null) {
            str = c09647f.getPackageName();
        }
        if (A0B(str)) {
            return;
        }
        A00(c09647f);
        final C1268Kc c1268Kc = new C1268Kc(c09647f, str);
        try {
            c1268Kc.A06();
    ...
    public static boolean A0A(C09647f c09647f) {
        return ProcessUtils.isRemoteRenderingProcess() || C1225Ih.A2L(c09647f);
    }
