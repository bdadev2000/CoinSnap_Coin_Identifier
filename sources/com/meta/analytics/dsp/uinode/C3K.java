...
public final class C3K<T extends Enum<T>> extends AbstractC09546u<T> implements InterfaceC1168Ga<T>, Serializable {
    ...
    public C3K(T[] tArr) {
        C1790bu.A07(tArr, A03(7, 7, 60));
        this.A00 = tArr;
    }

    private final int A00(T t9) {
        C1790bu.A07(t9, A03(0, 7, 113));
        int ordinal = t9.ordinal();
        if (((Enum) C3M.A01(this.A00, ordinal)) == t9) {
            return ordinal;
        }
        return -1;
    }
    ...
    public final T get(int i9) {
        AbstractC09546u.A02.A03(i9, this.A00.length);
        return this.A00[i9];
    }

    private final boolean A05(T t9) {
        C1790bu.A07(t9, A03(0, 7, 113));
        Enum target = (Enum) C3M.A01(this.A00, t9.ordinal());
        return target == t9;
    }
