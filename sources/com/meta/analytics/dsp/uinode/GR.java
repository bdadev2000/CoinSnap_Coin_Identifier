...
public final class GR {
        ...
        while (i9 < str2.length()) {
            ...
            switch (charAt) {
                case MotionEventCompat.AXIS_GENERIC_7 /* 38 */:
                    int indexOf = str2.indexOf(59, i9 + 1);
                    int indexOf2 = str2.indexOf(32, i9 + 1);
                    if (indexOf == -1) {
                        indexOf = indexOf2;
                    } else if (indexOf2 != -1) {
                    ...
                    if (indexOf == -1) {
                        ...
                        A07(str2.substring(i9 + 1, indexOf), spannableStringBuilder);
                        if (indexOf == indexOf2) {
                ...
                case '<':
                    if (i9 + 1 < str2.length()) {
                        int i10 = i9;
                        boolean z8 = str2.charAt(i10 + 1) == '/';
                        i9 = A01(str2, i10 + 1);
                        boolean z9 = str2.charAt(i9 + (-2)) == '/';
                        String substring = str2.substring((z8 ? 2 : 1) + i10, z9 ? i9 - 2 : i9 - 1);
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 20 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final boolean A0G(C1217Hz c1217Hz, GO go, List<GM> list) {
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, c1217Hz, go, this.A00, list);
        }
        String A0P2 = c1217Hz.A0P();
        if (A0P2 == null) {
            return false;
        }
        Matcher matcher2 = pattern.matcher(A0P2);
        if (matcher2.matches()) {
            return A0F(A0P.trim(), matcher2, c1217Hz, go, this.A00, list);
        }
        return false;
    }
    ...
    */
    ...
    public static int A01(String str, int i9) {
    ...
    public static void A06(SpannableStringBuilder spannableStringBuilder, GM gm, int i9, int i10) {
        if (gm == null) {
            return;
        }
        if (gm.A08() != -1) {
            spannableStringBuilder.setSpan(new StyleSpan(gm.A08()), i9, i10, 33);
        }
        if (gm.A0O()) {
        ...
        if (gm.A0N()) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan(gm.A06()), i9, i10, 33);
        }
        if (gm.A0M()) {
            spannableStringBuilder.setSpan(new BackgroundColorSpan(gm.A05()), i9, i10, 33);
        }
        String A0H = gm.A0H();
        if (A02[6].charAt(12) != 'U') {
            A02[6] = "tzfwj6Yb5L7snAfsv0bj9UNvpNFUfxvv";
            if (A0H != null) {
                spannableStringBuilder.setSpan(new TypefaceSpan(gm.A0H()), i9, i10, 33);
            }
            if (gm.A0A() != null) {
                spannableStringBuilder.setSpan(new AlignmentSpan.Standard(gm.A0A()), i9, i10, 33);
            }
            switch (gm.A07()) {
                case 1:
                    spannableStringBuilder.setSpan(new AbsoluteSizeSpan((int) gm.A04(), true), i9, i10, 33);
                    return;
                case 2:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(gm.A04()), i9, i10, 33);
                    return;
                case 3:
                    spannableStringBuilder.setSpan(new RelativeSizeSpan(gm.A04() / 100.0f), i9, i10, 33);
                    return;
                default:
                    return;
            }
    ...
    public static void A0B(String str, GP gp, SpannableStringBuilder spannableStringBuilder, List<GM> list, List<GQ> list2) {
        char c9;
        int i9 = gp.A00;
        int i10 = spannableStringBuilder.length();
        String str2 = gp.A01;
        ...
        for (int end2 = 0; end2 < styleMatchesCount; end2++) {
            A06(spannableStringBuilder, list2.get(end2).A01, i9, i10);
        }
    }
    ...
    public static boolean A0F(String str, Matcher matcher, C1217Hz c1217Hz, GO go, StringBuilder sb, List<GM> list) {
        try {
