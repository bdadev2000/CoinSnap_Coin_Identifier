...
public final class ER extends ZG {
     ...
     */
    public final void A04(NativeAdLayout nativeAdLayout, C1636Yn c1636Yn, NativeAd nativeAd, JR jr) {
        O3 o3 = new O3(c1636Yn);
        MediaView mediaView = new MediaView(c1636Yn);
        AdOptionsView adOptionsView = new AdOptionsView(c1636Yn, nativeAd, nativeAdLayout);
        jr.A09(adOptionsView, 28);
        this.A00 = new SH(c1636Yn, nativeAd, jr, V2.A0L(nativeAd.getInternalNativeAd()).A17(), o3, mediaView, adOptionsView);
