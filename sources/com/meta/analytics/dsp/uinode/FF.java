...
public final class FF extends AbstractC1708aa {
    ...
    public static final AnonymousClass27 A03 = new C1696aO();
    public C1701aT A00;
    ...
    public final void A09() {
        C1701aT c1701aT = new C1701aT(this.A01, this, A04());
        this.A00 = c1701aT;
        c1701aT.A0G(this.A01.A0B(), this.A01.A07());
    }
    ...
    public final void A0D(InterstitialAd interstitialAd, EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        C1701aT c1701aT = this.A00;
        if (c1701aT != null) {
            c1701aT.A0G(cacheFlags, str);
            return;
        }
        this.A01.A0K(cacheFlags);
        this.A01.A0H(str);
        if (AbstractC1227Ik.A07(this.A02) && AbstractC1227Ik.A08(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final boolean A0H(InterstitialAd interstitialAd, InterstitialAd.InterstitialShowAdConfig interstitialShowAdConfig) {
        ...
        C1701aT c1701aT2 = new C1701aT(this.A01, this, A04());
        this.A00 = c1701aT2;
        c1701aT2.A0J();
        return false;
    }
