...
public final class JR implements NativeAdViewAttributesApi {
    ...
    public final int A04(float f9) {
        int i9 = this.A01;
        return AbstractC08522p.A02(((-16777216) & i9) | ((i9 ^ (-1)) & ViewCompat.MEASURED_SIZE_MASK), i9, f9);
    }
    ...
    public final void A05(TextView textView) {
        ...
        int i9 = A08;
        buttonBackgroundPressed.setCornerRadius(i9);
        int i10 = A07;
        buttonBackgroundPressed.setStroke(i10, this.A02);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(this.A03);
        gradientDrawable.setCornerRadius(i9);
        gradientDrawable.setStroke(i10, this.A02);
        StateListDrawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{R.attr.state_pressed}, gradientDrawable);
        stateListDrawable.addState(new int[0], buttonBackgroundPressed);
        AbstractC1303Lo.A0S(textView, stateListDrawable);
    ...
    public final void A09(AdOptionsView adOptionsView, int i9) {
        adOptionsView.setIconColor(this.A04);
        adOptionsView.setIconSizeDp(i9);
    }
    ...
    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setCTABorderColor(int i9) {
        this.A02 = i9;
    }
