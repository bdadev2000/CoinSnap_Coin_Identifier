...
public final class C08442h extends Drawable {
    ...
    public C08442h(ColorStateList colorStateList, float f9) {
        this.A01 = f9;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = C08462j.A01(this.A00, this.A01, this.A07);
            float vInset = C08462j.A00(this.A00, this.A01, this.A07);
    ...
    public final void A06(float f9) {
        if (f9 == this.A01) {
            return;
        }
        this.A01 = f9;
    ...
    public final void A07(float f9, boolean z8, boolean z9) {
        if (f9 == this.A00) {
    ...
    public final boolean onStateChange(int[] iArr) {
        ...
        boolean z8 = colorForState != newColor;
        if (z8) {
