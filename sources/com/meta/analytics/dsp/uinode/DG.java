...
public final class DG {
    ...
    public DG(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z8, boolean z9, boolean z10) {
        this.A02 = (String) AbstractC1192Ha.A01(str);
        this.A01 = str2;
        this.A00 = codecCapabilities;
        this.A04 = z8;
        boolean z11 = true;
        this.A03 = (z9 || codecCapabilities == null || !A07(codecCapabilities)) ? false : true;
        this.A06 = codecCapabilities != null && A0B(codecCapabilities);
        if (!z10 && (codecCapabilities == null || !A09(codecCapabilities))) {
            z11 = false;
        }
        this.A05 = z11;
    }

    public static int A00(String str, String str2, int i9) {
        int i10;
        if (i9 > 1 || (IF.A02 >= 26 && i9 > 0)) {
            return i9;
        }
        ...
        Log.w(A03(54, 14, 111), A03(9, 29, 122) + str + A03(6, 3, 52) + i9 + A03(0, 4, 49) + i10 + A03(79, 1, 119));
        return i10;
    }
    ...
    public static DG A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z8, boolean z9) {
        return new DG(str, str2, codecCapabilities, false, z8, z9);
    }
    ...
    public static boolean A0D(MediaCodecInfo.VideoCapabilities videoCapabilities, int i9, int i10, double d2) {
        if (d2 == -1.0d || d2 <= 0.0d) {
    ...
    public final Point A0E(int i9, int i10) {
        ...
        int heightAlignment2 = IF.A04(i9, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, IF.A04(i10, heightAlignment) * heightAlignment);
    }

    public final boolean A0F(int i9) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(285, 17, 41));
            return false;
        ...
        if (A00(this.A02, this.A01, audioCapabilities.getMaxInputChannelCount()) < i9) {
            A06(A03(302, 22, 80) + i9);
            return false;
        }
        return true;
    }

    public final boolean A0G(int i9) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
        ...
        if (!audioCapabilities.isSampleRateSupported(i9)) {
            A06(A03(386, 20, 66) + i9);
            return false;
        }
        return true;
    }

    public final boolean A0H(int i9, int i10, double d2) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(421, 16, 101));
            return false;
        ...
        if (!A0D(videoCapabilities, i9, i10, d2)) {
            String A03 = A03(513, 1, 73);
            if (i9 >= i10 || !A0D(videoCapabilities, i10, i9, d2)) {
                A06(A03(458, 21, 100) + i9 + A03 + i10 + A03 + d2);
                return false;
            }
            A05(A03(437, 21, 29) + i9 + A03 + i10 + A03 + d2);
            return true;
        }
        return true;
    }
    ...
    public final boolean A0I(String str) {
        ...
        String A05 = AbstractC1210Hs.A05(str);
        if (A08[4].charAt(25) != 'Z') {
            String[] strArr = A08;
