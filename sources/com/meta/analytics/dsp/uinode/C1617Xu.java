...
public final class C1617Xu implements InterfaceC1031Ab {
    ...
    public ByteBuffer A08 = InterfaceC1031Ab.A00;
    public int A01 = -1;
    public int A04 = -1;
    ...
    private int A00(long j7) {
        return (int) ((this.A04 * j7) / 1000000);
    }
    ...
    */
    private int A01(java.nio.ByteBuffer r5) {
        ...
        L6:
            ...
            int r3 = r3 * r0
            int r3 = r3 + r0
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1617Xu.A0E
            r0 = 4
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        L44:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1617Xu.A01(java.nio.ByteBuffer):int");
    }
    ...
    */
    private int A02(java.nio.ByteBuffer r4) {
        ...
        L1f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1617Xu.A02(java.nio.ByteBuffer):int");
    }

    private void A03(int i9) {
        if (this.A07.capacity() < i9) {
            this.A07 = ByteBuffer.allocateDirect(i9).order(ByteOrder.nativeOrder());
        } else {
            this.A07.clear();
        }
        if (i9 > 0) {
    ...
    private void A05(ByteBuffer byteBuffer) {
        ...
        int i9 = this.A02 + maybeSilenceInputSize;
        this.A02 = i9;
        byte[] bArr2 = this.A0C;
        if (i9 == bArr2.length) {
            if (this.A0A) {
                ...
                this.A06 = j7 + ((noisePosition4 - (this.A03 * 2)) / this.A00);
            } else {
                this.A06 += (i9 - this.A03) / this.A00;
            }
    ...
    private void A07(ByteBuffer byteBuffer) {
        ...
        int limit2 = this.A00;
        this.A06 = j7 + (noisyPosition / limit2);
        byte[] bArr = this.A0D;
        int limit3 = this.A03;
    ...
    private void A08(ByteBuffer byteBuffer, byte[] bArr, int i9) {
        int min = Math.min(byteBuffer.remaining(), this.A03);
        int i10 = this.A03 - min;
        System.arraycopy(bArr, i9 - i10, this.A0D, 0, i10);
        int fromInputSize = byteBuffer.limit();
        byteBuffer.position(fromInputSize - min);
        byteBuffer.get(this.A0D, i10, min);
    }

    private void A09(byte[] bArr, int i9) {
        A03(i9);
        this.A07.put(bArr, 0, i9);
        this.A07.flip();
        this.A08 = this.A07;
    }
    ...
    public final boolean A91() {
        return this.A0B && this.A08 == InterfaceC1031Ab.A00;
    }
    ...
    public final void flush() {
        if (A8w()) {
            ...
            int i9 = A002 * maybeSilenceBufferSize2;
            this.A03 = i9;
            int maybeSilenceBufferSize3 = this.A0D.length;
            if (maybeSilenceBufferSize3 != i9) {
                this.A0D = new byte[i9];
            }
        }
        this.A05 = 0;
        this.A08 = InterfaceC1031Ab.A00;
        this.A0B = false;
        this.A06 = 0L;
        this.A02 = 0;
        this.A0A = false;
