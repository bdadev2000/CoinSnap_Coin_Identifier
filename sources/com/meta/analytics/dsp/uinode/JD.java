...
public final class JD {
    ...
    public static void A04() {
        A00 = new byte[]{57, 43, 89, 112, -126, 43, -127, 108, 119, Byte.MIN_VALUE, 112, 69, 43, 96, 111, 87, 124, -122, -125, 116, -121, 118, 123, 124, -127, 122, 51, Ascii.DEL, -126, 118, 116, Ascii.DEL, 51, 118, -126, -120, -127, -121, 120, -123, -122, 77, 51, 122, -97, -108, -93, -106, -98, -106, -97, -91, -102, -97, -104, 81, -108, -96, -90, -97, -91, -106, -93, 107, 81, -56, -21, -33, -35, -24, -65, -21, -15, -22, -16, -31, -18, -17, 116, 119, 119, 124, -121, 124, -126, -127, 116, Ascii.DEL, 114, 124, -127, 121, -126, -43, -24, -24, -39, -31, -28, -24, -111, -113, -93, -107, -106, -94, -115, -109, -90, -111, -109, -98, -94, -105, -99, -100, -46, -34, -36, -99, -43, -48, -46, -44, -47, -34, -34, -38, -99, -48, -45, -30, -99, -69, -66, -78, -80, -69, -50, -78, -66, -60, -67, -61, -76, -63, -62, -103, -106, -87, -106, -42, -25, -42, -33, -27, -28, -49, -46, -58, -60, -49, -62, -58, -46, -40, -47, -41, -56, -43, -42, -121, 120, -112, -125, -122, 120, 123, -95, -94, -113, -111, -103, -94, -96, -113, -111, -109, -124, -122, 115, -123, -118, -127, 118, -37, -35, -54, -36, -31, -40, -51, -57, -53, -41, -52, -51};
    }
     ...
     */
    public static void A06(C09647f c09647f, RK rk, Map<String, ?> map) throws JSONException {
        ...
        A09(c09647f, hashMap2);
        C09828c A08 = c09647f.A08();
        ...
        rk.AE0(c09647f.A04().A73(), ry.A08(), new VN(c09647f));
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 2 out of bounds for length 2
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static void A09(C09647f c09647f, Map<String, String> map) {
        map.putAll(c09647f.A03().A4n());
    }
    ...
    public static void A05(C09647f c09647f) {
        if (A0B(c09647f)) {
            return;
        }
        synchronized (JD.class) {
            ...
            atomicInteger.set(1);
            ExecutorC1308Lt.A06.execute(new VO(c09647f));
        }
    }

    public static void A08(C09647f c09647f, String str) {
        int i9;
        int i10;
        if (A0B(c09647f)) {
            return;
        ...
        synchronized (JD.class) {
            if (A04.get() != 2) {
                ...
                SharedPreferences sharedPreferences = c09647f.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(116, 31, 104), c09647f), 0);
                i9 = sharedPreferences.getInt(str, 0) + 1;
                sharedPreferences.edit().putInt(str, i9).apply();
            }
            if (c09647f.A04().A8z()) {
                String str2 = A01(43, 22, 42) + str + A01(0, 13, 4) + i9;
            }
        }
    }

    public static boolean A0A(double d2, int i9) {
        return i9 <= 0 || d2 >= 1.0d / ((double) i9);
    }
    ...
    public static boolean A0B(C09647f c09647f) {
        ...
        return A0A(c09647f.A08().A00(), Ij.A0C(c09647f));
    }
}
