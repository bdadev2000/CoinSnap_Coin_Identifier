...
public class IL extends HandlerThread implements Handler.Callback {
    ...
    private void A03(int i9) {
        AbstractC1192Ha.A01(this.A01);
        this.A01.A09(i9);
        this.A02 = new DummySurface(this, this.A01.A07(), i9 != 0);
    }

    public final DummySurface A04(int i9) {
        start();
        this.A00 = new Handler(getLooper(), this);
        this.A01 = new RunnableC1202Hk(this.A00);
        boolean z8 = false;
        synchronized (this) {
            this.A00.obtainMessage(1, i9, 0).sendToTarget();
        ...
        if (runtimeException == null) {
            ...
            if (error == null) {
                return (DummySurface) AbstractC1192Ha.A01(this.A02);
            }
            throw error;
        }
