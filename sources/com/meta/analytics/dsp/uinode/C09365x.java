...
public final class C09365x implements RewardedVideoAdApi, Repairable {
    ...
    public C09365x(Context context, String str, Ad ad) {
        this.A00 = ad;
        String uuid = UUID.randomUUID().toString();
        C1636Yn A07 = C09155c.A07(context, uuid);
        this.A03 = A07;
        C0S A0E = A07.A0E();
        String adId = AdPlacementType.REWARDED_VIDEO.toString();
        A0E.A2s(adId, str);
        C2F c2f = new C2F(A07, str, ad, new C1707aZ());
        this.A01 = c2f;
        A07.A0L(this);
    ...
    public final C09375y buildLoadAdConfig() {
        return new C09375y(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C09385z buildShowAdConfig() {
        return new C09385z();
    }

    public final void A04() {
        if (C1225Ih.A1s(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0E().A2t();
    ...
    public final void A07(String str, AdExperienceType adExperienceType, boolean z8) {
        if (str == null) {
            this.A03.A0E().A2p();
        } else {
        ...
        this.A02.A0D(this.A00, str, adExperienceType, z8);
        this.A03.A0E().A2n();
    }
    ...
    public final void destroy() {
        AbstractC1255Jp.A05(A00(136, 7, 66), A00(48, 27, 119), A00(16, 8, 74));
        A04();
    }
    ...
    public final void loadAd() {
        AbstractC1255Jp.A05(A00(143, 6, 60), A00(75, 32, 89), A00(24, 8, 17));
        A07(null, null, true);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C09375y) rewardedVideoLoadAdConfig).A00();
    }
    ...
    public final boolean show() {
        AbstractC1255Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(0, 8, 62));
        return A08(new C09385z().withAppOrientation(-1).build());
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        AbstractC1255Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(8, 8, 108));
