...
public abstract class AbstractC1787br {
    ...
    public static final <T> void A02(Appendable appendable, T t9, GV<? super T, ? extends CharSequence> gv) {
        C1790bu.A07(appendable, A00(0, 6, 6));
        if (gv != null) {
            appendable.append(gv.A8v(t9));
            return;
        }
