...
public class C1344Nd extends WebViewClient {
    ...
    public C1344Nd(C1636Yn c1636Yn, WeakReference<InterfaceC1342Nb> weakReference, WeakReference<RE> weakReference2, WeakReference<C1295Lg> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C1515Ts> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z8) {
        this.A02 = c1636Yn;
    ...
    private void A03(int i9, CharSequence charSequence, long j7) {
        JSONObject jSONObject = new JSONObject();
        boolean z8 = charSequence != null;
        try {
            jSONObject.put(A01(160, 10, 14), i9);
            jSONObject.put(A01(170, 17, 63), charSequence);
            jSONObject.put(A01(202, 21, 64), z8);
            jSONObject.put(A01(g.STALE_CACHED_RESPONSE_VALUE, 22, 64), j7);
    ...
    public void A04(int i9, String str) {
        ...
        this.A02.A0E().AH6(i9, str);
        Date finishTime = new Date();
        long time = finishTime.getTime();
        Date finishTime2 = this.A00;
        A03(i9, str, time - finishTime2.getTime());
        if (this.A04.get() != null) {
            this.A04.get().ABW(i9, str);
        }
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (c1636Yn != null) {
            c1636Yn.A07().A9a(A01(306, 8, 32), C8A.A2a, new C8B(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
        ...
        if (path != null && scheme != null) {
            ...
            if (path2.length() != 8) {
                ...
                if (scheme.equals(A01)) {
                    ...
                    List<String> A09 = C09416c.A09(this.A02);
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AH8();
        this.A00 = new Date();
        new Handler().postDelayed(new C1516Tt(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A0u = C1225Ih.A0u(this.A02);
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        NY.A02(C8A.A2Z);
        InterfaceC1342Nb adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().AB4(str, new C1349Ni().A03(this.A07.get()).A02(this.A06.get()).A05());
            return true;
        }
        return true;
    }
