...
public final class C1629Yg implements InterfaceC09767w {
    ...
    public static void A03() {
        A04 = new byte[]{107, Ascii.DEL, 96, 112, 124, 106, 123, 123, 102, 97, 104, 124, 112, 100, 106, 118};
    }
    ...
    public C1629Yg(Context context, C7v c7v) {
        this.A00 = context;
        this.A02 = c7v;
    }

    private C09747t A00() {
        return C09747t.A00(KE.A00(this.A00).getString(A01(0, 16, 81), null));
    }

    private void A02() {
        this.A02.AAQ(new C1630Yh(this));
    }

    public final void A04(String[] strArr, Integer num, Integer num2) {
        C09747t c09747t = new C09747t(strArr, num, num2);
        C09747t newSettings = this.A01;
        if (c09747t.equals(newSettings)) {
            return;
        }
        this.A01 = c09747t;
        this.A03.set(true);
        ...
        C09747t newSettings2 = this.A01;
        edit.putString(A01(0, 16, 81), newSettings2.A07()).apply();
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC09767w
    public final C09747t A6i() {
        A02();
        return this.A01;
    }
    ...
    public final boolean A9F() {
        ...
        Set<String> A0W = C1225Ih.A0W(this.A00);
