...
public abstract class NY extends WebView {
    ...
    public NY(Activity activity, C1636Yn c1636Yn) {
        super(activity);
        A03(c1636Yn);
    }

    public NY(C1636Yn c1636Yn) {
        super(c1636Yn);
        A03(c1636Yn);
    }

    public static void A02(int i9) {
        C1635Ym context = AbstractC09637e.A00();
        if (context != null) {
            context.A07().A9a(A00(56, 8, 76), i9, new C8B(A00(35, 10, 98)));
        }
    }

    private void A03(C09647f c09647f) {
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        AbstractC1345Ne.A04(this);
        ...
        if (c09647f.A04().A8z() && Build.VERSION.SDK_INT >= 19) {
