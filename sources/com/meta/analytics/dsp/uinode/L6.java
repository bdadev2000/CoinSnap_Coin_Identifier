...
public abstract class L6 {
    ...
    */
    ...
    public static void A09(Context context) {
        ...
        A04 = L5.A03;
        Executors.newSingleThreadExecutor().execute(new C1533Uk(context));
    }

    public static void A0A(C09647f c09647f, Throwable th) {
        c09647f.A07().A9a(A06(38, 7, 69), C8A.A1c, new C8B(th));
    }
    ...
    public static boolean A0C(C09647f c09647f) {
        ...
        boolean z8 = true;
        try {
            xmlResourceParser = c09647f.getAssets().openXmlResourceParser(A06(0, 19, 71));
            loop0: while (true) {
                ...
                if (xmlResourceParser.getEventType() == 2 && (xmlResourceParser.getName().equals(A06(27, 11, 77)) || xmlResourceParser.getName().equals(A06(19, 8, 32)))) {
                    for (int i9 = 0; i9 < xmlResourceParser.getAttributeCount(); i9++) {
                        if (xmlResourceParser.getAttributeName(i9).equals(A06(58, 18, 89)) && !Boolean.parseBoolean(xmlResourceParser.getAttributeValue(i9))) {
                            z8 = false;
                            break loop0;
                        }
                    }
