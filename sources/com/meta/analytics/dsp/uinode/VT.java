...
public final class VT implements J1 {
    ...
    public VT(C1635Ym c1635Ym, J0 j02) {
        this.A07 = j02;
        this.A06 = c1635Ym;
        this.A04 = (ConnectivityManager) c1635Ym.getSystemService(A03(293, 12, 10));
        this.A08 = C1447Rc.A01(c1635Ym);
        this.A03 = Ij.A0K(c1635Ym);
        this.A02 = Ij.A0J(c1635Ym);
    }
    ...
    private void A08(long j7) {
        this.A05.postDelayed(this.A09, j7);
    }
        ...
        try {
            ...
            if (A8z && A4a.has(A03)) {
                ...
                for (int i9 = 0; i9 < jSONArray.length(); i9++) {
                    String str = A03(4, 19, 27) + i9 + A03(0, 3, 88) + jSONArray.get(i9);
                }
            }
            ...
            if (!TextUtils.isEmpty(A69) && ADz != null) {
                if (ADz.A83() != 200) {
                    ...
                    if (A0E[4].length() != 29) {
                        ...
                        if (A83 == 413 && C1225Ih.A22(this.A06)) {
                            this.A07.ACo();
                            A05();
                            return;
                        } else {
            ...
            if (C1225Ih.A1t(this.A06) && A4a.has(A03)) {
                this.A07.ABI(A4a.getJSONArray(A03));
            }
            A06();
        } catch (Exception e4) {
            if (this.A06.A04().A8z()) {
                Log.e(A0F, A03(23, 35, 54), e4);
            }
            A06();
        }
    }
