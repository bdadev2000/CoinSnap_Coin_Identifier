...
public final class C9E implements Closeable {
    ...
    private void A04(int i9, File file) throws IOException {
        C9A c9a = new C9A(file);
        c9a.A05();
        this.A02.addFirst(new C9D(i9, c9a));
    }
            ...
            if (!hashMap.isEmpty()) {
                ...
                while (fileNumber >= fileNumberToLoad) {
                    ...
                    try {
                        ...
                        c9c.AFG(String.format(Locale.US, A02(104, 62, 43), file2.getCanonicalPath(), Integer.valueOf(fileNumber)), e4);
    ...
    public final synchronized AnonymousClass92 A0A(int i9, int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        if (!this.A00) {
            for (C9D file : this.A02) {
                if (file.A00() == i9) {
                    return new AnonymousClass92(i9, file.A02(i10, bArr, i11, iArr, i12));
                }
            }
