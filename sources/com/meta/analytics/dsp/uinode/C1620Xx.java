...
public final class C1620Xx implements InterfaceC1031Ab {
    ...
    public static void A00(int i9, ByteBuffer byteBuffer) {
        float pcm32BitFloat = (float) (i9 * 4.656612875245797E-10d);
    ...
    public final boolean A4Q(int i9, int i10, int i11) throws C1030Aa {
        if (IF.A0b(i11)) {
            if (this.A01 == i9 && this.A00 == i10 && this.A02 == i11) {
                return false;
            }
            this.A01 = i9;
            this.A00 = i10;
    ...
    public final boolean A91() {
        if (this.A05) {
            ...
            if (byteBuffer == InterfaceC1031Ab.A00) {
                return true;
            }
        }
        return false;
