...
public final class C1G implements Serializable {
    ...
    public static String A01(int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < copyOfRange.length; i12++) {
            byte b = (byte) ((copyOfRange[i12] ^ i11) ^ 58);
            String[] strArr = A0B;
    ...
    public static C1G A00(JSONObject jSONObject) {
        ...
        C1I A0I = new C1I().A0J(jSONObject.optString(A01(496, 9, 21))).A0H(jSONObject.optLong(A01(472, 24, 61), -1L)).A0D(optInt).A0C(jSONObject.optInt(A01(274, 18, 10), Integer.MAX_VALUE)).A0I(C08131c.A01(jSONObject));
