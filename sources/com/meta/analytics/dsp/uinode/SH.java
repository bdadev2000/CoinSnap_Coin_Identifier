...
public final class SH extends FrameLayout implements QB {
    ...
    public SH(C1636Yn c1636Yn, NativeAd nativeAd, JR jr, JS js, O3 o3, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1636Yn);
        ArrayList<View> arrayList = new ArrayList<>();
        this.A07 = arrayList;
        this.A05 = nativeAd;
        this.A04 = mediaView;
        QC qc = new QC(c1636Yn, nativeAd, jr, o3, adOptionsView);
        this.A06 = qc;
        int i9 = A0C;
        qc.setPadding(i9, i9, i9, A0E);
    ...
    */
    ...
    private void A02(int i9) {
        AbstractC1303Lo.A0N(this.A04, i9 > A0B ? 0 : 8);
        AbstractC1303Lo.A0N(this.A03, i9 > A0A ? 0 : 8);
        AbstractC1303Lo.A0N(this.A00, i9 <= A09 ? 8 : 0);
    }

    public static void A03(int i9, int i10, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int A04 = AbstractC1303Lo.A04(textView, i10);
                textView.setLines(A04 + 1);
                textView.measure(i9, View.MeasureSpec.makeMeasureSpec(textView.getMeasuredHeight() + (textView.getLineHeight() * A04), 1073741824));
                i10 -= textView.getLineHeight() * A04;
            }
        }
    }
    ...
    private void A06(JR jr) {
        if (this.A05.getAdHeadline() != null && !this.A05.getAdHeadline().trim().isEmpty()) {
            ...
            TextView textView2 = this.A02;
            int i9 = A0C;
            textView2.setPadding(i9, A0D, i9, 0);
    ...
    private void A07(JR jr) {
        if (this.A05.getAdLinkDescription() != null && !this.A05.getAdLinkDescription().trim().isEmpty()) {
            ...
            int i9 = A0C;
            textView2.setPadding(i9, 0, i9, A0D);
    ...
    public final void onLayout(boolean z8, int i9, int i10, int i11, int i12) {
        ...
        if (textView3 != null) {
            ...
            if (top9 == 0) {
                ...
                textView4.layout(i9, i14, i11, top10 + i14);
            }
        }
        ...
        if (textView5 != null) {
            ...
            textView5.layout(i9 + i15, (i12 - top11) - i15, i11 - i15, i12 - i15);
        }
    }
    ...
    */
    public final void onMeasure(int r5, int r6) {
        ...
        L46:
            ...
            com.facebook.ads.redexgen.X.ZH r0 = (com.meta.analytics.dsp.uinode.ZH) r0
            boolean r0 = r0.A0N()
            if (r0 == 0) goto L56
            r0 = r2
            goto L22
        L56:
            ...
            goto L22
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.SH.onMeasure(int, int):void");
    }
