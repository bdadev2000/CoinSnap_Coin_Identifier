...
public final class QC extends LinearLayout {
    ...
    public QC(C1636Yn c1636Yn, NativeAd nativeAd, JR jr, O3 o3, AdOptionsView adOptionsView) {
        super(c1636Yn);
        setOrientation(0);
        o3.setFullCircleCorners(true);
        int i9 = A00;
        LinearLayout.LayoutParams iconViewParams = new LinearLayout.LayoutParams(i9, i9);
        ...
        TextView sponsoredTextView = new TextView(c1636Yn);
