...
public final class C5A extends AbstractC1072Bq {
    ...
    public int A02;
    public int A03;
    public List<C1155Fn> A05;
    public List<C1155Fn> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final C1217Hz A0A = new C1217Hz();
    public final ArrayList<C1162Fu> A0B = new ArrayList<>();
    public C1162Fu A04 = new C1162Fu(0, 4);
    ...
    private List<C1155Fn> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i9 = 0; i9 < this.A0B.size(); i9++) {
            C1155Fn A05 = this.A0B.get(i9).A05();
            if (A05 != null) {
                arrayList.add(A05);
            }
        }
    ...
    private void A0A(byte b, byte b8) {
        int i9 = A0G[b & 7];
        int row = b8 & 32;
        int row2 = row != 0 ? 1 : 0;
        if (row2 != 0) {
        ...
        if (i9 != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i10 = this.A02;
                int row5 = this.A03;
                C1162Fu c1162Fu = new C1162Fu(i10, row5);
                this.A04 = c1162Fu;
                this.A0B.add(c1162Fu);
            }
            this.A04.A0C(i9);
        }
        int cursorOrStyle = (b8 & Ascii.DLE) == 16 ? 1 : 0;
        int row6 = b8 & 1;
        boolean isCursor = row6 == 1;
        int row7 = b8 >> 1;
        int i11 = row7 & 7;
        C1162Fu c1162Fu2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i11;
        c1162Fu2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C1162Fu c1162Fu3 = this.A04;
            int row9 = A0F[i11];
            c1162Fu3.A0B(row9);
        }
    }
    ...
    */
    ...
    public static boolean A0F(byte b, byte b8) {
        return (b & 247) == 17 && (b8 & 240) == 32;
    }

    public static boolean A0G(byte b, byte b8) {
        return (b & 247) == 20 && (b8 & 240) == 32;
    }

    public static boolean A0H(byte b, byte b8) {
        return (b & 240) == 16 && (b8 & 192) == 64;
    }

    public static boolean A0I(byte b, byte b8) {
        return (b & 247) == 23 && b8 >= 33 && b8 <= 35;
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq
    /* renamed from: A0L */
    public final /* bridge */ /* synthetic */ C5 A54() throws C1157Fp {
        return super.A54();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq
    /* renamed from: A0M */
    public final /* bridge */ /* synthetic */ AbstractC1073Br A55() throws C1157Fp {
        return super.A55();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq
    public final WI A0N() {
        List<C1155Fn> list = this.A05;
        this.A06 = list;
        return new WI(list);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq
    /* renamed from: A0O */
    public final /* bridge */ /* synthetic */ void AEG(C5 c52) throws C1157Fp {
        super.AEG(c52);
    }
    ...
    public final void A0P(C5 c52) {
        ...
        while (true) {
            ...
            if (A04 >= i10) {
                ...
                if ((ccData2 & 6) == 4 && ((i9 = this.A09) != 1 || (ccData2 & 1) == 0)) {
                    if (i9 != 2 || (ccData2 & 1) == 1) {
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq, com.meta.analytics.dsp.uinode.BB
    public final void AEV() {
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC1072Bq, com.meta.analytics.dsp.uinode.WL
    public final /* bridge */ /* synthetic */ void AGB(long j7) {
        super.AGB(j7);
    }
