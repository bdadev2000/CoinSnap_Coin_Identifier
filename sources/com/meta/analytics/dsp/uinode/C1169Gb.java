...
public class C1169Gb implements Parcelable.Creator<DefaultTrackSelector$SelectionOverride> {
    ...
    public final DefaultTrackSelector$SelectionOverride[] newArray(int i9) {
        return new DefaultTrackSelector$SelectionOverride[i9];
    }
}
