...
public final class TextureViewSurfaceTextureListenerC1261Jv extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC1438Qt, R9, InterfaceC1440Qv {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C1225Ih.A1X(this.A0A) && this.A0D != RB.A08) {
            if (!this.A0L) {
                this.A0L = true;
                this.A0A.A0E().AFY();
            }
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC1261Jv.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC1261Jv(C1636Yn c1636Yn) {
        super(c1636Yn);
        this.A0D = RB.A04;
        this.A0E = RB.A04;
        this.A0M = false;
    ...
    public TextureViewSurfaceTextureListenerC1261Jv(C1636Yn c1636Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC1261Jv(C1636Yn c1636Yn, AttributeSet attributeSet, int i9) {
    ...
    */
    private void A04() {
        /*
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1261Jv.A0P
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            ...
            throw r0
        L38:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1261Jv.A0P
        ...
        Lbc:
            ...
            goto L65
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC1261Jv.A04():void");
    }

    private void A05() {
        C1441Qw c1441Qw = this.A0C;
        if (c1441Qw == null) {
            return;
        }
        C1439Qu A08 = c1441Qw.A08();
        String[] strArr = A0P;
    ...
    private void A08(int i9, int i10) {
    ...
    public final boolean A8b() {
        C1441Qw c1441Qw = this.A0C;
        return c1441Qw != null && c1441Qw.A0K();
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC1438Qt
    ...
    public final void ACf(boolean z8, int i9) {
        ...
        switch (i9) {
            ...
            case 3:
                ...
                long j7 = this.A05;
                if (j7 > 0 && j7 < this.A0C.A07()) {
                    this.A0C.A0D(this.A05);
                    this.A05 = 0L;
                }
                if (this.A0C.A06() != 0 && !z8 && this.A0N) {
                    setVideoState(RB.A05);
                    return;
                }
                if (z8 || this.A0D == RB.A06) {
                    return;
                }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC1440Qv
    ...
    @Override // com.meta.analytics.dsp.uinode.R9
    public final void AGS(QM qm, int i9) {
        this.A0A.A0E().A3E(i9);
        this.A0M = false;
        this.A0E = RB.A0A;
        this.A0B = qm;
    ...
    public final void onAttachedToWindow() {
        ...
        if (C1225Ih.A2D(getContext()) && !isHardwareAccelerated()) {
            setVideoState(RB.A03);
            AGZ(8);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z8) {
        ...
        if (!z8) {
            if (this.A0D != RB.A05) {
                if ((this.A0A.A0F().A01() || C1225Ih.A1c(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.R1
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextureViewSurfaceTextureListenerC1261Jv.this.A0A();
                        }
                    }, 1000L);
                    return;
                } else {
