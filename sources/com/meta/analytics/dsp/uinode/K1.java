...
public final class K1 {
    ...
    public K1(C09647f c09647f, String str, LQ lq, EnumC1246Jg enumC1246Jg, int i9, C1251Jl c1251Jl, String str2, String str3, String str4, C8Z c8z) {
        this.A01 = c09647f;
        this.A06 = str;
        this.A03 = lq;
        this.A02 = enumC1246Jg;
        this.A00 = i9;
        this.A0B = c1251Jl;
        this.A0A = enumC1246Jg.A04();
        this.A07 = str2;
        this.A05 = str3;
        this.A04 = str4;
        this.A09 = c8z;
    ...
    public final Map<String, String> A09(Map<String, String> map) {
        ...
        EnumC1246Jg enumC1246Jg = this.A02;
        if (enumC1246Jg != null) {
            A03(hashMap, A01(NotificationCompat.FLAG_LOCAL_ONLY, 11, 36), String.valueOf(enumC1246Jg.A03()));
        }
        C8Z c8z = this.A09;
        ...
        if (idfaFlag2.charAt(22) == strArr[3].charAt(22)) {
            ...
            if (i9 != 0) {
                ...
                A03(hashMap, idfaFlag4, String.valueOf(i9));
            }
            boolean z8 = this.A08;
            if (z8) {
                String idfaFlag5 = A01(138, 22, 92);
                A03(hashMap, idfaFlag5, String.valueOf(z8));
            }
            A03(hashMap, A01(160, 13, 80), String.valueOf(C1304Lp.A02(this.A01)));
            A03(hashMap, A01(233, 12, 126), C1294Lf.A05(System.currentTimeMillis()));
            ...
            A03(hashMap, A01(20, 36, 122), C1294Lf.A06(A00()));
