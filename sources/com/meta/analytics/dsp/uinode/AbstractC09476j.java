...
public abstract class AbstractC09476j extends EM {
    ...
    public Format A07;
    public InterfaceC1057Bb<FrameworkMediaCrypto> A08;
    public InterfaceC1057Bb<FrameworkMediaCrypto> A09;
    public DG A0A;
    ...
    public final C10199p A0W;
    public final C1614Xr A0X;
    public final C1614Xr A0Y;
    public final InterfaceC1058Bc<FrameworkMediaCrypto> A0Z;
    public final DM A0a;
    public final List<Long> A0b;
    public final boolean A0c;

    public static String A0Z(int i9, int i10, int i11) {
        byte[] copyOfRange = Arrays.copyOfRange(A0d, i9, i9 + i10);
        for (int i12 = 0; i12 < copyOfRange.length; i12++) {
            int i13 = (copyOfRange[i12] ^ i11) ^ 57;
            if (A0e[5].length() == 20) {
    ...
    public static void A0j() {
        A0d = new byte[]{85, 89, Ascii.ESC, Ascii.FF, Ascii.CR, 89, Ascii.ETB, Ascii.SYN, 89, 10, Ascii.FS, Ascii.SUB, Ascii.FF, Ascii.VT, Ascii.FS, 89, Ascii.GS, Ascii.FS, Ascii.SUB, Ascii.SYN, Ascii.GS, Ascii.FS, Ascii.VT, 89, Ascii.CAN, Ascii.SI, Ascii.CAN, Ascii.DLE, Ascii.NAK, Ascii.CAN, Ascii.ESC, Ascii.NAK, Ascii.FS, 87, 89, 45, Ascii.VT, 0, Ascii.DLE, Ascii.ETB, Ascii.RS, 89, Ascii.CR, Ascii.SYN, 89, 9, Ascii.VT, Ascii.SYN, Ascii.SUB, Ascii.FS, Ascii.FS, Ascii.GS, 89, Ascii.SO, Ascii.DLE, Ascii.CR, 17, 89, 19, 106, 106, 106, 106, 106, 107, 108, 109, 110, 104, Ascii.EM, 106, 106, Ascii.CAN, Ascii.RS, Ascii.ESC, 104, 111, 99, 106, 106, 106, 106, 106, 106, 107, 108, 98, Ascii.EM, Ascii.US, 106, Ascii.FS, 107, 105, 104, 106, 106, 106, 106, 106, 106, 107, 108, 111, 98, 98, 98, 110, 106, Ascii.RS, Ascii.EM, Ascii.US, 109, 107, 107, 98, Ascii.ESC, 106, 106, 106, 104, Ascii.FS, Ascii.CAN, Ascii.FS, 107, Ascii.EM, 105, 107, Ascii.EM, 105, 104, 109, 111, Ascii.RS, 109, 98, 107, 108, 126, 121, 3, 47, 35, 56, 45, 44, 93, 107, 116, 57, 106, 124, 106, 106, 112, 118, 119, 57, 107, 124, 104, 108, 112, 107, 124, 106, 57, 106, 124, 122, 108, 107, 124, 57, 125, 124, 122, 118, 125, 124, 107, 57, Ascii.DEL, 118, 107, 57, Ascii.ESC, 51, 50, 63, 55, 118, 36, 51, 39, 35, 63, 36, 51, 37, 118, 55, 118, Ascii.DC2, 36, 59, 5, 51, 37, 37, 63, 57, 56, Ascii.ESC, 55, 56, 55, 49, 51, 36, 9, 33, 32, 45, 37, 7, 43, 32, 33, 39, Ascii.SYN, 33, 42, 32, 33, 54, 33, 54, 69, 71, 82, 36, 79, 114, 115, 100, 101, 121, 36, 107, 124,
, 113, 107, Ascii.VT, 7, 6, Ascii.SO, 1, Ascii.SI, Ascii.GS, Ascii.SUB, Ascii.CR, 43, 7, Ascii.FF, Ascii.CR, Ascii.VT, 4, Ascii.NAK, 2, 6, 19, 2, 36, 8, 3, 2, 4, 93, 122, 108, Ascii.DEL, 119, 112, 95, 112, 122, 88, 123, 123, 122, Ascii.RS, Ascii.DC4, Ascii.ETB, Ascii.CR, Ascii.SYN, Ascii.FS, Ascii.GS, 10, 57, 51, 48, 42, 49, 59, 58, 45, 0, 51, 43, 58, 107, 105, 120, 65, 105, 104, 101, 109, 79, 126, 117, 124, 120, 99, 1, 3, Ascii.DC2, 53, Ascii.DC2, 7, Ascii.DC2, 3, 79, 90, 71, 93, 88, 77, 90, 62, 52, 100, 102, 102, 102, 102, 107, 103, 105, 102, 122, 68, 83, 90, 83, 87, 69, 83, 101, 83, 69, 69, 95, 89, 88, 55, 48, 37, 54, 48, 7, 43, 32, 33, 39, 104, 117, 112, 125, 108, 117, 125, 73, 87, 90, 74, 86};
    }

    public abstract int A1B(MediaCodec mediaCodec, DG dg, Format format, Format format2);

    public abstract int A1C(DM dm, InterfaceC1058Bc<FrameworkMediaCrypto> interfaceC1058Bc, Format format) throws DP;

    public abstract void A1L(MediaCodec mediaCodec, MediaFormat mediaFormat) throws C10079c;

    public abstract void A1N(C1614Xr c1614Xr);

    public abstract void A1O(DG dg, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws DP;

    public abstract void A1P(String str, long j7, long j9);

    public abstract boolean A1Q(long j7, long j9, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i9, int i10, long j10, boolean z8) throws C10079c;
    ...
    public AbstractC09476j(int i9, DM dm, InterfaceC1058Bc<FrameworkMediaCrypto> interfaceC1058Bc, boolean z8) {
        super(i9);
        AbstractC1192Ha.A04(IF.A02 >= 16);
        this.A0a = (DM) AbstractC1192Ha.A01(dm);
        this.A0Z = interfaceC1058Bc;
        this.A0c = z8;
        this.A0X = new C1614Xr(0);
        this.A0Y = C1614Xr.A02();
        this.A0W = new C10199p();
    ...
    public static MediaCodec.CryptoInfo A0Y(C1614Xr c1614Xr, int i9) {
        MediaCodec.CryptoInfo A02 = c1614Xr.A02.A02();
        if (i9 == 0) {
            return A02;
        }
    ...
    private ByteBuffer A0a(int i9) {
        if (IF.A02 >= 21) {
            return this.A06.getInputBuffer(i9);
        }
        ByteBuffer byteBuffer = this.A0S[i9];
        String[] strArr = A0e;
    ...
    private ByteBuffer A0b(int i9) {
        if (IF.A02 >= 21) {
            return this.A06.getOutputBuffer(i9);
        }
        return this.A0T[i9];
    }
    ...
    private void A0d() throws C10079c {
        if (this.A02 == 2) {
            A1H();
            A1J();
        } else {
    ...
    private void A0f() throws C10079c {
    ...
    private void A0k(DI di) throws C10079c {
        throw C10079c.A01(di, A0z());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x0169, code lost:
        ...
        throw com.meta.analytics.dsp.uinode.C10079c.A01(r1, A0z());
     */
    ...
    */
    private boolean A0l() throws com.meta.analytics.dsp.uinode.C10079c {
        /*
            Method dump skipped, instructions count: 573
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC09476j.A0l():boolean");
    }
    ...
    private boolean A0n(long j7) {
        int size = this.A0b.size();
        for (int i9 = 0; i9 < size; i9++) {
            if (this.A0b.get(i9).longValue() == j7) {
                this.A0b.remove(i9);
                int i10 = A0e[1].charAt(18);
                if (i10 != 119) {
                    throw new RuntimeException();
                }
    ...
    private boolean A0o(long j7, long j9) throws C10079c {
        ...
        if (!A0m()) {
            ...
            if (dequeueOutputBuffer >= 0) {
                ...
                if (A0b != null) {
                    ...
                    int i9 = this.A0V.offset;
                    int outputIndex4 = this.A0V.size;
                    int i10 = i9 + outputIndex4;
                    if (A0e[2].length() != 1) {
                        String[] strArr = A0e;
        ...
        if (this.A0F && this.A0K) {
            try {
                processedOutputBuffer = A1Q(j7, j9, this.A06, this.A0B, this.A04, this.A0V.flags, this.A0V.presentationTimeUs, this.A0P);
    ...
    */
    public static boolean A0p(com.meta.analytics.dsp.uinode.DG r4) {
        ...
        L28:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.AbstractC09476j.A0e
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 20
            if (r1 == r0) goto L6b
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC09476j.A0e
        ...
        L6b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC09476j.A0p(com.facebook.ads.redexgen.X.DG):boolean");
    }
    ...
    private boolean A0v(boolean z8) throws C10079c {
        if (0 == 0 || (!z8 && this.A0c)) {
            return false;
        }
    ...
    @Override // com.meta.analytics.dsp.uinode.EM
    public void A16(long j7, boolean z8) throws C10079c {
        this.A0M = false;
        this.A0N = false;
        if (this.A06 != null) {
            A1G();
    ...
    public DG A1F(DM dm, Format format, boolean z8) throws DP {
        return dm.A6m(format.A0O, z8);
    }

    public void A1G() throws C10079c {
    ...
    */
    public void A1H() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC09476j.A1H():void");
    }

    public void A1I() throws C10079c {
    }

    public final void A1J() throws C10079c {
        Format format;
        long j7;
        ...
        if (this.A0A == null) {
            try {
                ...
                A0k(new DI(this.A07, (Throwable) e4, false, -49998));
                throw null;
            }
        }
        if (!A1R(this.A0A)) {
        ...
        try {
            ...
            A0c();
            if (A81() == 2) {
                j7 = SystemClock.elapsedRealtime() + 1000;
            } else {
                j7 = C.TIME_UNSET;
            }
            this.A05 = j7;
            ...
            A0k(new DI(this.A07, (Throwable) e9, false, str2));
            throw null;
        }
    }

    public void A1K(long j7) {
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1M(com.facebook.ads.internal.exoplayer2.thirdparty.Format r7) throws com.meta.analytics.dsp.uinode.C10079c {
        /*
            r6 = this;
        ...
        Lad:
            ...
            goto Lac
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC09476j.A1M(com.facebook.ads.internal.exoplayer2.thirdparty.Format):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00b9, code lost:
        ...
        com.meta.analytics.dsp.uinode.AbstractC1192Ha.A04(r6.A0Y.A04());
        r6.A0M = true;
        A0d();
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void AFB(long r7, long r9) throws com.meta.analytics.dsp.uinode.C10079c {
        /*
            Method dump skipped, instructions count: 218
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC09476j.AFB(long, long):void");
    }

    @Override // com.meta.analytics.dsp.uinode.AA
    public final int AGe(Format format) throws C10079c {
        try {
