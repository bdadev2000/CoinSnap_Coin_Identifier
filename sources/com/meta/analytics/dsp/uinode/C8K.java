...
public final class C8K {
    ...
    public C8K(C09647f c09647f) {
        this(c09647f, null);
    }

    public C8K(C09647f c09647f, String str) {
        this.A00 = c09647f;
        this.A01 = str;
    }
    ...
    private String A00() {
        ...
        PendingIntent activity = PendingIntent.getActivity(this.A00, 0, new Intent(), i9);
        if (activity == null) {
            return A01(0, 0, 80);
        }
    ...
    public final int A04() {
        try {
            ...
            this.A00.A07().A9a(A01(45, 7, 22), C8A.A1M, new C8B(t9));
            return 0;
        }
    }
