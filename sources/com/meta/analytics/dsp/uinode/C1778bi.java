...
public final class C1778bi implements C0K {
    ...
    static {
        A04();
        A07 = C1778bi.class.getSimpleName();
    }

    public C1778bi(String str) {
        this(str, C0I.A01(str));
    }

    public C1778bi(String str, int i9) {
        this(str);
        this.A00 = i9;
    }

    public C1778bi(String str, String str2) {
    ...
    private int A00(HttpURLConnection httpURLConnection, int i9, int i10) throws IOException {
        int contentLength = httpURLConnection.getContentLength();
        return i10 == 200 ? contentLength : i10 == 206 ? contentLength + i9 : this.A05;
    }

    private HttpURLConnection A02(int i9, int i10) throws IOException, C1780bk {
        HttpURLConnection httpURLConnection;
        int code;
        int i11 = 0;
        String str = this.A03;
        do {
            String str2 = A01(234, 16, 102) + (i9 > 0 ? A01(19, 13, 86) + i9 : A01(0, 0, 78)) + A01(15, 4, 66) + str;
            httpURLConnection = (HttpURLConnection) new URL(str).openConnection();
            if (i9 > 0) {
                httpURLConnection.setRequestProperty(A01(250, 5, 60), A01(322, 6, 127) + i9 + A01(50, 1, 18));
            }
            if (i10 > 0) {
            ...
            if (i11 > 5) {
                String url2 = A01(293, 20, 106) + i11;
                throw new C1780bk(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C1780bk {
        String[] strArr;
        ...
        try {
            try {
                ...
                Log.e(A07, A01(129, 25, 77) + this.A03, e4);
                C0I.A05(inputStream);
    ...
    private final void A05(int i9, int i10) throws C1780bk {
        try {
            HttpURLConnection A02 = A02(i9, i10);
            this.A02 = A02;
            this.A06 = A02.getContentType();
            this.A01 = new BufferedInputStream(this.A02.getInputStream(), FragmentTransaction.TRANSIT_EXIT_MASK);
            HttpURLConnection httpURLConnection = this.A02;
            this.A05 = A00(httpURLConnection, i9, httpURLConnection.getResponseCode());
        } catch (IOException e4) {
            throw new C1780bk(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i9, e4);
        }
    }
    ...
    public final void close() throws C1780bk {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1780bk(A01(92, 37, 93), e4);
            }
        }
    }

    @Override // com.meta.analytics.dsp.uinode.C0K
    public final synchronized int length() throws C1780bk {
    ...
    public final int read(byte[] bArr) throws C1780bk {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new GF(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e4);
            } catch (IOException e9) {
                throw new C1780bk(A01 + this.A03, e9);
            }
        }
        throw new C1780bk(A01 + this.A03 + A01(51, 23, 21));
    }
