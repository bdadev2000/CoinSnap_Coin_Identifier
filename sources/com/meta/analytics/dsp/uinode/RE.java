...
public final class RE {
    ...
    */
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static RF A0E(View view, int i9, C1636Yn c1636Yn) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new RF(C0Q.A08);
        }
        boolean A2H = C1225Ih.A2H(c1636Yn);
        ...
        if (A0H[4].charAt(15) == 'A') {
            ...
            try {
                ...
                if (A0H[1].length() == 16) {
                    ...
                    if (i10 >= 17) {
                        ((WindowManager) c1636Yn.getSystemService(A0H(594, 6, 109))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                    } else {
                    ...
                    Map<String, String> A012 = M6.A01(c1636Yn);
                    if (C1304Lp.A04(A012)) {
                        A0N(view, false, A0H(156, 29, 77));
                        return new RF(C0Q.A0A, A082);
                    }
                    if (C1225Ih.A1d(c1636Yn) && C1304Lp.A03(A012)) {
    ...
    public static String A0H(int i9, int i10, int i11) {
    ...
    public RE(View view, int i9, int i10, boolean z8, WeakReference<RD> weakReference, C1636Yn c1636Yn) {
    ...
    public RE(View view, int i9, WeakReference<RD> weakReference, C1636Yn c1636Yn) {
        this(view, i9, 0, false, weakReference, c1636Yn);
    }

    public RE(View view, int i9, boolean z8, WeakReference<RD> weakReference, C1636Yn c1636Yn) {
        this(view, i9, 0, z8, weakReference, c1636Yn);
    }
    ...
    public static int A01(int i9, View view) {
        int width = view.getWidth() * view.getHeight();
        float onePixelPercentage = width > 0 ? 100.0f / width : 100.0f;
        int viewArea = (int) Math.max(i9, Math.ceil(onePixelPercentage));
        return viewArea;
    }
    ...
    public static int A09(int[] iArr, int i9) {
        int i10 = 0;
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            boolean z8 = true;
            boolean z9 = !(childAt instanceof C1416Px);
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (RG.A00(view) || isTransparentToolbar)) {
            ...
            for (int i9 = 0; i9 < viewGroup.getChildCount(); i9++) {
                Vector<Rect> visibleRectInView = A0L(viewGroup.getChildAt(i9));
    ...
    public static void A0N(View view, boolean z8, String str) {
        if (BuildConfigApi.isDebug()) {
            String str2 = A0H(PsExtractor.VIDEO_STREAM_MASK, 5, 110) + view + A0H(9, 4, 108) + (z8 ? A0H(579, 8, 81) : A0H(565, 12, 121)) + A0H(13, 14, 76) + str;
        }
    }
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(592, 2, 68), C1294Lf.A05(this.A03));
    ...
    public final void A0Y(boolean z8) {
        this.A07 = z8;
    }
