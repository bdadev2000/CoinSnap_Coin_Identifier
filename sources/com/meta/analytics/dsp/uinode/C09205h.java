...
public final class C09205h implements MediaViewVideoRendererApi {
    ...
    public final AbstractC1380On A0B = new EW(this);
    public final AbstractC1321Mg A0E = new EV(this);
    public final AbstractC1413Pu A09 = new EU(this);
    public final MV A0F = new ET(this);
    public final AbstractC1411Ps A0A = new ES(this);
    public C09135a A02 = new C09135a();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1636Yn A11 = ((V2) nativeAd.getInternalNativeAd()).A11();
        C1636Yn adObjectContext = this.A03;
        adObjectContext.A0K(A11);
        C09215i c09215i = (C09215i) nativeAd.getNativeAdApi();
        this.A05.setClientToken(V2.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c09215i.A01());
        this.A05.setVideoURI(c09215i.A02());
        C1754bK A0y = V2.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (A0y != null) {
        ...
        this.A01 = c09215i.getVideoAutoplayBehavior();
        JM jm = this.A04;
        if (jm != null) {
            jm.AG8(nativeAd);
        }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0b(AbstractC1299Lk.A00(videoStartReason), 3);
        }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1636Yn) {
            ...
            A03 = C09155c.A03(context);
        }
        this.A03 = A03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C1056Ba(A03);
                break;
            case 1:
                this.A05 = new C1056Ba(A03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C1056Ba(A03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C1056Ba(A03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0b(AbstractC1299Lk.A00(videoStartReason), 2);
    }
    ...
    public final void setVolume(float f9) {
        this.A05.setVolume(f9);
    }

    @Override // com.facebook.ads.internal.api.MediaViewVideoRendererApi
    public final boolean shouldAutoplay() {
        C1056Ba c1056Ba = this.A05;
