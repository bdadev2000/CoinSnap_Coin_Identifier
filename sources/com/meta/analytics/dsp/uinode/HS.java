...
public final class HS {
    ...
    public HS(File file, byte[] bArr, boolean z8) {
        this.A07 = z8;
        if (bArr != null) {
            AbstractC1192Ha.A03(bArr.length == 16);
            try {
                this.A05 = A03();
        ...
        this.A03 = new C1194Hc(new File(file, A02(25, 24, 29)));
    }
    ...
    public final HU A0B(String str) {
        ...
        return cachedContent != null ? cachedContent.A05() : C1555Vh.A04;
    }

    public final String A0C(int i9) {
        return this.A02.get(i9);
    }
