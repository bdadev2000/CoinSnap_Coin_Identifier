...
public final class GM {
    ...
    public static int A00(int i9, String str, String str2, int i10) {
        if (str.isEmpty() || i9 == -1) {
            return i9;
        }
        if (str.equals(str2)) {
    ...
    public final GM A0B(int i9) {
        this.A01 = i9;
        this.A0E = true;
        return this;
    }

    public final GM A0C(int i9) {
        this.A03 = i9;
        this.A0F = true;
        return this;
    }
    ...
    public final GM A0E(boolean z8) {
        this.A02 = z8 ? 1 : 0;
        return this;
    }

    public final GM A0F(boolean z8) {
        this.A05 = z8 ? 1 : 0;
        return this;
    }

    public final GM A0G(boolean z8) {
        this.A07 = z8 ? 1 : 0;
        return this;
    }
