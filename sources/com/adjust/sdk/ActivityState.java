...
public class ActivityState implements Serializable, Cloneable {
    ...
    private static String stamp(long j3) {
    ...
    public int hashCode() {
        return Util.hashString(this.installVersionVivo) + e.a(this.installReferrerVivo, (Util.hashLong(Long.valueOf(this.installBeginVivo)) + ((Util.hashLong(Long.valueOf(this.clickTimeVivo)) + e.a(this.installReferrerSamsung, (Util.hashLong(Long.valueOf(this.installBeginSamsung)) + ((Util.hashLong(Long.valueOf(this.clickTimeSamsung)) + e.a(this.installVersionXiaomi, (Util.hashLong(Long.valueOf(this.installBeginServerXiaomi)) + ((Util.hashLong(Long.valueOf(this.clickTimeServerXiaomi)) + e.a(this.installReferrerXiaomi, (Util.hashLong(Long.valueOf(this.installBeginXiaomi)) + ((Util.hashLong(Long.valueOf(this.clickTimeXiaomi)) + e.a(this.installReferrerHuaweiAppGallery, e.a(this.installReferrerHuawei, (Util.hashLong(Long.valueOf(this.installBeginHuawei)) + ((Util.hashLong(Long.valueOf(this.clickTimeHuawei)) + e.a(this.installVersion, (Util.hashLong(Long.valueOf(this.installBeginServer)) + ((Util.hashLong(Long.valueOf(this.clickTimeServer)) + ((Util.hashBoolean(this.googlePlayInstant) + e.a(this.installReferrer, (Util.hashLong(Long.valueOf(this.installBegin)) + ((Util.hashLong(Long.valueOf(this.clickTime)) + e.a(this.adid, e.a(this.pushToken, (Util.hashObject(this.orderIds) + ((Util.hashBoolean(Boolean.valueOf(this.updatePackages)) + ((Util.hashLong(Long.valueOf(this.lastInterval)) + ((Util.hashLong(Long.valueOf(this.timeSpent)) + ((Util.hashLong(Long.valueOf(this.sessionLength)) + ((((((((Util.hashBoolean(Boolean.valueOf(this.askingAttribution)) + ((Util.hashBoolean(Boolean.valueOf(this.isThirdPartySharingDisabledForCoppa)) + ((Util.hashBoolean(Boolean.valueOf(this.isThirdPartySharingDisabled)) + ((Util.hashBoolean(Boolean.valueOf(this.isGdprForgotten)) + ((Util.hashBoolean(Boolean.valueOf(this.enabled)) + e.a(this.uuid, 629)) * 37)) * 37)) * 37)) * 37)) * 37) + this.eventCount) * 37) + this.sessionCount) * 37) + this.subsessionCount) * 37)) * 37)) * 37)) * 37)) * 37)) * 37))) * 37)) * 37)) * 37)) * 37)) * 37)) * 37)) * 37))) * 37)) * 37)) * 37)) * 37)) * 37)) * 37)) * 37)) * 37);
    }

    public void resetSessionAttributes(long j3) {
