...
public class AdjustAttribution implements Serializable {
    ...
    public int hashCode() {
        return Util.hashString(this.fbInstallReferrer) + e.a(this.costCurrency, (Util.hashDouble(this.costAmount) + e.a(this.costType, e.a(this.adid, e.a(this.clickLabel, e.a(this.creative, e.a(this.adgroup, e.a(this.campaign, e.a(this.network, e.a(this.trackerName, e.a(this.trackerToken, 629)))))))))) * 37);
    }
