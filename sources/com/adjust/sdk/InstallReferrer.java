...
public class InstallReferrer implements InvocationHandler {
    ...
    public class b implements Runnable {
        ...
        public final /* synthetic */ Method f2853b;
        ...
        public final void run() {
            try {
                InstallReferrer.this.invokeI(this.a, this.f2853b, this.f2854c);
            } catch (Throwable th2) {
    ...
    private Object createInstallReferrerClient(Context context) {
        try {
            ...
            this.logger.error("createInstallReferrerClient error (%s) from (%s)", e10.getMessage(), e10.getClass().getCanonicalName());
            return null;
        }
    }
    ...
    private void startConnection(Class cls, Object obj) {
        try {
            ...
            this.logger.error("startConnection error (%s) thrown by (%s)", e10.getMessage(), e10.getClass().getCanonicalName());
        }
    }
}
