...
public class PackageBuilder {
    ...
    public class a {
        ...
        public a(ActivityState activityState) {
            ...
            this.f2856b = activityState.sessionCount;
            this.f2857c = activityState.subsessionCount;
            this.f2858d = activityState.timeSpent;
            this.f2859e = activityState.lastInterval;
            this.f2860f = activityState.sessionLength;
            this.f2861g = activityState.uuid;
            this.f2862h = activityState.pushToken;
        }
    }

    public PackageBuilder(AdjustConfig adjustConfig, com.adjust.sdk.a aVar, ActivityState activityState, SessionParameters sessionParameters, long j3) {
        this.createdAt = j3;
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue, boolean z10) {
        ...
        addString(hashMap, "android_uuid", this.activityStateCopy.f2861g);
        addString(hashMap, "gps_adid", this.deviceInfo.a);
        addLong(hashMap, "gps_adid_attempt", this.deviceInfo.f2872c);
        addString(hashMap, "gps_adid_src", this.deviceInfo.f2871b);
        addBoolean(hashMap, "tracking_enabled", this.deviceInfo.f2873d);
        ...
        if (!containsPlayIds(hashMap) && !containsFireIds(hashMap)) {
            ...
            addString(hashMap, "android_id", this.deviceInfo.f2875f);
        }
        addString(hashMap, "api_level", this.deviceInfo.f2885p);
        addString(hashMap, "app_secret", this.adjustConfig.appSecret);
        addString(hashMap, "app_token", this.adjustConfig.appToken);
        addString(hashMap, "app_version", this.deviceInfo.f2879j);
        ...
        addString(hashMap, "country", this.deviceInfo.f2887r);
        addString(hashMap, "cpu_type", this.deviceInfo.f2893y);
        ...
        addString(hashMap, "device_manufacturer", this.deviceInfo.f2882m);
        addString(hashMap, "device_name", this.deviceInfo.f2881l);
        addString(hashMap, "device_type", this.deviceInfo.f2880k);
        addLong(hashMap, "ui_mode", this.deviceInfo.C);
        addString(hashMap, "display_height", this.deviceInfo.f2891w);
        addString(hashMap, "display_width", this.deviceInfo.f2890v);
        ...
        addString(hashMap, "fb_id", this.deviceInfo.f2876g);
        addString(hashMap, "hardware_name", this.deviceInfo.f2892x);
        addString(hashMap, "installed_at", this.deviceInfo.A);
        addString(hashMap, "language", this.deviceInfo.f2886q);
        addDuration(hashMap, "last_interval", this.activityStateCopy.f2859e);
        ...
        addString(hashMap, "os_build", this.deviceInfo.f2894z);
        addString(hashMap, "os_name", this.deviceInfo.f2883n);
        addString(hashMap, "os_version", this.deviceInfo.f2884o);
        addString(hashMap, CampaignEx.JSON_KEY_PACKAGE_NAME, this.deviceInfo.f2878i);
        addString(hashMap, "push_token", this.activityStateCopy.f2862h);
        addString(hashMap, "screen_density", this.deviceInfo.u);
        addString(hashMap, "screen_format", this.deviceInfo.f2889t);
        addString(hashMap, "screen_size", this.deviceInfo.f2888s);
        ...
        addLong(hashMap, "session_count", this.activityStateCopy.f2856b);
        addDuration(hashMap, "session_length", this.activityStateCopy.f2860f);
        addLong(hashMap, "subsession_count", this.activityStateCopy.f2857c);
        addDuration(hashMap, "time_spent", this.activityStateCopy.f2858d);
    ...
    private ActivityPackage getDefaultActivityPackage(ActivityKind activityKind) {
        ...
        activityPackage.setClientSdk(this.deviceInfo.f2877h);
