...
public class AdjustInstance {
    ...
    public class a implements IRunActivityHandler {
        ...
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addSessionCallbackParameterI(this.a, this.f2844b);
        }
    }
    ...
    public class b implements IRunActivityHandler {
        ...
        @Override // com.adjust.sdk.IRunActivityHandler
        public final void run(ActivityHandler activityHandler) {
            activityHandler.addSessionPartnerParameterI(this.a, this.f2845b);
        }
    }
    ...
    private void saveDeeplink(Uri uri, long j3, Context context) {
        SharedPreferencesManager.getDefaultInstance(context).saveDeeplink(uri, j3);
    }
    ...
    private void saveRawReferrer(String str, long j3, Context context) {
        SharedPreferencesManager.getDefaultInstance(context).saveRawReferrer(str, j3);
    }
