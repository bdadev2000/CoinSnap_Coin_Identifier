...
public class TimerCycle {
    ...
    public TimerCycle(Runnable runnable, long j3, long j10, String str) {
        ...
        this.logger.verbose("%s configured to fire after %s seconds of starting and cycles every %s seconds", str, decimalFormat.format(j3 / 1000.0d), decimalFormat.format(j10 / 1000.0d));
    }
