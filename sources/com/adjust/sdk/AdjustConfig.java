...
public class AdjustConfig {
    ...
    private void init(Context context, String str, String str2, boolean z10) {
        ...
        setLogLevel((z10 && ENVIRONMENT_PRODUCTION.equals(str2)) ? LogLevel.SUPRESS : LogLevel.INFO, str2);
        if (context != null) {
    ...
    public void setAppSecret(long j3, long j10, long j11, long j12, long j13) {
        this.secretId = Util.formatString("%d", Long.valueOf(j3));
        this.appSecret = Util.formatString("%d%d%d%d", Long.valueOf(j10), Long.valueOf(j11), Long.valueOf(j12), Long.valueOf(j13));
    }
