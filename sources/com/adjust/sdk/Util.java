...
public class Util {
    ...
    public class b implements Callable<String> {
        ...
        public final String call() {
            return Reflection.getPlayAdId(this.a, this.f2869b);
        }
    }
    ...
    public class c implements Callable<Boolean> {
        ...
        public final Boolean call() {
            return Reflection.isPlayTrackingEnabled(this.a, this.f2870b);
        }
    }
    ...
    public class d extends AsyncTaskExecutor<Context, String> {
        ...
        public final String doInBackground(Context[] contextArr) {
            ...
            logger.debug(e.e("GoogleAdId read ", googleAdId), new Object[0]);
            return googleAdId;
        }
    ...
    public static String convertToHex(byte[] bArr) {
        return formatString(e.g(new StringBuilder("%0"), bArr.length << 1, "x"), new BigInteger(1, bArr));
    }
    ...
    public static Object getAdvertisingInfoObject(Context context, long j3) {
        return runSyncInPlayAdIdSchedulerWithTimeout(context, new a(context), j3);
    }
    ...
    public static String getPlayAdId(Context context, Object obj, long j3) {
        return (String) runSyncInPlayAdIdSchedulerWithTimeout(context, new b(context, obj), j3);
    }
    ...
    public static int hashDouble(Double d10) {
        if (d10 == null) {
            return 0;
        }
        return d10.hashCode();
    ...
    public static Boolean isPlayTrackingEnabled(Context context, Object obj, long j3) {
        return (Boolean) runSyncInPlayAdIdSchedulerWithTimeout(context, new c(context, obj), j3);
    }
    ...
    public static long readLongField(ObjectInputStream.GetField getField, String str, long j3) {
        try {
            return getField.get(str, j3);
        } catch (Exception e2) {
            getLogger().debug(fieldReadErrorMessage, str, e2.getMessage());
            return j3;
        }
    ...
    */
    ...
    private static <R> R runSyncInPlayAdIdSchedulerWithTimeout(Context context, Callable<R> callable, long j3) {
        ...
        try {
            return (R) playAdIdScheduler.scheduleFutureWithReturn(callable, 0L).get(j3, TimeUnit.MILLISECONDS);
