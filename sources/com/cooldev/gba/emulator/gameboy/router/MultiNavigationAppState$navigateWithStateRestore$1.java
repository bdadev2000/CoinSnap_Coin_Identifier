...
public final class MultiNavigationAppState$navigateWithStateRestore$1 extends r implements l {
    final /* synthetic */ MultiNavigationAppState this$0;

    /* renamed from: com.cooldev.gba.emulator.gameboy.router.MultiNavigationAppState$navigateWithStateRestore$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public MultiNavigationAppState$navigateWithStateRestore$1(MultiNavigationAppState multiNavigationAppState) {
        super(1);
    ...
    public final void invoke(@NotNull NavOptionsBuilder navOptionsBuilder) {
        ...
        navOptionsBuilder.f20490c = true;
