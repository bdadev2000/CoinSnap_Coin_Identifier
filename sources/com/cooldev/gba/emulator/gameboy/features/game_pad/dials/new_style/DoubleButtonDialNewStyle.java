...
public final class DoubleButtonDialNewStyle implements SimulateKeyDial {
    ...
    public DoubleButtonDialNewStyle(@NotNull Context context, @NotNull ButtonConfig buttonConfig, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
    ...
    private final void drawForeground(Canvas canvas, RadialGamePadTheme radialGamePadTheme) {
        ...
        int parseColor2 = Color.parseColor("#B0BABF");
        BasePaint fillPaint2 = pressed.getFillPaint();
        fillPaint2.setColor(parseColor2);
        Paint.Style style2 = Paint.Style.STROKE;
        fillPaint2.setStyle(style2);
        fillPaint2.setStrokeWidth(4.0f);
        fillPaint2.setAntiAlias(true);
        ...
        if (strokePaint2 != null) {
            strokePaint2.setColor(parseColor2);
            strokePaint2.setStyle(style2);
            strokePaint2.setStrokeWidth(4.0f);
            strokePaint2.setAntiAlias(true);
