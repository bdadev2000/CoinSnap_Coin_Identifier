...
public final class StickDialDefault implements SimulateMotionDial {
    ...
    public StickDialDefault(@NotNull Context context, int i2, @Nullable Integer num, @NotNull Set<? extends GestureType> set, @Nullable String str, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
    ...
    private final void drawForeground(Canvas canvas) {
        ...
        canvas.drawCircle(d.D((float) Math.cos(this.angle), this.strength, f2, this.drawingBox.left + this.radius), d.D((float) Math.sin(this.angle), this.strength, f2, this.drawingBox.top + this.radius), f2, pressed.getFillPaint());
        BasePaint strokePaint = pressed.getStrokePaint();
        if (strokePaint != null) {
    ...
    public /* synthetic */ StickDialDefault(Context context, int i2, Integer num, Set set, String str, RadialGamePadTheme radialGamePadTheme, int i3, k kVar) {
