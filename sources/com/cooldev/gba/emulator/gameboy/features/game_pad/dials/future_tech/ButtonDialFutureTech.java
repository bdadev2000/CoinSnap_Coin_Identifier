...
public final class ButtonDialFutureTech implements SimulateKeyDial {
    ...
    public ButtonDialFutureTech(@NotNull Context context, @NotNull ButtonConfig buttonConfig, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
