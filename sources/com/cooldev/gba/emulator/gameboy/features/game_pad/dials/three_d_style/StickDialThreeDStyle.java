...
public final class StickDialThreeDStyle implements SimulateMotionDial {
    ...
    public StickDialThreeDStyle(@NotNull Context context, int i2, @Nullable Integer num, @NotNull Set<? extends GestureType> set, @Nullable String str, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
    ...
    private final void drawForeground(Canvas canvas) {
        ...
        LinearGradient linearGradient = new LinearGradient((1 * f3) / f4, rectF.top, (f3 * 2) / f4, f5, parseColor, parseColor2, tileMode);
        BasePaint fillPaint = pressed.getFillPaint();
        ...
        RectF rectF2 = this.drawingBox;
        LinearGradient linearGradient2 = new LinearGradient(0.0f, rectF2.top, 0.0f, rectF2.bottom, Color.parseColor("#B0BABF"), Color.parseColor("#525759"), tileMode);
        BasePaint fillPaint2 = pressed.getFillPaint();
        fillPaint2.setShader(linearGradient2);
        ...
        if (strokePaint2 != null) {
            strokePaint2.setShader(linearGradient2);
    ...
    public /* synthetic */ StickDialThreeDStyle(Context context, int i2, Integer num, Set set, String str, RadialGamePadTheme radialGamePadTheme, int i3, k kVar) {
