...
public final class DoubleButtonDialFutureTech implements SimulateKeyDial {
    ...
    public DoubleButtonDialFutureTech(@NotNull Context context, @NotNull ButtonConfig buttonConfig, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
    ...
    private final void drawForeground(Canvas canvas, RadialGamePadTheme radialGamePadTheme) {
        ...
        int j2 = ColorKt.j(myColors.m36getText60d7_KjU());
        ...
        int j3 = ColorKt.j(myColors.m40getWhite0d7_KjU());
        BasePaint fillPaint2 = pressed.getFillPaint();
        fillPaint2.setColor(j3);
        Paint.Style style2 = Paint.Style.STROKE;
        fillPaint2.setStyle(style2);
        fillPaint2.setStrokeWidth(4.0f);
        fillPaint2.setAntiAlias(true);
