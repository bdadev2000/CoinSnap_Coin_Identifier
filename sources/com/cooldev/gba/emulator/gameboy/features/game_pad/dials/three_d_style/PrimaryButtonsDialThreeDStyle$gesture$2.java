...
public final class PrimaryButtonsDialThreeDStyle$gesture$2 extends r implements l {
    final /* synthetic */ GestureType $gestureType;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PrimaryButtonsDialThreeDStyle$gesture$2(GestureType gestureType) {
        super(1);
