...
public final class StickDialFutureTech implements SimulateMotionDial {
    ...
    public StickDialFutureTech(@NotNull Context context, int i2, @Nullable Integer num, @NotNull Set<? extends GestureType> set, @Nullable String str, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
    ...
    private final void drawForeground(Canvas canvas) {
        ...
        int j2 = ColorKt.j(MyColors.INSTANCE.m36getText60d7_KjU());
        BasePaint fillPaint = pressed.getFillPaint();
    ...
    public /* synthetic */ StickDialFutureTech(Context context, int i2, Integer num, Set set, String str, RadialGamePadTheme radialGamePadTheme, int i3, k kVar) {
