...
public final class ButtonDialThreeDStyle implements SimulateKeyDial {
    ...
    public ButtonDialThreeDStyle(@NotNull Context context, @NotNull ButtonConfig buttonConfig, @NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(context, "context");
