...
public final class PrimaryButtonsDialDefault$sendNewActionUps$1 extends r implements l {
    final /* synthetic */ Set<Integer> $newPressed;
    final /* synthetic */ PrimaryButtonsDialDefault this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PrimaryButtonsDialDefault$sendNewActionUps$1(Set<Integer> set, PrimaryButtonsDialDefault primaryButtonsDialDefault) {
        super(1);
        this.$newPressed = set;
    ...
    */
    public final java.lang.Boolean invoke(int r3) {
        ...
        L1d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cooldev.gba.emulator.gameboy.features.game_pad.dials.default_style.PrimaryButtonsDialDefault$sendNewActionUps$1.invoke(int):java.lang.Boolean");
    }
