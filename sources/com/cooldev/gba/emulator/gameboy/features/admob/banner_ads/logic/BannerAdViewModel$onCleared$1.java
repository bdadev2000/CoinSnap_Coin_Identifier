...
public final class BannerAdViewModel$onCleared$1 extends r implements l {
    public static final BannerAdViewModel$onCleared$1 INSTANCE = new BannerAdViewModel$onCleared$1();

    public BannerAdViewModel$onCleared$1() {
        super(1);
    }
