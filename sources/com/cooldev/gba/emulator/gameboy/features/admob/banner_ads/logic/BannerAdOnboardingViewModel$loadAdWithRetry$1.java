...
public final class BannerAdOnboardingViewModel$loadAdWithRetry$1 extends r implements l {
    public static final BannerAdOnboardingViewModel$loadAdWithRetry$1 INSTANCE = new BannerAdOnboardingViewModel$loadAdWithRetry$1();

    public BannerAdOnboardingViewModel$loadAdWithRetry$1() {
        super(1);
    }
