...
public final class ThemePageKt$ThemePage$5 extends r implements a {
    ...
    @e(c = "com.cooldev.gba.emulator.gameboy.features.theme.page.ThemePageKt$ThemePage$5$1", f = "ThemePage.kt", l = {Opcodes.LNEG}, m = "invokeSuspend")
    /* renamed from: com.cooldev.gba.emulator.gameboy.features.theme.page.ThemePageKt$ThemePage$5$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ThemePageKt$ThemePage$5(d0 d0Var, AppPrefUtils appPrefUtils, Context context, MutableState<Boolean> mutableState, MutableState<Boolean> mutableState2) {
        super(0);
