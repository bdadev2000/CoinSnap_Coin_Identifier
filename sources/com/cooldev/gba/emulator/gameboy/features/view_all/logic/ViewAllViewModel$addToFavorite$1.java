...
@e(c = "com.cooldev.gba.emulator.gameboy.features.view_all.logic.ViewAllViewModel$addToFavorite$1", f = "ViewAllViewModel.kt", l = {Opcodes.MONITORENTER}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class ViewAllViewModel$addToFavorite$1 extends i implements p {
    boolean Z$0;
    int label;
    final /* synthetic */ ViewAllViewModel this$0;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.view_all.logic.ViewAllViewModel$addToFavorite$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public ViewAllViewModel$addToFavorite$1(ViewAllViewModel viewAllViewModel, g gVar) {
        super(2, gVar);
    ...
    public final g create(@Nullable Object obj, @NotNull g gVar) {
        return new ViewAllViewModel$addToFavorite$1(this.this$0, gVar);
    }

    @Override // q0.p
    @Nullable
    public final Object invoke(@NotNull d0 d0Var, @Nullable g gVar) {
        return ((ViewAllViewModel$addToFavorite$1) create(d0Var, gVar)).invokeSuspend(b0.f30125a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            boolean updateGameFavoriteStatus = gamePrefUtils.updateGameFavoriteStatus(context, str, true);
        ...
        if (z2) {
            ...
            b0.a.c(context3, "Game added to favorites successfully!").show();
        } else {
            context2 = this.this$0.context;
            b0.a.b(context2, "Failed to add game to favorites. Please try again.").show();
        }
