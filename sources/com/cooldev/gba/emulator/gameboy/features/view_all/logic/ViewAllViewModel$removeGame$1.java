...
@e(c = "com.cooldev.gba.emulator.gameboy.features.view_all.logic.ViewAllViewModel$removeGame$1", f = "ViewAllViewModel.kt", l = {Opcodes.FCMPL}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class ViewAllViewModel$removeGame$1 extends i implements p {
    boolean Z$0;
    int label;
    final /* synthetic */ ViewAllViewModel this$0;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.view_all.logic.ViewAllViewModel$removeGame$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public ViewAllViewModel$removeGame$1(ViewAllViewModel viewAllViewModel, g gVar) {
        super(2, gVar);
    ...
    public final g create(@Nullable Object obj, @NotNull g gVar) {
        return new ViewAllViewModel$removeGame$1(this.this$0, gVar);
    }

    @Override // q0.p
    @Nullable
    public final Object invoke(@NotNull d0 d0Var, @Nullable g gVar) {
        return ((ViewAllViewModel$removeGame$1) create(d0Var, gVar)).invokeSuspend(b0.f30125a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            boolean removeGame = gamePrefUtils.removeGame(context, str);
            this.Z$0 = removeGame;
            this.label = 1;
        ...
        if (z2) {
            ...
            b0.a.c(context3, "Game removed successfully!").show();
        } else {
            context2 = this.this$0.context;
            b0.a.b(context2, "Failed to remove game. Please try again.").show();
        }
