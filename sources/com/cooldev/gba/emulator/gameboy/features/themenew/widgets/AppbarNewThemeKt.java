...
public final class AppbarNewThemeKt {
    @ComposableTarget
    @Composable
    public static final void AppbarNewTheme(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-2027702427);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
        ...
        if (Z != null) {
            Z.d = new AppbarNewThemeKt$AppbarNewTheme$2(i2);
        }
    }
}
