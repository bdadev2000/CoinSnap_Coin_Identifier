...
import com.cooldev.gba.emulator.gameboy.features.admob.banner_ads.page.BannerAdGameViewKt;
...
public final class MainGameViewKt$BannerAd$4 extends r implements q {
    final /* synthetic */ BannerAdState $bannerState;
    final /* synthetic */ IAPState $iapState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MainGameViewKt$BannerAd$4(BannerAdState bannerAdState, IAPState iAPState) {
        super(3);
    ...
    public final void invoke(@NotNull AnimatedVisibilityScope animatedVisibilityScope, @Nullable Composer composer, int i2) {
        ...
        BannerAdGameViewKt.BannerAdGameView(this.$bannerState.getAdView(), composer, 8);
    }
}
