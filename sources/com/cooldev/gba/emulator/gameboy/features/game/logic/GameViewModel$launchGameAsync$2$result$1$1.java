...
public final class GameViewModel$launchGameAsync$2$result$1$1 extends r implements l {
    final /* synthetic */ GameData $gameData;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GameViewModel$launchGameAsync$2$result$1$1(GameData gameData) {
        super(1);
