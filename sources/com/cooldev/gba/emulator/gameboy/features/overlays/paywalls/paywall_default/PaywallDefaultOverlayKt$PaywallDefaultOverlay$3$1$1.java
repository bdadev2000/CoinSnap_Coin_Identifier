...
public final class PaywallDefaultOverlayKt$PaywallDefaultOverlay$3$1$1 extends r implements l {
    final /* synthetic */ PurchasePageViewModel $purchasePageViewModel;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.overlays.paywalls.paywall_default.PaywallDefaultOverlayKt$PaywallDefaultOverlay$3$1$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaywallDefaultOverlayKt$PaywallDefaultOverlay$3$1$1(PurchasePageViewModel purchasePageViewModel) {
        super(1);
        this.$purchasePageViewModel = purchasePageViewModel;
    }
    ...
    public final void invoke(@NotNull LazyListScope lazyListScope) {
        ...
        LazyListScope.f(lazyListScope, null, new ComposableLambdaImpl(-122846164, anonymousClass1, true), 3);
    }
}
