...
public final class LayerBlackMenuGameKt {
    @ComposableTarget
    @Composable
    public static final void LayerBlackMenuGame(@NotNull Modifier modifier, @Nullable Composer composer, int i2) {
        int i3;
        a.s(modifier, "modifier");
        ComposerImpl g2 = composer.g(1350296318);
        if ((i2 & 14) == 0) {
        ...
        if (Z != null) {
            Z.d = new LayerBlackMenuGameKt$LayerBlackMenuGame$1(modifier, i2);
        }
    }
}
