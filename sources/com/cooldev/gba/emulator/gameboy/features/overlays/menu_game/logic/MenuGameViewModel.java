...
public final class MenuGameViewModel extends ViewModel {
    ...
    public MenuGameViewModel() {
        i1 c2 = t0.c(new MenuGameState(false, 1, null));
        this._state = c2;
    ...
    public final void hideMenu() {
        updateState(MenuGameViewModel$hideMenu$1.INSTANCE);
    }

    public final void showMenu() {
        GameEvents.INSTANCE.logViewSettingGame();
        updateState(MenuGameViewModel$showMenu$1.INSTANCE);
    }
}
