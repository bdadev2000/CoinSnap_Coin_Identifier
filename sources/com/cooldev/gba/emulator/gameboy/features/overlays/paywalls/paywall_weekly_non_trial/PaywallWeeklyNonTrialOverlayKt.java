...
public final class PaywallWeeklyNonTrialOverlayKt {
    ...
    public static final void HideOverlayIfPurchaseComplete(Composer composer, int i2) {
        ...
        if (i2 == 0 && g2.i()) {
            ...
            g2.V(false);
            g2.V(false);
            EffectsKt.f(Boolean.valueOf(isPremium), new PaywallWeeklyNonTrialOverlayKt$HideOverlayIfPurchaseComplete$1(isPremium, (PurchaseOverlayViewModel) u3, null), g2);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new PaywallWeeklyNonTrialOverlayKt$HideOverlayIfPurchaseComplete$2(i2);
        }
    }

    @ComposableTarget
    @Composable
    public static final void PaywallWeeklyNonTrialOverlay(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1141928888);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            EffectsKt.f(b0.f30125a, new PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$1((IAPViewModel) u2, null), g2);
            BackHandlerKt.a(false, PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$2.INSTANCE, g2, 48, 1);
            Scope q3 = t.q(g2, 414512006, g2, 0, 1274527078);
            boolean y3 = t.y(g2, false, 511388516, null) | g2.I(q3);
            Object u3 = g2.u();
            if (y3 || u3 == composer$Companion$Empty$1) {
            ...
            g2.V(false);
            g2.V(false);
            ScaffoldKt.a(null, null, null, null, null, 0, MyColors.INSTANCE.m25getText200d7_KjU(), 0L, null, ComposableLambdaKt.c(1000732249, new PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$3((PurchasePageViewModel) u4, purchaseOverlayViewModel), g2), g2, 806879232, 447);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$4(i2);
        }
    }
}
