...
import com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_weekly_non_trial.widgets.BackgroundPaywallWeeklyNonTrialKt;
import com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_weekly_non_trial.widgets.CloseIconPaywallWeeklyNonTrialKt;
import d0.b0;
...
public final class PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$3 extends r implements q {
    ...
    public PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$3(PurchasePageViewModel purchasePageViewModel, PurchaseOverlayViewModel purchaseOverlayViewModel) {
        super(3);
    ...
    public final void invoke(@NotNull PaddingValues paddingValues, @Nullable Composer composer, int i2) {
        ...
        if (composer.j() instanceof Applier) {
            ...
            BackgroundPaywallWeeklyNonTrialKt.BackgroundPaywallWeeklyNonTrial(composer, 0);
            LazyDslKt.a(null, null, null, false, null, Alignment.Companion.f14670n, null, false, new PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$3$1$1(purchasePageViewModel), composer, 196608, 223);
            CloseIconPaywallWeeklyNonTrialKt.CloseIconPaywallWeeklyNonTrial(PaddingKt.j(companion, 0.0f, paddingValues.d(), 0.0f, 0.0f, 13), new PaywallWeeklyNonTrialOverlayKt$PaywallWeeklyNonTrialOverlay$3$1$2(purchaseOverlayViewModel), composer, 0);
            composer.p();
            return;
        }
        ComposablesKt.a();
