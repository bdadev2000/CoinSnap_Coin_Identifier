...
import com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_lifetime.widgets.BackgroundPaywallLifetimeKt;
import com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_lifetime.widgets.CloseIconPaywallLifetimeKt;
import d0.b0;
...
public final class PaywallLifetimeOverlayKt$PaywallLifetimeOverlay$3 extends r implements q {
    ...
    public PaywallLifetimeOverlayKt$PaywallLifetimeOverlay$3(PurchasePageViewModel purchasePageViewModel, PurchaseOverlayViewModel purchaseOverlayViewModel) {
        super(3);
    ...
    public final void invoke(@NotNull PaddingValues paddingValues, @Nullable Composer composer, int i2) {
        ...
        if (composer.j() instanceof Applier) {
            ...
            BackgroundPaywallLifetimeKt.BackgroundPaywallLifetime(composer, 0);
            LazyDslKt.a(null, null, null, false, null, Alignment.Companion.f14670n, null, false, new PaywallLifetimeOverlayKt$PaywallLifetimeOverlay$3$1$1(purchasePageViewModel), composer, 196608, 223);
            CloseIconPaywallLifetimeKt.CloseIconPaywallLifetime(PaddingKt.j(companion, 0.0f, paddingValues.d(), 0.0f, 0.0f, 13), new PaywallLifetimeOverlayKt$PaywallLifetimeOverlay$3$1$2(purchaseOverlayViewModel), composer, 0);
            composer.p();
            return;
        }
        ComposablesKt.a();
