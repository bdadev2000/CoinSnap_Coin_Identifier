...
public final class PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3$1$2 extends r implements a {
    final /* synthetic */ PurchaseOverlayViewModel $purchaseOverlayViewModel;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3$1$2(PurchaseOverlayViewModel purchaseOverlayViewModel) {
        super(0);
