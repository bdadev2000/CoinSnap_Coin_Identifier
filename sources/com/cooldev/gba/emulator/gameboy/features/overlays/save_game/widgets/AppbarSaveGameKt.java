...
public final class AppbarSaveGameKt {
    @ComposableTarget
    @Composable
    public static final void AppbarSaveGame(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(144320243);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            g2.t(-1614864554);
            ...
            TextKt.b("Save Game", null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(MyColors.INSTANCE.m34getText40d7_KjU(), b2, new FontWeight(400), MyFonts.INSTANCE.getDeterminationSans(), 0L, null, 3, b3, 16613336), g2, 6, 0, 65534);
            SpacerKt.a(rowScopeInstance.a(companion, 1.0f, true), g2);
            CloseIconWidgetKt.CloseIconWidget(new AppbarSaveGameKt$AppbarSaveGame$1$1$1(saveGameViewModel, menuGameViewModel), g2, 0);
            g2.V(true);
            g2.V(true);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new AppbarSaveGameKt$AppbarSaveGame$2(i2);
        }
    }
}
