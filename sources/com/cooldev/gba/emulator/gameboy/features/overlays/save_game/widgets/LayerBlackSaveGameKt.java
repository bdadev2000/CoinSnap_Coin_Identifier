...
public final class LayerBlackSaveGameKt {
    @ComposableTarget
    @Composable
    public static final void LayerBlackSaveGame(@NotNull Modifier modifier, @Nullable Composer composer, int i2) {
        int i3;
        a.s(modifier, "modifier");
        ComposerImpl g2 = composer.g(1149135068);
        if ((i2 & 14) == 0) {
        ...
        if (Z != null) {
            Z.d = new LayerBlackSaveGameKt$LayerBlackSaveGame$1(modifier, i2);
        }
    }
}
