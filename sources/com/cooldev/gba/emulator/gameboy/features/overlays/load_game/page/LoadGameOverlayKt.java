...
public final class LoadGameOverlayKt {
    ...
    public static final void LoadGameOverlay(@Nullable Composer composer, int i2) {
        ...
        if (i2 == 0 && g2.i()) {
            ...
            EffectsKt.c(b0.f30125a, new LoadGameOverlayKt$LoadGameOverlay$1(loadGameViewModel), g2);
            ...
            LazyDslKt.a(PaddingKt.h(companion, 16, 0.0f, 2), null, null, false, Arrangement.g(39), Alignment.Companion.f14670n, null, false, new LoadGameOverlayKt$LoadGameOverlay$2$1$1(gameState, gameViewModel, loadGameViewModel, menuGameViewModel), g2, 221190, 206);
            g2.V(true);
            g2.V(true);
        }
