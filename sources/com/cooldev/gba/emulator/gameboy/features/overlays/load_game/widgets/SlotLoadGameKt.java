...
public final class SlotLoadGameKt {
    @ComposableTarget
    @Composable
    public static final void SlotLoadGame(@NotNull StateEntry stateEntry, @NotNull a aVar, @Nullable Composer composer, int i2) {
        p0.a.s(stateEntry, "item");
        p0.a.s(aVar, "onClick");
        ComposerImpl g2 = composer.g(1698252111);
        Modifier.Companion companion = Modifier.Companion.f14687a;
        Modifier h2 = PaddingKt.h(SizeKt.d(companion, 1.0f), 16, 0.0f, 2);
        boolean enabled = stateEntry.getEnabled();
        g2.J(-846292292);
        boolean z2 = (((i2 & 112) ^ 48) > 32 && g2.I(aVar)) || (i2 & 48) == 32;
        Object u2 = g2.u();
        if (z2 || u2 == Composer.Companion.f13690a) {
            u2 = new SlotLoadGameKt$SlotLoadGame$1$1(aVar);
            g2.o(u2);
        }
        g2.V(false);
        Modifier debouncedClickable$default = DebounceExtensionsKt.debouncedClickable$default(h2, enabled, 0L, (a) u2, 2, null);
        ...
        if (Z != null) {
            Z.d = new SlotLoadGameKt$SlotLoadGame$3(stateEntry, aVar, i2);
        }
    }
}
