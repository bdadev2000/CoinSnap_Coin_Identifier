...
import com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_yearly_non_trial.widgets.ClosePaywallYearlyNonTrialKt;
import d0.b0;
...
public final class PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3 extends r implements q {
    ...
    public PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3(PurchasePageViewModel purchasePageViewModel, PurchaseOverlayViewModel purchaseOverlayViewModel) {
        super(3);
    ...
    public final void invoke(@NotNull PaddingValues paddingValues, @Nullable Composer composer, int i2) {
        ...
        if (composer.j() instanceof Applier) {
            ...
            LazyDslKt.a(null, null, null, false, null, Alignment.Companion.f14670n, null, false, new PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3$1$1(purchasePageViewModel), composer, 196608, 223);
            ClosePaywallYearlyNonTrialKt.CloseIconPaywallYearlyNonTrial(new PaywallYearlyNonTrialOverlayKt$PaywallYearlyNonTrialOverlay$3$1$2(purchaseOverlayViewModel), composer, 0);
            composer.p();
            return;
        }
        ComposablesKt.a();
