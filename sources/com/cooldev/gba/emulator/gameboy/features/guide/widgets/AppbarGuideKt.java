...
public final class AppbarGuideKt {
    @ComposableTarget
    @Composable
    public static final void AppbarGuide(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-959561758);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            BackIconWidgetKt.BackIconWidget(AppbarGuideKt$AppbarGuide$1$1$1.INSTANCE, g2, 6);
            SpacerKt.a(rowScopeInstance.a(companion, 1.0f, true), g2);
            long b2 = TextUnitKt.b(40);
            long b3 = TextUnitKt.b(48);
            TextKt.b("Guide", null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(MyColors.INSTANCE.m34getText40d7_KjU(), b2, new FontWeight(400), MyFonts.INSTANCE.getDeterminationSans(), 0L, null, 3, b3, 16613336), g2, 6, 0, 65534);
            SpacerKt.a(rowScopeInstance.a(companion, 1.0f, true), g2);
        ...
        if (Z != null) {
            Z.d = new AppbarGuideKt$AppbarGuide$2(i2);
        }
    }
}
