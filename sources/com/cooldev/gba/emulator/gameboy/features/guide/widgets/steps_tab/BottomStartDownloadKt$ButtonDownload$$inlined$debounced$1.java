...
public final class BottomStartDownloadKt$ButtonDownload$$inlined$debounced$1 extends r implements a {
    final /* synthetic */ long $debounceTime;
    final /* synthetic */ MutableLongState $lastTimeClicked$delegate;
    final /* synthetic */ a $onDownloadGame$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomStartDownloadKt$ButtonDownload$$inlined$debounced$1(long j2, MutableLongState mutableLongState, a aVar) {
        super(0);
        this.$debounceTime = j2;
        this.$lastTimeClicked$delegate = mutableLongState;
        this.$onDownloadGame$inlined = aVar;
    }
    ...
    public final void m210invoke() {
        ...
        if (uptimeMillis - d > this.$debounceTime) {
            this.$onDownloadGame$inlined.invoke();
        }
