...
public final class CloseIconPaywallDefaultKt$CloseIconPaywallDefault$2 extends r implements p {
    final /* synthetic */ int $$changed;
    final /* synthetic */ a $block;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloseIconPaywallDefaultKt$CloseIconPaywallDefault$2(a aVar, int i2) {
        super(2);
        this.$block = aVar;
        this.$$changed = i2;
    }
