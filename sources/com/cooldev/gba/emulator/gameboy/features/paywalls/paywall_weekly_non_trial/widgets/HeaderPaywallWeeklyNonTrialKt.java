...
public final class HeaderPaywallWeeklyNonTrialKt {
    @ComposableTarget
    @Composable
    public static final void HeaderPaywallWeeklyNonTrial(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(295994534);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
        ...
        if (Z != null) {
            Z.d = new HeaderPaywallWeeklyNonTrialKt$HeaderPaywallWeeklyNonTrial$1(i2);
        }
    }
}
