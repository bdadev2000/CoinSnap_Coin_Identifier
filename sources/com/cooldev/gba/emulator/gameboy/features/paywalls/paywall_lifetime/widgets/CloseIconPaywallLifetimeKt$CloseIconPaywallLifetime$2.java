...
public final class CloseIconPaywallLifetimeKt$CloseIconPaywallLifetime$2 extends r implements p {
    final /* synthetic */ int $$changed;
    final /* synthetic */ a $block;
    final /* synthetic */ Modifier $modifier;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CloseIconPaywallLifetimeKt$CloseIconPaywallLifetime$2(Modifier modifier, a aVar, int i2) {
        super(2);
