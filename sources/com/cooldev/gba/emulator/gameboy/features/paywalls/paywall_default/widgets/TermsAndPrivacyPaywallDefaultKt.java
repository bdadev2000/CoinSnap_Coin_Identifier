...
public final class TermsAndPrivacyPaywallDefaultKt {
    @ComposableTarget
    @Composable
    public static final void TermsAndPrivacyPaywallDefault(@NotNull PurchasePageViewModel purchasePageViewModel, @Nullable Composer composer, int i2) {
        a.s(purchasePageViewModel, "purchasePageViewModel");
        ComposerImpl g2 = composer.g(1520150173);
        ...
        TextKt.b("Term & Conditions", DebounceExtensionsKt.debouncedClickable$default(companion, false, 0L, new TermsAndPrivacyPaywallDefaultKt$TermsAndPrivacyPaywallDefault$1$1(purchasePageViewModel, context), 3, null), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(myColors.m34getText40d7_KjU(), b2, fontWeight, inter, 0L, null, 5, b3, 16613336), g2, 6, 0, 65532);
        ...
        TextKt.b("Privacy policy", DebounceExtensionsKt.debouncedClickable$default(companion, false, 0L, new TermsAndPrivacyPaywallDefaultKt$TermsAndPrivacyPaywallDefault$1$2(purchasePageViewModel, context), 3, null), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(myColors.m34getText40d7_KjU(), b6, new FontWeight(700), myFonts.getInter(), 0L, null, 6, b7, 16613336), g2, 6, 0, 65532);
        g2.V(true);
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new TermsAndPrivacyPaywallDefaultKt$TermsAndPrivacyPaywallDefault$2(purchasePageViewModel, i2);
        }
    }
}
