...
public final class PaywallDefaultPageKt$PaywallDefaultPage$3 extends r implements q {
    final /* synthetic */ PurchasePageViewModel $purchasePageViewModel;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaywallDefaultPageKt$PaywallDefaultPage$3(PurchasePageViewModel purchasePageViewModel) {
        super(3);
    ...
    public final void invoke(@NotNull PaddingValues paddingValues, @Nullable Composer composer, int i2) {
        ...
        if (composer.j() instanceof Applier) {
            ...
            LazyDslKt.a(null, null, null, false, null, Alignment.Companion.f14670n, null, false, new PaywallDefaultPageKt$PaywallDefaultPage$3$1$1(purchasePageViewModel), composer, 196608, 223);
            CloseIconPaywallDefaultKt.CloseIconPaywallDefault(PaywallDefaultPageKt$PaywallDefaultPage$3$1$2.INSTANCE, composer, 6);
            composer.p();
            return;
        }
        ComposablesKt.a();
