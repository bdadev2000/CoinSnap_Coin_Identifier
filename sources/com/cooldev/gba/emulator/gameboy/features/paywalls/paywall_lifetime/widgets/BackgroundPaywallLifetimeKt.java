...
public final class BackgroundPaywallLifetimeKt {
    @ComposableTarget
    @Composable
    public static final void BackgroundPaywallLifetime(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1722332663);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
        ...
        if (Z != null) {
            Z.d = new BackgroundPaywallLifetimeKt$BackgroundPaywallLifetime$1(i2);
        }
    }
}
