...
public final class TermsAndPrivacyPaywallWeeklyNonTrialKt {
    @ComposableTarget
    @Composable
    public static final void TermsAndPrivacyPaywallWeeklyNonTrial(@NotNull PurchasePageViewModel purchasePageViewModel, @Nullable Composer composer, int i2) {
        a.s(purchasePageViewModel, "purchasePageViewModel");
        ComposerImpl g2 = composer.g(-500570868);
        ...
        TextKt.b("Term & Conditions", DebounceExtensionsKt.debouncedClickable$default(companion, false, 0L, new TermsAndPrivacyPaywallWeeklyNonTrialKt$TermsAndPrivacyPaywallWeeklyNonTrial$1$1(purchasePageViewModel, context), 3, null), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(myColors.m34getText40d7_KjU(), b2, fontWeight, inter, 0L, null, 5, b3, 16613336), g2, 6, 0, 65532);
        ...
        TextKt.b("Privacy policy", DebounceExtensionsKt.debouncedClickable$default(companion, false, 0L, new TermsAndPrivacyPaywallWeeklyNonTrialKt$TermsAndPrivacyPaywallWeeklyNonTrial$1$2(purchasePageViewModel, context), 3, null), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(myColors.m34getText40d7_KjU(), b6, new FontWeight(700), myFonts.getInter(), 0L, null, 6, b7, 16613336), g2, 6, 0, 65532);
        g2.V(true);
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new TermsAndPrivacyPaywallWeeklyNonTrialKt$TermsAndPrivacyPaywallWeeklyNonTrial$2(purchasePageViewModel, i2);
        }
    }
}
