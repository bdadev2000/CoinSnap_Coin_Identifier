...
public final class BillingsPaywallYearlyNonTrialKt$PurchaseYearly$1$1$1 extends r implements l {
    final /* synthetic */ MutableIntState $fontSize$delegate;
    final /* synthetic */ int $minFontSize;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BillingsPaywallYearlyNonTrialKt$PurchaseYearly$1$1$1(int i2, MutableIntState mutableIntState) {
        super(1);
        this.$minFontSize = i2;
