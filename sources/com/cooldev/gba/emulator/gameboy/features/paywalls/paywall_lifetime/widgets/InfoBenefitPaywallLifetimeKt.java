...
public final class InfoBenefitPaywallLifetimeKt {
    @ComposableTarget
    @Composable
    public static final void InfoBenefitPaywallLifetime(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-135008635);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
        ...
        if (Z != null) {
            Z.d = new InfoBenefitPaywallLifetimeKt$InfoBenefitPaywallLifetime$1(i2);
        }
    }
}
