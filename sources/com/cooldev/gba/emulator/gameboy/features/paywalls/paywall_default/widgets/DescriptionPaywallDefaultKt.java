...
public final class DescriptionPaywallDefaultKt {
    @ComposableTarget
    @Composable
    public static final void DescriptionPaywallDefault(@Nullable Composer composer, int i2) {
        String str;
        ComposerImpl g2 = composer.g(1915696511);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            String k14 = m.k1(m.k1(m.k1(m.k1(k13, "{FREE_TRIAL_PERIOD}", lowerCase2), "{MONTHLY_TITLE}", billingEnum3.getTitle()), "{MONTHLY_PRICE}", DescriptionPaywallDefault$getPrice(iAPState, billingEnum3)), "{MONTHLY_PERIOD}", lowerCase4);
            BillingEnum billingEnum4 = BillingEnum.LIFETIME;
            TextKt.b(m.k1(m.k1(k14, "{LIFETIME_TITLE}", billingEnum4.getTitle()), "{LIFETIME_PRICE}", DescriptionPaywallDefault$getPrice(iAPState, billingEnum4)), PaddingKt.h(Modifier.Companion.f14687a, 16, 0.0f, 2), MyColors.INSTANCE.m38getText80d7_KjU(), TextUnitKt.b(12), null, FontWeight.f17264b, MyFonts.INSTANCE.getInter(), 0L, null, new TextAlign(5), TextUnitKt.b(16), 0, false, 0, 0, null, null, g2, 1772976, 6, 129424);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new DescriptionPaywallDefaultKt$DescriptionPaywallDefault$1(i2);
        }
    }

    private static final String DescriptionPaywallDefault$getPrice(IAPState iAPState, BillingEnum billingEnum) {
