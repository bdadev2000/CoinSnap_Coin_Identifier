...
public final class BillingsPaywallLifetimeKt {
    @ComposableTarget
    @Composable
    public static final void BillingsPaywallLifetime(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1703885303);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            g2.J(308959506);
            for (SkuDetails skuDetails : u.T0(iAPState.getBillings(), new Comparator() { // from class: com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_lifetime.widgets.BillingsPaywallLifetimeKt$BillingsPaywallLifetime$lambda$2$$inlined$sortedBy$1
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t2, T t3) {
                    int sortOrderLifetime;
                    int sortOrderLifetime2;
                    String sku = ((SkuDetails) t2).getSku();
                    p0.a.r(sku, "getSku(...)");
                    sortOrderLifetime = BillingsPaywallLifetimeKt.getSortOrderLifetime(sku);
                    Integer valueOf = Integer.valueOf(sortOrderLifetime);
                    String sku2 = ((SkuDetails) t3).getSku();
                    p0.a.r(sku2, "getSku(...)");
                    sortOrderLifetime2 = BillingsPaywallLifetimeKt.getSortOrderLifetime(sku2);
                    return q.c(valueOf, Integer.valueOf(sortOrderLifetime2));
                }
            })) {
                ...
                if (p0.a.g(sku, BillingEnum.LIFETIME.getSkuId())) {
                    ...
                    SpacerKt.a(SizeKt.e(companion, f2), g2);
                    g2.V(false);
                } else if (p0.a.g(sku, BillingEnum.YEARLY_NON_TRIAL.getSkuId())) {
                    g2.J(-1492553730);
        ...
        if (Z != null) {
            Z.d = new BillingsPaywallLifetimeKt$BillingsPaywallLifetime$2(i2);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x00e2, code lost:
        ...
        if (p0.a.g(r2.u(), java.lang.Integer.valueOf(r8)) == false) goto L21;
     */
    ...
    */
    public static final void PurchaseLifetime(com.cooldev.gba.emulator.gameboy.features.paywalls.logic.IAPViewModel r55, com.android.billingclient.api.SkuDetails r56, androidx.compose.runtime.Composer r57, int r58) {
        /*
            Method dump skipped, instructions count: 694
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_lifetime.widgets.BillingsPaywallLifetimeKt.PurchaseLifetime(com.cooldev.gba.emulator.gameboy.features.paywalls.logic.IAPViewModel, com.android.billingclient.api.SkuDetails, androidx.compose.runtime.Composer, int):void");
    }
    ...
    public static final void PurchaseMonthly(IAPViewModel iAPViewModel, SkuDetails skuDetails, Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1072501727);
        ...
        try {
            builder.c("Monthly");
            builder.d(e);
            builder.c(" - Auto renew");
            AnnotatedString f2 = builder.f();
            Modifier.Companion companion = Modifier.Companion.f14687a;
            Modifier debouncedClickable$default = DebounceExtensionsKt.debouncedClickable$default(SizeKt.d(SizeKt.e(companion, 68), 1.0f), false, 0L, new BillingsPaywallLifetimeKt$PurchaseMonthly$1(iAPViewModel, skuDetails, getNavController, context), 3, null);
            ...
            TextKt.b(price, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(myColors.m27getText220d7_KjU(), b2, new FontWeight(400), myFonts.getDeterminationSans(), 0L, null, 3, b3, 16613336), g2, 0, 0, 65534);
            ...
            RecomposeScopeImpl Z = g2.Z();
            if (Z != null) {
                Z.d = new BillingsPaywallLifetimeKt$PurchaseMonthly$3(iAPViewModel, skuDetails, i2);
            }
        } catch (Throwable th) {
            builder.d(e);
            throw th;
    ...
    @ComposableTarget
    @Composable
    public static final void PurchaseYearly(IAPViewModel iAPViewModel, SkuDetails skuDetails, Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1140009402);
        Context context = (Context) g2.K(AndroidCompositionLocals_androidKt.f16325b);
        NavHostController getNavController = MultiNavigationAppStateKt.getLocalNavigationState().getRootNavigation().getGetNavController();
        String price = skuDetails.getPrice();
        p0.a.r(price, "getPrice(...)");
        ...
        try {
            ...
            AnnotatedString f2 = builder.f();
            Modifier.Companion companion = Modifier.Companion.f14687a;
            Modifier debouncedClickable$default = DebounceExtensionsKt.debouncedClickable$default(SizeKt.d(SizeKt.e(companion, 68), 1.0f), false, 0L, new BillingsPaywallLifetimeKt$PurchaseYearly$1(iAPViewModel, skuDetails, getNavController, context), 3, null);
            MeasurePolicy e2 = BoxKt.e(Alignment.Companion.f14660b, false);
            int i3 = g2.P;
            PersistentCompositionLocalMap Q = g2.Q();
            Modifier c2 = ComposedModifierKt.c(g2, debouncedClickable$default);
            ...
            RecomposeScopeImpl Z = g2.Z();
            if (Z != null) {
                Z.d = new BillingsPaywallLifetimeKt$PurchaseYearly$3(iAPViewModel, skuDetails, i2);
            }
        } catch (Throwable th) {
            builder.d(e);
            throw th;
    ...
    private static final int calculateSavingsPercentage(Long l2, Long l3) {
        if (l3 == null) {
            return 60;
        }
        try {
            double longValue = l3.longValue() / 1000000.0d;
            if (l2 != null) {
                return p0.a.s0((1 - (((l2.longValue() / 1000000.0d) / 20) / longValue)) * 100);
            }
            return 60;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int getSortOrderLifetime(String str) {
        try {
            Locale locale = Locale.getDefault();
            p0.a.r(locale, "getDefault(...)");
            String lowerCase = str.toLowerCase(locale);
            p0.a.r(lowerCase, "toLowerCase(...)");
            if (p0.a.g(lowerCase, BillingEnum.LIFETIME.getSkuId())) {
                return 1;
            }
            if (p0.a.g(lowerCase, BillingEnum.MONTHLY.getSkuId())) {
                return 2;
            }
            return p0.a.g(lowerCase, BillingEnum.YEARLY_NON_TRIAL.getSkuId()) ? 3 : 0;
        } catch (Throwable th) {
