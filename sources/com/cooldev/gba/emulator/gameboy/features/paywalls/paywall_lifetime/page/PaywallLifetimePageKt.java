...
public final class PaywallLifetimePageKt {
    /* JADX INFO: Access modifiers changed from: private */
    @Composable
    public static final void LogEventScreen(Composer composer, int i2) {
        ComposerImpl g2 = composer.g(571381247);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            EffectsKt.f(b0.f30125a, new PaywallLifetimePageKt$LogEventScreen$1(null), g2);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new PaywallLifetimePageKt$LogEventScreen$2(i2);
        }
    }
    ...
    public static final void NavigateUpIfPurchaseComplete(Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-802668418);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            if (a2 || u3 == composer$Companion$Empty$1) {
                u3 = new PaywallLifetimePageKt$NavigateUpIfPurchaseComplete$1$1(isPremium, null);
                g2.o(u3);
            }
            g2.V(false);
        ...
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new PaywallLifetimePageKt$NavigateUpIfPurchaseComplete$2(i2);
        }
    }
    ...
    public static final void PaywallLifetimePage(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1829218221);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            g2.V(false);
            g2.V(false);
            EffectsKt.f(b0.f30125a, new PaywallLifetimePageKt$PaywallLifetimePage$1((IAPViewModel) u2, null), g2);
            BackHandlerKt.a(false, PaywallLifetimePageKt$PaywallLifetimePage$2.INSTANCE, g2, 48, 1);
            ...
            g2.V(false);
            g2.V(false);
            ScaffoldKt.a(null, null, null, null, null, 0, MyColors.INSTANCE.m25getText200d7_KjU(), 0L, null, ComposableLambdaKt.c(-1819277788, new PaywallLifetimePageKt$PaywallLifetimePage$3((PurchasePageViewModel) u3), g2), g2, 806879232, 447);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new PaywallLifetimePageKt$PaywallLifetimePage$4(i2);
        }
    }
}
