...
public final class BillingsPaywallWeeklyNonTrialKt {
    @ComposableTarget
    @Composable
    public static final void BillingsPaywallWeeklyNonTrial(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(1920889350);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            g2.J(-978117456);
            for (SkuDetails skuDetails : u.T0(iAPState.getBillings(), new Comparator() { // from class: com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_weekly_non_trial.widgets.BillingsPaywallWeeklyNonTrialKt$BillingsPaywallWeeklyNonTrial$lambda$2$$inlined$sortedBy$1
                ...
                public final int compare(T t2, T t3) {
                    ...
                    p0.a.r(sku, "getSku(...)");
                    sortOrderLifetime = BillingsPaywallWeeklyNonTrialKt.getSortOrderLifetime(sku);
                    Integer valueOf = Integer.valueOf(sortOrderLifetime);
                    String sku2 = ((SkuDetails) t3).getSku();
                    p0.a.r(sku2, "getSku(...)");
                    sortOrderLifetime2 = BillingsPaywallWeeklyNonTrialKt.getSortOrderLifetime(sku2);
                    return q.c(valueOf, Integer.valueOf(sortOrderLifetime2));
                }
            })) {
                String sku = skuDetails.getSku();
                if (p0.a.g(sku, BillingEnum.WEEKLY_NON_TRIAL.getSkuId())) {
                    g2.J(-1520544928);
                    PurchaseWeekly(iAPViewModel, skuDetails, g2, 72);
        ...
        if (Z != null) {
            Z.d = new BillingsPaywallWeeklyNonTrialKt$BillingsPaywallWeeklyNonTrial$2(i2);
        }
    }
    ...
    public static final void PurchaseLifetime(IAPViewModel iAPViewModel, SkuDetails skuDetails, Composer composer, int i2) {
        ComposerImpl g2 = composer.g(326641667);
        ...
        try {
            ...
            Modifier.Companion companion = Modifier.Companion.f14687a;
            Modifier debouncedClickable$default = DebounceExtensionsKt.debouncedClickable$default(SizeKt.d(SizeKt.e(companion, 68), 1.0f), false, 0L, new BillingsPaywallWeeklyNonTrialKt$PurchaseLifetime$1(iAPViewModel, skuDetails, getNavController, context), 3, null);
            ...
            RecomposeScopeImpl Z = g2.Z();
            if (Z != null) {
                Z.d = new BillingsPaywallWeeklyNonTrialKt$PurchaseLifetime$3(iAPViewModel, skuDetails, i2);
            }
        } catch (Throwable th) {
            builder.d(e);
            throw th;
    ...
    public static final void PurchaseMonthly(IAPViewModel iAPViewModel, SkuDetails skuDetails, Composer composer, int i2) {
        ComposerImpl g2 = composer.g(-1203000451);
        Context context = (Context) g2.K(AndroidCompositionLocals_androidKt.f16325b);
        NavHostController getNavController = MultiNavigationAppStateKt.getLocalNavigationState().getRootNavigation().getGetNavController();
        String price = skuDetails.getPrice();
        p0.a.r(price, "getPrice(...)");
        ...
        try {
            ...
            AnnotatedString f2 = builder.f();
            Modifier.Companion companion = Modifier.Companion.f14687a;
            Modifier debouncedClickable$default = DebounceExtensionsKt.debouncedClickable$default(SizeKt.d(SizeKt.e(companion, 68), 1.0f), false, 0L, new BillingsPaywallWeeklyNonTrialKt$PurchaseMonthly$1(iAPViewModel, skuDetails, getNavController, context), 3, null);
            ...
            RecomposeScopeImpl Z = g2.Z();
            if (Z != null) {
                Z.d = new BillingsPaywallWeeklyNonTrialKt$PurchaseMonthly$3(iAPViewModel, skuDetails, i2);
            }
        } catch (Throwable th) {
            builder.d(e);
            throw th;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x00b5, code lost:
        ...
        if (p0.a.g(r2.u(), java.lang.Integer.valueOf(r5)) == false) goto L17;
     */
    ...
    */
    public static final void PurchaseWeekly(com.cooldev.gba.emulator.gameboy.features.paywalls.logic.IAPViewModel r65, com.android.billingclient.api.SkuDetails r66, androidx.compose.runtime.Composer r67, int r68) {
        /*
            Method dump skipped, instructions count: 866
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_weekly_non_trial.widgets.BillingsPaywallWeeklyNonTrialKt.PurchaseWeekly(com.cooldev.gba.emulator.gameboy.features.paywalls.logic.IAPViewModel, com.android.billingclient.api.SkuDetails, androidx.compose.runtime.Composer, int):void");
    }
    ...
    public static final int getSortOrderLifetime(String str) {
        try {
            ...
            if (p0.a.g(lowerCase, BillingEnum.WEEKLY_NON_TRIAL.getSkuId())) {
                return 1;
            }
