...
public final class TermsAndPrivacyPaywallDefaultKt$TermsAndPrivacyPaywallDefault$1$2 extends r implements a {
    final /* synthetic */ Context $context;
    final /* synthetic */ PurchasePageViewModel $purchasePageViewModel;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TermsAndPrivacyPaywallDefaultKt$TermsAndPrivacyPaywallDefault$1$2(PurchasePageViewModel purchasePageViewModel, Context context) {
        super(0);
