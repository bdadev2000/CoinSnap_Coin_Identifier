...
public final class PaywallLifetimePageKt$PaywallLifetimePage$3$1$1 extends r implements l {
    final /* synthetic */ PurchasePageViewModel $purchasePageViewModel;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.paywalls.paywall_lifetime.page.PaywallLifetimePageKt$PaywallLifetimePage$3$1$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaywallLifetimePageKt$PaywallLifetimePage$3$1$1(PurchasePageViewModel purchasePageViewModel) {
        super(1);
        this.$purchasePageViewModel = purchasePageViewModel;
    }
    ...
    public final void invoke(@NotNull LazyListScope lazyListScope) {
        ...
        LazyListScope.f(lazyListScope, null, new ComposableLambdaImpl(-1043164226, anonymousClass1, true), 3);
    }
}
