...
public final class TouchConfigFutureTech {
    ...
    @NotNull
    public static final TouchConfigFutureTech INSTANCE = new TouchConfigFutureTech();
    ...
    static {
        ...
        Integer valueOf = Integer.valueOf(myImages.getTest31());
        ...
        GamePadTheme gamePadTheme = GamePadTheme.FutureTech;
        BUTTON_CONFIG_START = new ButtonConfig(108, null, false, valueOf, "Start", null, false, radialGamePadTheme, gamePadTheme, 102, null);
        BUTTON_CONFIG_SELECT = new ButtonConfig(109, null, false, Integer.valueOf(myImages.getTest32()), "Select", null, false, new RadialGamePadTheme(ColorKt.j(j2), constants.getDEFAULT_COLOR_PRESSED(), ColorKt.j(j4), ColorKt.j(j6), ColorKt.j(j2), ColorKt.j(myColors.m26getText210d7_KjU()), 1.0f, ColorKt.j(myColors.m30getText260d7_KjU()), ColorKt.j(myColors.m24getText20d7_KjU()), ColorKt.j(j2)), gamePadTheme, 102, null);
        BUTTON_CONFIG_MENU = new ButtonConfig(110, null, false, Integer.valueOf(myImages.getTest29()), "Menu", null, false, new RadialGamePadTheme(ColorKt.j(j2), constants.getDEFAULT_COLOR_PRESSED(), ColorKt.j(j4), ColorKt.j(j6), ColorKt.j(j2), ColorKt.j(myColors.m26getText210d7_KjU()), 1.0f, ColorKt.j(myColors.m30getText260d7_KjU()), ColorKt.j(myColors.m24getText20d7_KjU()), ColorKt.j(j2)), gamePadTheme, 102, null);
        BUTTON_CONFIG_CROSS = new ButtonConfig(97, null, false, Integer.valueOf(myImages.getTest40()), "Cross", null, false, null, gamePadTheme, 230, null);
        BUTTON_CONFIG_SQUARE = new ButtonConfig(100, null, false, Integer.valueOf(myImages.getTest38()), "Square", null, false, null, gamePadTheme, 230, null);
        BUTTON_CONFIG_TRIANGLE = new ButtonConfig(99, null, false, Integer.valueOf(myImages.getTest30()), "Triangle", null, false, null, gamePadTheme, 230, null);
        BUTTON_CONFIG_CIRCLE = new ButtonConfig(96, null, false, Integer.valueOf(myImages.getTest33()), "Circle", null, false, null, gamePadTheme, 230, null);
        ...
        BUTTON_CONFIG_L = new ButtonConfig(102, "L", false, null, null, f0.C(gestureType, gestureType2), false, new RadialGamePadTheme(ColorKt.j(j2), constants.getDEFAULT_COLOR_PRESSED(), ColorKt.j(j4), ColorKt.j(myColors.m40getWhite0d7_KjU()), ColorKt.j(j2), ColorKt.j(myColors.m26getText210d7_KjU()), 1.0f, ColorKt.j(myColors.m30getText260d7_KjU()), ColorKt.j(myColors.m24getText20d7_KjU()), ColorKt.j(j2)), gamePadTheme, 92, null);
        BUTTON_CONFIG_R = new ButtonConfig(103, "R", false, null, null, f0.C(gestureType, gestureType2), false, new RadialGamePadTheme(ColorKt.j(j2), constants.getDEFAULT_COLOR_PRESSED(), ColorKt.j(j4), ColorKt.j(myColors.m40getWhite0d7_KjU()), ColorKt.j(j2), ColorKt.j(myColors.m26getText210d7_KjU()), 1.0f, ColorKt.j(myColors.m30getText260d7_KjU()), ColorKt.j(myColors.m24getText20d7_KjU()), ColorKt.j(j2)), gamePadTheme, 92, null);
        ...
        PRIMARY_DIAL_CROSS = new PrimaryDialConfig.Cross(new CrossConfig(0, shape, Integer.valueOf(myImages.getTest34()), f0.C(gestureType, gestureType2), null, false, null, gamePadTheme, 112, null));
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.cooldev.gba.emulator.gameboy.features.home.models.touch_config.TouchConfigFutureTech$rotationInvert$1] */
    private final TouchConfigFutureTech$rotationInvert$1 rotationInvert() {
        return new SecondaryDialConfig.RotationProcessor() { // from class: com.cooldev.gba.emulator.gameboy.features.home.models.touch_config.TouchConfigFutureTech$rotationInvert$1
    ...
    private final SecondaryDialConfig.RotationProcessor rotationOffset(final float f2) {
        return new SecondaryDialConfig.RotationProcessor() { // from class: com.cooldev.gba.emulator.gameboy.features.home.models.touch_config.TouchConfigFutureTech$rotationOffset$1
            @Override // com.cooldev.gba.emulator.gameboy.features.game_pad.config.SecondaryDialConfig.RotationProcessor
    ...
    public final ButtonConfig BUTTON_CONFIG_A(int i2) {
        return new ButtonConfig(i2, null, false, Integer.valueOf(MyImages.INSTANCE.getTest35()), "A", null, false, null, GamePadTheme.FutureTech, 230, null);
    }

    @NotNull
    public final ButtonConfig BUTTON_CONFIG_B(int i2) {
        return new ButtonConfig(i2, null, false, Integer.valueOf(MyImages.INSTANCE.getTest39()), "B", null, false, null, GamePadTheme.FutureTech, 230, null);
    }

    @NotNull
    public final ButtonConfig BUTTON_CONFIG_X(int i2) {
        return new ButtonConfig(i2, null, false, Integer.valueOf(MyImages.INSTANCE.getTest41()), "X", null, false, null, GamePadTheme.FutureTech, 230, null);
    }

    @NotNull
    public final ButtonConfig BUTTON_CONFIG_Y(int i2) {
        return new ButtonConfig(i2, null, false, Integer.valueOf(MyImages.INSTANCE.getTest37()), "Y", null, false, null, GamePadTheme.FutureTech, 230, null);
    }

    @NotNull
    public final ButtonConfig BUTTON_CONFIG_Z(int i2) {
        return new ButtonConfig(i2, null, false, Integer.valueOf(MyImages.INSTANCE.getTest36()), "Z", null, false, null, GamePadTheme.FutureTech, 230, null);
    }
    ...
    public final RadialGamePadConfig getAtari7800Left(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(4, 1.0f, 0.0f, BUTTON_CONFIG_SELECT, null, null, 48, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getGBALeft(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(2, 1.0f, 0.0f, BUTTON_CONFIG_SELECT, null, null, 48, null), new SecondaryDialConfig.DoubleButton(3, 0.0f, BUTTON_CONFIG_L, null, null, 24, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getGGLeft(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.Empty(4, 1, 1.0f, 0.0f, null, 16, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getGenesis6Right(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, new PrimaryDialConfig.PrimaryButtons(f0.v(new ButtonConfig(96, "C", false, null, null, null, false, null, null, 508, null), BUTTON_CONFIG_Z(103), BUTTON_CONFIG_Y(99), BUTTON_CONFIG_X(102), BUTTON_CONFIG_A(100), new ButtonConfig(0, null, false, null, null, null, false, null, null, 506, null)), BUTTON_CONFIG_B(97), 0.0f, false, null, 28, null), f0.v(new SecondaryDialConfig.Empty(9, 1, 0.5f, 0.0f, null, 16, null), new SecondaryDialConfig.Empty(3, 1, 0.5f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }

    @NotNull
    public final RadialGamePadConfig getLynxLeft(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(4, 1.0f, 0.0f, new ButtonConfig(102, "OPTION 1", false, null, null, null, false, null, null, 508, null), null, null, 48, null), new SecondaryDialConfig.SingleButton(8, 1.0f, 0.0f, new ButtonConfig(103, "OPTION 2", false, null, null, null, false, null, null, 508, null), null, null, 48, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getN64Left(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(2, 1.0f, 0.0f, BUTTON_CONFIG_Z(104), null, null, 48, null), new SecondaryDialConfig.DoubleButton(3, 0.0f, BUTTON_CONFIG_L, null, null, 24, null), new SecondaryDialConfig.Stick(9, 2, 2.2f, 0.1f, 1, null, null, f0.C(GestureType.TRIPLE_TAP, GestureType.FIRST_TOUCH), null, rotationOffset(-8.0f), 352, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getPSXDualshockLeft(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(2, 1.0f, 0.0f, BUTTON_CONFIG_SELECT, null, null, 48, null), new SecondaryDialConfig.SingleButton(3, 1.0f, 0.0f, BUTTON_CONFIG_L1, null, null, 48, null), new SecondaryDialConfig.SingleButton(4, 1.0f, 0.0f, BUTTON_CONFIG_L2, null, null, 48, null), new SecondaryDialConfig.Stick(9, 2, 2.2f, 0.0f, 1, 106, null, f0.C(GestureType.TRIPLE_TAP, GestureType.FIRST_TOUCH), "Left Stick", rotationOffset(-8.0f), 64, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
    ...
    public final RadialGamePadConfig getPSXLeft(@NotNull RadialGamePadTheme radialGamePadTheme) {
        a.s(radialGamePadTheme, RouterName.THEME);
        return new RadialGamePadConfig(12, PRIMARY_DIAL_CROSS, f0.v(new SecondaryDialConfig.SingleButton(2, 1.0f, 0.0f, BUTTON_CONFIG_SELECT, null, null, 48, null), new SecondaryDialConfig.SingleButton(3, 1.0f, 0.0f, BUTTON_CONFIG_L1, null, null, 48, null), new SecondaryDialConfig.SingleButton(4, 1.0f, 0.0f, BUTTON_CONFIG_L2, null, null, 48, null), new SecondaryDialConfig.Empty(8, 1, 1.0f, 0.0f, null, 16, null)), null, radialGamePadTheme, false, GamePadTheme.FutureTech, 40, null);
    }
