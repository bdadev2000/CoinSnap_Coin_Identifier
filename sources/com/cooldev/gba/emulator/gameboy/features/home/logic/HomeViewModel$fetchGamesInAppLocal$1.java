...
public final class HomeViewModel$fetchGamesInAppLocal$1 extends r implements l {
    final /* synthetic */ List<Game> $value;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$fetchGamesInAppLocal$1(List<Game> list) {
        super(1);
        this.$value = list;
    }
