...
public final class HomeViewModel$onChangedSearchText$1 extends r implements l {
    final /* synthetic */ String $value;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$onChangedSearchText$1(String str) {
        super(1);
        this.$value = str;
    }
