...
public final class HomeViewModel$hidePopupOffReward1$1 extends r implements l {
    public static final HomeViewModel$hidePopupOffReward1$1 INSTANCE = new HomeViewModel$hidePopupOffReward1$1();

    public HomeViewModel$hidePopupOffReward1$1() {
        super(1);
    }
