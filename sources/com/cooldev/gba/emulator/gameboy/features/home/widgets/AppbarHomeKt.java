...
import com.cooldev.gba.emulator.gameboy.widgets.app_bar.ManageSubIconWidgetKt;
...
public final class AppbarHomeKt {
    @ComposableTarget
    @Composable
    public static final void AppbarHome(@Nullable Composer composer, int i2) {
        ComposerImpl g2 = composer.g(110840573);
        if (i2 == 0 && g2.i()) {
            g2.A();
        } else {
            ...
            if (iAPState.isPremium()) {
                g2.J(1501842891);
                ManageSubIconWidgetKt.ManageSubIconWidget(g2, 0);
                g2.V(false);
            } else {
                g2.J(1501901357);
            ...
            TextKt.b("Home", null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(MyColors.INSTANCE.m34getText40d7_KjU(), b2, new FontWeight(400), MyFonts.INSTANCE.getDeterminationSans(), 0L, null, 3, b3, 16613336), g2, 6, 0, 65534);
            SpacerKt.a(rowScopeInstance.a(companion, 1.0f, true), g2);
            SettingIconWidgetKt.SettingIconWidget(AppbarHomeKt$AppbarHome$1$1$1.INSTANCE, g2, 6, 0);
            g2.V(true);
            g2.V(true);
        }
        RecomposeScopeImpl Z = g2.Z();
        if (Z != null) {
            Z.d = new AppbarHomeKt$AppbarHome$2(i2);
        }
    }
}
