...
public final class HomePageKt$HomePage$8$1$6 extends r implements a {
    final /* synthetic */ HomeViewModel $homeViewModel;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomePageKt$HomePage$8$1$6(HomeViewModel homeViewModel) {
        super(0);
    ...
    public final void m226invoke() {
        RewardEvents.INSTANCE.logClickReward();
        this.$homeViewModel.showPopupOffReward2();
    }
}
