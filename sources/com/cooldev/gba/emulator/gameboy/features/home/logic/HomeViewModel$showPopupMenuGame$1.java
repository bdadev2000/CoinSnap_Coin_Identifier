...
public final class HomeViewModel$showPopupMenuGame$1 extends r implements l {
    final /* synthetic */ Game $game;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HomeViewModel$showPopupMenuGame$1(Game game) {
        super(1);
        this.$game = game;
    }
