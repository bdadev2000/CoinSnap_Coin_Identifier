...
public final class CancelSubDialogKt$CancelSubDialog$2 extends r implements p {
    final /* synthetic */ a $onBack;
    final /* synthetic */ a $onUnSub;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.dialogs.cancel_sub_dialog.CancelSubDialogKt$CancelSubDialog$2$1, reason: invalid class name */
    /* loaded from: classes2.dex */
        ...
        public final void invoke(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i2) {
            ...
            if (composer.j() instanceof Applier) {
                ...
                if (composer.j() instanceof Applier) {
                    ...
                    CancelSubDialogKt.TextSubtitle(composer, 0);
                    ...
                    if (composer.j() instanceof Applier) {
                        ...
                        composer.J(-1844973062);
                        boolean I = composer.I(aVar);
                        Object u2 = composer.u();
                        Object obj = Composer.Companion.f13690a;
                        if (I || u2 == obj) {
                            u2 = new CancelSubDialogKt$CancelSubDialog$2$1$1$1$1$1$1(aVar);
                            composer.o(u2);
                        }
                        composer.D();
                        CancelSubDialogKt.ButtonUnSub(a4, (a) u2, composer, 0);
                        SpacerKt.a(SizeKt.r(companion, 8), composer);
                        Modifier a5 = rowScopeInstance.a(companion, 5.0f, true);
                        composer.J(-1844964487);
                        boolean I2 = composer.I(aVar2);
                        Object u3 = composer.u();
                        if (I2 || u3 == obj) {
                            u3 = new CancelSubDialogKt$CancelSubDialog$2$1$1$1$1$2$1(aVar2);
                            composer.o(u3);
                        }
                        composer.D();
                        CancelSubDialogKt.ButtonBack(a5, (a) u3, composer, 0);
                        composer.p();
                        composer.p();
                        composer.p();
                        return;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CancelSubDialogKt$CancelSubDialog$2(a aVar, a aVar2) {
        super(2);
        this.$onUnSub = aVar;
        this.$onBack = aVar2;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        ...
        CardKt.a(PaddingKt.h(SizeKt.d(Modifier.Companion.f14687a, 1.0f), 24, 0.0f, 2), RoundedCornerShapeKt.b(16), CardDefaults.a(Color.f14961h, composer), CardDefaults.b(0, 62), null, ComposableLambdaKt.c(233023482, new AnonymousClass1(this.$onUnSub, this.$onBack), composer), composer, 196614, 16);
    }
}
