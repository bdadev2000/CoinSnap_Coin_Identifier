...
/* renamed from: com.cooldev.gba.emulator.gameboy.features.dialogs.cancel_sub_dialog.ComposableSingletons$CancelSubDialogKt$lambda-1$1, reason: invalid class name */
/* loaded from: classes.dex */
public final class ComposableSingletons$CancelSubDialogKt$lambda1$1 extends r implements q {
    public static final ComposableSingletons$CancelSubDialogKt$lambda1$1 INSTANCE = new ComposableSingletons$CancelSubDialogKt$lambda1$1();

    public ComposableSingletons$CancelSubDialogKt$lambda1$1() {
        super(3);
    }
    ...
    public final void invoke(@NotNull RowScope rowScope, @Nullable Composer composer, int i2) {
        ...
        if (composer.j() instanceof Applier) {
            ...
            TextKt.b("Back", PaddingKt.j(companion, 0.0f, 4, 0.0f, 0.0f, 13), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, new TextStyle(MyColors.INSTANCE.m25getText200d7_KjU(), b2, new FontWeight(400), MyFonts.INSTANCE.getDeterminationSans(), 0L, null, 3, b3, 16613336), composer, 54, 0, 65532);
            composer.p();
            return;
        }
        ComposablesKt.a();
