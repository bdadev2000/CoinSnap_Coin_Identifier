...
public final class CancelSubDialogViewModel extends ViewModel {
    ...
    public CancelSubDialogViewModel() {
        i1 c2 = t0.c(new CancelSubDialogState(false, 1, null));
        this._state = c2;
    ...
    public final void hideDialog() {
        updateState(CancelSubDialogViewModel$hideDialog$1.INSTANCE);
    }

    public final void showDialog() {
        updateState(CancelSubDialogViewModel$showDialog$1.INSTANCE);
    }
}
