...
public final class RemoveGameDialogKt$RemoveGameDialog$2 extends r implements p {
    final /* synthetic */ a $onCancel;
    final /* synthetic */ a $onRemove;

    /* renamed from: com.cooldev.gba.emulator.gameboy.features.dialogs.remove_game_dialog.RemoveGameDialogKt$RemoveGameDialog$2$1, reason: invalid class name */
    /* loaded from: classes.dex */
        ...
        public final void invoke(@NotNull ColumnScope columnScope, @Nullable Composer composer, int i2) {
            ...
            if (composer.j() instanceof Applier) {
                ...
                if (composer.j() instanceof Applier) {
                    ...
                    SpacerKt.a(SizeKt.e(companion, f2), composer);
                    RemoveGameDialogKt.TextSubtitle(composer, 0);
                    SpacerKt.a(SizeKt.e(companion, f2), composer);
                    ...
                    if (composer.j() instanceof Applier) {
                        ...
                        if (I || u2 == obj) {
                            u2 = new RemoveGameDialogKt$RemoveGameDialog$2$1$1$1$1$1$1(aVar);
                            composer.o(u2);
                        }
                        composer.D();
                        RemoveGameDialogKt.ButtonCancel(a4, (a) u2, composer, 0);
                        SpacerKt.a(SizeKt.r(companion, 8), composer);
                        Modifier a5 = rowScopeInstance.a(companion, 5.0f, true);
                        composer.J(62317456);
                        boolean I2 = composer.I(aVar2) | composer.I(aVar);
                        Object u3 = composer.u();
                        if (I2 || u3 == obj) {
                            u3 = new RemoveGameDialogKt$RemoveGameDialog$2$1$1$1$1$2$1(aVar2, aVar);
                            composer.o(u3);
                        }
                        composer.D();
                        RemoveGameDialogKt.ButtonRemove(a5, (a) u3, composer, 0);
                        composer.p();
                        composer.p();
                        composer.p();
                        return;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RemoveGameDialogKt$RemoveGameDialog$2(a aVar, a aVar2) {
        super(2);
        this.$onCancel = aVar;
        this.$onRemove = aVar2;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i2) {
        ...
        CardKt.a(PaddingKt.h(SizeKt.d(Modifier.Companion.f14687a, 1.0f), 24, 0.0f, 2), RoundedCornerShapeKt.b(16), CardDefaults.a(Color.f14961h, composer), CardDefaults.b(0, 62), null, ComposableLambdaKt.c(-1310318980, new AnonymousClass1(this.$onCancel, this.$onRemove), composer), composer, 196614, 16);
    }
}
