...
public final class NoInternetDialogKt$NoInternetDialog$1$1 extends r implements a {
    final /* synthetic */ MutableState<Boolean> $openDialog$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NoInternetDialogKt$NoInternetDialog$1$1(MutableState<Boolean> mutableState) {
        super(0);
