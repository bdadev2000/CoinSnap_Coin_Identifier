...
public final class SettingIconWidgetKt$SettingIconWidget$$inlined$debounced$1 extends r implements a {
    ...
    public SettingIconWidgetKt$SettingIconWidget$$inlined$debounced$1(long j2, MutableLongState mutableLongState, a aVar) {
        super(0);
    ...
    public final void m405invoke() {
        ...
        if (uptimeMillis - d > this.$debounceTime) {
            ...
            MultiNavigationAppStateKt.getLocalNavigationState().getDashboardNavigation().navigateTo(RouterName.SETTING);
        }
