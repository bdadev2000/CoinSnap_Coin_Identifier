...
public final class TypeAdapters {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public T read(JsonReader jsonReader) throws IOException {
            ...
            return t2 == null ? this.stringToConstant.get(nextString) : t2;
        }
    ...
    static {
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    ...
                    if (i3 == 1 || i3 == 2) {
                        ...
                        if (nextInt != 0) {
                            if (nextInt != 1) {
                                StringBuilder t2 = d.t("Invalid bitset value ", nextInt, ", expected 0 or 1; at path ");
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder t2 = d.t("Lossy conversion from ", nextInt, " to byte; at path ");
                    t2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(t2.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder t2 = d.t("Lossy conversion from ", nextInt, " to short; at path ");
                    t2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(t2.toString());
                } catch (NumberFormatException e) {
                    throw new JsonSyntaxException(e);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder v2 = d.v("Expecting character, got: ", nextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder v2 = d.v("Failed parsing '", nextString, "' as BigDecimal; at path ");
                    v2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(v2.toString(), e);
                }
            }
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder v2 = d.v("Failed parsing '", nextString, "' as BigInteger; at path ");
                    v2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(v2.toString(), e);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder v2 = d.v("Failed parsing '", nextString, "' as UUID; at path ");
                    v2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(v2.toString(), e);
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder v2 = d.v("Failed parsing '", nextString, "' as Currency; at path ");
                    v2.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(v2.toString(), e);
                }
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i2 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i2 == 1) {
