...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i9, B b) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i9);
        b.f14254a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            b.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            b.f14255c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, b.f14254a);
            return;
        }
        throw new IllegalArgumentException(String.format("Invalid ImageMetadata key: %1$d", Integer.valueOf(i9)));
    }

    private native void nativeDestroyMetadataEntry(long j7, long j9);

    private native long[] nativeGetAllKeys(long j7, long j9);

    private native byte[] nativeGetByteArrayFromMetadataEntry(long j7, long j9);

    private native byte nativeGetByteFromMetadataEntry(long j7, long j9);

    private native double[] nativeGetDoubleArrayFromMetadataEntry(long j7, long j9);

    private native double nativeGetDoubleFromMetadataEntry(long j7, long j9);

    private native float[] nativeGetFloatArrayFromMetadataEntry(long j7, long j9);

    private native float nativeGetFloatFromMetadataEntry(long j7, long j9);

    private native int[] nativeGetIntArrayFromMetadataEntry(long j7, long j9);

    private native int nativeGetIntFromMetadataEntry(long j7, long j9);

    private native long[] nativeGetLongArrayFromMetadataEntry(long j7, long j9);

    private native long nativeGetLongFromMetadataEntry(long j7, long j9);

    private native long nativeGetMetadataEntry(long j7, long j9, int i9);

    private native int nativeGetMetadataEntryValueCount(long j7, long j9);

    private native int nativeGetMetadataEntryValueType(long j7, long j9);

    private native Rational[] nativeGetRationalArrayFromMetadataEntry(long j7, long j9);

    private native Rational nativeGetRationalFromMetadataEntry(long j7, long j9);

    public static native void nativeLoadSymbols();

    private static native void nativeReleaseImageMetadata(long j7, long j9);

    public void finalize() throws Throwable {
        long j7 = this.nativeHandle;
        if (j7 != 0) {
            nativeReleaseImageMetadata(this.nativeSymbolTableHandle, j7);
        }
        super.finalize();
    }

    public byte getByte(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 0 && b.f14255c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
            return nativeGetByteFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i9)));
    }

    public byte[] getByteArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public double getDouble(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 4 && b.f14255c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public double[] getDoubleArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public float getFloat(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 2 && b.f14255c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public float[] getFloatArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public int getInt(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 1 && b.f14255c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public int[] getIntArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public long getLong(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 3 && b.f14255c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", Integer.valueOf(i9), Integer.valueOf(this.sketchEntry.b), Integer.valueOf(this.sketchEntry.f14255c)));
    }

    public long[] getLongArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public Rational getRational(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 5 && b.f14255c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    public Rational[] getRationalArray(int i9) throws MetadataNotFoundException {
        getMetdataEntry(i9, this.sketchEntry);
        B b = this.sketchEntry;
        if (b.b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, b.f14254a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f14254a);
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [com.google.ar.core.B, java.lang.Object] */
    public ImageMetadata(long j7, Session session) {
