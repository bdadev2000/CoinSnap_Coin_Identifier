...
public final class MonochromeRectangleDetector {
    ...
    */
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int i6 = i2 / 2;
        ResultPoint findCornerFromCenter = findCornerFromCenter(i3, -max2, 0, width, i2, 0, y2, height, i6);
        int x = ((int) findCornerFromCenter.getX()) - 1;
        ResultPoint findCornerFromCenter2 = findCornerFromCenter(i3, max2, x, width, i2, 0, y2, height, i6);
        int x2 = ((int) findCornerFromCenter2.getX()) + 1;
        ResultPoint findCornerFromCenter3 = findCornerFromCenter(i3, 0, x, x2, i2, max, y2, height, i5);
        return new ResultPoint[]{findCornerFromCenter(i3, 0, x, x2, i2, i4, y2, ((int) findCornerFromCenter3.getY()) + 1, i3 / 4), findCornerFromCenter, findCornerFromCenter2, findCornerFromCenter3};
    }
}
