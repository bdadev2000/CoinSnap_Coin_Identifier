...
public final class WhiteRectangleDetector {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        while (z8) {
            ...
            boolean z10 = true;
            while (true) {
                if ((z10 || !z3) && i3 < this.width) {
                    z10 = containsBlackPoint(i4, i5, i3, false);
                    if (z10) {
                        i3++;
                        z3 = true;
                        z9 = true;
            ...
            if (i3 < this.width) {
                boolean z11 = true;
                while (true) {
                    if ((z11 || !z4) && i5 < this.height) {
                        z11 = containsBlackPoint(i2, i3, i5, true);
                        if (z11) {
                            i5++;
                            z4 = true;
                            z9 = true;
                ...
                if (i5 < this.height) {
                    ...
                    while (true) {
                        if ((z12 || !z5) && i2 >= 0) {
                            z12 = containsBlackPoint(i4, i5, i2, false);
                            if (z12) {
                                i2--;
                                z5 = true;
                                z9 = true;
                    ...
                    if (i2 >= 0) {
                        ...
                        while (true) {
                            if ((z13 || !z7) && i4 >= 0) {
                                z13 = containsBlackPoint(i2, i3, i4, true);
                                if (z13) {
                                    i4--;
                                    z8 = true;
                                    z7 = true;
