...
public final class PerspectiveTransform {
    ...
    public PerspectiveTransform times(PerspectiveTransform perspectiveTransform) {
        ...
        float f28 = this.a33;
        return new PerspectiveTransform(f8, f12, f17, f21, f22, f24, (f7 * f28) + f27, (f11 * f28) + (f10 * f26) + (f9 * f25), (f28 * f15) + (f26 * f14) + (f25 * f13));
    }
    ...
    public void transformPoints(float[] fArr, float[] fArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            fArr[i2] = (((this.a21 * f3) + (this.a11 * f2)) + this.a31) / f4;
            fArr2[i2] = (((this.a22 * f3) + (this.a12 * f2)) + this.a32) / f4;
        }
    }
}
