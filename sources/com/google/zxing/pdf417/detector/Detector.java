...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z2) throws NotFoundException {
        ...
        List<ResultPoint[]> detect = detect(z2, blackMatrix);
        if (detect.isEmpty()) {
            blackMatrix = blackMatrix.m611clone();
            blackMatrix.rotate180();
            detect = detect(z2, blackMatrix);
        }
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i2, int i3, int i4, int i5, int[] iArr) {
        ...
        while (true) {
            ...
            int[] findGuardPattern = findGuardPattern(bitMatrix, i5, i7, i3, false, iArr, iArr2);
            if (findGuardPattern != null) {
                int i8 = i7;
                int[] iArr3 = findGuardPattern;
                while (i8 > 0) {
                    int i9 = i8 - 1;
                    int[] findGuardPattern2 = findGuardPattern(bitMatrix, i5, i9, i3, false, iArr, iArr2);
        ...
        if (z2) {
            ...
            while (true) {
                ...
                int i13 = i12;
                int[] findGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i11, i3, false, iArr, iArr2);
