...
public final class PDF417Reader implements Reader, MultipleBarcodeReader {
    ...
    private static int getMinWidth(ResultPoint resultPoint, ResultPoint resultPoint2) {
        return (resultPoint == null || resultPoint2 == null) ? Api.BaseClientBuilder.API_PRIORITY_OTHER : (int) Math.abs(resultPoint.getX() - resultPoint2.getX());
    }
    ...
    private static Result[] decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z2) throws NotFoundException, FormatException, ChecksumException {
        ArrayList arrayList = new ArrayList();
        PDF417DetectorResult detect = Detector.detect(binaryBitmap, map, z2);
