    ...
    public byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            if (i4 == height && i2 == 0 && !z2) {
                ...
                int i5 = height - 2;
                if (i4 == i5 && i2 == 0 && (width & 3) != 0 && !z3) {
                    bArr[i3] = (byte) readCorner2(height, width);
                    i4 -= 2;
                    i2 += 2;
                    i3++;
                    z3 = true;
                } else if (i4 == height + 4 && i2 == 2 && (width & 7) == 0 && !z4) {
                    bArr[i3] = (byte) readCorner3(height, width);
                    i4 -= 2;
                    i2 += 2;
                    i3++;
                    z4 = true;
                } else if (i4 == i5 && i2 == 0 && (width & 7) == 4 && !z5) {
                    ...
                    while (true) {
                        if (i8 >= 0 && i9 < width && !this.readMappingMatrix.get(i9, i8)) {
                            bArr[i3] = (byte) readUtah(i8, i9, height, width);
                            i3++;
                        }
                        int i10 = i8 + 2;
                        int i11 = i9 - 2;
