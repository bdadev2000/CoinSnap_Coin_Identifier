...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private boolean shouldUpdateVisibility(@NonNull View view, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.LayoutParams) extendedFloatingActionButton.getLayoutParams()).f18361f == view.getId();
        }
    ...
    public void performMotion(int i2, @Nullable final OnChangedCallback onChangedCallback) {
        ...
        if (i2 == 0) {
            ...
            if (i2 != 3) {
                throw new IllegalStateException(d.i("Unknown strategy type: ", i2));
            }
    ...
    */
    public ExtendedFloatingActionButton(@androidx.annotation.NonNull android.content.Context r17, @androidx.annotation.Nullable android.util.AttributeSet r18, int r19) {
        /*
            ...
            java.util.WeakHashMap r15 = androidx.core.view.ViewCompat.f18740a
