...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            if (isSystemAnimatorDisabled() && (drawable = this.staticDummyDrawable) != null) {
                ...
                DrawableCompat.i(this.staticDummyDrawable, this.baseSpec.indicatorColors[0]);
            ...
            if (i2 == 0) {
                ...
                DrawingDelegate.ActiveIndicator activeIndicator2 = (DrawingDelegate.ActiveIndicator) a.g(this.animatorDelegate.activeIndicators, 1);
                ...
                if (drawingDelegate instanceof LinearDrawingDelegate) {
                    ...
                    alpha = 0;
                    drawingDelegate.fillTrack(canvas, this.paint, activeIndicator2.endFraction, 1.0f + activeIndicator.startFraction, this.baseSpec.trackColor, 0, i2);
                }
            }
    ...
    public static IndeterminateDrawable<CircularProgressIndicatorSpec> createCircularDrawable(@NonNull Context context, @NonNull CircularProgressIndicatorSpec circularProgressIndicatorSpec, @NonNull CircularDrawingDelegate circularDrawingDelegate) {
        ...
        indeterminateDrawable.setStaticDummyDrawable(VectorDrawableCompat.a(context.getResources(), R.drawable.indeterminate_static, null));
