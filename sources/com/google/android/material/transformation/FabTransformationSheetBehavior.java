    ...
    private void updateImportantForAccessibility(@NonNull View view, boolean z2) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                boolean z3 = (childAt.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) && (((CoordinatorLayout.LayoutParams) childAt.getLayoutParams()).f18358a instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z3) {
                    if (z2) {
