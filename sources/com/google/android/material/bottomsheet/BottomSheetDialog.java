...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        public void setWindow(@Nullable Window window) {
            ...
            this.window = window;
            if (window != null) {
                this.lightStatusBar = new WindowInsetsControllerCompat(window.getDecorView(), window).d();
            }
        }
        ...
        private EdgeToEdgeCallback(@NonNull View view, @NonNull WindowInsetsCompat windowInsetsCompat) {
            ...
            if (materialShapeDrawable != null) {
                i2 = materialShapeDrawable.getFillColor();
            } else {
                i2 = ViewCompat.i(view);
            }
            if (i2 != null) {
                this.lightBottomSheet = Boolean.valueOf(MaterialColors.isColorLight(i2.getDefaultColor()));
                return;
            }
    ...
    private View wrapInBottomSheet(int i2, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ...
        if (this.edgeToEdgeEnabled) {
            ViewCompat.H(this.bottomSheet, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.1
        ...
        ViewCompat.A(this.bottomSheet, new AccessibilityDelegateCompat() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.3
