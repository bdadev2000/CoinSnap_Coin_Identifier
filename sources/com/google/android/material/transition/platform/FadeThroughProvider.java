...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f2, final float f3, @FloatRange final float f4, @FloatRange final float f5, final float f6) {
    ...
    public void setProgressThreshold(@FloatRange float f2) {
