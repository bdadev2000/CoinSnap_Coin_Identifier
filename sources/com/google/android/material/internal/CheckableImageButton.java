...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.cooldev.gba.emulator.gameboy.R.attr.imageButtonStyle);
    }
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        ViewCompat.A(this, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.f18826a.setCheckable(CheckableImageButton.this.isCheckable());
                accessibilityNodeInfoCompat.f18826a.setChecked(CheckableImageButton.this.isChecked());
            }
        });
    }
}
