...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private EdgeTreatment createMarkerEdge() {
        ...
        return new OffsetEdgeTreatment(new MarkerEdgeTreatment(this.arrowSize), Math.min(Math.max(f2, -width), width));
    }
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        ...
        boolean z2 = obtainStyledAttributes.getBoolean(R.styleable.Tooltip_showMarker, true);
        this.showMarker = z2;
        if (z2) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.translate(calculatePointerOffset, f2);
        super.draw(canvas);
        drawText(canvas);
        canvas.restore();
    }
    ...
    public void setRevealFraction(@FloatRange float f2) {
