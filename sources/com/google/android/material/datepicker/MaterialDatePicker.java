...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public class AnonymousClass3 implements OnApplyWindowInsetsListener {
        ...
        public AnonymousClass3(int i2, View view, int i3) {
            r2 = i2;
            r3 = view;
            r4 = i3;
        }
        ...
        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
            int i2 = windowInsetsCompat.e(7).f18534b;
            if (r2 >= 0) {
                r3.getLayoutParams().height = r2 + i2;
                View view2 = r3;
                view2.setLayoutParams(view2.getLayoutParams());
            }
            View view3 = r3;
            view3.setPadding(view3.getPaddingLeft(), r4 + i2, r3.getPaddingRight(), r3.getPaddingBottom());
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.a(context, com.google.android.material.R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.a(context, com.google.android.material.R.drawable.material_ic_edit_black_24dp));
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.H(findViewById, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            final /* synthetic */ View val$headerLayout;
            final /* synthetic */ int val$originalHeaderHeight;
            final /* synthetic */ int val$originalPaddingTop;

            public AnonymousClass3(int i2, View findViewById2, int i3) {
                r2 = i2;
                r3 = findViewById2;
                r4 = i3;
            }
    ...
    private void initHeaderToggle(Context context) {
        ...
        ViewCompat.A(this.headerToggleButton, null);
        updateToggleContentDescription(this.headerToggleButton);
        this.headerToggleButton.setOnClickListener(new com.applovin.mediation.nativeAds.a(this, 4));
    }
    ...
    private void startPickerFragment() {
        ...
        d.g(com.google.android.material.R.id.mtrl_calendar_frame, this.pickerFragment);
        d.e();
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        this.background.setElevation(ViewCompat.k(dialog.getWindow().getDecorView()));
        return dialog;
    }
