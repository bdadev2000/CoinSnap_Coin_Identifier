...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void applyChildDrawable(@Nullable Drawable drawable) {
        ...
        if (drawable == this.closeIcon) {
            ...
            DrawableCompat.j(drawable, this.closeIconTint);
            return;
        }
        Drawable drawable2 = this.chipIcon;
        if (drawable == drawable2 && this.hasChipIconTint) {
            DrawableCompat.j(drawable2, this.chipIconTint);
        }
        if (drawable.isStateful()) {
    ...
    private void drawDebug(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.g(-16777216, 127));
            ...
            this.debugPaint.setColor(ColorUtils.g(Opcodes.V_PREVIEW, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.g(-16711936, 127));
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i2, i3, new int[0]);
    ...
    public boolean onLayoutDirectionChanged(int i2) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.h(this.chipIcon, i2);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.h(this.checkedIcon, i2);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.h(this.closeIcon, i2);
        }
    ...
    public void setCheckedIconResource(@DrawableRes int i2) {
        setCheckedIcon(AppCompatResources.a(this.context, i2));
    }
    ...
    public void setCheckedIconTint(@Nullable ColorStateList colorStateList) {
        if (this.checkedIconTint != colorStateList) {
            ...
            if (canShowCheckedIcon()) {
                DrawableCompat.j(this.checkedIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCheckedIconTintResource(@ColorRes int i2) {
        setCheckedIconTint(ContextCompat.getColorStateList(this.context, i2));
    }
    ...
    public void setChipBackgroundColorResource(@ColorRes int i2) {
        setChipBackgroundColor(ContextCompat.getColorStateList(this.context, i2));
    }
    ...
    public void setChipIconResource(@DrawableRes int i2) {
        setChipIcon(AppCompatResources.a(this.context, i2));
    }
    ...
    public void setChipIconTint(@Nullable ColorStateList colorStateList) {
        ...
        if (this.chipIconTint != colorStateList) {
            ...
            if (showsChipIcon()) {
                DrawableCompat.j(this.chipIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setChipIconTintResource(@ColorRes int i2) {
        setChipIconTint(ContextCompat.getColorStateList(this.context, i2));
    }
    ...
    public void setChipStrokeColorResource(@ColorRes int i2) {
        setChipStrokeColor(ContextCompat.getColorStateList(this.context, i2));
    }
    ...
    public void setCloseIconContentDescription(@Nullable CharSequence charSequence) {
        if (this.closeIconContentDescription != charSequence) {
            ...
            this.closeIconContentDescription = c2.d(charSequence, c2.f18659c);
            invalidateSelf();
        }
    }
    ...
    public void setCloseIconResource(@DrawableRes int i2) {
        setCloseIcon(AppCompatResources.a(this.context, i2));
    }
    ...
    public void setCloseIconTint(@Nullable ColorStateList colorStateList) {
        if (this.closeIconTint != colorStateList) {
            ...
            if (showsCloseIcon()) {
                DrawableCompat.j(this.closeIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconTintResource(@ColorRes int i2) {
        setCloseIconTint(ContextCompat.getColorStateList(this.context, i2));
    }
    ...
    public void setRippleColorResource(@ColorRes int i2) {
        setRippleColor(ContextCompat.getColorStateList(this.context, i2));
    }
