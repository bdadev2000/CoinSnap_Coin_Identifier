...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @VisibleForTesting
    public ActivityRecognitionResult(@NonNull DetectedActivity detectedActivity, long j7, long j9) {
        this(Collections.singletonList(detectedActivity), j7, j9, 0, null);
    }
    ...
    */
    ...
    public int getActivityConfidence(int i9) {
        for (DetectedActivity detectedActivity : this.zza) {
            if (detectedActivity.getType() == i9) {
    ...
    public ActivityRecognitionResult(@NonNull List<DetectedActivity> list, long j7, long j9) {
        this(list, j7, j9, 0, null);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(id = 1) List<DetectedActivity> list, @SafeParcelable.Param(id = 2) long j7, @SafeParcelable.Param(id = 3) long j9, @SafeParcelable.Param(id = 4) int i9, @Nullable @SafeParcelable.Param(id = 5) Bundle bundle) {
        Preconditions.checkArgument(list != null && list.size() > 0, "Must have at least 1 detected activity");
        Preconditions.checkArgument(j7 > 0 && j9 > 0, "Must set times");
        this.zza = list;
        this.zzb = j7;
        this.zzc = j9;
        this.zzd = i9;
