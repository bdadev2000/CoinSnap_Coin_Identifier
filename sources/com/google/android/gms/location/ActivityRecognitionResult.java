...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @VisibleForTesting
    public ActivityRecognitionResult(@NonNull DetectedActivity detectedActivity, long j3, long j10) {
        this(Collections.singletonList(detectedActivity), j3, j10, 0, null);
    }
    ...
    */
    ...
    public ActivityRecognitionResult(@NonNull List<DetectedActivity> list, long j3, long j10) {
        this(list, j3, j10, 0, null);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(id = 1) List list, @SafeParcelable.Param(id = 2) long j3, @SafeParcelable.Param(id = 3) long j10, @SafeParcelable.Param(id = 4) int i10, @Nullable @SafeParcelable.Param(id = 5) Bundle bundle) {
        Preconditions.checkArgument(list != null && list.size() > 0, "Must have at least 1 detected activity");
        Preconditions.checkArgument(j3 > 0 && j10 > 0, "Must set times");
        this.zza = list;
        this.zzb = j3;
        this.zzc = j10;
        this.zzd = i10;
