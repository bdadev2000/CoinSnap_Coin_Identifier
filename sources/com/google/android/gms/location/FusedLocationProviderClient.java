...
public class FusedLocationProviderClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    private final Task<Void> zze(final com.google.android.gms.internal.location.zzba zzbaVar, final LocationCallback locationCallback, Looper looper, final zzan zzanVar, int i9) {
        ...
        }).unregister(zzakVar).withHolder(createListenerHolder).setMethodKey(i9).build());
    }
    ...
    public Task<Location> getCurrentLocation(int i9, @NonNull final CancellationToken cancellationToken) {
    ...
    @NonNull
    @RequiresPermission(anyOf = {"android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION"})
    public Task<Void> setMockMode(final boolean z8) {
        return doWrite(TaskApiCall.builder().run(new RemoteCall(z8) { // from class: com.google.android.gms.location.zzah
