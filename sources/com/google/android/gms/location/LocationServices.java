...
public class LocationServices {
    ...
    public static com.google.android.gms.internal.location.zzaz zza(GoogleApiClient googleApiClient) {
        ...
        Preconditions.checkArgument(z8, "GoogleApiClient parameter is required.");
        ...
        Preconditions.checkState(z9, "GoogleApiClient is not configured to use the LocationServices.API Api. Pass thisinto GoogleApiClient.Builder#addApi() to use this feature.");
        return zzazVar;
    }
