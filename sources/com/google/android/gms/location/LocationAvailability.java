...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public LocationAvailability(@SafeParcelable.Param(id = 4) int i10, @SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) long j3, @SafeParcelable.Param(id = 5) zzac[] zzacVarArr, @SafeParcelable.Param(id = 6) boolean z10) {
        this.zzc = i10 < 1000 ? 0 : 1000;
        this.zzd = i11;
        this.zze = i12;
        this.zzf = j3;
        this.zzg = zzacVarArr;
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i10) {
        ...
        SafeParcelWriter.writeTypedArray(parcel, 5, this.zzg, i10, false);
