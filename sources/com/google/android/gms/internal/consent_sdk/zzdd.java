...
public abstract class zzdd extends zzda implements List, RandomAccess {
    ...
    public static zzdd zzg(Object[] objArr, int i2) {
        return i2 == 0 ? zzdg.zza : new zzdg(objArr, i2);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i2 = 0; i2 < size; i2++) {
                        if (zzcv.zza(get(i2), list.get(i2))) {
                        }
                    }
                    return true;
                }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzdd subList(int i2, int i3) {
        zzcw.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzdg.zza : new zzdc(this, i2, i4);
    }

    @Override // java.util.List
    /* renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzdk listIterator(int i2) {
        zzcw.zzb(i2, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzdb(this, i2);
    }
}
