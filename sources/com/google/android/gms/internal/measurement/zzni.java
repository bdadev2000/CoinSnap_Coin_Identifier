...
public final class zzni implements zznj {
    ...
    static {
        ...
        zze = zza2.zza("measurement.config.cache_time", j.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzt = zza2.zza("measurement.rb.max_trigger_registrations_per_day", 0L);
        ...
        zzw = zza2.zza("measurement.alarm_manager.minimum_interval", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
        zzx = zza2.zza("measurement.upload.minimum_delay", 500L);
        zzy = zza2.zza("measurement.monitoring.sample_period_millis", j.TWENTY_FOUR_HOURS_MILLIS);
        zzz = zza2.zza("measurement.config.notify_trigger_uris_on_backgrounded", true);
        zzaa = zza2.zza("measurement.rb.attribution.app_allowlist", "com.labpixies.flood,com.sofascore.results,games.spearmint.triplecrush,com.block.juggle,io.supercent.linkedcubic,com.cdtg.gunsound,com.corestudios.storemanagementidle,com.cdgames.fidget3d,io.supercent.burgeridle,io.supercent.pizzaidle,jp.ne.ibis.ibispaintx.app,com.dencreak.dlcalculator,com.ebay.kleinanzeigen,de.wetteronline.wetterapp,com.game.shape.shift,com.champion.cubes,bubbleshooter.orig,com.wolt.android,com.master.hotelmaster,com.games.bus.arrival,com.playstrom.dop2,com.huuuge.casino.slots,com.ig.spider.fighting,com.jura.coloring.page,com.rikkogame.ragdoll2,com.ludo.king,com.sigma.prank.sound.haircut,com.crazy.block.robo.monster.cliffs.craft,com.fugo.wow,com.maps.locator.gps.gpstracker.phone,com.gamovation.tileclub,com.pronetis.ironball2,com.meesho.supply,pdf.pdfreader.viewer.editor.free,com.dino.race.master,com.ig.moto.racing,ai.photo.enhancer.photoclear,com.duolingo,com.candle.magic_piano,com.free.vpn.super.hotspot.open,sg.bigo.live,com.cdg.tictactoe,com.zhiliaoapp.musically.go,com.wildspike.wormszone,com.mast.status.video.edit,com.vyroai.photoeditorone,com.pujiagames.deeeersimulator,com.superbinogo.jungleboyadventure,com.trustedapp.pdfreaderpdfviewer,com.artimind.aiart.artgenerator.artavatar,de.cellular.ottohybrid,com.zeptolab.cats.google,in.crossy.daily_crossword");
        zzab = zza2.zza("measurement.upload.realtime_upload_interval", 10000L);
        zzac = zza2.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zza2.zza("measurement.config.cache_time.service", 3600000L);
        zzad = zza2.zza("measurement.service_client.idle_disconnect_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
        zza2.zza("measurement.log_tag.service", "FA-SVC");
        zzae = zza2.zza("measurement.sgtm.app_allowlist", "de.zalando.mobile.internal,de.zalando.mobile.internal.debug,de.zalando.lounge.dev,grit.storytel.app,com.rbc.mobile.android,com.rbc.mobile.android,com.dylvian.mango.activities,com.home24.android,com.home24.android.staging,se.lf.mobile.android,se.lf.mobile.android.beta,se.lf.mobile.android.rc,se.lf.mobile.android.test,se.lf.mobile.android.test.debug,com.boots.flagship.android,com.boots.flagshiproi.android,de.zalando.mobile,com.trivago,com.getyourguide.android,es.mobail.meliarewards,se.nansen.coop.debug,se.nansen.coop,se.coop.coop.qa,com.booking,com.google.firebaseengage,com.mse.mseapp.dev,com.mse.mseapp,pl.eobuwie.eobuwieapp,br.com.eventim.mobile.app.Android,ch.ticketcorner.mobile.app.Android,de.eventim.mobile.app.Android,dk.billetlugen.mobile.app.Android,nl.eventim.mobile.app.Android,com.asos.app,com.blueshieldca.prod,dk.magnetix.tivoliapp,matas.matas.internal,nl.omoda,com.thetrainline,com.simo.androidtest,de.aboutyou.mobile.app,com.hometogo,de.casamundo.casamundomobile,it.casevacanz,eu.coolblue.shop,com.stihl.app,com.indeed.android.jobsearch,com.homeretailgroup.argos.android,com.dylvian.mango.activities.pre,se.nansen.coop.qa");
        zzaf = zza2.zza("measurement.upload.stale_data_deletion_interval", j.TWENTY_FOUR_HOURS_MILLIS);
        zzag = zza2.zza("measurement.rb.attribution.uri_authority", "google-analytics.com");
        zzah = zza2.zza("measurement.rb.attribution.max_queue_time", 1209600000L);
        zzai = zza2.zza("measurement.rb.attribution.uri_path", "privacy-sandbox/register-app-conversion");
        zzaj = zza2.zza("measurement.rb.attribution.query_parameters_to_remove", "");
        zzak = zza2.zza("measurement.rb.attribution.uri_scheme", Constants.SCHEME);
        zzal = zza2.zza("measurement.sdk.attribution.cache.ttl", 604800000L);
        zzam = zza2.zza("measurement.redaction.app_instance_id.ttl", 7200000L);
        zzan = zza2.zza("measurement.upload.backoff_period", 43200000L);
        zzao = zza2.zza("measurement.upload.initial_upload_delay_time", 15000L);
        zzap = zza2.zza("measurement.upload.interval", 3600000L);
        zzaq = zza2.zza("measurement.upload.max_bundle_size", 65536L);
        zzar = zza2.zza("measurement.upload.max_bundles", 100L);
        zzas = zza2.zza("measurement.upload.max_conversions_per_day", 500L);
        zzat = zza2.zza("measurement.upload.max_error_events_per_day", 1000L);
        zzau = zza2.zza("measurement.upload.max_events_per_bundle", 1000L);
        zzav = zza2.zza("measurement.upload.max_events_per_day", 100000L);
        zzaw = zza2.zza("measurement.upload.max_public_events_per_day", 50000L);
        zzax = zza2.zza("measurement.upload.max_queue_time", 518400000L);
        zzay = zza2.zza("measurement.upload.max_realtime_events_per_day", 10L);
        zzaz = zza2.zza("measurement.upload.max_batch_size", 65536L);
        zzba = zza2.zza("measurement.upload.retry_count", 6L);
        zzbb = zza2.zza("measurement.upload.retry_time", 1800000L);
        zzbc = zza2.zza("measurement.upload.url", "https://app-measurement.com/a");
        zzbd = zza2.zza("measurement.upload.window_interval", 3600000L);
        zzbe = zza2.zza("measurement.rb.attribution.user_properties", "_npa,npa|_fot,fot");
    }
