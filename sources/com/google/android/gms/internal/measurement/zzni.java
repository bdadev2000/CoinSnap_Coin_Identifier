...
public final class zzni implements zznj {
    ...
    static {
        ...
        zza = zza2.zza("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzab = zza2.zza("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzad = zza2.zza("measurement.service_client.idle_disconnect_millis", 5000L);
        ...
        zzaf = zza2.zza("measurement.upload.stale_data_deletion_interval", 86400000L);
        ...
        zzak = zza2.zza("measurement.rb.attribution.uri_scheme", "https");
        ...
        zzaq = zza2.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzaz = zza2.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
