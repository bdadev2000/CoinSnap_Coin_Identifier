...
public final class zzbc extends zzay {
    ...
    public final zzaq zza(String str, zzh zzhVar, List<zzaq> list) {
        ...
        switch (zzbf.zza[zzg.zza(str).ordinal()]) {
            case 1:
                ...
                throw new IllegalArgumentException(AbstractC2914a.d("Function arguments for Apply are not a list found ", zza3.getClass().getCanonicalName()));
            case 2:
            ...
            case 12:
                ...
                if (zza9 instanceof zzaf) {
                    if (zza10 instanceof zzaf) {
                        ...
                        while (true) {
                            if (i9 < zzafVar.zzb()) {
                                if (z8 || zza8.equals(zzhVar.zza(zzafVar.zza(i9)))) {
                                    zzaq zza11 = zzhVar.zza(zzafVar2.zza(i9));
    ...
    private static zzaq zza(zzh zzhVar, List<zzaq> list) {
        ...
        throw new IllegalArgumentException(AbstractC2914a.d("FN requires an ArrayValue of parameter names found ", zza2.getClass().getCanonicalName()));
    }
}
