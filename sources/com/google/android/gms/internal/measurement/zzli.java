...
final class zzli<T> implements zzlu<T> {
    ...
    public final int zza(T t2) {
        ...
        int zzb = zzmkVar.zzb(zzmkVar.zzd(t2));
        return this.zzc ? zzb + this.zzd.zza(t2).zza() : zzb;
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzlu
    public final void zza(T t2, zzlr zzlrVar, zzjg zzjgVar) throws IOException {
        boolean zzt;
        zzmk<?, ?> zzmkVar = this.zzb;
        zzji<?> zzjiVar = this.zzd;
        Object zzc = zzmkVar.zzc(t2);
        zzjm<?> zzb = zzjiVar.zzb(t2);
                ...
                if (zzd != 11) {
                    if ((zzd & 7) == 2) {
                        ...
                        if (zza != null) {
                            ...
                            zzt = zzmkVar.zza((zzmk<?, ?>) zzc, zzlrVar, 0);
                        }
                    } else {
                        zzt = zzlrVar.zzt();
                    }
                    if (!zzt) {
                        zzmkVar.zzb((Object) t2, (T) zzc);
                        return;
                    }
                } else {
                    Object obj = null;
                    ...
                    while (zzlrVar.zzc() != Integer.MAX_VALUE) {
                        ...
                        if (zzd2 == 16) {
                            i2 = zzlrVar.zzj();
                            obj = zzjiVar.zza(zzjgVar, this.zza, i2);
                        } else if (zzd2 == 26) {
                            if (obj != null) {
                    ...
                    if (zzikVar != null) {
                        if (obj != null) {
                            ...
                            zzmkVar.zza((zzmk<?, ?>) zzc, i2, zzikVar);
                        }
                    }
                }
            } catch (Throwable th) {
    ...
    */
    ...
    public final void zza(T t2, zznb zznbVar) throws IOException {
        ...
        zzmk<?, ?> zzmkVar = this.zzb;
        zzmkVar.zza((zzmk<?, ?>) zzmkVar.zzd(t2), zznbVar);
    }
}
