...
public final class zzaf implements zzak, zzaq, Iterable<zzaq> {
    ...
    public final Double zze() {
        return this.zza.size() == 1 ? zza(0).zze() : this.zza.size() <= 0 ? Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) : Double.valueOf(Double.NaN);
    }
    ...
    public final boolean zzc(int i2) {
        ...
        throw new IndexOutOfBoundsException(d.i("Out of bounds index: ", i2));
    }
    ...
    public final void zza(int i2, zzaq zzaqVar) {
        ...
        throw new IllegalArgumentException(d.i("Invalid value index: ", i2));
    }
