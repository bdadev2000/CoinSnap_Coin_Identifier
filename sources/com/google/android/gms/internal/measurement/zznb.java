...
public final class zznb implements zznc {
    ...
    static {
        ...
        zzd = zza2.zza("measurement.config.cache_time", j.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzs = zza2.zza("measurement.alarm_manager.minimum_interval", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
        zzt = zza2.zza("measurement.upload.minimum_delay", 500L);
        zzu = zza2.zza("measurement.monitoring.sample_period_millis", j.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzy = zza2.zza("measurement.service_client.idle_disconnect_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
        ...
        zzaa = zza2.zza("measurement.upload.stale_data_deletion_interval", j.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzag = zza2.zza("measurement.sdk.attribution.cache.ttl", 604800000L);
        zzah = zza2.zza("measurement.redaction.app_instance_id.ttl", 7200000L);
        zzai = zza2.zza("measurement.upload.backoff_period", 43200000L);
        ...
        zzar = zza2.zza("measurement.upload.max_public_events_per_day", 50000L);
