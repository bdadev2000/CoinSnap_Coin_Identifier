...
final class zzjb implements zzlr {
    ...
    private final <T> void zzd(T t5, zzlu<T> zzluVar, zzjg zzjgVar) throws IOException {
        int zzj = this.zza.zzj();
        zziw zziwVar = this.zza;
        if (zziwVar.zza < zziwVar.zzb) {
            int zzb = zziwVar.zzb(zzj);
            this.zza.zza++;
            zzluVar.zza(t5, this, zzjgVar);
            this.zza.zzc(0);
            r5.zza--;
            this.zza.zzd(zzb);
            return;
    ...
    private final <T> void zzc(T t5, zzlu<T> zzluVar, zzjg zzjgVar) throws IOException {
        int i10 = this.zzc;
    ...
    @Override // com.google.android.gms.internal.measurement.zzlr
    public final <T> void zzb(T t5, zzlu<T> zzluVar, zzjg zzjgVar) throws IOException {
        zzb(2);
        zzd(t5, zzluVar, zzjgVar);
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzlr
    public final <T> void zza(T t5, zzlu<T> zzluVar, zzjg zzjgVar) throws IOException {
        zzb(3);
        zzc(t5, zzluVar, zzjgVar);
    }
