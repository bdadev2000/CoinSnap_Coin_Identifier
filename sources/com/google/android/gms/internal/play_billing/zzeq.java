...
public final class zzeq extends zzdh implements RandomAccess, zzfc, zzgj {
    ...
    public final /* bridge */ /* synthetic */ zzfc zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzeq(Arrays.copyOf(this.zzb, i2), this.zzc, true);
        }
    ...
    private zzeq(float[] fArr, int i2, boolean z2) {
        super(z2);
        this.zzb = fArr;
        this.zzc = i2;
    }
