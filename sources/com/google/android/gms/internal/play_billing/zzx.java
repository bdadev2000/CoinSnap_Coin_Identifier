...
public final class zzx {
    ...
    public static void zzd(int i2, int i3, int i4) {
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            throw new IndexOutOfBoundsException((i2 < 0 || i2 > i4) ? zze(i2, i4, "start index") : (i3 < 0 || i3 > i4) ? zze(i3, i4, "end index") : zzy.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2)));
        }
    }
