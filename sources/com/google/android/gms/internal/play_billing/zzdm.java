...
final class zzdm extends zzdq {
    ...
    public final void zza(Object obj, long j3) {
        ...
        List list = (List) zzfp.zzf(obj, j3);
        ...
        zzfp.zzs(obj, j3, unmodifiableList);
    }
    ...
    public final void zzb(Object obj, Object obj2, long j3) {
        zzdj zzdjVar;
        List list = (List) zzfp.zzf(obj2, j3);
        int size = list.size();
        List list2 = (List) zzfp.zzf(obj, j3);
        if (list2.isEmpty()) {
