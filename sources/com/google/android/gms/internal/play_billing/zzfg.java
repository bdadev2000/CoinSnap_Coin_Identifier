...
public final class zzfg {
    ...
    static {
        ...
        zzd = zzfgVar4;
        zzfg zzfgVar5 = new zzfg("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        zze = zzfgVar5;
    ...
    private zzfg(String str, int i2, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
