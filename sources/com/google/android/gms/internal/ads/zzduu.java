...
public final class zzduu {
    ...
    private String zze = "";
    private final int zzc = ((Integer) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcn.zziM)).intValue();
    private final int zzd = ((Integer) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcn.zziN)).intValue();
    ...
    public final JSONObject zza() throws JSONException {
        ...
        if (this.zze.isEmpty()) {
            try {
                drawable = (Drawable) Wrappers.packageManager(this.zza).getApplicationLabelAndIcon(this.zzb.packageName).f21421b;
