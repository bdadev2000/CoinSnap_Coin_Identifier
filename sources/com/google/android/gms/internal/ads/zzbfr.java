...
public final class zzbfr extends AbstractSafeParcelable {
    ...
    public zzbfr(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) boolean z2, @SafeParcelable.Param(id = 3) int i3, @SafeParcelable.Param(id = 4) boolean z3, @SafeParcelable.Param(id = 5) int i4, @SafeParcelable.Param(id = 6) com.google.android.gms.ads.internal.client.zzgb zzgbVar, @SafeParcelable.Param(id = 7) boolean z4, @SafeParcelable.Param(id = 8) int i5, @SafeParcelable.Param(id = 9) int i6, @SafeParcelable.Param(id = 10) boolean z5, @SafeParcelable.Param(id = 11) int i7) {
        this.zza = i2;
        this.zzb = z2;
        this.zzc = i3;
        this.zzd = z3;
    ...
    */
    public static com.google.android.gms.ads.nativead.NativeAdOptions zza(@androidx.annotation.Nullable com.google.android.gms.internal.ads.zzbfr r5) {
        /*
        ...
        L4a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbfr.zza(com.google.android.gms.internal.ads.zzbfr):com.google.android.gms.ads.nativead.NativeAdOptions");
    }
    ...
    @Deprecated
    public zzbfr(@NonNull NativeAdOptions nativeAdOptions) {
