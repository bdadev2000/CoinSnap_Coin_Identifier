...
public final class zzdvr implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences, @Nullable String str) {
        if (str != null && this.zzb.contains(str)) {
            try {
                ...
                com.google.android.gms.ads.internal.zzv.zzp().zzv(e2, "InspectorSharedPreferenceCollector.onSharedPreferenceChanged");
            }
        }
    }
