...
public class zzfym extends AbstractCollection {
    final Collection zza;
    final zzfwr zzb;

    public zzfym(Collection collection, zzfwr zzfwrVar) {
        this.zza = collection;
        this.zzb = zzfwrVar;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        while (it.hasNext()) {
            zzfwq.zze(this.zzb.zza(it.next()));
        }
