...
public final class zzbvv extends AbstractSafeParcelable {
    ...
    public zzbvv(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        ...
        if (this.zzc) {
            ...
            try {
                try {
                    ...
                    com.google.android.gms.ads.internal.util.client.zzm.zzh("Could not read from parcel file descriptor", e2);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th3) {
