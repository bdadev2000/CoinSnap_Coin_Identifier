...
public abstract class zzgxp implements Iterable<Byte>, Serializable {
    ...
    private static zzgxp zzc(Iterator it, int i10) {
        if (i10 > 0) {
            if (i10 == 1) {
                return (zzgxp) it.next();
            }
            int i11 = i10 >>> 1;
            zzgxp zzc = zzc(it, i11);
            zzgxp zzc2 = zzc(it, i10 - i11);
            if (Integer.MAX_VALUE - zzc.zzd() >= zzc2.zzd()) {
                return zzhba.zzC(zzc, zzc2);
            }
            throw new IllegalArgumentException(j.e("ByteString would be too long: ", zzc.zzd(), "+", zzc2.zzd()));
        }
    ...
    public static int zzq(int i10, int i11, int i12) {
        ...
        if ((i10 | i11 | i13 | (i12 - i11)) < 0) {
            if (i10 >= 0) {
                if (i11 < i10) {
                    throw new IndexOutOfBoundsException(j.e("Beginning index larger than ending index: ", i10, ", ", i11));
                }
                throw new IndexOutOfBoundsException(j.e("End index: ", i11, " >= ", i12));
            }
    ...
    public static zzgxp zzv(byte[] bArr, int i10, int i11) {
    ...
    public static void zzy(int i10, int i11) {
        if (((i11 - (i10 + 1)) | i10) < 0) {
            ...
            throw new ArrayIndexOutOfBoundsException(j.e("Index > length: ", i10, ", ", i11));
        }
    }
    ...
    public final String toString() {
        ...
        if (zzd() <= 50) {
            concat = zzhbl.zza(this);
        } else {
            concat = zzhbl.zza(zzk(0, 47)).concat("...");
        }
        objArr[2] = concat;
    ...
    public abstract zzgxp zzk(int i10, int i11);
