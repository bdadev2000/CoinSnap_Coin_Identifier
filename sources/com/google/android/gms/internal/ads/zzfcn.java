...
public final class zzfcn implements zzhfx {
    private final zzhgp zza;
    private final zzhgp zzb;
    private final zzhgp zzc;

    public zzfcn(zzhgp zzhgpVar, zzhgp zzhgpVar2, zzhgp zzhgpVar3) {
        this.zza = zzhgpVar;
        this.zzb = zzhgpVar2;
        this.zzc = zzhgpVar3;
    }
    ...
    public final zzfck zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcn.zzgj)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcn.zzgg)).booleanValue() || z10) {
                zzfhp zza = zzfhqVar.zza(zzfhg.Rewarded, context, zzfgyVar, new zzfbo(new zzfbl()));
