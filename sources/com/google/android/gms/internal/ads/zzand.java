...
final class zzand {
            ...
            if (i16 < zzd4 + 1) {
                ...
                while (true) {
                    ...
                    if (i19 < zzc) {
                        ...
                        byte[] bArr = null;
                        if (zzecVar.zzp()) {
                            int zzc3 = zzc(zzecVar, 2, 4, 8) + 1;
                            for (int i21 = 0; i21 < zzc3; i21++) {
                                int zzc4 = zzc(zzecVar, 4, 8, 16);
                                int zzc5 = zzc(zzecVar, 4, 8, 16);
                                if (zzc4 == 7) {
                                    int zzd9 = zzecVar.zzd(4) + 1;
                                    zzecVar.zzn(4);
                                    byte[] bArr2 = new byte[zzd9];
                                    for (int i22 = 0; i22 < zzd9; i22++) {
                                        bArr2[i22] = (byte) zzecVar.zzd(8);
                                    }
                                    bArr = bArr2;
                                } else {
                                    zzecVar.zzn(zzc5 * 8);
                        ...
                        switch (i10) {
                            ...
                            case 96000:
                                ...
                                break;
                            default:
                                throw zzbh.zzc("Unsupported sampling rate " + i10);
                        }
                        return new zzanb(i20, (int) (i10 * d10), (int) (i11 * d10), bArr3, null);
                    }
                }
            }
        }
    ...
    */
    public static boolean zzb(com.google.android.gms.internal.ads.zzec r17, com.google.android.gms.internal.ads.zzana r18) throws com.google.android.gms.internal.ads.zzbh {
        /*
            r0 = r17
            r1 = r18
            r17.zzb()
        ...
        L27:
            ...
            com.google.android.gms.internal.ads.zzgcm.zza(r14, r5)
            int r5 = r17.zza()
            r14 = -1
            if (r5 >= r2) goto L44
        L42:
        ...
        L89:
            ...
            com.google.android.gms.internal.ads.zzbh r0 = com.google.android.gms.internal.ads.zzbh.zza(r0, r5)
            throw r0
        L90:
    ...
    private static int zzc(zzec zzecVar, int i10, int i11, int i12) {
        boolean z10;
        ...
        int i13 = (1 << i10) - 1;
        int i14 = (1 << i11) - 1;
        zzgck.zza(zzgck.zza(i13, i14), 1 << i12);
        if (zzecVar.zza() < i10) {
            return -1;
        }
        int zzd = zzecVar.zzd(i10);
        if (zzd == i13) {
            if (zzecVar.zza() < i11) {
                return -1;
            }
            int zzd2 = zzecVar.zzd(i11);
            int i15 = zzd + zzd2;
            if (zzd2 == i14) {
                if (zzecVar.zza() < i12) {
                    return -1;
                }
                return i15 + zzecVar.zzd(i12);
            }
            return i15;
        }
        return zzd;
        ...
        if (zzd2 == 2) {
            ...
            while (i13 < zzc) {
                if (zzecVar.zzp()) {
                    ...
                    if (zzecVar.zzd(2) == 3 && zzecVar.zzd(i12) * i10 != 0) {
                        zzecVar.zzm();
                    }
                    zzd = zzecVar.zzd(i11) * i10;
                    if (zzd != 0 && zzd != 180) {
                        zzecVar.zzm();
                    }
                    zzecVar.zzm();
