...
public abstract class zzgeq extends AtomicReference implements Runnable {
    private static final Runnable zza;
    private static final Runnable zzb;

    static {
        zzgep zzgepVar = null;
        zza = new zzgeo(zzgepVar);
        zzb = new zzgeo(zzgepVar);
    }
    ...
    public final String toString() {
        ...
        if (runnable == zza) {
            ...
            str = e.f("running=[RUNNING ON ", ((Thread) runnable).getName(), "]");
        } else {
            str = "running=[NOT STARTED YET]";
        }
        return kotlin.reflect.jvm.internal.impl.serialization.deserialization.a.m(str, ", ", zzb());
    }
