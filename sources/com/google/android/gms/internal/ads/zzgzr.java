...
public final class zzgzr extends OutputStream {
    ...
    private final void zzc(int i2) {
        this.zzc.add(new zzgzq(this.zze));
    ...
    public final synchronized zzgzs zzb() {
        try {
            int i2 = this.zzf;
            byte[] bArr = this.zze;
            if (i2 >= bArr.length) {
                ...
                this.zzc.add(new zzgzq(Arrays.copyOf(bArr, i2)));
            }
            this.zzd += this.zzf;
            this.zzf = 0;
        } catch (Throwable th) {
