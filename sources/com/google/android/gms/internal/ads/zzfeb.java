...
public final class zzfeb implements zzhii {
    private final zzhja zza;
    private final zzhja zzb;
    private final zzhja zzc;

    public zzfeb(zzhja zzhjaVar, zzhja zzhjaVar2, zzhja zzhjaVar3) {
        this.zza = zzhjaVar;
        this.zzb = zzhjaVar2;
        this.zzc = zzhjaVar3;
    }
    ...
    public final zzfdy zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcv.zzge)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcv.zzgb)).booleanValue() || z2) {
                zzfjd zza = zzfjeVar.zza(zzfiu.Rewarded, context, zzfimVar, new zzfdc(new zzfcz()));
