...
public final class zzhfq {
    public static final zzhfq zza = new zzhfq(1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfq zzb = new zzhfq(0.0d, 1.0d, -1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfq zzc = new zzhfq(-1.0d, 0.0d, 0.0d, -1.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    public static final zzhfq zzd = new zzhfq(0.0d, -1.0d, 1.0d, 0.0d, 0.0d, 0.0d, 1.0d, 0.0d, 0.0d);
    ...
    public zzhfq(double d10, double d11, double d12, double d13, double d14, double d15, double d16, double d17, double d18) {
        this.zze = d14;
        this.zzf = d15;
        this.zzg = d16;
        this.zzh = d10;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || zzhfq.class != obj.getClass()) {
            return false;
        }
        zzhfq zzhfqVar = (zzhfq) obj;
        if (Double.compare(zzhfqVar.zzh, this.zzh) == 0 && Double.compare(zzhfqVar.zzi, this.zzi) == 0 && Double.compare(zzhfqVar.zzj, this.zzj) == 0 && Double.compare(zzhfqVar.zzk, this.zzk) == 0 && Double.compare(zzhfqVar.zzl, this.zzl) == 0 && Double.compare(zzhfqVar.zzm, this.zzm) == 0 && Double.compare(zzhfqVar.zze, this.zze) == 0 && Double.compare(zzhfqVar.zzf, this.zzf) == 0 && Double.compare(zzhfqVar.zzg, this.zzg) == 0) {
            return true;
        }
        return false;
    }
