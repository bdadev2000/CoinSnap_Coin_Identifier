...
public abstract class zzbmk extends WebViewClient {
    ...
    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z8) {
        ...
        delegate.doUpdateVisitedHistory(webView, str, z8);
    }
    ...
    public final void onReceivedError(WebView webView, int i9, String str, String str2) {
        ...
        delegate.onReceivedError(webView, i9, str, str2);
    }
    ...
    public final void onSafeBrowsingHit(WebView webView, WebResourceRequest webResourceRequest, int i9, SafeBrowsingResponse safeBrowsingResponse) {
        WebViewClient delegate = getDelegate();
        if (delegate != null) {
            delegate.onSafeBrowsingHit(webView, webResourceRequest, i9, safeBrowsingResponse);
        }
    }
    ...
    public final void onScaleChanged(WebView webView, float f9, float f10) {
        ...
        delegate.onScaleChanged(webView, f9, f10);
    }
