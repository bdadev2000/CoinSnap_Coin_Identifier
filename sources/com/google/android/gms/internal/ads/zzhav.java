...
interface zzhav {
    ...
    @Deprecated
    void zzC(List list, zzhbb zzhbbVar, zzgyh zzgyhVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhbb zzhbbVar, zzgyh zzgyhVar) throws IOException;
    ...
    zzgxp zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzhbb zzhbbVar, zzgyh zzgyhVar) throws IOException;

    void zzu(Object obj, zzhbb zzhbbVar, zzgyh zzgyhVar) throws IOException;
