...
public final class zzhbp extends zzgzl implements RandomAccess, zzhbw, zzhdn {
    ...
    public final /* bridge */ /* synthetic */ Object set(int i9, Object obj) {
        return Integer.valueOf(zze(i9, ((Integer) obj).intValue()));
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzhbw
    public final int zze(int i9, int i10) {
        zzdJ();
        zzk(i9);
        int[] iArr = this.zzb;
        int i11 = iArr[i9];
    ...
    public final zzhbw zzf(int i9) {
        if (i9 >= this.zzc) {
            return new zzhbp(Arrays.copyOf(this.zzb, i9), this.zzc, true);
        }
    ...
    private zzhbp(int[] iArr, int i9, boolean z8) {
        super(z8);
        this.zzb = iArr;
        this.zzc = i9;
    }
