...
final class zzbrt implements MediationBannerAdCallback, MediationInterstitialAdCallback, MediationRewardedAdCallback, MediationNativeAdCallback, MediationAppOpenAdCallback {
    final zzbpm zza;
    ...
    public final void onUserEarnedReward(RewardItem rewardItem) {
        try {
            this.zza.zzt(new zzbxt(rewardItem));
        } catch (RemoteException unused) {
        }
    }
