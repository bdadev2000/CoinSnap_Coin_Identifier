...
public final class zzwq {
    ...
    public final zzwq zzf() {
        return new zzwq(0, new Random(this.zza.nextLong()));
    }

    public final zzwq zzg(int i2, int i3) {
        int[] iArr = new int[i3];
        ...
        while (true) {
            ...
            if (i4 >= iArr4.length + i3) {
                return new zzwq(iArr3, new Random(this.zza.nextLong()));
            }
            if (i7 >= i3 || i8 != iArr[i7]) {
                int i9 = i8 + 1;
                int i10 = iArr4[i8];
    ...
    public final zzwq zzh(int i2, int i3) {
        ...
        while (true) {
            int[] iArr2 = this.zzb;
            if (i4 >= iArr2.length) {
                return new zzwq(iArr, new Random(this.zza.nextLong()));
            }
            int i6 = iArr2[i4];
            if (i6 < 0 || i6 >= i3) {
                int i7 = i4 - i5;
    ...
    private zzwq(int i2, Random random) {
        this(new int[0], random);
    }

    private zzwq(int[] iArr, Random random) {
        this.zzb = iArr;
        this.zza = random;
