...
public final class zzaye {
    ...
    private static final ClassLoader zzb = zzaye.class.getClassLoader();
    ...
    public static void zzc(Parcel parcel) {
        ...
        if (dataAvail <= 0) {
            ...
            throw new BadParcelableException(j.i("Parcel data not fully consumed, unread size: ", dataAvail));
        }
    }
