...
public final class zzbqo implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, int i2) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        com.google.android.gms.ads.internal.util.client.zzm.zze("Adapter called onAdFailedToLoad with error. " + i2);
        try {
            this.zza.zzg(i2);
        } catch (RemoteException e) {
            com.google.android.gms.ads.internal.util.client.zzm.zzl("#007 Could not call remote method.", e);
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbgx zzbgxVar) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        com.google.android.gms.ads.internal.util.client.zzm.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbgxVar.zzb())));
        this.zzc = zzbgxVar;
        try {
            this.zza.zzo();
        } catch (RemoteException e) {
