...
public final class zzbqj implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, int i10) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        com.google.android.gms.ads.internal.util.client.zzm.zze("Adapter called onAdFailedToLoad with error. " + i10);
        try {
            this.zza.zzg(i10);
        } catch (RemoteException e2) {
            com.google.android.gms.ads.internal.util.client.zzm.zzl("#007 Could not call remote method.", e2);
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbgt zzbgtVar) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        com.google.android.gms.ads.internal.util.client.zzm.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbgtVar.zzb())));
        this.zzc = zzbgtVar;
        try {
            this.zza.zzo();
        } catch (RemoteException e2) {
