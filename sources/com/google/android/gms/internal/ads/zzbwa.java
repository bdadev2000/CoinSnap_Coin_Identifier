    ...
    */
    ...
    private static ResolveInfo zzb(PackageManager packageManager, String str) {
        try {
            ...
            com.google.android.gms.ads.internal.zzv.zzp().zzw(th2, "DeviceInfo.getResolveInfo");
            return null;
        }
    }
    ...
    private final void zzc(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                com.google.android.gms.ads.internal.zzv.zzp().zzw(th2, "DeviceInfo.gatherAudioInfo");
            }
        }
        this.zza = -2;
        this.zzb = false;
