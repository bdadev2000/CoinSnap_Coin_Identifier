...
public final class zzfpk {
    private static final zzfpk zza = new zzfpk();

    private zzfpk() {
    }

    public static final zzfpk zza() {
        return zza;
    }
    ...
    public static final boolean zzj(WebView webView, String str) {
        ...
        try {
            ...
            AdMobNetworkBridge.webviewLoadUrl(webView, "javascript: ".concat(String.valueOf(str)));
            return true;
        }
    }
    ...
    public final void zzb(WebView webView, String str, Object... objArr) {
        ...
        if (handler == null || Looper.myLooper() == handler.getLooper()) {
            ...
            handler.post(new zzfpj(this, webView, sb2));
        }
    }
    ...
    public final void zze(WebView webView, String str, float f2) {
        zzb(webView, "setDeviceVolume", Float.valueOf(f2), str);
    }
