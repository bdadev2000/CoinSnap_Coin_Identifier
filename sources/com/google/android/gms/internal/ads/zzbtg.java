...
public interface zzbtg extends IInterface {
    boolean zzH() throws RemoteException;

    void zzh(int i10, int i11, Intent intent) throws RemoteException;
    ...
    void zzp(int i10, String[] strArr, int[] iArr) throws RemoteException;
