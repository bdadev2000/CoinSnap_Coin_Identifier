...
interface zzhdr {
    ...
    @Deprecated
    void zzE(List list, zzhdz zzhdzVar, zzhay zzhayVar) throws IOException;

    void zzF(List list) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(List list, zzhdz zzhdzVar, zzhay zzhayVar) throws IOException;
    ...
    zzhac zzp() throws IOException;

    @Deprecated
    Object zzr(Class cls, zzhay zzhayVar) throws IOException;

    Object zzs(Class cls, zzhay zzhayVar) throws IOException;

    String zzt() throws IOException;

    String zzu() throws IOException;

    void zzv(Object obj, zzhdz zzhdzVar, zzhay zzhayVar) throws IOException;

    void zzw(Object obj, zzhdz zzhdzVar, zzhay zzhayVar) throws IOException;
