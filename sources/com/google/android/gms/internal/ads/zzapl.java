...
public final class zzapl {
    ...
    private zzapl(int i10, byte[] bArr, @Nullable Map map, @Nullable List list, boolean z10, long j3) {
        this.zza = i10;
        this.zzb = bArr;
        this.zzc = map;
    ...
    @Deprecated
    public zzapl(int i10, byte[] bArr, @Nullable Map map, boolean z10, long j3) {
        this(i10, bArr, map, zza(map), z10, j3);
    }
    ...
    */
    public zzapl(int r9, byte[] r10, boolean r11, long r12, @androidx.annotation.Nullable java.util.List r14) {
        /*
            r8 = this;
            if (r14 != 0) goto L5
            r0 = 0
    ...
    @Deprecated
    public zzapl(byte[] bArr, @Nullable Map map) {
