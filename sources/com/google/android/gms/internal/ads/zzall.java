...
public final class zzall implements zzakv {
    ...
    private static float zzb(int i2) {
        if (i2 == 0) {
            return 0.05f;
        }
        if (i2 != 1) {
    ...
    private static int zzc(long j2, List list, List list2) {
        int i2;
        int size = list.size();
        while (true) {
            size--;
    ...
    */
    ...
    public zzall(@Nullable List list) {
        ...
        this.zzb = true;
        String zzA = zzeu.zzA((byte[]) list.get(0));
        zzdi.zzd(zzA.startsWith("Format:"));
        zzalk zza2 = zzalk.zza(zzA);
        zza2.getClass();
        this.zzc = zza2;
