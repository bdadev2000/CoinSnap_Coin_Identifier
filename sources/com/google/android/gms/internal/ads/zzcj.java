...
public class zzcj extends Exception {
    ...
    @Deprecated
    public static final zzn zza = new zzn() { // from class: com.google.android.gms.internal.ads.zzci
    };

    public zzcj(@Nullable String str, @Nullable Throwable th, int i9, long j7) {
        super(str, th);
        this.zzb = i9;
        this.zzc = j7;
    }
