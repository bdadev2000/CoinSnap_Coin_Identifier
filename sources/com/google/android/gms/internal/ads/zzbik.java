    ...
    public final /* bridge */ /* synthetic */ void zza(Object obj, Map map) {
        ...
        if ("tick".equals(str)) {
            ...
            try {
                ...
                zzcfkVar.zzm().zzc(str2, str3, parseLong);
                return;
            } catch (NumberFormatException e2) {
                com.google.android.gms.ads.internal.util.client.zzm.zzk("Malformed timestamp for CSI tick.", e2);
                return;
            }
        }
        ...
        if ("extra".equals(str)) {
            ...
            if (TextUtils.isEmpty(str7)) {
                ...
                zzcfkVar.zzm().zza().zzd(str6, str7);
            }
        }
    }
}
