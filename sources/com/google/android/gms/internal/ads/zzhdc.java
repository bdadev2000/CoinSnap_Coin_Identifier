...
interface zzhdc {
    ...
    @Deprecated
    void zzC(List list, zzhdk zzhdkVar, zzhao zzhaoVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhdk zzhdkVar, zzhao zzhaoVar) throws IOException;
    ...
    void zzt(Object obj, zzhdk zzhdkVar, zzhao zzhaoVar) throws IOException;

    void zzu(Object obj, zzhdk zzhdkVar, zzhao zzhaoVar) throws IOException;
