...
final class zzgyo extends zzgxb implements RandomAccess, zzgze, zzhar {
    ...
    public final /* synthetic */ void add(int i10, Object obj) {
        ...
        if (i10 >= 0 && i10 <= (i11 = this.zzc)) {
            ...
            if (i11 < fArr.length) {
                ...
                float[] fArr2 = new float[j.z(i11, 3, 2, 1)];
    ...
    public final zzgze zzf(int i10) {
        if (i10 >= this.zzc) {
            return new zzgyo(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    public final void zzh(float f10) {
        ...
        float[] fArr = this.zzb;
        if (i10 == fArr.length) {
            float[] fArr2 = new float[j.z(i10, 3, 2, 1)];
            System.arraycopy(fArr, 0, fArr2, 0, i10);
            this.zzb = fArr2;
        }
    ...
    private zzgyo(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
