        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    String k2 = androidx.compose.foundation.text.input.a.k(obj.getClass().getName(), "@", Integer.toHexString(System.identityHashCode(obj)));
                    ...
                    m2 = androidx.compose.foundation.text.input.a.m("<", k2, " threw ", e.getClass().getName(), ">");
                }
            }
            objArr[i3] = m2;
            i3++;
