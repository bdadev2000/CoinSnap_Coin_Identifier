...
public final class zzhat extends zzgxb implements RandomAccess {
    ...
    public final void add(int i10, Object obj) {
        ...
        if (i10 >= 0 && i10 <= (i11 = this.zzc)) {
            ...
            if (i11 < objArr.length) {
                ...
                Object[] objArr2 = new Object[zzg(i11)];
    ...
    public final /* bridge */ /* synthetic */ zzgzj zzf(int i10) {
        if (i10 >= this.zzc) {
            return new zzhat(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzhat(Object[] objArr, int i10, boolean z10) {
        super(z10);
        this.zzb = objArr;
        this.zzc = i10;
    }
    ...
    public final boolean add(Object obj) {
        ...
        if (i10 == objArr.length) {
            this.zzb = Arrays.copyOf(objArr, zzg(i10));
        }
