...
public final class zzbtx {
    ...
    public zzbtx(Context context, AdFormat adFormat, @Nullable com.google.android.gms.ads.internal.client.zzei zzeiVar, @Nullable String str) {
        this.zzb = context;
        this.zzc = adFormat;
        this.zzd = zzeiVar;
        this.zze = str;
    ...
    public static zzbzh zza(Context context) {
        ...
        synchronized (zzbtx.class) {
            if (zza == null) {
                zza = com.google.android.gms.ads.internal.client.zzbc.zza().zzt(context, new zzbpc());
            }
            zzbzhVar = zza;
        }
        return zzbzhVar;
    ...
    public final void zzb(QueryInfoGenerationCallback queryInfoGenerationCallback) {
        ...
        try {
            zza3.zzf(wrap, new zzbzl(this.zze, this.zzc.name(), null, zza2), new zzbtw(this, queryInfoGenerationCallback));
