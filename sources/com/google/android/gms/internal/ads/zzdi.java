...
public final class zzdi implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdi(Handler handler, @Nullable zzdh zzdhVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i10) throws zzdj {
        boolean z10;
        boolean z11;
        int[] iArr;
        boolean z12;
        ...
        zzdk.zza(z10, "eglGetDisplay failed");
        int[] iArr3 = new int[2];
        zzdk.zza(EGL14.eglInitialize(eglGetDisplay, iArr3, 0, iArr3, 1), "eglInitialize failed");
        ...
        zzdk.zza(z11, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]));
        ...
        zzdk.zza(z12, "eglCreateContext failed");
        ...
        if (i10 == 1) {
            ...
            zzdk.zza(z13, "eglCreatePbufferSurface failed");
        }
        zzdk.zza(EGL14.eglMakeCurrent(eGLDisplay2, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
