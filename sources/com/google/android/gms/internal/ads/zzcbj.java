...
public final class zzcbj extends zzcbl implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public zzcbj(Context context, zzccf zzccfVar, boolean z10, boolean z11, zzcce zzcceVar, zzccg zzccgVar) {
        super(context);
        this.zzg = 0;
        this.zzh = 0;
        this.zzr = false;
    ...
    private final void zzD() {
        ...
        if (this.zzj != null && surfaceTexture != null) {
            ...
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzm.zzk("Failed to initialize MediaPlayer at ".concat(String.valueOf(this.zzj)), e2);
    ...
    public static /* bridge */ /* synthetic */ void zzl(zzcbj zzcbjVar, MediaPlayer mediaPlayer) {
        MediaFormat format;
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcn.zzbW)).booleanValue() && zzcbjVar.zzd != null && mediaPlayer != null) {
            try {
                ...
                if (trackInfo != null) {
                    ...
                    if (!hashMap.isEmpty()) {
                        zzcbjVar.zzd.zzd("onMetadataEvent", hashMap);
                    }
                }
            } catch (RuntimeException e2) {
                com.google.android.gms.ads.internal.zzv.zzp().zzw(e2, "AdMediaPlayerView.reportMetadata");
            }
        }
    }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i10, int i11) {
        ...
        zzF(-1);
        this.zzh = -1;
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzcbd(this, str, str2));
        return true;
    }
    ...
    */
    public final void onMeasure(int r6, int r7) {
        /*
            ...
            int r2 = r5.zzl
            if (r2 <= 0) goto L7a
            com.google.android.gms.internal.ads.zzccd r2 = r5.zzn
            if (r2 != 0) goto L7a
        ...
        L7a:
            ...
            com.google.android.gms.internal.ads.zzccd r6 = r5.zzn
            if (r6 == 0) goto L84
            r6.zzc(r0, r1)
        L84:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcbj.onMeasure(int, int):void");
    }
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        zzF(2);
        this.zze.zzb();
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzcbb(this, mediaPlayer));
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzcbf(this, i10, i11));
    }
    ...
    public final String toString() {
        return kotlin.reflect.jvm.internal.impl.serialization.deserialization.a.m(zzcbj.class.getName(), "@", Integer.toHexString(hashCode()));
    }
