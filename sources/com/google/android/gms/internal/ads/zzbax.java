...
public final class zzbax extends AbstractSafeParcelable {
    ...
    public zzbax(@Nullable @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) long j3, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 5) String str3, @SafeParcelable.Param(id = 6) String str4, @SafeParcelable.Param(id = 7) Bundle bundle, @SafeParcelable.Param(id = 8) boolean z10, @SafeParcelable.Param(id = 9) long j10, @SafeParcelable.Param(id = 10) String str5, @SafeParcelable.Param(id = 11) int i10) {
        this.zza = str;
        this.zzb = j3;
    ...
    public static zzbax zza(Uri uri) {
        ...
        try {
            ...
            return new zzbax(queryParameter, j3, host, str, str2, bundle, equals, 0L, "", 0);
        } catch (NullPointerException | NumberFormatException e2) {
            com.google.android.gms.ads.internal.util.client.zzm.zzk("Unable to parse Uri into cache offering.", e2);
            return null;
        }
    }
