...
public final class zzbuy extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(id = Encoder.DEFAULT_EC_PERCENT)
    ...
    @SafeParcelable.Field(id = Opcodes.V15)
    public final boolean zzaa;

    @SafeParcelable.Field(id = Opcodes.V16)
    public final ArrayList zzab;

    @SafeParcelable.Field(id = Opcodes.V17)
    ...
    @SafeParcelable.Field(id = TypeReference.RESOURCE_VARIABLE)
