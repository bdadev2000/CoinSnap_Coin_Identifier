    ...
    private static void zzd(zzfw zzfwVar, StringBuilder sb, int i) {
        ...
        for (Method method : zzfwVar.getClass().getDeclaredMethods()) {
            ...
            if (method.getParameterTypes().length == 0) {
                ...
                if (method.getName().startsWith(LogEvents.exportemptyalert_close_click_type_get)) {
                    treeSet.add(method.getName());
                }
            }
        }
        for (String str : treeSet) {
            String substring = str.startsWith(LogEvents.exportemptyalert_close_click_type_get) ? str.substring(3) : str;
            ...
            if (((Method) hashMap2.get("set".concat(String.valueOf(substring)))) != null && (!substring.endsWith("Bytes") || !hashMap.containsKey(LogEvents.exportemptyalert_close_click_type_get.concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                String concat3 = String.valueOf(substring.substring(0, 1).toLowerCase()).concat(String.valueOf(substring.substring(1)));
                Method method4 = (Method) hashMap.get(LogEvents.exportemptyalert_close_click_type_get.concat(String.valueOf(substring)));
