...
public class GoogleApiManager implements Handler.Callback {
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, a.l("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        switch (i2) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", d.j("Could not find API instance ", i3, " while trying to fail enqueued calls."), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabq.zai(zabqVar, new Status(17, a.l("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
