...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new b());
    private int zzc = 0;
    ...
    public final void addCallback(String str, @NonNull LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(e.f("LifecycleCallback with tag ", str, " already added to this fragment."));
    }
