...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new SimpleArrayMap());
    private int zzc = 0;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                ...
                d.f(0, zzdVar2, "SupportLifecycleFragmentImpl", 1);
                d.d();
            }
    ...
    public final void addCallback(String str, @NonNull LifecycleCallback lifecycleCallback) {
        if (this.zzb.containsKey(str)) {
            throw new IllegalArgumentException(a.A("LifecycleCallback with tag ", str, " already added to this fragment."));
        }
