...
public final class zaaw implements zabf {
    ...
    public final boolean zaG(int i10) {
        if (this.zag != i10) {
            ...
            j.v("mRemainingConnections=", this.zah, "GACConnecting");
            StringBuilder o10 = a4.j.o("GoogleApiClient connecting is in step ", zaJ(this.zag), " but received callback for step ");
            o10.append(zaJ(i10));
