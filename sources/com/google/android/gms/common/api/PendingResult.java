...
public abstract class PendingResult<R extends Result> {
    ...
    @NonNull
    @ResultIgnorabilityUnspecified
    public abstract R await(long j3, @NonNull TimeUnit timeUnit);
    ...
    public abstract void setResultCallback(@NonNull ResultCallback<? super R> resultCallback, long j3, @NonNull TimeUnit timeUnit);
