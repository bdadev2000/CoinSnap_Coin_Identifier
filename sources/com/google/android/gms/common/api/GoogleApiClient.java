...
public abstract class GoogleApiClient {
    ...
    @NonNull
    @ResultIgnorabilityUnspecified
    public abstract ConnectionResult blockingConnect(long j3, @NonNull TimeUnit timeUnit);
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(@NonNull T t5) {
        throw new UnsupportedOperationException();
    }
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(@NonNull T t5) {
        throw new UnsupportedOperationException();
    }
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        throw new IllegalStateException(a.m(api2.zad(), " cannot be used with ", api.zad()));
                    }
                }
            }
            if (api != null) {
                if (!z12) {
                    ...
                    throw new IllegalStateException(e.f("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, bVar, this.zaq, this.zar, bVar2, this.zal, zabe.zad(bVar2.values(), true), arrayList);
