...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            this.zah = new SimpleArrayMap();
            this.zaj = new SimpleArrayMap();
            this.zal = -1;
        ...
        /* JADX WARN: Type inference failed for: r11v0, types: [java.util.Map, androidx.collection.SimpleArrayMap] */
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                boolean z3 = zad.get(api2) != null;
                simpleArrayMap.put(api2, Boolean.valueOf(z3));
                ...
                if (buildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(a.k(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z2) {
                    throw new IllegalStateException(a.A("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, simpleArrayMap, this.zaq, this.zar, simpleArrayMap2, this.zal, zabe.zad(simpleArrayMap2.values(), true), arrayList);
