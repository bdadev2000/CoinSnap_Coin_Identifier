...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    @KeepForSdk
    public GoogleApi(@NonNull Activity activity, @NonNull Api<O> api, @NonNull O o3, @NonNull Settings settings) {
        this(activity, activity, api, o3, settings);
    }

    private final BaseImplementation.ApiMethodImpl zad(int i9, @NonNull BaseImplementation.ApiMethodImpl apiMethodImpl) {
        apiMethodImpl.zak();
        this.zaa.zau(this, i9, apiMethodImpl);
        return apiMethodImpl;
    }

    private final Task zae(int i9, @NonNull TaskApiCall taskApiCall) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.zaa.zav(this, i9, taskApiCall, taskCompletionSource, this.zaj);
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doBestEffortWrite(@NonNull T t9) {
        zad(2, t9);
        return t9;
    }
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doRead(@NonNull T t9) {
        zad(0, t9);
        return t9;
    }
    ...
    @Deprecated
    @KeepForSdk
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t9, @NonNull U u8) {
        Preconditions.checkNotNull(t9);
        Preconditions.checkNotNull(u8);
        Preconditions.checkNotNull(t9.getListenerKey(), "Listener has already been released.");
        Preconditions.checkNotNull(u8.getListenerKey(), "Listener has already been released.");
        Preconditions.checkArgument(Objects.equal(t9.getListenerKey(), u8.getListenerKey()), "Listener registration and unregistration methods must be constructed with the same ListenerHolder.");
        return this.zaa.zao(this, t9, u8, new Runnable() { // from class: com.google.android.gms.common.api.zad
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doWrite(@NonNull T t9) {
        zad(1, t9);
        return t9;
    }
    ...
    */
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public Task<Boolean> doUnregisterEventListener(@NonNull ListenerHolder.ListenerKey<?> listenerKey, int i9) {
        Preconditions.checkNotNull(listenerKey, "Listener key cannot be null.");
        return this.zaa.zap(this, listenerKey, i9);
    }
