...
public final class Preconditions {
    ...
    public static void checkHandlerThread(@NonNull Handler handler) {
        ...
        if (myLooper != handler.getLooper()) {
            throw new IllegalStateException(a.m("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", myLooper != null ? myLooper.getThread().getName() : "null current looper", "."));
        }
    }
