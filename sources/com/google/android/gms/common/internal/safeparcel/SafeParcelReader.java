...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i2) {
        if (parcel.dataPosition() != i2) {
            throw new ParseException(d.i("Overread allowed size end=", i2), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (i2 < dataPosition || i2 > parcel.dataSize()) {
            throw new ParseException(d.k("Size read is invalid start=", dataPosition, " end=", i2), parcel);
        }
        return i2;
    }
    ...
    private static void zza(Parcel parcel, int i2, int i3, int i4) {
        ...
        throw new ParseException(d.r(d.u("Expected size ", i4, " got ", i3, " (0x"), Integer.toHexString(i3), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i2, int i3) {
        ...
        throw new ParseException(d.r(d.u("Expected size ", i3, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
