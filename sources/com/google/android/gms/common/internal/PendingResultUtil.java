...
public class PendingResultUtil {
    ...
    @NonNull
    @KeepForSdk
    public static <R extends Result, T extends Response<R>> Task<T> toResponseTask(@NonNull PendingResult<R> pendingResult, @NonNull T t5) {
        return toTask(pendingResult, new zaq(t5));
    }
