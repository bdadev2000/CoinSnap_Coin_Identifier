...
public final class zaaa extends Button {
    ...
    private static final int zab(int i2, int i3, int i4, int i5) {
        ...
        throw new IllegalStateException(d.i("Unknown color scheme: ", i2));
    }
    ...
    public final void zaa(Resources resources, int i2, int i3) {
        ...
        if (i2 == 0 || i2 == 1) {
            ...
            throw new IllegalStateException(d.i("Unknown button size: ", i2));
        }
        Drawable drawable = resources.getDrawable(zab);
        DrawableCompat.j(drawable, resources.getColorStateList(com.google.android.gms.base.R.color.common_google_signin_btn_tint));
        DrawableCompat.k(drawable, PorterDuff.Mode.SRC_ATOP);
