...
public class AppMeasurement {
    ...
    @ShowFirstParty
    @KeepForSdk
    public void logEventInternalNoInterceptor(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, long j3) {
    ...
    public static class ConditionalUserProperty {
        ...
        public ConditionalUserProperty(@NonNull Bundle bundle) {
            ...
            this.mAppId = (String) zzjf.zza(bundle, MBridgeConstans.APP_ID, String.class, null);
