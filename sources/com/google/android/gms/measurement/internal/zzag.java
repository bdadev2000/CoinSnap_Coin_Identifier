...
public final class zzag extends zzja {
    ...
    private final String zza(String str, String str2) {
        try {
            String str3 = (String) Class.forName("android.os.SystemProperties").getMethod(LogEvents.exportemptyalert_close_click_type_get, String.class, String.class).invoke(null, str, str2);
