...
public final class zznu extends zzns {
    ...
    public final String zza(zzg zzgVar) {
        ...
        builder.scheme(zzbh.zze.zza(null)).encodedAuthority(zzbh.zzf.zza(null)).path("config/app/" + zzah).appendQueryParameter(AppLovinBridge.e, "android").appendQueryParameter("gmp_version", "106000").appendQueryParameter("runtime_version", AppEventsConstants.EVENT_PARAM_VALUE_NO);
