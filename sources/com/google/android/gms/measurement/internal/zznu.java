...
public final class zznu extends zzns {
    ...
    public final String zza(zzg zzgVar) {
        ...
        builder.scheme(zzbh.zze.zza(null)).encodedAuthority(zzbh.zzf.zza(null)).path("config/app/" + zzah).appendQueryParameter("platform", "android").appendQueryParameter("gmp_version", "106000").appendQueryParameter("runtime_version", LikeItem.DISLIKE);
    ...
    private final String zzb(String str) {
        ...
        if (!TextUtils.isEmpty(zzf)) {
            ...
            buildUpon.authority(zzf + InstructionFileId.DOT + parse.getAuthority());
