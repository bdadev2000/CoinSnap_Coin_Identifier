...
public final class zzhl extends zznr implements zzai {
    ...
    public final zzjh zza(String str, zzje.zza zzaVar) {
        ...
        for (zzfr.zza.C0140zza c0140zza : zzb.zzf()) {
            if (zza(c0140zza.zzc()) == zzaVar) {
                int i = zzht.zzc[c0140zza.zzb().ordinal()];
                if (i == 1) {
                    return zzjh.DENIED;
                }
                if (i == 2) {
    ...
    public final boolean zzc(String str, zzje.zza zzaVar) {
        ...
        Iterator<zzfr.zza.C0140zza> it = zzb.zzd().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            zzfr.zza.C0140zza next = it.next();
