    ...
    public final byte[] zza(@NonNull zzbf zzbfVar, String str) {
        ...
        try {
            ...
            for (int i10 = 0; i10 < zzl.size(); i10++) {
                zzfy.zzo.zza zzb3 = zzfy.zzo.zze().zza(zzl.get(i10).zzc).zzb(zzl.get(i10).zzd);
                g_().zza(zzb3, zzl.get(i10).zze);
                zzoVarArr[i10] = (zzfy.zzo) ((com.google.android.gms.internal.measurement.zzjt) zzb3.zzai());
            }
