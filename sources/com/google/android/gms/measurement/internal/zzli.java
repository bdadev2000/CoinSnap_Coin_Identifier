...
public final class zzli extends zznr {
    ...
    @WorkerThread
    public final byte[] zza(@NonNull zzbf zzbfVar, @Size String str) {
        zzop zzopVar;
        Bundle bundle;
        zzfy.zzk.zza zzaVar;
        ...
        try {
            ...
            for (int i2 = 0; i2 < zzl.size(); i2++) {
                zzfy.zzo.zza zzb3 = zzfy.zzo.zze().zza(zzl.get(i2).zzc).zzb(zzl.get(i2).zzd);
                g_().zza(zzb3, zzl.get(i2).zze);
                zzoVarArr[i2] = (zzfy.zzo) ((com.google.android.gms.internal.measurement.zzjt) zzb3.zzai());
            }
