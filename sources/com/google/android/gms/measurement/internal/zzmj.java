        ...
        if (this.zza) {
            ...
            try {
                if (TextUtils.isEmpty(this.zze)) {
                    Preconditions.checkNotNull(this.zzb);
                    if (zza) {
                        j4 = this.zzf.zzu.zzb().currentTimeMillis();
                        try {
                            ...
                            if (zza) {
                                zzgm.zza(this.zzf.zzu).zza(36301, 13, j3, this.zzf.zzu.zzb().currentTimeMillis(), (int) (this.zzf.zzu.zzb().elapsedRealtime() - j2));
                            }
                            this.zzf.zzar();
                        }
                    } else {
                    ...
                    try {
                        ...
                        if (zza) {
                            ...
                            zzgm.zza(this.zzf.zzu).zza(36301, 0, j4, this.zzf.zzu.zzb().currentTimeMillis(), (int) (this.zzf.zzu.zzb().elapsedRealtime() - j2));
                        }
