...
public final class DynamicHeightSearchAdRequest {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAdTest(boolean z10) {
            String str;
            if (true != z10) {
        ...
        public Builder setAdjustableLineHeight(int i10) {
            this.zzb.putString("csa_adjustableLineHeight", Integer.toString(i10));
            return this;
        }
        ...
        public Builder setAttributionSpacingBelow(int i10) {
            this.zzb.putString("csa_attributionSpacingBelow", Integer.toString(i10));
            return this;
        }
        ...
        public Builder setCssWidth(int i10) {
            this.zzb.putString("csa_width", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setDetailedAttribution(boolean z10) {
            this.zzb.putString("csa_detailedAttribution", Boolean.toString(z10));
            return this;
        }
        ...
        public Builder setFontSizeAnnotation(int i10) {
            this.zzb.putString("csa_fontSizeAnnotation", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setFontSizeAttribution(int i10) {
            this.zzb.putString("csa_fontSizeAttribution", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setFontSizeDescription(int i10) {
            this.zzb.putString("csa_fontSizeDescription", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setFontSizeDomainLink(int i10) {
            this.zzb.putString("csa_fontSizeDomainLink", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setFontSizeTitle(int i10) {
            this.zzb.putString("csa_fontSizeTitle", Integer.toString(i10));
            return this;
        }
        ...
        @NonNull
        public Builder setIsClickToCallEnabled(boolean z10) {
            this.zzb.putString("csa_clickToCall", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsLocationEnabled(boolean z10) {
            this.zzb.putString("csa_location", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsPlusOnesEnabled(boolean z10) {
            this.zzb.putString("csa_plusOnes", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsSellerRatingsEnabled(boolean z10) {
            this.zzb.putString("csa_sellerRatings", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsSiteLinksEnabled(boolean z10) {
            this.zzb.putString("csa_siteLinks", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsTitleBold(boolean z10) {
            this.zzb.putString("csa_titleBold", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setIsTitleUnderlined(boolean z10) {
            this.zzb.putString("csa_noTitleUnderline", Boolean.toString(!z10));
            return this;
        }
        ...
        public Builder setLocationFontSize(int i10) {
            this.zzb.putString("csa_fontSizeLocation", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setLongerHeadlines(boolean z10) {
            this.zzb.putString("csa_longerHeadlines", Boolean.toString(z10));
            return this;
        }

        @NonNull
        public Builder setNumber(int i10) {
            this.zzb.putString("csa_number", Integer.toString(i10));
            return this;
        }

        @NonNull
        public Builder setPage(int i10) {
            this.zzb.putString("csa_adPage", Integer.toString(i10));
            return this;
        }
        ...
        public Builder setVerticalSpacing(int i10) {
            this.zzb.putString("csa_verticalSpacing", Integer.toString(i10));
            return this;
        }
    }
