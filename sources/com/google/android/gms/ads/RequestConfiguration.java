...
public class RequestConfiguration {
    ...
    public static class Builder {
        ...
        public Builder setTagForChildDirectedTreatment(int i9) {
            if (i9 != -1 && i9 != 0 && i9 != 1) {
                zzm.zzj("Invalid value passed to setTagForChildDirectedTreatment: " + i9);
            } else {
                this.zza = i9;
            }
            return this;
        ...
        public Builder setTagForUnderAgeOfConsent(int i9) {
            if (i9 != -1 && i9 != 0 && i9 != 1) {
                zzm.zzj("Invalid value passed to setTagForUnderAgeOfConsent: " + i9);
            } else {
                this.zzb = i9;
            }
            return this;
    ...
    public /* synthetic */ RequestConfiguration(int i9, int i10, String str, List list, PublisherPrivacyPersonalizationState publisherPrivacyPersonalizationState, zzh zzhVar) {
        this.zzb = i9;
        this.zzc = i10;
        this.zzd = str;
        this.zze = list;
