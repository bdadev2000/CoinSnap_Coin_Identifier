...
public final class zzbw extends zzayc implements zzby {
    ...
    public final zzs zzg() throws RemoteException {
        ...
        zzs zzsVar = (zzs) zzaye.zza(zzdb, zzs.CREATOR);
        zzdb.recycle();
        return zzsVar;
    }
    ...
    public final zzdy zzk() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof zzdy) {
                zzdwVar = (zzdy) queryLocalInterface;
            } else {
                zzdwVar = new zzdw(readStrongBinder);
            }
        }
        zzdb.recycle();
        return zzdwVar;
    ...
    public final zzeb zzl() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof zzeb) {
                ...
                zzdzVar = new zzdz(readStrongBinder);
            }
        }
        zzdb.recycle();
        return zzdzVar;
