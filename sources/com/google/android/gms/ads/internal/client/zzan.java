...
public final class zzan extends zzbb {
    ...
    public zzan(zzba zzbaVar, Context context, zzs zzsVar, String str, zzbpg zzbpgVar) {
        this.zza = context;
        this.zzb = zzsVar;
        this.zzc = str;
        this.zzd = zzbpgVar;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzcp zzcpVar) throws RemoteException {
        return zzcpVar.zzc(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 243799000);
    }
