    ...
    */
    public VersionInfoParcel(int r8, int r9, boolean r10, boolean r11, boolean r12) {
        ...
        Lc:
            ...
            java.lang.String r1 = "."
            java.lang.StringBuilder r0 = android.support.v4.media.d.u(r0, r8, r1, r9, r1)
            r0.append(r11)
    ...
    public VersionInfoParcel(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) int i2, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) boolean z2, @SafeParcelable.Param(id = 6) boolean z3) {
