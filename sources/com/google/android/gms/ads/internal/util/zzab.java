...
public class zzab {
    ...
    public WebResourceResponse zzb(String str, String str2, int i2, String str3, Map map, InputStream inputStream) {
        throw null;
    }

    public zzcfw zzc(zzcfo zzcfoVar, zzbbu zzbbuVar, boolean z2, @Nullable zzefj zzefjVar) {
        throw null;
    }
    ...
    public zzbcb.zzq zzg(Context context, TelephonyManager telephonyManager) {
        return zzbcb.zzq.ENUM_UNKNOWN;
    }
