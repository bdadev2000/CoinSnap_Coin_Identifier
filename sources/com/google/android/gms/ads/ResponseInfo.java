...
public final class ResponseInfo {
    ...
    private ResponseInfo(@Nullable zzdy zzdyVar) {
        ...
        if (zzdyVar != null) {
            try {
                ...
                zzm.zzh("Could not forward getAdapterResponseInfo to ResponseInfo.", e2);
            }
        }
        ...
        if (zzdyVar2 != null) {
            try {
                ...
                zzm.zzh("Could not forward getLoadedAdapterResponse to ResponseInfo.", e10);
            }
        }
    }
    ...
    public String getMediationAdapterClassName() {
        try {
            ...
            zzm.zzh("Could not forward getMediationAdapterClassName to ResponseInfo.", e2);
            return null;
        }
    }
    ...
    public Bundle getResponseExtras() {
        try {
            ...
            zzm.zzh("Could not forward getResponseExtras to ResponseInfo.", e2);
        }
        return new Bundle();
    }
    ...
    public String getResponseId() {
        try {
            ...
            zzm.zzh("Could not forward getResponseId to ResponseInfo.", e2);
            return null;
        }
    }
