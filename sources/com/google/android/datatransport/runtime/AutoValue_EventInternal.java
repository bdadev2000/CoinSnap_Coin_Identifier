...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal build() {
            ...
            if (this.encodedPayload == null) {
                str = androidx.compose.foundation.text.input.a.j(str, " encodedPayload");
            }
            if (this.eventMillis == null) {
                str = androidx.compose.foundation.text.input.a.j(str, " eventMillis");
            }
            if (this.uptimeMillis == null) {
                str = androidx.compose.foundation.text.input.a.j(str, " uptimeMillis");
            }
            if (this.autoMetadata == null) {
                str = androidx.compose.foundation.text.input.a.j(str, " autoMetadata");
            }
            if (str.isEmpty()) {
    ...
    public int hashCode() {
        ...
        int hashCode3 = (((i2 ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ this.autoMetadata.hashCode()) * 1000003;
