...
public final class ProgressiveDownloader implements Downloader {
    ...
    public ProgressiveDownloader(Uri uri, String str, CacheDataSource.Factory factory) {
        this(uri, str, factory, new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0());
    }
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory, Executor executor) {
        ...
        this.cacheWriter = new CacheWriter(createDataSourceForDownloading, build, false, null, new CacheWriter.ProgressListener() { // from class: com.google.android.exoplayer2.offline.ProgressiveDownloader$$ExternalSyntheticLambda0
