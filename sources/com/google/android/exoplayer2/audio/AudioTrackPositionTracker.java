    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (!this.notifiedPositionIncreasing) {
            ...
            if (j > j4) {
                ...
                this.listener.onPositionAdvancing(System.currentTimeMillis() - C.usToMs(Util.getPlayoutDurationForMediaDuration(C.usToMs(j - j4), this.audioTrackPlaybackSpeed)));
            }
        }
