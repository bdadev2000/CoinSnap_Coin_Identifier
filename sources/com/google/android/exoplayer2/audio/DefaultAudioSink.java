...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            intValue = i7;
            i4 = pcmFrameSize;
            i2 = Util.getPcmFrameSize(i7, audioFormat.channelCount);
            i5 = 0;
        } else {
        ...
        Configuration configuration = new Configuration(format, i4, i5, i2, i3, intValue2, intValue, i, this.enableAudioTrackPlaybackParams, audioProcessorArr);
