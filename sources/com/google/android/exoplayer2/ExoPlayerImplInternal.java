...
public final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized boolean release() {
        if (!this.released && this.internalPlaybackThread.isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return ExoPlayerImplInternal.this.m8019x37739a9a();
                }
    ...
    public /* synthetic */ Boolean m8019x37739a9a() {
    ...
    */
    ...
    private void resetInternal(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        this.playbackInfo = new PlaybackInfo(this.playbackInfo.timeline, mediaPeriodId, j3, this.playbackInfo.playbackState, z4 ? null : this.playbackInfo.playbackError, false, z5 ? TrackGroupArray.EMPTY : this.playbackInfo.trackGroups, z5 ? this.emptyTrackSelectorResult : this.playbackInfo.trackSelectorResult, z5 ? ImmutableList.of() : this.playbackInfo.staticMetadata, mediaPeriodId, this.playbackInfo.playWhenReady, this.playbackInfo.playbackSuppressionReason, this.playbackInfo.playbackParameters, j2, 0L, j2, this.offloadSchedulingEnabled, false);
        if (z3) {
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ExoPlayerImplInternal.this.m8020xacec0129(playerMessage);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m8020xacec0129(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
        } catch (ExoPlaybackException e) {
    ...
    */
    ...
    private void handleMediaSourceListInfoRefreshed(Timeline timeline) throws ExoPlaybackException {
        ...
        boolean z2 = (this.playbackInfo.periodId.equals(mediaPeriodId) && j2 == this.playbackInfo.positionUs) ? false : true;
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            updateLivePlaybackSpeedControl(this.playbackInfo.timeline, advancePlayingPeriod.info.id, this.playbackInfo.timeline, playingPeriod.info.id, C.TIME_UNSET);
            resetPendingPauseAtEndOfPeriod();
            updatePlaybackPositions();
            z = true;
        }
    ...
    private void enableRenderer(int i, boolean z) throws ExoPlaybackException {
        ...
        renderer.handleMessage(Renderer.MSG_SET_WAKEUP_LISTENER, new Renderer.WakeupListener() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal.1
