...
public abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public CeaDecoder() {
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            this.availableOutputBuffers.add(new CeaOutputBuffer(new OutputBuffer.Owner() { // from class: com.google.android.exoplayer2.text.cea.CeaDecoder$$ExternalSyntheticLambda0
