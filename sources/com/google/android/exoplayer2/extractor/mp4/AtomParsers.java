...
final class AtomParsers {
    ...
    */
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        String str5 = i8 == 1831958048 ? MimeTypes.VIDEO_MPEG : null;
        float f = 1.0f;
        int i9 = -1;
        boolean z = false;
        byte[] bArr = null;
        ...
        stsdData.format = new Format.Builder().setId(i4).setSampleMimeType(str5).setCodecs(str4).setWidth(readUnsignedShort).setHeight(readUnsignedShort2).setPixelWidthHeightRatio(f).setRotationDegrees(i5).setProjectionData(bArr).setStereoMode(i9).setInitializationData(list).setDrmInitData(drmInitData2).build();
    }
