...
public class DefaultDrmSession implements DrmSession {
    ...
    @EnsuresNonNullIf(expression = {Args.sessionId}, result = true)
    ...
    @RequiresNonNull({Args.sessionId})
    ...
    @RequiresNonNull({Args.sessionId, "offlineLicenseKeySetId"})
    ...
    public void onKeyResponse(Object obj, Object obj2) {
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                this.state = 4;
                dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.DefaultDrmSession$$ExternalSyntheticLambda5
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj3) {
