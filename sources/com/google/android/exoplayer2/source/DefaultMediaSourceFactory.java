...
public final class DefaultMediaSourceFactory implements MediaSourceFactory {
    ...
    private MediaSource maybeWrapWithAdsMediaSource(MediaItem mediaItem, MediaSource mediaSource) {
        ...
        if (adsConfiguration.adsId != null) {
            create = adsConfiguration.adsId;
        } else {
            create = Pair.create(mediaItem.mediaId, adsConfiguration.adTagUri);
        }
        return new AdsMediaSource(mediaSource, dataSpec, create, this, adsLoader, adViewProvider);
    }
