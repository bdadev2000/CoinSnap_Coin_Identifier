...
public class DefaultLoadControl implements LoadControl {
    ...
    public static final class Builder {
        ...
        public Builder setBufferDurationsMs(int i, int i2, int i3, int i4) {
            Assertions.checkState(!this.buildCalled);
            DefaultLoadControl.assertGreaterOrEqual(i3, 0, "bufferForPlaybackMs", LikeItem.DISLIKE);
            DefaultLoadControl.assertGreaterOrEqual(i4, 0, "bufferForPlaybackAfterRebufferMs", LikeItem.DISLIKE);
        ...
        public Builder setBackBuffer(int i, boolean z) {
            Assertions.checkState(!this.buildCalled);
            DefaultLoadControl.assertGreaterOrEqual(i, 0, "backBufferDurationMs", LikeItem.DISLIKE);
    ...
    protected DefaultLoadControl(DefaultAllocator defaultAllocator, int i, int i2, int i3, int i4, int i5, boolean z, int i6, boolean z2) {
        assertGreaterOrEqual(i3, 0, "bufferForPlaybackMs", LikeItem.DISLIKE);
        assertGreaterOrEqual(i4, 0, "bufferForPlaybackAfterRebufferMs", LikeItem.DISLIKE);
        ...
        assertGreaterOrEqual(i6, 0, "backBufferDurationMs", LikeItem.DISLIKE);
        this.allocator = defaultAllocator;
