...
public class AnalyticsDeferredProxy {
    ...
    public /* synthetic */ void lambda$init$2(Provider provider) {
        ...
        BlockingAnalyticsEventLogger blockingAnalyticsEventLogger = new BlockingAnalyticsEventLogger(crashlyticsOriginAnalyticsEventLogger, d.f29936c, TimeUnit.MILLISECONDS);
        synchronized (this) {
            try {
