...
public class SessionReportingCoordinator {
        ...
        if (!z) {
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    SessionReportingCoordinator.this.m8191x631b9fbf(addMetaDataToEvent, str, equals);
                }
            });
        } else {
    ...
    public /* synthetic */ void m8191x631b9fbf(CrashlyticsReport.Session.Event event, String str, boolean z) {
