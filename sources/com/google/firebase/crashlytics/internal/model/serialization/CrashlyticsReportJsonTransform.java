...
public class CrashlyticsReportJsonTransform {
    ...
    private static CrashlyticsReport.ApplicationExitInfo parseAppExitInfo(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c2) {
                case 0:
                    builder.setBuildIdMappingForArch(parseArray(jsonReader, new a(10)));
                    break;
                case 1:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 96801:
                    ...
                    break;
                case 107332:
                    if (nextName.equals(CreativeInfo.an)) {
                        c2 = 3;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c2) {
                case 0:
                    builder.setAppProcessDetails(parseArray(jsonReader, new a(9)));
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    builder.setInternalKeys(parseArray(jsonReader, new a(8)));
                    break;
                case 4:
                    builder.setCustomAttributes(parseArray(jsonReader, new a(7)));
                    break;
                case 5:
    ...
    private static CrashlyticsReport.Session.Event.RolloutsState parseEventRolloutsState(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("assignments")) {
                builder.setRolloutAssignments(parseArray(jsonReader, new a(6)));
            } else {
                jsonReader.skipValue();
            }
        }
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 351608024:
                    ...
                    break;
                case 1874684019:
                    if (nextName.equals(AppLovinBridge.e)) {
                        c2 = 3;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1335157162:
                    ...
                    break;
                case -1291329255:
                    if (nextName.equals(CrashEvent.f29806f)) {
                        c2 = 5;
                        break;
                    }
                    break;
