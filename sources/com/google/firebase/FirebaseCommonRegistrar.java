...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new c(14)));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new c(15)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new c(16)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new c(17)));
