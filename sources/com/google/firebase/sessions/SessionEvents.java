...
public final class SessionEvents {
    ...
    public final ApplicationInfo getApplicationInfo(FirebaseApp firebaseApp) {
        ...
        return new ApplicationInfo(applicationId, MODEL, BuildConfig.VERSION_NAME, RELEASE, logEnvironment, new AndroidApplicationInfo(packageName, str2, valueOf, MANUFACTURER, currentProcessDetails, processDetailsProvider2.getAppProcessDetails(applicationContext3)));
    }
