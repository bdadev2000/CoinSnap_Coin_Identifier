...
public final class SessionsSettings {
    ...
    */
    ...
    public final long m8266getSessionRestartTimeoutUwyO8pc() {
        Duration mo8264getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo8264getSessionRestartTimeoutFghU774();
        if (mo8264getSessionRestartTimeoutFghU774 != null) {
            long rawValue = mo8264getSessionRestartTimeoutFghU774.getRawValue();
            if (m8265isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration mo8264getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo8264getSessionRestartTimeoutFghU774();
        if (mo8264getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = mo8264getSessionRestartTimeoutFghU7742.getRawValue();
            if (m8265isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m8265isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m9649isPositiveimpl(sessionRestartTimeout) && Duration.m9644isFiniteimpl(sessionRestartTimeout);
    }
