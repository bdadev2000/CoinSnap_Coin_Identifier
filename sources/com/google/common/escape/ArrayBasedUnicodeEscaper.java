...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper {
    ...
    public ArrayBasedUnicodeEscaper(Map<Character, String> map, int i2, int i3, String str) {
    ...
    public ArrayBasedUnicodeEscaper(ArrayBasedEscaperMap arrayBasedEscaperMap, int i2, int i3, String str) {
