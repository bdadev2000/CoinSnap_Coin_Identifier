...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return t.k(valueOf.length() + t.b(obj, 15), obj, ".asCharSource(", valueOf, ")");
        }
    }
    ...
    public static class ByteArrayByteSource extends ByteSource {
        ...
        public ByteSource slice(long j2, long j3) {
            ...
            return new ByteArrayByteSource(this.bytes, this.offset + ((int) min), (int) Math.min(j3, this.length - min));
        }

        public String toString() {
            String truncate = Ascii.truncate(BaseEncoding.base16().encode(this.bytes, this.offset, this.length), 30, "...");
            return t.j(t.b(truncate, 17), "ByteSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return t.j(valueOf.length() + 19, "ByteSource.concat(", valueOf, ")");
        }
    }
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            long j2 = this.offset;
            long j3 = this.length;
            StringBuilder sb = new StringBuilder(t.b(obj, 50));
            sb.append(obj);
            sb.append(".slice(");
            sb.append(j2);
            sb.append(", ");
