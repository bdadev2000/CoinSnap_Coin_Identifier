...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(ValueGraph<N, V> valueGraph, N n2) {
        d dVar = new d(1, valueGraph, n2);
        return valueGraph.isDirected() ? DirectedGraphConnections.ofImmutable(n2, valueGraph.incidentEdges(n2), dVar) : UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n2), dVar));
    }
