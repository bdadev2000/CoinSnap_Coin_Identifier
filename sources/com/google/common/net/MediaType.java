...
public final class MediaType {
    ...
    public static final MediaType HTML_UTF_8 = createConstantUtf8("text", CreativeInfo.al);
    ...
    public static final MediaType MP4_AUDIO = createConstant(AUDIO_TYPE, k.f30095c);
    ...
    public static final MediaType MP4_VIDEO = createConstant("video", k.f30095c);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(ImpressionLog.R);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new d(2)).entries());
        }
        return sb.toString();
    }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new d(1));
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(t.j(t.b(str, 18), "Could not parse '", str, "'"), e);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(t.k(t.b(next, str.length() + 35), "Multiple charset values defined: ", str, ", ", next));
                }
            }
