...
public final class Stats implements Serializable {
    ...
    public String toString() {
        return count() > 0 ? MoreObjects.toStringHelper(this).add("count", this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add(AppLovinMediationProvider.MAX, this.max).toString() : MoreObjects.toStringHelper(this).add("count", this.count).toString();
    }
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j2++;
            doubleValue = (Doubles.isFinite(doubleValue2) && Doubles.isFinite(doubleValue)) ? ((doubleValue2 - doubleValue) / j2) + doubleValue : StatsAccumulator.calculateNewMeanNonFinite(doubleValue, doubleValue2);
        }
        return doubleValue;
    }
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i2 = 1; i2 < dArr.length; i2++) {
            double d2 = dArr[i2];
            d = (Doubles.isFinite(d2) && Doubles.isFinite(d)) ? ((d2 - d) / (i2 + 1)) + d : StatsAccumulator.calculateNewMeanNonFinite(d, d2);
        }
        return d;
    }
