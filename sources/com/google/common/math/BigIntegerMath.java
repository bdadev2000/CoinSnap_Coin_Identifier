    ...
    */
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
            case 5:
                return isPowerOfTwo(bigInteger) ? i2 : bitLength;
            case 6:
            case 7:
            case 8:
                return i2 < 256 ? bigInteger.compareTo(SQRT2_PRECOMPUTED_BITS.shiftRight(256 - i2)) <= 0 ? i2 : bitLength : bigInteger.pow(2).bitLength() + (-1) < (i2 * 2) + 1 ? i2 : bitLength;
            default:
