...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public String toString() {
            ...
            StringBuilder n2 = t.n(valueOf2.length() + valueOf.length() + 19, "CharMatcher.and(", valueOf, ", ", valueOf2);
            n2.append(")");
            return n2.toString();
        }
    }
    ...
    public static final class ForPredicate extends CharMatcher {
        ...
        public String toString() {
            ...
            return t.j(valueOf.length() + 26, "CharMatcher.forPredicate(", valueOf, ")");
        }
    ...
    public static final class InRange extends FastMatcher {
        ...
        public String toString() {
            ...
            StringBuilder n2 = t.n(t.b(showCharacter2, t.b(showCharacter, 27)), "CharMatcher.inRange('", showCharacter, "', '", showCharacter2);
            n2.append("')");
            return n2.toString();
        }
    }
    ...
    public static final class Is extends FastMatcher {
        ...
        public String toString() {
            ...
            return t.j(t.b(showCharacter, 18), "CharMatcher.is('", showCharacter, "')");
        }
    }
    ...
    public static final class IsEither extends FastMatcher {
        ...
        public String toString() {
            ...
            return t.k(t.b(showCharacter2, t.b(showCharacter, 21)), "CharMatcher.anyOf(\"", showCharacter, showCharacter2, "\")");
        }
    }
    ...
    public static final class IsNot extends FastMatcher {
        ...
        public String toString() {
            String showCharacter = CharMatcher.showCharacter(this.match);
            return t.j(t.b(showCharacter, 21), "CharMatcher.isNot('", showCharacter, "')");
        }
    }
    ...
    public static class Negated extends CharMatcher {
        ...
        public String toString() {
            ...
            return t.i(valueOf.length() + 9, valueOf, ".negate()");
        }
    }
    ...
    public static final class Or extends CharMatcher {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.first);
            String valueOf2 = String.valueOf(this.second);
            StringBuilder n2 = t.n(valueOf2.length() + valueOf.length() + 18, "CharMatcher.or(", valueOf, ", ", valueOf2);
            n2.append(")");
            return n2.toString();
        }
    }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i2, bitSet, charMatcher.endsWith(".negate()") ? charMatcher.substring(0, charMatcher.length() - 9) : ".negate()".length() != 0 ? charMatcher.concat(".negate()") : new String(charMatcher))) { // from class: com.google.common.base.CharMatcher.1
    ...
    public String replaceFrom(CharSequence charSequence, CharSequence charSequence2) {
        ...
        StringBuilder sb = new StringBuilder(a.z(length2, 3, 2, 16));
        do {
