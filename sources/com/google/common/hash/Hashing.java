...
public final class Hashing {
    ...
    public static HashFunction hmacSha1(Key key) {
        return new MacHashFunction(com.amazonaws.services.s3.internal.Constants.HMAC_SHA1_ALGORITHM, key, hmacToString("hmacSha1", key));
    }

    public static HashFunction hmacSha1(byte[] bArr) {
        return hmacSha1(new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), com.amazonaws.services.s3.internal.Constants.HMAC_SHA1_ALGORITHM));
    }
