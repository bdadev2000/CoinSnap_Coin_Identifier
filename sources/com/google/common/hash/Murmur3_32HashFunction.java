...
public final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i2, long j2) {
            ...
            this.length += i2;
            if (i4 >= 32) {
                this.f28782h1 = Murmur3_32HashFunction.mixH1(this.f28782h1, Murmur3_32HashFunction.mixK1((int) j4));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int mixK1 = this.f28782h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f28782h1 = mixK1;
        ...
        public Hasher putByte(byte b2) {
            update(1, b2 & UnsignedBytes.MAX_VALUE);
            return this;
        }
