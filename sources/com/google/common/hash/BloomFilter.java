...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> BloomFilter<T> readFrom(InputStream inputStream, Funnel<? super T> funnel) throws IOException {
        ...
        try {
            ...
            i3 = readByte;
            i = i5;
            throw new IOException(new StringBuilder(TsExtractor.TS_STREAM_TYPE_SPLICE_INFO).append("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ").append(i3).append(" numHashFunctions: ").append(i2).append(" dataLength: ").append(i).toString(), e);
        }
    }
}
