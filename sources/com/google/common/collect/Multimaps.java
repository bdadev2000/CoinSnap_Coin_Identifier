...
public final class Multimaps {
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: com.google.common.collect.Multimaps.MapMultimap.1.1
                        ...
                        public V next() {
                            ...
                            this.f28761i++;
                            AnonymousClass1 anonymousClass1 = AnonymousClass1.this;
                            return (V) NullnessCasts.uncheckedCastNullableTToT(MapMultimap.this.map.get(k2));
                        }

                        @Override // java.util.Iterator
                        public void remove() {
                            CollectPreconditions.checkRemove(this.f28761i == 1);
                            this.f28761i = -1;
                            AnonymousClass1 anonymousClass1 = AnonymousClass1.this;
    ...
    public static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap
        public List<V2> transform(@ParametricNullness K k2, Collection<V1> collection) {
    ...
    public static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> transform(@ParametricNullness K k2, Collection<V1> collection) {
            Function asValueToValueFunction = Maps.asValueToValueFunction(this.transformer, k2);
