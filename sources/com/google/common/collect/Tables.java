...
public final class Tables {
    ...
    public static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            return android.support.v4.media.d.r(t.n(valueOf3.length() + valueOf2.length() + valueOf.length() + 4, "(", valueOf, ",", valueOf2), ")=", valueOf3);
        }
    }
    ...
    public static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        public ImmutableCell(@ParametricNullness R r2, @ParametricNullness C c2, @ParametricNullness V v2) {
            this.rowKey = r2;
            this.columnKey = c2;
            this.value = v2;
        }
    ...
    public static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        public V put(@ParametricNullness C c2, @ParametricNullness R r2, @ParametricNullness V v2) {
            return this.original.put(r2, c2, v2);
        }
