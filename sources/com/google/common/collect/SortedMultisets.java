...
final class SortedMultisets {
    ...
    public static class NavigableElementSet<E> extends ElementSet<E> implements NavigableSet<E> {
        ...
        public NavigableSet<E> headSet(@ParametricNullness E e, boolean z2) {
            return new NavigableElementSet(multiset().headMultiset(e, BoundType.forBoolean(z2)));
        }
        ...
        public NavigableSet<E> subSet(@ParametricNullness E e, boolean z2, @ParametricNullness E e2, boolean z3) {
            return new NavigableElementSet(multiset().subMultiset(e, BoundType.forBoolean(z2), e2, BoundType.forBoolean(z3)));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<E> tailSet(@ParametricNullness E e, boolean z2) {
            return new NavigableElementSet(multiset().tailMultiset(e, BoundType.forBoolean(z2)));
        }
    }
