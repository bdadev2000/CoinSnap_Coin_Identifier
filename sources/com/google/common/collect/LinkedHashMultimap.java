...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        public ValueEntry(@ParametricNullness K k2, @ParametricNullness V v2, int i2, ValueEntry<K, V> valueEntry) {
            super(k2, v2);
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public ValueSet(@ParametricNullness K k2, int i2) {
            this.key = k2;
        ...
        public boolean add(@ParametricNullness V v2) {
            ...
            for (ValueEntry<K, V> valueEntry2 = valueEntry; valueEntry2 != null; valueEntry2 = valueEntry2.nextInValueBucket) {
                if (valueEntry2.matchesValue(v2, smearedHash)) {
                    return false;
                }
            }
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v2, smearedHash, valueEntry);
