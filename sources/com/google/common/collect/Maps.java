...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(Object obj, @ParametricNullness V v2) {
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> biMap, X x) {
            Y y2 = biMap.get(x);
            Preconditions.checkArgument(y2 != null, "No non-null mapping present for input: %s", x);
            return y2;
        }
        ...
        public String toString() {
            ...
            return t.j(valueOf.length() + 18, "Maps.asConverter(", valueOf, ")");
        }
    }
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        public static <V> MapDifference.ValueDifference<V> create(@ParametricNullness V v2, @ParametricNullness V v3) {
    ...
    public static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() { // from class: com.google.common.collect.Maps.9
            ...
            @ParametricNullness
            public V2 transformEntry(@ParametricNullness K k2, @ParametricNullness V1 v1) {
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            @Override // com.google.common.collect.TransformedIterator
            public Map.Entry<K, V> transform(@ParametricNullness K k2) {
                return Maps.immutableEntry(k2, function.apply(k2));
            }
        };
    }

    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, @ParametricNullness final K k2) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            @Override // com.google.common.base.Function
            @ParametricNullness
            public V2 apply(@ParametricNullness V1 v1) {
                return (V2) EntryTransformer.this.transformEntry(k2, v1);
            }
        };
    }
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                a.a aVar = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.6
            ...
            public NavigableSet<E> headSet(@ParametricNullness E e, boolean z2) {
                return Maps.removeOnlyNavigableSet(super.headSet(e, z2));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> subSet(@ParametricNullness E e, boolean z2, @ParametricNullness E e2, boolean z3) {
                return Maps.removeOnlyNavigableSet(super.subSet(e, z2, e2, z3));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> tailSet(@ParametricNullness E e, boolean z2) {
                return Maps.removeOnlyNavigableSet(super.tailSet(e, z2));
            }
        };
    }
