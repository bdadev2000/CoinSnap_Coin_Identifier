...
public final class TopKSelector<T> {
    ...
    private TopKSelector(Comparator<? super T> comparator, int i2) {
        ...
        this.buffer = (T[]) new Object[IntMath.checkedMultiply(i2, 2)];
        this.bufferSize = 0;
        this.threshold = null;
    }
    ...
    private int partition(int i2, int i3, int i4) {
        Object uncheckedCastNullableTToT = NullnessCasts.uncheckedCastNullableTToT(this.buffer[i4]);
        T[] tArr = this.buffer;
        tArr[i4] = tArr[i3];
        int i5 = i2;
        while (i2 < i3) {
            if (this.comparator.compare((Object) NullnessCasts.uncheckedCastNullableTToT(this.buffer[i2]), uncheckedCastNullableTToT) < 0) {
                swap(i5, i2);
                i5++;
            }
            i2++;
        ...
        T[] tArr2 = this.buffer;
        tArr2[i3] = tArr2[i5];
        tArr2[i5] = uncheckedCastNullableTToT;
        return i5;
    }
    ...
    private void trim() {
        ...
        while (true) {
            ...
            i4++;
            if (i4 >= log2) {
                Arrays.sort(this.buffer, i3, i2 + 1, this.comparator);
                break;
            }
        }
        this.bufferSize = this.f28763k;
        this.threshold = (T) NullnessCasts.uncheckedCastNullableTToT(this.buffer[i5]);
        while (true) {
            i5++;
            if (i5 >= this.f28763k) {
                return;
    ...
    public void offer(@ParametricNullness T t2) {
        ...
        if (i3 < i2) {
            ...
            tArr[i3] = t2;
            if (this.comparator.compare(t2, (Object) NullnessCasts.uncheckedCastNullableTToT(this.threshold)) > 0) {
                this.threshold = t2;
                return;
            }
            return;
