...
public class CycleDetectingLockFactory {
    ...
    public final class CycleDetectingReentrantReadWriteLock extends ReentrantReadWriteLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantReadWriteLock(CycleDetectingLockFactory cycleDetectingLockFactory, LockGraphNode lockGraphNode, boolean z2) {
            super(z2);
        ...
        */
        public ExampleStackTrace(com.google.common.util.concurrent.CycleDetectingLockFactory.LockGraphNode r4, com.google.common.util.concurrent.CycleDetectingLockFactory.LockGraphNode r5) {
            /*
                ...
                r0 = 4
                int r0 = com.applovin.impl.adview.t.b(r4, r0)
                int r0 = com.applovin.impl.adview.t.b(r5, r0)
                java.lang.String r1 = " -> "
                java.lang.String r4 = com.applovin.impl.adview.t.j(r0, r4, r1, r5)
                r3.<init>(r4)
    ...
    private static String getLockName(Enum<?> r3) {
        ...
        String name = r3.name();
        return t.j(t.b(name, simpleName.length() + 1), simpleName, ".", name);
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z2) {
        ...
        return new CycleDetectingReentrantLock(new LockGraphNode(str), z2);
    }
    ...
    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z2) {
        ...
        return new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z2);
    }
