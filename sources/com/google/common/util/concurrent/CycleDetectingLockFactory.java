...
public class CycleDetectingLockFactory {
    ...
    private static String getLockName(Enum<?> r3) {
        ...
        String name = r3.name();
        return new StringBuilder(String.valueOf(simpleName).length() + 1 + String.valueOf(name).length()).append(simpleName).append(InstructionFileId.DOT).append(name).toString();
    }
