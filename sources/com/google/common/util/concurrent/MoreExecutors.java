...
public final class MoreExecutors {
    ...
    public static class ListeningDecorator extends AbstractListeningExecutorService {
        ...
        public final String toString() {
            ...
            return t.k(valueOf.length() + t.b(obj, 2), obj, "[", valueOf, "]");
        }
    }
    ...
    */
    ...
    public static class Application {
        public final void addDelayedShutdownHook(final ExecutorService executorService, final long j2, final TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread(t.i(valueOf.length() + 24, "DelayedShutdownHook-for-", valueOf), new Runnable(this) { // from class: com.google.common.util.concurrent.MoreExecutors.Application.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        executorService.shutdown();
