...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public class AnonymousClass1 implements InvocationHandler {
        ...
        public AnonymousClass1(Object obj, long j2, TimeUnit timeUnit, Set set) {
            this.val$target = obj;
        ...
        public Object invoke(Object obj, final Method method, final Object[] objArr) throws Throwable {
            ...
            return SimpleTimeLimiter.this.callWithTimeout(new Callable() { // from class: com.google.common.util.concurrent.h
    ...
    public <T> T newProxy(T t2, Class<T> cls, long j2, TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new AnonymousClass1(t2, j2, timeUnit, findInterruptibleMethods(cls)));
    }
