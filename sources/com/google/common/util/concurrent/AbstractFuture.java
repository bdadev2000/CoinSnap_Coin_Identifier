...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        public boolean casListeners(AbstractFuture<?> abstractFuture, Listener listener, Listener listener2) {
            return com.google.android.gms.internal.ads.a.a(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        public boolean casValue(AbstractFuture<?> abstractFuture, Object obj, Object obj2) {
            return com.google.android.gms.internal.ads.a.a(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        public boolean casWaiters(AbstractFuture<?> abstractFuture, Waiter waiter, Waiter waiter2) {
            return com.google.android.gms.internal.ads.a.a(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            try {
                ...
                i2 = t.i(valueOf.length() + 38, "Exception thrown from implementation: ", valueOf);
            }
            if (i2 != null) {
                sb.append(", info=[");
                sb.append(i2);
    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        try {
            ...
            return new Failure(new IllegalArgumentException(t.i(valueOf2.length() + 77, "get() threw CancellationException, despite reporting isCancelled() == false: ", valueOf2), e));
        } catch (ExecutionException e2) {
            if (!isCancelled) {
                return new Failure(e2.getCause());
            }
            String valueOf3 = String.valueOf(listenableFuture);
            return new Cancellation(false, new IllegalArgumentException(t.i(valueOf3.length() + 84, "get() did not throw CancellationException, despite reporting isCancelled() == true: ", valueOf3), e2));
        } catch (Throwable th) {
    ...
    public V get(long j2, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            StringBuilder sb = new StringBuilder(t.b(lowerCase2, 28));
            sb.append("Waited ");
            sb.append(j2);
            sb.append(" ");
            ...
            if (nanos + SPIN_THRESHOLD_NANOS < 0) {
                ...
                if (convert > 0) {
                    ...
                    StringBuilder sb3 = new StringBuilder(t.b(lowerCase, valueOf.length() + 21));
                    sb3.append(valueOf);
                    sb3.append(convert);
                    sb3.append(" ");
            ...
            throw new TimeoutException(t.j(t.b(abstractFuture, t.b(sb2, 5)), sb2, " for ", abstractFuture));
        }
        throw new InterruptedException();
    }
