...
public class jU extends rV<Integer, Integer> {
    public jU(List<com.bytedance.adsdk.lottie.QR.zp<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.lottie.zp.lMd.zp<Integer, Integer> zp() {
        return new com.bytedance.adsdk.lottie.zp.lMd.HWF(this.zp);
    }
}
