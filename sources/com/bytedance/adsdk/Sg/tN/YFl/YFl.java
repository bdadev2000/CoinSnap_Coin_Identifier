...
public class YFl extends pDU<Integer, Integer> {
    public YFl(List<com.bytedance.adsdk.Sg.DSW.YFl<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.Sg.YFl.Sg.YFl<Integer, Integer> YFl() {
        return new com.bytedance.adsdk.Sg.YFl.Sg.Sg(this.YFl);
    }
