...
public class tN {
    ...
    private HashMap<String, Object> YFl = new HashMap<>();
    ...
    public boolean Sg(String str) {
        return this.YFl.containsKey(str);
    }

    public Object YFl(String str) {
        if (this.YFl.containsKey(str)) {
        ...
        while (keys.hasNext()) {
            ...
            if (TextUtils.equals("image", next)) {
                        ...
                        if (i10 < jSONArray.length()) {
                            ...
                            if (optJSONObject != null) {
                                ...
                                while (keys2.hasNext()) {
                                    ...
                                    this.YFl.put(next + "." + i10 + "." + next2, opt2);
                                }
                            }
                            i10++;
                        }
                        ...
                        while (keys3.hasNext()) {
                            ...
                            if ((opt3 instanceof JSONArray) && !TextUtils.equals(next3, "short_phrase") && !TextUtils.equals(next3, "long_phrase")) {
                                for (int i11 = 0; i11 < ((JSONArray) opt3).length(); i11++) {
                                    this.YFl.put(next + "." + next3 + "." + i11, ((JSONArray) opt3).opt(i11));
                                }
                ...
                while (keys5.hasNext()) {
                    ...
                    this.YFl.put(next + "." + next5, opt5);
                }
            }
        }
    }

    private void YFl(String str, String str2, Object obj) {
                ...
                while (true) {
                    ...
                    if (i10 < jSONArray.length()) {
                        ...
                        while (keys2.hasNext()) {
                            String next2 = keys2.next();
                            Object opt2 = optJSONObject.opt(next2);
                            this.YFl.put(str + "." + str2 + "." + next + "." + i10 + "." + next2, opt2);
                        }
                        i10++;
                    }
                }
            } else {
                this.YFl.put(str + "." + str2 + "." + next, opt);
            }
        }
    }
}
