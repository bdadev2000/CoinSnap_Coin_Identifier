...
public class NjR extends AlY {
    public NjR(View view, com.bytedance.sdk.component.adexpress.dynamic.AlY.YFl yFl) {
        super(view, yFl);
    }

    @Override // com.bytedance.sdk.component.adexpress.dynamic.animation.YFl.AlY
    public List<ObjectAnimator> YFl() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.tN, "rotation", 0.0f, 360.0f).setDuration((int) (this.Sg.nc() * 1000.0d));
