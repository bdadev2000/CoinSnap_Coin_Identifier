...
public class DSW implements View.OnTouchListener {
    ...
    private RectF f10395vc = new RectF();
    private long DSW = 0;
    private final int qsH = 200;
    private final int NjR = 3;

    /* renamed from: nc, reason: collision with root package name */
    private SoftReference<View> f10394nc = new SoftReference<>(null);

    public DSW(com.bytedance.sdk.component.adexpress.dynamic.tN.qsH qsh, int i10, final ViewGroup viewGroup) {
        this.wN = tN;
        this.AlY = qsh;
        if (i10 > 0) {
            this.wN = i10;
        ...
        if (viewGroup != null) {
            viewGroup.post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.dynamic.tN.YFl.DSW.1
                ...
                public void run() {
                    ...
                    DSW.this.f10394nc = new SoftReference(findViewById);
                }
            });
        }
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action == 1) {
                ...
                int i10 = tN;
                if (abs >= i10 && abs2 >= i10) {
                    if (rawX > this.YFl && Sg > this.wN && (qsh2 = this.AlY) != null) {
                        qsh2.YFl();
                    }
            ...
            this.f10395vc = YFl(this.f10394nc.get());
