...
public class NjR extends nc {
    ...
    public com.bytedance.sdk.openadsdk.core.wN.qsH Sg(Context context) {
        ...
        qsh.setGravity(16);
        qsh.setMaxWidth(GS.tN(context, 153.0f));
        qsh.setSingleLine();
        qsh.setText("Pangle");
        qsh.setTextColor(-1);
    ...
    public void YFl(Context context) {
        ...
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(GS.tN(context, 130.0f), GS.tN(context, 20.0f));
        layoutParams5.leftMargin = tN2;
        layoutParams5.setMarginStart(tN2);
        ...
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(GS.tN(context, 80.0f), GS.tN(context, 30.0f));
        layoutParams7.addRule(21);
        layoutParams7.addRule(11);
        layoutParams7.addRule(15);
        layoutParams7.rightMargin = tN;
        layoutParams7.setMarginEnd(tN);
    ...
    public com.bytedance.sdk.openadsdk.core.wN.qsH tN(Context context) {
        ...
        tN.setGravity(16);
        tN.setMaxWidth(GS.tN(context, 153.0f));
        tN.setTextColor(-1);
        tN.setTextSize(2, 13.0f);
        return tN;
    }

    public NjR(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public NjR(Context context, AttributeSet attributeSet, int i10) {
