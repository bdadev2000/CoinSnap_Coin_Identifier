...
public class YFl extends nc {
    ...
    public void YFl(Context context) {
        ...
        dsw.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        wNVar2.addView(dsw);
        lG DSW = DSW(context);
        this.tN = DSW;
        ...
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, GS.tN(context, 32.0f));
        layoutParams7.topMargin = tN2;
        this.f10518vc.setLayoutParams(layoutParams7);
        wNVar2.addView(this.f10518vc);
    }

    public YFl(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public YFl(Context context, AttributeSet attributeSet, int i10) {
