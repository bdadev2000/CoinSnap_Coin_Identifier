...
public class DSW extends nc {
    ...
    public com.bytedance.sdk.openadsdk.core.wN.qsH Sg(Context context) {
        ...
        Sg.setGravity(16);
        Sg.setMaxWidth(GS.tN(context, 150.0f));
        Sg.setTextColor(Color.parseColor("#B7B7B7"));
        Sg.setTextSize(2, 15.0f);
        Sg.setText("APP NAME");
        return Sg;
    }
    ...
    public void YFl(Context context) {
        ...
        layoutParams3.leftMargin = tN4;
        layoutParams3.setMarginStart(tN4);
        ...
        layoutParams4.setMarginStart(tN2);
        ...
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(GS.tN(context, 70.0f), GS.tN(context, 36.0f));
        layoutParams5.addRule(21);
        layoutParams5.addRule(11);
        layoutParams5.addRule(15);
        layoutParams5.rightMargin = tN4;
        layoutParams5.setMarginEnd(tN4);
    ...
    public DSW(Context context, AttributeSet attributeSet, int i10) {
