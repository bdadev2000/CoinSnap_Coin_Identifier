...
public class AlY extends nc {
    ...
    public void YFl(Context context) {
        ...
        dsw.setLayoutParams(layoutParams4);
        wNVar.addView(dsw);
        lG DSW = DSW(context);
        this.tN = DSW;
        int i10 = com.bytedance.sdk.openadsdk.utils.GA.f10822ni;
        DSW.setId(i10);
        int tN2 = GS.tN(context, 40.0f);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(tN2, tN2);
        layoutParams5.addRule(15);
        this.tN.setLayoutParams(layoutParams5);
        dsw.addView(this.tN);
        ...
        layoutParams6.leftMargin = tN;
        layoutParams6.setMarginStart(tN);
        layoutParams6.addRule(1, i10);
        layoutParams6.addRule(17, i10);
        this.AlY.setLayoutParams(layoutParams6);
        ...
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(GS.tN(context, 100.0f), GS.tN(context, 32.0f));
        layoutParams7.addRule(11);
        layoutParams7.addRule(21);
        layoutParams7.addRule(15);
        this.f10518vc.setLayoutParams(layoutParams7);
        dsw.addView(this.f10518vc);
    }
