...
public class TTInteractionStyle009016VLayout extends TTInteractionStyleBaseFrameLayout {
    ...
    public PAGTextView lMd(Context context) {
        ...
        lMd.setGravity(16);
        lMd.setMaxWidth(WNy.lMd(context, 150.0f));
        lMd.setTextColor(Color.parseColor("#B7B7B7"));
        lMd.setTextSize(2, 15.0f);
    ...
    public void zp(Context context) {
        ...
        layoutParams3.leftMargin = lMd4;
        layoutParams3.setMarginStart(lMd4);
        ...
        layoutParams4.setMarginStart(lMd2);
        ...
        this.HWF = jU;
        jU.setId(vDp.xg);
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(WNy.lMd(context, 70.0f), WNy.lMd(context, 36.0f));
    ...
    public TTInteractionStyle009016VLayout(Context context, AttributeSet attributeSet, int i9) {
