...
public class TTVideoTrafficTipsLayout extends PAGRelativeLayout {
    ...
    private void zp(Context context) {
        ...
        pAGTextView.setText(cz.lMd(context, "tt_video_without_wifi_tips"));
        pAGTextView.setTextColor(Color.parseColor("#cacaca"));
        pAGTextView.setTextSize(2, 14.0f);
        addView(pAGTextView);
        PAGRelativeLayout pAGRelativeLayout = new PAGRelativeLayout(context);
        pAGRelativeLayout.setId(vDp.Gor);
        ...
        pAGImageView.setImageDrawable(cz.KS(context, "tt_new_play_video"));
    ...
    public TTVideoTrafficTipsLayout(Context context, AttributeSet attributeSet, int i9) {
