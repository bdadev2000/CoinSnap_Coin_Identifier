...
public class TTInteractionStyle001001Layout extends TTInteractionStyleBaseFrameLayout {
    ...
    public void zp(Context context) {
        ...
        layoutParams4.setMarginEnd(lMd);
        ...
        this.HWF = jU;
        jU.setId(vDp.xg);
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, WNy.lMd(context, 32.0f));
    ...
    public TTInteractionStyle001001Layout(Context context, AttributeSet attributeSet, int i9) {
