...
public class jU {
    public View zp(Context context) {
        ...
        pAGRelativeLayout.setId(vDp.ITK);
        pAGRelativeLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, WNy.lMd(context, 44.0f)));
        pAGRelativeLayout.setBackground(ku.zp(context, "tt_dislike_top_bg"));
        pAGRelativeLayout.setVisibility(8);
        PAGTextView pAGTextView = new PAGTextView(context);
        pAGTextView.setId(vDp.JR);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(9);
        layoutParams.addRule(15);
        pAGTextView.setLayoutParams(layoutParams);
        pAGTextView.setCompoundDrawablesWithIntrinsicBounds(ku.zp(context, "tt_lefterbackicon_titlebar_press_wrapper"), (Drawable) null, (Drawable) null, (Drawable) null);
        ...
        view.setId(vDp.vFs);
        view.setLayoutParams(new LinearLayout.LayoutParams(-1, WNy.lMd(context, 1.0f)));
        ...
        tTDislikeListView.setId(vDp.Oza);
        ...
        tTDislikeListView.setDividerHeight(WNy.lMd(context, 1.0f));
        ...
        tTDislikeListView2.setId(vDp.OJ);
        ...
        tTDislikeListView2.setDividerHeight(WNy.lMd(context, 1.0f));
        ...
        if (dQp.etV().gH()) {
            ...
            view2.setLayoutParams(new FrameLayout.LayoutParams(-1, WNy.lMd(context, 1.0f)));
            view2.setBackgroundColor(Color.parseColor("#DCDCDC"));
            FrameLayout frameLayout = new FrameLayout(context);
            frameLayout.setLayoutParams(new ViewGroup.LayoutParams(-1, WNy.lMd(context, 50.0f)));
            frameLayout.setBackground(ku.zp(context, "tt_dislike_bottom_seletor"));
            PAGTextView pAGTextView3 = new PAGTextView(context);
            pAGTextView3.setId(vDp.VgU);
            FrameLayout.LayoutParams layoutParams3 = new FrameLayout.LayoutParams(-1, -2);
            layoutParams3.leftMargin = WNy.lMd(context, 20.0f);
            layoutParams3.rightMargin = WNy.lMd(context, 20.0f);
            layoutParams3.gravity = 17;
            pAGTextView3.setLayoutParams(layoutParams3);
            pAGTextView3.setBackground(ku.zp(context, "tt_comment_tv"));
            Drawable KS = cz.KS(context, "tt_suggestion_logo");
            KS.setBounds(0, 0, KS.getIntrinsicWidth(), KS.getIntrinsicHeight());
            pAGTextView3.setCompoundDrawables(KS, null, null, null);
            pAGTextView3.setCompoundDrawablePadding(WNy.lMd(context, 5.0f));
            pAGTextView3.setPadding(WNy.lMd(context, 8.6f), WNy.lMd(context, 10.0f), WNy.lMd(context, 8.6f), WNy.lMd(context, 10.0f));
            pAGTextView3.setFocusable(false);
            pAGTextView3.setHint(cz.zp(context, "tt_display_error"));
