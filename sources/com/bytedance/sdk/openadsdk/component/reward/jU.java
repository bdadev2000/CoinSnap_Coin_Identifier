...
public class jU {
    ...
    private jU(Context context) {
        ...
        this.KS = new tG("sp_full_screen_video");
    }
    ...
    public void zp() {
        ...
        File[] listFiles2;
        try {
            boolean COT = com.bytedance.sdk.openadsdk.core.ku.COT("sp_full_screen_video");
            if (COT) {
                str = "files";
            } else {
                str = "shared_prefs";
            ...
            if (file.exists() && file.isDirectory() && (listFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.jU.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (listFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.jU.2
                @Override // java.io.FileFilter
    ...
    public void zp(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.zp zpVar) {
        if (zpVar != null && adSlot != null && TextUtils.isEmpty(adSlot.getBidAdm())) {
            try {
    ...
    public static jU zp(Context context) {
        if (zp == null) {
    ...
    public String zp(woN won) {
        ...
        return zp(won.eWG().Bj(), won.eWG().rV(), won.jyq());
    }
    ...
    public String zp(String str, String str2, int i9) {
        ...
        File zp2 = zp(str2, i9);
        if (zp2 == null || !zp2.exists() || !zp2.isFile() || zp2.length() <= 0) {
            return null;
        }
    ...
    public void zp(final boolean z8, final woN won, final long j7, String str) {
        ...
        com.bytedance.sdk.openadsdk.dT.KS.zp(str2, false, new com.bytedance.sdk.openadsdk.dT.lMd() { // from class: com.bytedance.sdk.openadsdk.component.reward.jU.3
    ...
    public void zp(final woN won, final zp<Object> zpVar) {
        ...
        if (won.eWG() != null && !TextUtils.isEmpty(won.eWG().Bj())) {
            ...
            jU.zp(new com.bytedance.sdk.component.QR.zp.zp() { // from class: com.bytedance.sdk.openadsdk.component.reward.jU.4
                ...
                public void zp(com.bytedance.sdk.component.QR.lMd.KS ks, com.bytedance.sdk.component.QR.lMd lmd) {
                    if (lmd.HWF() && lmd.COT() != null && lmd.COT().exists()) {
                        ...
                        jU.this.zp(true, won, lmd.zp(), lmd.lMd());
                        return;
                    }
                    zp zpVar3 = zpVar;
                    if (zpVar3 != null) {
                    ...
                    jU.this.zp(false, won, lmd.zp(), lmd.lMd());
                }
                ...
                public void zp(com.bytedance.sdk.component.QR.lMd.KS ks, IOException iOException) {
                    ...
                    jU.this.zp(false, won, -2L, iOException.getMessage());
                }
            });
            return;
        }
