...
public class dT {
    public static void zp(String str, int i9, String str2, String str3, String str4) {
        try {
            ...
            if (zp != null) {
                ...
                if (zp.Vjb() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        zp.Vjb().zp(str2);
                        zp.Vjb().lMd("Test the downloaded app");
                    } else {
                        zp.Vjb().zp((String) null);
                        zp.Vjb().lMd("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        zp.Vjb().KS(str3);
            ...
            arrayList.add(zp);
            zpVar.zp(arrayList);
            new rV(KVG.zp(), zpVar).zp(true);
        } catch (Exception e4) {
            com.bytedance.sdk.component.utils.tG.zp("PlayableVerityHelper", e4.getMessage());
        }
    }
}
