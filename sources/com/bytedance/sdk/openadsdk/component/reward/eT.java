...
public class eT {
    ...
    private static volatile eT YFl;
    ...
    private eT(Context context) {
        ...
        this.tN = new GA("sp_reward_video");
    }
    ...
    public void YFl() {
        ...
        File[] listFiles2;
        try {
            boolean z10 = com.bytedance.sdk.openadsdk.core.NjR.DSW("sp_reward_video");
            File file = new File(this.Sg.getDataDir(), z10 ? "files" : "shared_prefs");
            if (file.exists() && file.isDirectory() && (listFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.eT.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (listFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.eT.2
                @Override // java.io.FileFilter
    ...
    public void YFl(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.YFl yFl) {
        if (yFl == null || yFl.NjR() || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm())) {
            return;
        }
        String YFl2 = yFl.YFl();
        synchronized (yFl) {
    ...
    public static eT YFl(Context context) {
        if (YFl == null) {
    ...
    public String YFl(String str, String str2, int i10) {
        File YFl2;
        if (!TextUtils.isEmpty(str) && (YFl2 = YFl(str2, i10)) != null && YFl2.exists() && YFl2.isFile() && YFl2.length() > 0) {
    ...
    public void YFl(final boolean z10, final Wwa wwa, final long j3, String str) {
        ...
        com.bytedance.sdk.openadsdk.pDU.tN.YFl(str2, false, new com.bytedance.sdk.openadsdk.pDU.Sg() { // from class: com.bytedance.sdk.openadsdk.component.reward.eT.3
    ...
    public void YFl(final Wwa wwa, final YFl<Object> yFl) {
        ...
        if (wwa != null && wwa.BPI() != null && !TextUtils.isEmpty(wwa.BPI().f23462g)) {
            ...
            AlY.YFl(new com.bytedance.sdk.component.DSW.YFl.YFl() { // from class: com.bytedance.sdk.openadsdk.component.reward.eT.4
                ...
                public void YFl(com.bytedance.sdk.component.DSW.Sg.tN tNVar, com.bytedance.sdk.component.DSW.Sg sg2) {
                    if (sg2.vc() && sg2.wN() != null && sg2.wN().exists()) {
                        ...
                        eT.this.YFl(true, wwa, sg2.YFl(), sg2.Sg());
                        return;
                    }
                    YFl yFl3 = yFl;
                    if (yFl3 != null) {
                    ...
                    eT.this.YFl(false, wwa, sg2.YFl(), sg2.Sg());
                }
                ...
                public void YFl(com.bytedance.sdk.component.DSW.Sg.tN tNVar, IOException iOException) {
                    ...
                    eT.this.YFl(false, wwa, -2L, iOException.getMessage());
                }
            });
            return;
        }
