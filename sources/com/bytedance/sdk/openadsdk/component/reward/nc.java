...
public class nc {
    public static void YFl(String str, int i10, String str2, String str3, String str4) {
        try {
            ...
            if (YFl != null) {
                if (YFl.BPI() != null) {
                    YFl.BPI().f23463h = str5;
                }
                if (YFl.in() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        YFl.in().YFl(str2);
                        YFl.in().Sg("Test the downloaded app");
                    } else {
                        YFl.in().YFl((String) null);
                        YFl.in().Sg("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        YFl.in().tN(str3);
            ...
            arrayList.add(YFl);
            yFl.YFl(arrayList);
            new pDU(lG.YFl(), yFl).YFl(true);
        } catch (Exception e2) {
            com.bytedance.sdk.component.utils.YoT.YFl("PlayableVerityHelper", e2.getMessage());
        }
    }
}
