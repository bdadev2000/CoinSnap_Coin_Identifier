...
public class QR extends com.bytedance.sdk.openadsdk.core.lMd.lMd {
    public QR(@NonNull Context context, @NonNull com.bytedance.sdk.openadsdk.core.model.woN won, @NonNull String str, int i9) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.YW zp(float f9, float f10, float f11, float f12, SparseArray<KS.zp> sparseArray, long j7, long j9, View view, View view2, String str, float f13, int i9, float f14, int i10, JSONObject jSONObject) {
        ...
        this.pvr = i16;
        return new YW.zp().HWF(f15).COT(f16).jU(f17).KS(f18).lMd(j10).zp(j11).lMd(zp).zp(iArr).KS(WNy.KS(view)).jU(iArr2).jU(this.Lij).COT(this.Gzh).HWF(this.irS).lMd(com.bytedance.sdk.openadsdk.core.ku.lMd().zp() ? i13 : 2).zp(sparseArray).zp(str).zp(i10).zp(jSONObject).zp();
    }
