...
public class NjR extends com.bytedance.sdk.openadsdk.core.Sg.Sg {
    public NjR(@NonNull Context context, @NonNull com.bytedance.sdk.openadsdk.core.model.Wwa wwa, @NonNull String str, int i10) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.nc YFl(float f10, float f11, float f12, float f13, SparseArray<tN.YFl> sparseArray, long j3, long j10, View view, View view2, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.aIu = i17;
        return new nc.YFl().vc(f16).wN(f17).AlY(f18).tN(f19).Sg(j11).YFl(j12).Sg(YFl).YFl(iArr).tN(GS.tN(view)).AlY(iArr2).AlY(this.Ga).wN(this.dXO).vc(this.Cfr).Sg(com.bytedance.sdk.openadsdk.core.NjR.Sg().YFl() ? i14 : 2).YFl(sparseArray).YFl(str).YFl(i11).YFl(jSONObject).Sg(jSONObject2).YFl();
    }
