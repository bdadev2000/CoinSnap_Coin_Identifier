...
public abstract class C6H {
    ...
    */
    public static com.instagram.common.viewpoint.core.C6F A01(com.instagram.common.viewpoint.core.C7j r5, com.instagram.common.viewpoint.core.C6F r6) {
        /*
            if (r6 == 0) goto Lc
            ...
            if (r0 == 0) goto L29
        Lc:
            com.facebook.ads.redexgen.X.6F r0 = com.instagram.common.viewpoint.core.C6N.A00(r5)     // Catch: java.lang.Throwable -> L11
            return r0
        L11:
            r0 = move-exception
            com.facebook.ads.redexgen.X.8D r5 = r5.A07()
            int r4 = com.instagram.common.viewpoint.core.C8E.A1Q
        ...
        L29:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C6H.A01(com.facebook.ads.redexgen.X.7j, com.facebook.ads.redexgen.X.6F):com.facebook.ads.redexgen.X.6F");
    }

    public static C6F A02(C7j c7j, C6F c6f, C6G c6g) {
        C6I c6i = null;
        try {
            if (AbstractC0607Il.A06(c7j) && (c6f == null || TextUtils.isEmpty(c6f.A03()))) {
    ...
    public static void A07(C7j c7j) {
        ...
        try {
            ...
            if (advertisingIdInfo2 != null && !TextUtils.isEmpty(advertisingIdInfo2.A03())) {
                j2 = advertisingIdInfo2.A01();
            } else {
                j2 = -1;
            }
            if (j2 > 0 && System.currentTimeMillis() - j2 < AbstractC0607Il.A00(c7j)) {
                return;
            }
            if (AbstractC0607Il.A07(c7j)) {
            ...
            c7j.A07().AA0(A04(12, 7, 84), C8E.A1R, new C8F(t2));
        }
    }
