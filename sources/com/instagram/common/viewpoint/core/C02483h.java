...
public class C02483h extends ViewGroup {
    ...
    public static final C02473g A0w;
    ...
    private C3Z A03() {
        ...
        C3Z c3z = null;
        int i3 = 0;
        while (i3 < this.A0r.size()) {
            C3Z c3z2 = this.A0r.get(i3);
            if (!z2 && c3z2.A02 != i2 + 1) {
                c3z2 = this.A0p;
                c3z2.A00 = f3 + f4 + f2;
                c3z2.A02 = i2 + 1;
            ...
            if (scrollX < f6 || i3 == this.A0r.size() - 1) {
                return c3z2;
            }
            z2 = false;
            i2 = c3z2.A02;
    ...
    public static String A08(int i2, int i3, int i4) {
        byte[] copyOfRange = Arrays.copyOfRange(A0s, i2, i2 + i3);
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 21 out of bounds for length 17
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    private final void A0J(int i2, int i3, int i4) {
        int scrollX;
        if (getChildCount() == 0) {
        ...
        float A00 = i7 + (i7 * A00(Math.min(1.0f, (Math.abs(i5) * 1.0f) / clientWidth)));
        int abs = Math.abs(i4);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(A00 / abs) * 1000.0f) * 4 : (int) ((1.0f + (Math.abs(i5) / (this.A0M + (clientWidth * this.A01.A00(this.A00))))) * 100.0f), 600);
        this.A0j = false;
        this.A0X.startScroll(scrollX, scrollY, i5, i6, min);
        C3T.A07(this);
    }
    ...
    */
    public void onMeasure(int r16, int r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.onMeasure(int, int):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x017b, code lost:
        ...
        r9.A05 = r1;
        r9.A06 = r2;
        r2 = com.instagram.common.viewpoint.core.C02483h.A0t;
     */
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    static {
        ...
        A0w = new Comparator<View>() { // from class: com.facebook.ads.redexgen.X.3g
            ...
            public final int compare(View view, View view2) {
                C02413a c02413a = (C02413a) view.getLayoutParams();
                C02413a c02413a2 = (C02413a) view2.getLayoutParams();
                if (c02413a.A05 != c02413a2.A05) {
                    return c02413a.A05 ? 1 : -1;
                }
                return c02413a.A02 - c02413a2.A02;
            }
        };
    }

    public C02483h(Context context) {
        super(context);
    ...
    private int A01(int i2, float f2, int i3, int i4) {
        if (Math.abs(i4) > this.A0H && Math.abs(i3) > this.A0K) {
            ...
            float truncator = i2 >= targetPage ? 0.4f : 0.6f;
            i2 = ((int) (f2 + truncator)) + i2;
        }
        ...
        if (targetPage2 > 0) {
            ...
            return Math.max(i5, Math.min(i2, targetPage4));
        }
        return i2;
    }
    ...
    private Rect A02(Rect rect, View view) {
        ...
        while ((parent instanceof ViewGroup) && parent != this) {
            ...
            rect.bottom = i2 + viewGroup.getBottom();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C3Z A04(int r7) {
        /*
            r6 = this;
            r5 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.3Z r4 = (com.instagram.common.viewpoint.core.C3Z) r4
            int r3 = r4.A02
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C02483h.A0t
            r0 = 6
            r1 = r1[r0]
            r0 = 18
            ...
            r0 = 53
            if (r1 == r0) goto L34
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C02483h.A0t
        ...
        L3a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A04(int):com.facebook.ads.redexgen.X.3Z");
    }

    private final C3Z A05(int i2, int i3) {
        C3Z c3z = new C3Z();
        c3z.A02 = i2;
        c3z.A03 = this.A01.A04(this, i2);
        c3z.A01 = this.A01.A00(i2);
        if (i3 < 0 || i3 >= this.A0r.size()) {
            this.A0r.add(c3z);
        } else {
            this.A0r.add(i3, c3z);
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C3Z A07(android.view.View r5) {
        /*
            r4 = this;
            r3 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.3Z r2 = (com.instagram.common.viewpoint.core.C3Z) r2
        ...
        L1f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A07(android.view.View):com.facebook.ads.redexgen.X.3Z");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.3a r0 = (com.instagram.common.viewpoint.core.C02413a) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        C3T.A0B(this, new C1117b4(this));
        if (C3T.A00(this) == 0) {
            C3T.A09(this, 1);
        }
        C3T.A0C(this, new C1118b5(this));
    }

    private void A0E(int i2) {
        List<InterfaceC02433c> list = this.A0d;
        String[] strArr = A0t;
        if (strArr[5].charAt(3) == strArr[3].charAt(3)) {
            throw new RuntimeException();
        }
    ...
    */
    private final void A0G(int r17) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A0G(int):void");
    }
    ...
    private final void A0I(int i2, float f2, int i3) {
        int max;
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i4; childCount++) {
                View childAt = getChildAt(childCount);
                C02413a lp = (C02413a) childAt.getLayoutParams();
        ...
        if (0 != 0) {
            ...
            for (int i6 = 0; i6 < childCount2; i6++) {
                ...
                if (!((C02413a) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
                    throw new NullPointerException(A08(450, 13, Opcodes.LSHR));
                }
            }
        }
        this.A0e = true;
    ...
    private void A0K(int i2, int i3, int i4, int i5) {
        if (i3 > 0 && !this.A0r.isEmpty()) {
            ...
            int i6 = i3 - widthWithMargin;
            int widthWithMargin2 = getPaddingRight();
            int i7 = (i6 - widthWithMargin2) + i5;
            int widthWithMargin3 = getScrollX();
            int oldWidthWithMargin = (int) (paddingLeft * (widthWithMargin3 / i7));
        ...
        int paddingLeft2 = (int) (((i2 - getPaddingLeft()) - getPaddingRight()) * scrollOffset);
    ...
    private final void A0L(int i2, boolean z2) {
        this.A0m = false;
        A0N(i2, z2, false);
    }

    private void A0M(int i2, boolean z2, int i3, boolean z3) {
        C3Z A04 = A04(i2);
        int destX = 0;
        if (A04 != null) {
    ...
    private final void A0N(int i2, boolean z2, boolean z3) {
        A0O(i2, z2, z3, 0);
    }

    private final void A0O(int i2, boolean z2, boolean z3, int i3) {
        ...
        if (i2 < 0) {
            i2 = 0;
        } else if (i2 >= this.A01.A01()) {
            i2 = this.A01.A01() - 1;
        }
        int i4 = this.A0L;
        if (i2 > this.A00 + i4 || i2 < this.A00 - i4) {
            for (int i5 = 0; i5 < this.A0r.size(); i5++) {
                this.A0r.get(i5).A04 = true;
            }
        }
        boolean z4 = this.A00 != i2;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0Q(com.instagram.common.viewpoint.core.C3Z r13, int r14, com.instagram.common.viewpoint.core.C3Z r15) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A0Q(com.facebook.ads.redexgen.X.3Z, int, com.facebook.ads.redexgen.X.3Z):void");
    }
    ...
    private void A0S(boolean z2) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            getChildAt(i2).setLayerType(layerType, null);
        }
    }
    ...
    private boolean A0X(float f2) {
        boolean z2 = false;
        float f3 = this.A05 - f2;
        this.A05 = f2;
        float scrollX = getScrollX() + f3;
        int clientWidth = getClientWidth();
        float f4 = clientWidth * this.A02;
    ...
    private final boolean A0Y(float f2, float f3) {
        return (f2 < ((float) this.A0I) && f3 > 0.0f) || (f2 > ((float) (getWidth() - this.A0I)) && f3 < 0.0f);
    }
    ...
    private boolean A0Z(int i2) {
        ...
        int i3 = A03.A02;
        float f2 = ((i2 / currentPage) - A03.A00) / (A03.A01 + (this.A0M / currentPage));
        this.A0e = false;
        A0I(i3, f2, (int) (widthWithMargin * f2));
        if (this.A0e) {
            return true;
        }
        throw new IllegalStateException(A08);
    ...
    private final boolean A0a(int i2) {
        ...
        boolean z3 = false;
        View nextFocused = FocusFinder.getInstance().findNextFocus(this, findFocus, i2);
    ...
    private final boolean A0d(View view, boolean z2, int i2, int i3, int i4) {
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                if (i3 + count >= childAt.getLeft() && i3 + count < childAt.getRight() && i4 + scrollY >= childAt.getTop() && i4 + scrollY < childAt.getBottom() && A0d(childAt, true, i2, (i3 + count) - childAt.getLeft(), (i4 + scrollY) - childAt.getTop())) {
                    return true;
                }
            }
        }
    ...
    */
    public final void A0e() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.A0e():void");
    }
    ...
    public final void addFocusables(ArrayList<View> views, int i2, int i3) {
        ...
        int descendantFocusability4 = i3 & 1;
    ...
    public final void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        ...
        C02413a c02413a = (C02413a) layoutParams;
        boolean z2 = c02413a.A05;
        String[] strArr = A0t;
        if (strArr[4].charAt(21) != strArr[2].charAt(21)) {
            throw new RuntimeException();
        }
        A0t[6] = "0hKurRTmjdCHvNVYXWivI507L49T3Iz9";
        c02413a.A05 = z2 | A0c(view);
        if (this.A0h) {
            if (c02413a == null || !c02413a.A05) {
                c02413a.A03 = true;
    ...
    public final boolean canScrollHorizontally(int i2) {
        ...
        int scrollX = getScrollX();
        return i2 < 0 ? scrollX > ((int) (((float) width) * this.A02)) : i2 > 0 && scrollX < ((int) (((float) width) * this.A07));
    }

    @Override // android.view.ViewGroup
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C02413a) && super.checkLayoutParams(layoutParams);
    }
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (childCount2 == 0) {
                        ...
                        if (A07 != null) {
                            ...
                            if (i4 == childCount4 && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                                return true;
                            }
                        } else {
                            continue;
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C02413a(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i2, int i3) {
        int result = this.A0F == 2 ? (i2 - 1) - i3 : i3;
        int index = ((C02413a) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            int scrollX = getScrollX();
            int pos = getWidth();
            float f3 = this.A0M / pos;
            int firstPos = 0;
            C3Z c3z = this.A0r.get(0);
            float marginOffset = c3z.A00;
            int itemCount = this.A0r.size();
            int i2 = this.A0r.get(itemCount - 1).A02;
            for (int i3 = c3z.A02; i3 < i2; i3++) {
                while (i3 > c3z.A02 && firstPos < itemCount) {
                    firstPos++;
                    c3z = this.A0r.get(firstPos);
                }
                if (i3 == c3z.A02) {
                    f2 = (c3z.A00 + c3z.A01) * pos;
                    float marginOffset2 = c3z.A00;
                    marginOffset = marginOffset2 + c3z.A01 + f3;
                } else {
                    float A00 = this.A01.A00(i3);
                ...
                if (this.A0M + f2 > scrollX) {
                    ...
                    drawable.setBounds(round, i4, width, this.A09);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00d4, code lost:
        ...
        com.instagram.common.viewpoint.core.C3T.A07(r17);
     */
    ...
    */
    public final boolean onInterceptTouchEvent(android.view.MotionEvent r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
        ...
        while (true) {
            ...
            if (paddingTop < scrollX) {
                ...
                if (childAt.getVisibility() != 8) {
                    C02413a c02413a = (C02413a) childAt.getLayoutParams();
                    if (c02413a.A05) {
                        int count3 = c02413a.A04 & 7;
                        int childTop2 = c02413a.A04 & 112;
                        switch (count3) {
                            case 1:
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        C02413a c02413a2 = (C02413a) childAt2.getLayoutParams();
                        if (!c02413a2.A05 && (A07 = A07(childAt2)) != null) {
                            int i7 = vgrav + ((int) (childLeft2 * A07.A00));
                            if (c02413a2.A03) {
                                c02413a2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * c02413a2.A00), Ints.MAX_POWER_OF_TWO);
                                childAt2.measure(widthSpec, View.MeasureSpec.makeMeasureSpec((childWidth - width) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                            }
                            int childTop3 = childAt2.getMeasuredWidth() + i7;
                            width = width;
                            ...
                            if (widthSpec2 != str4.charAt(20)) {
                                ...
                                childAt2.layout(i7, width, childTop3, height);
                            } else {
                                childAt2.layout(i7, width, childTop3, height);
                            }
                        }
    ...
    public final boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i3 != childCount) {
            ...
            if (count2 == 0 && (A07 = A07(childAt)) != null) {
                int index = A07.A02;
                int count3 = this.A00;
                if (index == count3 && childAt.requestFocus(i2, rect)) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setAdapter(com.instagram.common.viewpoint.core.C3E r7) {
        /*
            r6 = this;
        ...
        Lc:
            ...
            com.facebook.ads.redexgen.X.3Z r0 = (com.instagram.common.viewpoint.core.C3Z) r0
        ...
        Lc2:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02483h.setAdapter(com.facebook.ads.redexgen.X.3E):void");
    }

    public void setCurrentItem(int i2) {
        this.A0m = false;
        A0N(i2, !this.A0g, false);
    }

    public void setOffscreenPageLimit(int i2) {
        if (i2 < 1) {
            Log.w(A08(300, 9, 73), A08(127, 31, 122) + i2 + A08(51, 26, 45) + 1);
            i2 = 1;
        }
        if (i2 != this.A0L) {
            this.A0L = i2;
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC02433c interfaceC02433c) {
        this.A0Y = interfaceC02433c;
    }
    ...
    public void setPageMargin(int i2) {
        ...
        A0K(oldMargin, oldMargin, i2, width);
        requestLayout();
    }

    public void setPageMarginDrawable(int i2) {
        setPageMarginDrawable(AbstractC02252k.A00(getContext(), i2));
    }
