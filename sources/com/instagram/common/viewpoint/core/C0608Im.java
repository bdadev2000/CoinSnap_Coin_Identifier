...
public final class C0608Im {
    public static C0608Im A01;
    ...
    public C0608Im(Context context) {
    ...
    public static int A04(Context context) {
        return A0T(context).A2p(A0U(2076, 33, Opcodes.DNEG), 0);
    }
    ...
    public static int A06(Context context) {
        return A0T(context).A2p(A0U(569, 37, Opcodes.LSHR), 3);
    }
    ...
    public static int A09(Context context) {
        return A0T(context).A2p(A0U(1228, 50, 106), p.f29763c);
    }

    public static int A0A(Context context) {
        return A0T(context).A2p(A0U(1322, 40, Opcodes.LNEG), 3);
    }
    ...
    public static synchronized C0608Im A0T(Context context) {
        C0608Im c0608Im;
        synchronized (C0608Im.class) {
            if (A01 == null) {
                A01 = new C0608Im(context);
            }
            c0608Im = A01;
        }
        return c0608Im;
    ...
    public static boolean A0m(Context context) {
        return A0T(context).A2v(A0U(606, 44, Opcodes.LNEG), true);
    }
    ...
    public static boolean A0y(Context context) {
        return A0T(context).A2v(A0U(881, 35, Opcodes.LUSHR), false);
    }
    ...
    public static boolean A12(Context context) {
        return A0T(context).A2v(A0U(Opcodes.IINC, 25, 67), false);
    }
    ...
    public static boolean A1D(Context context) {
        return A0T(context).A2v(A0U(3145, 34, Opcodes.DREM), false);
    }
    ...
    public static boolean A1G(Context context) {
        return A0T(context).A2v(A0U(3379, 31, Opcodes.FNEG), false);
    }
    ...
    public static boolean A1O(Context context) {
        return A0T(context).A2v(A0U(3635, 31, Opcodes.FNEG), true);
    }
    ...
    public static boolean A1c(Context context) {
        return A0T(context).A2v(A0U(2150, 30, Opcodes.FNEG), false);
    }
    ...
    public static boolean A1m(Context context) {
        return A0T(context).A2v(A0U(1474, 45, Opcodes.LUSHR), true);
    }
    ...
    public static boolean A2m(Context context, boolean z2) {
        return A2o(context, z2) && A0T(context).A2v(A0U(2489, 27, 32), false);
    }

    public static boolean A2n(Context context, boolean z2) {
        return Build.VERSION.SDK_INT >= 21 && A2m(context, z2) && A0T(context).A2v(A0U(2516, 35, 70), true);
    }

    public static boolean A2o(Context context, boolean z2) {
        return z2 && Build.VERSION.SDK_INT >= 19 && A0T(context).A2v(A0U(2551, 24, 30), false);
    }
    ...
    public final boolean A2v(String str, boolean z2) {
        String string = this.A00.getString(str, String.valueOf(z2));
        if (string != null) {
            String value = A0U(5627, 4, 100);
            return string.equals(value) ? z2 : Boolean.parseBoolean(string);
        }
        return z2;
    }
}
