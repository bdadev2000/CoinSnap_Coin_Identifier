...
public final class C9Z extends VP {
    ...
    public AbstractC1187cD A03;
    public C03226f A04;
    public C02583r A05;
    public OT A06;
    public TV A07;
    public AbstractC0832Rj A08;
    public C0833Rk A09;
    public String A0A;
    public List<QK> A0B;
    public boolean A0C;
    ...
    public C9Z(C1045Zs c1045Zs, J7 j7, C03226f c03226f, MR mr, C0533Fk c0533Fk) {
        super(c1045Zs, j7, mr, c0533Fk);
        this.A0E = new C0688Lv();
        this.A0C = false;
        super.A07 = true;
        super.A06 = new C0799Qc(c1045Zs, new V5(), super.A0A.A0m(), mr);
        this.A04 = c03226f;
        this.A0D = c1045Zs;
    }

    public C9Z(C1045Zs c1045Zs, J7 j7, C03226f c03226f, MR mr, C0535Fm c0535Fm) {
        super(c1045Zs, j7, mr, c0535Fm);
        this.A0E = new C0688Lv();
        this.A0C = false;
        this.A04 = c03226f;
        this.A0D = c1045Zs;
    ...
    private AbstractC1187cD A00(Intent intent) {
        if (super.A07) {
            return (AbstractC1187cD) intent.getSerializableExtra(A0A(14, 25, 103));
        }
        return (AbstractC1187cD) intent.getSerializableExtra(A0A(0, 14, 36));
    }
    ...
    private final void A0E(int i2, Bundle bundle) {
        int extraSpacing;
        int i3;
        int height;
        ...
        int i4 = LP.A03.widthPixels;
        int i5 = LP.A03.heightPixels;
        if (i2 == 1) {
            extraSpacing = Math.min(i4 - (A0I * 4), i5 / 2);
            i3 = (i4 - extraSpacing) / 8;
            height = i3 * 4;
        } else {
            extraSpacing = i5 - ((A0L + A0H) + (A0I * 4));
            i3 = A0I;
            height = i3 * 2;
        }
        this.A08 = new TP(this);
        this.A09 = new C0833Rk(this, 1, new WeakReference(this.A08), this.A0D);
        this.A09.A0W(this.A00);
        this.A09.A0X(this.A01);
        this.A05 = new C02583r(this.A0D);
        this.A05.setLayoutParams(new RelativeLayout.LayoutParams(-1, -2));
        this.A07 = new TV(this.A05, i2, this.A0B, this.A09, bundle);
        int extraSpacing2 = i3;
        int childSpacing = extraSpacing;
        this.A05.setAdapter(new TQ(this.A0D, this.A0B, this.A03, super.A0C, this.A04, this.A09, this.A0E, getAudienceNetworkListener(), this.A0A, childSpacing, extraSpacing2, height, i2, this.A07, super.A0E));
        ...
        if (C0608Im.A1p(this.A0D)) {
            this.A0D.A0A().AHO(this.A05, super.A0A.A1U(), false);
        }
        A0V(this.A02, false, i2);
    }

    private void A0F(AbstractC1187cD abstractC1187cD) {
    ...
    @Override // com.instagram.common.viewpoint.core.VP, com.instagram.common.viewpoint.core.MS
