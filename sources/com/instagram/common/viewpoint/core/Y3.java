...
public final class Y3 implements D3 {
    ...
    private int A00(I3 i3) throws A0 {
        int A01 = i3.A01();
        Pair<Integer, Integer> config = AbstractC0580Hj.A02(i3, true);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00b4, code lost:
        ...
        if (r9.equals(r20.A0C) != false) goto L23;
     */
    ...
    */
    private void A08(com.instagram.common.viewpoint.core.I3 r21) throws com.instagram.common.viewpoint.core.A0 {
        /*
            Method dump skipped, instructions count: 308
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Y3.A08(com.facebook.ads.redexgen.X.I3):void");
    }

    private void A09(I3 i3, int i2) {
        int A03 = i3.A03();
        ...
        this.A0D.AFv(this.A0I, i2);
        this.A0D.AFw(this.A0B, 1, i2, 0, null);
        this.A0B += this.A0A;
    }
        ...
        while (i4.A04() > 0) {
            switch (this.A08) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    int min = Math.min(i4.A04(), this.A06 - this.A01);
                    byte[] bArr = this.A0H.A00;
                    int bytesToRead2 = this.A01;
                    i4.A0c(bArr, bytesToRead2, min);
    ...
    public final void A5B(InterfaceC0457Bz interfaceC0457Bz, DH dh) {
        dh.A05();
        this.A0D = interfaceC0457Bz.AHA(dh.A03(), 1);
        this.A0E = dh.A04();
    }
