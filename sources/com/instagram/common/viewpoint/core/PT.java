...
public final class PT extends FrameLayout {
    ...
    public EnumC0815Qs A00;
    public boolean A01;
    public boolean A02;
    public boolean A03;
    public boolean A04;
    public final AbstractC1187cD A05;
    public final C03226f A06;
    ...
    public final AbstractC0856Sh A0G;
    public final AbstractC0852Sd A0H;
    public final AbstractC0836Rn A0I;
    public final R9 A0J;
    public final R8 A0K;
    ...
    public PT(C1045Zs c1045Zs, J7 j7, AbstractC1187cD abstractC1187cD, C03226f c03226f, JF jf, MR mr, N9 n9, PS ps) {
        super(c1045Zs);
        ...
        this.A09 = mr;
        this.A0A = n9;
        this.A0D = new T7(c1045Zs);
        this.A0B = ps;
        this.A0D.setFunnelLoggingHandler(jf);
        this.A0D.getEventBus().A03(this.A0J, this.A0I, this.A0H, this.A0K, this.A0F, this.A0G);
        this.A0E = new C9S(c1045Zs, j7, this.A0D, abstractC1187cD.A1U());
        if (C0608Im.A1q(this.A07)) {
            this.A0C = new TC(c1045Zs, j7, this.A0D, abstractC1187cD.A1U(), this.A0E, null);
        } else {
            this.A0C = null;
        }
        A0B();
        ...
        String videoUrl = abstractC1187cD.A1P().A0E().A07();
        if (!TextUtils.isEmpty(videoUrl)) {
            AbstractC0746Ob.A00(c1045Zs, this, videoUrl);
        }
    ...
    public JSONObject A04(int i2) {
        ...
        try {
            jSONObject.put(A02(0, 11, 32), i2);
            jSONObject.put(A02(11, 8, 62), this.A0D.getDuration());
            jSONObject.put(A02(19, 5, Opcodes.FREM), this.A0D.A0i());
            jSONObject.put(A02(24, 12, Opcodes.LNEG), this.A0D.A0k());
            return jSONObject;
    ...
    private void A08() {
        this.A0D.postDelayed(new UD(this), C0608Im.A0M(this.A07));
    }

    private void A09() {
        this.A0D.postDelayed(new UC(this), C0608Im.A0N(this.A07));
    }
    ...
    public void A0H(C9O c9o) {
        if (this.A0D.getState() == EnumC0830Rh.A02 && C0608Im.A1U(this.A07)) {
    ...
    public final void A0N() {
        ...
        this.A0D.A0b(EnumC0815Qs.A02, 26);
        A08();
    }
    ...
    public final void A0T(boolean z2) {
        if (this.A0D.A0k() || this.A02 || this.A0D.getState() == EnumC0830Rh.A06 || this.A00 == null) {
            return;
        }
        if (!this.A01 || z2) {
    ...
    public final void A0V(boolean z2) {
        this.A0D.A0b(EnumC0815Qs.A04, 25);
    }
}
