...
public final class YF implements InterfaceC0455Bx {
    ...
    public final int AEk(InterfaceC0456By interfaceC0456By, C4 c4) throws IOException, InterruptedException {
        int read = interfaceC0456By.read(this.A03.A00, 0, 2786);
        if (read == -1) {
            return -1;
        }
        this.A03.A0Y(0);
        ...
        if (A05[1].length() == 16) {
            ...
            while (true) {
                ...
                if (headerPosition != 2935) {
                    ...
                    interfaceC0456By.A3s(validFramesCount);
                } else {
                    i2++;
