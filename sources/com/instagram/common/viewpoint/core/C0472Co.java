...
public final class C0472Co {
    public int A01;
    public boolean A02;
    public final C0473Cp A03 = new C0473Cp();
    ...
    */
    private int A00(int r5) {
        ...
        L1f:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0472Co.A00(int):int");
    }

    public final C0473Cp A01() {
        return this.A03;
    }
    ...
    public final boolean A05(InterfaceC0456By interfaceC0456By) throws IOException, InterruptedException {
        AbstractC0576Hf.A04(interfaceC0456By != null);
        if (this.A02) {
            this.A02 = false;
            this.A04.A0V();
        }
        while (!this.A02) {
            if (this.A00 < 0) {
                if (!this.A03.A03(interfaceC0456By, true)) {
                    return false;
                }
                int segmentIndex = 0;
                int i2 = this.A03.A01;
            ...
            if (A00 > 0) {
                ...
                interfaceC0456By.readFully(this.A04.A00, this.A04.A07(), A00);
