...
public class C1228cs implements C0S {
    ...
    public final AtomicReference<EnumC01680e> A08;
    ...
    private final void A03(JSONObject jSONObject) {
        ...
        try {
            ...
            EnumC01680e enumC01680e = this.A08.get();
            if (enumC01680e != null) {
                C0Z.A0I.A04(enumC01680e).A02(jSONObject);
            }
            int i2 = this.A02.get();
            String[] strArr = A0A;
            ...
            if (i2 != -1) {
                C0Z.A0J.A04(Integer.valueOf(i2)).A02(jSONObject);
            }
        } catch (Throwable th) {
            KQ.A00(th, this);
        }
    ...
    public C1228cs(C1226cq c1226cq) {
        this(c1226cq, UUID.randomUUID().toString());
    }

    public C1228cs(C1226cq c1226cq, String str) {
    ...
    private void A02(int i2, String str) {
        ...
        try {
            ...
            try {
                jSONObject.put(A00(97, 7, Opcodes.FREM) + C0Z.A0Y.getName(), str);
            } catch (JSONException unused) {
            }
            A03(jSONObject);
            this.A00.A00().AAN(i2, jSONObject);
        } catch (Throwable th) {
            KQ.A00(th, this);
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0S
    ...
    public final void AG4() {
        ...
        try {
            A04(C0V.A2x, C0Z.A0Y.A04(A00(Opcodes.FREM, 12, 35)));
        } catch (Throwable th) {
            KQ.A00(th, this);
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0S
    public final void AGg(EnumC01680e viewType) {
        if (KQ.A02(this)) {
            return;
        }
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.C0S
    public final void AHd(int i2, String error) {
        if (KQ.A02(this)) {
            return;
        }
        try {
