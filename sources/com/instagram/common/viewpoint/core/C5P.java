...
public final class C5P implements AdViewApi {
    ...
    public final C0515Ei A0A;
    public final EnumC0627Jj A0B;
    ...
    public C5P(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        ...
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            this.A08 = adView;
            this.A0A = C02925b.A08(context);
            this.A0A.A0E().A3E(AdPlacementType.BANNER.toString(), str);
            C02081t c02081t = new C02081t(str, LA.A05(this.A0B), AdPlacementType.BANNER, LA.A04(adSize), 1, new C1155bh());
            c02081t.A06(this.A05);
            c02081t.A07(this.A06);
            this.A03 = new C0532Fj(this.A0A, c02081t);
            this.A03.A0R(new C1084aV(this));
            return;
        }
        throw new IllegalArgumentException(A01(108, 6, 37));
    }

    public C5P(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws C0626Jh {
        this(context, str, A00(str2), adViewParentApi, adView);
        this.A0A.A0E().A49();
    }

    public static AdSize A00(String str) throws C0626Jh {
        EnumC0629Jl template = C0634Jq.A00(str);
        if (template != null) {
            C0634Jq.A03(template);
            return LA.A01(template);
        }
        throw new C0626Jh(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A01(67, 41, Opcodes.DREM), str));
    }
    ...
    public final C0532Fj A08() {
        return this.A03;
    }

    public final C0515Ei A09() {
        return this.A0A;
    }

    public final EnumC0627Jj A0A() {
        return this.A0B;
    }
    ...
    public final void destroy() {
        AbstractC0638Ju.A05(A01(Opcodes.FREM, 7, 45), A01(24, 19, 68), A01(16, 8, 6));
        this.A0A.A0E().A3F();
        if (this.A03 != null) {
            this.A03.A0X(true);
            this.A03.A0J();
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            if (o6 != null) {
                ...
                if (C0608Im.A16(adView.getContext())) {
                    this.A04.A07();
                    if (this.A01 != null) {
    ...
    public final boolean isAdInvalidated() {
        boolean z2 = this.A03 == null || this.A03.A0Y();
        this.A0A.A0E().A5E(z2);
        return z2;
    }
    ...
    public final void loadAd() {
        AbstractC0638Ju.A05(A01(Opcodes.LSHL, 6, 47), A01(43, 24, 116), A01(0, 8, 54));
        A03(null);
    }

    @Override // com.facebook.ads.internal.api.AdViewApi
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        AbstractC0638Ju.A05(A01(Opcodes.LSHL, 6, 47), A01(43, 24, 116), A01(8, 8, 59));
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A01 != null) {
            AbstractC0631Jn.A01(this.A07, this.A01, this.A0B);
        }
    }
    ...
    public final void setExtraHints(ExtraHints extraHints) {
        ...
        if (C0608Im.A0i(this.A0A) && this.A03 != null) {
