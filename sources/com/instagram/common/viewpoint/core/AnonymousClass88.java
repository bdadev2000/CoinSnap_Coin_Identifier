...
public final class AnonymousClass88 {
    ...
    public static int A00(String str, int i2, C7j c7j) {
        if ((A01(462, 7, 5).equals(str) && C8E.A20 == i2) || A01(422, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
    ...
    public static void A05(C7j c7j, int i2, int i3) {
        c7j.A07().AA0(A01(427, 10, 35), C8E.A2Z, new C8F(A01(338, 33, 12) + i2, A01(87, 9, 54) + i3));
    }

    @Deprecated
    public static void A06(C7j c7j, String str, int i2, C8F c8f) {
        if (c7j == null) {
            A0F(new RuntimeException(A01(48, 39, 37)));
            return;
        }
        AbstractC03457i.A01(c7j.A01());
        if (A02 && c8f.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 81) + str + A01(31, 16, 108) + i2, c8f));
        }
        try {
            if (A0J(c7j, str, i2, Math.random(), c8f)) {
                A09(c7j, str, i2, c8f);
            }
        } catch (Throwable th) {
            if (A05[7].length() == 7) {
    ...
    @Deprecated
    public static void A07(C7j c7j, String str, int i2, C8F c8f) {
        try {
            c8f.A05(2);
            c8f.A0A(false);
            c8f.A06(1);
    ...
    @Deprecated
    public static void A08(C7j c7j, String str, int i2, C8F c8f) {
        try {
            c8f.A05(2);
            c8f.A08(false);
            A06(c7j, str, i2, c8f);
    ...
    public static void A09(C7j c7j, String str, int i2, C8F c8f) {
        synchronized (AnonymousClass88.class) {
            if (!A03) {
                int A012 = Io.A01(c7j);
                int threshold = A09.getAndIncrement();
                if (threshold < A012 - 1) {
                    A07.add(new AnonymousClass89(str, i2, c8f));
                } else if (A09.get() == A012) {
                    A07.add(new AnonymousClass89(A01(427, 10, 35), C8E.A2W, new C8F(A01(Opcodes.F2L, 42, 70) + str + A01(47, 1, 91) + i2)));
                }
            } else {
                A0A(c7j, str, i2, c8f, true);
            }
        }
    }

    public static void A0A(C7j c7j, String str, int i2, C8F c8f, boolean z2) {
        AnonymousClass87 anonymousClass87 = A0B.get();
        boolean z3 = anonymousClass87 != null && anonymousClass87.A9f();
        boolean z4 = A08.get();
        String[] strArr = A05;
        ...
        if (z4 || z3) {
            ...
            if (A012 == 0) {
                Log.e(A013, A01(Opcodes.INVOKEVIRTUAL, 37, Opcodes.FREM) + str + A014 + i2, c8f);
            } else {
                Log.i(A013, A01(306, 32, 102) + str + A014 + i2 + A01(19, 12, 98) + c8f.getMessage() + A01(0, 19, 12) + c8f.A03());
            }
        }
        C1036Zj c1036Zj = new C1036Zj(c7j, str, i2, c8f, anonymousClass87);
        if (z2) {
            A01.execute(c1036Zj);
        } else {
            c1036Zj.run();
    ...
    public static void A0C(C1044Zr c1044Zr, AnonymousClass87 anonymousClass87, AnonymousClass86 anonymousClass86, boolean z2) {
        ...
        synchronized (AnonymousClass88.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1037Zk(c1044Zr));
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x0175, code lost:
        ...
        r0 = com.instagram.common.viewpoint.core.Io.A0A(r13);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:102:0x017b, code lost:
        ...
        com.instagram.common.viewpoint.core.AnonymousClass88.A0C.set(true);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:107:0x018c, code lost:
        ...
        r7 = r7 * r2;
        r2 = com.instagram.common.viewpoint.core.AnonymousClass88.A05;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x01da, code lost:
        ...
        if (com.instagram.common.viewpoint.core.AnonymousClass88.A05[7].length() == 7) goto L127;
     */
    /* JADX WARN: Code restructure failed: missing block: B:79:0x01dc, code lost:
    
        com.instagram.common.viewpoint.core.AnonymousClass88.A05[0] = "IU4RZwbJxJdQMYPPezGzztuufFdsMCjm";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x0164, code lost:
        ...
        r0 = com.instagram.common.viewpoint.core.AnonymousClass88.A0C.get();
     */
    ...
    */
    public static boolean A0J(com.instagram.common.viewpoint.core.C7j r13, java.lang.String r14, int r15, double r16, com.instagram.common.viewpoint.core.C8F r18) {
        /*
            Method dump skipped, instructions count: 633
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass88.A0J(com.facebook.ads.redexgen.X.7j, java.lang.String, int, double, com.facebook.ads.redexgen.X.8F):boolean");
    }

    public static boolean A0K(C7j c7j, String str, int i2, C8F c8f) {
        if (!Io.A0P(c7j)) {
            return true;
        }
        ...
        if (c8f.A02() != -1) {
            ...
            int currentCounter = A00(str, i2, c7j);
