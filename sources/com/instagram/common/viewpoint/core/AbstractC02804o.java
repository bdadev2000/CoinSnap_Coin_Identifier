...
public abstract class AbstractC02804o {
    ...
    public int A0C;
    public int A0D;
    public final AnonymousClass59 A0G = new C1099al(this);
    public final AnonymousClass59 A0H = new C1098ak(this);
    ...
    public abstract int A1d(int i2, C02874w c02874w, AnonymousClass53 anonymousClass53);

    public abstract int A1e(int i2, C02874w c02874w, AnonymousClass53 anonymousClass53);
    ...
    public abstract View A1n(View view, int i2, C02874w c02874w, AnonymousClass53 anonymousClass53);

    public abstract C02814p A1o();

    public abstract void A1p(int i2);

    public abstract void A1q(int i2, int i3, AnonymousClass53 anonymousClass53, InterfaceC02784m interfaceC02784m);

    public abstract void A1r(int i2, InterfaceC02784m interfaceC02784m);

    public abstract void A1s(Parcelable parcelable);

    public abstract void A1u(C02874w c02874w, AnonymousClass53 anonymousClass53);

    public abstract void A1x(FL fl, AnonymousClass53 anonymousClass53, int i2);
    ...
    public static int A00(int i2, int i3, int i4) {
        ...
        switch (mode) {
            ...
            case Ints.MAX_POWER_OF_TWO /* 1073741824 */:
                return size;
            default:
                int mode3 = Math.max(i3, i4);
                return mode3;
        }
    }

    public static int A01(int i2, int i3, int i4, int i5, boolean z2) {
        ...
        if (z2) {
            ...
            i6 = max;
            resultMode = (i3 == Integer.MIN_VALUE || i3 == 1073741824) ? Integer.MIN_VALUE : 0;
        }
        int size = View.MeasureSpec.makeMeasureSpec(i6, resultMode);
        return size;
    }

    private final int A02(View view) {
        return ((C02814p) view.getLayoutParams()).A03.bottom;
    }

    private final int A03(View view) {
        return ((C02814p) view.getLayoutParams()).A03.left;
    }

    private final int A04(View view) {
        return ((C02814p) view.getLayoutParams()).A03.right;
    }

    private final int A05(View view) {
        return ((C02814p) view.getLayoutParams()).A03.top;
    }

    private final int A06(C02874w c02874w, AnonymousClass53 anonymousClass53) {
        return 0;
    }
    ...
    private final void A0B(int i2, int i3) {
        ...
        throw new IllegalArgumentException(A07(85, 44, 81) + i2 + this.A03.toString());
    }
    ...
    private final void A0E(View view, int i2) {
        A0F(view, i2, (C02814p) view.getLayoutParams());
    }

    private final void A0F(View view, int i2, C02814p c02814p) {
        ...
        this.A01.A0H(view, i2, c02814p, A0F.A0a());
    }

    private void A0G(View view, int i2, boolean z2) {
        AnonymousClass56 A0F = FL.A0F(view);
        if (z2 || A0F.A0a()) {
            this.A03.A0t.A09(A0F);
        } else {
        ...
        if (A0F.A0g() || A0F.A0b()) {
            ...
            if (parent == fl) {
                ...
                if (currentIndex != -1) {
                    if (currentIndex != i2) {
                        this.A03.A06.A0B(currentIndex, i2);
                    }
                } else {
    ...
    private void A0J(C02874w c02874w, int i2, View view) {
        AnonymousClass56 A0F = FL.A0F(view);
        if (A0F.A0f()) {
            return;
        }
    ...
    private final void A0K(C02874w c02874w, AnonymousClass53 anonymousClass53, AccessibilityEvent accessibilityEvent) {
    ...
    */
    private final void A0L(com.instagram.common.viewpoint.core.C02874w r6, com.instagram.common.viewpoint.core.AnonymousClass53 r7, com.instagram.common.viewpoint.core.C02593s r8) {
        /*
            r5 = this;
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.AbstractC02804o.A0J
            r0 = 3
            r1 = r1[r0]
            r0 = 19
            ...
            if (r1 == r0) goto L8e
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC02804o.A0J
        ...
        L63:
            ...
            int r0 = r5.A06(r6, r7)
            com.facebook.ads.redexgen.X.3p r0 = com.instagram.common.viewpoint.core.C02563p.A00(r3, r2, r1, r0)
            r8.A0P(r0)
            return
        L7b:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC02804o.A0J
        ...
        L8e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC02804o.A0L(com.facebook.ads.redexgen.X.4w, com.facebook.ads.redexgen.X.53, com.facebook.ads.redexgen.X.3s):void");
    }
    ...
    public static boolean A0O(int i2, int i3, int i4) {
    ...
    private final boolean A0P(C02874w c02874w, AnonymousClass53 anonymousClass53) {
        return false;
    }

    private final boolean A0Q(C02874w c02874w, AnonymousClass53 anonymousClass53, int i2, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
        ...
        this.A03.scrollBy(i3, hScroll);
        return true;
    }

    private final boolean A0R(C02874w c02874w, AnonymousClass53 anonymousClass53, View view, int i2, Bundle bundle) {
        return false;
    }

    private boolean A0S(FL fl, int i2, int i3) {
        ...
        if (rect.left - i2 >= parentTop2 || rect.right - i2 <= parentBottom || rect.top - i3 >= parentLeft2 || rect.bottom - i3 <= parentRight) {
            return false;
        }
        return true;
    }
    ...
    public final int A0l(View view) {
        Rect rect = ((C02814p) view.getLayoutParams()).A03;
    ...
    public int A0q(C02874w c02874w, AnonymousClass53 anonymousClass53) {
    ...
    public int A0r(C02874w c02874w, AnonymousClass53 anonymousClass53) {
    ...
    public C02814p A0v(Context context, AttributeSet attributeSet) {
        return new C02814p(context, attributeSet);
    }

    public C02814p A0w(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof C02814p) {
            return new C02814p((C02814p) layoutParams);
        }
        if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
            return new C02814p((ViewGroup.MarginLayoutParams) layoutParams);
        }
        return new C02814p(layoutParams);
    }
    ...
    public final void A12(int i2, int i3) {
        ...
        this.A03.A0p.set(i4, i5, maxY, maxX);
        A15(this.A03.A0p, i2, i3);
    }
    ...
    public final void A14(int i2, C02874w c02874w) {
        View view = A0t(i2);
        A0A(i2);
        c02874w.A0T(view);
    }
    ...
    public void A15(Rect rect, int i2, int i3) {
        ...
        int usedWidth = A0g();
        int i4 = height + usedWidth;
        int usedWidth2 = A0d();
        int width = i4 + usedWidth2;
        int usedWidth3 = A0c();
        int usedHeight2 = A00(i2, usedHeight, usedWidth3);
        int usedWidth4 = A0b();
        A13(usedHeight2, A00(i3, width, usedWidth4));
    }
    ...
    public final void A1A(View view, int i2, int i3) {
        ...
        int i4 = i2 + A1D.left + A1D.right;
        int i5 = i3 + A1D.top + A1D.bottom;
        int A01 = A01(A0h(), A0i(), A0e() + A0f() + c02814p.leftMargin + c02814p.rightMargin + i4, c02814p.width, A20());
        int A0X = A0X();
        int A0Y = A0Y();
        int widthSpec = A0g();
        int A012 = A01(A0X, A0Y, widthSpec + A0d() + c02814p.topMargin + c02814p.bottomMargin + i5, c02814p.height, A21());
        if (A1W(view, A01, A012, c02814p)) {
    ...
    public final void A1B(View view, int i2, int i3, int i4, int i5) {
        ...
        view.layout(rect.left + i2 + c02814p.leftMargin, rect.top + i3 + c02814p.topMargin, (i4 - rect.right) - c02814p.rightMargin, (i5 - rect.bottom) - c02814p.bottomMargin);
    }

    public final void A1C(View view, C02593s c02593s) {
        AnonymousClass56 A0F = FL.A0F(view);
        if (A0F != null) {
            boolean A0a = A0F.A0a();
            if (A0J[4].charAt(12) == 'v') {
            ...
            if (!A0a && !this.A01.A0K(A0F.A0H)) {
                A1K(this.A03.A0r, this.A03.A0s, view, c02593s);
            }
        }
    }

    public final void A1D(View view, C02874w c02874w) {
        A0D(view);
        c02874w.A0T(view);
    }
    ...
    public final void A1E(View view, boolean z2, Rect rect) {
        Matrix matrix;
        if (z2) {
            Rect rect2 = ((C02814p) view.getLayoutParams()).A03;
    ...
    public final void A1F(C02593s c02593s) {
        A0L(this.A03.A0r, this.A03.A0s, c02593s);
    }

    public final void A1G(C02874w c02874w) {
        int A0E = c02874w.A0E();
        for (int i2 = A0E - 1; i2 >= 0; i2--) {
            View A0F = c02874w.A0F(i2);
    ...
    public final void A1H(C02874w c02874w) {
        int childCount = A0W();
        for (int i2 = childCount - 1; i2 >= 0; i2--) {
            A0J(c02874w, i2, A0t(i2));
        }
    }

    public final void A1I(C02874w c02874w) {
    ...
    public void A1J(C02874w c02874w, AnonymousClass53 anonymousClass53, int i2, int i3) {
        this.A03.A1a(i2, i3);
    }

    public void A1K(C02874w c02874w, AnonymousClass53 anonymousClass53, View view, C02593s c02593s) {
        C02573q itemInfo = C02573q.A00(A21() ? A0p(view) : 0, 1, A20() ? A0p(view) : 0, 1, false, false);
        c02593s.A0Q(itemInfo);
    }
    ...
    public final void A1O(FL fl) {
        A11(View.MeasureSpec.makeMeasureSpec(fl.getWidth(), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec(fl.getHeight(), Ints.MAX_POWER_OF_TWO));
    }
    ...
    public final void A1Q(FL fl, C02874w c02874w) {
        this.A07 = false;
        A1w(fl, c02874w);
    }
    ...
    public final boolean A1V(int i2, Bundle bundle) {
        return A0Q(this.A03.A0r, this.A03.A0s, i2, bundle);
    }

    public final boolean A1W(View view, int i2, int i3, C02814p c02814p) {
        if (!view.isLayoutRequested()) {
            ...
            if (z2 && A0O(view.getWidth(), i2, c02814p.width) && A0O(view.getHeight(), i3, c02814p.height)) {
                return false;
            }
        }
        return true;
    ...
    public final boolean A1X(View view, int i2, Bundle bundle) {
        return A0R(this.A03.A0r, this.A03.A0s, view, i2, bundle);
    }

    public boolean A1Y(C02814p c02814p) {
        return c02814p != null;
    }

    public final boolean A1Z(FL fl, View view, Rect rect, boolean z2) {
        return A1a(fl, view, rect, z2, false);
    }

    public final boolean A1a(FL fl, View view, Rect rect, boolean z2, boolean z3) {
        int[] scrollAmount = A0U(view, rect);
        int i2 = scrollAmount[0];
        int i3 = scrollAmount[1];
        if ((z3 && !A0S(fl, i2, i3)) || (i2 == 0 && i3 == 0)) {
            return false;
        }
        if (z2) {
            fl.scrollBy(i2, i3);
    ...
    public final boolean A1c(FL fl, ArrayList<View> views, int i2, int i3) {
        return false;
    }

    public View A1m(int i2) {
        int A0W = A0W();
        for (int i3 = 0; i3 < A0W; i3++) {
            ...
            if (A0F != null) {
                ...
                if (childCount == i2 && !A0F.A0f() && (this.A03.A0s.A07() || !A0F.A0a())) {
                    return child;
                }
            }
        }
    ...
    public void A1w(FL fl, C02874w c02874w) {
    }
