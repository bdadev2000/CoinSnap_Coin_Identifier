...
public final class C1193cJ extends AbstractC01800r {
    ...
    public C1193cJ(C1045Zs c1045Zs, AbstractC01810s abstractC01810s, C0833Rk c0833Rk, C1204cU c1204cU) {
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        boolean z2 = false;
        jSONObject.putOpt(A01(100, 6, 87), String.format(Locale.US, A01(Opcodes.ARETURN, 12, 33), Integer.valueOf(view.getTop()), Integer.valueOf(view.getLeft())));
        jSONObject.putOpt(A01(120, 4, 99), String.format(Locale.US, A01(Opcodes.IF_ICMPLE, 12, 101), Integer.valueOf(view.getHeight()), Integer.valueOf(view.getWidth())));
        if (this.A06 != null && this.A06.contains(view)) {
            z2 = true;
        }
        jSONObject.putOpt(A01(25, 9, 12), Boolean.valueOf(z2));
        String A01 = A01(Opcodes.D2F, 7, 5);
        if (view instanceof Button) {
            A01 = A01(14, 6, 86);
        } else if (view instanceof TextView) {
            A01 = A01(Opcodes.IINC, 4, 69);
        } else if (view instanceof ImageView) {
            A01 = A01(47, 5, 103);
        } else {
            boolean z3 = view instanceof MediaView;
        ...
        jSONObject.putOpt(A01(Opcodes.L2I, 4, Opcodes.FREM), A01);
        if (view instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) view;
            JSONArray list = new JSONArray();
            for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                JSONObject data = A04(viewGroup.getChildAt(i2));
                list.put(data);
            }
    ...
    public final void A06(Map<String, String> map) {
        ...
        if (this.A00 != null && this.A0D.A0T()) {
            ...
            String A01 = A01(Opcodes.DCMPL, 4, 30);
            if (A0F[5].charAt(12) != 'y') {
                throw new RuntimeException();
            }
        ...
        if (this.A09) {
            map.put(A01(Opcodes.F2L, 4, 60), Boolean.TRUE.toString());
        }
        if (this.A01 != null) {
