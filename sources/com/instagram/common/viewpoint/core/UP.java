...
public final class UP extends AbstractC0753Oi {
    ...
    public final C0757Om A0C;
    public final AbstractC0858Sj A0D;
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(A05)) {
            MB mb = MB.RATINGS;
            AbstractC1187cD A04 = this.A0C.A04();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(mb, A04.A1P().A0F().A05());
    ...
    private final RelativeLayout A02(String str, int i2, MB mb) {
        ...
        M3.A0S(relativeLayout, M3.A06(i2, A0G));
    ...
    private TextView A03(String str, boolean z2, int i2, int i3, int i4) {
        TextView textView = new TextView(this.A0B);
        textView.setText(str);
        textView.setTextColor(i3);
        M3.A0Y(textView, z2, i2);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.setMargins(A0K, 0, A0K, i4);
    ...
    private void A08() {
        ...
        AbstractC0746Ob.A00(this.A0C.A05(), this, this.A0C.A04().A1P().A0E().A07());
        ...
        this.A04.A0b(EnumC0815Qs.A02, 20);
    ...
    private void A0A(int i2) {
        int height;
        int width;
        this.A06.setOrientation(i2 == 1 ? 1 : 0);
        ...
        setRewardDescContainerVisibility(i2);
    }
    ...
    private void A0C(int i2) {
        ...
        layoutParams.weight = i2 == 1 ? 3.0f : 1.0f;
    ...
    private void setRewardDescContainerVisibility(int i2) {
        if (i2 == 1) {
