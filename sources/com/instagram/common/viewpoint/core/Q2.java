...
public final class Q2 extends RelativeLayout {
    ...
    public Q2(C1045Zs c1045Zs, C1Z c1z, C1M c1m, ViewOnClickListenerC0909Ui viewOnClickListenerC0909Ui, String str, View.OnClickListener onClickListener) {
        super(c1045Zs);
        this.A04 = c1045Zs;
        this.A03 = c1z;
        this.A02 = c1m;
        ...
        this.A06 = new C0745Oa(this.A04, C1O.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC0746Ob.A00(this.A04, this, this.A03.A01());
        ...
        new AsyncTaskC0914Un(this.A05, this.A04).A04().A07(this.A03.A01());
