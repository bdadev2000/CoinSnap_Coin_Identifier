...
public class C1036Zj extends KY {
    ...
    public C1036Zj(C7j c7j, String str, int i2, C8F c8f, AnonymousClass87 anonymousClass87) {
        this.A01 = c7j;
        this.A04 = str;
        this.A00 = i2;
        this.A03 = c8f;
    ...
    public final void A06() {
        ...
        try {
            ...
            if (cause != null) {
                str = AbstractC0678Ll.A03(this.A01, cause);
            } else if (Io.A0R(this.A01)) {
                C7j c7j = this.A01;
                Throwable deLogExceptionCause = this.A03;
                str = AbstractC0678Ll.A03(c7j, deLogExceptionCause);
            } else {
            ...
            A59.put(A00(Opcodes.L2I, 7, 19), this.A04);
            A59.put(A00(Opcodes.D2L, 12, 30), String.valueOf(this.A00));
