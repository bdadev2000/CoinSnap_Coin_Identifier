...
public abstract class AbstractC1245d9 {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C1243d7.A07(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i3 >= length) {
                ...
                C1243d7.A06(objArr, A002);
                i2 = i3;
            } else {
                if (!it.hasNext()) {
                    Object[] copyOf = Arrays.copyOf(objArr, i3);
                    C1243d7.A06(copyOf, A002);
                    return copyOf;
                }
                i2 = i3;
            }
                ...
                if (!it.hasNext()) {
                    ...
                    if (size$iv != $i$f$toArrayImpl2) {
                        ...
                        if (size <= length) {
                            ...
                            C1243d7.A05(newInstance, A00(21, 62, 11));
