...
public abstract class AnonymousClass57 {
    ...
    public static int A00(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC02804o abstractC02804o, boolean z2) {
        if (abstractC02804o.A0W() == 0) {
            return 0;
        }
        ...
        if (!z2) {
            return Math.abs(abstractC02804o.A0p(view) - abstractC02804o.A0p(view2)) + 1;
        }
    ...
    public static int A01(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC02804o abstractC02804o, boolean z2) {
        if (abstractC02804o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z2) {
        ...
        int A0C = c4y.A0C(view2) - c4y.A0F(view);
        int A0p = abstractC02804o.A0p(view);
        int laidOutArea = abstractC02804o.A0p(view2);
        float abs = A0C / (Math.abs(A0p - laidOutArea) + 1);
        int laidOutArea2 = anonymousClass53.A03();
        return (int) (abs * laidOutArea2);
    }

    public static int A02(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC02804o abstractC02804o, boolean z2, boolean z3) {
        int laidOutArea;
        if (abstractC02804o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        int maxPosition = Math.min(abstractC02804o.A0p(view), abstractC02804o.A0p(view2));
        int A0p = abstractC02804o.A0p(view);
        int minPosition = abstractC02804o.A0p(view2);
        ...
        int itemsBefore2 = abstractC02804o.A0p(view);
        int minPosition4 = abstractC02804o.A0p(view2);
