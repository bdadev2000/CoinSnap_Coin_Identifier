...
public abstract class AbstractC1235cz implements C0B {
    ...
    public static String A03(int i2, int i3, int i4) {
        ...
        while (true) {
            ...
            byte b2 = (byte) ((copyOfRange[i5] - i4) - 56);
            if (A02[7].length() == 15) {
                throw new RuntimeException();
            }
    ...
    static {
        A04();
        A03 = AbstractC1235cz.class.getSimpleName();
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0B
    public void AH9(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC1235cz.this.A06(this.A00);
                return null;
            }
        });
    }
