...
public final class Z3 implements InterfaceC0427At {
    ...
    public boolean A0b;
    public byte[] A0c;
    public InterfaceC0414Ag[] A0d;
    public ByteBuffer[] A0e;
    public final ConditionVariable A0f;
    public final AZ A0g;
    public final C0433Az A0h;
    public final Z6 A0i;
    public final B2 A0j;
    public final C1024Yx A0k;
    public final ArrayDeque<B4> A0l;
    public final boolean A0m;
    public final InterfaceC0414Ag[] A0n;
    public final InterfaceC0414Ag[] A0o;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x0192, code lost:
        ...
        com.instagram.common.viewpoint.core.AbstractC0576Hf.A04(r4);
        r10.A02 = com.instagram.common.viewpoint.core.IK.A06(r2 * 4, ((int) A07(250000)) * r10.A09, (int) java.lang.Math.max(r2, A07(750000) * r10.A09));
     */
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 18 out of bounds for length 18
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A4l(int r11, int r12, int r13, int r14, int[] r15, int r16, int r17) throws com.instagram.common.viewpoint.core.C0423Ap {
        /*
            Method dump skipped, instructions count: 520
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Z3.A4l(int, int, int, int, int[], int, int):void");
    }
    ...
    public Z3(AZ az, B2 b2, boolean z2) {
        this.A0g = az;
        this.A0j = (B2) AbstractC0576Hf.A01(b2);
        this.A0m = z2;
        this.A0f = new ConditionVariable(true);
        this.A0h = new C0433Az(new Z4(this, null));
        this.A0i = new Z6();
        this.A0k = new C1024Yx();
        ArrayList arrayList = new ArrayList();
        Collections.addAll(arrayList, new Z0(), this.A0i, this.A0k);
        Collections.addAll(arrayList, b2.A6S());
        this.A0o = (InterfaceC0414Ag[]) arrayList.toArray(new InterfaceC0414Ag[arrayList.size()]);
        this.A0n = new InterfaceC0414Ag[]{new Z2()};
        this.A00 = 1.0f;
        this.A0D = 0;
        this.A0Q = AY.A04;
        this.A01 = 0;
        this.A0P = A2.A05;
        this.A04 = -1;
        this.A0d = new InterfaceC0414Ag[0];
        this.A0e = new ByteBuffer[0];
        this.A0l = new ArrayDeque<>();
    }

    public Z3(AZ az, InterfaceC0414Ag[] interfaceC0414AgArr) {
        this(az, interfaceC0414AgArr, false);
    }

    public Z3(AZ az, InterfaceC0414Ag[] interfaceC0414AgArr, boolean z2) {
        this(az, new Z5(interfaceC0414AgArr), z2);
    }
    ...
    public static int A00(int i2, ByteBuffer byteBuffer) {
        ...
        throw new IllegalStateException(A0I(84, 27, 82) + i2);
    }
    ...
    private long A06(long j2) {
        ...
        if (b4 != null) {
            this.A0P = B4.A02(b4);
            this.A0G = B4.A00(b4);
            this.A0F = B4.A01(b4) - this.A0H;
        }
        if (this.A0P.A01 == 1.0f) {
            return (this.A0F + j2) - this.A0G;
        }
        if (this.A0l.isEmpty()) {
            return this.A0F + this.A0j.A7m(j2 - this.A0G);
        }
        return this.A0F + IK.A0C(j2 - this.A0G, this.A0P.A01);
    }
    ...
    private AudioTrack A0E() throws C0424Aq {
        ...
        throw new C0424Aq(state, this.A0A, this.A07, this.A02);
    }
    ...
    */
    private void A0J() {
        ...
        L18:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Z3.A0J():void");
    }

    private void A0K() throws C0424Aq {
        A2 a2;
        this.A0f.block();
        this.A0M = A0E();
        ...
        if (this.A0V) {
            a2 = this.A0j.A3x(this.A0P);
        } else {
            a2 = A2.A05;
        }
        this.A0P = a2;
        A0N();
        C0433Az c0433Az = this.A0h;
        AudioTrack audioTrack = this.A0M;
        int i2 = this.A08;
        int i3 = this.A09;
        int audioSessionId4 = this.A02;
        c0433Az.A0G(audioTrack, i2, i3, audioSessionId4);
        A0M();
    }
    ...
    private void A0N() {
        ArrayList arrayList = new ArrayList();
        for (InterfaceC0414Ag interfaceC0414Ag : A0V()) {
            String[] strArr = A0s;
            ...
            if (interfaceC0414Ag.A9L()) {
                arrayList.add(interfaceC0414Ag);
            } else {
                interfaceC0414Ag.flush();
            }
        }
        int count = arrayList.size();
        this.A0d = (InterfaceC0414Ag[]) arrayList.toArray(new InterfaceC0414Ag[count]);
        this.A0e = new ByteBuffer[count];
        A0J();
    }

    private void A0P(long j2) throws C0426As {
        ByteBuffer input;
        ...
        while (i2 >= 0) {
            if (i2 > 0) {
                ...
                input = this.A0T != null ? this.A0T : InterfaceC0414Ag.A00;
            }
            if (i2 == length) {
                A0S(input, j2);
            } else {
                InterfaceC0414Ag interfaceC0414Ag = this.A0d[i2];
                interfaceC0414Ag.AEi(input);
                ByteBuffer A7u = interfaceC0414Ag.A7u();
                this.A0e[i2] = A7u;
                if (A7u.hasRemaining()) {
                    i2++;
                }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0S(java.nio.ByteBuffer r11, long r12) throws com.instagram.common.viewpoint.core.C0426As {
        /*
            r10 = this;
            r6 = r11
        ...
        L18:
            int r7 = r6.remaining()
            r4 = 0
            int r0 = com.instagram.common.viewpoint.core.IK.A02
            if (r0 >= r3) goto L6c
        ...
        L6c:
            ...
            if (r0 == 0) goto L85
        L7a:
            com.instagram.common.viewpoint.core.AbstractC0576Hf.A04(r5)
        ...
        Lb7:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Z3.A0S(java.nio.ByteBuffer, long):void");
    }

    private boolean A0T() throws C0426As {
        boolean z2 = false;
        if (this.A04 == -1) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                InterfaceC0414Ag audioProcessor = this.A0d[this.A04];
                if (z2) {
                    audioProcessor.AEh();
                }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final void A5s(int i2) {
        AbstractC0576Hf.A04(IK.A02 >= 21);
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final long A72(boolean z2) {
        if (!A0U()) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final boolean A8p(ByteBuffer byteBuffer, long j2) throws C0424Aq, C0426As {
        AbstractC0576Hf.A03(this.A0T == null || byteBuffer == this.A0T);
        if (!A0U()) {
            A0K();
            if (this.A0Y) {
                AEV();
        ...
        if (byteBuffer2 == null) {
            ...
            if (this.A0O != null) {
                ...
                A2 a2 = this.A0O;
                this.A0O = null;
                this.A0l.add(new B4(this.A0j.A3x(a2), Math.max(0L, j2), A08(A04()), null));
                A0N();
            }
            if (this.A0D == 0) {
                ...
                if (this.A0D == 1 && Math.abs(expectedPresentationTimeUs - j2) > 200000) {
                    Log.e(A0I, A0I(16, 33, 37) + expectedPresentationTimeUs + A0I(0, 6, 72) + j2 + A0I(Opcodes.L2D, 1, 23));
                    this.A0D = 2;
                }
                if (this.A0D == 2) {
                    ...
                    this.A0D = 1;
                    if (this.A0R != null) {
                        InterfaceC0425Ar interfaceC0425Ar = this.A0R;
                        String[] strArr = A0s;
                        if (strArr[3].length() != strArr[4].length()) {
                            throw new RuntimeException();
                        }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final boolean A9P(int i2) {
        if (IK.A0c(i2)) {
            return i2 != 4 || IK.A02 >= 21;
        }
        if (this.A0g != null) {
            boolean A04 = this.A0g.A04(i2);
            String[] strArr = A0s;
            if (strArr[2].length() == strArr[0].length()) {
                throw new RuntimeException();
            }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final void AEW() throws C0426As {
        if (!this.A0W && A0U() && A0T()) {
            this.A0h.A0F(A04());
            this.A0M.stop();
            this.A03 = 0;
    ...
    public final void AEy() {
        reset();
        A0L();
        for (InterfaceC0414Ag interfaceC0414Ag : this.A0o) {
            interfaceC0414Ag.reset();
        }
        for (InterfaceC0414Ag interfaceC0414Ag2 : this.A0n) {
            interfaceC0414Ag2.reset();
        }
        this.A01 = 0;
        this.A0Y = false;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0427At
    public final void AGU(InterfaceC0425Ar interfaceC0425Ar) {
        this.A0R = interfaceC0425Ar;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0076, code lost:
        ...
        r7.A0h.A0D();
        r7.A0f.close();
        new com.instagram.common.viewpoint.core.B0(r7, r1).start();
     */
    ...
    */
    public final void reset() {
        /*
            ...
            com.facebook.ads.redexgen.X.A2 r0 = r7.A0O
            r7.A0P = r0
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.Z3.A0s
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        Lb4:
            ...
            com.facebook.ads.redexgen.X.B4 r0 = (com.instagram.common.viewpoint.core.B4) r0
            com.facebook.ads.redexgen.X.A2 r0 = com.instagram.common.viewpoint.core.B4.A02(r0)
            r7.A0P = r0
            goto L3c
        Lcc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Z3.reset():void");
    }
