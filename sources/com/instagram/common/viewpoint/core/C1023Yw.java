...
public class C1023Yw extends BC {
    ...
    public C1023Yw(int i2) {
        this.A03 = i2;
    }

    public static C1023Yw A02() {
        return new C1023Yw(0);
    }
    ...
    private ByteBuffer A04(int i2) {
        ...
        throw new IllegalStateException(A03(4, 18, 28) + (this.A01 == null ? 0 : this.A01.capacity()) + A03(0, 3, 76) + i2 + A03(3, 1, 101));
    }
    ...
    public final boolean A0A() {
        return A06(Ints.MAX_POWER_OF_TWO);
    }
