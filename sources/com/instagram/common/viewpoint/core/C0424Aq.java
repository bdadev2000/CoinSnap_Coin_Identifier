...
public final class C0424Aq extends Exception {
    ...
    */
    public C0424Aq(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0424Aq.<init>(int, int, int, int):void");
    }
}
