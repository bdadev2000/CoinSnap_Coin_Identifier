...
public class C9E {
    ...
    public C9E(RandomAccessFile randomAccessFile, long[] jArr, long j2) throws IOException {
        ...
        for (int i3 = this.A00; i3 < jArr.length; i3++) {
            if (jArr[i3] != 0) {
                throw new IOException(String.format(Locale.US, A05(257, 66, 57), Integer.valueOf(i3), Integer.valueOf(this.A00), Long.valueOf(jArr[i3])));
            }
        }
        for (int i4 = 1; i4 < this.A00; i4++) {
            if (jArr[i4 - 1] > jArr[i4]) {
                throw new IOException(String.format(Locale.US, A05(207, 50, 76), Integer.valueOf(i4 - 1), Long.valueOf(jArr[i4 - 1]), Integer.valueOf(i4), Long.valueOf(jArr[i4])));
            }
        }
        if (this.A00 > 0 && jArr[this.A00 - 1] > j2) {
            throw new IOException(String.format(Locale.US, A05(323, 50, Opcodes.LNEG), Integer.valueOf(this.A00 - 1), Long.valueOf(jArr[this.A00 - 1]), Long.valueOf(j2)));
        }
    }
