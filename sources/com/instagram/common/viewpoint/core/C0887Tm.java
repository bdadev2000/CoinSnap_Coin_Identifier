...
public final class C0887Tm extends FrameLayout implements MS {
    ...
    public boolean A08;
    public boolean A09;
    public final C1185cB A0A;
    public final C5W A0B;
    public final C03226f A0C;
    public final C1045Zs A0D;
    public final J7 A0E;
    public final JF A0F;
    public final ViewOnSystemUiVisibilityChangeListenerC0683Lq A0G;
    public final MR A0H;
     ...
     */
    private U6 A08(boolean z2, int i2) {
        C0889To c0889To = new C0889To(this, i2);
        AbstractC1187cD A1N = this.A0A.A1N(this.A00);
        boolean z3 = this.A0A.A1V() && this.A00 > 0;
        C1185cB c1185cB = this.A0A;
        String[] strArr = A0M;
        ...
        boolean z4 = c1185cB.A1U() && this.A00 > 0;
        String A1P = this.A0A.A1P();
        if (!A0V(A1N)) {
            if (A1N.A1P().A0P()) {
                this.A0D.A0E().AGg(EnumC01680e.A07);
                this.A0D.A0E().AGL(this.A00);
                this.A0D.A0E().A4Z(A1P);
                return new A6(this.A0D, this.A0E, this.A0I, A1N, this.A0C, this.A0J, this.A00, this.A0H, this.A0F, i2, z3, z4, c0889To);
            }
            this.A0D.A0E().AGg(EnumC01680e.A07);
            this.A0D.A0E().AGL(this.A00);
            this.A0D.A0E().A4Z(A1P);
            return new C0409Ab(this.A0D, this.A0E, A1N, this.A0C, this.A0J, this.A00, this.A0H, this.A0F, this.A0A.A0S(), i2, this.A0A.A1J(), z2, this.A0A.A1L(), this.A0A.A1W(), z3, z4, c0889To);
        }
        int i3 = this.A00;
        String[] strArr3 = A0M;
        ...
        this.A0D.A0E().AGg(EnumC01680e.A06);
        this.A0D.A0E().AGL(this.A00);
        this.A0D.A0E().A4Z(A1P);
        return new B8(this.A0D, this.A0J, this.A00, this.A0E, A1N, this.A0H, this.A0I, z3, z4, c0889To, A01);
    }
    ...
    public C0887Tm(C1045Zs c1045Zs, N9 n9, J7 j7, C1185cB c1185cB, C03226f c03226f, MR mr) {
        super(c1045Zs);
        ...
        this.A0G = new ViewOnSystemUiVisibilityChangeListenerC0683Lq(this);
        this.A0G.A05(EnumC0682Lp.A02);
        this.A05 = new C0799Qc(this.A0D, this.A0J, this.A0A.A0m(), mr);
        this.A0I = A05();
    ...
    */
    private int A00() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0887Tm.A00():int");
    }
    ...
    private int A01(int i2) {
        if (this.A0A.A1W()) {
            ...
            if (i2 < c1185cB.A1R().size() && i2 >= 0) {
                return this.A0A.A1R().get(i2).intValue();
            }
        }
        return this.A0A.A0S();
    }

    public static /* synthetic */ int A02(C0887Tm c0887Tm, int i2) {
        int i3 = c0887Tm.A01 + i2;
        c0887Tm.A01 = i3;
        return i3;
    }
    ...
    private FullScreenAdToolbar A05() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C0888Tn(this));
    ...
    private void A0B() {
        if (this.A00 > 0 && !TextUtils.isEmpty(this.A0A.A1N(this.A00 - 1).A1U())) {
            ...
            j7.A9x(A1U, A03.A02(u6 != null ? this.A04.getTouchDataRecorder() : null).A05());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0G(float f2) {
        float seenCurrentPosMS;
        float A01 = A01(this.A00 - 1);
        float seenCurrentPosMS2 = (this.A0A.A1W() ? 0 : this.A01) + f2;
        if (A01 > 0.0f) {
    ...
    private void A0I(ViewGroup viewGroup, Q3 q3) {
        if (q3.A00 == Q3.A06 && q3.A03 != null) {
            AbstractC0746Ob.A00(this.A0D, viewGroup, q3.A03);
        } else {
            int i2 = q3.A01;
            String[] strArr = A0M;
            if (strArr[0].length() == strArr[1].length()) {
    ...
    private void A0J(AbstractC1187cD abstractC1187cD) {
        if (A0V(abstractC1187cD) && this.A02 == 2) {
            this.A0I.setOnlyPageDetails(abstractC1187cD.A1S());
        } else {
            this.A0I.setOnlyPageDetails(null);
        }
    }
    ...
    private final void A0K(C5Q c5q) {
        c5q.A0A(this.A0B);
        int i2 = c5q.A05().getResources().getConfiguration().orientation;
        this.A02 = i2;
        A0R(this.A0A.A1T(), i2);
        A0E();
    }
    ...
    */
    public void A0Q(boolean r7) {
        /*
            ...
            if (r0 != 0) goto La4
            boolean r5 = r6.A0U()
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C0887Tm.A0M
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        Lac:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0887Tm.A0Q(boolean):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0R(boolean z2, int i2) {
        if (this.A04 != null) {
            this.A04.A0z();
    ...
    public static boolean A0V(AbstractC1187cD abstractC1187cD) {
