...
public final class ViewOnSystemUiVisibilityChangeListenerC0683Lq implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC0682Lp A02 = EnumC0682Lp.A02;
    public final Runnable A04 = new C0935Vi(this);

    public ViewOnSystemUiVisibilityChangeListenerC0683Lq(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z2) {
        if (EnumC0682Lp.A02.equals(this.A02)) {
            return;
        }
        int i2 = 3840;
        if (!z2) {
    ...
    public final void A05(EnumC0682Lp enumC0682Lp) {
        this.A02 = enumC0682Lp;
        switch (this.A02) {
            case A03:
                A00(67108864, true);
                A00(134217728, true);
