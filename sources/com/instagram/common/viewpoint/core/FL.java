...
public class FL extends ViewGroup implements C3A {
    ...
    public C1108au A02;
    public C4P A03;
    public AbstractC02684c A04;
    public AbstractC02764k A05;
    public AbstractC02804o A06;
    public InterfaceC02884x A07;
    ...
    public C3B A0d;
    public InterfaceC02714f A0e;
    public InterfaceC02744i A0f;
    public AbstractC02834r A0g;
    public InterfaceC02844s A0h;
    public AbstractC02854t A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC02854t> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C02874w A0r;
    ...
    public final C1097aj A11;
    public final C5D A12;
    public final ArrayList<InterfaceC02844s> A13;
    ...
    public static FL A0H(View view) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            FL A0H = A0H(viewGroup.getChildAt(i2));
            if (A0H != null) {
                return A0H;
            }
        }
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int A05 = this.A01.A05() - 1; A05 >= 0; A05--) {
                ...
                if (!A0F.A0f()) {
                    long A0C = A0C(A0F);
                    C02754j A08 = this.A05.A08(this.A0s, A0F);
                    ...
                    if (A052 == null || A052.A0f()) {
                        ...
                        if (A0H && A052 == A0F) {
                            ...
                            C02754j A04 = this.A0t.A04(A052);
                            this.A0t.A0E(A0F, A08);
                            C02754j A03 = this.A0t.A03(A0F);
                            if (A04 == null) {
                                A0m(A0C, A0F, A052);
                            } else {
    ...
    public FL(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.A11 = new C1097aj(this);
        this.A0r = new C02874w(this);
        this.A0t = new C5E();
        ...
        this.A02 = A1E ? new C1108au() : null;
        this.A0s = new AnonymousClass53();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C1100am(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        setAccessibilityDelegateCompat(new C1095ag(this));
    ...
    private View A0D() {
        ...
        for (int startFocusSearchIndex = i2; startFocusSearchIndex < A03; startFocusSearchIndex++) {
        ...
        int startFocusSearchIndex2 = Math.min(A03, i2);
    ...
    private final AnonymousClass56 A0E(long j2) {
        ...
        for (int i2 = 0; i2 < A06; i2++) {
            AnonymousClass56 holder = A0F(this.A01.A0A(i2));
            if (holder != null && !holder.A0a() && holder.A0K() == j2) {
    ...
    public static AnonymousClass56 A0F(View view) {
        ...
        return ((C02814p) view.getLayoutParams()).A00;
    }
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i2 = 0; i2 < A05; i2++) {
                AnonymousClass56 holder = A0F(this.A01.A09(i2));
                if (!holder.A0f() && (!holder.A0Z() || this.A04.A0A())) {
                    AbstractC02764k abstractC02764k = this.A05;
                    AnonymousClass53 anonymousClass53 = this.A0s;
                    int i3 = AbstractC02764k.A00(holder);
                    this.A0t.A0F(holder, abstractC02764k.A09(anonymousClass53, holder, i3, holder.A0L()));
        ...
        if (this.A0s.A0B) {
            ...
            this.A0s.A0D = z2;
            for (int i4 = 0; i4 < this.A01.A05(); i4++) {
                AnonymousClass56 A0F = A0F(this.A01.A09(i4));
                ...
                if (!didStructureChange) {
                    ...
                    if (!didStructureChange2) {
                        int A00 = AbstractC02764k.A00(A0F);
                        boolean A0i = A0F.A0i(8192);
                        if (!A0i) {
                            A00 |= 4096;
                        }
                        C02754j A09 = this.A05.A09(this.A0s, A0F, A00, A0F.A0L());
                        if (A0i) {
                            A1i(A0F, A09);
                        } else {
    ...
    private void A0O() {
        this.A01 = new C4C(new C1102ao(this));
    }
    ...
    */
    private void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FL.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            AnonymousClass56 anonymousClass56 = null;
            long j2 = this.A0s.A08;
            String[] strArr = A19;
            if (strArr[3].charAt(2) == strArr[2].charAt(2)) {
                throw new RuntimeException();
            }
            A19[1] = "kf1DBtA0T6eQEv5OJ0aXYpUf8VxTHKxU";
            if (j2 != -1 && this.A04.A0A()) {
    ...
    private void A0U() {
        ...
        if (this.A0o && hasFocus()) {
            AbstractC02684c abstractC02684c = this.A04;
            String[] strArr = A19;
            if (strArr[3].charAt(2) == strArr[2].charAt(2)) {
                throw new RuntimeException();
            }
    ...
    private final void A0e() {
        this.A00 = new C1109av(new C1101an(this));
    }
    ...
    private final void A0g() {
        int A06 = this.A01.A06();
        for (int i2 = 0; i2 < A06; i2++) {
            ((C02814p) this.A01.A0A(i2).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private void A0j(float f2, float f3, float f4, float f5) {
        ...
        if (f3 < 0.0f) {
            A0b();
            AnonymousClass43.A00(this.A0a, (-f3) / getWidth(), 1.0f - (f4 / getHeight()));
            z2 = true;
        } else if (f3 > 0.0f) {
            A0c();
            AnonymousClass43.A00(this.A0b, f3 / getWidth(), f4 / getHeight());
            z2 = true;
        }
        if (f5 < 0.0f) {
            A0d();
            AnonymousClass43.A00(this.A0c, (-f5) / getHeight(), f2 / getWidth());
            z2 = true;
        } else if (f5 > 0.0f) {
            A0a();
            AnonymousClass43.A00(this.A0Z, f5 / getHeight(), 1.0f - (f2 / getWidth()));
            z2 = true;
        }
        if (!z2 && f3 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private final void A0k(int i2) {
        AbstractC02804o abstractC02804o = this.A06;
        if (this.A0i != null) {
    ...
    private final void A0l(int i2, int i3, Interpolator interpolator) {
        if (this.A06 == null) {
    ...
    private void A0m(long j2, AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562) {
        int A05 = this.A01.A05();
        for (int i2 = 0; i2 < A05; i2++) {
            AnonymousClass56 other = A0F(this.A01.A09(i2));
            if (other != anonymousClass56 && A0C(other) == j2) {
                AbstractC02684c abstractC02684c = this.A04;
                String[] strArr = A19;
                String str = strArr[0];
                String str2 = strArr[6];
                int i3 = str.charAt(14);
                ...
                if (abstractC02684c != null && this.A04.A0A()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + other + A0I + anonymousClass56 + A1H());
                }
                throw new IllegalStateException(A0I(1508, Opcodes.NEWARRAY, 43) + other + A0I + anonymousClass56 + A1H());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(1202, 111, 51) + anonymousClass562 + A0I(18, 41, Opcodes.LNEG) + anonymousClass56 + A1H());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c02814p.A03;
        rect.set((view.getLeft() - rect2.left) - c02814p.leftMargin, (view.getTop() - rect2.top) - c02814p.topMargin, view.getRight() + rect2.right + c02814p.rightMargin, view.getBottom() + rect2.bottom + c02814p.bottomMargin);
    }
    ...
    private void A0p(View view, View view2) {
        ...
        if (layoutParams instanceof C02814p) {
            ...
            C02814p c02814p = (C02814p) layoutParams;
            if (!c02814p.A01) {
                Rect insets = c02814p.A03;
    ...
    private void A0q(AbstractC02684c abstractC02684c, boolean z2, boolean z3) {
        if (this.A04 != null) {
        ...
        this.A00.A09();
        AbstractC02684c abstractC02684c2 = this.A04;
        this.A04 = abstractC02684c;
        if (abstractC02684c != null) {
            abstractC02684c.A07(this.A11);
        }
        AbstractC02804o abstractC02804o = this.A06;
        C02874w c02874w = this.A0r;
        AbstractC02684c oldAdapter = this.A04;
        c02874w.A0U(abstractC02684c2, oldAdapter, z2);
        this.A0s.A0D = true;
        A1P();
    }
    ...
    private void A0t(AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562, C02754j c02754j, C02754j c02754j2, boolean z2, boolean z3) {
        ...
        if (this.A05.A0H(anonymousClass56, anonymousClass562, c02754j, c02754j2)) {
            A1M();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i2 = 0; i2 < A05; i2++) {
            AnonymousClass56 A0F = A0F(this.A01.A09(i2));
            if (!A0F.A0f()) {
                int count = A0F.A0I();
    ...
    private boolean A11(int i2, int i3) {
        A0x(this.A14);
        return (this.A14[0] == i2 && this.A14[1] == i3) ? false : true;
    }

    private final boolean A12(int i2, int i3) {
        if (this.A06 == null) {
        ...
        if (!A20 || Math.abs(i2) < this.A0y) {
            i2 = 0;
        }
        if (!canScroll || Math.abs(i3) < this.A0y) {
            i3 = 0;
        }
        if (i2 == 0 && i3 == 0) {
            return false;
        ...
        boolean canScrollHorizontal = dispatchNestedPreFling(f2, i3);
        if (!canScrollHorizontal) {
            boolean canScrollVertical = A20 || canScroll;
            dispatchNestedFling(i2, i3, canScrollVertical);
            if (this.A0g != null) {
                boolean canScrollHorizontal2 = this.A0g.A0B(i2, i3);
            ...
            if (canScrollVertical) {
                ...
                int max = Math.max(nestedScrollAxis, Math.min(i2, this.A0x));
                int nestedScrollAxis2 = -this.A0x;
                this.A08.A09(max, Math.max(nestedScrollAxis2, Math.min(i3, this.A0x)));
                return true;
            }
        }
        return false;
    ...
    private final boolean A13(int consumedX, int consumedY, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1J();
            A1K();
            AbstractC02312q.A01(A0I(1361, 9, 51));
            A1h(this.A0s);
            if (consumedX != 0) {
                i4 = this.A06.A1d(consumedX, this.A0r, this.A0s);
                i2 = consumedX - i4;
            }
            if (consumedY != 0) {
                i5 = this.A06.A1e(consumedY, this.A0r, this.A0s);
                i3 = consumedY - i5;
            }
            AbstractC02312q.A00();
            A1O();
        ...
        if (A1t(i4, i5, i2, i3, this.A17, 0)) {
            ...
            if (motionEvent != null && !AnonymousClass39.A00(motionEvent, 8194)) {
                A0j(motionEvent.getX(), i2, motionEvent.getY(), i3);
            }
    ...
    private boolean A17(View view, View view2, int i2) {
        ...
        switch (i2) {
            ...
            default:
                throw new IllegalArgumentException(A0I(1844, 37, 85) + i2 + A1H());
        }
    }
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        if (A1q()) {
            ...
            if (accessibilityEvent != null) {
                i2 = AbstractC02533m.A00(accessibilityEvent);
            }
            if (i2 == 0) {
                i2 = 0;
            }
    ...
    public final AnonymousClass56 A1F(int i2) {
        if (this.A0C) {
            return null;
        }
        int A06 = this.A01.A06();
        ...
        for (int i3 = 0; i3 < A06; i3++) {
            AnonymousClass56 A0F = A0F(this.A01.A0A(i3));
            if (A0F != null && !A0F.A0a()) {
    ...
    */
    public final void A1I() {
        /*
            ...
            if (r0 == 0) goto L1c
        L12:
            com.instagram.common.viewpoint.core.AbstractC02312q.A01(r4)
            r5.A0Y()
            com.instagram.common.viewpoint.core.AbstractC02312q.A00()
            return
        L1c:
        ...
        L25:
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.FL.A19
            r0 = 0
            r1 = r2[r0]
            r0 = 6
            r2 = r2[r0]
            ...
            com.instagram.common.viewpoint.core.AbstractC02312q.A01(r0)
            r5.A1J()
            r5.A1K()
            com.facebook.ads.redexgen.X.av r0 = r5.A00
            r0.A08()
        ...
        L92:
            r0 = 1
            r5.A1n(r0)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.FL.A19
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
        ...
        Ld5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FL.A1I():void");
    }
    ...
    public final void A1O() {
        ...
        for (int left = 0; left < A05; left++) {
            ...
            if (A1G2 != null && A1G2.A07 != null) {
                ...
                shadowingView.layout(left2, top, i2 + left2, count3 + top);
            }
        }
    }
    ...
    public final void A1a(int i2, int i3) {
        int A00 = AbstractC02804o.A00(i2, getPaddingLeft() + getPaddingRight(), C3T.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i4 = paddingTop + width;
        int width2 = C3T.A02(this);
        setMeasuredDimension(A00, AbstractC02804o.A00(i3, i4, width2));
    }
    ...
    public final void A1b(int i2, int i3) {
        ...
        if (this.A0i != null) {
            this.A0i.A0M(this, i2, i3);
        }
        if (this.A0m != null) {
            for (int scrollY2 = this.A0m.size() - 1; scrollY2 >= 0; scrollY2--) {
                this.A0m.get(scrollY2).A0M(this, i2, i3);
            }
        }
        this.A0N--;
    }
    ...
    public final void A1f(AbstractC02854t abstractC02854t) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC02854t);
    }

    public final void A1g(AbstractC02854t abstractC02854t) {
        if (this.A0m != null) {
            List<AbstractC02854t> list = this.A0m;
            if (A19[7].length() != 1) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public final void A1i(AnonymousClass56 anonymousClass56, C02754j c02754j) {
        ...
        this.A0t.A0F(anonymousClass56, c02754j);
    }

    public final void A1j(AnonymousClass56 anonymousClass56, C02754j c02754j, C02754j c02754j2) {
        anonymousClass56.A0X(false);
        if (this.A05.A0E(anonymousClass56, c02754j, c02754j2)) {
            A1M();
        }
    }

    public final void A1k(AnonymousClass56 anonymousClass56, C02754j c02754j, C02754j c02754j2) {
        A0r(anonymousClass56);
        anonymousClass56.A0X(false);
        if (this.A05.A0F(anonymousClass56, c02754j, c02754j2)) {
            A1M();
        }
    }
    ...
    public final void A1n(boolean z2) {
        ...
        if (this.A0O == 1) {
            if (z2 && this.A0J) {
                ...
                A19[7] = "k";
                if (!z3 && this.A06 != null && this.A04 != null) {
                    A0Y();
                }
            }
            if (!this.A0I) {
    ...
    public final boolean A1r(int i2) {
        return getScrollingChildHelper().A09(i2);
    }

    public final boolean A1s(int i2, int i3) {
        return getScrollingChildHelper().A0B(i2, i3);
    }

    public final boolean A1t(int i2, int i3, int i4, int i5, int[] iArr, int i6) {
        return getScrollingChildHelper().A0D(i2, i3, i4, i5, iArr, i6);
    }

    public final boolean A1u(int i2, int i3, int[] iArr, int[] iArr2, int i4) {
    ...
    public final boolean A1x(AnonymousClass56 anonymousClass56, int i2) {
        if (A1q()) {
            anonymousClass56.A02 = i2;
            this.A0w.add(anonymousClass56);
            return false;
        }
        C3T.A09(anonymousClass56.A0H, i2);
        return true;
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void addFocusables(ArrayList<View> views, int i2, int i3) {
        if (this.A06 == null || !this.A06.A1c(this, views, i2, i3)) {
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C02814p) && this.A06.A1Y((C02814p) layoutParams);
    }
    ...
    public final int computeVerticalScrollExtent() {
        ...
        return abstractC02804o.A1i(this.A0s);
    }
    ...
    public final boolean dispatchNestedFling(float f2, float f3, boolean z2) {
        return getScrollingChildHelper().A08(f2, f3, z2);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FL.draw(android.graphics.Canvas):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0075, code lost:
        ...
        r2 = com.instagram.common.viewpoint.core.FL.A19;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x009e, code lost:
        ...
        if (com.instagram.common.viewpoint.core.FL.A1F == false) goto L35;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00a9, code lost:
        ...
        if (r10.A06.A20() == false) goto L51;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00b1, code lost:
    
        if (r10.A06.A0a() != 1) goto L58;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00c5, code lost:
        ...
        if (com.instagram.common.viewpoint.core.FL.A1F == false) goto L51;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:68:0x015e, code lost:
        ...
        com.instagram.common.viewpoint.core.FL.A19[1] = "b9MIeYXaHVfTdq5nKFyUZKSBlIH2M87t";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:87:0x0123, code lost:
        ...
        if (com.instagram.common.viewpoint.core.FL.A19[7].length() == 1) goto L77;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x012b, code lost:
        ...
        com.instagram.common.viewpoint.core.FL.A19[7] = "d";
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FL.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public AbstractC02684c getAdapter() {
        return this.A04;
    }
    ...
    public C1095ag getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AbstractC02764k getItemAnimator() {
        return this.A05;
    }

    public AbstractC02804o getLayoutManager() {
        return this.A06;
    }
    ...
    public AbstractC02834r getOnFlingListener() {
        return this.A0g;
    }
    ...
    public final void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        AbstractC02312q.A01(A0I(1330, 11, 34));
        A0Y();
        AbstractC02312q.A00();
        this.A0D = true;
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (z2) {
            ...
            int widthMode = View.MeasureSpec.getMode(i3);
            if (mode == 1073741824 && widthMode == 1073741824) {
                heightMode = 1;
            }
            this.A06.A1J(this.A0r, this.A0s, i2, i3);
            ...
            if (this.A06.A1z()) {
                ...
                abstractC02804o.A11(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(widthMode4, Ints.MAX_POWER_OF_TWO));
                this.A0s.A0A = true;
                A0M();
                if (A19[1].charAt(14) != '5') {
                    this.A06.A12(i2, i3);
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FL.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ArrayList<InterfaceC02844s> arrayList = this.A13;
            int i3 = A19[7].length();
            if (i3 != 1) {
                throw new RuntimeException();
            }
    ...
    public void setAccessibilityDelegateCompat(C1095ag c1095ag) {
        this.A09 = c1095ag;
    ...
    public void setAdapter(AbstractC02684c abstractC02684c) {
        ...
        A0q(abstractC02684c, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(InterfaceC02714f interfaceC02714f) {
        if (interfaceC02714f == null) {
            return;
        }
        this.A0e = interfaceC02714f;
    ...
    public void setItemAnimator(AbstractC02764k abstractC02764k) {
        if (this.A05 != null) {
            this.A05.A0I();
            this.A05.A0B(null);
        }
        this.A05 = abstractC02764k;
        if (this.A05 != null) {
            this.A05.A0B(this.A0f);
        }
    }
    ...
    public void setLayoutManager(AbstractC02804o abstractC02804o) {
        ...
        this.A01.A0B();
        this.A06 = abstractC02804o;
        if (abstractC02804o != null) {
            if (abstractC02804o.A03 == null) {
                this.A06.A1P(this);
                if (this.A0F) {
                    this.A06.A1N(this);
                }
            } else {
                throw new IllegalArgumentException(A0I(1109, 14, 42) + abstractC02804o + A0I(59, 39, 124) + abstractC02804o.A03.A1H());
            }
        }
        this.A0r.A0O();
        requestLayout();
    ...
    public void setOnFlingListener(AbstractC02834r abstractC02834r) {
        this.A0g = abstractC02834r;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC02854t abstractC02854t) {
        this.A0i = abstractC02854t;
    }
    ...
    public void setRecyclerListener(InterfaceC02884x interfaceC02884x) {
        this.A07 = interfaceC02884x;
    }
    ...
    public void setScrollingTouchSlop(int i2) {
        ...
        switch (i2) {
            ...
            case 1:
                ...
                return;
            default:
                Log.w(A0I(1370, 12, 39), A0I(1994, 47, 98) + i2 + A0I(Opcodes.IFNULL, 21, 88));
                this.A0X = viewConfiguration.getScaledTouchSlop();
                return;
        }
    }
    ...
    @Override // android.view.View, com.instagram.common.viewpoint.core.C3A
