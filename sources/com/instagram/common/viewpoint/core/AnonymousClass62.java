...
public final class AnonymousClass62 {
    ...
    public AnonymousClass62(C1045Zs c1045Zs, AudienceNetworkActivity audienceNetworkActivity) {
        this.A02 = c1045Zs;
        this.A01 = audienceNetworkActivity;
    }

    private void A02(int i2, int i3) {
        if (this.A01.getWindow() != null) {
            this.A01.getWindow().setFlags(i2, i3);
        }
    }
    ...
    public final QS A03(Intent intent, RelativeLayout relativeLayout) {
        ...
        if (stringExtra != null) {
            ...
            QS A01 = QR.A01(c1045Zs, stringExtra);
            if (A01 != null) {
    ...
    public final void A04() {
        if (C0608Im.A28(this.A01)) {
            A02(Http2Connection.OKHTTP_CLIENT_WINDOW_SIZE, Http2Connection.OKHTTP_CLIENT_WINDOW_SIZE);
        }
    }

    public final void A05() {
        if (this.A00 != null && C0608Im.A16(this.A01)) {
            this.A00.A07();
        }
    }

    public final void A06() {
        if (C0608Im.A2G(this.A01)) {
            A02(128, 128);
        }
    }

    public final void A07(Intent intent, KG kg, final RelativeLayout relativeLayout) {
        if (C0608Im.A16(this.A01)) {
            KG kg2 = KG.A03;
            if (A04[1].length() == 14) {
                throw new RuntimeException();
            }
            A04[7] = "MXPR3PNgo3gwYNs9J3I1TINqSxswEDcD";
            if (kg != kg2 && Build.VERSION.SDK_INT >= 18) {
                this.A00 = new O6();
                ...
                M3.A0M(textView, Color.argb(Opcodes.IF_ICMPNE, 0, 0, 0));
                textView.setPadding(5, 5, 5, 5);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
                layoutParams.addRule(12, -1);
                layoutParams.addRule(11, -1);
                textView.setLayoutParams(layoutParams);
                final O6 o62 = this.A00;
                View.OnLongClickListener onLongClickListener = new View.OnLongClickListener(o62, relativeLayout) { // from class: com.facebook.ads.redexgen.X.5c
                    ...
                    public final boolean onLongClick(View view) {
                        if (this.A01 != null && this.A00 != null) {
                            ...
                            A02[7] = "";
                            o63.setBounds(0, 0, width, relativeLayout2.getHeight());
    ...
    public final void A08(KG kg, boolean z2) {
