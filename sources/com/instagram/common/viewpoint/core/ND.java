...
public final class ND extends RelativeLayout {
    ...
    public ND(NC nc) {
        ...
        this.A04 = NC.A03(nc);
        this.A01 = NC.A09(nc) ? A0E : A0F;
        this.A00 = NC.A09(nc) ? A0B : A0C;
        this.A05 = NC.A0A(nc);
        setFocusable(true);
        View A01 = A01(nc);
        View A00 = A00(nc);
        ...
        footerView.setVisibility(NC.A0B(nc) ? 0 : 8);
    }
    ...
    private View A00(NC nc) {
        ...
        subtitleView.setText(NC.A04(nc));
        ...
        if (NC.A08(nc)) {
            ...
            if (!TextUtils.isEmpty(NC.A06(nc))) {
                ...
                new AsyncTaskC0914Un(ou, this.A03).A05(A0F, A0F).A07(NC.A06(nc));
                linearLayout2.addView(ou, iconParams);
            }
            NI ni = new NI(this.A03);
            ni.setData(NC.A07(nc), MB.CHECKMARK);
            ni.setSelected(true);
