...
public final class ViewpointRegistry {
    ...
    public final Map<DspViewableNode, Map<C1276dt, Cdo<?, ?>>> A01;
     ...
     */
    public final synchronized void A05(DspViewableNode dspViewableNode, C1276dt c1276dt, Cdo<?, ?> cdo) {
        C1243d7.A07(dspViewableNode, A00(14, 4, 83));
        C1243d7.A07(c1276dt, A00(11, 3, 8));
        C1243d7.A07(cdo, A00(32, 13, 42));
        Map<DspViewableNode, Map<C1276dt, Cdo<?, ?>>> map = this.A01;
        WeakHashMap weakHashMap = map.get(dspViewableNode);
        if (weakHashMap == null) {
            weakHashMap = new WeakHashMap();
            map.put(dspViewableNode, weakHashMap);
        }
        weakHashMap.put(c1276dt, cdo);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 7 out of bounds for length 6
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final synchronized void A07(DspViewableNode dspViewableNode, InterfaceC0574Hd<? super Cdo<?, ?>, C1252dK> interfaceC0574Hd) {
        Collection<Cdo<?, ?>> values;
        C1243d7.A07(dspViewableNode, A00(14, 4, 83));
        C1243d7.A07(interfaceC0574Hd, A00(5, 6, 14));
        Cdo<?, ?> cdo = this.A02.get(dspViewableNode);
        if (cdo != null) {
            interfaceC0574Hd.A9K(cdo);
        }
        Map<C1276dt, Cdo<?, ?>> map = this.A01.get(dspViewableNode);
        if (map != null && (values = map.values()) != null) {
            Iterator<T> it = values.iterator();
            while (it.hasNext()) {
                interfaceC0574Hd.A9K((Cdo) it.next());
            }
        }
    }
    ...
    public final synchronized void A08(Collection<DspViewableNode> collection) {
        C1243d7.A07(collection, A00(26, 6, 82));
    ...
    public ViewpointRegistry(ViewpointQeConfig viewpointQeConfig) {
        C1243d7.A07(viewpointQeConfig, A00(18, 8, 112));
    ...
    public final synchronized void A04(DspViewableNode dspViewableNode, C1276dt c1276dt) {
        C1243d7.A07(dspViewableNode, A00(14, 4, 83));
        C1243d7.A07(c1276dt, A00(11, 3, 8));
        Map nodeDataMap = this.A01.get(dspViewableNode);
        if (nodeDataMap != null) {
            nodeDataMap.remove(c1276dt);
