...
public final class AnonymousClass71 implements InterfaceC0640Jw, SK {
    ...
    public final InterfaceC0839Rq A02;
    public final SL A03;
    public final ST A04;
    public final SU A05;
    public final String A06;
    public final Map<SG, C0643Jz> A09 = new HashMap();
    ...
    private void A04() throws Throwable {
        ...
        synchronized (this) {
            for (C0643Jz c0643Jz : this.A09.values()) {
                if (c0643Jz.A9b()) {
                    hashMap.put(c0643Jz, EnumC0850Sb.A05);
                } else {
                    hashMap.put(c0643Jz, EnumC0850Sb.A04);
                }
            }
            new AtomicReference();
            new AtomicReference();
        ...
        this.A02.AET(this.A06, (A01(327, 8, Opcodes.LSHL) + URLEncoder.encode(A03.toString())).getBytes(), new C0637Jt(this, atomicReference, atomicReference2, countDownLatch));
        ...
        synchronized (this) {
            ...
            Iterator<SX> it3 = A02.iterator();
            while (it3.hasNext()) {
                it3.next().A3v(hashMap5, hashMap6);
            }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 7 out of bounds for length 7
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0640Jw
    public final synchronized SF A54(SG sg) {
        ...
        C0643Jz c0643Jz = new C0643Jz(sg);
        this.A09.put(sg, c0643Jz);
        Iterator<SY> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            throw new NullPointerException(A01(377, 24, 120));
        }
        String.format(Locale.US, A01(153, 35, Opcodes.LSHR), sg);
        return c0643Jz;
    }
    ...
    public AnonymousClass71(C7j c7j, AnonymousClass80 anonymousClass80, InterfaceC0839Rq interfaceC0839Rq, String str, SU su, ST st, SJ sj) {
        this.A00 = c7j;
        this.A01 = anonymousClass80;
        this.A02 = interfaceC0839Rq;
        this.A06 = str;
        this.A05 = su;
        this.A04 = st;
    ...
    public static int A00(JSONObject jSONObject) throws JSONException {
        ...
        throw new JSONException(String.format(Locale.US, A01(Opcodes.LOR, 24, 44), Integer.valueOf(time)));
    }
    ...
    private Set<SX> A02(JSONObject jSONObject) throws JSONException {
        ...
        Iterator<C0643Jz> it = this.A09.values().iterator();
        while (true) {
            ...
            strArr2[3] = "8JT";
            if (hasNext) {
                final C0643Jz next = it.next();
                switch (SW.A01[EnumC0851Sc.A00(jSONObject2.getString(next.A7Y().A04())).ordinal()]) {
                    case 1:
                        ...
                        hashSet.add(new AbstractC0635Jr(next, fingerprint, responseObject) { // from class: com.facebook.ads.redexgen.X.76
                            public final JSONObject A00;
                            public final JSONObject A01;

                            {
                                EnumC0851Sc enumC0851Sc = EnumC0851Sc.A03;
                                this.A00 = fingerprint;
                                this.A01 = responseObject;
                            }

                            @Override // com.instagram.common.viewpoint.core.AbstractC0635Jr, com.instagram.common.viewpoint.core.SX
                            public final void A3v(Map<SF, EnumC0851Sc> map, Map<SyncModifiableBundle, SP> map2) {
                        ...
                        break;
                    case 2:
                        hashSet.add(new AbstractC0635Jr(next) { // from class: com.facebook.ads.redexgen.X.73
                            {
                                EnumC0851Sc enumC0851Sc = EnumC0851Sc.A04;
                            }
                        });
                        break;
                    default:
                ...
                while (it2.hasNext()) {
                    ...
                    switch (SW.A00[SP.A00(jSONObject2.getString(anonymousClass79.A7Y().A04())).ordinal()]) {
                        case 1:
                            hashSet.add(new AbstractC0636Js(anonymousClass79) { // from class: com.facebook.ads.redexgen.X.77
                                {
                                    SP sp = SP.A03;
                                }
                            });
                            break;
                        case 2:
                            hashSet.add(new AbstractC0636Js(anonymousClass79) { // from class: com.facebook.ads.redexgen.X.72
                                ...
                                @Override // com.instagram.common.viewpoint.core.AbstractC0636Js, com.instagram.common.viewpoint.core.SX
                                public final void A3v(Map<SF, EnumC0851Sc> map, Map<SyncModifiableBundle, SP> map2) {
    ...
    private JSONObject A03(Map<SF, EnumC0850Sb> map, Map<SyncModifiableBundle, SO> map2, Map<SyncModifiableBundle, JSONObject> clientBundleData, Map<SyncModifiableBundle, JSONObject> clientBundleFingerprint) throws JSONException {
        String A01;
        JSONObject syncRequest = new JSONObject();
        for (Map.Entry<SF, EnumC0850Sb> entry : map.entrySet()) {
            syncRequest.put(entry.getKey().A7Y().A04(), entry.getValue().A03());
        }
        for (Map.Entry<SyncModifiableBundle, SO> entry2 : map2.entrySet()) {
            entry2.getKey();
            SF sf = null;
            String A04 = sf.A7Y().A04();
        ...
        Iterator<Map.Entry<SF, EnumC0850Sb>> it = map.entrySet().iterator();
        while (true) {
            boolean hasNext = it.hasNext();
            A01 = A01(316, 11, 43);
            if (!hasNext) {
            ...
            Map.Entry<SF, EnumC0850Sb> next = it.next();
            if (next.getValue() == EnumC0850Sb.A05) {
    ...
    public static void A06(String str, AtomicReference<JSONObject> atomicReference, AtomicReference<Throwable> atomicReference2) {
        String.format(Locale.US, A01(221, 28, Opcodes.FNEG), str);
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0640Jw, com.instagram.common.viewpoint.core.InterfaceC03507p
    public final void A68() {
        this.A03.A67();
    }

    @Override // com.instagram.common.viewpoint.core.SK
    public final void AFt() {
        ...
        try {
            if (!C0608Im.A1x(this.A00) || this.A00.A03().A9T()) {
                A04();
                return;
            }
