...
public abstract class JH {
    ...
    public static List<String> A02(C1045Zs c1045Zs, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e) {
                c1045Zs.A07().AA0(A00(39, 17, 76), C8E.A1C, new C8F(e));
            }
        }
        return arrayList;
    }

    public static void A04(View view, JF jf, JE je) {
        view.addOnAttachStateChangeListener(new JG(jf, je));
    }

    public static void A05(C1045Zs c1045Zs, String str, long j2) {
        J7 adEventManager = c1045Zs.A09();
        JF jf = new JF(str, adEventManager);
        HashMap hashMap = new HashMap();
        hashMap.put(A00(24, 15, 67), C0687Lu.A06(j2));
        hashMap.put(A00(12, 12, 71), C0687Lu.A04(j2));
        jf.A04(JE.A0D, hashMap);
    }

    public static void A06(C1045Zs c1045Zs, JSONObject jSONObject, long j2, String str) {
        ...
        if (TextUtils.isEmpty(str) && optJSONArray != null) {
            A07(c1045Zs, optJSONObject, A02(c1045Zs, optJSONArray), j2, null);
            return;
        }
        ...
        A07(c1045Zs, optJSONObject, A03.get(str), j2, str);
    }

    public static void A07(C1045Zs c1045Zs, JSONObject jSONObject, List<String> list, long j2, String str) {
        String A002 = A00(0, 2, 106);
        if (jSONObject.has(A002)) {
            String clientToken = jSONObject.optString(A002);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1045Zs, clientToken, j2);
        }
    }
    ...
    public static boolean A0A(String str, JE je) {
