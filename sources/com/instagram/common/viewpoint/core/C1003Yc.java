...
public final class C1003Yc implements InterfaceC0455Bx {
    ...
    public static void A06() {
        ...
        -28, -40, -43, -33, -30, -47, -21, -12, -21, -27, -51, 54, Utf8.REPLACEMENT_BYTE, 54, 48, 25, 70, 58, 77, 75, 72, 76, 68, 58, 37, 24, 19, 20, 30, -34, 38, 20, 17, 28, 80, 62, 59, 70};
    }

    /* JADX WARN: Code restructure failed: missing block: B:21:0x0091, code lost:
    
        if ((r11.A0k.A00[0] & com.google.common.primitives.UnsignedBytes.MAX_POWER_OF_TWO) != 128) goto L22;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x021d, code lost:
        ...
        throw new com.instagram.common.viewpoint.core.A0(A03(504, 35, 96));
     */
    ...
    */
    private void A08(com.instagram.common.viewpoint.core.InterfaceC0456By r12, com.instagram.common.viewpoint.core.CJ r13, int r14) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 838
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1003Yc.A08(com.facebook.ads.redexgen.X.By, com.facebook.ads.redexgen.X.CJ, int):void");
    }
    ...
    public C1003Yc(int i2) {
        this(new C1006Yf(), i2);
    }

    public C1003Yc(CF cf, int i2) {
        this.A0K = -1L;
        ...
        this.A0d = cf;
        this.A0d.A9E(new C1004Yd(this, null));
        this.A0o = (i2 & 1) == 0;
        this.A0e = new CM();
    ...
    private int A00(InterfaceC0456By interfaceC0456By, C9 c9, int i2) throws IOException, InterruptedException {
        int bytesRead;
        int strippedBytesLeft = this.A0j.A04();
        if (strippedBytesLeft > 0) {
            bytesRead = Math.min(i2, strippedBytesLeft);
            c9.AFv(this.A0j, bytesRead);
        } else {
            bytesRead = c9.AFu(interfaceC0456By, i2, false);
        }
        this.A07 += bytesRead;
        this.A08 += bytesRead;
        return bytesRead;
    ...
    private long A01(long j2) throws A0 {
        if (this.A0M != -9223372036854775807L) {
            return IK.A0F(j2, this.A0M, 1000L);
        }
        throw new A0(A03(Opcodes.ANEWARRAY, 54, 18));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.instagram.common.viewpoint.core.C6 A02() {
        /*
            r11 = this;
            long r3 = r11.A0K
            r1 = -1
        ...
        L80:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1003Yc.A02():com.facebook.ads.redexgen.X.C6");
    }
    ...
    private void A07(InterfaceC0456By interfaceC0456By, int i2) throws IOException, InterruptedException {
        if (this.A0k.A07() >= i2) {
            return;
        }
        if (this.A0k.A05() < i2) {
            ...
            i4.A0b(Arrays.copyOf(i42.A00, Math.max(this.A0k.A00.length * 2, i2)), this.A0k.A07());
        }
        interfaceC0456By.readFully(this.A0k.A00, this.A0k.A07(), i2 - this.A0k.A07());
        this.A0k.A0X(i2);
    }

    private void A09(InterfaceC0456By interfaceC0456By, byte[] bArr, int i2) throws IOException, InterruptedException {
        ...
        interfaceC0456By.readFully(bArr2, sizeWithPrefix3, i2);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC0456By interfaceC0456By, byte[] bArr, int i2, int i3) throws IOException, InterruptedException {
        int min = Math.min(i3, this.A0j.A04());
        int pendingStrippedBytes = i3 - min;
        interfaceC0456By.readFully(bArr, i2 + min, pendingStrippedBytes);
        if (min > 0) {
            this.A0j.A0c(bArr, i2, min);
        }
        int pendingStrippedBytes2 = this.A07;
        this.A07 = pendingStrippedBytes2 + i3;
    }

    private void A0B(CJ cj, long j2) {
        if (cj.A0X != null) {
            cj.A0X.A03(cj, j2);
        } else {
            ...
            cj.A0W.AFw(j2, this.A01, this.A08, 0, cj.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0C(CJ cj, String str, int i2, long j2, byte[] bArr) {
    ...
    public static void A0D(byte[] bArr, long j2, String str, int i2, long j3, byte[] bArr2) {
        ...
        if (j2 == -9223372036854775807L) {
            ...
            int minutes = i4 * 60;
            long j5 = j4 - (minutes * 1000000);
            int lastValue = (int) (j5 / 1000000);
            int minutes2 = (int) ((j5 - (lastValue * 1000000)) / j3);
            timeCodeData = IK.A0i(String.format(Locale.US, str, Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(lastValue), Integer.valueOf(minutes2)));
        }
        System.arraycopy(timeCodeData, 0, bArr, i2, bArr2.length);
    }

    private boolean A0E(C4 c4, long j2) {
        if (this.A0Y) {
            this.A0J = j2;
            c4.A00 = this.A0F;
            this.A0Y = false;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00d2, code lost:
        ...
        if (A03(154, 6, 28).equals(r6) == false) goto L28;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00d4, code lost:
    
        r2 = com.instagram.common.viewpoint.core.C1003Yc.A0q;
     */
    /* JADX WARN: Code restructure failed: missing block: B:28:0x00e8, code lost:
    
        if (r2[4].length() == r2[1].length()) goto L79;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0100, code lost:
        ...
        if (A03(org.objectweb.asm.Opcodes.PUTFIELD, 8, 30).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x010f, code lost:
    
        if (A03(74, 5, 88).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:34:0x011f, code lost:
    
        if (A03(128, 9, 41).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:36:0x012f, code lost:
    
        if (A03(org.objectweb.asm.Opcodes.L2F, 9, 83).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:38:0x013e, code lost:
    
        if (A03(79, 5, 52).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:40:0x014d, code lost:
    
        if (A03(116, 6, 93).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:42:0x015d, code lost:
    
        if (A03(org.objectweb.asm.Opcodes.LRETURN, 8, 116).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:44:0x016c, code lost:
    
        if (A03(84, 5, 33).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:46:0x017c, code lost:
    
        if (A03(89, 13, 34).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:48:0x018c, code lost:
    
        if (A03(102, 14, 16).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x019b, code lost:
    
        if (A03(122, 6, 49).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:52:0x01ab, code lost:
    
        if (A03(org.objectweb.asm.Opcodes.I2C, 8, 126).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:54:0x01be, code lost:
    
        if (com.instagram.common.viewpoint.core.C1003Yc.A0q[7].length() == 30) goto L76;
     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x01c0, code lost:
    
        com.instagram.common.viewpoint.core.C1003Yc.A0q[7] = "hCOrDW1Xt9EUQRBJh4lIFcdmIau3uO";
     */
    /* JADX WARN: Code restructure failed: missing block: B:56:0x01cf, code lost:
    
        if (A03(org.objectweb.asm.Opcodes.IF_ICMPNE, 13, 72).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x01df, code lost:
    
        if (A03(843, 11, 105).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:60:0x01ef, code lost:
    
        if (A03(833, 10, 89).equals(r6) != false) goto L70;
     */
    /* JADX WARN: Code restructure failed: missing block: B:62:0x01ff, code lost:
    
        if (com.instagram.common.viewpoint.core.C1003Yc.A0q[3].charAt(1) == 'J') goto L73;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0266, code lost:
        ...
        com.instagram.common.viewpoint.core.C1003Yc.A0q[3] = "57SEv8zsmKegk4FairLq34Nwn3RXRdHM";
     */
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0277, code lost:
    
        if (A03(org.objectweb.asm.Opcodes.PUTFIELD, 8, 25).equals(r6) != false) goto L70;
     */
    ...
    */
    public static boolean A0F(java.lang.String r6) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1003Yc.A0F(java.lang.String):boolean");
    }
    ...
    public final void A0I(int i2) throws A0 {
        switch (i2) {
            ...
            case 25152:
                ...
                if (this.A0O.A0V != null) {
                    this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(AbstractC03849b.A05, A03(1024, 10, 78), this.A0O.A0V.A03));
                    return;
                }
    ...
    public final void A0J(int i2, double d) {
        switch (i2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x037f, code lost:
        ...
        if ((r5[2] & com.google.common.primitives.UnsignedBytes.MAX_POWER_OF_TWO) == 128) goto L109;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0K(int r18, int r19, com.instagram.common.viewpoint.core.InterfaceC0456By r20) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 1010
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1003Yc.A0K(int, int, com.facebook.ads.redexgen.X.By):void");
    }

    public final void A0L(int i2, long j2) throws A0 {
        ...
        switch (i2) {
            ...
            case 16980:
                if (j2 == 3) {
                    ...
                    throw new A0(A03(296, 16, 65) + j2 + A03);
                }
            case 17029:
                if (j2 >= 1 && j2 <= 2) {
                    return;
                } else {
                    throw new A0(A03(377, 19, 42) + j2 + A03);
                }
            case 17143:
                if (j2 == 1) {
                    return;
                } else {
                    throw new A0(A03(433, 16, 50) + j2 + A03);
                }
            case 18401:
                if (j2 == 5) {
                    return;
                } else {
                    throw new A0(A03(312, 15, 83) + j2 + A03);
                }
            case 18408:
                String[] strArr7 = A0q;
                ...
                throw new A0(A03(52, 22, 77) + j2 + A03);
            case 20529:
                if (j2 == 0) {
                    return;
                } else {
                    throw new A0(A03(327, 21, 71) + j2 + A03);
                }
            case 20530:
                if (j2 == 1) {
                    return;
                } else {
                    throw new A0(A03(348, 21, 42) + j2 + A03);
                }
            case 21420:
    ...
    public final void A0M(int i2, long j2, long j3) throws A0 {
        switch (i2) {
            case Opcodes.IF_ICMPNE /* 160 */:
                this.A0W = false;
                return;
            ...
            case 475249515:
                this.A0Q = new C0591Hu();
                this.A0P = new C0591Hu();
                return;
            case 524531317:
                if (this.A0a) {
                    return;
                ...
                if (this.A0o && this.A0F != -1) {
                    ...
                    this.A0N.AG8(new C1015Yo(this.A0H));
                    this.A0a = true;
                    return;
                }
        }
    ...
    public final void A0N(int i2, String str) throws A0 {
        switch (i2) {
    ...
    public final int AEk(InterfaceC0456By interfaceC0456By, C4 c4) throws IOException, InterruptedException {
        ...
        boolean z2 = true;
        while (z2 && !this.A0V) {
            z2 = this.A0d.AEm(interfaceC0456By);
            if (z2 && A0E(c4, interfaceC0456By.A86())) {
                if (A0q[3].charAt(1) == 'J') {
                    throw new RuntimeException();
                }
                String[] strArr = A0q;
    ...
    */
    public final void AG7(long r3, long r5) {
        ...
        L18:
            ...
            com.facebook.ads.redexgen.X.CJ r0 = (com.instagram.common.viewpoint.core.CJ) r0
            r0.A08()
            int r1 = r1 + 1
            goto L18
        L2e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1003Yc.AG7(long, long):void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0455Bx
    public final boolean AGs(InterfaceC0456By interfaceC0456By) throws IOException, InterruptedException {
        return new CL().A01(interfaceC0456By);
    }
}
