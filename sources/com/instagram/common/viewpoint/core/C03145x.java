...
public final class C03145x implements RewardedInterstitialAd.RewardedInterstitialAdLoadConfigBuilder, RewardedInterstitialAd.RewardedInterstitialLoadAdConfig {
    public final AnonymousClass60 A00;

    public C03145x(AnonymousClass60 anonymousClass60) {
    ...
    public final RewardedInterstitialAd.RewardedInterstitialAdLoadConfigBuilder withAdListener(RewardedInterstitialAdListener rewardedInterstitialAdListener) {
        this.A00.withAdListener(new C03135w(rewardedInterstitialAdListener));
        return this;
    }
