...
public abstract class NF {
    ...
    public static NE A01(C1045Zs c1045Zs, J7 j7, String str, View view) {
        if (view == null) {
            return null;
        }
        int w = view.getWidth();
        ...
        if (w >= A03) {
            ...
            if (height >= i2) {
                return new V2(c1045Zs, j7, str);
            }
        }
        return null;
    }

    public static V3 A02(C1045Zs c1045Zs, J7 j7, String str, C1Z c1z, MS ms, MR mr) {
        return new V3(c1045Zs, j7, str, c1z, ms, mr);
    }
    ...
    */
    public static boolean A03(com.facebook.ads.NativeAdLayout r6) {
        /*
            int r5 = r6.getWidth()
            int r4 = r6.getHeight()
            int r0 = com.instagram.common.viewpoint.core.NF.A01
            if (r5 < r0) goto L10
            int r0 = com.instagram.common.viewpoint.core.NF.A01
            if (r4 >= r0) goto L2a
        L10:
            int r3 = com.instagram.common.viewpoint.core.NF.A03
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.NF.A00
            r0 = 1
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        L2c:
            ...
            r2[r0] = r1
            if (r5 < r3) goto L3e
            int r0 = com.instagram.common.viewpoint.core.NF.A02
            if (r4 >= r0) goto L2a
        L3e:
            r0 = 1
        L3f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.NF.A03(com.facebook.ads.NativeAdLayout):boolean");
    }
}
