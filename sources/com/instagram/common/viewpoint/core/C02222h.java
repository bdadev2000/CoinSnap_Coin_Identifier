...
public final class C02222h extends Drawable {
    ...
    public C02222h(ColorStateList colorStateList, float f2) {
        this.A01 = f2;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = C02242j.A01(this.A00, this.A01, this.A07);
            float vInset = C02242j.A00(this.A00, this.A01, this.A07);
    ...
    public final void A07(float f2, boolean z2, boolean z3) {
        if (f2 == this.A00 && this.A06 == z2 && this.A07 == z3) {
            return;
        }
        this.A00 = f2;
        this.A06 = z2;
