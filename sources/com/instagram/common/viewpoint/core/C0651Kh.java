...
public final class C0651Kh {
    public static C0651Kh A03;
    ...
    public final C0650Kg A01 = new C0650Kg();
    ...
    public C0651Kh(C7j c7j) {
        this.A00 = c7j;
    }

    public static C0651Kh A00(C7j c7j) {
        if (A03 == null) {
            A03 = new C0651Kh(c7j);
        }
        return A03;
    ...
    private final String A02(String str) {
        return this.A01.A04(this.A00, str, A01(Opcodes.PUTFIELD, 2, 89));
    }
    ...
    private void A05(String str) {
        A06(str, 0);
        this.A01.A06(this.A00, str, A01(Opcodes.PUTFIELD, 2, 89));
    }

    private void A06(String str, int i2) {
        if (str.equals(AdPlacementType.REWARDED_VIDEO.toString())) {
            this.A01.A05(this.A00, A01(154, 13, 61), i2);
            return;
        }
        if (str.equals(AdPlacementType.INTERSTITIAL.toString())) {
            this.A01.A05(this.A00, A01(65, 23, Opcodes.DNEG), i2);
            return;
        }
        if (str.equals(AdPlacementType.BANNER.toString())) {
            this.A01.A05(this.A00, A01(48, 17, 18), i2);
            return;
        }
        if (str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString())) {
            this.A01.A05(this.A00, A01(88, 26, 112), i2);
        } else if (str.equals(AdPlacementType.NATIVE.toString())) {
            this.A01.A05(this.A00, A01(Opcodes.L2F, 17, 5), i2);
        } else {
            if (!str.equals(AdPlacementType.NATIVE_BANNER.toString())) {
                return;
            }
            this.A01.A05(this.A00, A01(Opcodes.FREM, 23, 66), i2);
        }
    }
    ...
    public final int A0A(String str) {
        ...
        if (str.equals(AdPlacementType.INTERSTITIAL.toString())) {
            return this.A01.A03(this.A00, A01(65, 23, Opcodes.DNEG), 0);
        }
        if (str.equals(AdPlacementType.BANNER.toString())) {
        ...
        if (str.equals(AdPlacementType.NATIVE.toString())) {
            return this.A01.A03(this.A00, A01(Opcodes.L2F, 17, 5), 0);
        }
        if (!str.equals(AdPlacementType.NATIVE_BANNER.toString())) {
            return 0;
        }
        C0650Kg c0650Kg = this.A01;
        C7j c7j = this.A00;
        String A01 = A01(Opcodes.FREM, 23, 66);
        if (A05[5].charAt(25) != '7') {
            throw new RuntimeException();
        }
        A05[3] = "fotbcTaHfC";
        return c0650Kg.A03(c7j, A01, 0);
    }

    public final Pair<String, String> A0B(String str) {
        String A01 = A01(Opcodes.GOTO, 10, 12);
        String A02 = A02(str);
        if (A02 == null) {
            return null;
        }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(A01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(A01) < C0608Im.A02(this.A00)) {
    ...
    public final void A0C(String str) {
        try {
            ...
            JSONArray placementJSON = jSONArray.getJSONObject(0).getJSONArray(A01(11, 3, Opcodes.LUSHR));
            ...
            adData.put(A01(Opcodes.GOTO, 10, 12), System.currentTimeMillis());
    ...
    public final boolean A0F(String str) {
        return !C0608Im.A14(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
