...
public abstract class AbstractC0631Jn {
    ...
    public static EnumC0629Jl A00(DisplayMetrics displayMetrics) {
        int i2 = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = displayMetrics.heightPixels;
        int screenHeight = (int) (screenWidth / displayMetrics.density);
        if (LQ.A04(i2, screenHeight)) {
            return EnumC0629Jl.A0I;
        }
        if (screenHeight > i2) {
            EnumC0629Jl enumC0629Jl = EnumC0629Jl.A0K;
            String[] strArr = A00;
            String str = strArr[5];
        ...
        return EnumC0629Jl.A0H;
    }

    public static void A01(DisplayMetrics displayMetrics, View view, EnumC0627Jj enumC0627Jj) {
        int ceil;
        int i2 = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = enumC0627Jj.A04();
        if (i2 >= screenWidth) {
            ceil = displayMetrics.widthPixels;
        } else {
            int screenWidth2 = enumC0627Jj.A04();
            ceil = (int) Math.ceil(screenWidth2 * displayMetrics.density);
        }
        int screenWidth3 = enumC0627Jj.A03();
