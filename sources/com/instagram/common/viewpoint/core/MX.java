...
public final class MX extends AdNativeComponentView {
    ...
    public static final int A09 = ((int) LP.A02) * d.f29936c;
    ...
    public MX(C1045Zs c1045Zs, JW jw) {
        super(c1045Zs);
        this.A06 = jw;
        this.A05 = new TextView(c1045Zs);
        this.A04 = new TextView(c1045Zs);
        this.A03 = new TextView(c1045Zs);
        this.A02 = new RelativeLayout(c1045Zs);
        this.A00 = new LinearLayout(c1045Zs);
        this.A01 = new RelativeLayout(c1045Zs);
        this.A07 = new V8(c1045Zs);
        A09();
        A0D();
        A05();
        A0A();
    ...
    public final void onMeasure(int i2, int i3) {
        int A0F2 = ((int) LP.A02) * C0608Im.A0F(getContext());
        int heightThreshold = View.MeasureSpec.getSize(i3);
        if (heightThreshold < A0F2) {
            int heightThreshold2 = View.MeasureSpec.getMode(i3);
