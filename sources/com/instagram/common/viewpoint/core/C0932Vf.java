...
public final class C0932Vf {
    ...
    */
    public static void A00(int[] r43, int r44, int r45, int r46, int r47, int r48, int r49) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0932Vf.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f2) {
        ...
        try {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                int h3 = h2;
                int cores = i3;
                arrayList.add(new MD(iArr, w, h3, (int) f2, i2, cores, 1));
                h2 = h3;
                int cores2 = i3;
                vertical.add(new MD(iArr, w, h2, (int) f2, i2, cores2, 2));
            }
            try {
                ME.A01.invokeAll(arrayList);
                try {
                    ME.A01.invokeAll(vertical);
                    try {
