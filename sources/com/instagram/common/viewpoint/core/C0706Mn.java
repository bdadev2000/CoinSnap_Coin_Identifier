...
public final class C0706Mn extends RelativeLayout {
    public TextView A00;
    ...
    public C0706Mn(C1045Zs c1045Zs, int i2, int i3, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1045Zs);
        this.A05 = new TextView(c1045Zs);
        this.A02 = new Button(c1045Zs);
        this.A01 = new Button(c1045Zs);
        ...
        int A01 = AbstractC02302p.A01(i3, 20);
        M3.A0O(this.A02, i2, A07);
