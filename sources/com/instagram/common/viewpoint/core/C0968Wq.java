...
public final class C0968Wq implements InterfaceC0568Gx {
    ...
    public C0968Wq(HP hp, long j2) {
        this(hp, j2, 20480, true);
    }

    public C0968Wq(HP hp, long j2, int i2, boolean z2) {
        this.A09 = (HP) AbstractC0576Hf.A01(hp);
        this.A08 = j2;
        this.A07 = i2;
        this.A0A = z2;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0568Gx
    public final void AEG(H3 h3) throws C0969Wr {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0568Gx
    public final void close() throws C0969Wr {
        if (this.A02 == null) {
            return;
        }
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0568Gx
    public final void write(byte[] bArr, int i2, int i3) throws C0969Wr {
        if (this.A02 == null) {
            return;
        }
        int i4 = 0;
