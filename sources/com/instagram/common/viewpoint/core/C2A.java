...
public final class C2A extends Handler {
    ...
    public C2A(C1044Zr c1044Zr) {
        ...
        this.A03 = new ServiceConnection() { // from class: com.facebook.ads.redexgen.X.29
            ...
            public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                c1044Zr2 = C2A.this.A06;
                if (AbstractC0610Ip.A07(c1044Zr2)) {
                    C2A c2a = C2A.this;
    ...
    public final void A0A(String str, LZ lz, int i2) {
        if (this.A02) {
            this.A01 = lz;
    ...
    public final void A0B(boolean z2) {
        this.A02 = AnonymousClass28.A04(this.A06, z2, this.A03);
        if (this.A02) {
            ...
            handler.postDelayed(ky, AbstractC0610Ip.A01(this.A06));
            return;
        }
        AbstractC03628f.A04(this.A06);
    }
