...
public abstract class AbstractC03768t {
    ...
    public static String A02(final C7j c7j) {
        FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.facebook.ads.redexgen.X.8s
            ...
            public final String call() {
                ...
                atomicReference = AbstractC03768t.A04;
                ...
                if (userAgentString != null) {
                    atomicReference2 = AbstractC03768t.A04;
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ExecutorC0690Lx.A00(futureTask);
            try {
    ...
    public static String A03(C7j c7j, C8O c8o) {
        ...
        if (TextUtils.isEmpty(A07) && !A03.getAndSet(true)) {
            ...
            A072.AA0(bundle2, i2, c8f);
        }
        return A07;
    }

    public static String A04(C7j c7j, boolean z2) {
        if (c7j == null) {
            return A00;
        }
        if (z2) {
            return System.getProperty(A00(Opcodes.LSHR, 10, 59));
        }
        String str = A04.get();
        if (str != null) {
            return str;
        }
        long A012 = AbstractC0607Il.A01(c7j);
    ...
    public static String A05(C8O c8o, C7j c7j) {
        if (AbstractC0607Il.A04(c7j)) {
            return A00(63, 5, 5) + A03(c7j, c8o) + A00(39, 6, 61) + c8o.A06() + A00(45, 6, 61) + c8o.A04() + A00(38, 1, 85);
        }
        return A00(0, 0, 76);
    }

    public static String A06(C8O c8o, C7j c7j, boolean z2) {
        return A04(c7j, z2) + A00(0, 38, 50) + c7j.A04().A8f() + A00(57, 6, 26) + C8O.A04 + A00(38, 1, 85) + A05(c8o, c7j) + A00(68, 5, 13) + c7j.A04().A8g() + A00(51, 6, 8) + Locale.getDefault().toString() + A00(87, 1, 36);
    }

    public static void A09(C7j c7j, Throwable th) {
        c7j.A07().AA0(A00(Opcodes.IF_ACMPNE, 8, 78), C8E.A2i, new C8F(th));
    }
}
