...
public final class C1055a2 implements C6C {
    ...
    public C1055a2(C6D c6d, String str) {
        this.A00 = c6d;
        this.A01 = str;
    }

    public static C1055a2 A00(JSONObject jSONObject) {
        C6D A00 = C6D.A00(jSONObject.optString(A01(0, 4, 77)));
        String url = jSONObject.optString(A01(4, 3, 8));
        if (A00 == null || url == null) {
            return null;
        }
        return new C1055a2(A00, url);
    }

    @Override // com.instagram.common.viewpoint.core.C6C
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (cls == obj.getClass()) {
                C1055a2 c1055a2 = (C1055a2) obj;
                if (this.A00 != c1055a2.A00) {
                    return false;
                }
                return this.A01.equals(c1055a2.A01);
            }
        }
        return false;
    }
