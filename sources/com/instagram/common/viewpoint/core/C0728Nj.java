...
public final class C0728Nj extends LinearLayout {
    ...
    public final InterfaceC0738Nt A0C;
    ...
    static {
        ...
        A0J = new ViewOnTouchListenerC0722Nd();
        A0H = Color.argb(34, 0, 0, 0);
    }

    public C0728Nj(C1045Zs c1045Zs, WebView webView) {
        this(c1045Zs, webView, false);
    }

    public C0728Nj(C1045Zs c1045Zs, WebView webView, boolean z2) {
        super(c1045Zs);
        this.A09 = getResources().getDisplayMetrics().density;
        this.A0C = new V0(this);
        this.A0A = webView;
        this.A0B = c1045Zs;
        this.A08 = AbstractC0609In.A06(c1045Zs);
        this.A0D = z2;
        A08();
    }
    ...
    private void A08() {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC0723Ne(this));
        addView(this.A01, layoutParams);
        if (this.A08 && !C0608Im.A2j(this.A0B)) {
            ...
            this.A00.setOnClickListener(new ViewOnClickListenerC0724Nf(this));
            addView(this.A00, backButtonParams);
        }
        this.A06 = new C0734Np(this.A0B);
        ...
        if (C0608Im.A2j(this.A0B) && !this.A0D) {
            this.A04 = new LinearLayout(this.A0B);
            this.A04.setOrientation(1);
            LinearLayout linearLayout = this.A04;
            int i3 = (int) (this.A09 * 2.0f);
            int buttonSizePx2 = (int) (this.A09 * 2.0f);
            linearLayout.setPadding(0, i3, 0, buttonSizePx2);
            ...
            int i4 = (int) (this.A09 * 4.0f);
            int buttonSizePx3 = (int) (this.A09 * 4.0f);
            imageView.setPadding(0, i4, 0, buttonSizePx3);
        ...
        if (this.A08 && !C0608Im.A2j(this.A0B)) {
            ...
            this.A02.setOnClickListener(new ViewOnClickListenerC0725Ng(this));
        ...
        this.A03.setOnClickListener(new ViewOnClickListenerC0726Nh(this));
    ...
    private void A09() {
        ...
        if (packageManager != null) {
            List<ResolveInfo> queryIntentActivities = packageManager.queryIntentActivities(new Intent(A06(46, 26, Opcodes.LSHR), A0I), 65536);
            if (queryIntentActivities.isEmpty()) {
                ...
                if (queryIntentActivities.size() == 1 && queryIntentActivities.get(0).activityInfo != null) {
                    if (A06(72, 18, 116).equals(queryIntentActivities.get(0).activityInfo.packageName)) {
                        MB mb = MB.BROWSER_LAUNCH_CHROME;
                        if (A0F[2].length() == 9) {
    ...
    public InterfaceC0738Nt getBrowserNavigationListener() {
        return this.A0C;
    }

    public void setListener(InterfaceC0727Ni interfaceC0727Ni) {
        this.A05 = interfaceC0727Ni;
    }
