...
public abstract class OL extends Button {
    ...
    public OL(C1045Zs c1045Zs, C1O c1o) {
        super(c1045Zs);
        this.A03 = false;
        this.A01 = 0;
        this.A00 = 0;
        this.A04 = true;
        this.A05 = false;
        this.A08 = new C0908Uh(this);
        this.A09 = new C0907Ug(this);
        this.A02 = c1o;
        this.A07 = C0608Im.A05(c1045Zs);
        this.A06 = C0608Im.A00(c1045Zs);
    ...
    private void A04() {
        ...
        if (C0608Im.A2W(getContext()) && Build.VERSION.SDK_INT >= 16) {
