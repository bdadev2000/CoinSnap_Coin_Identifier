...
public final class C1056a3 implements AnonymousClass69 {
    ...
    public C1056a3(InterfaceC0640Jw interfaceC0640Jw) {
        this.A01 = interfaceC0640Jw.A54(SG.A0B);
        this.A01.A3n(new C1057a4(this));
        A03();
    }
    ...
    public static Set<C6C> A01(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            if (i2 < i3) {
                ...
                if (optJSONObject == null || (A00 = C1055a2.A00(optJSONObject)) == null) {
                    return null;
                }
                hashSet.add(A00);
                i2++;
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass69
