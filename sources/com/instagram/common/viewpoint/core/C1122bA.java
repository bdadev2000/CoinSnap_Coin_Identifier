...
public final class C1122bA<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC02392y<K, V> A00;
    ...
    private AbstractC02392y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1123bB(this);
        }
        return this.A00;
    }
