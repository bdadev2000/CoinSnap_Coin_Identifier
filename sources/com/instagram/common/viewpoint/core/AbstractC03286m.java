...
public abstract class AbstractC03286m extends AbstractC0512Ee {
    ...
    public Format A07;
    public InterfaceC0438Bg<FrameworkMediaCrypto> A08;
    public InterfaceC0438Bg<FrameworkMediaCrypto> A09;
    public DL A0A;
    ...
    public final C04029u A0W;
    public final C1023Yw A0X;
    public final C1023Yw A0Y;
    public final InterfaceC0439Bh<FrameworkMediaCrypto> A0Z;
    public final DR A0a;
    ...
    public abstract int A1C(DR dr, InterfaceC0439Bh<FrameworkMediaCrypto> interfaceC0439Bh, Format format) throws DU;

    public abstract void A1L(MediaCodec mediaCodec, MediaFormat mediaFormat) throws C03909h;

    public abstract void A1N(C1023Yw c1023Yw);

    public abstract void A1O(DL dl, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws DU;

    public abstract void A1P(String str, long j2, long j3);

    public abstract boolean A1Q(long j2, long j3, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i2, int i3, long j4, boolean z2) throws C03909h;
    ...
    public AbstractC03286m(int i2, DR dr, InterfaceC0439Bh<FrameworkMediaCrypto> interfaceC0439Bh, boolean z2) {
        super(i2);
        AbstractC0576Hf.A04(IK.A02 >= 16);
        this.A0a = (DR) AbstractC0576Hf.A01(dr);
        this.A0Z = interfaceC0439Bh;
        this.A0c = z2;
        this.A0X = new C1023Yw(0);
        this.A0Y = C1023Yw.A02();
        this.A0W = new C04029u();
    ...
    private int A0W(String str) {
        if (IK.A02 <= 25 && A0Z(255, 25, 12).equals(str) && (IK.A06.startsWith(A0Z(617, 7, 16)) || IK.A06.startsWith(A0Z(589, 7, 102)) || IK.A06.startsWith(A0Z(596, 7, 99)) || IK.A06.startsWith(A0Z(610, 7, 77)))) {
            return 2;
        }
        if (IK.A02 < 24) {
            if (A0Z(330, 22, Opcodes.LNEG).equals(str) || A0Z(352, 29, 80).equals(str)) {
    ...
    public static MediaCodec.CryptoInfo A0Y(C1023Yw c1023Yw, int i2) {
        MediaCodec.CryptoInfo A02 = c1023Yw.A02.A02();
        if (i2 == 0) {
            return A02;
        }
    ...
    private ByteBuffer A0b(int i2) {
        ...
        ByteBuffer byteBuffer = this.A0T[i2];
        String[] strArr = A0e;
        if (strArr[1].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0d() throws C03909h {
        if (this.A02 == 2) {
            A1H();
            A1J();
        } else {
    ...
    private void A0f() throws C03909h {
    ...
    private void A0k(DN dn) throws C03909h {
        throw C03909h.A01(dn, A0z());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:106:0x028c, code lost:
        ...
        throw com.instagram.common.viewpoint.core.C03909h.A01(r1, A0z());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:89:0x020f, code lost:
        ...
        com.instagram.common.viewpoint.core.I0.A0A(r13.A0X.A01);
     */
    /* JADX WARN: Code restructure failed: missing block: B:90:0x021e, code lost:
    
        if (r13.A0X.A01.position() != 0) goto L103;
     */
    ...
    */
    private boolean A0l() throws com.instagram.common.viewpoint.core.C03909h {
        /*
            Method dump skipped, instructions count: 653
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.A0l():boolean");
    }
    ...
    private boolean A0n(long j2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (this.A0b.get(i2).longValue() == j2) {
                this.A0b.remove(i2);
                return true;
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0o(long r21, long r23) throws com.instagram.common.viewpoint.core.C03909h {
        /*
            Method dump skipped, instructions count: 381
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.A0o(long, long):boolean");
    }

    /* JADX WARN: Code restructure failed: missing block: B:8:0x0046, code lost:
    
        if (r3.equals(r4) == false) goto L10;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0p(com.instagram.common.viewpoint.core.DL r5) {
        /*
            java.lang.String r4 = r5.A02
            int r1 = com.instagram.common.viewpoint.core.IK.A02
            r0 = 17
            if (r1 > r0) goto L48
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC03286m.A0e
            r0 = 3
            r1 = r2[r0]
            r0 = 5
            r2 = r2[r0]
            ...
            if (r0 != 0) goto L8e
        L48:
            java.lang.String r3 = com.instagram.common.viewpoint.core.IK.A05
            ...
            java.lang.String r0 = com.instagram.common.viewpoint.core.IK.A06
        ...
        L95:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.A0p(com.facebook.ads.redexgen.X.DL):boolean");
    }
    ...
    private boolean A0v(boolean z2) throws C03909h {
        if (0 == 0 || (!z2 && this.A0c)) {
            return false;
        }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0512Ee
    public void A16(long j2, boolean z2) throws C03909h {
        this.A0M = false;
        this.A0N = false;
        if (this.A06 != null) {
            A1G();
    ...
    public DL A1F(DR dr, Format format, boolean z2) throws DU {
        return dr.A7A(format.A0O, z2);
    }

    public void A1G() throws C03909h {
    ...
    public void A1I() throws C03909h {
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x00fc, code lost:
        ...
        r6 = A1R(r14.A0A);
        r2 = com.instagram.common.viewpoint.core.AbstractC03286m.A0e;
        r1 = r2[6];
        r0 = r2[2];
     */
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0112, code lost:
    
        if (r1.length() == r0.length()) goto L38;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0169, code lost:
        ...
        r0 = A0Z(665, 12, org.objectweb.asm.Opcodes.LUSHR);
        com.instagram.common.viewpoint.core.IH.A02(r6.append(r0).append(r9).toString());
        r14.A06 = android.media.MediaCodec.createByCodecName(r9);
        com.instagram.common.viewpoint.core.IH.A00();
        r0 = A0Z(651, 14, 108);
        com.instagram.common.viewpoint.core.IH.A02(r0);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x01f5, code lost:
        ...
        if (r1.length() == r0.length()) goto L51;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x021a, code lost:
        ...
        A0k(new com.instagram.common.viewpoint.core.DN(r14.A07, (java.lang.Throwable) r2, false, r9));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x009e, code lost:
        ...
        r0 = A0Z(org.objectweb.asm.Opcodes.I2B, 40, 56);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00ea, code lost:
        ...
        if (r14.A0A != null) goto L32;
     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00ec, code lost:
    
        A0k(new com.instagram.common.viewpoint.core.DN(r14.A07, (java.lang.Throwable) null, false, -49999));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0117, code lost:
        ...
        A0k(new com.instagram.common.viewpoint.core.DN(r14.A07, (java.lang.Throwable) r3, false, -49998));
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A1J() throws com.instagram.common.viewpoint.core.C03909h {
        /*
            Method dump skipped, instructions count: 550
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.A1J():void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1M(com.facebook.ads.internal.exoplayer2.thirdparty.Format r8) throws com.instagram.common.viewpoint.core.C03909h {
        /*
            r7 = this;
            ...
            r0 = r1
        Lc:
            boolean r0 = com.instagram.common.viewpoint.core.IK.A0g(r2, r0)
            r3 = 1
            r0 = r0 ^ r3
            if (r0 == 0) goto L4d
            com.facebook.ads.internal.exoplayer2.thirdparty.Format r0 = r7.A07
        ...
        Lbd:
            ...
            goto Lbc
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.A1M(com.facebook.ads.internal.exoplayer2.thirdparty.Format):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x00d7, code lost:
        ...
        com.instagram.common.viewpoint.core.AbstractC0576Hf.A04(r6.A0Y.A04());
        r6.A0M = true;
        A0d();
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void AFe(long r7, long r9) throws com.instagram.common.viewpoint.core.C03909h {
        /*
            Method dump skipped, instructions count: 231
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC03286m.AFe(long, long):void");
    }

    @Override // com.instagram.common.viewpoint.core.AF
    public final int AH6(Format format) throws C03909h {
        try {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0512Ee, com.instagram.common.viewpoint.core.AF
