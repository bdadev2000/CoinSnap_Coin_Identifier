...
public final class C02724g extends DP {
    ...
    public C02724g(List<byte[]> list) {
        super(A02(Opcodes.INVOKEVIRTUAL, 10, 122));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String A0Q = IK.A0Q(list.get(0));
            String formatLine = A02(47, 8, 30);
            AbstractC0576Hf.A03(A0Q.startsWith(formatLine));
            A06(A0Q);
    ...
    public final XK A0b(byte[] bArr, int i2, boolean z2) {
        ArrayList arrayList = new ArrayList();
        C0591Hu c0591Hu = new C0591Hu();
        I4 i4 = new I4(bArr, i2);
        if (!this.A04) {
            A04(i4);
        }
        A05(i4, arrayList, c0591Hu);
        C0539Fs[] c0539FsArr = new C0539Fs[arrayList.size()];
        arrayList.toArray(c0539FsArr);
        return new XK(c0539FsArr, c0591Hu.A05());
    }
    ...
    private void A04(I4 i4) {
        ...
        } while (!A0P.startsWith(A02(Opcodes.CHECKCAST, 8, 109)));
    }

    private void A05(I4 i4, List<C0539Fs> list, C0591Hu c0591Hu) {
        while (true) {
            String A0P = i4.A0P();
            if (A0P != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x005d, code lost:
        ...
        if (r7.equals(A02(216, 5, 26)) != false) goto L8;
     */
    /*
    ...
    */
    private void A06(java.lang.String r9) {
        ...
        L2a:
            ...
            java.lang.String r7 = com.instagram.common.viewpoint.core.IK.A0M(r0)
            int r0 = r7.hashCode()
            switch(r0) {
        ...
        L81:
            ...
            if (r0 == r5) goto La8
            int r3 = r8.A00
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C02724g.A06
            r0 = 4
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        Lab:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C02724g.A06(java.lang.String):void");
    }

    private void A07(String str, List<C0539Fs> list, C0591Hu c0591Hu) {
        int i2 = this.A01;
        String A02 = A02(Opcodes.INVOKEVIRTUAL, 10, 122);
        if (i2 == 0) {
        ...
        String endTimeString = split[this.A03].replaceAll(A02(206, 7, Opcodes.LNEG), A02(0, 0, 39));
        String A023 = A02(200, 3, 65);
        String A024 = A02(0, 1, 63);
        list.add(new C0539Fs(endTimeString.replaceAll(A023, A024).replaceAll(A02(203, 3, 23), A024)));
        c0591Hu.A04(startTimeUs);
        if (j2 != -9223372036854775807L) {
            list.add(null);
            c0591Hu.A04(j2);
        }
