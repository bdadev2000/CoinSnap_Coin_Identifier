...
public final class LW extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC0828Rf {
    ...
    public EnumC0830Rh A0C;
    public EnumC0830Rh A0D;
    public InterfaceC0831Ri A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    public LW(C1045Zs c1045Zs) {
        super(c1045Zs);
        this.A0C = EnumC0830Rh.A04;
        ...
        this.A0M = new C0825Rc(this);
        this.A0I = false;
        this.A0N = c1045Zs;
    }

    public LW(C1045Zs c1045Zs, AttributeSet attributeSet) {
    ...
    public LW(C1045Zs c1045Zs, AttributeSet attributeSet, int i2) {
    ...
    private boolean A06() {
        return (this.A0C == EnumC0830Rh.A08 || this.A0C == EnumC0830Rh.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC0830Rh.A07 || this.A0C == EnumC0830Rh.A0A || this.A0C == EnumC0830Rh.A05 || this.A0C == EnumC0830Rh.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A07().AA0(A03(384, 6, 110), C8E.A2H, new C8F(e));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A07().AA0(A03(384, 6, 110), C8E.A2I, new C8F(e));
            return false;
        }
    }
    ...
    public final void AEN(boolean z2, int i2) {
        ...
        if (this.A06 != null) {
            ...
            this.A0J = z2;
            this.A06.pause();
            if (this.A0C != EnumC0830Rh.A06) {
                setVideoState(EnumC0830Rh.A05);
                return;
            }
            return;
        }
    ...
    public final void AGt(EnumC0815Qs enumC0815Qs, int i2) {
        this.A0N.A0E().A3a(i2);
        this.A0J = false;
        this.A0D = EnumC0830Rh.A0A;
        this.A0B = enumC0815Qs;
        if (this.A0C == EnumC0830Rh.A0A || this.A0C == EnumC0830Rh.A07 || this.A0C == EnumC0830Rh.A04 || this.A0C == EnumC0830Rh.A05 || this.A0C == EnumC0830Rh.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC0830Rh.A07 || this.A0K) {
                    setVideoState(EnumC0830Rh.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i2, int i3) {
        this.A0N.A0E().AAr(A03(390, 11, 85) + i2 + A03(0, 14, 21) + i3 + A03(14, 2, 108));
        if (this.A01 > 0 && getState() == EnumC0830Rh.A0A) {
            this.A01--;
            AH1(6);
            AGt(this.A0B, 10);
        } else {
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i3) {
        ...
        if (!A0A(this.A08)) {
            ...
            this.A0N.A0E().A3T(4);
            destroy();
        } else if (this.A0C == EnumC0830Rh.A05 && !this.A0J) {
            AGt(this.A0B, 7);
        }
    }
    ...
    */
    public final void onWindowFocusChanged(boolean r6) {
        ...
        L15:
            ...
            com.facebook.ads.redexgen.X.Rh r0 = com.instagram.common.viewpoint.core.EnumC0830Rh.A05
            if (r1 == r0) goto La6
            ...
            if (r0 != 0) goto L8d
            com.facebook.ads.redexgen.X.Zs r0 = r5.A0N
            boolean r3 = com.instagram.common.viewpoint.core.C0608Im.A1v(r0)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.LW.A0P
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 22
        ...
        L42:
            ...
            com.facebook.ads.redexgen.X.Rh r3 = com.instagram.common.viewpoint.core.EnumC0830Rh.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.LW.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
        ...
        L54:
            ...
            throw r0
        L6d:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.LW.A0P
        ...
        La7:
            ...
            goto La6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.LW.onWindowFocusChanged(boolean):void");
    }
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC0827Re(this));
    }
    ...
    public void setFullScreen(boolean z2) {
        this.A0H = z2;
        if (this.A0H && !this.A0G) {
            setOnTouchListener(new ViewOnTouchListenerC0826Rd(this));
        }
    }
    ...
    public void setRequestedVolume(float f2) {
        this.A00 = f2;
        if (this.A06 == null || this.A0C == EnumC0830Rh.A08) {
            return;
        }
        EnumC0830Rh enumC0830Rh = this.A0C;
        String[] strArr = A0P;
        if (strArr[0].charAt(16) == strArr[7].charAt(16)) {
            throw new RuntimeException();
        }
        A0P[3] = "xC5rxgqNbqLUjjPrr";
        if (enumC0830Rh != EnumC0830Rh.A04) {
    ...
    private void setVideoState(EnumC0830Rh enumC0830Rh) {
        if (enumC0830Rh != this.A0C) {
            if (this.A0N.A04().A9O()) {
                String str = A03(356, 23, 106) + enumC0830Rh;
            }
            this.A0C = enumC0830Rh;
            if (this.A0E != null) {
                this.A0E.AEA(enumC0830Rh);
            }
        }
    }
