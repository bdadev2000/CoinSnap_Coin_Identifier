...
public final class Y2 implements D3 {
    ...
    */
    private void A00(com.instagram.common.viewpoint.core.I4 r9) {
        /*
            r8 = this;
            byte[] r6 = r9.A00
            int r5 = r9.A06()
        ...
        L42:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Y2.A00(com.facebook.ads.redexgen.X.I4):void");
    }

    private void A01(I4 i4) {
    ...
    private void A02(I4 i4) {
        int min = Math.min(i4.A04(), 4 - this.A00);
        i4.A0c(this.A0A.A00, this.A00, min);
        this.A00 += min;
        if (this.A00 < 4) {
            return;
        }
    ...
    public final void A5B(InterfaceC0457Bz interfaceC0457Bz, DH dh) {
        dh.A05();
        this.A06 = dh.A04();
        this.A05 = interfaceC0457Bz.AHA(dh.A03(), 1);
    }
