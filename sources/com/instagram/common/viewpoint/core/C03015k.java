...
public final class C03015k implements NativeAdApi {
    ...
    public C03015k(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        W7.A0L(nativeAdBaseApi).A1a(EnumC0629Jl.A06);
    }

    public C03015k(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1045Zs A11 = A00().A11();
            C1045Zs downloadContext = C02925b.A03(imageView.getContext());
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C1075aM) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C1075aM) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
