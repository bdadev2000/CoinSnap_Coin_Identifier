...
public final class BX extends AbstractC0904Ud {
    ...
    static {
        ...
        A0K = (int) (LP.A02 * 8.0f);
        A0R = AbstractC02302p.A01(-1, 77);
        A0N = (int) (LP.A02 * 16.0f);
        A0U = (int) (LP.A02 * 12.0f);
    }

    public BX(C0757Om c0757Om) {
        super(c0757Om, false);
        this.A0F = new AtomicBoolean(false);
        this.A09 = false;
        this.A08 = false;
        this.A02 = c0757Om.A05();
        this.A04 = c0757Om.A09();
        ...
        A06();
        this.A0A = c0757Om.A0A();
        AbstractC0746Ob.A00(c0757Om.A05(), this, getAdInfo().A0E().A07());
        this.A0D = A01(c0757Om);
        getAdDetailsView().bringToFront();
        this.A0E = A02(c0757Om);
        ...
        A14();
        this.A06 = new C0797Qa(this.A02, c0757Om.A06(), getAdDataBundle());
        this.A0B = new C0902Ub(this);
        this.A0C = new OS(c0757Om, getAdDataBundle(), this.A0D, this.A0E, getAdDetailsView(), this.A0A, this.A0B);
        LK A0A = super.A07.A0A(getAdDataBundle());
        this.A02.A0G().A00(A0A.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A07);
        if (A0A.A00) {
            this.A0D.getVideoImplView().setOnClickListener(new ViewOnClickListenerC0760Op(this));
        } else if (C0608Im.A1E(getAdContextWrapper())) {
            OB.A00(this.A0D.getVideoImplView(), C0608Im.A1F(getAdContextWrapper()), new ViewOnClickListenerC0761Oq(this));
        }
        if (c0757Om.A04().A1C()) {
            this.A05 = new UP(c0757Om);
            View view = this.A05;
    ...
    private T7 A01(C0757Om c0757Om) {
        T7 t7 = (T7) c0757Om.A02();
        int A13 = A13(c0757Om.A09());
        ImageView imageView = (ImageView) c0757Om.A03();
        int i2 = AbstractC0904Ud.A0F;
        int i3 = AbstractC0904Ud.A0F;
        int toolbarHeight = AbstractC0904Ud.A0F;
        imageView.setPadding(i2, i3, toolbarHeight, AbstractC0904Ud.A0F);
        int toolbarHeight2 = AbstractC0904Ud.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0904Ud.A0G);
        int toolbarHeight3 = AbstractC0904Ud.A0E;
        layoutParams.setMargins(0, A13, toolbarHeight3, 0);
        layoutParams.addRule(11);
        layoutParams.addRule(10);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
        if (getAdDataBundle().A1F() && t7 != null) {
            View videoView = t7.getVideoView();
    ...
    private N5 A02(C0757Om c0757Om) {
        N5 A0B = c0757Om.A0B();
        A0B.A06(-1, AbstractC0904Ud.A0B);
        A0B.setPadding(AbstractC0904Ud.A0J, AbstractC0904Ud.A0J, AbstractC0904Ud.A0J, AbstractC0904Ud.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0904Ud.A0I);
    ...
    private void A05() {
        ...
        ViewOnClickListenerC0909Ui ctaButton = getCtaButton();
    ...
    private void A07() {
        ...
        switch ((QZ) r2.first) {
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0904Ud.A0H, AbstractC0904Ud.A0H, AbstractC0904Ud.A0H, AbstractC0904Ud.A0H);
        ...
        if (getAdInfo().A0H().A00() >= 0) {
            ...
            this.A03 = new LH((int) getAdInfo().A0H().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0901Ua(this));
            this.A03.A07();
        }
    }
    ...
    private void A0A(RelativeLayout relativeLayout) {
        ...
        M3.A0M(ou, 0);
        M3.A0K(ou);
        new AsyncTaskC0914Un(ou, this.A02).A05(A0M, A0M).A07(getAdDataBundle().A1S().A01());
        ...
        OW ow = new OW(c1045Zs, i2, 5, A0R, -1);
        ow.setGravity(16);
    ...
    public final boolean A12(boolean z2) {
        ...
        if (!z3) {
            this.A0D.A0a(EnumC0810Qn.A08);
            return true;
        }
        return false;
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC0904Ud
    ...
    public final void A17() {
        new JF(((AbstractC0753Oi) this).A06.A04().A1U(), getAdEventManager()).A04(JE.A0f, null);
        if (((AbstractC0753Oi) this).A06.A09() != null) {
            MQ A09 = ((AbstractC0753Oi) this).A06.A09();
            if (A0H[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0H[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            A09.setVisibility(8);
            removeView(((AbstractC0753Oi) this).A06.A09());
        }
        removeView(this.A05);
        removeView(this.A0D);
        A04();
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0904Ud, com.instagram.common.viewpoint.core.AbstractC0753Oi, android.view.View
