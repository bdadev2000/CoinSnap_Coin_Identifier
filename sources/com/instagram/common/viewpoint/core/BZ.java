...
public class BZ extends UO {
    ...
    public final AbstractC0858Sj A09;
    public final AbstractC0852Sd A0A;
    public final AbstractC0836Rn A0B;
    public final R9 A0C;
    public final AbstractC0802Qf A0D;
    public final String A0E;
    public final Paint A0F;
    public final Path A0G;
    public final RectF A0H;
    public final C0757Om A0I;
    ...
    public BZ(C0757Om c0757Om, boolean z2, String str, TV tv) {
        super(c0757Om, z2);
        this.A0G = new Path();
        this.A0H = new RectF();
        this.A0D = new C0442Bk(this);
        this.A09 = new C0441Bj(this);
        this.A0B = new C0440Bi(this);
        this.A0A = new C0437Bf(this);
        this.A0C = new C0436Be(this);
        this.A0I = c0757Om;
        this.A07 = tv;
        this.A0E = str;
        this.A08 = c0757Om.A05();
        setGravity(17);
    ...
    */
    public void A04() {
        ...
        L5:
            ...
            if (r0 == 0) goto L25
            boolean r3 = r4.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.BZ.A0J
            r0 = 4
            r1 = r1[r0]
            r0 = 16
            ...
            r0 = 83
            if (r1 == r0) goto L35
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.BZ.A0J
        ...
        L35:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.BZ.A04():void");
    }
    ...
    public void setImageUrl(String str) {
        if (this.A00 != null) {
            ...
            new AsyncTaskC0914Un(this.A00, this.A08).A04().A06(new C0906Uf(this, null)).A07(str);
        }
        if (this.A02 != null) {
    ...
    public void setUpImageView(C1045Zs c1045Zs) {
        ...
        if (C0608Im.A1C(c1045Zs)) {
            OB.A00(this.A00, C0608Im.A1D(c1045Zs), new OM(this));
        }
        A06(this.A00);
    }
    ...
    public void setUpVideoView(C1045Zs c1045Zs) {
        this.A02 = new QM(c1045Zs, new JF(this.A0E, getAdEventManager()));
        if (C0608Im.A1E(c1045Zs)) {
            OB.A00(this.A02, C0608Im.A1F(c1045Zs), new ON(this));
        }
        QM qm = this.A02;
        if (A0J[2].charAt(30) != 'G') {
            throw new RuntimeException();
