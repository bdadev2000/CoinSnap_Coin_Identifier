...
public final class C0913Um extends AbstractC02192e {
    ...
    private void A05() {
        ...
        new AsyncTaskC0914Un(ou, this.A03).A05(A0D, A0D).A07(this.A02.A1S().A01());
    ...
    static {
        A06();
        A0C = (int) (AbstractC02192e.A08 * 12.0f);
        A0D = (int) (AbstractC02192e.A08 * 84.0f);
        A0B = (int) (AbstractC02192e.A08 * 14.0f);
        A09 = (int) (AbstractC02192e.A08 * 8.0f);
        A0A = AbstractC02302p.A01(-1, 77);
    }

    public C0913Um(C1045Zs c1045Zs, AbstractC1187cD abstractC1187cD, J7 j7, MR mr) {
        super(c1045Zs);
        ...
        AbstractC0746Ob.A00(c1045Zs, this.A01, abstractC1187cD.A1P().A0E().A07());
    ...
    private void A04() {
        ViewOnClickListenerC0909Ui viewOnClickListenerC0909Ui = new ViewOnClickListenerC0909Ui(this.A03, EnumC0818Qv.A04.A03(), this.A02.A1O().A01(), this.A02.A1P().A0G().A06(), this.A04, this.A06, null, this.A05, this.A02.A1Q());
        viewOnClickListenerC0909Ui.setViewShowsOverMedia(true);
        M3.A0G(1001, viewOnClickListenerC0909Ui);
        viewOnClickListenerC0909Ui.setCta(this.A02.A1P().A0G(), this.A02.A1U(), new HashMap(), null);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        viewOnClickListenerC0909Ui.setPadding(A0C, A0C, A0C, A0C);
        layoutParams.setMargins(A0C, A0C, A0C, A0C * 2);
        this.A00.addView(viewOnClickListenerC0909Ui, layoutParams);
    }
}
