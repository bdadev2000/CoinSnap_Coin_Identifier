...
public final class UQ extends AbstractC0753Oi {
    ...
    public TextView A0F;
    public AbstractC1187cD A0G;
    public C0728Nj A0H;
    public C0729Nk A0I;
    public C0925Uy A0J;
    public ViewOnClickListenerC0909Ui A0K;
    public C0757Om A0L;
    public PD A0M;
    public boolean A0N;
    public boolean A0O;
    ...
    public final AbstractC01710h A0c;
    public final JF A0d;
    public final OR A0e;
    public final OS A0f;
    public final N5 A0g;
    ...
    public static void A0X() {
        A0k = new byte[]{8, 92, 83, 86, 92, 84, 96, 76, 80, 74, 77, 92, 90, 121, 123, 106, 76, Byte.MAX_VALUE, 105, 86, 123, 119, 121, 118, 106, 124, 123, 101, 96, 97, 74, 120, 112, 97, 125, 122, 113, 77, 75, 93, 74, 91, 84, 81, 91, 83, 103, 94, 81, 84, 76, 93, 74, 93, 92, 64, 94, 89, 83, 88, 64, 78, 87, 80, 102, 90, 77, 88, 102, 91, 76, 77, 77, 86, 87, 119, 110, 105, 95, 119, 101, 98, 95, 105, 110, 115, 116, 97, 108, 108, 95, 98, 117, 116, 116, 111, 110, 41};
    }
    ...
    static {
        ...
        A0o = AbstractC02302p.A01(-1, 77);
        A0q = (int) (LP.A02 * 12.0f);
    }

    public UQ(C0757Om c0757Om) {
        super(c0757Om, true);
        this.A0X = false;
        this.A02 = -1;
        this.A0Y = false;
        ...
        this.A0B = (InputMethodManager) c0757Om.A05().getSystemService(A0J(25, 12, 55));
        this.A0L = c0757Om;
        this.A0G = this.A0L.A04();
        this.A0d = new JF(c0757Om.A04().A1U(), c0757Om.A06());
        this.A0g = this.A0L.A0B();
        if (this.A0g != null) {
            M3.A0K(this.A0g);
        }
        this.A0b = this.A0L.A03();
        this.A0c = C01720i.A01(c0757Om.A05(), c0757Om.A06(), c0757Om.A04().A1U(), L5.A00(c0757Om.A04().A1P().A0G().A05()), new HashMap(), false, true, this.A0G.A1Q());
        AbstractC0746Ob.A00(c0757Om.A05(), this, c0757Om.A04().A1P().A0E().A07());
        ...
        T7 t7 = this.A0L.A02() instanceof T7 ? (T7) this.A0L.A02() : null;
        this.A0f = new OS(c0757Om, this.A0G, t7, this.A0L.A0A(), this.A0e, this.A0F, this.A0M, this.A0g, this.A0b);
        if (t7 != null && C0608Im.A1E(getAdContextWrapper())) {
            OB.A00(t7.getVideoImplView(), C0608Im.A1F(getAdContextWrapper()), new P4(this));
        } else if (t7 == null && this.A0A != null && C0608Im.A1C(getAdContextWrapper())) {
            OB.A00(this.A0A, C0608Im.A1D(getAdContextWrapper()), new P5(this));
        }
        this.A0E = null;
        this.A0K = null;
    }

    public UQ(C0757Om c0757Om, boolean z2) {
        this(c0757Om);
        this.A0X = z2;
        AbstractC1187cD A04 = c0757Om.A04();
    ...
    public void A16() {
        A0d(((C0547Ga) this.A0c).A0G().toString());
        A0g(true);
    }

    private void A0M() {
        ExecutorC0690Lx.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.Ox
            @Override // java.lang.Runnable
            public final void run() {
                UQ.this.A15();
            }
    ...
    private void A0Q() {
        if (this.A0b != null) {
            M3.A0J(this.A0b);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC0753Oi.A08, AbstractC0753Oi.A08);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC0753Oi.A07, this.A07, AbstractC0753Oi.A07, AbstractC0753Oi.A07);
    ...
    private void A0V() {
        ...
        if (this.A0Y && this.A0K != null) {
            ...
            ViewOnClickListenerC0909Ui viewOnClickListenerC0909Ui = this.A0K;
            String[] strArr = A0l;
            if (strArr[6].charAt(18) != strArr[5].charAt(18)) {
                throw new RuntimeException();
            }
            ...
            viewOnClickListenerC0909Ui.setLayoutParams(layoutParams2);
        }
    }
    ...
    public void A0d(String str) {
        ...
        if (!AbstractC0609In.A02(this.A0L.A05()) && this.A0L.A05().A0D() != null) {
            c0925Uy = new C0925Uy(this.A0L.A05(), this.A0L.A05().A0D(), uv);
        } else {
            c0925Uy = new C0925Uy(this.A0L.A05(), uv);
        }
        this.A0J = c0925Uy;
        if (this.A0X) {
            this.A0J.setInterceptRedirectRequest(new InterfaceC0736Nr() { // from class: com.facebook.ads.redexgen.X.UY
        ...
        if (this.A0G.A1B() && Build.VERSION.SDK_INT > 16) {
            this.A0J.addJavascriptInterface(new C0748Od(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Ou
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    UQ.this.A17(view);
                }
            }, this.A0J, new InterfaceC0747Oc() { // from class: com.facebook.ads.redexgen.X.UX
                @Override // com.instagram.common.viewpoint.core.InterfaceC0747Oc
        ...
        if (this.A0Y || this.A0G.A1B()) {
            ...
            this.A0K = new ViewOnClickListenerC0909Ui(A05, A0Y, A00, this.A0L.A04().A1P().A0G().A06(), this.A0L.A06(), this.A0L.A0A(), this.A0L.A0C(), this.A0L.A08(), this.A0L.A04().A1Q());
    ...
    public void A0g(boolean z2) {
        ...
        postDelayed(new UU(this, z2), 250L);
        String A0J = A0J(97, 1, Opcodes.FREM);
        if (z2) {
            objectAnimator = ObjectAnimator.ofFloat(this.A0M, A0J, this.A0M.getY(), this.A05 / 5);
        }
        LinearLayout linearLayout = this.A0C;
        float y2 = this.A0C.getY();
        int i2 = this.A05;
        if (z2) {
            i2 /= 5;
        }
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(linearLayout, A0J, y2, i2);
        ...
        ValueAnimator duration = ValueAnimator.ofInt(height, i3).setDuration(500L);
        ...
        animatorSet.addListener(new P2(this, z2));
        animatorSet.start();
    }

    private void A0h(boolean z2) {
        ...
        if (z3) {
            ...
            if (C0608Im.A1C(getAdContextWrapper()) && getResources().getConfiguration().orientation == 2 && !(this.A0A instanceof T7)) {
    ...
    */
    public final void A10(com.instagram.common.viewpoint.core.C1F r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        /*
            r5 = this;
        ...
        L17:
            ...
            r0 = 8
            com.instagram.common.viewpoint.core.M3.A0N(r1, r0)
            com.facebook.ads.redexgen.X.Om r0 = r5.A0L
            com.facebook.ads.redexgen.X.Zs r0 = r0.A05()
            boolean r0 = com.instagram.common.viewpoint.core.C0608Im.A12(r0)
            if (r0 == 0) goto L30
            android.widget.LinearLayout r1 = r5.A0D
            r0 = 0
            r1.setClickable(r0)
        ...
        L49:
            ...
            r3 = 1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.UQ.A0l
            r0 = 2
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L81:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.UQ.A10(com.facebook.ads.redexgen.X.1F, java.lang.String, double, android.os.Bundle):void");
    }
    ...
    public final /* synthetic */ void A18(View view) {
        ExecutorC0690Lx.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.Ow
            @Override // java.lang.Runnable
            public final void run() {
                UQ.this.A14();
            }
    ...
    private void setUpBrowserControls(C0925Uy c0925Uy) {
        M3.A0J(this.A0H);
        this.A0H = new C0728Nj(this.A0L.A05(), c0925Uy, true);
        c0925Uy.setBrowserNavigationListener(this.A0H.getBrowserNavigationListener());
        M3.A0K(this.A0H);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.weight = 0.1f;
        this.A0H.setListener(new UW(this));
        this.A0H.setOnTouchListener(new ViewOnTouchListenerC0770Oz(this));
        this.A0C.addView(this.A0H, layoutParams);
        M3.A0J(this.A0I);
        this.A0I = new C0729Nk(this.A0L.A05(), null, R.attr.progressBarStyleHorizontal);
