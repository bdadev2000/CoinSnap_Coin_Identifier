...
public final class OD extends RelativeLayout implements InterfaceC0816Qt, View.OnClickListener {
    public T7 A00;
    ...
    public OD(C1045Zs c1045Zs) {
        ...
        this.A02 = new AbstractC0852Sd() { // from class: com.facebook.ads.redexgen.X.7c
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.AbstractC03808x
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A03 = new AbstractC0836Rn() { // from class: com.facebook.ads.redexgen.X.7Z
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.AbstractC03808x
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A01 = new AbstractC0858Sj() { // from class: com.facebook.ads.redexgen.X.7X
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.AbstractC03808x
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
    ...
    public final void onClick(View view) {
        ...
        try {
            ...
            if (this.A00.getState() == EnumC0830Rh.A07 || this.A00.getState() == EnumC0830Rh.A05 || this.A00.getState() == EnumC0830Rh.A06) {
                this.A00.A0b(EnumC0815Qs.A04, 11);
            } else if (this.A00.getState() == EnumC0830Rh.A0A) {
                this.A00.A0e(true, 7);
            }
        } catch (Throwable th) {
            KQ.A00(th, this);
