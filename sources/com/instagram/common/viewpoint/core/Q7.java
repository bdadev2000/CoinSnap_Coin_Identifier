...
public final class Q7 extends LinearLayout {
    ...
    public Q7(Q5 q5) {
        ...
        this.A06 = new C0745Oa(this.A04, Q5.A02(q5), true, false, true);
        this.A03 = Q5.A00(q5);
        this.A02 = Q5.A08(q5);
        this.A01 = Q5.A05(q5);
        A03(q5);
    ...
    public /* synthetic */ Q7(Q5 q5, C0882Th c0882Th) {
        this(q5);
    }
    ...
    private void A02(Q5 q5) {
        if (!TextUtils.isEmpty(Q5.A06(q5))) {
            ...
            int i4 = A0C;
            int marginTop = A0C;
            linearLayout.setPadding(i3, i2, i4, marginTop / 2);
            ...
            new AsyncTaskC0914Un(imageView, this.A04).A04().A07(Q5.A07(q5));
            int i5 = A0A;
            int marginTop2 = A0A;
            LinearLayout.LayoutParams informativeContainerParams = new LinearLayout.LayoutParams(i5, marginTop2);
            int marginTop3 = A0C;
            informativeContainerParams.setMargins(0, 0, marginTop3 / 2, 0);
            if (this.A02) {
                OO oo = new OO(getContext(), 0, -1, MB.PLAYABLE_ICON);
                oo.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(oo);
            } else {
    ...
    private void A03(Q5 q5) {
        ...
        new AsyncTaskC0914Un(this.A05, this.A04).A04().A07(Q5.A03(q5).A01());
    ...
    public final void A04(Q6 q6) {
        A00();
        postDelayed(new C0882Th(this, q6), this.A03);
    }
}
