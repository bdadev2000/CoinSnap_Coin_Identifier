...
public final class C1249dE {
    ...
    public /* synthetic */ C1249dE(AbstractC1244d8 abstractC1244d8) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C1243d7.A07(collection, A00(31, 1, 39));
        int i2 = 1;
    ...
    public final void A03(int i2, int i3) {
        if (i2 >= 0 && i2 < i3) {
            ...
            throw new IndexOutOfBoundsException(A00(43, 7, 95) + i2 + A00(12, 8, 8) + i3);
        }
    }
    ...
    public final void A05(int i2, int i3, int i4) {
        ...
        if (i2 >= 0 && i3 <= i4) {
            if (i2 <= i3) {
                ...
                throw new IllegalArgumentException(A002 + i2 + A00(0, 12, 21) + i3);
            }
        }
        throw new IndexOutOfBoundsException(A002 + i2 + A00(20, 11, 49) + i3 + A00(12, 8, 8) + i4);
    }

    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C1243d7.A07(collection, A00(31, 1, 39));
        C1243d7.A07(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C1243d7.A0A(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
