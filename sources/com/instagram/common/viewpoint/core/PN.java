...
public abstract class PN {
    public static BP A00(final C0757Om c0757Om, int i2, final String str, final TV tv) {
        if (i2 == 1) {
            return new BP(c0757Om, str, tv) { // from class: com.facebook.ads.redexgen.X.3Q
                ...
                @Override // com.instagram.common.viewpoint.core.BP
                public final void A1A(C1045Zs c1045Zs) {
                    C0745Oa titleDescContainer = getTitleDescContainer();
        ...
        return new BP(c0757Om, str, tv) { // from class: com.facebook.ads.redexgen.X.3b
            ...
            @Override // com.instagram.common.viewpoint.core.BP, com.instagram.common.viewpoint.core.AbstractC0753Oi
