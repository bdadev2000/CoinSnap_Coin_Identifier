...
public final class C1145bX implements InterfaceC03427f {
    public long A00;
    ...
    public C1145bX(C1045Zs c1045Zs, InterstitialAd interstitialAd, String str) {
        this(c1045Zs, interstitialAd, str, new C1155bh());
    }

    public C1145bX(C1045Zs c1045Zs, InterstitialAd interstitialAd, String str, InterfaceC03608d interfaceC03608d) {
        this.A0A = c1045Zs;
        this.A0B = str;
    ...
    public final InterfaceC03608d A06() {
        return this.A09;
    }
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C0608Im.A0r(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
