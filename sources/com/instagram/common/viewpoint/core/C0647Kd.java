...
public final class C0647Kd {
    ...
    public static final ThreadLocal<C0647Kd> A02 = new ThreadLocal<>();
    ...
    public static KM A01(C0646Kc c0646Kc) {
        KM currentStackTraces = new KM(A00());
        currentStackTraces.add(c0646Kc);
        return currentStackTraces;
    }

    public static C0647Kd A02() {
        C0647Kd c0647Kd = A02.get();
        if (c0647Kd == null) {
            C0647Kd c0647Kd2 = new C0647Kd();
            A02.set(c0647Kd2);
            return c0647Kd2;
        }
        return c0647Kd;
