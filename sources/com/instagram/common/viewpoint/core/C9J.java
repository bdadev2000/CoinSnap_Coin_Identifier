...
public final class C9J implements Closeable {
    ...
    public final synchronized int A09() throws IOException {
        ...
        i2 = 0;
        Iterator<C9I> it = this.A02.iterator();
        while (it.hasNext()) {
            i2 += it.next().A01();
        }
        return i2;
    ...
    private C9I A00() throws IOException {
        ...
        int i3 = i2 + 1;
        this.A02.add(new C9I(i3, new C9F(new File(this.A01.A05(), A01(i3)))));
    ...
    private void A04(int i2, File file) throws IOException {
        ...
        c9f.A05();
        this.A02.addFirst(new C9I(i2, c9f));
    }
    ...
    private void A05(AnonymousClass99 anonymousClass99, C9H c9h) throws IOException {
        ...
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    c9h.AFj(String.format(Locale.US, A02(260, 39, Opcodes.FNEG), file.getCanonicalPath()));
                }
            }
            ...
            if (!isEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (intValue < i3) {
                        c9h.AFj(String.format(Locale.US, A02(Opcodes.IF_ACMPNE, 61, 41), Integer.valueOf(intValue), Integer.valueOf(i3)));
                        hashSet.add((File) hashMap.remove(Integer.valueOf(intValue)));
                    }
                }
                while (i2 >= i3) {
                    File file2 = (File) hashMap.get(Integer.valueOf(i2));
                    try {
                        A04(i2, file2);
                        hashMap.remove(Integer.valueOf(i2));
                        i2--;
                    } catch (IOException e) {
                        c9h.AFk(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i2)), e);
        ...
        IOException e2 = new IOException(String.format(Locale.US, A02(66, 38, 13), anonymousClass99.A05().getCanonicalPath()));
        throw e2;
    }
    ...
    public final synchronized AnonymousClass97 A0A(int i2, int i3, byte[] bArr, int i4, int[] iArr, int i5) throws IOException {
        if (!this.A00) {
            for (C9I file : this.A02) {
                if (file.A00() == i2) {
                    return new AnonymousClass97(i2, file.A02(i3, bArr, i4, iArr, i5));
                }
            }
