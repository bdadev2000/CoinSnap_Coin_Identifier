...
public abstract class MA {
    public static Bitmap A00(C1045Zs c1045Zs, Bitmap bitmap, int i2) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c1045Zs);
    ...
    public static Bitmap A01(C1045Zs c1045Zs, Bitmap bitmap, int i2, int i3) {
        ...
        try {
            Bitmap A00 = A00(c1045Zs, createBitmap, i2);
            if (i3 != 1) {
            ...
            return new C0932Vf().A02(createBitmap, i2);
        }
    }
}
