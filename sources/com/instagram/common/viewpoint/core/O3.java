...
public class O3 extends WebViewClient {
    ...
    public final WeakReference<C0916Up> A03;
    public final WeakReference<O1> A04;
    public final WeakReference<AtomicBoolean> A05;
    public final WeakReference<C0688Lv> A06;
    public final WeakReference<C0833Rk> A07;
    ...
    public static void A02() {
        byte[] bArr = {8, 38, 40, 45, 42, -14, 8, 52, 51, 57, 55, 52, 49, -69, -36, -27, -32, -36, -37, 28, 77, 56, 67, 76, 56, 75, 64, 69, 62, -9, 44, 41, 32, -9, 39, 56, 75, Utf8.REPLACEMENT_BYTE, -9, 61, 70, 73, -9, 29, 64, 67, 60, -9, 24, 58, 58, 60, 74, 74, -9, -46, 5, 1, -1, -18, -83, -15, -18, 1, -18, -57, -83, 60, 72, 72, 68, 20, 57, 102, 102, 99, 102, 59, 84, 89, 71, 76, 75, 6, 56, 75, 87, 91, 75, 89, 90, 6, 76, 85, 88, 6, 44, 79, 82, 75, 6, 39, 73, 73, 75, 89, 89, 6, 34, 59, 64, 46, 51, 50, -19, 31, 50, 62, 66, 50, 64, 65, -19, 51, 60, Utf8.REPLACEMENT_BYTE, -19, 19, 54, 57, 50, -19, 14, 48, 48, 50, 64, 64, -19, 49, 50, 59, 54, 50, 49, 67, 68, 77, 72, 68, 67, 62, 84, 81, 72, 62, 79, 64, 83, 71, Utf8.REPLACEMENT_BYTE, 76, 76, 73, 76, 57, 61, 73, 62, Utf8.REPLACEMENT_BYTE, 40, 53, 53, 50, 53, 34, 39, 40, 54, 38, 53, 44, 51, 55, 44, 50, 49, 15, 10, 31, 18, 12, 24, 23, -41, 18, 12, 24, 19, 22, 25, 18, 89, 99, 79, 103, 85, 82, 79, 98, 85, 99, 95, 101, 98, 83, 85, 79, 85, 98, 98, 95, 98, 70, 73, 59, 62, 67, 72, 65, 57, 78, 67, 71, Utf8.REPLACEMENT_BYTE, 57, 67, 72, 57, 71, 67, 70, 70, 67, 77, -3, -12, 3, -55, -55, -44, -31, -31, -18, -44, -36, -33, -29, -24, -18, -31, -44, -30, -33, -34, -35, -30, -44, 46, 47, -19, 51, 52, 47, 50, 37, 66, 53, 65, 69, 53, 67, 68, 47, 57, 52, 101, 86, 105, 101, 32, 97, 93, 82, 90, 95, -8, -29, -18, -21, -26, -31, -14, -29, -10, -22, 62, 44, 41, 38, 61, 48, 44, 62};
        String[] strArr = A0C;
    ...
    public O3(C1045Zs c1045Zs, WeakReference<O1> weakReference, WeakReference<C0833Rk> weakReference2, WeakReference<C0688Lv> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C0916Up> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z2) {
        this.A02 = c1045Zs;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(286, 10, Opcodes.LSHR), StandardCharsets.UTF_8.name(), 403, A01(13, 6, 1), Collections.singletonMap(A01(0, 13, 79), A01(268, 8, 74)), new ByteArrayInputStream(A01(13, 6, 1).getBytes()));
    }
    ...
    private void A03(int i2, CharSequence charSequence, long j2) {
        ...
        try {
            jSONObject.put(A01(Opcodes.IF_ICMPNE, 10, 100), i2);
            jSONObject.put(A01(Opcodes.TABLESWITCH, 17, 77), charSequence);
            jSONObject.put(A01(202, 21, 122), z2);
            jSONObject.put(A01(223, 22, 100), j2);
    ...
    public void A04(int i2, String str) {
        ...
        this.A02.A0E().AHZ(i2, str);
        Date finishTime = new Date();
        long time = finishTime.getTime();
        Date finishTime2 = this.A00;
        A03(i2, str, time - finishTime2.getTime());
        if (this.A04.get() != null) {
            this.A04.get().ABx(i2, str);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x006c, code lost:
        ...
        r5 = com.instagram.common.viewpoint.core.C03226f.A09(r7.A02);
        r6 = A0A(r3, r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0098, code lost:
        ...
        r4 = com.instagram.common.viewpoint.core.C0916Up.A0H;
        r0 = A01(108, 37, 87);
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.O3.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.instagram.common.viewpoint.core.C03226f.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.instagram.common.viewpoint.core.C0916Up.A03()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.O3.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AHb();
        this.A00 = new Date();
        new Handler().postDelayed(new C0917Uq(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A0y = C0608Im.A0y(this.A02);
