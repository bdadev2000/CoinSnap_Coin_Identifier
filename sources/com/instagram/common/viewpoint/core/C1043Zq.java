...
public final class C1043Zq extends AbstractC03557w {
    ...
    static {
        A04();
        A04 = new C7q(0, A00(Opcodes.IF_ICMPEQ, 8, 1), A00(73, 16, 127));
        ...
        A07 = new C7q(5, A00(Opcodes.ATHROW, 12, 31), A007);
        A06 = new C7q(6, A00(Opcodes.PUTFIELD, 10, 87), A005);
        A03 = new C7q(7, A00(155, 4, 103), A005);
        A02 = new C7q(8, A00(Opcodes.LCMP, 7, 8), A003);
        A0B = new C7q[]{A04, A09, A05, A0A, A08, A07, A06, A03, A02};
        A0C = AbstractC03557w.A02(A00(Opcodes.GOTO, 6, 97), A0B);
    }

    public C1043Zq(C03527s c03527s) {
        super(c03527s);
    }
    ...
    public final String A0E(String str, int i2, String str2, double d, double d2, String str3, Map<String, String> map) throws SQLiteException {
