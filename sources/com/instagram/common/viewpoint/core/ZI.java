...
public final class ZI implements AnonymousClass91 {
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:35:0x00f2 A[Catch: 9L -> 0x0138, TryCatch #5 {9L -> 0x0138, blocks: (B:33:0x00e6, B:35:0x00f2, B:36:0x0101, B:19:0x0089, B:24:0x008f, B:26:0x009b, B:27:0x00dc, B:62:0x010a, B:63:0x010e, B:65:0x0114, B:67:0x0124, B:68:0x0128, B:70:0x012e), top: B:32:0x00e6 }] */
    ...
    */
    public final int A0B(int r13, java.util.Set<java.lang.String> r14, java.util.Set<java.lang.String> r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.ZI.A0B(int, java.util.Set, java.util.Set):int");
    }
    ...
    public ZI(C1044Zr c1044Zr) throws IOException {
        this.A00 = c1044Zr;
        this.A01 = new ZF(AnonymousClass99.A00(A00(11, 28, 27), c1044Zr), new ZK(this));
        this.A02 = new ZF(AnonymousClass99.A00(A00(322, 37, 96), c1044Zr), new ZJ(this));
    }
    ...
    public void A04(int i2, String str) {
        C8F c8f = new C8F(str);
        c8f.A05(1);
        this.A00.A07().AA1(A00(425, 15, 3), i2, c8f);
    }

    private void A05(int i2, Throwable th) {
        this.A00.A07().AA0(A00(425, 15, 3), i2, new C8F(th));
    }

    public static byte[] A07(C7j c7j, String str, J4 j4) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(A00(423, 2, Opcodes.FREM), str);
            jSONObject.put(A00(466, 5, 95), j4.A08());
            jSONObject.put(A00(471, 4, 24), j4.A06().toString());
            jSONObject.put(A00(462, 4, 49), C0687Lu.A02(j4.A04()));
            jSONObject.put(A00(450, 12, Opcodes.LUSHR), C0687Lu.A02(j4.A03()));
            jSONObject.put(A00(440, 10, 20), j4.A07());
            jSONObject.put(A00(419, 4, 55), new JSONObject(j4.A09()));
    ...
    */
    public final java.util.List<org.json.JSONObject> A0C(int r8) {
        ...
        L7:
            ...
            r3.<init>()
            com.facebook.ads.redexgen.X.9C<com.facebook.ads.redexgen.X.J4> r0 = r7.A01     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            com.facebook.ads.redexgen.X.9B r0 = r0.A61(r4, r1)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            r3.add(r0)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            int r2 = r0.A62()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            java.util.List r5 = r7.A01(r5, r4, r1)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
        L28:
            boolean r0 = r0.AAk()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            if (r0 == 0) goto L4b
            if (r2 < r8) goto L32
            if (r6 == 0) goto L4b
        L32:
            if (r6 == 0) goto L39
            r0 = 0
            java.util.Arrays.fill(r1, r0)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            goto L3d
        L39:
            int r0 = r8 - r2
            int[] r1 = new int[r0]     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
        L3d:
            com.facebook.ads.redexgen.X.9C<com.facebook.ads.redexgen.X.J4> r0 = r7.A01     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            com.facebook.ads.redexgen.X.9B r0 = r0.A61(r4, r1)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            r3.add(r0)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            ...
            goto L28
        L4b:
            java.util.Iterator r2 = r5.iterator()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
        L4f:
            boolean r0 = r2.hasNext()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            if (r0 == 0) goto L65
            java.lang.Object r0 = r2.next()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            org.json.JSONObject r0 = (org.json.JSONObject) r0     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            com.facebook.ads.redexgen.X.9C<com.facebook.ads.redexgen.X.J4> r1 = r7.A02     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            byte[] r0 = A09(r0)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            r1.AH3(r0)     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            goto L4f
        L65:
            java.util.Iterator r1 = r3.iterator()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
        L69:
            boolean r0 = r1.hasNext()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            if (r0 == 0) goto L9a
            java.lang.Object r0 = r1.next()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            com.facebook.ads.redexgen.X.9B r0 = (com.instagram.common.viewpoint.core.C9B) r0     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            r0.A5O()     // Catch: com.instagram.common.viewpoint.core.C9L -> L79
            goto L69
        L79:
            r4 = move-exception
            ...
            boolean r0 = r0.A9O()
            if (r0 == 0) goto L95
            java.lang.String r3 = com.instagram.common.viewpoint.core.ZI.A05
        ...
        L95:
            int r0 = com.instagram.common.viewpoint.core.C8E.A2M
            r7.A05(r0, r4)
        L9a:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.ZI.A0C(int):java.util.List");
    }
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass91
    public final void AHh(final J4 j4, final AbstractC03818y<String> abstractC03818y) {
        Executor executor = M8.A07;
        final C9C<J4> c9c = this.A01;
        final C1044Zr c1044Zr = this.A00;
        M5.A00(executor, new AsyncTask<Void, Void, String>(j4, abstractC03818y, c9c, c1044Zr) { // from class: com.facebook.ads.redexgen.X.92
            public static byte[] A05;
            public C9L A00;
            public final C7j A01;
            public final AbstractC03818y<String> A02;
