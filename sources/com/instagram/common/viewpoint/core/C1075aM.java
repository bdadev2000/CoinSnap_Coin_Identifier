...
public final class C1075aM extends C5Y implements MediaViewApi, Repairable, InterfaceC03417e {
    ...
    private final void A0C(C1045Zs c1045Zs, AttributeSet attributeSet, int i2, int i3, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1045Zs, attributeSet, i2, i3));
        A0H(new O5(c1045Zs, attributeSet, i2, i3));
        this.A08 = new C3C(c1045Zs, attributeSet, i2);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1045Zs, attributeSet, i2, i3));
        A07();
    }

    private final void A0D(C1045Zs c1045Zs, AttributeSet attributeSet, int i2, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1045Zs, attributeSet, i2));
        A0H(new O5(c1045Zs, attributeSet, i2));
        this.A08 = new C3C(c1045Zs, attributeSet, i2);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1045Zs, attributeSet, i2));
        A07();
    }

    private final void A0E(C1045Zs c1045Zs, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1045Zs, attributeSet));
        A0H(new O5(c1045Zs, attributeSet));
        this.A08 = new C3C(c1045Zs, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1045Zs, attributeSet));
        A07();
    }

    private final void A0F(C1045Zs c1045Zs, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1045Zs));
        A0H(new O5(c1045Zs));
        this.A08 = new C3C(c1045Zs);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1045Zs));
        A07();
    }

    private void A0G(W7 w7, boolean z2, JU ju) {
        AsyncTaskC0914Un A04 = new AsyncTaskC0914Un(this.A02, this.A07).A04();
        if (z2) {
            A04.A06(new C1082aT(this, w7));
        }
        A04.A07(ju.getUrl());
    }

    private void A0H(O5 o5) {
        if (!this.A0D) {
            if (this.A09 != null) {
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C03015k) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C03015k) nativeAd.getNativeAdApi()).A02());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x02f3, code lost:
        ...
        new com.instagram.common.viewpoint.core.AsyncTaskC0914Un(r17.A03, r17.A07).A05(r17.A03.getHeight(), r17.A03.getWidth()).A06(new com.instagram.common.viewpoint.core.C1078aP(r17, r2)).A07(r2.getAdCoverImage().getUrl());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x0326, code lost:
        ...
        android.util.Log.i(com.instagram.common.viewpoint.core.C1075aM.A0G, A04(292, 9, 49) + ((com.instagram.common.viewpoint.core.C03015k) r18.getNativeAdApi()).A02());
     */
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1075aM.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z2) {
        C1045Zs A11 = ((W7) nativeAdBaseApi).A11();
        C1045Zs adObjectContext = this.A07;
        ...
        ((C02985h) this.A05.getMediaViewVideoRendererApi()).A03();
        if (this.A01 != null) {
            this.A01.setVisibility(8);
            if (this.A01 instanceof C0741Nw) {
                ((C0741Nw) this.A01).A04();
            } else {
        ...
        if (adIcon != null) {
            ...
            if (A0M != null) {
                ...
                if (z2) {
                    this.A03.post(new C1083aU(this, A0L));
                }
            } else {
                A0G(A0L, z2, adIcon);
            }
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C1045Zs adObjectContext2 = this.A07;
                adObjectContext2.A07().AA0(A04(258, 3, 44), C8E.A0W, new C8F(A04(Opcodes.CHECKCAST, 23, 42)));
            }
        }
        A0A(this.A02, A0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1075aM.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1075aM.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1075aM.getMediaWidth():int");
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C5Y, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C02985h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C02985h) this.A05.getMediaViewVideoRendererApi()).A07(new C1076aN(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C02985h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            mediaViewVideoRenderer.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C1075aM) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
