...
public final class C8N {
    ...
    public static void A09(Context context) {
        ...
        A05.put(A01(61, 16, Opcodes.DREM), String.valueOf(memoryInfo.availMem));
    ...
    public static void A0A(C7j c7j) {
        try {
            ...
            int scale = A002.getIntExtra(A01(Opcodes.LSHR, 5, 78), -1);
            ...
            A05.put(A01(77, 7, 100), String.valueOf(f2));
            Map<String, String> map = A05;
            String A012 = z2 ? A01(1, 1, 69) : A01(0, 1, 82);
            ...
            c7j.A07().AA0(A01(102, 7, 96), C8E.A1T, new C8F(e));
        }
    }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr2 != null) {
            ...
            for (int i3 = 0; i3 < min2; i3++) {
                map.put(A01(Opcodes.FREM, 9, 19) + A08[i3], String.valueOf(fArr2[i3]));
            }
        }
    }
}
