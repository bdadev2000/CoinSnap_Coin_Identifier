...
public final class AO {
    ...
    private AP A00(AP ap, AM am) {
        ...
        Object uid = am2.A0A(et.A02, this.A04, true).A03;
        int newPeriodIndex = am.A04(uid);
        if (newPeriodIndex == -1) {
            return ap;
        }
        int newWindowIndex = am.A09(newPeriodIndex, this.A04).A00;
        return new AP(newWindowIndex, ap.A01.A00(newPeriodIndex));
    }
    ...
    public final Et A07(int i2) {
        ...
        if (this.A00 != null) {
            ...
            for (int periodIndex = 0; periodIndex < this.A05.size(); periodIndex++) {
                ...
                int i3 = match.A02;
                if (i3 < A00 && this.A00.A09(i3, this.A04).A00 == i2) {
                    if (et != null) {
                        return null;
                    }
                    et = mediaPeriod.A01;
    ...
    public final void A0B(int i2, Et et) {
        this.A05.add(new AP(i2, et));
        if (this.A05.size() == 1 && !this.A00.A0E()) {
            A02();
        }
    }

    public final void A0C(int i2, Et et) {
        AP mediaPeriod;
        AP ap = new AP(i2, et);
        this.A05.remove(ap);
    ...
    public final void A0D(int i2, Et et) {
        this.A02 = new AP(i2, et);
    }
    ...
    */
    public final void A0E(com.instagram.common.viewpoint.core.AM r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.AP r0 = (com.instagram.common.viewpoint.core.AP) r0
        ...
        L29:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AO.A0E(com.facebook.ads.redexgen.X.AM):void");
    }
