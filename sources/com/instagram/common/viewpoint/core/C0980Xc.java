...
public final class C0980Xc implements EP {
    ...
    public final H3 A00;
    public final HP A01;
    public final C0967Wp A02;
    public final I8 A04;
    public final HU A03 = new HU();
    public final AtomicBoolean A05 = new AtomicBoolean();

    public C0980Xc(Uri uri, String str, EQ eq) {
    ...
    public final void A5Z() throws InterruptedException, IOException {
        this.A04.A00(-1000);
        try {
            HV.A03(this.A00, this.A01, this.A02, new byte[Opcodes.ACC_DEPRECATED], this.A04, -1000, this.A03, this.A05, true);
        } finally {
            this.A04.A03(-1000);
        }
    }
