...
public final class AnonymousClass66 extends AbstractC0512Ee implements Handler.Callback {
    ...
    public final C04029u A0A;
    public final InterfaceC0542Fv A0B;
    public final InterfaceC0543Fw A0C;

    public AnonymousClass66(InterfaceC0543Fw interfaceC0543Fw, Looper looper) {
        this(interfaceC0543Fw, looper, InterfaceC0542Fv.A00);
    }

    public AnonymousClass66(InterfaceC0543Fw interfaceC0543Fw, Looper looper, InterfaceC0542Fv interfaceC0542Fv) {
        super(3);
        this.A0C = (InterfaceC0543Fw) AbstractC0576Hf.A01(interfaceC0543Fw);
        this.A09 = looper == null ? null : new Handler(looper, this);
        this.A0B = interfaceC0542Fv;
        this.A0A = new C04029u();
    }
    ...
    private void A05(List<C0539Fs> list) {
        this.A0C.ABg(list);
    }

    private void A06(List<C0539Fs> list) {
        if (this.A09 != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x00d4, code lost:
        ...
        r4 = r10.A06;
        r2 = com.instagram.common.viewpoint.core.AnonymousClass66.A0D;
     */
    ...
    */
    public final void AFe(long r11, long r13) throws com.instagram.common.viewpoint.core.C03909h {
        /*
            Method dump skipped, instructions count: 408
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AnonymousClass66.AFe(long, long):void");
    }
    ...
    public final int AH6(Format format) {
        ...
        if (!AbstractC0594Hx.A0A(format.A0O)) {
            return 0;
        }
    ...
    public final boolean handleMessage(Message message) {
        switch (message.what) {
            case 0:
                List<C0539Fs> list = (List) message.obj;
                if (A0D[4].charAt(24) == 'c') {
                    throw new RuntimeException();
                }
                String[] strArr = A0D;
