    ...
    */
    public static int A05(org.xmlpull.v1.XmlPullParser r5) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        L23:
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.LE.A02
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.LE.A05(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static void A09(Context context) {
        ...
        A04 = LD.A03;
        Executors.newSingleThreadExecutor().execute(new C0942Vp(context));
    }

    public static void A0A(C7j c7j, Throwable th) {
        c7j.A07().AA0(A06(38, 7, 85), C8E.A1c, new C8F(th));
    }
                ...
                loop0: while (true) {
                    ...
                    if (xmlResourceParser.getEventType() == 2 && (xmlResourceParser.getName().equals(A06(27, 11, 23)) || xmlResourceParser.getName().equals(A06(19, 8, 90)))) {
                        for (int i2 = 0; i2 < xmlResourceParser.getAttributeCount(); i2++) {
                            if (xmlResourceParser.getAttributeName(i2).equals(A06(58, 18, 8)) && !Boolean.parseBoolean(xmlResourceParser.getAttributeValue(i2))) {
                                z2 = false;
                                break loop0;
                            }
                        }
