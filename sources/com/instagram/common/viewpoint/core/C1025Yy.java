...
public final class C1025Yy implements InterfaceC0414Ag {
    public static String[] A0D = {"NxTbi7bx", "NV", "29YIJTQraO09", "tSBtmW6rpVAi", "UK8XAzXUIUX", c.f29536f, "AP", "UABkszmBYQrswcP0tzS304augAMBuSYm"};
    public long A06;
    public long A07;
    public BB A08;
    public boolean A0C;
    ...
    public int A05 = -1;
    public int A03 = -1;
    public ByteBuffer A09 = InterfaceC0414Ag.A00;
    public ShortBuffer A0B = this.A09.asShortBuffer();
    public ByteBuffer A0A = InterfaceC0414Ag.A00;
    public int A04 = -1;

    public final float A00(float f2) {
        float A00 = IK.A00(f2, 0.1f, 8.0f);
        if (this.A00 != A00) {
            this.A00 = A00;
            this.A08 = null;
        }
    ...
    public final long A02(long j2) {
        if (this.A07 >= RealWebSocket.DEFAULT_MINIMUM_DEFLATE_SIZE) {
            if (this.A03 == this.A05) {
                return IK.A0F(j2, this.A06, this.A07);
            }
            return IK.A0F(j2, this.A06 * this.A03, this.A07 * this.A05);
        }
    ...
    public final boolean A4m(int i2, int i3, int i4) throws C0413Af {
        ...
        if (i4 == 2) {
            ...
            if (outputSampleRateHz == i2) {
                int outputSampleRateHz2 = this.A02;
                if (outputSampleRateHz2 == i3) {
                    int outputSampleRateHz3 = this.A03;
                    if (outputSampleRateHz3 == i5) {
                        return false;
                    }
                }
            }
    ...
    public final void AEh() {
        AbstractC0576Hf.A04(this.A08 != null);
        this.A08.A0J();
        this.A0C = true;
    }
    ...
    */
    public final void AEi(java.nio.ByteBuffer r7) {
        ...
        L5:
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1025Yy.A0D
            r0 = 5
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        Lb7:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1025Yy.AEi(java.nio.ByteBuffer):void");
    }
