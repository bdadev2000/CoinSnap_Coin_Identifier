...
public abstract class AbstractC1240d4 {
    ...
    public static final <T> void A02(Appendable appendable, T t2, InterfaceC0574Hd<? super T, ? extends CharSequence> interfaceC0574Hd) {
        C1243d7.A07(appendable, A00(0, 6, 22));
        if (interfaceC0574Hd != null) {
            appendable.append(interfaceC0574Hd.A9K(t2));
            return;
        }
