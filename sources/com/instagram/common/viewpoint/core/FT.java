...
public final class FT extends AbstractC1094af {
     ...
     */
    @Override // com.instagram.common.viewpoint.core.AbstractC1094af
    public final boolean A0T(AnonymousClass56 anonymousClass56, int i2, int i3, int i4, int i5) {
        View view = anonymousClass56.A0H;
        int translationX = i2 + ((int) anonymousClass56.A0H.getTranslationX());
        int translationY = i3 + ((int) anonymousClass56.A0H.getTranslationY());
        ...
        this.A09.add(new C4M(anonymousClass56, translationX, translationY, i4, i5));
        return true;
    }
    ...
    */
    public final void A0J() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.FT.A0J():void");
    }
    ...
    public final void A0K(AnonymousClass56 anonymousClass56) {
        ...
        for (int i2 = this.A09.size() - 1; i2 >= 0; i2--) {
            if (this.A09.get(i2).A04 == anonymousClass56) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                A0O(anonymousClass56);
                this.A09.remove(i2);
        ...
        for (int i3 = this.A03.size() - 1; i3 >= 0; i3--) {
            ArrayList<C4L> arrayList = this.A03.get(i3);
        ...
        for (int size = this.A05.size() - 1; size >= 0; size--) {
            ...
            int i4 = arrayList2.size() - 1;
            while (true) {
                if (i4 < 0) {
                    break;
                }
                if (arrayList2.get(i4).A04 == anonymousClass56) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    A0O(anonymousClass56);
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC1094af
    public final boolean A0U(AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562, int i2, int i3, int i4, int i5) {
        if (anonymousClass56 == anonymousClass562) {
            return A0T(anonymousClass56, i2, i3, i4, i5);
        }
        ...
        A04(anonymousClass56);
        float prevTranslationX = i4 - i2;
        int deltaY = (int) (prevTranslationX - translationX);
        float prevTranslationX2 = i5 - i3;
        ...
        this.A08.add(new C4L(anonymousClass56, anonymousClass562, i2, i3, i4, i5));
        return true;
    }
    ...
    public final void A0Y(final AnonymousClass56 anonymousClass56, int i2, int i3, int i4, int i5) {
        final View view = anonymousClass56.A0H;
        final int i6 = i4 - i2;
        final int i7 = i5 - i3;
        if (i6 != 0) {
