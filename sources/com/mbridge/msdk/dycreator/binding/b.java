...
public final class b {
    ...
    private static volatile b f15203a;
    private d b = (d) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0154a.VIEW_OBSERVER);

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.dycreator.g.c f15204c = (com.mbridge.msdk.dycreator.g.c) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0154a.CLICK_OBSERVER);

    /* renamed from: d, reason: collision with root package name */
    private f f15205d = (f) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0154a.EFFECT_OBSERVER);

    /* renamed from: e, reason: collision with root package name */
    private h f15206e = (h) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0154a.REPORT_OBSERVER);

    /* renamed from: f, reason: collision with root package name */
    private BaseViewModel f15207f;

    /* renamed from: g, reason: collision with root package name */
    private com.mbridge.msdk.shake.b f15208g;
        ...
        e eVar = new e() { // from class: com.mbridge.msdk.dycreator.binding.b.2
            ...
            public final void a(Object obj) {
                try {
                    ...
                    ad.b("MBDataBinding", e4.getMessage());
                }
            }
        };
        int id = view.getId();
                ...
                if (view instanceof InterBase) {
                    ...
                    if (!TextUtils.isEmpty(actionDes)) {
                        if (actionDes.startsWith(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                            ...
                            int id = view.getId();
                            com.mbridge.msdk.dycreator.g.c cVar = this.f15204c;
                            if (cVar != null) {
                                cVar.a(bVar, id);
                            }
    ...
    public static /* synthetic */ void c(b bVar, InterBase interBase, Object obj) {
        ...
        try {
            Object a6 = com.mbridge.msdk.dycreator.e.d.a(obj, bindDataDes);
            if (a6 == null) {
                return;
            }
            if (interBase instanceof ViewGroup) {
                ...
                if (viewGroup instanceof MBSplashClickView) {
                    if (aVar.getEffectData() != null && aVar.getEffectData().isClickButtonVisible() && !aVar.getEffectData().isShakeVisible()) {
                        if (!TextUtils.isEmpty(a6.toString())) {
                            ...
                            ((MBSplashClickView) viewGroup).initView(a6.toString());
                        }
                    }
                ...
                if (viewGroup instanceof MBSplashShakeView) {
                    if (aVar.getEffectData() != null && aVar.getEffectData().isShakeVisible()) {
                        ...
                        viewGroup.setVisibility(0);
                        ((MBSplashShakeView) viewGroup).initView(a6.toString());
                        return;
                    }
                    viewGroup.setVisibility(8);
                    return;
            ...
            if (interBase instanceof View) {
                ...
                try {
                    if (view instanceof TextView) {
                        try {
                            ((TextView) view).setText(String.valueOf(a6).replace("\\n", "\n"));
                            return;
                        } catch (Exception e4) {
                            e4.printStackTrace();
                            return;
                    ...
                    if (view instanceof ImageView) {
                        if (a6 instanceof Integer) {
                            ((ImageView) view).setImageResource(((Integer) a6).intValue());
                        }
                        if (a6 instanceof String) {
                            com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.c.m().c()).a(a6.toString(), new com.mbridge.msdk.foundation.same.c.c() { // from class: com.mbridge.msdk.dycreator.binding.b.6
    ...
    public final void a(BaseViewModel baseViewModel) {
        this.f15207f = baseViewModel;
        if (baseViewModel != null) {
            baseViewModel.setClickSubject(this.f15204c);
            this.f15207f.setConcreteSubject(this.b);
            this.f15207f.setEffectSubject(this.f15205d);
            this.f15207f.setReportSubject(this.f15206e);
        }
    }
    ...
    private com.mbridge.msdk.shake.b a(final View view, final MBSplashData mBSplashData) {
        if (mBSplashData != null) {
            try {
                ...
                if (dyOption != null && dyOption.isShakeVisible() && this.f15208g == null) {
                    this.f15208g = new com.mbridge.msdk.shake.b(dyOption.getShakeStrenght(), dyOption.getShakeTime() * 1000) { // from class: com.mbridge.msdk.dycreator.binding.b.7
                            ...
                            if (view2 != null) {
                                try {
                                    if (view2.getGlobalVisibleRect(new Rect())) {
                                        ...
                                        com.mbridge.msdk.shake.a.a().b(b.this.f15208g);
                                    }
                                } catch (Exception e4) {
                                    ad.b("MBDataBinding", e4.getMessage());
                                }
                ...
                if (effectDes != null) {
                    if (effectDes.equals("wobble") && (viewGroup instanceof MBSplashShakeView)) {
                        if (aVar.getEffectData().isShakeVisible()) {
                            if (bVar.f15208g != null) {
                                com.mbridge.msdk.shake.a.a().b(bVar.f15208g);
                            }
                            com.mbridge.msdk.shake.a.a().a(bVar.a(viewGroup, (MBSplashData) aVar));
                        } else if (bVar.f15208g != null) {
                            com.mbridge.msdk.shake.a.a().b(bVar.f15208g);
                        }
                    }
                ...
                if (effectDes != null) {
                    ...
                    if (effectDes.equals("countdown") && (view instanceof TextView)) {
                        ...
                        if (effectData != null) {
                            ...
                            i9 = effectData.getCountDownTime();
                            z8 = isCanSkip;
                        } else {
                            i9 = 5;
                            z8 = false;
                        }
                        ((TextView) view).setText(com.mbridge.msdk.dycreator.e.d.a(z8, i9, str, s5));
                        ((com.mbridge.msdk.dycreator.f.a.a) obj).getEffectData().setDyCountDownListenerWrapper(new DyCountDownListenerWrapper() { // from class: com.mbridge.msdk.dycreator.binding.b.5
                            ...
                            public final void getCountDownValue(int i10) {
                                if (i10 == 0) {
                                    ...
                                    ((TextView) view).setText(com.mbridge.msdk.dycreator.e.d.a(z8, i10, str, s5));
                                }
                            }
                        });
                    }
