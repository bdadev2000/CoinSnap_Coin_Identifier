...
public class MBInduceClickView extends FrameLayout implements InterBase, InterEffect {
    ...
    private Map<String, Boolean> f12683b;
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12683b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12683b.get("mbridgeAttached").booleanValue()) {
            e.e("mbridgeAttached").a(this.f12684c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12683b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12683b.get("mbridgeDetached").booleanValue()) {
            e.e("mbridgeDetached").a(this.f12684c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12683b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12684c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBInduceClickView(Context context, AttributeSet attributeSet) {
        ...
        if (context != null && attributeSet != null) {
            try {
                ...
                ad.b("MBInduceClickView", e2.getMessage());
                return;
            }
        }
