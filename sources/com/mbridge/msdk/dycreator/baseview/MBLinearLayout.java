...
public class MBLinearLayout extends LinearLayout implements InterBase {
    ...
    private Map<String, String> f12686c;

    /* renamed from: d, reason: collision with root package name */
    private Map<String, Boolean> f12687d;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12686c;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f12686c.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f12686c.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f12686c.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f12686c.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f12686c.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12687d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12687d.get("mbridgeAttached").booleanValue()) {
            e.e("mbridgeAttached").a(this.f12688e);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12687d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12687d.get("mbridgeDetached").booleanValue()) {
            e.e("mbridgeDetached").a(this.f12688e);
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.f12685b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12687d = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12688e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBLinearLayout(Context context, AttributeSet attributeSet) {
        super(context);
        this.f12688e = "";
        this.f12686c = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
        a.a(this, attributeSet);
        setLayoutParams(generateLayoutParams(attributeSet));
        com.mbridge.msdk.dycreator.e.c.a(this.f12686c, this);
    }
