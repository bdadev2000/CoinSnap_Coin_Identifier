...
public class MBListView extends ListView implements InterBase {
    ...
    private Map<String, Boolean> f12689b;
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12689b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12689b.get("mbridgeAttached").booleanValue()) {
            e.e("mbridgeAttached").a(this.f12690c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12689b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12689b.get("mbridgeDetached").booleanValue()) {
            e.e("mbridgeDetached").a(this.f12690c);
        }
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12689b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12690c = campaignEx.getCampaignUnitId();
        }
    }
