...
public class MBExtFeedBackView extends FeedBackButton implements InterBase {
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12812b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12812b.get("mbridgeAttached").booleanValue()) {
            e.e("mbridgeAttached").a(this.f12813c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12812b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12812b.get("mbridgeDetached").booleanValue()) {
            e.e("mbridgeDetached").a(this.f12813c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12812b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12813c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtFeedBackView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            ad.b("MBExtFeedBackView", e2.getMessage());
        }
    }
