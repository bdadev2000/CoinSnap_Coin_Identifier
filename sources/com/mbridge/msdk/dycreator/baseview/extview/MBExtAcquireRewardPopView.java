...
public class MBExtAcquireRewardPopView extends MBAcquireRewardPopView implements InterBase {
    ...
    private Map<String, String> f15141a;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f15142a[c.background.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15142a[c.padding.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15142a[c.gravity.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15142a[c.visibility.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15142a[c.layout_width.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15142a[c.layout_height.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15142a[c.layout_centerHorizontal.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f15142a[c.layout_alignParentBottom.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f15142a[c.layout_alignParentTop.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f15142a[c.layout_centerVertical.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f15142a[c.layout_below.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f15142a[c.layout_above.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f15142a[c.layout_toLeftOf.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f15142a[c.layout_toRightOf.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f15142a[c.layout_toEndOf.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f15142a[c.layout_margin.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f15142a[c.layout_marginLeft.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f15142a[c.layout_marginRight.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f15142a[c.layout_marginTop.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f15142a[c.layout_marginBottom.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f15142a[c.layout_alignParentRight.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f15142a[c.layout_alignParentLeft.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f15142a[c.layout_alignTop.ordinal()] = 24;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f15142a[c.layout_alignLeft.ordinal()] = 25;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f15142a[c.layout_alignRight.ordinal()] = 26;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f15142a[c.layout_alignBottom.ordinal()] = 27;
            } catch (NoSuchFieldError unused27) {
            }
            try {
                f15142a[c.layout_centerInParent.ordinal()] = 28;
            } catch (NoSuchFieldError unused28) {
            }
            try {
                f15142a[c.layout_alignParentEnd.ordinal()] = 29;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f15141a;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f15141a.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f15141a.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f15141a.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f15141a.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f15141a.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i9 = 0; i9 < attributeCount; i9++) {
            ...
            if (cVar != null) {
                int i10 = AnonymousClass1.f15142a[cVar.ordinal()];
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 != 4) {
    ...
    public MBExtAcquireRewardPopView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f15141a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f15141a, this);
        } catch (Exception e4) {
            ad.b("MBExtAcquireRewardPopView", e4.getMessage());
        }
    }
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i9 = 0; i9 < attributeCount; i9++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f15142a[cVar.ordinal()]) {
                    case 6:
                        String attributeValue = attributeSet.getAttributeValue(i9);
    ...
    public MBExtAcquireRewardPopView(Context context, AttributeSet attributeSet, int i9) {
