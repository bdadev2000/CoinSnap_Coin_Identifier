...
public class DownloadMessage<T> {
    ...
    public DownloadMessage(T t9, String str, String str2, int i9, DownloadResourceType downloadResourceType) {
        this.checkMD5 = false;
        this.md5 = "";
        this.object = t9;
    ...
    public void setMd5VerifyResult(int i9) {
        this.md5VerifyResult = i9;
    }
    ...
    public void setUseCronetDownload(int i9) {
        boolean z8 = true;
        if (i9 != 1 && i9 != 2) {
            z8 = false;
        }
