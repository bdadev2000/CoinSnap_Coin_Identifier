...
public class ResourceConfig {
    ...
    public static class Builder {
        ...
        public Builder addMaxStorageSpace(DownloadResourceType downloadResourceType, long j3) {
            if (this.maxStorageSpacePerResourceType == null) {
                this.maxStorageSpacePerResourceType = new HashMap();
            }
            this.maxStorageSpacePerResourceType.put(downloadResourceType.name(), Long.valueOf(j3));
            return this;
        }

        public Builder addMaxStorageTime(DownloadResourceType downloadResourceType, long j3) {
            if (this.maxStorageTimePerResourceType == null) {
                this.maxStorageTimePerResourceType = new HashMap();
            }
            this.maxStorageTimePerResourceType.put(downloadResourceType.name(), Long.valueOf(j3));
            return this;
        }
        ...
        public Builder setMaxStorageSpace(long j3) {
            this.maxStorageSpace = j3;
            return this;
        }

        public Builder setMaxStorageTime(long j3) {
