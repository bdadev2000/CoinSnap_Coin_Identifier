...
public class ResourceConfig {
    ...
    public static class Builder {
        ...
        public Builder addMaxStorageSpace(DownloadResourceType downloadResourceType, long j7) {
            if (this.maxStorageSpacePerResourceType == null) {
                this.maxStorageSpacePerResourceType = new HashMap();
            }
            this.maxStorageSpacePerResourceType.put(downloadResourceType.name(), Long.valueOf(j7));
            return this;
        }

        public Builder addMaxStorageTime(DownloadResourceType downloadResourceType, long j7) {
            if (this.maxStorageTimePerResourceType == null) {
                this.maxStorageTimePerResourceType = new HashMap();
            }
            this.maxStorageTimePerResourceType.put(downloadResourceType.name(), Long.valueOf(j7));
            return this;
        }
        ...
        public Builder setMaxStorageSpace(long j7) {
            this.maxStorageSpace = j7;
            return this;
        }

        public Builder setMaxStorageTime(long j7) {
            this.maxStorageTime = j7;
            return this;
        }
    }
