...
public interface RequestBuilder<T> {
    ...
    RequestBuilder<T> withConnectTimeout(long j3);
    ...
    RequestBuilder<T> withReadTimeout(long j3);

    RequestBuilder<T> withTimeout(long j3);

    RequestBuilder<T> withUserAgent(String str);

    RequestBuilder<T> withWriteTimeout(long j3);
}
