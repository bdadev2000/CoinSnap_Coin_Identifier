...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j3, long j10, int i10, int i11, DownloadResourceType downloadResourceType, int i12) {
        ...
        downloadModel.setDownloadedBytes(j10);
        downloadModel.setTotalBytes(j3);
    ...
    public void setDownloadedBytes(long j3) {
    ...
    public void setUnZipResourceByte(long j3) {
        this.unZipResourceByte = j3;
    }
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j3, long j10, int i10, int i11, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
