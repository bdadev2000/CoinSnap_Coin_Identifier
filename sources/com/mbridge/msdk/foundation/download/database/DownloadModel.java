...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j7, long j9, int i9, int i10, DownloadResourceType downloadResourceType, int i11) {
        ...
        downloadModel.setDownloadedBytes(j9);
        downloadModel.setTotalBytes(j7);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i10);
        downloadModel.setDownloadRate(i9);
    ...
    public void setDownloadRate(int i9) {
        this.downloadRate = i9;
    }
    ...
    public void setUnZipResourceByte(long j7) {
        this.unZipResourceByte = j7;
    }
    ...
    public void setUsageCounter(int i9) {
        this.usageCounter = i9;
    }

    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j7, long j9, int i9, int i10, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
