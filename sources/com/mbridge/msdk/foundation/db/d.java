...
public class d extends a<JumpLoaderResult> {
    ...
    public static final String f15478a = "d";
    private static d b;
    ...
    */
    public final synchronized com.mbridge.msdk.click.entity.JumpLoaderResult b(java.lang.String r11, java.lang.String r12) {
        ...
        L51:
            ...
            if (r1 == 0) goto L5e
            java.lang.String r1 = com.mbridge.msdk.foundation.db.d.f15478a     // Catch: java.lang.Throwable -> L42
    ...
    public final synchronized long a(CampaignEx campaignEx, String str) {
        ...
        try {
            try {
                String a6 = aj.a(campaignEx.getJumpResult());
                ContentValues contentValues = new ContentValues();
                contentValues.put("id", campaignEx.getId());
                contentValues.put("unitid", str);
                contentValues.put("result", a6);
                ...
                if (b8 != null && b8.X() > 0) {
                    contentValues.put("cpei", Integer.valueOf(b8.X() * 1000));
                }
                if (b8 != null && b8.Y() > 0) {
                    contentValues.put("cpoci", Integer.valueOf(b8.Y() * 1000));
                }
