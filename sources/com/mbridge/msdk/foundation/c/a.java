...
public final class a {
    ...
    private static final SparseArray<String> f15361a;
    ...
    public static String a(int i9, String str) {
        return i9 + "#" + f15361a.get(i9) + "#" + str;
    }

    public static b a(int i9, int i10, String str) {
        return new b(i9, i10, str);
    }
}
