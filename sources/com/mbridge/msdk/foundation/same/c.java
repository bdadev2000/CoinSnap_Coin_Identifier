...
public final class c {
    ...
    public static String a(List<CampaignEx> list) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            try {
                ...
                ad.b("SameCommon", "getCreativeID", e2);
            }
        }
        return sb2.toString();
    }
    ...
    public static boolean a(Context context, CampaignEx campaignEx) {
        if (context != null && campaignEx != null) {
            boolean c10 = ai.c(context, campaignEx.getPackageName());
            if (ai.c(campaignEx) || campaignEx.getWtick() == 1 || !c10) {
                return true;
            }
        }
        return false;
    ...
    public static JSONObject a(String str) {
        ...
        try {
            ...
            ad.a("SameCommon", "coverReportMessage", e2);
            return null;
        } catch (Throwable th2) {
            ad.a("SameCommon", "coverReportMessage", th2);
            return null;
        }
    }
    ...
    public static void a(CampaignEx campaignEx, Context context, com.mbridge.msdk.foundation.same.report.d.b bVar, a aVar) {
        ...
        boolean c10 = ai.c(campaignEx);
        int d10 = ai.d(context, campaignEx.getPackageName());
        ...
        dVar.a("ind", Integer.valueOf(d10));
        dVar.a("stage", 1);
        if (c10) {
            if (d10 != 1) {
