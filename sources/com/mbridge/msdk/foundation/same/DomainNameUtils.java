...
public class DomainNameUtils implements NoProGuard {
    ...
    public static final class a {
        ...
        public static final DomainNameUtils f15653a = new DomainNameUtils();
    }
    ...
    private DomainNameUtils() {
        ...
        String a6 = x.a("LdxThdi1WBKXDgfQhgHQWktTJdv/YkQ/J75ghrcsWrPQJv==");
        this.DEFAULT_HOST_MONITOR_DEFAULT_CN = a6;
        this.DEFAULT_HOST_MONITOR_DEFAULT = a6;
        this.DEFAULT_HOST_MONITOR_DEFAULT_NONE_CN = x.a("LdxThdi1WBKXDgfQhgHQWktTJdv/Y+xgHFeXDrcshBPUYFT=");
        String a9 = x.a("LdxThdi1WBKbJbh/YkQ/J75ghrcsWrfXYZKQY0KMhrQFDkfPWM==");
        this.DEFAULT_HOST_PRIVACY_CN = a9;
        this.DEFAULT_HOST_PRIVACY = a9;
        this.DEFAULT_HOST_PRIVACY_NONE_CN = x.a("LdxThdi1WBKbJbh/Y+xgHFeXDrcshBPUYFTXHk9XhdzuJrcU4ZI=");
        String a10 = x.a("LdxThdi1WBKUY73wHrR/YkQ/J75ghrcsWrPQJv==");
        this.DEFAULT_HOST_REVENUE_DEFAULT_CN = a10;
        this.DEFAULT_HOST_REVENUE_DEFAULT = a10;
        ...
        String a11 = x.a("YFzAH+zFHZ2TDbv/YkQ/J75ghrcsWrPQJv==");
        this.DEFAULT_HOST_TCP_MONITOR_CN = a11;
        this.DEFAULT_HOST_TCP_MONITOR = a11;
        this.DEFAULT_HOST_TCP_MONITOR_NONE_CN = x.a("YFzAH+zFHZ2TDbv/Y+xgHFeXDrcshBPUYFT=");
        String a12 = x.a("DFeuWkH0W+xUhoPwLkPTHkJBDkM/Yr5T");
        this.DEFAULT_HOST_TCP_REVENUE_CN = a12;
        this.DEFAULT_HOST_TCP_REVENUE = a12;
