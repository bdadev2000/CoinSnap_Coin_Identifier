...
public final class b {
    ...
    private static ThreadPoolExecutor f13356b;

    /* renamed from: c, reason: collision with root package name */
    private static Handler f13357c;

    /* renamed from: d, reason: collision with root package name */
    private static ThreadPoolExecutor f13358d;

    /* renamed from: e, reason: collision with root package name */
    private static ThreadPoolExecutor f13359e;

    /* renamed from: f, reason: collision with root package name */
    private static ThreadPoolExecutor f13360f;
    ...
    public static ThreadPoolExecutor d() {
        if (f13358d == null) {
            f13358d = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(1), new ThreadFactory() { // from class: com.mbridge.msdk.foundation.same.f.b.3
                @Override // java.util.concurrent.ThreadFactory
                public final Thread newThread(Runnable runnable) {
                    Thread newThread = Executors.defaultThreadFactory().newThread(runnable);
