...
public final class aq {
    ...
    */
    ...
    public static boolean a(View view, int i10) {
        ...
        boolean z10 = ((float) ((rect.right - rect.left) * (rect.bottom - rect.top))) > ((float) (view.getMeasuredWidth() * view.getMeasuredHeight())) * (i10 == 1 ? 0.0f : 0.5f);
        boolean z11 = globalVisibleRect && z10;
        ad.b("ViewUtils", "View Judge : partVisible is " + globalVisibleRect + " halfPercentVisible is " + z10);
        StringBuilder sb2 = new StringBuilder("View Judge : totalViewVisible is ");
        sb2.append(z11);
        ad.b("ViewUtils", sb2.toString());
        if (!z11) {
            return true;
        }
        View view2 = view;
