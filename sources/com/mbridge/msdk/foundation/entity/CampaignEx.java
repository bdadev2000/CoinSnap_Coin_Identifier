...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    public static final class a implements Serializable {
        ...
        private static a a(JSONObject jSONObject) {
            ...
            try {
                aVar.f15512c = jSONObject.optString("adchoice_icon");
                aVar.f15513d = jSONObject.optString("adchoice_link");
                String optString = jSONObject.optString("adchoice_size");
                aVar.f15514e = optString;
                aVar.f15511a = jSONObject.optString("ad_logo_link");
                aVar.f15517h = jSONObject.optString("adv_logo");
                aVar.f15518i = jSONObject.optString("adv_name");
                aVar.f15519j = jSONObject.optString("platform_logo");
                aVar.f15520k = jSONObject.optString("platform_name");
                aVar.f15515f = c(optString);
                aVar.f15516g = d(optString);
    ...
    public static final class b implements Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f15521a;
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* renamed from: a, reason: collision with root package name */
            public List<String> f15536a = new ArrayList();
            public String b;
        }
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.f15535f = jSONObject.optInt("video_template", 1);
                cVar.f15534e = jSONObject.optString("template_url");
                cVar.b = jSONObject.optInt("orientation");
                cVar.f15532c = jSONObject.optString("paused_url");
                ...
                if (optJSONObject != null) {
                    ...
                    while (keys != null && keys.hasNext()) {
                        ...
                        List<String> b = ai.b(optJSONObject.optJSONArray(next));
                        if (b != null && b.size() > 0) {
                            a aVar = new a();
                            aVar.b = next;
                            aVar.f15536a.addAll(b);
                            arrayList.add(aVar);
                        }
                    }
                    cVar.f15531a = arrayList;
                }
                return cVar;
            } catch (Throwable unused) {
                return null;
        ...
        try {
            if (jSONObject.has(JSON_KEY_AD_TMP_IDS) && (optJSONArray = jSONObject.optJSONArray(JSON_KEY_AD_TMP_IDS)) != null && optJSONArray.length() > 0) {
                ...
                for (int i9 = 0; i9 < optJSONArray.length(); i9++) {
                    JSONObject a6 = com.mbridge.msdk.foundation.db.a.a.a().a(optJSONArray.getString(i9));
                    if (a6 != null) {
                        Iterator<String> keys = a6.keys();
                        while (keys.hasNext()) {
                            String next = keys.next();
                            jSONObject.put(next, a6.opt(next));
                        }
                    }
                }
                return jSONObject;
                ...
                try {
                    ...
                    if (optJSONArray3 != null && optJSONArray3.length() > 0) {
                        ...
                        for (int i10 = 0; i10 < optJSONArray3.length(); i10++) {
                            arrayList2.add(Integer.valueOf(optJSONArray3.optInt(i10)));
                        }
    ...
    private void setMoreOfferAdControl(String str, String str2) {
        ...
        try {
            int c9 = ai.c(str, MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMF);
            if (c9 == 0) {
                return;
            }
            ...
            int c10 = ai.c(str, MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMFTM);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put(MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMF, c9);
            jSONObject2.put(MBridgeConstans.DYNAMIC_VIEW_MORE_OFFER_ADMFTM, c10);
    ...
    public String getImpressionURL() {
        try {
            if (af.a().a("v_a_d_p", false)) {
                String a6 = ai.a(this.impressionURL, "&tun=", z.q() + "");
                this.impressionURL = a6;
                return a6;
            }
        } catch (Exception e4) {
            ad.b(TAG, e4.getMessage());
    ...
    public String getNoticeUrl() {
        try {
            if (af.a().a("v_a_d_p", false)) {
                String a6 = ai.a(this.noticeUrl, "&tun=", z.q() + "");
                this.noticeUrl = a6;
                return a6;
            }
        } catch (Exception e4) {
    ...
    public String getOnlyImpressionURL() {
        try {
            if (af.a().a("v_a_d_p", false)) {
                String a6 = ai.a(this.onlyImpressionURL, "&tun=", z.q() + "");
                this.onlyImpressionURL = a6;
                return a6;
            }
        } catch (Exception e4) {
            ad.b(TAG, e4.getMessage());
    ...
    public boolean isEffectiveOffer(long j7) {
        ...
        if (getTimestamp() + j7 < currentTimeMillis) {
            return false;
        }
        return true;
    }
    ...
    public boolean isSpareOffer(long j7, long j9) {
        if (isEffectiveOffer(j7)) {
            return false;
        }
        long currentTimeMillis = System.currentTimeMillis();
        if (getPlctb() > 0) {
    ...
    public void setAdSpaceT(int i9) {
        this.adSpaceT = i9;
    }
    ...
    public void setAutoShowStoreMiniCard(int i9) {
        this.autoShowStoreMiniCard = i9;
    }
    ...
    public void setCandidateCacheTime(long j7) {
        this.candidateCacheTime = j7;
    }

    public void setCbd(int i9) {
        this.cbd = i9;
    }

    public void setCbt(int i9) {
        this.cbt = i9;
    }

    public void setClickInterval(int i9) {
        this.clickInterval = i9;
    }

    public void setClickTempSource(int i9) {
        this.clickTempSource = i9;
    }

    public void setClickTimeOutInterval(int i9) {
        this.clickTimeOutInterval = i9;
    }
    ...
    public void setDynamicTempCode(int i9) {
        this.dynamicTempCode = ai.a(i9);
    }
    ...
    public void setEcCrtvId(long j7) {
        this.ecCrtvId = j7;
    }

    public void setEcTemplateId(long j7) {
        this.ecTemplateId = j7;
    }
    ...
    public void setEndcard_click_result(int i9) {
        this.endcard_click_result = i9;
    }
    ...
    public void setFac(int i9) {
        this.fac = i9;
    }

    public void setFca(int i9) {
        this.fca = i9;
    }

    public void setFcb(int i9) {
        this.fcb = i9;
    }

    public void setFlb(int i9) {
        this.flb = i9;
    }

    public void setFlbSkipTime(int i9) {
        this.flbSkipTime = i9;
    }
    ...
    public void setImpReportType(int i9) {
        this.impReportType = i9;
        if (i9 == 1) {
            int i10 = this.adType;
            if (i10 == 296 || i10 == 42) {
                ...
                if (!TextUtils.isEmpty(impressionURL) && !impressionURL.contains(JSON_KEY_IMP_REPORT_TYPE)) {
                    setImpressionURL(impressionURL + "&imp_report_type=" + i9);
                }
                if (!TextUtils.isEmpty(onlyImpressionURL) && !onlyImpressionURL.contains(JSON_KEY_IMP_REPORT_TYPE)) {
                    setOnlyImpressionURL(onlyImpressionURL + "&imp_report_type=" + i9);
                }
            }
        }
    }

    public void setImpUA(int i9) {
        this.impUA = i9;
    }
    ...
    public void setIsAddSuccesful(int i9) {
        this.isAddSuccesful = i9;
    }
    ...
    public void setIsDownLoadZip(int i9) {
        this.isDownLoadZip = i9;
    }
    ...
    public void setIsTimeoutCheckVideoStatus(int i9) {
        this.isTimeoutCheckVideoStatus = i9;
    }

    public void setJmPd(int i9) {
        this.jmPd = i9;
    }
    ...
    public void setKeyIaOri(int i9) {
        this.keyIaOri = i9;
    }

    public void setKeyIaRst(int i9) {
        this.keyIaRst = i9;
    }
    ...
    public void setLoadTimeoutState(int i9) {
        this.loadTimeoutState = i9;
    }
    ...
    public void setMof_tplid(int i9) {
        this.mof_tplid = i9;
    }
    ...
    public void setNscpt(int i9) {
        this.nscpt = i9;
    }

    public void setNvT2(int i9) {
        this.nvT2 = i9;
    }

    public void setOc_time(int i9) {
        this.oc_time = i9;
    }

    public void setOc_type(int i9) {
        this.oc_type = i9;
    }
    ...
    public void setPlayable_ads_without_video(int i9) {
        this.playable_ads_without_video = i9;
    }

    public void setPlct(long j7) {
        this.plct = j7;
    }

    public void setPlctb(long j7) {
        this.plctb = j7;
    }

    public void setPrivacyButtonTemplateVisibility(int i9) {
        this.privacyButtonTemplateVisibility = i9;
    }
    ...
    public void setProgressBarShow(int i9) {
        this.progressBarShow = i9;
    }
    ...
    public void setReadyState(int i9) {
        this.readyState = i9;
    }

    public void setReady_rate(int i9) {
        this.ready_rate = i9;
    }
    ...
    public void setRetarget_offer(int i9) {
        this.retarget_offer = i9;
    }
    ...
    public void setRewardPlayStatus(int i9) {
        this.rewardPlayStatus = i9;
    }
    ...
    public void setRtinsType(int i9) {
        this.rtinsType = i9;
    }
    ...
    public void setShowStoreMiniCardDelayTime(int i9) {
        this.showStoreMiniCardDelayTime = i9;
    }
    ...
    public void setSpareOfferFlag(int i9) {
        this.spareOfferFlag = i9;
    }

    public void setTImp(int i9) {
        this.t_imp = i9;
    }
    ...
    public void setTokenRule(int i9) {
        this.tokenRule = i9;
    }

    public void setTpOffer(int i9) {
        this.tpOffer = i9;
    }

    public void setTrackingTcpPort(int i9) {
        this.trackingTcpPort = i9;
    }

    public void setTriggerClickSource(int i9) {
        this.triggerClickSource = i9;
    }
    ...
    public void setTyped(int i9) {
        this.typed = i9;
    }

    public void setUseSkipTime(int i9) {
        this.useSkipTime = i9;
    }
    ...
    public void setVcn(int i9) {
        this.vcn = i9;
    }

    public void setVidCrtvId(long j7) {
        this.vidCrtvId = j7;
    }

    public void setVideoCheckType(int i9) {
        if (i9 <= 2 && i9 >= 1) {
            this.videoCheckType = i9;
        } else {
            this.videoCheckType = 2;
        }
    }

    public void setVideoCompleteTime(int i9) {
        this.videoCompleteTime = i9;
    }

    public void setVideoCtnType(int i9) {
        if (i9 <= 2 && i9 >= 1) {
            this.videoCtnType = i9;
        } else {
            this.videoCtnType = 1;
        }
    }
    ...
    public void setVideoPlayProgress(int i9) {
        this.videoPlayProgress = i9;
    }
    ...
    public void setVideo_end_type(int i9) {
        this.video_end_type = i9;
    }

    public void setVst(int i9) {
        this.vst = i9;
    }

    public void setWatchMile(int i9) {
        this.watchMile = i9;
    }

    public void setWtick(int i9) {
        this.wtick = i9;
    }

    public void setcUA(int i9) {
        this.cUA = i9;
    }

    public void setcVersionCode(long j7) {
        this.cVersionCode = j7;
    }

    public void setendcard_url(String str) {
        c cVar;
        this.endcard_url = str;
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f15534e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
