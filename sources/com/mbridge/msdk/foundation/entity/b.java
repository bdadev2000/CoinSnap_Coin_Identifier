...
public abstract class b {
    ...
    private static void getSysIDAndBKUPID(JSONObject jSONObject) {
        ...
        if (fastKV != null) {
            try {
                ...
                if (jSONObject != null && c9 != null) {
                    ...
                    if (!TextUtils.isEmpty(optString) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f15673U, optString)) {
                        com.mbridge.msdk.foundation.same.a.f15673U = optString;
                        com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.f15673U);
                        try {
                            fastKV.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f15673U);
                        } catch (Exception unused2) {
                        }
                    }
                    String optString2 = jSONObject.optString(com.mbridge.msdk.foundation.controller.a.f15376a);
                    if (!TextUtils.isEmpty(optString2) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f15681g, optString2)) {
                        com.mbridge.msdk.foundation.same.a.f15681g = optString2;
                        com.mbridge.msdk.foundation.a.a.a.a().a(com.mbridge.msdk.foundation.controller.a.f15376a, com.mbridge.msdk.foundation.same.a.f15681g);
                        try {
                            fastKV.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f15681g);
                            return;
        ...
        try {
            ...
            if (jSONObject != null && c10 != null) {
                String optString3 = jSONObject.optString("b");
                if (!TextUtils.isEmpty(optString3) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f15673U, optString3)) {
                    com.mbridge.msdk.foundation.same.a.f15673U = optString3;
                    com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.f15673U);
                    SharedPreferences sharedPreferences = c10.getSharedPreferences(x.a("H+tU+FeXHM=="), 0);
                ...
                String optString4 = jSONObject.optString(com.mbridge.msdk.foundation.controller.a.f15376a);
                if (!TextUtils.isEmpty(optString4) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f15681g, optString4)) {
                    com.mbridge.msdk.foundation.same.a.f15681g = optString4;
                    com.mbridge.msdk.foundation.a.a.a.a().a(com.mbridge.msdk.foundation.controller.a.f15376a, com.mbridge.msdk.foundation.same.a.f15681g);
                    SharedPreferences sharedPreferences2 = c10.getSharedPreferences(x.a("H+tU+FeXHM=="), 0);
                    if (sharedPreferences2 != null) {
                        SharedPreferences.Editor edit2 = sharedPreferences2.edit();
                        edit2.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f15681g);
                        edit2.apply();
                    }
                }
            }
    ...
    public void setEcppv(double d2) {
        this.ecppv = d2;
    }
    ...
    public void setIa_ori(int i9) {
        this.ia_ori = i9;
    }

    public void setIa_rst(int i9) {
        this.ia_rst = i9;
    }
                                    ...
                                    try {
                                        ...
                                        if (parseCampaign != null) {
                                            try {
                                                ...
                                                parseCampaign.setMof_tplid(i16);
                                                str5 = optString;
                                                parseCampaign.setMof_template_url(str5);
                                                parseCampaign.setNscpt(i15);
