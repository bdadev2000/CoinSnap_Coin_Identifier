...
public abstract class b {
    ...
    private static void getSysIDAndBKUPID(JSONObject jSONObject) {
        ...
        if (fastKV != null) {
            try {
                ...
                if (jSONObject != null && c10 != null) {
                    ...
                    if (!TextUtils.isEmpty(optString) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.U, optString)) {
                        com.mbridge.msdk.foundation.same.a.U = optString;
                        com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.U);
                        try {
                            fastKV.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.U);
                        } catch (Exception unused2) {
                        }
                    }
                    String optString2 = jSONObject.optString(com.mbridge.msdk.foundation.controller.a.a);
                    if (!TextUtils.isEmpty(optString2) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f13276g, optString2)) {
                        com.mbridge.msdk.foundation.same.a.f13276g = optString2;
                        com.mbridge.msdk.foundation.a.a.a.a().a(com.mbridge.msdk.foundation.controller.a.a, com.mbridge.msdk.foundation.same.a.f13276g);
                        try {
                            fastKV.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f13276g);
                            return;
        ...
        try {
            ...
            if (jSONObject != null && c11 != null) {
                String optString3 = jSONObject.optString("b");
                if (!TextUtils.isEmpty(optString3) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.U, optString3)) {
                    com.mbridge.msdk.foundation.same.a.U = optString3;
                    com.mbridge.msdk.foundation.a.a.a.a().a("b", com.mbridge.msdk.foundation.same.a.U);
                    SharedPreferences sharedPreferences = c11.getSharedPreferences(x.a("H+tU+FeXHM=="), 0);
                ...
                String optString4 = jSONObject.optString(com.mbridge.msdk.foundation.controller.a.a);
                if (!TextUtils.isEmpty(optString4) && !TextUtils.equals(com.mbridge.msdk.foundation.same.a.f13276g, optString4)) {
                    com.mbridge.msdk.foundation.same.a.f13276g = optString4;
                    com.mbridge.msdk.foundation.a.a.a.a().a(com.mbridge.msdk.foundation.controller.a.a, com.mbridge.msdk.foundation.same.a.f13276g);
                    SharedPreferences sharedPreferences2 = c11.getSharedPreferences(x.a("H+tU+FeXHM=="), 0);
                    if (sharedPreferences2 != null) {
                        SharedPreferences.Editor edit2 = sharedPreferences2.edit();
                        edit2.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f13276g);
                        edit2.apply();
                    }
                }
            }
                                    ...
                                    try {
                                        ...
                                        if (parseCampaign != null) {
                                            try {
                                                ...
                                                parseCampaign.setMof_tplid(i17);
                                                str5 = optString;
                                                parseCampaign.setMof_template_url(str5);
                                                parseCampaign.setNscpt(i16);
                ...
                if (optJSONArray != null) {
                    if (optJSONArray.length() > 0) {
                        ...
                        while (i20 < optJSONArray.length()) {
                            JSONObject optJSONObject4 = optJSONArray.optJSONObject(i20);
                            String str33 = str28;
                            ...
                            try {
                                ...
                                if (parseCampaign2 != null) {
                                    ...
                                    str8 = str39;
                                    parseCampaign2.setMof_template_url(str8);
                                    parseCampaign2.setNscpt(i19);
