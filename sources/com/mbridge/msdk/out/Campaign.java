...
public class Campaign extends BaseCampaign {
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeHeight(int i10) {
        super.setAdchoiceSizeHeight(i10);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeWidth(int i10) {
        super.setAdchoiceSizeWidth(i10);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setCreativeId(long j3) {
        super.setCreativeId(j3);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setNumberRating(int i10) {
        super.setNumberRating(i10);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setRating(double d10) {
        super.setRating(d10);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setTimestamp(long j3) {
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setVideoLength(int i10) {
        super.setVideoLength(i10);
    }
}
