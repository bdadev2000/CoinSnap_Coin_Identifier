...
public class Campaign extends BaseCampaign {
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeHeight(int i9) {
        super.setAdchoiceSizeHeight(i9);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeWidth(int i9) {
        super.setAdchoiceSizeWidth(i9);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setCreativeId(long j7) {
        super.setCreativeId(j7);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setNumberRating(int i9) {
        super.setNumberRating(i9);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setRating(double d2) {
        super.setRating(d2);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setTimestamp(long j7) {
        super.setTimestamp(j7);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setType(int i9) {
        super.setType(i9);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setVideoLength(int i9) {
        super.setVideoLength(i9);
    }
}
