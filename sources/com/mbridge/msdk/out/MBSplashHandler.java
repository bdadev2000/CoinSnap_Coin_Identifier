...
public class MBSplashHandler implements BaseExtraInterfaceForHandler {
    ...
    public void setLoadTimeOut(long j7) {
        c cVar = this.splashProvider;
        if (cVar != null) {
            cVar.a(j7);
        }
    ...
    public void setLogoView(View view, int i9, int i10) {
        if (this.splashProvider != null) {
            this.splashProvider.a(view, new RelativeLayout.LayoutParams(i9, i10));
        }
    }

    public void setNotchScreenParameter(int i9, int i10, int i11, int i12) {
        c cVar = this.splashProvider;
        if (cVar != null) {
            cVar.a(i9, i11, i10, i12);
        }
    }
    ...
    public MBSplashHandler(String str, String str2, boolean z8, int i9) {
        this(str, str2, z8, i9, orientation, logoSizeH, logoSizeW);
    }
    ...
    public MBSplashHandler(Activity activity, String str, String str2, boolean z8, int i9) {
        this(activity, str, str2, z8, i9, orientation, logoSizeH, logoSizeW);
    }

    public MBSplashHandler(String str, String str2, boolean z8, int i9, int i10, int i11, int i12) {
        String e4 = ai.e(str2);
        ...
        cVar.b(z8);
        this.splashProvider.b(i9);
        this.splashProvider.a(i10);
        this.splashProvider.a(i11, i12);
    }
    ...
    public MBSplashHandler(Activity activity, String str, String str2, boolean z8, int i9, int i10, int i11, int i12) {
        String e4 = ai.e(str2);
        if (!TextUtils.isEmpty(e4)) {
            ai.b(str2, e4);
        }
