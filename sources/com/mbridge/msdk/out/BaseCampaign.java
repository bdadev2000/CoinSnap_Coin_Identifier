...
public abstract class BaseCampaign implements c, NoProGuard, Serializable {
    ...
    public void setAdchoiceSizeHeight(int i9) {
        this.adchoiceSizeHeight = i9;
    }

    public void setAdchoiceSizeWidth(int i9) {
        this.adchoiceSizeWidth = i9;
    }
    ...
    public void setNumberRating(int i9) {
        if (i9 > 0) {
            this.numberRating = i9;
        }
    }
    ...
    public void setVideoLength(int i9) {
        this.videoLength = i9;
    }
}
