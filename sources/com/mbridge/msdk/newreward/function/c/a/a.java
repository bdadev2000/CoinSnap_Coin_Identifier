...
public final class a extends com.mbridge.msdk.newreward.function.c.a {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                a[e.CHECK_CAMPAIGN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                a[e.HANDLER_ALREADY_INSTALL_CAMPAIGN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                a[e.CREATE_OFFSET.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                a[e.CREATE_DAILY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                a[e.CREATE_BIDS.ordinal()] = 6;
            ...
            try {
                a[e.CHECK_IS_REQUEST_CONTROL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                a[e.UPDATE_CAM_TOKEN_RULE.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                a[e.START_LOAD_CHECK.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                a[e.CANDIDATE_LOAD_ACTION.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                a[e.REQ_SETTING.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                a[e.REQ_CAMPAIGN.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                a[e.REQ_DOWN_CAMPAIGN.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                a[e.RESTORE_DB.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                a[e.SMART_LOAD.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                a[e.NORMAL_LOAD.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                a[e.PRE_HANDLE_LOAD.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                a[e.UNIT_INIT.ordinal()] = 19;
    ...
    public final d a(com.mbridge.msdk.newreward.function.c.b bVar) {
        ...
        d dVar = new d();
        switch (AnonymousClass1.a[bVar.a().ordinal()]) {
            case 1:
            ...
            case 9:
                if (((l) c.a().b(e.UPDATE_CAM_TOKEN_RULE)) != null) {
                    try {
                        Object b3 = bVar.b();
                        Map map3 = null;
                        Map map4 = b3 instanceof Map ? (Map) b3 : null;
                        if (map4 != null) {
                            com.mbridge.msdk.newreward.a.e eVar = (com.mbridge.msdk.newreward.a.e) map4.get("adapter_model");
                            com.mbridge.msdk.newreward.function.f.a x11 = ((com.mbridge.msdk.newreward.a.e) map4.get("queue_first_adapter_model")).x();
                            if (x11 != null && (a = x11.a()) != null && a.size() != 0) {
                                String encryptPrice = a.get(0).getEncryptPrice();
                                if (!TextUtils.isEmpty(encryptPrice) && (x10 = eVar.x()) != null && x10.a() != null && x10.a().size() != 0) {
                                    List<CampaignEx> a10 = eVar.x().a();
