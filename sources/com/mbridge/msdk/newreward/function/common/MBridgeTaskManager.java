...
public class MBridgeTaskManager {
            ...
            if (runnable != null) {
                try {
                    ...
                    if (MBridgeConstans.DEBUG) {
                        ad.b(MBridgeTaskManager.TAG, "TaskWrapper", th2);
                    }
                }
            }
        }
    ...
    public static void directorExecute(Runnable runnable, long j3) {
        getDirectorHandler().postDelayed(new TaskWrapper(runnable), j3);
    }
