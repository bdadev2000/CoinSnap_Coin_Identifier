...
public class MBridgeDailyPlayModel {
    ...
    public MBridgeDailyPlayModel(int i10, String str, String str2) {
        ...
        this.mCountKey = j.k(str3, "_count");
        this.mTimeKey = j.k(str3, "_time");
    }

    public void insertDailyCap() {
        long j3 = MBridgeSharedPreferenceModel.getInstance().getLong(this.mTimeKey, 0L);
        int integer = MBridgeSharedPreferenceModel.getInstance().getInteger(this.mCountKey, 0) + 1;
        if (j3 != 0 && System.currentTimeMillis() - j3 <= com.vungle.ads.internal.signals.j.TWENTY_FOUR_HOURS_MILLIS) {
    ...
    public boolean isOverDailyCap() {
        ...
        if (System.currentTimeMillis() - j3 > com.vungle.ads.internal.signals.j.TWENTY_FOUR_HOURS_MILLIS) {
