...
public final class e implements a {
    ...
    private com.mbridge.msdk.newreward.a.e f14351b;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        final com.mbridge.msdk.newreward.function.d.c.d<?> c10 = aVar.c();
        if (aVar.h().F() != null) {
            ...
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f14351b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (c10 == null) {
            bVar.a(aVar);
        ...
        c10.k().a(0, new x() { // from class: com.mbridge.msdk.newreward.a.b.e.1
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i10, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        ...
        if (cVar == null || this.f14351b == null) {
            return;
        }
        try {
