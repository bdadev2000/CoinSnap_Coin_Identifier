...
public final class g implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f16946a;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f16949a[com.mbridge.msdk.newreward.function.c.e.REPORT_DOWNLOAD_END.ordinal()] = 2;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        com.mbridge.msdk.newreward.function.d.c.h b = aVar.b();
        if (aVar.h().F() != null) {
            if (aVar.h().F().containsKey("command_manager")) {
                this.f16946a = (com.mbridge.msdk.newreward.function.c.c) aVar.h().F().get("command_manager");
            }
        ...
        b.k().a(0, new x() { // from class: com.mbridge.msdk.newreward.a.b.g.1
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i9, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f16946a;
        if (cVar == null || this.b == null) {
            return;
        }
        try {
            Map a6 = cVar.a("resource_type", 6, "scenes", 1, "url", aVar.b().j(), "mraid_type", Integer.valueOf(aVar.i() ? 1 : 0));
            int i10 = AnonymousClass2.f16949a[eVar.ordinal()];
            if (i10 != 1) {
                if (i10 == 2 && this.f16947c == 2) {
                    a6.put("result", Integer.valueOf(i9));
                    if (i9 != 1 && mBridgeError != null) {
                        a6.put("reason", mBridgeError.getErrorMessage());
                    }
                    this.f16946a.a(this.b, eVar, a6);
                    return;
                }
                return;
            }
            a6.put("cache", Integer.valueOf(this.f16947c));
            this.f16946a.a(this.b, eVar, a6);
        } catch (Exception e4) {
