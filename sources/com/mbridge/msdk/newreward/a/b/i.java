...
public final class i implements a {
    ...
    private com.mbridge.msdk.newreward.a.e f14363b;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        com.mbridge.msdk.newreward.function.d.c.l e2 = aVar.e();
        if (aVar.h().F() != null) {
            ...
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f14363b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (e2 == null) {
            bVar.a(aVar);
        ...
        e2.k().a(0, new x() { // from class: com.mbridge.msdk.newreward.a.b.i.1
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i10, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        ...
        if (cVar == null || this.f14363b == null) {
            return;
        }
        try {
