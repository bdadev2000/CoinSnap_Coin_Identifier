...
public final class f implements a {
    ...
    private com.mbridge.msdk.newreward.a.e f14355b;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        final com.mbridge.msdk.newreward.function.d.c.d<?> f10 = aVar.f();
        if (aVar.h().F() != null) {
            ...
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f14355b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (f10 == null) {
            bVar.a(aVar);
        ...
        f10.k().a(0, new x() { // from class: com.mbridge.msdk.newreward.a.b.f.1
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i10, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        if (this.a == null || this.f14355b == null) {
            return;
        }
        try {
