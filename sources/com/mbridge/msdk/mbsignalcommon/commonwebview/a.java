...
public final class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f16641a = new CopyOnWriteArrayList<>();

    public final void a(WebChromeClient webChromeClient) {
        this.f16641a.add(webChromeClient);
    }

    public final void b(WebChromeClient webChromeClient) {
        this.f16641a.remove(webChromeClient);
    }
    ...
    public final void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
    ...
    public final void onConsoleMessage(String str, int i9, String str2) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
            it.next().onConsoleMessage(str, i9, str2);
        }
    }
    ...
    public final void onExceededDatabaseQuota(String str, String str2, long j7, long j9, long j10, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
            it.next().onExceededDatabaseQuota(str, str2, j7, j9, j10, quotaUpdater);
        }
    }
    ...
    public final void onPermissionRequest(PermissionRequest permissionRequest) {
        try {
            ...
            ad.b("CommonWebChromeClient", e4.getMessage());
        }
    }
    ...
    public final void onProgressChanged(WebView webView, int i9) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
            it.next().onProgressChanged(webView, i9);
        }
    }

    public final void onReachedMaxAppCacheSize(long j7, long j9, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
            it.next().onReachedMaxAppCacheSize(j7, j9, quotaUpdater);
        }
    }
    ...
    public final void onShowCustomView(View view, int i9, WebChromeClient.CustomViewCallback customViewCallback) {
        Iterator<WebChromeClient> it = this.f16641a.iterator();
        while (it.hasNext()) {
            it.next().onShowCustomView(view, i9, customViewCallback);
        }
    }
}
