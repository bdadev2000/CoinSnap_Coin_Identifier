...
public final class a extends WebChromeClient {
    ...
    public final void onExceededDatabaseQuota(String str, String str2, long j3, long j10, long j11, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.a.iterator();
        while (it.hasNext()) {
            it.next().onExceededDatabaseQuota(str, str2, j3, j10, j11, quotaUpdater);
        }
    }
    ...
    public final void onPermissionRequest(PermissionRequest permissionRequest) {
        try {
            ...
            ad.b("CommonWebChromeClient", e2.getMessage());
        }
    }
    ...
    public final void onReachedMaxAppCacheSize(long j3, long j10, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.a.iterator();
        while (it.hasNext()) {
            it.next().onReachedMaxAppCacheSize(j3, j10, quotaUpdater);
        }
    }
