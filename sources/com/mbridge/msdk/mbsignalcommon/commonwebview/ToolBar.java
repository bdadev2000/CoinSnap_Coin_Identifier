...
public class ToolBar extends LinearLayout {
    ...
    public static class b {
        ...
        /* renamed from: c, reason: collision with root package name */
        public boolean f16639c = true;

        /* renamed from: d, reason: collision with root package name */
        public View.OnClickListener f16640d;
    ...
    private void a(a aVar, List<b> list) {
        ...
        try {
            ...
            setPadding(0, a6, ai.a(getContext(), 20.0f), a6);
        } catch (Exception unused) {
        }
        try {
            for (b bVar : list) {
                ImageView imageView = (ImageView) b();
                imageView.setTag(bVar.f16638a);
                ...
                imageView.setOnClickListener(bVar.f16640d);
                if (!bVar.f16639c) {
    ...
    public void setOnItemClickListener(View.OnClickListener onClickListener) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            getChildAt(i9).setOnClickListener(onClickListener);
        }
    }
