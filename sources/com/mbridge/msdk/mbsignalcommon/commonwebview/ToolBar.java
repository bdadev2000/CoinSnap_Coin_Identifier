...
public class ToolBar extends LinearLayout {
    ...
    public static class a {
        ...
        public static int f14113b = 40;

        /* renamed from: c, reason: collision with root package name */
        public static int f14114c = 10;
        public int a;
    }
    ...
    public static class b {
        ...
        public View.OnClickListener f14117d;
    ...
    private void a(a aVar, List<b> list) {
        setOrientation(0);
        try {
            int a10 = ai.a(getContext(), 10.0f);
            setPadding(0, a10, ai.a(getContext(), 20.0f), a10);
        ...
        try {
            for (b bVar : list) {
                ...
                imageView.setImageDrawable(getResources().getDrawable(getResources().getIdentifier(bVar.f14115b, "drawable", c.m().g())));
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(a.f14113b, -1);
                layoutParams.setMargins(32, 0, 32, 0);
                imageView.setLayoutParams(layoutParams);
                imageView.setOnClickListener(bVar.f14117d);
                if (!bVar.f14116c) {
