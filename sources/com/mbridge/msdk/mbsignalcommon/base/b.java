...
public class b extends WebViewClient {
    ...
    private com.mbridge.msdk.mbsignalcommon.windvane.d f14075b;
    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        com.mbridge.msdk.mbsignalcommon.windvane.d dVar = this.f14075b;
        if (dVar != null) {
            dVar.a(webView, str);
        }
    }
    ...
    public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        if (webView != null) {
            try {
                ...
                ad.b("BaseWebViewClient", th2.getMessage());
                return true;
            }
        }
        com.mbridge.msdk.mbsignalcommon.windvane.d dVar = this.f14075b;
