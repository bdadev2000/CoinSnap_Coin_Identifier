...
public class MBShakeView extends LinearLayout {
    ...
    public void onAttachedToWindow() {
        ...
        this.f15058b.startAnimation(this.a);
    }
    ...
    public void initView(String str, boolean z10) {
        ...
        imageView.setLayoutParams(new LinearLayout.LayoutParams(ai.a(getContext(), z10 ? 60.0f : 80.0f), ai.a(getContext(), z10 ? 60.0f : 80.0f)));
        int parseColor = Color.parseColor("#80000000");
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(parseColor);
        gradientDrawable.setCornerRadius(200);
        imageView.setBackground(gradientDrawable);
        this.f15058b = new ImageView(getContext());
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(ai.a(getContext(), z10 ? 20.0f : 40.0f), ai.a(getContext(), z10 ? 20.0f : 40.0f));
        layoutParams.gravity = 17;
        this.f15058b.setLayoutParams(layoutParams);
        this.f15058b.setImageResource(getResources().getIdentifier("mbridge_cm_btn_shake", "drawable", c.m().g()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f15058b);
