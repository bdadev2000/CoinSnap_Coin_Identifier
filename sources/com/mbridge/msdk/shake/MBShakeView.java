...
public class MBShakeView extends LinearLayout {
    ...
    public void onAttachedToWindow() {
        ...
        this.f17743a = rotateAnimation;
        rotateAnimation.setDuration(100L);
        this.f17743a.setRepeatMode(2);
        this.f17743a.setRepeatCount(-1);
        this.b.startAnimation(this.f17743a);
    }
    ...
    public MBShakeView(Context context, AttributeSet attributeSet, int i9) {
        super(context, attributeSet, i9);
    }

    public MBShakeView(Context context, AttributeSet attributeSet, int i9, int i10) {
