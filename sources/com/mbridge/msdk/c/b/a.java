...
public class a {
    ...
    private String c() {
        try {
            File file = new File(e.a(c.MBRIDGE_OTHER), "mraid_js.txt");
            if (!file.exists() || !file.canRead()) {
                return "";
            }
            return ab.b(file);
        } catch (Exception e4) {
            ad.a("MraidJSController", e4.getMessage());
            return "";
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (TextUtils.isEmpty(this.f14662c)) {
                ...
                if (b8 != null && !TextUtils.isEmpty(b8.R())) {
                    a(com.mbridge.msdk.foundation.controller.c.m().c(), b8.R());
                }
                return f14661a;
            }
            return this.f14662c;
    ...
    public final void a(Context context, final String str) {
        ...
        String a6 = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
        if (TextUtils.isEmpty(a6) || !a6.equals(str)) {
            try {
                new com.mbridge.msdk.c.a.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.f.e) null, new com.mbridge.msdk.foundation.same.net.b.a() { // from class: com.mbridge.msdk.c.b.a.1
                    @Override // com.mbridge.msdk.foundation.same.net.b.a
                    public final void a(String str2) {
                        L.C("fail request mraid js. ", str2, "MraidJSController");
                    }

                    @Override // com.mbridge.msdk.foundation.same.net.b.a
                    public final void b(String str2) {
                        ad.a("MraidJSController", "request mraid js success, content = " + str2);
                ...
                }, "mraid_js", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            } catch (Exception e4) {
                ad.b("MraidJSController", e4.getMessage());
            }
        }
    }

    public static /* synthetic */ void b(a aVar, final String str) {
        new Thread(new Runnable() { // from class: com.mbridge.msdk.c.b.a.2
