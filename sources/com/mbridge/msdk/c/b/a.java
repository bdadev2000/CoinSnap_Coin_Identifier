...
public class a {
    ...
    private String c() {
        try {
            ...
            ad.a("MraidJSController", e2.getMessage());
            return "";
        }
    }
        ...
        try {
            ...
            if (TextUtils.isEmpty(this.f12384c)) {
                ...
                if (b3 != null && !TextUtils.isEmpty(b3.R())) {
                    a(com.mbridge.msdk.foundation.controller.c.m().c(), b3.R());
                }
                return a;
            }
            return this.f12384c;
    ...
    public final void a(Context context, final String str) {
        ...
        String a10 = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
            ...
            try {
                new com.mbridge.msdk.c.a.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.f.e) null, new com.mbridge.msdk.foundation.same.net.b.a() { // from class: com.mbridge.msdk.c.b.a.1
                    ...
                    public final void a(String str2) {
                        com.applovin.impl.mediation.ads.e.A("fail request mraid js. ", str2, "MraidJSController");
                    }
                ...
                ad.b("MraidJSController", e2.getMessage());
            }
        }
    }
