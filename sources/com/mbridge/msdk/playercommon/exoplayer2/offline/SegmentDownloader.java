...
public abstract class SegmentDownloader<M extends FilterableManifest<M, K>, K> implements Downloader {
    ...
    public static class Segment implements Comparable<Segment> {
        ...
        public Segment(long j7, DataSpec dataSpec) {
            this.startTimeUs = j7;
        ...
        public int compareTo(Segment segment) {
            long j7 = this.startTimeUs - segment.startTimeUs;
            if (j7 == 0) {
                return 0;
            }
            return j7 < 0 ? -1 : 1;
    ...
    public final void download() throws IOException, InterruptedException {
        ...
        try {
            ...
            CacheUtil.CachingCounters cachingCounters = new CacheUtil.CachingCounters();
            for (int i9 = 0; i9 < initDownload.size(); i9++) {
                try {
                    CacheUtil.cache(initDownload.get(i9).dataSpec, this.cache, this.dataSource, bArr, this.priorityTaskManager, -1000, cachingCounters, this.isCanceled, true);
                    this.downloadedSegments++;
    ...
    public abstract List<Segment> getSegments(DataSource dataSource, M m, boolean z8) throws InterruptedException, IOException;
    ...
    public final void remove() throws InterruptedException {
        try {
            ...
            for (int i9 = 0; i9 < segments.size(); i9++) {
                removeUri(segments.get(i9).dataSpec.uri);
            }
