...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public final boolean continueLoading(long j3) {
        if (!this.childrenPendingPreparation.isEmpty()) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                this.childrenPendingPreparation.get(i10).continueLoading(j3);
            }
            return false;
        }
    ...
    public final void discardBuffer(long j3, boolean z10) {
        for (MediaPeriod mediaPeriod : this.enabledPeriods) {
            mediaPeriod.discardBuffer(j3, z10);
        }
    }
    ...
    public final long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j3) {
        ...
        while (i12 < this.periods.length) {
            ...
            long selectTracks = this.periods[i12].selectTracks(trackSelectionArr2, zArr, sampleStreamArr4, zArr2, j10);
            if (i14 == 0) {
                j10 = selectTracks;
