...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        private long adjustMediaTime(long j3) {
        ...
        public final void downstreamFormatChanged(int i10, Format format, int i11, Object obj, long j3) {
            downstreamFormatChanged(new MediaLoadData(1, i10, format, i11, obj, adjustMediaTime(j3), C.TIME_UNSET));
        }

        public final void loadCanceled(DataSpec dataSpec, int i10, long j3, long j10, long j11) {
            loadCanceled(dataSpec, i10, -1, null, 0, null, C.TIME_UNSET, C.TIME_UNSET, j3, j10, j11);
        }

        public final void loadCompleted(DataSpec dataSpec, int i10, long j3, long j10, long j11) {
            loadCompleted(dataSpec, i10, -1, null, 0, null, C.TIME_UNSET, C.TIME_UNSET, j3, j10, j11);
        }

        public final void loadError(DataSpec dataSpec, int i10, long j3, long j10, long j11, IOException iOException, boolean z10) {
            loadError(dataSpec, i10, -1, null, 0, null, C.TIME_UNSET, C.TIME_UNSET, j3, j10, j11, iOException, z10);
        }

        public final void loadStarted(DataSpec dataSpec, int i10, long j3) {
        ...
        public final void upstreamDiscarded(int i10, long j3, long j10) {
            upstreamDiscarded(new MediaLoadData(1, i10, null, 3, null, adjustMediaTime(j3), adjustMediaTime(j10)));
        }

        public final EventDispatcher withParameters(int i10, MediaSource.MediaPeriodId mediaPeriodId, long j3) {
            return new EventDispatcher(this.listenerAndHandlers, i10, mediaPeriodId, j3);
        }

        private EventDispatcher(CopyOnWriteArrayList<ListenerAndHandler> copyOnWriteArrayList, int i10, MediaSource.MediaPeriodId mediaPeriodId, long j3) {
        ...
        public final void loadCanceled(DataSpec dataSpec, int i10, int i11, Format format, int i12, Object obj, long j3, long j10, long j11, long j12, long j13) {
            loadCanceled(new LoadEventInfo(dataSpec, j11, j12, j13), new MediaLoadData(i10, i11, format, i12, obj, adjustMediaTime(j3), adjustMediaTime(j10)));
        }

        public final void loadCompleted(DataSpec dataSpec, int i10, int i11, Format format, int i12, Object obj, long j3, long j10, long j11, long j12, long j13) {
            loadCompleted(new LoadEventInfo(dataSpec, j11, j12, j13), new MediaLoadData(i10, i11, format, i12, obj, adjustMediaTime(j3), adjustMediaTime(j10)));
        }

        public final void loadError(DataSpec dataSpec, int i10, int i11, Format format, int i12, Object obj, long j3, long j10, long j11, long j12, long j13, IOException iOException, boolean z10) {
            loadError(new LoadEventInfo(dataSpec, j11, j12, j13), new MediaLoadData(i10, i11, format, i12, obj, adjustMediaTime(j3), adjustMediaTime(j10)), iOException, z10);
        }

        public final void loadStarted(DataSpec dataSpec, int i10, int i11, Format format, int i12, Object obj, long j3, long j10, long j11) {
            loadStarted(new LoadEventInfo(dataSpec, j11, 0L, 0L), new MediaLoadData(i10, i11, format, i12, obj, adjustMediaTime(j3), adjustMediaTime(j10)));
        }
        ...
        public final void loadError(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData, final IOException iOException, final boolean z10) {
            Iterator<ListenerAndHandler> it = this.listenerAndHandlers.iterator();
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
    ...
    public static final class LoadEventInfo {
        ...
        public LoadEventInfo(DataSpec dataSpec, long j3, long j10, long j11) {
    ...
    public static final class MediaLoadData {
        ...
        public MediaLoadData(int i10, int i11, Format format, int i12, Object obj, long j3, long j10) {
            this.dataType = i10;
            this.trackType = i11;
