...
public final class ExtractorMediaSource extends BaseMediaSource implements ExtractorMediaPeriod.Listener {
    ...
    public static final class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        public final Factory setContinueLoadingCheckIntervalBytes(int i9) {
    ...
    private void notifySourceInfoRefreshed(long j7, boolean z8) {
    ...
    public final void onSourceInfoRefreshed(long j7, boolean z8) {
        if (j7 == C.TIME_UNSET) {
            j7 = this.timelineDurationUs;
        }
        if (this.timelineDurationUs == j7 && this.timelineIsSeekable == z8) {
            return;
        }
        notifySourceInfoRefreshed(j7, z8);
    }
    ...
    public ExtractorMediaSource(Uri uri, DataSource.Factory factory, ExtractorsFactory extractorsFactory, int i9, Handler handler, EventListener eventListener, String str, int i10) {
        this(uri, factory, extractorsFactory, i9, str, i10, null);
    ...
    private ExtractorMediaSource(Uri uri, DataSource.Factory factory, ExtractorsFactory extractorsFactory, int i9, String str, int i10, Object obj) {
        this.uri = uri;
        this.dataSourceFactory = factory;
        this.extractorsFactory = extractorsFactory;
        this.minLoadableRetryCount = i9;
