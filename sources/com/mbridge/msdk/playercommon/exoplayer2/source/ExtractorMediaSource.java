...
public final class ExtractorMediaSource extends BaseMediaSource implements ExtractorMediaPeriod.Listener {
    ...
    private void notifySourceInfoRefreshed(long j3, boolean z10) {
    ...
    public final void onSourceInfoRefreshed(long j3, boolean z10) {
        if (j3 == C.TIME_UNSET) {
            j3 = this.timelineDurationUs;
        }
        if (this.timelineDurationUs == j3 && this.timelineIsSeekable == z10) {
            return;
        }
        notifySourceInfoRefreshed(j3, z10);
    }
