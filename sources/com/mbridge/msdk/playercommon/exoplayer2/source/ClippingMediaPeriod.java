...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public final class ClippingSampleStream implements SampleStream {
            ...
            if (readData == -5) {
                ...
                if (i9 != 0 || format.encoderPadding != 0) {
                    ...
                    if (clippingMediaPeriod.endUs == Long.MIN_VALUE) {
                        i10 = format.encoderPadding;
                    }
                    formatHolder.format = format.copyWithGaplessInfo(i9, i10);
                }
                return -5;
            }
            ClippingMediaPeriod clippingMediaPeriod2 = ClippingMediaPeriod.this;
            long j7 = clippingMediaPeriod2.endUs;
            if (j7 != Long.MIN_VALUE && ((readData == -4 && decoderInputBuffer.timeUs >= j7) || (readData == -3 && clippingMediaPeriod2.getBufferedPositionUs() == Long.MIN_VALUE))) {
        ...
        public final int skipData(long j7) {
            ...
            return this.childStream.skipData(j7);
        }
    }

    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z8, long j7, long j9) {
        long j10;
    ...
    private SeekParameters clipSeekParameters(long j7, SeekParameters seekParameters) {
        long j9;
        long constrainValue = Util.constrainValue(seekParameters.toleranceBeforeUs, 0L, j7 - this.startUs);
    ...
    private static boolean shouldKeepInitialDiscontinuity(long j7, TrackSelection[] trackSelectionArr) {
        if (j7 != 0) {
    ...
    public final boolean continueLoading(long j7) {
        return this.mediaPeriod.continueLoading(j7);
    }
    ...
    public final long getAdjustedSeekPositionUs(long j7, SeekParameters seekParameters) {
        ...
        return this.mediaPeriod.getAdjustedSeekPositionUs(j7, clipSeekParameters(j7, seekParameters));
    }
    ...
    public final long readDiscontinuity() {
        ...
        if (isPendingInitialDiscontinuity()) {
            long j7 = this.pendingInitialDiscontinuityPositionUs;
    ...
    */
    ...
    public final void updateClipping(long j7, long j9) {
        this.startUs = j7;
        this.endUs = j9;
    }
