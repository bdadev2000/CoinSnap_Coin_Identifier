...
public abstract class BaseMediaSource implements MediaSource {
    ...
    public abstract void prepareSourceInternal(ExoPlayer exoPlayer, boolean z8);
    ...
    public final MediaSourceEventListener.EventDispatcher createEventDispatcher(MediaSource.MediaPeriodId mediaPeriodId, long j7) {
        ...
        return this.eventDispatcher.withParameters(0, mediaPeriodId, j7);
    }

    public final MediaSourceEventListener.EventDispatcher createEventDispatcher(int i9, MediaSource.MediaPeriodId mediaPeriodId, long j7) {
        return this.eventDispatcher.withParameters(i9, mediaPeriodId, j7);
    }
}
