...
public final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec, DataSource.Factory factory, Format format, long j3, int i10, MediaSourceEventListener.EventDispatcher eventDispatcher, boolean z10) {
        this.dataSpec = dataSpec;
    ...
    public final void onLoadCanceled(SourceLoadable sourceLoadable, long j3, long j10, boolean z10) {
        this.eventDispatcher.loadCanceled(sourceLoadable.dataSpec, 1, -1, null, 0, null, 0L, this.durationUs, j3, j10, sourceLoadable.sampleSize);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public final void onLoadCompleted(SourceLoadable sourceLoadable, long j3, long j10) {
        this.eventDispatcher.loadCompleted(sourceLoadable.dataSpec, 1, -1, this.format, 0, null, 0L, this.durationUs, j3, j10, sourceLoadable.sampleSize);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public final int onLoadError(SourceLoadable sourceLoadable, long j3, long j10, IOException iOException) {
        int i10 = this.errorCount + 1;
        this.errorCount = i10;
        boolean z10 = this.treatLoadErrorsAsEndOfStream && i10 >= this.minLoadableRetryCount;
        this.eventDispatcher.loadError(sourceLoadable.dataSpec, 1, -1, this.format, 0, null, 0L, this.durationUs, j3, j10, sourceLoadable.sampleSize, iOException, z10);
        if (!z10) {
            return 0;
        }
        this.loadingFinished = true;
