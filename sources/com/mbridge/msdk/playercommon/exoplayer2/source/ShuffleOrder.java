...
public interface ShuffleOrder {
    ...
    public static class DefaultShuffleOrder implements ShuffleOrder {
        ...
        public DefaultShuffleOrder(int i10, long j3) {
            this(i10, new Random(j3));
        }
    ...
    public static final class UnshuffledShuffleOrder implements ShuffleOrder {
        ...
        @Override // com.mbridge.msdk.playercommon.exoplayer2.source.ShuffleOrder
        public final ShuffleOrder cloneAndInsert(int i10, int i11) {
            return new UnshuffledShuffleOrder(this.length + i11);
        }

        @Override // com.mbridge.msdk.playercommon.exoplayer2.source.ShuffleOrder
        public final ShuffleOrder cloneAndRemove(int i10) {
