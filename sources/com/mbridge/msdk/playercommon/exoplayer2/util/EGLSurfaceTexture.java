...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void init(int i10) {
        ...
        EGLContext createEGLContext = createEGLContext(this.display, chooseEGLConfig, i10);
        this.context = createEGLContext;
        this.surface = createEGLSurface(this.display, chooseEGLConfig, createEGLContext, i10);
