...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    private static EGLContext createEGLContext(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i9) {
        int[] iArr;
        if (i9 == 0) {
    ...
    private static EGLSurface createEGLSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i9) {
        int[] iArr;
    ...
    public final void init(int i9) {
        ...
        EGLContext createEGLContext = createEGLContext(this.display, chooseEGLConfig, i9);
        this.context = createEGLContext;
        this.surface = createEGLSurface(this.display, chooseEGLConfig, createEGLContext, i9);
