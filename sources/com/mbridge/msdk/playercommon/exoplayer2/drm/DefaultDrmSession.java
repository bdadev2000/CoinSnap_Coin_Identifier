...
public class DefaultDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
    ...
    public class PostRequestHandler extends Handler {
        ...
        public void post(int i9, Object obj, boolean z8) {
    ...
    public void onKeyResponse(Object obj, Object obj2) {
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                int i9 = this.mode;
                if ((i9 == 2 || (i9 == 0 && this.offlineLicenseKeySetId != null)) && provideKeyResponse != null && provideKeyResponse.length != 0) {
        ...
        if (obj == this.currentProvisionRequest) {
            if (this.state == 2 || isOpen()) {
                ...
                try {
                    ...
                    this.provisioningManager.onProvisionError(e4);
                }
            }
        }
    }
    ...
    private void postKeyRequest(int i9, boolean z8) {
        ...
        try {
            Pair create = Pair.create(this.mediaDrm.getKeyRequest(bArr3, bArr2, str2, i9, this.optionalKeyRequestParameters), str);
    ...
    private boolean restoreKeys() {
        try {
            ...
            Log.e(TAG, "Error trying to restore Widevine keys.", e4);
            onError(e4);
            return false;
        }
    }
