...
public final class ExoPlayerFactory {
    ...
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int i10, long j3) {
        return newSimpleInstance(new DefaultRenderersFactory(context, i10, j3), trackSelector, loadControl, drmSessionManager);
    }
