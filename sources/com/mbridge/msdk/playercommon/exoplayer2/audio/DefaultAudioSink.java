...
public final class DefaultAudioSink implements AudioSink {
    ...
    public static final class PlaybackParametersCheckpoint {
        ...
        private PlaybackParametersCheckpoint(PlaybackParameters playbackParameters, long j3, long j10) {
    ...
    public final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public final void onInvalidLatency(long j3) {
            Log.w(DefaultAudioSink.TAG, "Ignoring impossibly large audio latency: " + j3);
        }

        @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioTrackPositionTracker.Listener
        public final void onPositionFramesMismatch(long j3, long j10, long j11, long j12) {
            StringBuilder o10 = a.o("Spurious audio timestamp (frame position mismatch): ", j3, ", ");
            o10.append(j10);
            o10.append(", ");
            o10.append(j11);
            o10.append(", ");
            o10.append(j12);
            o10.append(", ");
            o10.append(DefaultAudioSink.this.getSubmittedFrames());
            o10.append(", ");
            o10.append(DefaultAudioSink.this.getWrittenFrames());
        ...
        public final void onSystemTimeUsMismatch(long j3, long j10, long j11, long j12) {
            StringBuilder o10 = a.o("Spurious audio timestamp (system clock mismatch): ", j3, ", ");
            o10.append(j10);
            o10.append(", ");
            o10.append(j11);
            o10.append(", ");
        ...
        public final void onUnderrun(int i10, long j3) {
            if (DefaultAudioSink.this.listener != null) {
                DefaultAudioSink.this.listener.onUnderrun(i10, j3, SystemClock.elapsedRealtime() - DefaultAudioSink.this.lastFeedElapsedRealtimeMs);
            }
        }
    }
    ...
    */
    ...
    private static int getFramesPerEncodedSample(int i10, ByteBuffer byteBuffer) {
        if (i10 != 7 && i10 != 8) {
            ...
            throw new IllegalStateException(j.i("Unexpected audio encoding: ", i10));
        }
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j3) throws AudioSink.WriteException {
        ...
        if (Util.SDK_INT < 21) {
            ...
            i10 = writeNonBlockingWithAvSyncV21(this.audioTrack, byteBuffer, remaining2, j3);
        } else {
    ...
    private int writeNonBlockingWithAvSyncV21(AudioTrack audioTrack, ByteBuffer byteBuffer, int i10, long j3) {
    ...
    */
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final void enableTunnelingV21(int i10) {
        boolean z10;
        if (Util.SDK_INT >= 21) {
            z10 = true;
        } else {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final boolean handleBuffer(ByteBuffer byteBuffer, long j3) throws AudioSink.InitializationException, AudioSink.WriteException {
        boolean z10;
        ...
        if (this.inputBuffer == null) {
            ...
            if (this.afterDrainPlaybackParameters != null) {
                ...
                this.playbackParametersCheckpoints.add(new PlaybackParametersCheckpoint(this.audioProcessorChain.applyPlaybackParameters(playbackParameters), Math.max(0L, j3), framesToDurationUs(getWrittenFrames())));
                setupAudioProcessors();
            }
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(inputFramesToDurationUs - j3) > 200000) {
                    StringBuilder o10 = a.o("Discontinuity detected [expected ", inputFramesToDurationUs, ", got ");
                    o10.append(j3);
                    o10.append("]");
                ...
                if (this.startMediaTimeState == 2) {
                    this.startMediaTimeUs = (j3 - inputFramesToDurationUs) + this.startMediaTimeUs;
                    this.startMediaTimeState = 1;
                    AudioSink.Listener listener = this.listener;
                    if (listener != null) {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final boolean isEncodingSupported(int i10) {
