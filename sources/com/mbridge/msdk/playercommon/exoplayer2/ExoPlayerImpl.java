...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    public static final class PlaybackInfoUpdate {
        ...
        public PlaybackInfoUpdate(PlaybackInfo playbackInfo, PlaybackInfo playbackInfo2, Set<Player.EventListener> set, TrackSelector trackSelector, boolean z8, int i9, int i10, boolean z9, boolean z10, boolean z11) {
            boolean z12;
            boolean z13;
            boolean z14;
            ...
            this.positionDiscontinuityReason = i9;
    ...
    private PlaybackInfo getResetPlaybackInfo(boolean z8, boolean z9, int i9) {
        ...
        long j7 = playbackInfo.startPositionUs;
        ...
        return new PlaybackInfo(timeline2, obj2, mediaPeriodId, j7, j9, i9, false, trackGroupArray2, trackSelectorResult);
    }

    private void handlePlaybackInfo(PlaybackInfo playbackInfo, int i9, boolean z8, int i10) {
        int i11;
        int i12 = this.pendingOperationAcks - i9;
        ...
        if (i12 == 0) {
            ...
            updatePlaybackInfo(playbackInfo2, z8, i10, i11, z9, false);
        }
    }

    private long playbackInfoPositionUsToWindowPositionMs(long j7) {
    ...
    private void updatePlaybackInfo(PlaybackInfo playbackInfo, boolean z8, int i9, int i10, boolean z9, boolean z10) {
        boolean z11 = !this.pendingPlaybackInfoUpdates.isEmpty();
        this.pendingPlaybackInfoUpdates.addLast(new PlaybackInfoUpdate(playbackInfo, this.playbackInfo, this.listeners, this.trackSelector, z8, i9, i10, z9, this.playWhenReady, z10));
        this.playbackInfo = playbackInfo;
        if (z11) {
            return;
        }
    ...
    public final void handleEvent(Message message) {
        ...
        handlePlaybackInfo(playbackInfo, i10, z8, i11);
    }
    ...
    public final void seekTo(int i9, long j7) {
        ...
        if (i9 >= 0 && (timeline.isEmpty() || i9 < timeline.getWindowCount())) {
            ...
            if (timeline.isEmpty()) {
                this.maskingWindowPositionMs = j7 == C.TIME_UNSET ? 0L : j7;
                this.maskingPeriodIndex = 0;
            } else {
                long defaultPositionUs = j7 == C.TIME_UNSET ? timeline.getWindow(i9, this.window).getDefaultPositionUs() : C.msToUs(j7);
            ...
            this.internalPlayer.seekTo(timeline, i9, C.msToUs(j7));
            Iterator<Player.EventListener> it = this.listeners.iterator();
            while (it.hasNext()) {
        ...
        throw new IllegalSeekPositionException(timeline, i9, j7);
    }
