...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static long closestVsync(long j3, long j10, long j11) {
        long j12;
    ...
    private boolean isDriftTooLarge(long j3, long j10) {
        if (Math.abs((j10 - this.syncUnadjustedReleaseTimeNs) - (j3 - this.syncFramePresentationTimeNs)) > MAX_ALLOWED_DRIFT_NS) {
            return true;
        }
        return false;
    }
