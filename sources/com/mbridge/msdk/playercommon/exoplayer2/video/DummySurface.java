...
public final class DummySurface extends Surface {
    ...
    public static class DummySurfaceThread extends HandlerThread implements Handler.Callback {
        ...
        private void initInternal(int i9) {
            ...
            this.eglSurfaceTexture.init(i9);
    ...
    private static int getSecureModeV24(Context context) {
        ...
        int i9 = Util.SDK_INT;
        if (i9 < 26 && (Constants.REFERRER_API_SAMSUNG.equals(Util.MANUFACTURER) || "XT1650".equals(Util.MODEL))) {
            return 0;
        }
        if ((i9 < 26 && !context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance")) || (eglQueryString = EGL14.eglQueryString(EGL14.eglGetDisplay(0), 12373)) == null || !eglQueryString.contains(EXTENSION_PROTECTED_CONTENT)) {
            return 0;
        }
    ...
    public static DummySurface newInstanceV17(Context context, boolean z8) {
        ...
        return dummySurfaceThread.init(i9);
    }
