...
final class MediaPeriodQueue {
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodHolder mediaPeriodHolder, MediaPeriodInfo mediaPeriodInfo) {
        ...
        if (mediaPeriodInfo2.startPositionUs == mediaPeriodInfo.startPositionUs && mediaPeriodInfo2.endPositionUs == mediaPeriodInfo.endPositionUs && mediaPeriodInfo2.f14725id.equals(mediaPeriodInfo.f14725id)) {
            return true;
        }
        return false;
    }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j3) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(mediaPeriodInfo.f14725id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i11 = this.timeline.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj = this.period.uid;
            long j12 = mediaPeriodInfo.f14725id.windowSequenceNumber;
            long j13 = 0;
            if (this.timeline.getWindow(i11, this.window).firstPeriodIndex == nextPeriodIndex) {
                Pair<Integer, Long> periodPosition = this.timeline.getPeriodPosition(this.window, this.period, i11, C.TIME_UNSET, Math.max(0L, (mediaPeriodHolder.getRendererOffset() + mediaPeriodInfo.durationUs) - j3));
                ...
                if (mediaPeriodHolder2 != null && mediaPeriodHolder2.uid.equals(obj)) {
                    j11 = mediaPeriodHolder.next.info.f14725id.windowSequenceNumber;
                } else {
            ...
            long j14 = j13;
            return getMediaPeriodInfo(resolveMediaPeriodIdForAds(i10, j14, j10), j14, j13);
        }
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f14725id;
    ...
    private MediaPeriodInfo getMediaPeriodInfo(MediaSource.MediaPeriodId mediaPeriodId, long j3, long j10) {
        this.timeline.getPeriod(mediaPeriodId.periodIndex, this.period);
        if (mediaPeriodId.isAd()) {
    ...
    private MediaPeriodInfo getMediaPeriodInfoForAd(int i10, int i11, int i12, long j3, long j10) {
        long j11;
        ...
        return new MediaPeriodInfo(mediaPeriodId, j11, Long.MIN_VALUE, j3, adDurationUs, isLastInPeriod, isLastInTimeline);
    }

    private MediaPeriodInfo getMediaPeriodInfoForContent(int i10, long j3, long j10) {
        long adGroupTimeUs;
        long j11;
        ...
        return new MediaPeriodInfo(mediaPeriodId, j3, adGroupTimeUs, C.TIME_UNSET, j11, isLastInPeriod, isLastInTimeline);
    }
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(int i10) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.next) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.info.f14725id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.next) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i11) {
                return frontPeriod2.info.f14725id.windowSequenceNumber;
            }
        }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(frontPeriod.info.f14725id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            while (true) {
            ...
            if (nextPeriodIndex == -1 || mediaPeriodHolder == null || mediaPeriodHolder.info.f14725id.periodIndex != nextPeriodIndex) {
                break;
            }
            frontPeriod = mediaPeriodHolder;
        }
        ...
        frontPeriod.info = getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f14725id);
    ...
    public final MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (i10 == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f14725id.windowSequenceNumber;
            }
    ...
    public final void clear(boolean z10) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.info.f14725id.windowSequenceNumber;
            frontPeriod.release();
    ...
    public final MediaPeriodInfo getNextMediaPeriodInfo(long j3, PlaybackInfo playbackInfo) {
        MediaPeriodHolder mediaPeriodHolder = this.loading;
        if (mediaPeriodHolder == null) {
    ...
    public final MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo, int i10) {
        return getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f14725id.copyWithPeriodIndex(i10));
    }
    ...
    public final MediaSource.MediaPeriodId resolveMediaPeriodIdForAds(int i10, long j3) {
        return resolveMediaPeriodIdForAds(i10, j3, resolvePeriodIndexToWindowSequenceNumber(i10));
    }
    ...
    public final boolean updateQueuedPeriods(MediaSource.MediaPeriodId mediaPeriodId, long j3) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.next) {
            ...
            } else if (i11 != -1 && frontPeriod.uid.equals(this.timeline.getPeriod(i11, this.period, true).uid)) {
    ...
    public final boolean updateRepeatMode(int i10) {
        this.repeatMode = i10;
        return updateForPlaybackModeChange();
    }

    public final boolean updateShuffleModeEnabled(boolean z10) {
        this.shuffleModeEnabled = z10;
        return updateForPlaybackModeChange();
    }

    private MediaSource.MediaPeriodId resolveMediaPeriodIdForAds(int i10, long j3, long j10) {
        this.timeline.getPeriod(i10, this.period);
        int adGroupIndexForPositionUs = this.period.getAdGroupIndexForPositionUs(j3);
        if (adGroupIndexForPositionUs == -1) {
            return new MediaSource.MediaPeriodId(i10, j10);
        }
        return new MediaSource.MediaPeriodId(i10, adGroupIndexForPositionUs, this.period.getFirstAdIndexToPlay(adGroupIndexForPositionUs), j10);
    }
    ...
    private MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo, MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        if (mediaPeriodId.isAd()) {
            ...
            j3 = j11;
            return new MediaPeriodInfo(mediaPeriodId, j10, j11, mediaPeriodInfo.contentPositionUs, j3, isLastInPeriod, isLastInTimeline);
        }
        j3 = durationUs;
        return new MediaPeriodInfo(mediaPeriodId, j10, j11, mediaPeriodInfo.contentPositionUs, j3, isLastInPeriod, isLastInTimeline);
    }
