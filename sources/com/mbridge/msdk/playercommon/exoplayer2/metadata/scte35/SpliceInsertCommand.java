...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final class ComponentSplice {
        ...
        private ComponentSplice(int i9, long j7, long j9) {
            this.componentTag = i9;
            this.componentSplicePts = j7;
            this.componentSplicePlaybackPositionUs = j9;
        }
    }

    public static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j7, TimestampAdjuster timestampAdjuster) {
        boolean z8;
        List list;
        boolean z9;
        boolean z10;
        ...
        if (!z8) {
            ...
            if (z14 && !z16) {
                j11 = TimeSignalCommand.parseSpliceTime(parsableByteArray, j7);
            } else {
                j11 = C.TIME_UNSET;
            }
            if (!z14) {
                ...
                for (int i12 = 0; i12 < readUnsignedByte2; i12++) {
                    ...
                    if (!z16) {
                        j13 = TimeSignalCommand.parseSpliceTime(parsableByteArray, j7);
                    } else {
                        j13 = C.TIME_UNSET;
                    }
        ...
        return new SpliceInsertCommand(readUnsignedInt, z8, z9, z12, z10, j9, timestampAdjuster.adjustTsTimestamp(j9), list, z11, j10, i9, i10, i11);
    }
    ...
    private SpliceInsertCommand(long j7, boolean z8, boolean z9, boolean z10, boolean z11, long j9, long j10, List<ComponentSplice> list, boolean z12, long j11, int i9, int i10, int i11) {
