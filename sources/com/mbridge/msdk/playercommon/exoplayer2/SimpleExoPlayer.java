...
public class SimpleExoPlayer implements ExoPlayer, Player.TextComponent, Player.VideoComponent {
    ...
    public final class ComponentListener implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener, AudioRendererEventListener, MetadataOutput, TextOutput, VideoRendererEventListener {
        ...
        public final void onAudioDecoderInitialized(String str, long j3, long j10) {
            ...
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioDecoderInitialized(str, j3, j10);
            }
        }
        ...
        public final void onAudioSinkUnderrun(int i10, long j3, long j10) {
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSinkUnderrun(i10, j3, j10);
            }
        }
        ...
        public final void onDroppedFrames(int i10, long j3) {
            ...
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onDroppedFrames(i10, j3);
            }
        }
        ...
        public final void onVideoDecoderInitialized(String str, long j3, long j10) {
            Iterator it = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onVideoDecoderInitialized(str, j3, j10);
            }
        }
