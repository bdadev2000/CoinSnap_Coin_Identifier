...
public class SimpleExoPlayer implements ExoPlayer, Player.TextComponent, Player.VideoComponent {
    ...
    public final class ComponentListener implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener, AudioRendererEventListener, MetadataOutput, TextOutput, VideoRendererEventListener {
        ...
        public final void onAudioDecoderInitialized(String str, long j7, long j9) {
            ...
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioDecoderInitialized(str, j7, j9);
            }
        }
        ...
        public final void onAudioSinkUnderrun(int i9, long j7, long j9) {
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSinkUnderrun(i9, j7, j9);
            }
        }
        ...
        public final void onDroppedFrames(int i9, long j7) {
            ...
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onDroppedFrames(i9, j7);
            }
        }
        ...
        public final void onVideoDecoderInitialized(String str, long j7, long j9) {
            Iterator it = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onVideoDecoderInitialized(str, j7, j9);
            }
        }
        ...
        public final void onVideoSizeChanged(int i9, int i10, int i11, float f9) {
            Iterator it = SimpleExoPlayer.this.videoListeners.iterator();
            while (it.hasNext()) {
                ((com.mbridge.msdk.playercommon.exoplayer2.video.VideoListener) it.next()).onVideoSizeChanged(i9, i10, i11, f9);
            }
            Iterator it2 = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it2.hasNext()) {
