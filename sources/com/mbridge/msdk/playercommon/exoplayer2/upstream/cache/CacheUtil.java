...
public final class CacheUtil {
    ...
    public static void getCached(DataSpec dataSpec, Cache cache, CachingCounters cachingCounters) {
        ...
        while (j12 != 0) {
            ...
            long cachedLength = cache.getCachedLength(key, j11, j7);
            if (cachedLength > 0) {
    ...
    private static long readAndDiscard(DataSpec dataSpec, long j7, long j9, DataSource dataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i9, CachingCounters cachingCounters) throws IOException, InterruptedException {
        int length;
    ...
    public static void cache(DataSpec dataSpec, Cache cache, CacheDataSource cacheDataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i9, CachingCounters cachingCounters, AtomicBoolean atomicBoolean, boolean z8) throws IOException, InterruptedException {
