...
public final class SimpleCache implements Cache {
    ...
    private SimpleCacheSpan getSpan(String str, long j3) throws Cache.CacheException {
        SimpleCacheSpan span;
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent == null) {
            return SimpleCacheSpan.createOpenHole(str, j3);
        }
        while (true) {
            span = cachedContent.getSpan(j3);
    ...
    public final synchronized long getCachedLength(String str, long j3, long j10) {
        ...
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent != null) {
            j11 = cachedContent.getCachedBytesLength(j3, j10);
        } else {
            j11 = -j10;
        }
        return j11;
    ...
    */
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized void setContentLength(String str, long j3) throws Cache.CacheException {
        ContentMetadataMutations contentMetadataMutations = new ContentMetadataMutations();
        ContentMetadataInternal.setContentLength(contentMetadataMutations, j3);
        applyContentMetadataMutations(str, contentMetadataMutations);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized File startFile(String str, long j3, long j10) throws Cache.CacheException {
        boolean z10;
        ...
        this.evictor.onStartFile(this, str, j3, j10);
        return SimpleCacheSpan.getCacheFile(this.cacheDir, cachedContent.f14741id, j3, System.currentTimeMillis());
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized SimpleCacheSpan startReadWrite(String str, long j3) throws InterruptedException, Cache.CacheException {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized SimpleCacheSpan startReadWriteNonBlocking(String str, long j3) throws Cache.CacheException {
        Assertions.checkState(!this.released);
        SimpleCacheSpan span = getSpan(str, j3);
        if (span.isCached) {
