...
public final class SimpleCache implements Cache {
    ...
    private SimpleCacheSpan getSpan(String str, long j7) throws Cache.CacheException {
        SimpleCacheSpan span;
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent == null) {
            return SimpleCacheSpan.createOpenHole(str, j7);
        }
        while (true) {
            span = cachedContent.getSpan(j7);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized long getCachedLength(String str, long j7, long j9) {
        long j10;
        Assertions.checkState(!this.released);
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent != null) {
            j10 = cachedContent.getCachedBytesLength(j7, j9);
        } else {
            j10 = -j9;
        }
        return j10;
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized boolean isCached(String str, long j7, long j9) {
        boolean z8;
        z8 = false;
        Assertions.checkState(!this.released);
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent != null) {
            if (cachedContent.getCachedBytesLength(j7, j9) >= j9) {
                z8 = true;
            }
        }
        return z8;
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized void setContentLength(String str, long j7) throws Cache.CacheException {
        ContentMetadataMutations contentMetadataMutations = new ContentMetadataMutations();
        ContentMetadataInternal.setContentLength(contentMetadataMutations, j7);
        applyContentMetadataMutations(str, contentMetadataMutations);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized File startFile(String str, long j7, long j9) throws Cache.CacheException {
        ...
        try {
            ...
            this.evictor.onStartFile(this, str, j7, j9);
        } catch (Throwable th) {
            throw th;
        }
        return SimpleCacheSpan.getCacheFile(this.cacheDir, cachedContent.id, j7, System.currentTimeMillis());
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized SimpleCacheSpan startReadWrite(String str, long j7) throws InterruptedException, Cache.CacheException {
        SimpleCacheSpan startReadWriteNonBlocking;
        while (true) {
            startReadWriteNonBlocking = startReadWriteNonBlocking(str, j7);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public final synchronized SimpleCacheSpan startReadWriteNonBlocking(String str, long j7) throws Cache.CacheException {
        Assertions.checkState(!this.released);
        SimpleCacheSpan span = getSpan(str, j7);
        if (span.isCached) {
