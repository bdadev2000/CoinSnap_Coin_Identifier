...
public final class H262Reader implements ElementaryStreamReader {
    ...
    public static final class CsdBuffer {
        ...
        public final void onData(byte[] bArr, int i10, int i11) {
            if (!this.isFilling) {
                return;
            }
            int i12 = i11 - i10;
        ...
        public final boolean onStartCode(int i10, int i11) {
            if (this.isFilling) {
    ...
    */
    ...
    public final void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            int i12 = parsableByteArray.data[i11] & UByte.MAX_VALUE;
            if (!this.hasOutputFormat) {
                ...
                if (this.csdBuffer.onStartCode(i12, i10)) {
            ...
            if (i12 != 0 && i12 != START_SEQUENCE_HEADER) {
                ...
                if (this.startedFirstSample && this.sampleHasPicture && this.hasOutputFormat) {
                    this.output.sampleMetadata(this.sampleTimeUs, this.sampleIsKeyframe ? 1 : 0, ((int) (this.totalBytesWritten - this.samplePosition)) - i14, i14, null);
                }
                boolean z13 = this.startedFirstSample;
                if (z13 && !this.sampleHasPicture) {
                    z10 = false;
                    z11 = true;
                } else {
                    this.samplePosition = this.totalBytesWritten - i14;
