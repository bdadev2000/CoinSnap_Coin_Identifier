        ...
        if (!this.foundAllTracks) {
            if (pesReader == null) {
                ...
                if (elementaryStreamReader != null) {
                    elementaryStreamReader.createTracks(this.output, new TsPayloadReader.TrackIdGenerator(i10, 256));
            ...
            if (this.foundAudioTrack && this.foundVideoTrack) {
                j3 = this.lastTrackPosition + MAX_SEARCH_LENGTH_AFTER_AUDIO_AND_VIDEO_FOUND;
            } else {
                j3 = MAX_SEARCH_LENGTH;
            }
