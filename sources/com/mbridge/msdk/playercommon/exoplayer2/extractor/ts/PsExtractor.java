...
public final class PsExtractor implements Extractor {
    ...
    public final int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        int i9 = readInt & 255;
        PesReader pesReader = this.psPayloadReaders.get(i9);
        if (!this.foundAllTracks) {
            if (pesReader == null) {
                ...
                if (elementaryStreamReader != null) {
                    elementaryStreamReader.createTracks(this.output, new TsPayloadReader.TrackIdGenerator(i9, 256));
            ...
            if (this.foundAudioTrack && this.foundVideoTrack) {
                j7 = this.lastTrackPosition + MAX_SEARCH_LENGTH_AFTER_AUDIO_AND_VIDEO_FOUND;
            } else {
                j7 = MAX_SEARCH_LENGTH;
            }
