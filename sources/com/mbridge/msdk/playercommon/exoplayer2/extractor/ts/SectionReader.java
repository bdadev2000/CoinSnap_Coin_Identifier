...
public final class SectionReader implements TsPayloadReader {
    ...
    public final void consume(ParsableByteArray parsableByteArray, boolean z10) {
        int i10;
        if (z10) {
            ...
            if (i11 < 3) {
                ...
                if (i12 == 3) {
                    ...
                    if (capacity < i13) {
                        ...
                        parsableByteArray2.reset(Math.min(MAX_SECTION_LENGTH, Math.max(i13, bArr.length * 2)));
