...
final class OggPageHeader {
    ...
    public final boolean populate(ExtractorInput extractorInput, boolean z10) throws IOException, InterruptedException {
        boolean z11;
        this.scratch.reset();
        reset();
        ...
        if (z11 && extractorInput.peekFully(this.scratch.data, 0, 27, true)) {
