...
final class VorbisReader extends StreamReader {
    ...
    public static void appendNumberOfSamples(ParsableByteArray parsableByteArray, long j3) {
    ...
    private static int decodeBlockSize(byte b3, VorbisSetup vorbisSetup) {
        if (!vorbisSetup.modes[readBits(b3, vorbisSetup.iLogModes, 1)].blockFlag) {
            return vorbisSetup.idHeader.blockSize0;
        }
        return vorbisSetup.idHeader.blockSize1;
    }

    public static int readBits(byte b3, int i10, int i11) {
    ...
    public final void onSeekEnd(long j3) {
        boolean z10;
        super.onSeekEnd(j3);
        int i10 = 0;
        if (j3 != 0) {
    ...
    public final long preparePayload(ParsableByteArray parsableByteArray) {
        ...
        int decodeBlockSize = decodeBlockSize(b3, this.vorbisSetup);
