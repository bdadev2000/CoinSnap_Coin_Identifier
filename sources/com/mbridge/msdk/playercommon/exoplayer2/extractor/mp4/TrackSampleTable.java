...
final class TrackSampleTable {
    ...
    public TrackSampleTable(Track track, long[] jArr, int[] iArr, int i10, long[] jArr2, int[] iArr2, long j3) {
        boolean z10;
        boolean z11;
    ...
    public final int getIndexOfEarlierOrEqualSynchronizationSample(long j3) {
    ...
    public final int getIndexOfLaterOrEqualSynchronizationSample(long j3) {
