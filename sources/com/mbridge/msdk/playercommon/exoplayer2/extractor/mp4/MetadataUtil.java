...
final class MetadataUtil {
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == Atom.TYPE_data) {
            ...
            if (str == null) {
                o.z(parseFullAtomFlags, "Unrecognized cover art flags: ", TAG);
                return null;
            }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i9, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == Atom.TYPE_data && readInt >= 22) {
            ...
            if (readUnsignedShort > 0) {
                String h6 = o.h(readUnsignedShort, "");
                int readUnsignedShort2 = parsableByteArray.readUnsignedShort();
                if (readUnsignedShort2 > 0) {
                    h6 = h6 + "/" + readUnsignedShort2;
                }
                return new TextInformationFrame(str, null, h6);
            }
        }
    ...
    private static Id3Frame parseInternalAttribute(ParsableByteArray parsableByteArray, int i9) {
        ...
        return new InternalFrame(str, str2, parsableByteArray.readNullTerminatedString(i11 - 16));
    }
