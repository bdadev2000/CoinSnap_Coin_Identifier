...
abstract class Atom {
    ...
    public static final class ContainerAtom extends Atom {
        ...
        public ContainerAtom(int i10, long j3) {
            super(i10);
            this.endPosition = j3;
        ...
        public final int getChildAtomOfTypeCount(int i10) {
        ...
        public final ContainerAtom getContainerAtomOfType(int i10) {
        ...
        public final LeafAtom getLeafAtomOfType(int i10) {
            int size = this.leafChildren.size();
            for (int i11 = 0; i11 < size; i11++) {
