...
final class TtmlStyle {
    ...
    public final TtmlStyle setBackgroundColor(int i9) {
    ...
    public final TtmlStyle setFontColor(int i9) {
        boolean z8;
        if (this.inheritableStyle == null) {
            z8 = true;
        } else {
    ...
    public final TtmlStyle setFontSize(float f9) {
        this.fontSize = f9;
        return this;
    }

    public final TtmlStyle setFontSizeUnit(int i9) {
