...
public class VideoFeedsPlayer implements Player.EventListener {
        ...
        public void run() {
            ...
            try {
                if (VideoFeedsPlayer.this.exoPlayer != null && VideoFeedsPlayer.this.exoPlayerIsPlaying()) {
                    ...
                    float f9 = ((float) VideoFeedsPlayer.this.mCurrentPosition) / 1000.0f;
                    ...
                    if (VideoFeedsPlayer.this.exoPlayer != null && VideoFeedsPlayer.this.exoPlayer.getDuration() > 0) {
                        j7 = VideoFeedsPlayer.this.exoPlayer.getDuration() / 1000;
                    ...
                    if (round >= 0 && j7 > 0 && round < 1 + j7) {
                        VideoFeedsPlayer.this.postOnPlayProgressOnMainThread(round, (int) j7);
                    }
                ...
                ad.b(VideoFeedsPlayer.TAG, e4.getMessage());
            }
        }
    };
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoFeedsPlayer.6
                    ...
                    public void run() {
                        if (VideoFeedsPlayer.this.mOutterVFListener != null) {
                            try {
                                VideoFeedsPlayer.this.mOutterVFListener.onPlayProgress(i9, i10);
                            } catch (Exception e4) {
                                ad.b(VideoFeedsPlayer.TAG, e4.getMessage());
                            }
                        }
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                VideoFeedsPlayer.this.mInnerVFPLisener.onPlayProgress(i9, i10);
                            } catch (Exception e9) {
                                ad.b(VideoFeedsPlayer.TAG, e9.getMessage());
                            }
                        }
    ...
    private void postOnPlayStartOnMainThread(final long j7) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoFeedsPlayer.9
                    ...
                    public void run() {
                        ...
                        if (VideoFeedsPlayer.this.mOutterVFListener != null) {
                            try {
                                VideoFeedsPlayer.this.mOutterVFListener.onPlayStarted(i9);
                            } catch (Exception e4) {
                                ad.b(VideoFeedsPlayer.TAG, e4.getMessage());
                            }
                        }
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                VideoFeedsPlayer.this.mInnerVFPLisener.onPlayStarted(i9);
                            } catch (Exception e9) {
                                ad.b(VideoFeedsPlayer.TAG, e9.getMessage());
                            }
                        }
    ...
    public void setPlaybackParams(float f9) {
        try {
            if (exoPlayerIsPlaying()) {
                this.exoPlayer.setPlaybackParameters(new PlaybackParameters(f9));
            } else {
                this.exoPlayer.setPlaybackParameters(new PlaybackParameters(f9));
                this.exoPlayer.stop();
            }
