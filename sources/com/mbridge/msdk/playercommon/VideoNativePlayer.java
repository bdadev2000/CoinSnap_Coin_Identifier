...
public class VideoNativePlayer implements Player.EventListener {
        ...
        public void run() {
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    ad.c(VideoNativePlayer.TAG, "currentPosition:" + i10 + " mCurrentPosition:" + VideoNativePlayer.this.mCurrentPosition);
                    if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayer.getDuration() > 0) {
                        i9 = (int) (VideoNativePlayer.this.exoPlayer.getDuration() / 1000);
                    } else {
                        i9 = 0;
                    }
                    if (VideoNativePlayer.this.mIsStartPlay) {
                        VideoNativePlayer.this.postOnPlayStartOnMainThread(i9);
                        ad.c(VideoNativePlayer.TAG, "onPlayStarted()");
                        VideoNativePlayer.this.mIsStartPlay = false;
                    }
                    if (i10 >= 0 && i9 > 0 && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                        VideoNativePlayer.this.postOnPlayProgressOnMainThread(i10, i9);
                    }
                ...
                ad.b(VideoNativePlayer.TAG, e4.getMessage());
            }
        }
    };
        ...
        public void run() {
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayer.getDuration() > 0) {
                        j7 = VideoNativePlayer.this.exoPlayer.getDuration() / 100;
                    } else {
                        j7 = 0;
                    }
                    if (j9 >= 0 && j7 > 0 && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                        VideoNativePlayer videoNativePlayer2 = VideoNativePlayer.this;
                        videoNativePlayer2.postOnPlayProgressMSOnMainThread(videoNativePlayer2.mCurrentPosition / 100, j7);
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postOnPlayProgressMSOnMainThread(final long j7, final long j9) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoNativePlayer.8
                    ...
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayProgressMS((int) j7, (int) j9);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayProgressMS((int) j7, (int) j9);
                        }
                    }
                });
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postOnPlayProgressOnMainThread(final int i9, final int i10) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoNativePlayer.7
                    ...
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayProgress(i9, i10);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayProgress(i9, i10);
                        }
                    }
                });
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postOnPlayStartOnMainThread(final int i9) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoNativePlayer.11
                    ...
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayStarted(i9);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayStarted(i9);
                        }
                    }
                });
            }
    ...
    public boolean onError(int i9, String str) {
        try {
            ad.b(TAG, "onError what:" + i9 + " extra:" + str);
            hideLoading();
    ...
    public void onPlayerStateChanged(boolean z8, int i9) {
        ad.b(TAG, "onPlaybackStateChanged : " + i9);
        if (i9 != 1) {
            if (i9 != 2) {
                if (i9 != 3) {
                    if (i9 == 4) {
    ...
    public void onPositionDiscontinuity(int i9) {
        ad.b(TAG, "onPositionDiscontinuity : " + i9);
        if (i9 == 0) {
            onCompletion();
        }
    }
    ...
    public void play(Context context, String str, int i9) {
        try {
            ad.b(TAG, "进来播放 currentionPosition:" + this.mCurrentPosition);
            this.mCurrentPosition = (long) i9;
            if (TextUtils.isEmpty(str)) {
