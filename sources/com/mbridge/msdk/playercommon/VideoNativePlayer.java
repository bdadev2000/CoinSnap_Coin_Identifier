...
public class VideoNativePlayer implements Player.EventListener {
        ...
        public void run() {
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    ad.c(VideoNativePlayer.TAG, "currentPosition:" + i11 + " mCurrentPosition:" + VideoNativePlayer.this.mCurrentPosition);
                ...
                ad.b(VideoNativePlayer.TAG, e2.getMessage());
            }
        }
    };
        ...
        public void run() {
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayer.getDuration() > 0) {
                        j3 = VideoNativePlayer.this.exoPlayer.getDuration() / 100;
                    } else {
                        j3 = 0;
                    }
                    if (j10 >= 0 && j3 > 0 && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                        VideoNativePlayer videoNativePlayer2 = VideoNativePlayer.this;
                        videoNativePlayer2.postOnPlayProgressMSOnMainThread(videoNativePlayer2.mCurrentPosition / 100, j3);
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postOnPlayProgressMSOnMainThread(final long j3, final long j10) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoNativePlayer.8
                    ...
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayProgressMS((int) j3, (int) j10);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayProgressMS((int) j3, (int) j10);
                        }
                    }
                });
            }
    ...
    public void onPositionDiscontinuity(int i10) {
        ad.b(TAG, "onPositionDiscontinuity : " + i10);
        if (i10 == 0) {
            onCompletion();
        }
    }
