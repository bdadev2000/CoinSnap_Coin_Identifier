...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(byte b3, long j3, long j10) throws IOException;

    long indexOf(ByteString byteString) throws IOException;

    long indexOf(ByteString byteString, long j3) throws IOException;

    long indexOfElement(ByteString byteString) throws IOException;

    long indexOfElement(ByteString byteString, long j3) throws IOException;

    InputStream inputStream();

    boolean rangeEquals(long j3, ByteString byteString) throws IOException;

    boolean rangeEquals(long j3, ByteString byteString, int i10, int i11) throws IOException;
    ...
    void readFully(Buffer buffer, long j3) throws IOException;
    ...
    String readString(long j3, Charset charset) throws IOException;
