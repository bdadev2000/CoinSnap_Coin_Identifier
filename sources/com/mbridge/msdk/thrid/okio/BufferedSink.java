...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    BufferedSink write(Source source, long j3) throws IOException;
    ...
    BufferedSink writeDecimalLong(long j3) throws IOException;

    BufferedSink writeHexadecimalUnsignedLong(long j3) throws IOException;

    BufferedSink writeInt(int i10) throws IOException;

    BufferedSink writeIntLe(int i10) throws IOException;

    BufferedSink writeLong(long j3) throws IOException;

    BufferedSink writeLongLe(long j3) throws IOException;
