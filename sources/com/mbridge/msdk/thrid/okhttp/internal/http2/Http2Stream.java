...
public final class Http2Stream {
    ...
    public final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z8) throws IOException {
            ...
            try {
                ...
                int i9 = http2Stream3.id;
                if (z8 && min == this.sendBuffer.size()) {
                    z9 = true;
                } else {
                    z9 = false;
                }
                http2Connection.writeData(i9, z9, this.sendBuffer, min);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final class FramingSource implements Source {
        ...
        */
        ...
        public void receive(BufferedSource bufferedSource, long j7) throws IOException {
            boolean z8;
            boolean z9;
            boolean z10;
            long j9;
            while (j7 > 0) {
                synchronized (Http2Stream.this) {
                    z8 = this.finished;
                    z9 = false;
                    if (this.readBuffer.size() + j7 > this.maxByteCount) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                ...
                long read = bufferedSource.read(this.receiveBuffer, j7);
                if (read != -1) {
                    j7 -= read;
                    synchronized (Http2Stream.this) {
                        try {
