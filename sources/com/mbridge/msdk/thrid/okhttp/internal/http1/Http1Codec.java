...
public final class Http1Codec implements HttpCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        public long read(Buffer buffer, long j3) throws IOException {
            try {
                long read = Http1Codec.this.source.read(buffer, j3);
                if (read > 0) {
                    this.bytesRead += read;
                }
                return read;
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j3) throws IOException {
            if (!this.closed) {
                ...
                Http1Codec.this.sink.writeHexadecimalUnsignedLong(j3);
                Http1Codec.this.sink.writeUtf8("\r\n");
                Http1Codec.this.sink.write(buffer, j3);
                Http1Codec.this.sink.writeUtf8("\r\n");
                return;
            }
        ...
        public long read(Buffer buffer, long j3) throws IOException {
            if (j3 >= 0) {
                if (!this.closed) {
                    ...
                    long read = super.read(buffer, Math.min(j3, this.bytesRemainingInChunk));
                    if (read != -1) {
        ...
        public long read(Buffer buffer, long j3) throws IOException {
            if (j3 >= 0) {
                if (!this.closed) {
                    ...
                    long read = super.read(buffer, Math.min(j10, j3));
                    if (read != -1) {
