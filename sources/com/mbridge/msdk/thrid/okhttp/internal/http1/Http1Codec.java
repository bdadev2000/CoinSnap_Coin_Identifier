...
public final class Http1Codec implements HttpCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        public final void endOfInput(boolean z8, IOException iOException) throws IOException {
            Http1Codec http1Codec = Http1Codec.this;
            int i9 = http1Codec.state;
            if (i9 == 6) {
                return;
            }
            if (i9 == 5) {
        ...
        public long read(Buffer buffer, long j7) throws IOException {
            try {
                long read = Http1Codec.this.source.read(buffer, j7);
                if (read > 0) {
                    this.bytesRead += read;
                }
                return read;
        ...
        public long read(Buffer buffer, long j7) throws IOException {
            if (j7 >= 0) {
                if (!this.closed) {
                    ...
                    long read = super.read(buffer, Math.min(j7, this.bytesRemainingInChunk));
                    if (read != -1) {
        ...
        public void write(Buffer buffer, long j7) throws IOException {
            if (!this.closed) {
                ...
                if (j7 <= this.bytesRemaining) {
                    ...
                    throw new ProtocolException("expected " + this.bytesRemaining + " bytes but received " + j7);
                }
            }
            throw new IllegalStateException("closed");
        }
    ...
    public class FixedLengthSource extends AbstractSource {
        ...
        public FixedLengthSource(long j7) throws IOException {
            super();
            this.bytesRemaining = j7;
            if (j7 == 0) {
                endOfInput(true, null);
        ...
        public long read(Buffer buffer, long j7) throws IOException {
            if (j7 >= 0) {
                if (!this.closed) {
                    ...
                    long read = super.read(buffer, Math.min(j9, j7));
                    if (read != -1) {
    ...
    public Source newFixedLengthSource(long j7) throws IOException {
        if (this.state == 4) {
            this.state = 5;
