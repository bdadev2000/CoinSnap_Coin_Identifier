...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public DiskLruCache(FileSystem fileSystem, File file, int i10, int i11, long j3, Executor executor) {
    ...
    public static DiskLruCache create(FileSystem fileSystem, File file, int i10, int i11, long j3) {
        if (j3 > 0) {
            if (i11 > 0) {
                return new DiskLruCache(fileSystem, file, i10, i11, j3, new ThreadPoolExecutor(0, 1, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(), Util.threadFactory("OkHttp DiskLruCache", true)));
            }
