...
final class Relay {
    ...
    public class RelaySource implements Source {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:37:0x0083, code lost:
            ...
            r21.sourcePos += r2;
            r21.fileOperator.write(r7 + com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.FILE_HEADER_SIZE, r21.this$0.upstreamBuffer.m7clone(), r11);
            r4 = r21.this$0;
         */
    ...
    private Relay(RandomAccessFile randomAccessFile, Source source, long j3, ByteString byteString, long j10) {
        boolean z10;
    ...
    public static Relay edit(File file, Source source, ByteString byteString, long j3) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, "rw");
        Relay relay = new Relay(randomAccessFile, source, 0L, byteString, j3);
    ...
    private void writeHeader(ByteString byteString, long j3, long j10) throws IOException {
        Buffer buffer = new Buffer();
    ...
    private void writeMetadata(long j3) throws IOException {
        Buffer buffer = new Buffer();
        buffer.write(this.metadata);
        new FileOperator(this.file.getChannel()).write(FILE_HEADER_SIZE + j3, buffer, this.metadata.size());
    }

    public void commit(long j3) throws IOException {
        writeMetadata(j3);
