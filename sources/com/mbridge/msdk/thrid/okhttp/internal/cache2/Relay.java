...
final class Relay {
        ...
        public void close() throws IOException {
            ...
            synchronized (Relay.this) {
                try {
                    ...
                    int i9 = relay.sourceCount - 1;
                    relay.sourceCount = i9;
                    if (i9 == 0) {
                            ...
                            if (j9 == j10) {
                                ...
                                if (relay2.upstreamReader != null) {
                                    ...
                                    try {
                                        ...
                                        long min = Math.min(read, j7);
                                        Relay.this.upstreamBuffer.copyTo(buffer, 0L, min);
                                        this.sourcePos += min;
                                        this.fileOperator.write(j10 + Relay.FILE_HEADER_SIZE, Relay.this.upstreamBuffer.m4clone(), read);
                                        synchronized (Relay.this) {
                                            try {
    ...
    private Relay(RandomAccessFile randomAccessFile, Source source, long j7, ByteString byteString, long j9) {
        boolean z8;
    ...
    private void writeHeader(ByteString byteString, long j7, long j9) throws IOException {
        Buffer buffer = new Buffer();
    ...
    private void writeMetadata(long j7) throws IOException {
        ...
        new FileOperator(this.file.getChannel()).write(FILE_HEADER_SIZE + j7, buffer, this.metadata.size());
    }
