...
public final class a {
    ...
    private static boolean f15785j = false;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.video.dynview.i.c.b f15786b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, Bitmap> f15787c;

    /* renamed from: d, reason: collision with root package name */
    private volatile boolean f15788d;

    /* renamed from: e, reason: collision with root package name */
    private String f15789e = "#FFFFFFFF";

    /* renamed from: f, reason: collision with root package name */
    private String f15790f = "#60000000";

    /* renamed from: g, reason: collision with root package name */
    private String f15791g = "#FF5F5F5F";

    /* renamed from: h, reason: collision with root package name */
    private String f15792h = "#90ECECEC";

    /* renamed from: i, reason: collision with root package name */
    private volatile long f15793i = 0;

    /* renamed from: k, reason: collision with root package name */
    private com.mbridge.msdk.video.dynview.i.c.a f15794k = null;
    ...
    public com.mbridge.msdk.video.dynview.d.a a = new com.mbridge.msdk.video.dynview.d.a() { // from class: com.mbridge.msdk.video.dynview.j.a.1
        ...
        public final void a() {
            if (a.this.f15795l && a.this.f15786b != null) {
                a.this.f15786b.a(a.this.f15796m * 1000, a.this.f15794k);
                a.this.f15795l = false;
            }
        }

        @Override // com.mbridge.msdk.video.dynview.d.a
        public final void b() {
            if (a.this.f15786b != null) {
                a.this.f15786b.b();
                a.this.f15795l = true;
            }
        }
    ...
    public class AnonymousClass9 implements com.mbridge.msdk.foundation.same.c.c {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ImageView f15816b;
        ...
        public final void onFailedLoad(String str, String str2) {
            try {
                int a = v.a(this.f15816b.getContext(), "mbridge_icon_play_bg", "drawable");
                this.f15816b.setBackgroundColor(Color.parseColor(a.this.f15791g));
                this.f15816b.setImageResource(a);
                this.f15816b.setScaleType(ImageView.ScaleType.CENTER);
            } catch (Exception e2) {
                ad.a("DataEnergizeWrapper", e2.getMessage());
            }
        }
        ...
        public final void onSuccessLoad(final Bitmap bitmap, String str) {
            if (bitmap != null && !bitmap.isRecycled()) {
                int i10 = this.a;
                if (i10 != 501 && i10 != 802) {
                    this.f15816b.setImageBitmap(bitmap);
                    return;
                } else {
                    com.mbridge.msdk.foundation.same.f.b.a().execute(new Runnable() { // from class: com.mbridge.msdk.video.dynview.j.a.9.1
                        ...
                        public final void run() {
                            try {
                                ...
                                AnonymousClass9.this.f15816b.post(new Runnable() { // from class: com.mbridge.msdk.video.dynview.j.a.9.1.1
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        AnonymousClass9.this.f15816b.setImageBitmap(a);
                                    }
                                });
                            } catch (Exception e2) {
                                ad.b("DataEnergizeWrapper", e2.getMessage());
                            }
                        }
                    });
                    return;
    ...
    public final void c(com.mbridge.msdk.video.dynview.c cVar, View view, final Map map, e eVar) {
        try {
            ...
            if (map != null && map.containsKey("is_dy_success")) {
                f15785j = ((Boolean) map.get("is_dy_success")).booleanValue();
            }
            for (CampaignEx campaignEx : g10) {
                if (campaignEx != null) {
                    campaignEx.setECTemplateRenderSucc(f15785j);
                }
            }
            ListView listView = (ListView) view.findViewById(a(f15785j, "mbridge_order_view_lv"));
            GridView gridView = (GridView) view.findViewById(a(f15785j, "mbridge_order_view_h_lv"));
            ImageView imageView = (ImageView) view.findViewById(a(f15785j, "mbridge_order_view_iv_close"));
                ...
                if (listView != null) {
                    try {
                        ...
                        if (layoutParams != null) {
                            ...
                            float c10 = (cVar.c() - ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 720.0f)) / 2.0f;
                            int a = ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 10.0f);
                            int i10 = (int) c10;
                            layoutParams.setMargins(a, i10, a, i10);
    ...
    public final void b(com.mbridge.msdk.video.dynview.c cVar, View view, Map map, e eVar) {
        ...
        ImageView imageView = (ImageView) view.findViewById(a(f15785j, "mbridge_reward_icon_riv"));
        TextView textView = (TextView) view.findViewById(a(f15785j, "mbridge_reward_title_tv"));
        LinearLayout linearLayout2 = (LinearLayout) view.findViewById(a(f15785j, "mbridge_reward_stars_mllv"));
        TextView textView2 = (TextView) view.findViewById(a(f15785j, "mbridge_reward_click_tv"));
        ImageView imageView2 = (ImageView) view.findViewById(a(f15785j, "mbridge_videoview_bg"));
        TextView textView3 = (TextView) view.findViewById(a(f15785j, "mbridge_reward_desc_tv"));
        RelativeLayout relativeLayout = (RelativeLayout) view.findViewById(a(f15785j, "mbridge_reward_bottom_layout"));
    ...
    */
    ...
    private void b() {
        ...
        com.mbridge.msdk.video.dynview.i.c.b bVar = this.f15786b;
        if (bVar != null) {
            bVar.b();
            this.f15786b = null;
        }
        ...
        Map<String, Bitmap> map = this.f15787c;
        if (map != null) {
            if (map.entrySet() != null) {
                try {
                    Iterator<Map.Entry<String, Bitmap>> it = this.f15787c.entrySet().iterator();
                    while (it.hasNext()) {
            ...
            public final void onSuccessLoad(Bitmap bitmap, String str2) {
                ...
                if (bitmap != null && !bitmap.isRecycled() && (imageView2 = imageView) != null) {
                    ...
                    if (a.this.f15787c != null) {
                        a.this.f15787c.put(SameMD5.getMD5(str), bitmap);
    ...
    private Bitmap a() {
        ...
        try {
            ...
            bitmap.eraseColor(Color.parseColor(this.f15792h));
            return bitmap;
        } catch (Exception e2) {
    ...
    private void a(com.mbridge.msdk.video.dynview.c cVar, View view) {
        a.C0206a a = com.mbridge.msdk.video.dynview.g.a.a();
        a.a(cVar.e()).a(true);
        if (cVar.e() != 2) {
            a.a(cVar.d()).b(cVar.c());
        ...
        if (map.containsKey("choice_one_callback") && (map.get("choice_one_callback") instanceof d)) {
            ...
            if (dVar != null) {
                ...
                try {
                    ...
                    dVar2.a("time", Long.valueOf(aVar.f15793i));
                    dVar2.a("choose_cid", campaignEx.getId());
                    dVar2.a("position", Integer.valueOf(i10));
    ...
    public static /* synthetic */ void a(a aVar, com.mbridge.msdk.video.dynview.c cVar, View view) {
        Map<String, Bitmap> map = aVar.f15787c;
        if (map == null || map.size() <= 1) {
            return;
        }
        new com.mbridge.msdk.video.dynview.h.b();
        Map<String, Bitmap> map2 = aVar.f15787c;
        if (view != null) {
