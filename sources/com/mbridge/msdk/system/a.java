...
public abstract class a implements MBridgeSDK {
    ...
    private final Application.ActivityLifecycleCallbacks activityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks() { // from class: com.mbridge.msdk.system.a.1
        ...
        public final void onActivityStopped(Activity activity) {
            int f10 = c.m().f();
            ad.b("com.mbridge.msdk", "onActivityStopped currentActivityNum:" + f10);
            if (f10 == 1 || f10 == 0) {
    ...
    private void initMIMManager() {
        try {
            ...
            ad.b("com.mbridge.msdk", th2.getMessage());
        }
    }
    ...
    */
    ...
    public void setCoppaStatus(Context context, boolean z10) {
        ...
        com.mbridge.msdk.foundation.a.a.a.a().b(MBridgeConstans.AUTHORITY_COPPA, i10);
    }
    ...
    public void setDoNotTrackStatus(boolean z10) {
        com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().b(z10 ? 1 : 0);
    }

    @Override // com.mbridge.msdk.MBridgeSDK
    public void setPlayVideoMute(int i10, int i11) {
        if (i10 == 94) {
            com.mbridge.msdk.foundation.same.a.V = i11;
        } else if (i10 == 287) {
    ...
    private void init() {
        ...
        try {
            ...
            ad.b("com.mbridge.msdk", e2.getMessage());
        }
        ...
        try {
            ...
            ad.b("com.mbridge.msdk", "INIT FAIL", e10);
            if (this.sdkInited != null) {
            ...
            if (sDKInitStatusListener3 != null && !this.initCallbacked) {
                this.initCallbacked = true;
                sDKInitStatusListener3.onInitFail(e10.getMessage());
            }
        }
        ...
        try {
            ...
            if (this.sdkInited != null) {
                String str = "1";
                dVar.a(NotificationCompat.CATEGORY_STATUS, this.sdkInited.get() ? "1" : MBridgeConstans.API_REUQEST_CATEGORY_APP);
