...
public class MBNoRecycledCrashImageView extends ImageView {
    ...
    public MBNoRecycledCrashImageView(Context context, AttributeSet attributeSet, int i9) {
        super(context, attributeSet, i9);
    }

    public MBNoRecycledCrashImageView(Context context, AttributeSet attributeSet, int i9, int i10) {
