...
public final class d {
    ...
    private static String f15148b = "ResManager";

    /* renamed from: c, reason: collision with root package name */
    private static int f15149c = 1;
    ...
    */
    ...
    private static boolean a(MBSplashView mBSplashView, CampaignEx campaignEx, String str, String str2, boolean z10, int i10, boolean z11) {
        boolean z12;
        if (campaignEx == null) {
            return false;
        }
        ...
        if (TextUtils.isEmpty(campaignEx.getVideoUrlEncode())) {
            ...
            boolean z13 = mBSplashView.isVideoReady() || com.mbridge.msdk.videocommon.download.b.getInstance().a(297, str2, campaignEx.isBidCampaign());
            if (!z13) {
        ...
        if (TextUtils.isEmpty(campaignEx.getAdZip()) && !TextUtils.isEmpty(campaignEx.getAdHtml()) && !mBSplashView.isH5Ready()) {
            ...
            if (TextUtils.isEmpty(b3)) {
                ...
                a(mBSplashView, b3, campaignEx, str, str2, z10, i10);
            }
        }
