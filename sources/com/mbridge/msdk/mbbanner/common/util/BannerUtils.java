...
public class BannerUtils {
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.d.a>> map = b.f15701a;
            ...
            for (int i9 = 0; i9 < list.size(); i9++) {
                ...
                com.mbridge.msdk.foundation.same.d.a aVar = list.get(i9);
            ...
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    if (optJSONObject != null) {
                        str2 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f15682h)).intValue()));
                        str3 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f15683i)).intValue()));
                    } else {
                        str2 = "-999";
                        str3 = "-999";
                    }
    ...
    public static void uisList(Context context, List<CampaignEx> list) {
        if (context != null && list != null && list.size() != 0) {
            j a6 = j.a(g.a(context));
            for (int i9 = 0; i9 < list.size(); i9++) {
                CampaignEx campaignEx = list.get(i9);
                if (a6 != null && !a6.b(campaignEx.getId())) {
