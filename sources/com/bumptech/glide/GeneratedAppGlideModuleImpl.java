...
import com.glority.android.picturexx.utils.CustomAppGlideModule;
...
final class GeneratedAppGlideModuleImpl extends GeneratedAppGlideModule {
    ...
    public GeneratedAppGlideModuleImpl(Context context) {
        if (Log.isLoggable("Glide", 3)) {
            Log.d("Glide", "Discovered AppGlideModule from annotation: com.glority.android.picturexx.utils.CustomAppGlideModule");
