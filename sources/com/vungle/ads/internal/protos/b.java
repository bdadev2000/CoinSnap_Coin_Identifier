...
public final class b extends h3 implements c {
    ...
    public b removeMetrics(int i10) {
        copyOnWrite();
        Sdk$MetricBatch.access$5700((Sdk$MetricBatch) this.instance, i10);
        return this;
    }

    public b setMetrics(int i10, Sdk$SDKMetric sdk$SDKMetric) {
        copyOnWrite();
        Sdk$MetricBatch.access$5200((Sdk$MetricBatch) this.instance, i10, sdk$SDKMetric);
        return this;
    }
    ...
    public b addMetrics(int i10, Sdk$SDKMetric sdk$SDKMetric) {
        copyOnWrite();
        Sdk$MetricBatch.access$5400((Sdk$MetricBatch) this.instance, i10, sdk$SDKMetric);
        return this;
    }

    public b setMetrics(int i10, k kVar) {
        copyOnWrite();
        Sdk$MetricBatch.access$5200((Sdk$MetricBatch) this.instance, i10, (Sdk$SDKMetric) kVar.build());
        return this;
    }
    ...
    public b addMetrics(int i10, k kVar) {
        copyOnWrite();
        Sdk$MetricBatch.access$5400((Sdk$MetricBatch) this.instance, i10, (Sdk$SDKMetric) kVar.build());
        return this;
    }
}
