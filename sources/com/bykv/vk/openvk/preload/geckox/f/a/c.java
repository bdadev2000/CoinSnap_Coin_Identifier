...
public final class c extends a {
    ...
    public final InputStream a(File file, String str) throws IOException {
        File file2 = new File(file, AbstractC2914a.h(new StringBuilder("res"), File.separator, str));
    ...
    public final boolean b(File file, String str) throws IOException {
        return new File(file, AbstractC2914a.h(new StringBuilder("res"), File.separator, str)).exists();
    }
}
