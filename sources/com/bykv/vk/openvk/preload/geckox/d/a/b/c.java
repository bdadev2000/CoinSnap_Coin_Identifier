...
public class c extends com.bykv.vk.openvk.preload.b.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f10062g;

    /* renamed from: h, reason: collision with root package name */
    private File f10063h;

    @Override // com.bykv.vk.openvk.preload.b.d
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f10062g = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f10063h = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.b.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        try {
            this.f10062g.f10019d.downloadFile(uri, length, new BufferOutputStream(a));
            try {
            ...
            a.e();
            StringBuilder o10 = j.o("download patch single file failed, url:", uri, ", channel:");
