...
public class c extends com.bykv.vk.openvk.preload.b.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f13235g;

    /* renamed from: h, reason: collision with root package name */
    private File f13236h;

    @Override // com.bykv.vk.openvk.preload.b.d
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f13235g = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f13236h = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.b.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        try {
            this.f13235g.f13194d.downloadFile(uri, length, new BufferOutputStream(a6));
            try {
            ...
            a6.e();
            StringBuilder n2 = o.n("download patch single file failed, url:", uri, ", channel:");
