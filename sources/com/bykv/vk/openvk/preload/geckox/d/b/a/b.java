...
public class b extends com.bykv.vk.openvk.preload.b.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f13238g;

    /* renamed from: h, reason: collision with root package name */
    private File f13239h;

    @Override // com.bykv.vk.openvk.preload.b.d
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f13238g = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f13239h = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.b.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        file2.mkdirs();
        com.bykv.vk.openvk.preload.geckox.buffer.a a6 = com.bykv.vk.openvk.preload.geckox.buffer.a.a.a(new File(file2, "res.zip"), length);
        try {
            this.f13238g.f13194d.downloadFile(uri, length, new BufferOutputStream(a6));
            try {
            ...
            a6.e();
            StringBuilder n2 = o.n("download full zip file failed, url:", uri, ", channel:");
