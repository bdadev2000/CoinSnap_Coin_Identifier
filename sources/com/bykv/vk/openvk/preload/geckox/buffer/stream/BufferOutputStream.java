...
public class BufferOutputStream extends b {
    ...
    public void write(long j3, int i10) throws IOException {
        synchronized (this) {
            this.mBuffer.b(j3);
            this.mBuffer.a(i10);
        }
    ...
    @Override // com.bykv.vk.openvk.preload.geckox.buffer.stream.b
    public void write(long j3, byte[] bArr) throws IOException {
        synchronized (this) {
            this.mBuffer.b(j3);
            this.mBuffer.a(bArr);
        }
    ...
    @Override // com.bykv.vk.openvk.preload.geckox.buffer.stream.b
    public void write(long j3, byte[] bArr, int i10, int i11) throws IOException {
        synchronized (this) {
            this.mBuffer.b(j3);
            this.mBuffer.a(bArr, i10, i11);
        }
