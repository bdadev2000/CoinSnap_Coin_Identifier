...
public final class h extends t<Object> {
    public static final u a = new u() { // from class: com.bykv.vk.openvk.preload.a.b.a.h.1
        @Override // com.bykv.vk.openvk.preload.a.u
        public final <T> t<T> a(com.bykv.vk.openvk.preload.a.f fVar, com.bykv.vk.openvk.preload.a.c.a<T> aVar) {
            if (aVar.f9888b == Object.class) {
                return new h(fVar);
            }
            return null;
        }
    ...
    private final com.bykv.vk.openvk.preload.a.f f9781b;
    ...
    public final void a(com.bykv.vk.openvk.preload.a.d.c cVar, Object obj) throws IOException {
        ...
        t a10 = this.f9781b.a((Class) obj.getClass());
        if (a10 instanceof h) {
            cVar.c();
            cVar.d();
        } else {
