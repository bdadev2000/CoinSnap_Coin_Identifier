...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bytedance2.weakreference.b f14539a;
    private AdEvents b;

    /* renamed from: c, reason: collision with root package name */
    private MediaEvents f14540c;
    ...
    public AdSessionStatePublisher() {
        a();
        this.f14539a = new com.iab.omid.library.bytedance2.weakreference.b(null);
    }

    public void a() {
        this.f14542e = f.b();
        this.f14541d = a.AD_STATE_IDLE;
    }
    ...
    public void b(String str, long j7) {
        if (j7 >= this.f14542e) {
            this.f14541d = a.AD_STATE_VISIBLE;
            g.a().a(getWebView(), str);
        }
    }

    public void a(WebView webView) {
        this.f14539a = new com.iab.omid.library.bytedance2.weakreference.b(webView);
    }
    ...
    public void a(boolean z8) {
        if (e()) {
            g.a().b(getWebView(), z8 ? "foregrounded" : "backgrounded");
        }
    }
}
