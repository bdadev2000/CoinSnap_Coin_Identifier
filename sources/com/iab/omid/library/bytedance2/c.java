...
class c {
    ...
    private static final Pattern f12237b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* renamed from: c, reason: collision with root package name */
    private static final Pattern f12238c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* renamed from: d, reason: collision with root package name */
    private static final Pattern f12239d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* renamed from: e, reason: collision with root package name */
    private static final Pattern f12240e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* renamed from: f, reason: collision with root package name */
    private static final Pattern f12241f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* renamed from: g, reason: collision with root package name */
    private static final Pattern f12242g = Pattern.compile("<!DOCTYPE [^>]*>", 2);

    public static String a(String str, String str2) {
        g.a(str, "HTML is null or empty");
        int[][] a10 = a(str);
        StringBuilder sb2 = new StringBuilder(str2.length() + str.length() + 16);
        if (!b(str, sb2, f12237b, str2, a10) && !a(str, sb2, a, str2, a10) && !b(str, sb2, f12239d, str2, a10) && !a(str, sb2, f12238c, str2, a10) && !b(str, sb2, f12241f, str2, a10) && !a(str, sb2, f12240e, str2, a10) && !a(str, sb2, f12242g, str2, a10)) {
    ...
    public static String b(String str, String str2) {
        return a(str2, e.f("<script type=\"text/javascript\">", str, "</script>"));
    }
