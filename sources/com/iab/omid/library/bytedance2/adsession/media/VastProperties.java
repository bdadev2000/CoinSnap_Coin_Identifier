...
public final class VastProperties {
    ...
    private final Position f12236d;

    private VastProperties(boolean z10, Float f10, boolean z11, Position position) {
        this.a = z10;
        this.f12234b = f10;
        this.f12235c = z11;
        this.f12236d = position;
    }
    ...
    public JSONObject a() {
        ...
        try {
            ...
            if (this.a) {
                jSONObject.put("skipOffset", this.f12234b);
            }
            jSONObject.put("autoPlay", this.f12235c);
            jSONObject.put("position", this.f12236d);
