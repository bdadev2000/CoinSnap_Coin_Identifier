...
public class c {
    ...
    private static String[] f12281b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f12282c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            ...
            jSONObject.put("height", a10.f12283b);
    ...
    public static void a(Context context) {
        if (context != null) {
            f12282c = context.getResources().getDisplayMetrics().density;
    ...
    public static void a(JSONObject jSONObject, a.C0159a c0159a) {
        com.iab.omid.library.bytedance2.internal.e a10 = c0159a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0159a.b().iterator();
        while (it.hasNext()) {
