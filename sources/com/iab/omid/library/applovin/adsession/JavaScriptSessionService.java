...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        if (!d6.g.s("WEB_MESSAGE_LISTENER")) {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new d() { // from class: com.iab.omid.library.applovin.adsession.JavaScriptSessionService.2
            @Override // k2.d
            public void onPostMessage(WebView webView, c cVar, Uri uri, boolean z10, k2.a aVar) {
                try {
                    ...
                    com.iab.omid.library.applovin.utils.d.a("Error parsing JS message in JavaScriptSessionService.", e2);
                }
            }
        });
    }
