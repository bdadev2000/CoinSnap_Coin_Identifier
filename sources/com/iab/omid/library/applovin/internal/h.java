...
public class h {
    ...
    private static h f14427a = new h();

    /* loaded from: classes3.dex */
    public class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f14428a;
    ...
    public void a(WebView webView, String str, float f9) {
        a(webView, "setDeviceVolume", Float.valueOf(f9), str);
    }
