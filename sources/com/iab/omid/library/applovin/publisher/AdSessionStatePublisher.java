...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.applovin.weakreference.b f12175b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f12176c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f12177d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.a = str;
        this.f12175b = new com.iab.omid.library.applovin.weakreference.b(null);
    }

    public void a() {
        this.f12179f = f.b();
        this.f12178e = a.AD_STATE_IDLE;
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.a, f10);
    }

    public void b(String str, long j3) {
        if (j3 >= this.f12179f) {
            this.f12178e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.a, str);
        }
    }

    public void a(WebView webView) {
        this.f12175b = new com.iab.omid.library.applovin.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f12176c = adEvents;
    }
    ...
    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
