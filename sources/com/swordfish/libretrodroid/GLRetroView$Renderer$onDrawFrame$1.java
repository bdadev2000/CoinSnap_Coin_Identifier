...
public final class GLRetroView$Renderer$onDrawFrame$1 extends r implements q0.a {
    final /* synthetic */ GLRetroView this$0;

    @e(c = "com.swordfish.libretrodroid.GLRetroView$Renderer$onDrawFrame$1$1", f = "GLRetroView.kt", l = {281}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass1 extends i implements p {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                this.label = 1;
                if (l0Var.emit(frameRendered, this) == aVar) {
                    return aVar;
                }
            } else {
                if (i2 != 1) {
    ...
    public final void m617invoke() {
        boolean z2;
        Lifecycle lifecycle;
        z2 = this.this$0.isEmulationReady;
        if (z2) {
