...
public class StaxUnmarshallerContext {
    ...
    public boolean testExpression(String str, int i) {
        ...
        return getCurrentDepth() == i && this.stackString.endsWith(new StringBuilder(RemoteSettings.FORWARD_SLASH_STRING).append(str).toString());
    }
    ...
    private void updateContext() {
        ...
        if (i == 2) {
            String str = this.stackString + RemoteSettings.FORWARD_SLASH_STRING + this.xpp.getName();
