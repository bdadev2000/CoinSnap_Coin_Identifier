...
public class Principal {
    ...
    public static final Principal AllUsers = new Principal("AWS", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final Principal AllServices = new Principal("Service", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final Principal AllWebProviders = new Principal("Federated", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final Principal All = new Principal(ProxyConfig.MATCH_ALL_SCHEMES, ProxyConfig.MATCH_ALL_SCHEMES);
    ...
    public enum Services {
        ...
        AllServices(ProxyConfig.MATCH_ALL_SCHEMES);
    ...
    public enum WebIdentityProviders {
        ...
        AllProviders(ProxyConfig.MATCH_ALL_SCHEMES);
