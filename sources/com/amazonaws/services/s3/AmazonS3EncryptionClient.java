...
public class AmazonS3EncryptionClient extends AmazonS3Client implements AmazonS3Encryption {
    public static final String USER_AGENT = AmazonS3EncryptionClient.class.getName() + RemoteSettings.FORWARD_SLASH_STRING + VersionInfoUtils.getVersion();
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) {
        return this.crypto.putObjectSecurely(putObjectRequest.mo7651clone());
    }
    ...
    public void deleteObject(DeleteObjectRequest deleteObjectRequest) {
        ...
        DeleteObjectRequest deleteObjectRequest2 = (DeleteObjectRequest) deleteObjectRequest.mo7651clone();
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest initiateMultipartUploadRequest) {
        if (!(initiateMultipartUploadRequest instanceof EncryptedInitiateMultipartUploadRequest) || ((EncryptedInitiateMultipartUploadRequest) initiateMultipartUploadRequest).isCreateEncryptionMaterial()) {
