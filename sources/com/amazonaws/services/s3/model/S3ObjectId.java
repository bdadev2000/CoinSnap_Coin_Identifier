...
public class S3ObjectId implements Serializable {
    ...
    public InstructionFileId instructionFileId(String str) {
        StringBuilder append = new StringBuilder().append(this.key + InstructionFileId.DOT);
        if (str == null || str.trim().length() == 0) {
            str = "instruction";
        }
        return new InstructionFileId(this.bucket, append.append(str).toString(), this.versionId);
    }
