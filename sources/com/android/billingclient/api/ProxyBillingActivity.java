...
public class ProxyBillingActivity extends ComponentActivity {
    ...
    */
    ...
    public void onAlternativeBillingOnlyDialogResult(ActivityResult activityResult) {
        Intent intent = activityResult.f277b;
        int zzc = com.google.android.gms.internal.play_billing.zzb.zzc(intent, TAG);
        ...
        if (i2 != -1 || zzc != 0) {
            com.google.android.gms.internal.play_billing.zzb.zzk(TAG, "Alternative billing only dialog finished with resultCode " + i2 + " and billing's responseCode: " + zzc);
        }
        finish();
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.alternativeBillingOnlyDialogLauncher = registerForActivityResult(new Object(), new ActivityResultCallback() { // from class: com.android.billingclient.api.zzcd
        ...
        if (getIntent().hasExtra("ALTERNATIVE_BILLING_ONLY_DIALOG_INTENT")) {
            ...
            ActivityResultLauncher<IntentSenderRequest> activityResultLauncher = this.alternativeBillingOnlyDialogLauncher;
