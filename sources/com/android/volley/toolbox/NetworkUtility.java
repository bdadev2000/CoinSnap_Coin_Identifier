...
final class NetworkUtility {
    ...
    public static byte[] inputStreamToBytes(InputStream inputStream, int i2, ByteArrayPool byteArrayPool) throws IOException {
        byte[] bArr;
    ...
    public static void logSlowRequests(long j2, Request<?> request, byte[] bArr, int i2) {
        if (VolleyLog.DEBUG || j2 > 3000) {
    ...
    public static RetryInfo shouldRetryException(Request<?> request, IOException iOException, long j2, @Nullable HttpResponse httpResponse, @Nullable byte[] bArr) throws VolleyError {
        ...
        if (bArr == null) {
            return new RetryInfo(MaxEvent.d, new NetworkError());
        }
