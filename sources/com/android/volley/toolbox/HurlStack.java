...
public class HurlStack extends BaseHttpStack {
    ...
    private HttpURLConnection openConnection(URL url, Request<?> request) throws IOException {
        ...
        if (TournamentShareDialogURIBuilder.scheme.equals(url.getProtocol()) && (sSLSocketFactory = this.mSslSocketFactory) != null) {
    ...
    public OutputStream createOutputStream(Request<?> request, HttpURLConnection httpURLConnection, int i2) throws IOException {
    ...
    public HttpResponse executeRequest(Request<?> request, Map<String, String> map) throws IOException, AuthFailureError {
        ...
        if (urlRewriter != null) {
            ...
            if (rewriteUrl == null) {
                throw new IOException(j.b("URL blocked by rewriter: ", url));
            }
            url = rewriteUrl;
        }
    ...
    public void setConnectionParametersForRequest(HttpURLConnection httpURLConnection, Request<?> request) throws IOException, AuthFailureError {
        switch (request.getMethod()) {
            ...
            case 1:
                ...
                return;
            case 2:
                httpURLConnection.setRequestMethod(g.d);
                addBodyIfExists(httpURLConnection, request);
                return;
            case 3:
