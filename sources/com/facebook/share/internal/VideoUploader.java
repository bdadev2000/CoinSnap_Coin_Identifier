...
public class VideoUploader {
    ...
    public static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        @Override // com.facebook.share.internal.VideoUploader.UploadWorkItemBase
        public Bundle getParameters() {
            Bundle c2 = androidx.compose.foundation.text.input.a.c(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_START_PHASE);
            c2.putLong(VideoUploader.PARAM_FILE_SIZE, this.uploadContext.videoSize);
            return c2;
        }
    ...
    public static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() throws IOException {
            Bundle c2 = androidx.compose.foundation.text.input.a.c(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_TRANSFER_PHASE);
            c2.putString(VideoUploader.PARAM_SESSION_ID, this.uploadContext.sessionId);
            c2.putString(VideoUploader.PARAM_START_OFFSET, this.chunkStart);
            byte[] chunk = VideoUploader.getChunk(this.uploadContext, this.chunkStart, this.chunkEnd);
            if (chunk == null) {
                throw new FacebookException("Error reading video");
            }
            c2.putByteArray(VideoUploader.PARAM_VIDEO_FILE_CHUNK, chunk);
            return c2;
        }
