...
public class AdView extends RelativeLayout implements Ad {
    ...
    public AdView(Context context, String str, AdSize adSize) {
        super(context);
        C2400c c2400c = new C2400c(this, 29);
        this.mAdViewParentApi = c2400c;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, adSize, c2400c, this);
    }
    ...
    public AdView(Context context, String str, String str2) throws Exception {
        ...
        C2400c c2400c = new C2400c(this, 29);
        this.mAdViewParentApi = c2400c;
        this.mAdViewApi = DynamicLoaderFactory.makeLoader(context).createAdViewApi(context, str, str2, c2400c, this);
    }
}
