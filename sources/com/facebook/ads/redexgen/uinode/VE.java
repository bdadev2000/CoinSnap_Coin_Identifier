...
public final class VE extends C03475a implements DefaultMediaViewVideoRendererApi {
    ...
    private void A09() {
        C0490Ba c0490Ba = this.A04;
        if (c0490Ba != null) {
            QJ qj = (QJ) c0490Ba.getVideoView();
            if (A0G[3].length() != 24) {
    ...
    private void A0A() {
        C0490Ba c0490Ba = this.A04;
        if (c0490Ba != null) {
            c0490Ba.getVideoView().setOnTouchListener(new JJ(this));
        }
    }
    ...
    private void A0C() {
        ...
        C0490Ba c0490Ba = this.A04;
        if (c0490Ba != null && c0490Ba.getState() == RB.A05) {
            this.A0B = true;
        }
        this.A08.A0V();
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i10) {
        JM A01;
        ((C03475a) mediaViewVideoRendererApi.getAdComponentViewApi()).A00(this);
        switch (i10) {
            case 0:
        ...
        ((C03545h) mediaViewVideoRendererApi).A06(A01);
        this.A01 = C03495c.A03(context);
        ...
        while (true) {
            if (i12 < this.A00.getChildCount()) {
                ...
                if (childAt instanceof C0490Ba) {
                    C0490Ba c0490Ba = (C0490Ba) childAt;
                    String[] strArr = A0G;
                    if (strArr[4].length() != strArr[1].length()) {
        ...
        if (strArr2[2].length() == strArr2[0].length()) {
            ...
            if (c0490Ba2 == null) {
                ...
                c0490Ba2.A0c(this.A05);
                C0490Ba c0490Ba3 = this.A04;
                String[] strArr4 = A0G;
                if (strArr4[6].length() != strArr4[5].length()) {
                    throw new RuntimeException();
                }
                A0G[3] = "N5wNlZvELtjdUjcESL7VUEU7";
                c0490Ba3.A0c(this.A06);
            }
            this.A08.A0W(0);
            this.A08.A0X(250);
            A01.AG3();
    ...
    public final void onPrepared() {
        boolean A0n = C0659Ih.A0n(this.A01);
