...
public class C1188bK implements InterfaceC02300k, InterfaceC02340p {
    ...
    private void A06(Map<String, String> map, Map<String, String> map2) {
        try {
            new Handler().postDelayed(new C1189bL(this, map2, A03(map)), this.A01.A07() * 1000);
    ...
    */
    public final void A0M(java.util.Map<java.lang.String, java.lang.String> r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C1188bK.A0M(java.util.Map):void");
    }

    static {
        A04();
        A0E = C1188bK.class.getSimpleName();
    }

    public C1188bK(C1070Yn c1070Yn) {
        this(c1070Yn, new AnonymousClass14());
    }

    public C1188bK(C1070Yn c1070Yn, AnonymousClass14 anonymousClass14) {
        ...
        if (!this.A06) {
            ...
            if (A0f != null && A0f.size() > 0) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    C1188bK adapter = new C1188bK(this.A0A);
    ...
    public final void A0L(C1070Yn c1070Yn, AnonymousClass15 anonymousClass15, J2 j22, C02661v c02661v, JO jo) {
        int i10;
        this.A02 = anonymousClass15;
        this.A04 = jo;
        JSONObject A03 = c02661v.A03();
        C8T A01 = c02661v.A01();
        if (A01 != null) {
            i10 = A01.A06();
        } else {
        ...
        this.A00 = i10;
        A05(AnonymousClass17.A00(c1070Yn, A03, LJ.A02(A03, A02(94, 2, 85))));
        if (AbstractC02310l.A06(c1070Yn, this, j22)) {
            c1070Yn.A0E().A4K();
            anonymousClass15.ACQ(this, C0676Jb.A00(AdErrorType.NO_FILL));
            return;
        }
        if (anonymousClass15 != null) {
            anonymousClass15.ACN(this);
        }
        AnonymousClass16 anonymousClass16 = new AnonymousClass16(c1070Yn, this.A0B, this, anonymousClass15);
