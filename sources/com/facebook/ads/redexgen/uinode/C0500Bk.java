...
public final class C0500Bk implements InterfaceC0990Vi, Comparator<HO> {
    public long A00;
    public final long A01;
    public final TreeSet<HO> A02 = new TreeSet<>(this);

    public C0500Bk(long j3) {
        this.A01 = j3;
    }
    ...
    private void A01(HK hk, long j3) {
        while (this.A00 + j3 > this.A01 && !this.A02.isEmpty()) {
            try {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0990Vi
    public final void ADE(HK hk, String str, long j3, long j10) {
        A01(hk, j10);
    }
}
