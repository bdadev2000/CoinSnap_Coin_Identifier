...
public final class TextureViewSurfaceTextureListenerC0694Ju extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, R9 {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0659Ih.A1X(this.A0N) && this.A06 != null) {
            boolean A07 = A07();
            if (A0P[1].charAt(7) != 'q') {
    ...
    static {
        A04();
        A0Q = TextureViewSurfaceTextureListenerC0694Ju.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0694Ju(C1070Yn c1070Yn) {
        super(c1070Yn);
        this.A0C = RB.A04;
        this.A0D = RB.A04;
        this.A0J = false;
    ...
    public TextureViewSurfaceTextureListenerC0694Ju(C1070Yn c1070Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0694Ju(C1070Yn c1070Yn, AttributeSet attributeSet, int i10) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x0041, code lost:
        ...
        if (r5.A0C != com.facebook.ads.redexgen.uinode.RB.A06) goto L17;
     */
    @Override // com.facebook.ads.redexgen.uinode.R9
    /*
    ...
    */
    public final void AGS(com.facebook.ads.redexgen.uinode.QM r6, int r7) {
        /*
            r5 = this;
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0694Ju.A0P
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 4
            if (r1 == r0) goto L96
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0694Ju.A0P
        ...
        L96:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0694Ju.AGS(com.facebook.ads.redexgen.X.QM, int):void");
    }
                ...
                if ((this.A0N.A0F().A01() || C0659Ih.A1c(this.A0N)) && Build.VERSION.SDK_INT >= 24) {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.R5
                        ...
                        public final void run() {
                            TextureViewSurfaceTextureListenerC0694Ju.this.A0C();
                        }
                    }, 1000L);
                    return;
                } else {
