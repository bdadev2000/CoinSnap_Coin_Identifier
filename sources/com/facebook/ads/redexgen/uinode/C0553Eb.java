...
public class C0553Eb extends ViewGroup implements C3A {
    ...
    public C1097Zp A02;
    public C4P A03;
    public AbstractC03244c A04;
    public AbstractC03324k A05;
    public AbstractC03364o A06;
    public InterfaceC03444x A07;
    ...
    public C3B A0d;
    public InterfaceC03274f A0e;
    public InterfaceC03304i A0f;
    public AbstractC03394r A0g;
    public InterfaceC03404s A0h;
    public AbstractC03414t A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC03414t> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C03434w A0r;
    ...
    public final C1086Ze A11;
    public final C5D A12;
    public final ArrayList<InterfaceC03404s> A13;
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int A05 = this.A01.A05() - 1; A05 >= 0; A05--) {
                ...
                if (!A0F.A0f()) {
                    long A0C = A0C(A0F);
                    C03314j A08 = this.A05.A08(this.A0s, A0F);
                    ...
                    if (A052 == null || A052.A0f()) {
                        ...
                        if (A0H && A052 == A0F) {
                            ...
                            C03314j A04 = this.A0t.A04(A052);
                            this.A0t.A0E(A0F, A08);
                            C03314j A03 = this.A0t.A03(A0F);
                            if (A04 == null) {
                                A0m(A0C, A0F, A052);
                            } else {
    ...
    public C0553Eb(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C0553Eb(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A11 = new C1086Ze(this);
        this.A0r = new C03434w(this);
        this.A0t = new C5E();
        this.A0u = new Runnable() { // from class: com.facebook.ads.redexgen.X.4Z
            @Override // java.lang.Runnable
            public final void run() {
                if (!C0553Eb.this.A0D || C0553Eb.this.isLayoutRequested()) {
                    return;
                }
                if (!C0553Eb.this.A0F) {
                    C0553Eb.this.requestLayout();
                } else if (C0553Eb.this.A0I) {
                    C0553Eb.this.A0J = true;
                } else {
                    C0553Eb.this.A1I();
                }
            }
        ...
        this.A02 = A1E ? new C1097Zp() : null;
        this.A0s = new AnonymousClass53();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C1089Zh(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        this.A0k = new Runnable() { // from class: com.facebook.ads.redexgen.X.4a
            @Override // java.lang.Runnable
            public final void run() {
                if (C0553Eb.this.A05 != null) {
                    C0553Eb.this.A05.A0J();
                }
                C0553Eb.this.A0K = false;
            }
        };
        this.A12 = new C1092Zk(this);
        ...
        setAccessibilityDelegateCompat(new C1084Zb(this));
    ...
    private final AnonymousClass56 A0E(long j3) {
        AbstractC03244c abstractC03244c = this.A04;
        if (abstractC03244c == null || !abstractC03244c.A0A()) {
            return null;
        }
    ...
    public static AnonymousClass56 A0F(View view) {
        ...
        return ((C03374p) layoutParams).A00;
    }
    ...
    public static C0553Eb A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        boolean z10 = view instanceof C0553Eb;
        if (A19[5].charAt(2) != 'Y') {
            throw new RuntimeException();
        }
        ...
        for (int i10 = 0; i10 < count; i10++) {
            C0553Eb A0H = A0H(viewGroup.getChildAt(i10));
            if (A0H != null) {
                return A0H;
            }
        }
    ...
    */
    private void A0L() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.A0L():void");
    }
    ...
    */
    private void A0M() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C0553Eb.A19
            r0 = 3
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        L5d:
            r4.A0C = r0
            com.facebook.ads.redexgen.X.53 r4 = r6.A0s
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C0553Eb.A19
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
        ...
        L8b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.A0M():void");
    }

    private void A0O() {
        this.A01 = new C4C(new C1091Zj(this));
    }
    ...
    */
    private void A0P() {
        ...
        La1:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.A0P():void");
    }
    ...
    private void A0V() {
        this.A08.A08();
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            abstractC03364o.A0x();
        }
    }
    ...
    private final void A0e() {
        this.A00 = new C1098Zq(new C1090Zi(this));
    }
    ...
    private final void A0g() {
        int A06 = this.A01.A06();
        for (int i10 = 0; i10 < A06; i10++) {
            ((C03374p) this.A01.A0A(i10).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private final void A0k(int i10) {
        AbstractC03364o abstractC03364o = this.A06;
        AbstractC03414t abstractC03414t = this.A0i;
        if (abstractC03414t != null) {
            abstractC03414t.A0L(this, i10);
        }
        List<AbstractC03414t> list = this.A0m;
        String[] strArr = A19;
        if (strArr[2].length() == strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0m(long j3, AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562) {
        int A05 = this.A01.A05();
        for (int i10 = 0; i10 < A05; i10++) {
            AnonymousClass56 A0F = A0F(this.A01.A09(i10));
            if (A0F != anonymousClass56 && A0C(A0F) == j3) {
                AbstractC03244c abstractC03244c = this.A04;
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c03374p.A03;
        rect.set((view.getLeft() - rect2.left) - c03374p.leftMargin, (view.getTop() - rect2.top) - c03374p.topMargin, view.getRight() + rect2.right + c03374p.rightMargin, view.getBottom() + rect2.bottom + c03374p.bottomMargin);
    }
    ...
    private void A0p(View view, View view2) {
        ...
        if (focusedLayoutParams instanceof C03374p) {
            C03374p c03374p = (C03374p) focusedLayoutParams;
            if (!c03374p.A01) {
                Rect insets = c03374p.A03;
    ...
    private void A0q(AbstractC03244c abstractC03244c, boolean z10, boolean z11) {
        AbstractC03244c abstractC03244c2 = this.A04;
        if (abstractC03244c2 != null) {
            C1086Ze c1086Ze = this.A11;
            String[] strArr = A19;
            if (strArr[2].length() == strArr[7].length()) {
                throw new RuntimeException();
            }
            ...
            abstractC03244c2.A08(c1086Ze);
        }
        if (!z10 || z11) {
            A1N();
        }
        this.A00.A09();
        AbstractC03244c abstractC03244c3 = this.A04;
        this.A04 = abstractC03244c;
        if (abstractC03244c != null) {
            abstractC03244c.A07(this.A11);
        }
        AbstractC03364o abstractC03364o = this.A06;
        C03434w c03434w = this.A0r;
        AbstractC03244c oldAdapter = this.A04;
        c03434w.A0U(abstractC03244c3, oldAdapter, z10);
        this.A0s.A0D = true;
        A1P();
    }
    ...
    public static void A0s(AnonymousClass56 anonymousClass56) {
        if (anonymousClass56.A09 != null) {
            WeakReference<C0553Eb> weakReference = anonymousClass56.A09;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            C0553Eb c0553Eb = weakReference.get();
            while (c0553Eb != null) {
                View item = anonymousClass56.A0H;
                if (c0553Eb == item) {
                    return;
                }
                Object parent = c0553Eb.getParent();
    ...
    private void A0t(AnonymousClass56 anonymousClass56, AnonymousClass56 anonymousClass562, C03314j c03314j, C03314j c03314j2, boolean z10, boolean z11) {
        ...
        if (this.A05.A0H(anonymousClass56, anonymousClass562, c03314j, c03314j2)) {
            A1M();
        }
    }
    ...
    public static /* synthetic */ boolean A10() {
        return A1E;
    }
    ...
    private final boolean A12(int i10, int i11) {
        ...
        boolean A20 = abstractC03364o.A20();
        ...
        if (!canScrollHorizontal) {
            ...
            AbstractC03394r abstractC03394r = this.A0g;
            if (abstractC03394r != null) {
                boolean canScrollHorizontal2 = abstractC03394r.A0B(i10, i11);
    ...
    private final boolean A13(int i10, int i11, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1J();
            A1K();
            AbstractC02872q.A01(A0I(1361, 9, 75));
            A1h(this.A0s);
            if (i10 != 0) {
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        if (A1q()) {
            ...
            if (accessibilityEvent != null) {
                i10 = AbstractC03093m.A00(accessibilityEvent);
            }
            if (i10 == 0) {
                i10 = 0;
            }
    ...
    public static /* synthetic */ boolean A19(C0553Eb c0553Eb) {
        return c0553Eb.awakenScrollBars();
    }

    public static /* synthetic */ int[] A1A(C0553Eb c0553Eb) {
        return c0553Eb.A16;
    }
    ...
    */
    public final android.graphics.Rect A1D(android.view.View r6) {
        /*
            ...
            com.facebook.ads.redexgen.X.4p r4 = (com.facebook.ads.redexgen.uinode.C03374p) r4
            boolean r0 = r4.A01
            if (r0 != 0) goto Ld
        ...
        L6d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.A1D(android.view.View):android.graphics.Rect");
    }
    ...
    */
    public final android.view.View A1E(android.view.View r3) {
        ...
        L17:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.A1E(android.view.View):android.view.View");
    }
    ...
    public final void A1I() {
        ...
        if (this.A00.A0D(4)) {
            ...
            if (!A0D) {
                AbstractC02872q.A01(A0I(1341, 20, 82));
                A1J();
                A1K();
                this.A00.A08();
                if (!this.A0J) {
    ...
    public final void A1N() {
        AbstractC03324k abstractC03324k = this.A05;
        if (abstractC03324k != null) {
            abstractC03324k.A0I();
        }
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            abstractC03364o.A1I(this.A0r);
            this.A06.A1G(this.A0r);
        }
        this.A0r.A0P();
    }
    ...
    public final void A1W(int i10) {
        ...
        if (abstractC03364o != null) {
            abstractC03364o.A1x(this, this.A0s, i10);
            return;
        }
        String[] strArr3 = A19;
    ...
    public final void A1a(int i10, int i11) {
        int A00 = AbstractC03364o.A00(i10, getPaddingLeft() + getPaddingRight(), C3T.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i12 = paddingTop + width;
        int width2 = C3T.A02(this);
        setMeasuredDimension(A00, AbstractC03364o.A00(i11, i12, width2));
    }
    ...
    public final void A1b(int i10, int i11) {
        ...
        AbstractC03414t abstractC03414t = this.A0i;
        if (abstractC03414t != null) {
            abstractC03414t.A0M(this, i10, i11);
        }
        List<AbstractC03414t> list = this.A0m;
        if (list != null) {
    ...
    public final void A1f(AbstractC03414t abstractC03414t) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC03414t);
    }

    public final void A1g(AbstractC03414t abstractC03414t) {
        List<AbstractC03414t> list = this.A0m;
        if (list != null) {
            list.remove(abstractC03414t);
        }
    }
    ...
    public final void A1i(AnonymousClass56 anonymousClass56, C03314j c03314j) {
        ...
        this.A0t.A0F(anonymousClass56, c03314j);
    }

    public final void A1j(AnonymousClass56 anonymousClass56, C03314j c03314j, C03314j c03314j2) {
        anonymousClass56.A0X(false);
        if (this.A05.A0E(anonymousClass56, c03314j, c03314j2)) {
            A1M();
        }
    }

    public final void A1k(AnonymousClass56 anonymousClass56, C03314j c03314j, C03314j c03314j2) {
        A0r(anonymousClass56);
        anonymousClass56.A0X(false);
        if (this.A05.A0F(anonymousClass56, c03314j, c03314j2)) {
            A1M();
        }
    }
    ...
    public final boolean A1w(AnonymousClass56 anonymousClass56) {
        AbstractC03324k abstractC03324k = this.A05;
        return abstractC03324k == null || abstractC03324k.A0M(anonymousClass56, anonymousClass56.A0L());
    }
    ...
    public final void addFocusables(ArrayList<View> arrayList, int i10, int i11) {
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            boolean A1c = abstractC03364o.A1c(this, arrayList, i10, i11);
            if (A19[5].charAt(2) != 'Y') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C03374p) && this.A06.A1Y((C03374p) layoutParams);
    }

    @Override // android.view.View
    public final int computeHorizontalScrollExtent() {
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null && abstractC03364o.A20()) {
    ...
    public final int computeVerticalScrollExtent() {
        ...
        if (strArr[3].length() != strArr[0].length()) {
            ...
            AbstractC03364o abstractC03364o2 = this.A06;
            String[] strArr3 = A19;
            if (strArr3[3].length() != strArr3[0].length()) {
                A19[5] = "sfYwg45p3roym5legx720iFNlg07mmUN";
                return abstractC03364o2.A1i(this.A0s);
            }
        }
        throw new RuntimeException();
    }
    ...
    public final int computeVerticalScrollOffset() {
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null && abstractC03364o.A21()) {
    ...
    public final int computeVerticalScrollRange() {
        ...
        return abstractC03364o2.A1k(this.A0s);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.draw(android.graphics.Canvas):void");
    }
    ...
    */
    public final android.view.View focusSearch(android.view.View r9, int r10) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            return abstractC03364o.A0v(getContext(), attributeSet);
        }
        throw new IllegalStateException(A0I(1475, 33, 17) + A1H());
    }
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            C03374p A0w = abstractC03364o.A0w(layoutParams);
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    public AbstractC03244c getAdapter() {
        return this.A04;
    }
    ...
    public C1084Zb getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AbstractC03324k getItemAnimator() {
        return this.A05;
    }

    public AbstractC03364o getLayoutManager() {
        return this.A06;
    }
    ...
    public AbstractC03394r getOnFlingListener() {
        return this.A0g;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        AbstractC03364o abstractC03364o = this.A06;
        if (abstractC03364o != null) {
            abstractC03364o.A1Q(this, this.A0r);
        }
        this.A0w.clear();
    ...
    */
    public final boolean onGenericMotionEvent(android.view.MotionEvent r7) {
        ...
        Lb0:
            ...
            goto L57
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.onGenericMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    public final boolean onInterceptTouchEvent(android.view.MotionEvent r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        AbstractC02872q.A01(A0I(1330, 11, 86));
        A0Y();
        AbstractC02872q.A00();
        this.A0D = true;
    }
    ...
    */
    public void onMeasure(int r7, int r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.onMeasure(int, int):void");
    }
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        if (state != null) {
            ...
            AbstractC03364o abstractC03364o = this.A06;
            if (abstractC03364o != null) {
                recyclerView$SavedState.A00 = abstractC03364o.A1l();
            } else {
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0553Eb.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setAccessibilityDelegateCompat(C1084Zb c1084Zb) {
        this.A09 = c1084Zb;
        C3T.A0B(this, c1084Zb);
    }

    public void setAdapter(AbstractC03244c abstractC03244c) {
        setLayoutFrozen(false);
        A0q(abstractC03244c, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(InterfaceC03274f interfaceC03274f) {
        if (interfaceC03274f == null) {
            return;
        }
        this.A0e = interfaceC03274f;
        setChildrenDrawingOrderEnabled(interfaceC03274f != null);
    }
    ...
    public void setItemAnimator(AbstractC03324k abstractC03324k) {
        AbstractC03324k abstractC03324k2 = this.A05;
        if (abstractC03324k2 != null) {
            abstractC03324k2.A0I();
            this.A05.A0B(null);
        }
        this.A05 = abstractC03324k;
        if (abstractC03324k != null) {
            InterfaceC03304i interfaceC03304i = this.A0f;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            strArr[0] = "AtGY6u7EZb";
            abstractC03324k.A0B(interfaceC03304i);
        }
    }
    ...
    public void setLayoutManager(AbstractC03364o abstractC03364o) {
        ...
        this.A01.A0B();
        this.A06 = abstractC03364o;
        if (abstractC03364o != null) {
            C0553Eb c0553Eb = abstractC03364o.A03;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (c0553Eb == null) {
                ...
                throw new IllegalArgumentException(A0I(1109, 14, 88) + abstractC03364o + A0I(59, 39, 9) + abstractC03364o.A03.A1H());
            }
        }
        this.A0r.A0O();
        requestLayout();
    ...
    public void setOnFlingListener(AbstractC03394r abstractC03394r) {
        this.A0g = abstractC03394r;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC03414t abstractC03414t) {
        this.A0i = abstractC03414t;
    }
    ...
    public void setRecyclerListener(InterfaceC03444x interfaceC03444x) {
        this.A07 = interfaceC03444x;
    }
