...
public final class AnonymousClass84 {
    ...
    public static int A00(String str, int i10, C03987f c03987f) {
    ...
    public static void A05(C03987f c03987f, int i10, int i11) {
        c03987f.A07().A9a(A01(435, 10, 113), C8A.A2X, new C8B(A01(338, 33, 80) + i10, A01(87, 9, 13) + i11));
    }

    @Deprecated
    public static void A06(C03987f c03987f, String str, int i10, C8B c8b) {
        if (c03987f == null) {
            A0F(new RuntimeException(A01(48, 39, 84)));
            return;
        }
        AbstractC03977e.A01(c03987f.A01());
        if (A02 && c8b.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 70) + str + A01(31, 16, 8) + i10, c8b));
        }
        try {
            if (A0J(c03987f, str, i10, Math.random(), c8b)) {
                A09(c03987f, str, i10, c8b);
            }
        } catch (Throwable t5) {
            A0F(t5);
        }
    ...
    @Deprecated
    public static void A07(C03987f c03987f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A0A(false);
            c8b.A06(1);
    ...
    @Deprecated
    public static void A08(C03987f c03987f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A08(false);
            A06(c03987f, str, i10, c8b);
    ...
    public static void A09(C03987f c03987f, String str, int i10, C8B c8b) {
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                int A012 = Ij.A01(c03987f);
                ...
                A0A(c03987f, str, i10, c8b, true);
            }
        }
    }

    public static void A0A(C03987f c03987f, String str, int i10, C8B c8b, boolean z10) {
        ...
        if (A08.get() || z11) {
            ...
            if (A012 == 0) {
                Log.e(A013, A01(182, 37, 40) + str + A014 + i10, c8b);
            } else {
                Log.i(A013, A01(306, 32, 116) + str + A014 + i10 + A01(19, 12, 63) + c8b.getMessage() + A01(0, 19, 80) + c8b.A03());
            }
        }
        C1061Ye c1061Ye = new C1061Ye(c03987f, str, i10, c8b, anonymousClass83);
        if (z10) {
            A01.execute(c1061Ye);
        } else {
            c1061Ye.run();
    ...
    public static void A0C(C1069Ym c1069Ym, AnonymousClass83 anonymousClass83, AnonymousClass82 anonymousClass82, boolean z10) {
        ...
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1062Yf(c1069Ym));
            }
        }
    }
    ...
    public static void A0E(Throwable th2) {
        if (A02) {
            A0D(new RuntimeException(A01(NotificationCompat.FLAG_LOCAL_ONLY, 33, 121), th2));
        }
    }
    ...
    public static boolean A0H(C03987f c03987f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && Ij.A0A(c03987f) != 0;
    }

    public static boolean A0I(C03987f c03987f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        if (shouldSkipFunnelEventsForSession != null && shouldSkipFunnelEventsForSession.booleanValue()) {
            return false;
        }
        double funnelEventLogProbability = 1.0d / Ij.A0A(c03987f);
        return c03987f.A08().A00() <= funnelEventLogProbability;
    }
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.uinode.C03987f r12, java.lang.String r13, int r14, double r15, com.facebook.ads.redexgen.uinode.C8B r17) {
        /*
    ...
    public static boolean A0K(C03987f c03987f, String str, int i10, C8B c8b) {
        if (!Ij.A0P(c03987f)) {
            return true;
        }
        int customLimit = A00.get(i10);
        int eventsLimit = Ij.A00(c03987f);
        if (c8b.A02() != -1) {
            eventsLimit = c8b.A02();
        } else {
            int currentCounter = A00(str, i10, c03987f);
