...
public abstract class AbstractC0744Lv {
    public static Bitmap A00(C1070Yn c1070Yn, Bitmap bitmap, int i10) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c1070Yn);
    ...
    public static Bitmap A01(C1070Yn c1070Yn, Bitmap bitmap, int i10, int i11) {
        ...
        try {
            Bitmap A00 = A00(c1070Yn, createBitmap, i10);
            if (i11 != 1) {
            ...
            return new C0957Ua().A02(createBitmap, i10);
        }
    }
}
