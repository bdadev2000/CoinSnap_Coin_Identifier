...
public final class C0989Vh implements HU {
    ...
    public static final C0989Vh A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0989Vh(Collections.emptyMap());
    }

    public C0989Vh(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C0989Vh A00(DataInputStream dataInputStream) throws IOException {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0989Vh.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C0989Vh A08(HW hw) {
        Map<String, byte[]> A022 = A02(this.A01, hw);
        if (A06(A022)) {
            return this;
        }
        return new C0989Vh(A022);
    }
    ...
    public final long A5p(String str, long j3) {
