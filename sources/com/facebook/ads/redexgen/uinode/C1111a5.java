...
public final class C1111a5<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC02952y<K, V> A00;
    ...
    private AbstractC02952y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1112a6(this);
        }
        return this.A00;
    }
