...
public final class D2 {
    ...
    public final SparseArray<C0646Hu> A0D = new SparseArray<>();
    public final SparseArray<C0645Ht> A0C = new SparseArray<>();
                ...
                if (this.A0F.A09()) {
                    ...
                    if (this.A0F.A09()) {
                        ...
                        if (this.A0F.A09()) {
                            ...
                            C0645Ht c0645Ht = this.A0C.get(A042);
                            C0646Hu c0646Hu = this.A0D.get(c0645Ht.A01);
                            if (c0646Hu.A09) {
                                if (this.A0F.A0B(2)) {
                                    I0 i02 = this.A0F;
                                    if (A0I[2].length() != 18) {
                            ...
                            if (this.A0F.A0B(c0646Hu.A01)) {
                                boolean z10 = false;
                                boolean z11 = false;
                                boolean z12 = false;
                                int A052 = this.A0F.A05(c0646Hu.A01);
                                if (c0646Hu.A08) {
                                    if (A0I[5].length() != 7) {
                                        String[] strArr3 = A0I;
                                ...
                                int i20 = 0;
                                if (c0646Hu.A04 == 0) {
                                    if (!this.A0F.A0B(c0646Hu.A03)) {
                                        return;
                                    }
                                    i17 = this.A0F.A05(c0646Hu.A03);
                                    if (c0645Ht.A02 && !z10) {
                                        if (!this.A0F.A09()) {
                                            return;
                                        } else {
                                ...
                                } else if (c0646Hu.A04 == 1 && !c0646Hu.A07) {
                                    if (!this.A0F.A09()) {
                                        return;
                                    }
                                    i19 = this.A0F.A03();
                                ...
                                this.A07.A04(c0646Hu, A05, A04, A052, A042, z10, z11, z12, z13, i16, i17, i18, i19, i20);
                                this.A08 = false;
                            }
                        }
                    }
    ...
    */
    ...
    public final void A03(long j3, int i10, long j10) {
        this.A01 = i10;
        this.A03 = j10;
        this.A02 = j3;
        if (!this.A0G || i10 != 1) {
    ...
    public final void A04(C0645Ht c0645Ht) {
        this.A0C.append(c0645Ht.A00, c0645Ht);
    }

    public final void A05(C0646Hu c0646Hu) {
        this.A0D.append(c0646Hu.A05, c0646Hu);
    }
