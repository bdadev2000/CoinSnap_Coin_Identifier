...
public final class C0475Al extends Exception {
    ...
    */
    public C0475Al(int r5, int r6, int r7, int r8) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0475Al.<init>(int, int, int, int):void");
    }
}
