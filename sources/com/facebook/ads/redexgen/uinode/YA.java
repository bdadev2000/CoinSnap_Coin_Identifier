...
public final class YA<T> implements AnonymousClass97<T> {
    ...
    public YA(AnonymousClass94 anonymousClass94, C9C c9c) throws IOException {
        ...
        C04378y c04378y = new C04378y(new File(anonymousClass94.A05(), A00(509, 6, 70)));
        this.A04 = c04378y;
        this.A00 = c04378y.A03();
    ...
    private void A02(int i10, int i11) throws IOException {
        C04388z c04388z = new C04388z(i10, i11);
        this.A00 = c04388z;
        this.A04.A04(c04388z);
    }
    ...
    public final synchronized AnonymousClass96 A5f(byte[] bArr, int[] iArr) throws C9G {
        ...
        if (!this.A03) {
            ...
            try {
                ...
                while (true) {
                    AnonymousClass92 A0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                    int A00 = A0A.A01().A00();
                    ...
                    if (A0A.A01().A03() == AnonymousClass90.A04) {
                        ...
                        this.A01 = new C04388z(storageOffset5 + 1, 0);
                    } else {
                ...
                if (!arrayList.isEmpty()) {
                    C04388z c04388z = yb2.A01().A02;
                    int storageOffset6 = yb2.A01().A01;
                    this.A01 = c04388z.A05(storageOffset6);
                }
            } catch (IOException e2) {
