...
public final class BI extends AbstractC0937Tg {
    ...
    public BI(OP op) {
        ...
        C0935Te c0935Te = new C0935Te(this);
        this.A0A = c0935Te;
        this.A0B = new O1(op, getAdDataBundle(), A01, A02, getAdDetailsView(), A09, c0935Te);
        ...
        if (supported.A00) {
            ...
            if (!C0659Ih.A18(getAdContextWrapper())) {
                return;
            }
            AbstractC0786Nl.A00(A01.getVideoImplView(), C0659Ih.A19(getAdContextWrapper()), new OT(this));
        }
    }
    ...
    private SA A01(OP op) {
        ...
        int i10 = AbstractC0937Tg.A0F;
        int i11 = AbstractC0937Tg.A0F;
        int toolbarHeight = AbstractC0937Tg.A0F;
        imageView.setPadding(i10, i11, toolbarHeight, AbstractC0937Tg.A0F);
        int toolbarHeight2 = AbstractC0937Tg.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0937Tg.A0G);
        int toolbarHeight3 = AbstractC0937Tg.A0E;
    ...
    private KP A02(OP op) {
        KP A0A = op.A0A();
        A0A.A06(-1, AbstractC0937Tg.A0B);
        A0A.setPadding(AbstractC0937Tg.A0J, AbstractC0937Tg.A0J, AbstractC0937Tg.A0J, AbstractC0937Tg.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0937Tg.A0I);
    ...
    private void A06() {
        ...
        AbstractC0737Lo.A0H(this.A0C);
        AbstractC0737Lo.A0a(this.A0C, this.A0D, this.A0B, this.A00);
        AbstractC0737Lo.A0L(this.A04);
        Q5 q52 = this.A05;
        ...
        switch (OU.A00[((Q4) A03.first).ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                AbstractC0737Lo.A0a(getAdDetailsView());
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0937Tg.A0H, AbstractC0937Tg.A0H, AbstractC0937Tg.A0H, AbstractC0937Tg.A0H);
        ...
        if (getAdInfo().A0G().A00() >= 0) {
            ...
            L9 l92 = new L9((int) getAdInfo().A0G().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0934Td(this));
            this.A03 = l92;
            l92.A07();
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC0937Tg
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC0937Tg, com.facebook.ads.redexgen.uinode.OL, android.view.View
