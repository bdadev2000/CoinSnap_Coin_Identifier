...
public final class C04087t {
    ...
    public C04087t(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C04087t(String[] strArr, Integer num, Integer num2) {
    ...
    public static C04087t A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C04087t(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C04087t)) {
            return false;
        }
        C04087t c04087t = (C04087t) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c04087t.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c04087t.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c04087t.A03);
    }
