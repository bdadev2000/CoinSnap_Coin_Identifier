...
public final class C0681Jh implements RK {
    ...
    public boolean A02;
    public RP A03;
    public final RU A04 = new C0692Js();
    public final RZ A05;
    public final InterfaceC0879Ra A06;
        ...
        try {
            try {
                ...
                if ((A082 instanceof HttpsURLConnection) && (z11 || z10)) {
                    try {
                        AbstractC0880Rb.A03((HttpsURLConnection) A082, A01, A02);
                    } catch (CertificateException e2) {
                        this.A00.AA2(A072, C8A.A1z, new C8B(e2));
                    } catch (Exception e10) {
                        this.A00.AA2(A072, C8A.A1y, new C8B(e10));
                    }
                }
                if (A082.getDoOutput() && rw.A06() != null) {
                    A00(A082, rw.A06());
                }
                C0686Jm A06 = A082.getDoInput() ? A06(A082) : new C0686Jm(A082, null);
                if (this.A06.A98()) {
                    this.A06.A9z(A06);
                }
                if (A082 != null) {
                ...
                try {
                    try {
                        c0686Jm = A05(null);
                        if (c0686Jm == null || c0686Jm.A83() <= 0) {
                            throw new RX(e11, c0686Jm);
                        }
                        if (this.A06.A98()) {
                            this.A06.A9z(c0686Jm);
                        }
                        if (0 != 0) {
                    ...
                    if (this.A06.A98()) {
                        InterfaceC0879Ra interfaceC0879Ra = this.A06;
                        String[] strArr = A08;
    ...
    */
    public final com.facebook.ads.redexgen.uinode.RJ A0J(com.facebook.ads.redexgen.uinode.RW r30) throws com.facebook.ads.redexgen.uinode.RX {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0681Jh.A0J(com.facebook.ads.redexgen.X.RW):com.facebook.ads.redexgen.X.RJ");
    }
    ...
    public C0681Jh(RP rp, AnonymousClass89 anonymousClass89, Executor executor) {
        A0B();
        this.A03 = rp;
        final JN jn = new JN(rp.A04());
        this.A06 = jn;
        this.A05 = new AbstractC0691Jr(jn) { // from class: com.facebook.ads.redexgen.X.76
        };
        this.A01 = executor;
    ...
    private final RJ A03(String str, RY ry, RS rs) {
        return A02(new C0688Jo(str, ry, rs));
    }

    private final RJ A04(String str, String str2, byte[] bArr, RS rs) {
        return A02(new C0687Jn(str, null, str2, bArr, rs));
    }

    private final C0686Jm A05(HttpURLConnection httpURLConnection) throws Exception {
        ...
        try {
            ...
            C0686Jm c0686Jm = new C0686Jm(httpURLConnection, responseBody);
            if (inputStream != null) {
                try {
                    inputStream.close();
                } catch (Exception unused) {
    ...
    private final C0686Jm A06(HttpURLConnection httpURLConnection) throws Exception {
        InputStream inputStream = null;
        byte[] responseBody = null;
        try {
    ...
    private void A0F(String str, String str2, byte[] bArr, RL rl, RS rs) {
        C0687Jn req = new C0687Jn(str, null, str2, bArr, rs);
        A0D(req, rl);
    }
    ...
    private final boolean A0I(Throwable th2, long j3, RW rw) {
        RS A02 = rw.A02();
        long elapsedTime = (System.currentTimeMillis() - j3) + 10;
        if (this.A06.A98()) {
