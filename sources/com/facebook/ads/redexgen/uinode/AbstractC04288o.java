...
public abstract class AbstractC04288o {
    ...
    public static String A01(C03987f c03987f) {
        return WebSettings.getDefaultUserAgent(c03987f);
    }

    public static String A02(final C03987f c03987f) {
        FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.facebook.ads.redexgen.X.8n
            ...
            public final String call() {
                ...
                atomicReference = AbstractC04288o.A04;
                String browserUserAgent = (String) atomicReference.get();
                if (browserUserAgent != null) {
                    return browserUserAgent;
                }
                WebView webView = new WebView(C03987f.this.getApplicationContext());
                ...
                if (userAgentString != null) {
                    atomicReference2 = AbstractC04288o.A04;
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ExecutorC0731Li.A00(futureTask);
            try {
    ...
    public static String A03(C03987f c03987f, C8K c8k) {
        String A07 = c8k.A07();
    ...
    public static String A04(C03987f c03987f, boolean z10) {
        if (c03987f == null) {
            return A00;
        }
        if (z10) {
        ...
        long A012 = AbstractC0658Ig.A01(c03987f);
        String A002 = A00(143, 23, 90);
        String A003 = A00(133, 10, 64);
        String userAgentString = A00(88, 28, 104);
        if (A012 > 0) {
            SharedPreferences sharedPreferences = c03987f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c03987f), 0);
        ...
        if (A012 > 0) {
            SharedPreferences sharedPreferences2 = c03987f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c03987f), 0);
    ...
    public static String A05(C8K c8k, C03987f c03987f) {
        if (AbstractC0658Ig.A04(c03987f)) {
            return A00(63, 5, 117) + A03(c03987f, c8k) + A00(39, 6, 127) + c8k.A06() + A00(45, 6, 121) + c8k.A04() + A00(38, 1, 111);
        }
        return A00(0, 0, 40);
    }

    public static String A06(C8K c8k, C03987f c03987f, boolean z10) {
        return A04(c03987f, z10) + A00(0, 38, 127) + c03987f.A04().A8H() + A00(57, 6, 54) + C8K.A04 + A00(38, 1, 111) + A05(c8k, c03987f) + A00(68, 5, 69) + c03987f.A04().A8I() + A00(51, 6, 77) + Locale.getDefault().toString() + A00(87, 1, 79);
    }

    public static void A09(C03987f c03987f, Throwable th2) {
        c03987f.A07().A9a(A00(166, 8, 84), C8A.A2g, new C8B(th2));
    }
}
