...
public final class UD extends RelativeLayout implements MD {
    ...
    public boolean A0D;
    public boolean A0E;
    public final AbstractC1173b5 A0F;
    public final C02471c A0G;
    public final C5T A0H;
    public final C1070Yn A0I;
    public final J2 A0J;
    public final JA A0K;
    public final L9 A0L;
    public final ViewOnSystemUiVisibilityChangeListenerC0724Lb A0M;
    public final MC A0N;
    public final InterfaceC0758Mj A0O;
    public final O0 A0P;
    public final O1 A0Q;
    public final Q5 A0R;
    ...
    static {
        ...
        A0e = AbstractC02862p.A01(-1, 77);
        A0a = (int) (LD.A02 * 8.0f);
    }

    public UD(C1070Yn c1070Yn, J2 j22, MC mc2, AbstractC1173b5 abstractC1173b5, String str, InterfaceC0758Mj interfaceC0758Mj) {
        super(c1070Yn);
        int A07;
        ...
        this.A0N = mc2;
        this.A0J = j22;
        this.A0F = abstractC1173b5;
        C02471c A06 = abstractC1173b5.A0x().A0D().A06();
        this.A0G = A06;
        this.A0K = new JA(abstractC1173b5.A12(), j22);
        this.A0O = interfaceC0758Mj;
        this.A08 = new Q7(c1070Yn, interfaceC0758Mj, str, mc2);
        this.A0B = abstractC1173b5.A0x().A0M() && abstractC1173b5.A0x().A0D().A02() > 0;
        boolean A0A = abstractC1173b5.A0x().A0D().A0A();
        this.A0V = A0A;
        if (A06 == null) {
        ...
        if (this.A0B && A0A) {
            A07 = abstractC1173b5.A0x().A0D().A02();
        } else {
            A07 = A06.A07();
        }
        ...
        this.A0U = C0659Ih.A0j(c1070Yn);
        FullScreenAdToolbar A072 = A07();
        this.A0W = A072;
        this.A0R = new Q5(c1070Yn, j22, abstractC1173b5);
        ...
        this.A0M = viewOnSystemUiVisibilityChangeListenerC0724Lb;
        viewOnSystemUiVisibilityChangeListenerC0724Lb.A05(EnumC0723La.A03);
        if (C0659Ih.A1q(c1070Yn)) {
            A072.setProgressSpinnerInvisible(true);
        }
        HashMap hashMap = new HashMap();
        hashMap.put(A0D(56, 9, 61), interfaceC0758Mj.A7f());
        this.A07 = new Q0(c1070Yn, abstractC1173b5, A06, j22, new UE(this, uk), hashMap);
        A0K();
        mc2.A3U(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        UJ uj = new UJ(this);
        this.A0P = uj;
        this.A0Q = new O1(c1070Yn, A072, abstractC1173b5, (SA) null, mc2, uj, this.A06, this.A01, this.A07);
    }
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.A06(this.A0F.A0w().A01(), ViewOnClickListenerC0942Tl.A08(this.A0F));
    ...
    private ViewOnClickListenerC0942Tl A09() {
        Q0 q02 = this.A07;
        if (q02 == null || q02.getViewabilityChecker() == null || this.A07.getTouchDataRecorder() == null) {
            return null;
        }
        ViewOnClickListenerC0942Tl button = new ViewOnClickListenerC0942Tl(this.A0I, this.A0O.A6R(), this.A0F.A0w().A01(), this.A0J, this.A0N, this.A07.getViewabilityChecker(), this.A07.getTouchDataRecorder(), this.A0F.A0y());
    ...
    private void A0G() {
        ...
        new AsyncTaskC0947Tq(o32, this.A0I).A05(i10, i10).A07(this.A0F.A10().A01());
    ...
    private void A0J() {
        C0833Pg A0B = new C0831Pe(this.A0I, this.A0F.A0x().A0E(), this.A0F.A10()).A08(this.A0F.A0w().A01()).A0A(this.A0G.A0G()).A09(this.A0G.A0D()).A07(2000).A0B();
    ...
    private void A0K() {
        ...
        AbstractC0737Lo.A0K(relativeLayout2);
        if (this.A0U) {
            A0G();
        } else {
            RelativeLayout relativeLayout3 = this.A02;
        ...
        ViewOnClickListenerC0942Tl viewOnClickListenerC0942Tl = this.A06;
        if (viewOnClickListenerC0942Tl != null) {
            layoutParams.addRule(0, viewOnClickListenerC0942Tl.getId());
    ...
    public void A0L() {
        ...
        AbstractC0737Lo.A0a(this.A0Q, this.A00, this.A07);
        AbstractC0737Lo.A0L(this.A0W);
        AbstractC0737Lo.A0L(this.A06);
        ...
        switch (MT.A00[((Q4) A03.first).ordinal()]) {
            ...
            case 2:
                ...
                if (relativeLayout2 != null) {
                    AbstractC0737Lo.A0a(relativeLayout2);
                }
    ...
    public void A0O(int i10) {
        ...
        AbstractC0737Lo.A0Y(toast, A0C.replace(progress, valueOf), 49, 0, A0g);
    }
    ...
    public void A0U(boolean z10, String str) {
        ...
        new C0792Nr(this.A0I, this.A0O.A6R(), this.A07.getViewabilityChecker(), this.A07.getTouchDataRecorder(), this.A0J, this.A0F.A0y(), this.A0N).A07(this.A0F.A12(), this.A0F.A0x().A0F().A05(), hashMap);
    }
    ...
    public boolean A0V() {
        if (!this.A0F.A0P().equals(A0D(65, 14, 37))) {
            if (this.A0F.A0P().equals(A0D(32, 12, 100))) {
                AbstractC1173b5 abstractC1173b5 = this.A0F;
                if (A0Y[4].length() != 18) {
                    throw new RuntimeException();
                }
                A0Y[0] = "r5y7OBqhAYVA47bIfl4AlIWKO2XfiX80";
                if (abstractC1173b5.A0x().A0O()) {
                }
            }
            return false;
        }
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            ...
            if (!TextUtils.isEmpty(abstractC1173b5.A12())) {
                this.A0J.A9X(this.A0F.A12(), new C0783Ni().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0L.A06();
