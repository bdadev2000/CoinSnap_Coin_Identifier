...
public final class M6 {
    ...
    public static Map<String, String> A01(C1070Yn c1070Yn) {
        Window window;
        ...
        try {
            hashMap.put(A00(40, 3, 111), String.valueOf(A04(c1070Yn)));
            ...
            AnonymousClass89 A07 = c1070Yn.A07();
            int type3 = C8A.A2T;
            A07.A9a(A00(43, 5, 114), type3, new C8B(e2));
        }
        return hashMap;
    }

    public static boolean A03(C1070Yn c1070Yn) {
        return !C0738Lp.A04(A01(c1070Yn));
    }

    public static boolean A04(C1070Yn c1070Yn) {
        KeyguardManager keyguardManager = (KeyguardManager) c1070Yn.getSystemService(A00(32, 8, 4));
