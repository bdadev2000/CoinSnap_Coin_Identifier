...
public final class C03545h implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0814On A0B = new EW(this);
    public final AbstractC0755Mg A0E = new EV(this);
    public final AbstractC0847Pu A09 = new EU(this);
    public final MV A0F = new ET(this);
    public final AbstractC0845Ps A0A = new ES(this);
    public C03475a A02 = new C03475a();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1070Yn A11 = ((V2) nativeAd.getInternalNativeAd()).A11();
        C1070Yn adObjectContext = this.A03;
        adObjectContext.A0K(A11);
        C03555i c03555i = (C03555i) nativeAd.getNativeAdApi();
        this.A05.setClientToken(V2.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c03555i.A01());
        this.A05.setVideoURI(c03555i.A02());
        C1188bK A0y = V2.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (A0y != null) {
        ...
        this.A01 = c03555i.getVideoAutoplayBehavior();
        JM jm = this.A04;
        if (jm != null) {
            jm.AG8(nativeAd);
        }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0b(AbstractC0733Lk.A00(videoStartReason), 3);
        }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1070Yn) {
            ...
            A03 = C03495c.A03(context);
        }
        this.A03 = A03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C0490Ba(A03);
                break;
            case 1:
                this.A05 = new C0490Ba(A03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C0490Ba(A03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C0490Ba(A03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0b(AbstractC0733Lk.A00(videoStartReason), 2);
    }
    ...
    public final boolean shouldAutoplay() {
        C0490Ba c0490Ba = this.A05;
        if (c0490Ba == null || c0490Ba.getState() == RB.A06) {
            return false;
        }
