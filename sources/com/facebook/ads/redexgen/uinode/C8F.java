...
public abstract class C8F {
    ...
    public static JSONObject A01(C03987f c03987f, long j3, long j10, long j11, long j12, int i10, Exception exc) {
        String A002;
        double d10;
        JSONObject jSONObject = new JSONObject();
        try {
            try {
                jSONObject.put(A00(69, 10, 88), j3);
                A002 = A00(21, 8, 36);
                d10 = j10;
        ...
        try {
            jSONObject.put(A002, d10 / 1000.0d);
            try {
    ...
    public static void A03(C03987f c03987f, long j3, long j10, long j11, long j12, int i10, Exception exc) {
        C8B c8b = new C8B(A00(0, 21, 65));
        c8b.A05(1);
        c8b.A07(A01(c03987f, j3, j10, j11, j12, i10, exc));
        c03987f.A07().AAA(A00(50, 7, 100), C8A.A20, c8b);
    }
}
