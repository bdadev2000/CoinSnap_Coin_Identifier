...
public final class CD implements WP, InterfaceC0510Bu, H6<WT>, H9, FA {
    ...
    public final C0562Ek A0S;
    public final InterfaceC0563El A0T;
    public final F1 A0U;
    public final InterfaceC0613Gm A0V;
    public final InterfaceC0621Gu A0W;
    public final String A0b;
    public final C0998Vq A0X = new C0998Vq(A07(0, 27, 27));
    public final C0632Hg A0Y = new C0632Hg();
    public final Runnable A0Z = new RunnableC0560Ei(this);
    public final Runnable A0a = new RunnableC0561Ej(this);
    ...
    public final long AFm(InterfaceC0607Gg[] interfaceC0607GgArr, boolean[] zArr, FB[] fbArr, boolean[] zArr2, long j3) {
        AbstractC0626Ha.A04(this.A0F);
        int i10 = this.A01;
        int i11 = 0;
        while (true) {
            int i12 = 0;
            if (i11 >= interfaceC0607GgArr.length) {
                boolean z10 = !this.A0I ? j3 == 0 : i10 != 0;
                for (int i13 = 0; i13 < interfaceC0607GgArr.length; i13++) {
                    if (fbArr[i13] == null && interfaceC0607GgArr[i13] != null) {
                        InterfaceC0607Gg interfaceC0607Gg = interfaceC0607GgArr[i13];
                        AbstractC0626Ha.A04(interfaceC0607Gg.length() == 1);
                        AbstractC0626Ha.A04(interfaceC0607Gg.A7C(0) == 0);
                        int A00 = this.A09.A00(interfaceC0607Gg.A8A());
                        AbstractC0626Ha.A04(!this.A0L[A00]);
                        this.A01++;
                        this.A0L[A00] = true;
                        ...
                        if (!z10) {
                            WO wo = this.A0K[A00];
                            wo.A0J();
                            z10 = wo.A0D(j3, true, true) == -1 && wo.A0B() != 0;
                        }
                    }
                }
                if (this.A01 == 0) {
            ...
            if (fb2 != null && (interfaceC0607GgArr[i11] == null || !zArr[i11])) {
                int A002 = WS.A00((WS) fbArr[i11]);
                AbstractC0626Ha.A04(this.A0L[A002]);
                this.A01--;
                this.A0L[A002] = false;
                fbArr[i11] = null;
            }
    ...
    public CD(Uri uri, InterfaceC0621Gu interfaceC0621Gu, InterfaceC0508Bs[] interfaceC0508BsArr, int i10, F1 f12, InterfaceC0563El interfaceC0563El, InterfaceC0613Gm interfaceC0613Gm, String str, int i11) {
        this.A0Q = uri;
        this.A0W = interfaceC0621Gu;
        this.A0O = i10;
        this.A0U = f12;
        this.A0T = interfaceC0563El;
        this.A0V = interfaceC0613Gm;
        this.A0b = str;
        this.A0P = i11;
        this.A0S = new C0562Ek(interfaceC0508BsArr, this);
    ...
    public final int AC2(WT wt, long j3, long j10, IOException iOException) {
        boolean isErrorFatal = A0N(iOException);
        this.A0U.A0H(WT.A03(wt), 1, -1, null, 0, null, WT.A00(wt), this.A03, j3, j10, WT.A01(wt), iOException, isErrorFatal);
        A0E(wt);
        if (isErrorFatal) {
            return 3;
        }
    ...
    private long A02() {
        ...
        for (WO wo : this.A0K) {
            ...
            j3 = Math.max(j3, largestQueuedTimestampUs);
        }
        return j3;
    }
    ...
    public void A09() {
        ...
        while (true) {
            ...
            String str = A0G.A0O;
            if (!AbstractC0644Hs.A0B(str) && !AbstractC0644Hs.A09(str)) {
                isAudioVideo = false;
            }
    ...
    private void A0A() {
        ...
        if (this.A0F) {
            AbstractC0626Ha.A04(A0I());
            long j3 = this.A03;
            if (j3 != C.TIME_UNSET && this.A06 >= j3) {
                this.A0B = true;
        ...
        this.A02 = A00();
        this.A0U.A0E(WT.A03(wt), 1, -1, null, 0, null, WT.A00(wt), this.A03, this.A0X.A04(wt, this, this.A00));
    }

    private void A0C(int i10) {
        if (!this.A0M[i10]) {
            Format A01 = this.A09.A01(i10).A01(0);
            this.A0U.A06(AbstractC0644Hs.A01(A01.A0O), A01, 0, null, this.A04);
    ...
    public final void AC1(WT wt, long j3, long j10) {
        long j11;
        if (this.A03 == C.TIME_UNSET) {
            ...
            this.A03 = j11;
            this.A0T.AD9(j11, this.A07.A9I());
        }
        this.A0U.A0G(WT.A03(wt), 1, -1, null, 0, null, WT.A00(wt), this.A03, j3, j10, WT.A01(wt));
        A0E(wt);
        this.A0B = true;
        this.A08.ABC(this);
    }
    ...
    public final void ABz(WT wt, long j3, long j10, boolean z10) {
        this.A0U.A0F(WT.A03(wt), 1, -1, null, 0, null, WT.A00(wt), this.A03, j3, j10, WT.A01(wt));
        if (!z10) {
            A0E(wt);
            for (WO wo : this.A0K) {
                wo.A0I();
    ...
    public final int A0O(int i10, long j3) {
        int A0D;
        if (A0J()) {
            return 0;
        }
        WO wo = this.A0K[i10];
        if (this.A0B && j3 > wo.A0F()) {
            A0D = wo.A0A();
        } else {
            A0D = wo.A0D(j3, true, true);
            String[] strArr = A0d;
            String str = strArr[4];
            String str2 = strArr[5];
    ...
    public final int A0P(int i10, C04539p c04539p, C1048Xr c1048Xr, boolean z10) {
        if (A0J()) {
            return -3;
        }
        int A0E = this.A0K[i10].A0E(c04539p, c1048Xr, z10, this.A0B, this.A04);
        if (A0E == -4) {
            A0C(i10);
        } else if (A0E == -3) {
            A0D(i10);
    ...
    public final void A5A(long j3, boolean z10) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            this.A0K[i10].A0K(j3, z10, this.A0L[i10]);
        }
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0510Bu
    ...
    public final long A5x(long j3, AD ad2) {
        ...
        C0 A7t = this.A07.A7t(j3);
        return IF.A0I(j3, ad2, A7t.A00.A01, A7t.A01.A01);
    }
