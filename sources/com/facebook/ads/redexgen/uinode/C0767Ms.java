...
public final class C0767Ms extends LinearLayout {
    public boolean A00;
    ...
    public C0767Ms(C1070Yn c1070Yn) {
        super(c1070Yn);
        this.A00 = false;
        setOrientation(0);
        int i10 = A04;
    ...
    private void A00() {
        ...
        AbstractC0737Lo.A0X(this.A02, false, 14);
        if (this.A00) {
            textColor = -1;
        } else {
            textColor = -10459280;
    ...
    public void setData(String str, EnumC0745Lw enumC0745Lw) {
