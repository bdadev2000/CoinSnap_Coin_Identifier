...
public final class FG extends AbstractC1154am {
    ...
    public FG(C1070Yn c1070Yn, C02651u c02651u) {
        super(c1070Yn, c02651u);
    }

    private C1146ae A00(Runnable runnable) {
        return new C1146ae(this, runnable);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC1154am
    public final void A0M() {
        AbstractC1177b9 abstractC1177b9 = (AbstractC1177b9) this.A01;
        abstractC1177b9.A00(this.A07.A00);
        abstractC1177b9.A01(this.A07.A01);
        abstractC1177b9.A0I();
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC1154am
    public final void A0O(InterfaceC02340p interfaceC02340p, C8S c8s, C8Q c8q, C02661v c02661v) {
        FY fy = (FY) interfaceC02340p;
        C1147af c1147af = new C1147af(this, c02661v, fy);
        if (C0659Ih.A27(this.A0B)) {
            A0F().postDelayed(c1147af, c8s.A05().A05());
        }
        C1070Yn c1070Yn = this.A0B;
        C1146ae A002 = A00(c1147af);
        boolean z10 = this.A07.A06;
        String str = this.A07.A04;
        C02651u c02651u = this.A07;
        String[] strArr = A01;
        ...
        fy.A0J(c1070Yn, A002, c02661v, z10, str, c02651u.A05);
    }

    public final void A0X(RewardData rewardData) {
        if (this.A01 != null) {
            if (this.A01.A7e() == AdPlacementType.REWARDED_VIDEO) {
                AbstractC1177b9 rewardedVideoAdapter = (AbstractC1177b9) this.A01;
