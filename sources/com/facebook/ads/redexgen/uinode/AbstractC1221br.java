...
public abstract class AbstractC1221br {
    ...
    public static final <T> void A02(Appendable appendable, T t5, GV<? super T, ? extends CharSequence> gv) {
        C1224bu.A07(appendable, A00(0, 6, 6));
        if (gv != null) {
            appendable.append(gv.A8v(t5));
            return;
        }
