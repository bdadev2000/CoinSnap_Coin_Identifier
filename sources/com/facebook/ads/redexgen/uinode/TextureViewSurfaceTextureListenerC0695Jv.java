...
public final class TextureViewSurfaceTextureListenerC0695Jv extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC0872Qt, R9, InterfaceC0874Qv {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0659Ih.A1X(this.A0A) && this.A0D != RB.A08) {
            if (!this.A0L) {
                this.A0L = true;
                this.A0A.A0E().AFY();
            }
            ...
            RC rc2 = this.A0F;
            if (rc2 != null) {
                rc2.ABa(currentPosition, currentPosition2, currentTimeMillis, volume);
            }
        }
    }
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC0695Jv.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0695Jv(C1070Yn c1070Yn) {
        super(c1070Yn);
        this.A0D = RB.A04;
        this.A0E = RB.A04;
        this.A0M = false;
    ...
    public TextureViewSurfaceTextureListenerC0695Jv(C1070Yn c1070Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0695Jv(C1070Yn c1070Yn, AttributeSet attributeSet, int i10) {
    ...
    */
    private void A04() {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0695Jv.A0P
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            ...
            throw r0
        L38:
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0695Jv.A0P
        ...
        Lbc:
            ...
            goto L65
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.TextureViewSurfaceTextureListenerC0695Jv.A04():void");
    }

    private void A05() {
        C0875Qw c0875Qw = this.A0C;
        if (c0875Qw == null) {
            return;
        }
        C0873Qu A08 = c0875Qw.A08();
        String[] strArr = A0P;
    ...
    public final boolean A8b() {
        C0875Qw c0875Qw = this.A0C;
        return c0875Qw != null && c0875Qw.A0K();
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0872Qt
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0874Qv
    ...
    public final void onAttachedToWindow() {
        ...
        if (C0659Ih.A2D(getContext()) && !isHardwareAccelerated()) {
            setVideoState(RB.A03);
            AGZ(8);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z10) {
        ...
        if (!z10) {
            if (this.A0D != RB.A05) {
                if ((this.A0A.A0F().A01() || C0659Ih.A1c(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.R1
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextureViewSurfaceTextureListenerC0695Jv.this.A0A();
                        }
                    }, 1000L);
                    return;
                } else {
    ...
    @Override // com.facebook.ads.redexgen.uinode.R9
    public void setVideoStateChangeListener(RC rc2) {
        this.A0F = rc2;
    }
