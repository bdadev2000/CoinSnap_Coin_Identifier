...
public final class GB {
     ...
     */
    private void A08(long j3, Map<String, GH> map, Map<String, SpannableStringBuilder> map2) {
        if (A0C(j3)) {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 26 out of bounds for length 23
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final List<C0589Fn> A0D(long j3, Map<String, GH> map, Map<String, GC> map2) {
        TreeMap treeMap = new TreeMap();
        A09(j3, false, this.A04, treeMap);
        A08(j3, map, treeMap);
        ...
        while (true) {
            ...
            GC gc2 = map2.get(entry.getKey());
            arrayList.add(new C0589Fn(A01((SpannableStringBuilder) entry.getValue()), (Layout.Alignment) null, gc2.A00, gc2.A05, gc2.A04, gc2.A01, Integer.MIN_VALUE, gc2.A03, gc2.A06, gc2.A02));
        }
    }
    ...
    public GB(String str, String str2, long j3, long j10, GH gh2, String[] strArr, String str3) {
        this.A05 = str;
        this.A06 = str2;
        this.A03 = gh2;
        this.A0A = strArr;
        ...
        this.A02 = j3;
        this.A01 = j10;
        this.A04 = (String) AbstractC0626Ha.A01(str3);
    ...
    */
    ...
    public static GB A05(String str, long j3, long j10, GH gh2, String[] strArr, String str2) {
        return new GB(str, null, j3, j10, gh2, strArr, str2);
    }

    private void A09(long j3, boolean z10, String str, Map<String, SpannableStringBuilder> regionOutputs) {
        String str2 = str;
        this.A09.clear();
        this.A08.clear();
        ...
        for (int i10 = 0; i10 < A00(); i10++) {
            A03(i10).A09(j3, z10 || equals, str2, regionOutputs);
        }
        if (equals) {
    ...
    private final boolean A0C(long j3) {
        long j10 = this.A02;
        return (j10 == C.TIME_UNSET && this.A01 == C.TIME_UNSET) || (j10 <= j3 && this.A01 == C.TIME_UNSET) || ((j10 == C.TIME_UNSET && j3 < this.A01) || (j10 <= j3 && j3 < this.A01));
    }
