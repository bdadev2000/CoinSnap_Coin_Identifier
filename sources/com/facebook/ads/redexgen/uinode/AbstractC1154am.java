...
public abstract class AbstractC1154am implements K3 {
    ...
    public static final C02390u A0G = null;
    public static final K4 A0H = null;
    public static final String A0I;
    public InterfaceC02340p A00;
    public InterfaceC02340p A01;
    public C8S A04;
    public K1 A05;
    public AbstractC02350q A06;
    public final C02651u A07;
    public final J2 A08;
    public final C02390u A09;
    public final K4 A0A;
    ...
    public AbstractC1154am(C1070Yn c1070Yn, C02651u c02651u) {
        ...
        if (c02390u != null) {
            ...
            this.A09 = new C02390u();
        }
        DynamicLoaderFactory.makeLoader(c1070Yn).getInitApi().onAdLoadInvoked(c1070Yn);
        this.A08 = c1070Yn.A09();
        c1070Yn.A0E().A4r();
    }

    private void A09(C0972Up c0972Up) {
        C8S placement = c0972Up.A00();
        if (placement == null || placement.A05() == null) {
            String A07 = A07(279, 29, 125);
            C0676Jb error = new C0676Jb(AdErrorType.NO_AD_PLACEMENT, A07);
            this.A0B.A0E().A4t(error.A03().getErrorCode(), A07);
            AbstractC02350q abstractC02350q = this.A06;
            if (abstractC02350q != null) {
                abstractC02350q.A0G(error);
                return;
            }
            return;
        }
        ...
        if (A09 == null) {
            ...
            if (this.A00 == null) {
                ...
                ABR(C0676Jb.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            C02661v loadConfig = new C02661v(A04.A04(), c8s.A05(), this.A07.A0A, c8s.A05().A0C());
        ...
        try {
            if (arrayList.size() > 1 && this.A00.AGd()) {
                ...
                C02661v loadConfig2 = new C02661v(jSONObject, c8s.A05(), this.A07.A0A, c8s.A05().A0C());
        ...
        if (!loaded) {
            if (arrayList.isEmpty()) {
                C0676Jb A01 = C0676Jb.A01(AdErrorType.NO_FILL, A07(0, 0, 73));
                this.A0B.A0E().A4t(A01.A03().getErrorCode(), A07(133, 22, 67));
                AbstractC02350q abstractC02350q2 = this.A06;
                if (abstractC02350q2 != null) {
                    abstractC02350q2.A0G(A01);
                    return;
                }
                return;
            }
            InterfaceC02340p interfaceC02340p = this.A00;
            String[] strArr = A0E;
            ...
            C02661v loadConfig3 = new C02661v(c8q.A04(), c8s.A05(), this.A07.A0A, c8s.A05().A0C());
    ...
    private final void A0A(String str, AdExperienceType adExperienceType) {
        ...
        if (Build.VERSION.SDK_INT < 17) {
            ABR(new C0676Jb(AdErrorType.API_NOT_SUPPORTED, A07(0, 0, 73)));
            return;
        }
        try {
            C0685Jl bidPayload = new C0685Jl(this.A0B, str, this.A07.A0A, this.A07.A09);
            K1 A01 = this.A07.A01(this.A0B, bidPayload, adExperienceType);
            this.A05 = A01;
            this.A0A.A0O(A01);
        } catch (C0677Jc e2) {
            C0676Jb A02 = C0676Jb.A02(e2);
    ...
    private void A0B(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            C02410w.A01(this.A0B).A0O(jSONObject);
        }
    }
    ...
    private boolean A0D(C8S c8s, C8Q c8q) {
        ...
        if (c8q == null) {
            C0676Jb A01 = C0676Jb.A01(AdErrorType.NO_FILL, A07);
            this.A0B.A0E().A4t(A01.A03().getErrorCode(), A07(133, 22, 67));
            AbstractC02350q abstractC02350q = this.A06;
            if (abstractC02350q != null) {
                abstractC02350q.A0G(A01);
            }
            return false;
        }
        String A02 = c8q.A02();
        InterfaceC02340p A00 = this.A09.A00(this.A0B, c8s.A05().A0D());
        if (A00 == null) {
        ...
        if (this.A07.A00() != A00.A7e()) {
            C0676Jb A012 = C0676Jb.A01(AdErrorType.INTERNAL_ERROR, A07);
            this.A0B.A0E().A4t(A012.A03().getErrorCode(), A07(155, 19, 37));
            AbstractC02350q abstractC02350q2 = this.A06;
            if (abstractC02350q2 != null) {
                abstractC02350q2.A0G(A012);
            }
            return false;
        }
        this.A00 = A00;
        ...
        if (dataObject != null) {
            ...
            if (this.A05 == null) {
                ...
                C0676Jb A013 = C0676Jb.A01(AdErrorType.UNKNOWN_ERROR, A072);
                this.A0B.A0E().A4t(A013.A03().getErrorCode(), A072);
                AbstractC02350q abstractC02350q3 = this.A06;
                if (abstractC02350q3 != null) {
                    abstractC02350q3.A0G(A013);
                }
                return false;
            }
            return true;
        ...
        C0676Jb A014 = C0676Jb.A01(AdErrorType.UNKNOWN_ERROR, A073);
        this.A0B.A0E().A4t(A014.A03().getErrorCode(), A073);
        AbstractC02350q abstractC02350q4 = this.A06;
        if (abstractC02350q4 != null) {
            abstractC02350q4.A0G(A014);
        }
        return false;
    }
    ...
    public C1F A0G() {
        return ((AbstractC1177b9) this.A01).A0H();
    }
    ...
    public final void A0I() {
        String A6T;
        this.A0B.A0E().A2q(C0728Lf.A01(this.A03));
        InterfaceC02340p interfaceC02340p = this.A01;
        if (interfaceC02340p == null || (A6T = interfaceC02340p.A6T()) == null) {
            return;
        }
        HashMap hashMap = new HashMap();
        String A04 = C0728Lf.A04(this.A03);
    ...
    public final void A0J() {
        ...
        if (interfaceC02340p == null) {
            ...
            if (abstractC02350q != null) {
                ...
                abstractC02350q.A0G(C0676Jb.A01(adErrorType, errorMessage));
            }
            this.A0B.A0E().A4w();
            return;
        }
        if (this.A0C) {
            ...
            if (abstractC02350q2 != null) {
                ...
                abstractC02350q2.A0G(C0676Jb.A01(adErrorType2, errorMessage2));
            }
            this.A0B.A0E().A4v();
            return;
        }
    ...
    public final void A0L() {
        if (this.A02 != null) {
            C02410w.A01(this.A0B).A0N(this.A02);
        }
    }

    public final void A0N(InterfaceC02340p interfaceC02340p) {
        if (interfaceC02340p != null) {
            interfaceC02340p.onDestroy();
        }
    }

    public final void A0P(AbstractC02350q abstractC02350q) {
        this.A06 = abstractC02350q;
    }

    public final void A0Q(C02661v c02661v) {
        A0S(c02661v.A03().optString(A07(210, 2, 39)));
    }
    ...
    public final synchronized void ABR(C0676Jb c0676Jb) {
        A0F().post(new C1155an(this, c0676Jb));
    }

    @Override // com.facebook.ads.redexgen.uinode.K3
    public final synchronized void ADG(C0972Up c0972Up) {
        try {
            A09(c0972Up);
        } catch (Exception e2) {
