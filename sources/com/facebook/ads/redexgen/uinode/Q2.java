...
public abstract class Q2 {
    ...
    public static Map<String, String> A01(C03987f c03987f, String str, String str2) {
        HashMap hashMap = new HashMap();
        C8K c8k = new C8K(c03987f);
        int i10 = c03987f.getResources().getDisplayMetrics().widthPixels;
        int i11 = c03987f.getResources().getDisplayMetrics().heightPixels;
        hashMap.put(A00(105, 10, 61), c03987f.A08().A02());
        hashMap.put(A00(56, 13, 37), str2);
        hashMap.put(A00(40, 16, 85), str);
        hashMap.put(A00(14, 12, 100), String.valueOf(c8k.A09()));
        hashMap.put(A00(82, 12, 26), String.valueOf((int) (i10 / LD.A02)));
        hashMap.put(A00(69, 13, 61), String.valueOf((int) (i11 / LD.A02)));
        hashMap.put(A00(32, 2, 124), c03987f.A04().A8H());
