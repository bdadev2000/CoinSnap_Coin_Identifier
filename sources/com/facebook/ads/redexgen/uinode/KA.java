...
public final class KA implements InterfaceC0862Qj {
    ...
    private ValueAnimator A00(View view, int i10, int i11) {
        ...
        ofInt.addUpdateListener(new C0871Qs(this, view));
        return ofInt;
    }
    ...
    public void A08(boolean z10) {
        if (z10) {
            ...
            this.A00 = A00;
            A00.addListener(new C0870Qr(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z10) {
        ...
        if (z10) {
            ...
            this.A00 = A00;
            A00.addListener(new C0869Qq(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
