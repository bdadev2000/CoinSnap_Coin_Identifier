...
public final class C04378y implements Closeable {
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < copyOfRange.length; i13++) {
            ...
            copyOfRange[i13] = (byte) ((b3 ^ i12) ^ 38);
        }
    ...
    public C04378y(File file) throws IOException {
        ...
        this.A00 = new C04388z(readInt, fileIdx);
    }
    ...
    public final C04388z A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C04388z c04388z) throws IOException {
        if (!this.A01) {
            if (c04388z.A02() >= 0 && c04388z.A03() >= 0) {
                this.A00 = c04388z;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c04388z.A02()), Integer.valueOf(c04388z.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
