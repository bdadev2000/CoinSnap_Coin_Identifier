...
public final class V2 implements Ad, NativeAdBaseApi, Repairable, JX {
    ...
    private void A0f(View view, View view2, List<View> list, boolean z10) {
        ...
        if (A0C == null) {
            ...
            Log.e(A0n, A0W3);
            C0676Jb c0676Jb = new C0676Jb(AdErrorType.NATIVE_AD_IS_NOT_LOADED, A0W3);
            A11().A0E().A2m(C0728Lf.A01(this.A00), c0676Jb.A03().getErrorCode(), c0676Jb.A04());
            if (!C0659Ih.A2F(this.A0c) || (v12 = this.A0G) == null) {
                return;
            }
            v12.ABR(c0676Jb);
            return;
        ...
        if (zx != null && A0C.A08() == 1) {
            zx.A03(EnumC0745Lw.AN_INFO_ICON);
        }
        if (view2 == null) {
            if (this.A0J == EnumC0680Jg.A05) {
                AdErrorType adErrorType = AdErrorType.NO_MEDIAVIEW_IN_NATIVEAD;
                String A0W4 = A0W(243, 21, 68);
                C0676Jb c0676Jb2 = new C0676Jb(adErrorType, A0W4);
                A11().A0E().A2m(C0728Lf.A01(this.A00), c0676Jb2.A03().getErrorCode(), c0676Jb2.A04());
                V1 v13 = this.A0G;
                if (v13 != null) {
                    v13.ABR(c0676Jb2);
                }
            ...
            C0676Jb c0676Jb3 = new C0676Jb(adErrorType2, A0W5);
            A11().A0E().A2m(C0728Lf.A01(this.A00), c0676Jb3.A03().getErrorCode(), c0676Jb3.A04());
            V1 v14 = this.A0G;
            if (v14 != null) {
                v14.ABR(c0676Jb3);
            }
        ...
        if (!z12 && !z13) {
            if (this.A0G != null) {
                C0676Jb c0676Jb4 = new C0676Jb(AdErrorType.UNSUPPORTED_AD_ASSET_NATIVEAD, A0W(519, 31, 15));
                A11().A0E().A2m(C0728Lf.A01(this.A00), c0676Jb4.A03().getErrorCode(), c0676Jb4.A04());
                this.A0G.ABR(c0676Jb4);
                return;
            }
            return;
        }
        ...
        if (view instanceof ViewGroup) {
            C0757Mi c0757Mi = new C0757Mi(this.A0c, new V8(this));
            this.A0K = c0757Mi;
            ((ViewGroup) view).addView(c0757Mi);
        }
        if (A0C.A0S()) {
            this.A0O = new V7(this);
            RE re2 = new RE(view, 1, new WeakReference(this.A0O), this.A0c);
            this.A0Q = re2;
            re2.A0Y(false);
        ...
        int A00 = A00();
        this.A0P = new V6(this, view2, z13, A0C);
        ...
        RE re3 = new RE(this.A03, A00, A03(), true, new WeakReference(this.A0P), this.A0c);
        this.A0R = re3;
        re3.A0Y(true ^ A0q());
        this.A0R.A0W(A01());
        this.A0R.A0X(A02());
        ...
        C1178bA c1178bA = new C1178bA(this.A0c, new V3(this, null), this.A0R, this.A0a);
        this.A09 = c1178bA;
        c1178bA.A0D(arrayList);
        A0o.put(view, new WeakReference<>(this));
        if (Build.VERSION.SDK_INT < 18 || !C0659Ih.A11(this.A0c)) {
            return;
        }
        C0781Ng c0781Ng = new C0781Ng();
        this.A0L = c0781Ng;
        c0781Ng.A0C(this.A0g);
        this.A0L.A0B(this.A0c.getPackageName());
        this.A0L.A0A(this.A0R);
        C1188bK c1188bK = this.A0a;
        if (c1188bK != null && c1188bK.A0E().A03() > 0) {
    ...
    public V2(Context context, String str, JO jo, boolean z10) {
        ...
        this.A0J = EnumC0680Jg.A05;
        this.A0E = JL.A04;
        this.A08 = AnonymousClass12.A03;
        this.A0U = new WeakReference<>(null);
        this.A0i = new ArrayList();
        this.A0f = new C0729Lg();
        this.A0Z = false;
        this.A0Y = false;
        this.A00 = -1L;
        if (context instanceof C1070Yn) {
            this.A0c = (C1070Yn) context;
        } else if (!z10) {
            this.A0c = C03495c.A04(context);
        } else {
            this.A0c = C03495c.A03(context);
        }
        this.A0c.A0L(this);
        this.A0g = str;
        this.A0d = jo;
    ...
    public V2(C1070Yn c1070Yn, C1188bK c1188bK, C8T c8t, JO jo) {
        this((Context) c1070Yn, (String) null, jo, true);
        this.A0a = c1188bK;
        this.A0D = c8t;
        this.A0j = true;
        this.A05 = new View(c1070Yn);
    }

    public V2(C1070Yn c1070Yn, C1188bK c1188bK, C8T c8t, JO jo, C1148ag c1148ag) {
        this(c1070Yn, c1188bK, c8t, jo);
        this.A0B = c1148ag;
    }
    ...
    public static Drawable A05(C1070Yn c1070Yn, Bitmap bitmap, boolean z10, String str) {
        BitmapDrawable A00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c1070Yn.getResources(), bitmap);
        if (z10 && (A00 = AbstractC0849Pw.A00(c1070Yn, str)) != null) {
    ...
    public static NativeAdBase A0A(Context context, String str, String str2) throws C0677Jc {
        EnumC0680Jg A00 = C0685Jl.A00(str2);
        if (A00 != null) {
            EnumC0680Jg enumC0680Jg = EnumC0680Jg.A04;
            String[] strArr = A0m;
            if (strArr[7].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            ...
            EnumC0680Jg template = EnumC0680Jg.A05;
            if (A00 == template) {
                return new NativeAd(context, str);
            }
            throw new C0677Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(42, 34, 84), A00));
        }
        throw new C0677Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(114, 50, 50), str2));
    }

    private final C1188bK A0C() {
        C1188bK c1188bK = this.A0a;
        if (c1188bK != null && c1188bK.A0R()) {
            return c1188bK;
        }
        return null;
    }
    ...
    private void A0a() {
        if (!TextUtils.isEmpty(getAdChoicesLinkUrl())) {
            C0718Kv.A0M(new C0718Kv(), this.A0c, AbstractC0721Ky.A00(getAdChoicesLinkUrl()), A1B());
        }
    }
    ...
    private void A0g(FrameLayout frameLayout, String str) {
        ...
        C0850Px A01 = AbstractC0849Pw.A01(C03495c.A03(this.A0c), str);
        this.A0N = A01;
        if (A01 != null) {
    ...
    private void A0h(C1188bK c1188bK, boolean z10) {
        if (c1188bK == null) {
            return;
        }
        ...
        if (equals) {
            AnonymousClass14 A0E = c1188bK.A0E();
            String clientToken = c1188bK.A6T();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0d(new JA(clientToken, this.A0c.A09()));
            }
            if (A0E.A0G() != null) {
                C03736a c03736a = new C03736a(A0E.A0G().getUrl(), A0E.A0G().getHeight(), A0E.A0G().getWidth(), c1188bK.A0G(), A0W(596, 6, 89));
                c03736a.A00 = this.A0C;
                this.A0b.A0V();
                this.A0b.A0b(c03736a);
            }
            if (!this.A0J.equals(EnumC0680Jg.A04)) {
                if (A0E.A0F() != null) {
                    this.A0b.A0b(new C03736a(A0E.A0F().getUrl(), A0E.A0F().getHeight(), A0E.A0F().getWidth(), c1188bK.A0G(), A0W(596, 6, 89)));
                }
                List<V2> A0H = c1188bK.A0H();
                String[] strArr = A0m;
                if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                    throw new RuntimeException();
                }
                ...
                if (A0H != null) {
                    for (V2 v22 : c1188bK.A0H()) {
                        if (v22.getAdCoverImage() != null) {
                            this.A0b.A0b(new C03736a(v22.getAdCoverImage().getUrl(), v22.getAdCoverImage().getHeight(), v22.getAdCoverImage().getWidth(), c1188bK.A0G(), A0W(596, 6, 89)));
                        }
                    }
                }
                String A0d = A0E.A0d();
                if (!TextUtils.isEmpty(A0d)) {
                    this.A0b.A0a(new C6Y(A0d, c1188bK.A0G(), A0W(596, 6, 89), A0E.A0A()));
                }
            }
            AbstractC1173b5 A0D = A0E.A0D();
            if (A0D != null && A0D.A0m()) {
        ...
        this.A0b.A0W(new V9(this, c1188bK, z10), new C6V(c1188bK.A0G(), A0W));
    }
    ...
    private void A0i(AnonymousClass15 anonymousClass15) {
        ...
        c1188bK.A0K(anonymousClass15);
    }

    public static void A0j(NativeAdImageApi nativeAdImageApi, ImageView imageView, C1070Yn c1070Yn) {
        if (nativeAdImageApi != null && imageView != null) {
            new AsyncTaskC0947Tq(imageView, c1070Yn).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    public final C1188bK A0y() {
        return this.A0a;
    }

    public final AbstractC1173b5 A0z() {
        return A0F().A0D();
    }

    public final C03756c A10() {
        return this.A0b;
    }

    public final C1070Yn A11() {
        return this.A0c;
    }
    ...
    public final String A1G() {
        C1188bK c1188bK = this.A0a;
        if (c1188bK == null || TextUtils.isEmpty(c1188bK.A0E().A0d())) {
            return null;
        }
    ...
    public final void A1I() {
        ...
        C1070Yn c1070Yn = this.A0c;
        AbstractC0763Mo A01 = AbstractC0764Mp.A01(c1070Yn, c1070Yn.A09(), A1B(), this.A07);
        if (A01 == null) {
            A0a();
        } else {
    ...
    public final void A1K(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            boolean A11 = C0659Ih.A11(view.getContext());
            String[] strArr = A0m;
            if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                throw new RuntimeException();
            }
    ...
    public final void A1R(NativeAdBase nativeAdBase, NativeAdListener nativeAdListener) {
        ...
        A0m(new C0499Bj(nativeAdListener, nativeAdBase));
    }
    ...
    public final void A1T(C1188bK c1188bK) {
        A0h(c1188bK, true);
        if (this.A0G != null) {
            List<V2> A0H = c1188bK.A0H();
            String[] strArr = A0m;
            ...
            if (A0H != null) {
                VB vb2 = new VB(this);
                Iterator<V2> it = c1188bK.A0H().iterator();
                while (it.hasNext()) {
                    it.next().A0i(vb2);
                }
            }
    ...
    public final void A1V(JL jl, String str, C6i c6i) {
        ...
        if (this.A0j) {
            AdSettings.IntegrationErrorMode A00 = AbstractC02681x.A00(this.A0c);
            ...
            if (!integrationErrorMode.equals(A00)) {
                C0676Jb c0676Jb = new C0676Jb(AdErrorType.LOAD_AD_CALLED_MORE_THAN_ONCE, A0W(566, 30, 115));
                A11().A0E().A2m(C0728Lf.A01(this.A00), c0676Jb.A03().getErrorCode(), c0676Jb.A04());
                V1 v12 = this.A0G;
                if (v12 != null) {
                    v12.ABR(c0676Jb);
        ...
        this.A0C = c6i;
        C02651u c02651u = new C02651u(this.A0g, this.A0J, A0R(), null, 1, new C1141aZ());
        c02651u.A05(jl);
        c02651u.A06(this.A0S);
        c02651u.A07(this.A0T);
        FO fo = new FO(this.A0c, c02651u);
        this.A0A = fo;
        fo.A0P(new VC(this));
        this.A0A.A0T(str);
    }
    ...
    public final void A1Y(EnumC0680Jg enumC0680Jg) {
        if (!A0q()) {
            if (EnumC0680Jg.A04.equals(enumC0680Jg)) {
                C1070Yn c1070Yn = this.A0c;
                String[] strArr = A0m;
                if (strArr[7].length() != strArr[5].length()) {
                    throw new RuntimeException();
                ...
                c1070Yn.A0E().A2s(AdPlacementType.NATIVE_BANNER.toString(), this.A0g);
            } else {
                this.A0c.A0E().A2s(AdPlacementType.NATIVE.toString(), this.A0g);
            }
        }
        this.A0J = enumC0680Jg;
    }

    public final void A1Z(RD rd2) {
        this.A0V = new WeakReference<>(rd2);
    }
    ...
    */
    ...
    public final void destroy() {
        AbstractC0689Jp.A05(A0W(553, 7, 7), A0W(363, 19, 23), A0W(5, 8, 76));
        if (C0659Ih.A1W(this.A0c)) {
    ...
    public final boolean hasCallToAction() {
        C1188bK c1188bK = this.A0a;
        return c1188bK != null && c1188bK.A0Q();
    }
    ...
    public final boolean isAdLoaded() {
        C1188bK c1188bK = this.A0a;
        return c1188bK != null && c1188bK.A0R();
    }

    @Override // com.facebook.ads.Ad
    public final void loadAd() {
        AbstractC0689Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(13, 8, 89));
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        AbstractC0689Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(21, 8, 126));
    ...
    public final void repair(Throwable th2) {
        ...
        String str = A0W(164, 16, 64) + LW.A03(this.A0c, th2);
        A11().A0E().A2m(C0728Lf.A01(this.A00), 2001, str);
        V1 v12 = this.A0G;
        if (v12 != null) {
            v12.ABR(new C0676Jb(2001, str));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0070, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C0659Ih.A1W(r4) != false) goto L22;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x007f, code lost:
        ...
        r4 = com.facebook.ads.redexgen.uinode.V2.A0o;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0097, code lost:
        ...
        r2 = com.facebook.ads.redexgen.uinode.V2.A0m;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00dd, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.C0659Ih.A11(r7.A0c) == false) goto L44;
     */
