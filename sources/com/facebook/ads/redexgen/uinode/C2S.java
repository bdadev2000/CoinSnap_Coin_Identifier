...
public final class C2S {
    ...
    static {
        A06();
        A03 = new String[]{A02(452, 7, 20), A02(459, 19, 105), A02(478, 25, 96), A02(PglCryptUtils.COMPRESS_FAILED, 15, 30), A02(613, 9, 99), A02(622, 21, 8), A02(643, 27, 68), A02(670, 17, 53), A02(540, 21, 23), A02(418, 16, 83), A02(434, 18, 91), A02(398, 20, 78), A02(696, 20, 116), A02(352, 14, 46), A02(561, 25, 112)};
    }
    ...
    public static Map<String, String> A05(String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(PglCryptUtils.COMPRESS_FAILED, 15, 30))).size() == 0) {
    ...
    public final C2W A0A() {
        C2W c2w = new C2W(A00());
        try {
            for (C2W hideAdParent : A04(A03(A02(PglCryptUtils.COMPRESS_FAILED, 15, 30), A02(0, 0, 94)))) {
    ...
    public final boolean A0O(Context context, boolean z10) {
        return (z10 || C0659Ih.A29(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
