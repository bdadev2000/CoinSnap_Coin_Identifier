...
public final class C3K<T extends Enum<T>> extends AbstractC03886u<T> implements InterfaceC0602Ga<T>, Serializable {
    ...
    public C3K(T[] tArr) {
        C1224bu.A07(tArr, A03(7, 7, 60));
        this.A00 = tArr;
    }

    private final int A00(T t5) {
        C1224bu.A07(t5, A03(0, 7, 113));
        int ordinal = t5.ordinal();
        if (((Enum) C3M.A01(this.A00, ordinal)) == t5) {
            return ordinal;
        }
        return -1;
    }

    private final int A01(T t5) {
        C1224bu.A07(t5, A03(0, 7, 113));
        return indexOf(t5);
    }
    ...
    public final T get(int i10) {
        AbstractC03886u.A02.A03(i10, this.A00.length);
        return this.A00[i10];
    }

    private final boolean A05(T t5) {
        C1224bu.A07(t5, A03(0, 7, 113));
        Enum target = (Enum) C3M.A01(this.A00, t5.ordinal());
        return target == t5;
    }
