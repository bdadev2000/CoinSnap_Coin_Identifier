...
public abstract class AbstractC0796Nv extends Button {
    ...
    public AbstractC0796Nv(C1070Yn c1070Yn, C1P c1p) {
        super(c1070Yn);
        this.A03 = false;
        this.A01 = 0;
        this.A00 = 0;
        this.A04 = true;
        this.A05 = false;
        this.A08 = new C0941Tk(this);
        this.A09 = new C0940Tj(this);
        this.A02 = c1p;
        this.A07 = C0659Ih.A04(c1070Yn);
        this.A06 = C0659Ih.A00(c1070Yn);
        AbstractC0737Lo.A0X(this, false, 16);
        setGravity(17);
        A03();
    }
    ...
    private void A03() {
        ...
        AbstractC0737Lo.A0O(this, this.A00, this.A04 ? A0B : 0);
    ...
    private void A04() {
        ...
        this.A03 = true;
        if (C0659Ih.A2B(getContext()) && Build.VERSION.SDK_INT >= 16) {
