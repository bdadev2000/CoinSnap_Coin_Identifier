...
public final class C0988Vg implements HK {
    ...
    public long A00;
    public boolean A01;
    public final InterfaceC0990Vi A02;
    public final HS A03;
    ...
    public final synchronized void A4N(File file) throws HI {
        ...
        C0987Vf A00 = C0987Vf.A00(file, this.A03);
        AbstractC0626Ha.A04(A00 != null);
        HR A092 = this.A03.A09(A00.A04);
        AbstractC0626Ha.A01(A092);
        AbstractC0626Ha.A04(A092.A0D());
        if (file.exists()) {
            if (file.length() == 0) {
                file.delete();
                return;
            ...
            if (A002 != -1) {
                AbstractC0626Ha.A04(A00.A02 + A00.A01 <= A002);
            }
            A0A(A00);
            this.A03.A0G();
            notifyAll();
    ...
    public C0988Vg(File file, InterfaceC0990Vi interfaceC0990Vi) {
        this(file, interfaceC0990Vi, null, false);
    }

    public C0988Vg(File file, InterfaceC0990Vi interfaceC0990Vi, HS hs) {
        if (A0D(file)) {
            this.A04 = file;
            this.A02 = interfaceC0990Vi;
            this.A03 = hs;
    ...
    public C0988Vg(File file, InterfaceC0990Vi interfaceC0990Vi, byte[] bArr, boolean z10) {
        this(file, interfaceC0990Vi, new HS(file, bArr, z10));
    }

    private C0987Vf A00(String str, long j3) throws HI {
        C0987Vf span;
        HR A092 = this.A03.A09(str);
        if (A092 == null) {
            C0987Vf A02 = C0987Vf.A02(str, j3);
            if (A08[7].length() == 15) {
                throw new RuntimeException();
            }
    ...
    public final synchronized C0987Vf AGV(String str, long j3) throws InterruptedException, HI {
        C0987Vf span;
        while (true) {
            span = AGW(str, j3);
            if (span == null) {
    ...
    public final synchronized C0987Vf AGW(String str, long j3) throws HI {
        AbstractC0626Ha.A04(!this.A01);
        C0987Vf A00 = A00(str, j3);
        if (A00.A05) {
            C0987Vf cacheSpan = this.A03.A09(str).A07(A00);
            A0C(A00, cacheSpan);
            return cacheSpan;
        }
    ...
    public void A04() {
        ...
        for (File file : listFiles) {
            if (!file.getName().equals(A03(106, 24, 45))) {
                C0987Vf A00 = file.length() > 0 ? C0987Vf.A00(file, this.A03) : null;
                if (A00 != null) {
                    A0A(A00);
                } else {
                    file.delete();
    ...
    private void A05() throws HI {
        ...
        while (it.hasNext()) {
            Iterator<C0987Vf> it2 = it.next().A08().iterator();
            while (it2.hasNext()) {
                C0987Vf next = it2.next();
                if (!next.A03.exists()) {
                    arrayList.add(next);
                }
            }
    ...
    private void A0A(C0987Vf c0987Vf) {
        this.A03.A0A(c0987Vf.A04).A09(c0987Vf);
        this.A00 += c0987Vf.A01;
        A0B(c0987Vf);
    }

    private void A0B(C0987Vf c0987Vf) {
        ArrayList<HJ> arrayList = this.A05.get(c0987Vf.A04);
        if (arrayList != null) {
            for (int i10 = arrayList.size() - 1; i10 >= 0; i10--) {
                arrayList.get(i10).ADB(this, c0987Vf);
            }
        }
        this.A02.ADB(this, c0987Vf);
    }

    private void A0C(C0987Vf c0987Vf, HO ho) {
        ArrayList<HJ> arrayList = this.A05.get(c0987Vf.A04);
        if (arrayList != null) {
            ...
            for (int i10 = size - 1; i10 >= 0; i10--) {
                arrayList.get(i10).ADD(this, c0987Vf, ho);
            }
        }
        this.A02.ADD(this, c0987Vf, ho);
    }

    public static synchronized boolean A0D(File file) {
        synchronized (C0988Vg.class) {
            if (A06) {
                return true;
            }
    ...
    @Override // com.facebook.ads.redexgen.uinode.HK
    public final synchronized long A6G(String str, long j3, long j10) {
        HR cachedContent;
        AbstractC0626Ha.A04(!this.A01);
        cachedContent = this.A03.A09(str);
        return cachedContent != null ? cachedContent.A04(j3, j10) : -j10;
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.HK
    public final synchronized void AFx(String str, long j3) throws HI {
        HW mutations = new HW();
        HV.A05(mutations, j3);
        A3a(str, mutations);
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.HK
    public final synchronized File AGT(String str, long j3, long j10) throws HI {
        HR A092;
        AbstractC0626Ha.A04(!this.A01);
        A092 = this.A03.A09(str);
        AbstractC0626Ha.A01(A092);
        ...
        this.A02.ADE(this, str, j3, j10);
        return C0987Vf.A04(this.A04, A092.A02, j3, System.currentTimeMillis());
    }
}
