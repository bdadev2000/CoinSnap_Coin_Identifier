...
public final class VP implements J0 {
    ...
    public VP(C1069Ym c1069Ym, YH yh2) {
        this.A00 = c1069Ym;
        this.A01 = yh2;
    }

    public static JSONArray A01(C1069Ym c1069Ym, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c1069Ym, jSONArray, jSONArray2, i10);
    }

    public static JSONArray A02(C1069Ym c1069Ym, JSONArray jSONArray, JSONArray jSONArray2, int i10) {
        if (jSONArray == null) {
            return jSONArray2;
        }
        if (jSONArray2 == null) {
            ...
            if ((debugIdx < length || limit < length2) && i10 > 0) {
                ...
                if (limit < length2 && jSONObject2 == null) {
                    try {
                        ...
                        if (c1069Ym.A04().A8z()) {
                            Log.e(A04, A00(306, 25, 59) + limit, e10);
                        }
                        jSONObject2 = null;
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                if (A00(393, 26, 8).equals(string)) {
                    C0659Ih.A0R(this.A00).A2X(jSONObject.getString(A00(419, 14, 47)));
                    this.A00.A03().AAL();
                } else {
                ...
                if (this.A00.A04().A8z()) {
                    Log.e(A04, A00(331, 44, 82) + i10 + A00, e2);
                }
                z10 = false;
            }
        }
