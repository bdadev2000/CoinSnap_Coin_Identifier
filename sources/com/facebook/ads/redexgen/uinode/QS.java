...
public class QS {
     ...
     */
    public QS(C1070Yn c1070Yn, J2 j22, QE qe2, List<C2P> list, String str, boolean z10, Bundle bundle, Map<String, String> map, QK qk) {
        this.A0B = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A03 = null;
        ...
        if (bundle != null) {
            this.A05 = new C1121aF(list, bundle.getBundle(A0F(6, 16, 29)), qk);
            this.A01 = bundle.getInt(A0F(57, 18, 2));
            this.A00 = bundle.getInt(A0F(39, 18, 44));
        } else {
            this.A05 = new C1121aF(list, qk);
        }
    ...
    public QS(C1070Yn c1070Yn, J2 j22, QE qe2, List<C2P> list, String str, boolean z10, Bundle bundle, QK qk) {
        this(c1070Yn, j22, qe2, list, str, z10, bundle, null, qk);
    }

    public QS(C1070Yn c1070Yn, J2 j22, QE qe2, List<C2P> list, String str, boolean z10, QK qk) {
        this(c1070Yn, j22, qe2, list, str, z10, null, qk);
    }

    private final float A0E() {
        return AbstractC0734Ll.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0H(int i10) {
        HashMap<String, String> hashMap = new HashMap<>();
        AbstractC0734Ll.A03(hashMap, this.A08.getVideoStartReason() == QM.A02, !this.A08.A95());
        A0T(hashMap);
        A0S(hashMap);
        A0V(hashMap, i10);
        A0U(hashMap);
