...
public abstract class AbstractC0849Pw {
    ...
    public static BitmapDrawable A00(C1070Yn c1070Yn, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1070Yn, overlayBm))) {
                ...
                Resources resources = c1070Yn.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1070Yn, A02(0, 23, 116));
                    }
                } else {
                    A04(c1070Yn, A02(23, 18, 112));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th2) {
            c1070Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(th2));
            return null;
        }
    }

    public static C0850Px A01(C1070Yn c1070Yn, String str) {
        BitmapDrawable A002;
        try {
            if (TextUtils.isEmpty(str) || (A002 = A00(c1070Yn, str)) == null) {
                return null;
            }
            C0850Px overlayView = new C0850Px(c1070Yn);
    ...
    public static void A04(C1070Yn c1070Yn, String str) {
        c1070Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.uinode.C1070Yn r5, android.graphics.Bitmap r6) {
        /*
            r3 = 0
        L1:
            int r4 = r6.getWidth()
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.AbstractC0849Pw.A02
            r0 = 2
            r1 = r1[r0]
            r0 = 4
            ...
            if (r1 == r0) goto L4d
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.AbstractC0849Pw.A02
        ...
        L4d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.AbstractC0849Pw.A05(com.facebook.ads.redexgen.X.Yn, android.graphics.Bitmap):boolean");
    }
}
