...
public final class AnonymousClass26 {
    ...
    public AnonymousClass26(C1070Yn c1070Yn, InterstitialAd interstitialAd, String str) {
        this(c1070Yn, interstitialAd, str, new C1141aZ());
    }

    public AnonymousClass26(C1070Yn c1070Yn, InterstitialAd interstitialAd, String str, C8Z c8z) {
        this.A0A = c1070Yn;
        this.A0B = str;
    ...
    public final void A0C(long j3) {
        this.A00 = j3;
    }

    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C0659Ih.A0p(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
