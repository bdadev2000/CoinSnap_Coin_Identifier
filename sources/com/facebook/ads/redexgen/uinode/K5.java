...
public final class K5 {
     ...
     */
    private C0972Up A01(C1070Yn c1070Yn, JSONObject jSONObject, long j3) throws JSONException {
        ...
        if (jSONObject2.has(A042)) {
            ...
            while (true) {
                ...
                if (strArr[5].charAt(22) == strArr[0].charAt(22)) {
                    ...
                    JC.A06(c1070Yn, jSONObject3, j3, null);
                    ...
                    if (optJSONObject != null) {
                        ...
                        c1070Yn.A0E().A4t(AdErrorType.UNKNOWN_ERROR.getErrorCode(), A04(67, 18, 82));
                    }
                    i10++;
                } else {
        ...
        return new C0972Up(c8s, jSONObject.optString(A04(29, 18, 1)));
    }
    ...
    public static void A05() {
        A01 = new byte[]{116, 113, 74, 103, 112, 101, 122, 103, 97, 124, 123, 114, 74, 118, 122, 123, 115, 124, 114, 49, 52, 49, 32, 36, 53, 34, 47, 42, Base64.padSymbol, Ascii.ETB, Ascii.CAN, 41, 0, Ascii.ETB, Ascii.SUB, Ascii.US, Ascii.DC2, Ascii.ETB, 2, Ascii.US, Ascii.EM, Ascii.CAN, 41, 3, 3, Ascii.US, Ascii.DC2, 96, 107, 98, 106, 109, 92, 115, 98, 113, 98, 110, 112, Ascii.ETB, Ascii.ESC, Ascii.DLE, 17, 103, 98, 119, 98, 65, 68, 81, 68, 106, 71, 79, 64, 70, 81, 5, 76, 86, 5, 75, 80, 73, 73, 44, 41, 60, 41, Ascii.ETB, 37, 39, 44, 45, 36, Ascii.ETB, 60, 49, 56, 45, 68, 67, 76, Byte.MAX_VALUE, 84, 69, 83, 84, Byte.MAX_VALUE, 67, 79, 78, 70, 73, 71, 85, 84, 87, 88, 95, 88, 69, 88, 94, 95, 74, 93, 93, 64, 93, 3, 0, 4, 17, Ascii.DLE, Ascii.ETB, 0, 58, 6, 10, Ascii.VT, 3, Ascii.FF, 2, Ascii.SI, 7, 17, 17, 3, 5, 7, 73, 85, 88, 90, 92, 84, 92, 87, 77, 74, 89, 95, 76, 78, 70, 72, 95, 94, 69, 72, 65, 84};
    }
    ...
    private C0971Uo A02(JSONObject jSONObject) {
        return new C0971Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), null);
    }

    private C0971Uo A03(JSONObject jSONObject) {
        try {
            ...
            return new C0971Uo(jSONObject.optString(A04(144, 7, 21), A04(0, 0, 87)), jSONObject.optInt(A04(59, 4, 3), 0), new C8S(A002, adReportingConfig, definition.optString(A04(0, 19, 98)), null));
    ...
    public final K7 A06(C1070Yn c1070Yn, String str, long j3) throws JSONException {
        char c10;
        if (!TextUtils.isEmpty(str)) {
            ...
            switch (c10) {
                case 0:
                    return A01(c1070Yn, jSONObject, j3);
                case 1:
