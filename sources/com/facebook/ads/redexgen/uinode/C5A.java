...
public final class C5A extends AbstractC0506Bq {
    ...
    public int A02;
    public int A03;
    public List<C0589Fn> A05;
    public List<C0589Fn> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final C0651Hz A0A = new C0651Hz();
    public final ArrayList<C0596Fu> A0B = new ArrayList<>();
    public C0596Fu A04 = new C0596Fu(0, 4);
    ...
    static {
        ...
        A0I = new int[]{193, 201, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, PsExtractor.AUDIO_STREAM, 194, 199, 200, 202, 203, 235, 206, 207, 239, 212, 217, 249, 219, 171, 187};
        A0J = new int[]{195, 227, 205, 204, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, g.STALE_CACHED_RESPONSE_VALUE, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    }
    ...
    public static char A00(byte b3) {
        int index = A0E[(b3 & Byte.MAX_VALUE) - 32];
        return (char) index;
    }

    public static char A01(byte b3) {
        int index = A0I[b3 & Ascii.US];
        return (char) index;
    }

    public static char A02(byte b3) {
        int index = A0J[b3 & Ascii.US];
        return (char) index;
    }

    public static char A03(byte b3) {
        int index = A0H[b3 & Ascii.SI];
        return (char) index;
    }

    private List<C0589Fn> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < this.A0B.size(); i10++) {
            C0589Fn A05 = this.A0B.get(i10).A05();
            if (A05 != null) {
                arrayList.add(A05);
            }
        }
    ...
    private void A08(byte b3) {
        this.A04.A08(' ');
        int style = (b3 >> 1) & 7;
        this.A04.A0E(style, (b3 & 1) == 1);
    }

    private void A09(byte b3) {
        switch (b3) {
            case 32:
                A0B(2);
                return;
    ...
    private void A0A(byte b3, byte b10) {
        int i10 = A0G[b3 & 7];
        int row = b10 & 32;
        int row2 = row != 0 ? 1 : 0;
        if (row2 != 0) {
        ...
        if (i10 != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i11 = this.A02;
                int row5 = this.A03;
                C0596Fu c0596Fu = new C0596Fu(i11, row5);
                this.A04 = c0596Fu;
                this.A0B.add(c0596Fu);
            }
            this.A04.A0C(i10);
        }
        int cursorOrStyle = (b10 & Ascii.DLE) == 16 ? 1 : 0;
        int row6 = b10 & 1;
        boolean isCursor = row6 == 1;
        int row7 = b10 >> 1;
        int i12 = row7 & 7;
        C0596Fu c0596Fu2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i12;
        c0596Fu2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C0596Fu c0596Fu3 = this.A04;
            int row9 = A0F[i12];
            c0596Fu3.A0B(row9);
        }
    }
    ...
    public static boolean A0D(byte b3) {
        return (b3 & 240) == 16;
    }
    ...
    */
    ...
    public static boolean A0F(byte b3, byte b10) {
        return (b3 & 247) == 17 && (b10 & 240) == 32;
    }

    public static boolean A0G(byte b3, byte b10) {
        return (b3 & 247) == 20 && (b10 & 240) == 32;
    }

    public static boolean A0H(byte b3, byte b10) {
        return (b3 & 240) == 16 && (b10 & 192) == 64;
    }

    public static boolean A0I(byte b3, byte b10) {
        return (b3 & 247) == 23 && b10 >= 33 && b10 <= 35;
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq
    /* renamed from: A0L */
    public final /* bridge */ /* synthetic */ C5 A54() throws C0591Fp {
        return super.A54();
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq
    /* renamed from: A0M */
    public final /* bridge */ /* synthetic */ AbstractC0507Br A55() throws C0591Fp {
        return super.A55();
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq
    public final WI A0N() {
        List<C0589Fn> list = this.A05;
        this.A06 = list;
        return new WI(list);
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq
    /* renamed from: A0O */
    public final /* bridge */ /* synthetic */ void AEG(C5 c52) throws C0591Fp {
        super.AEG(c52);
    }
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq, com.facebook.ads.redexgen.uinode.BB
    public final void AEV() {
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC0506Bq, com.facebook.ads.redexgen.uinode.WL
    public final /* bridge */ /* synthetic */ void AGB(long j3) {
        super.AGB(j3);
    }
