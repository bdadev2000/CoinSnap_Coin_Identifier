...
public abstract class GD {
    ...
    */
    ...
    public static void A05(SpannableStringBuilder spannableStringBuilder, int i10, int i11, GH gh2) {
        if (gh2.A07() != -1) {
            spannableStringBuilder.setSpan(new StyleSpan(gh2.A07()), i10, i11, 33);
        }
        if (gh2.A0P()) {
        ...
        if (gh2.A0O()) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan(gh2.A05()), i10, i11, 33);
        }
        if (gh2.A0N()) {
            spannableStringBuilder.setSpan(new BackgroundColorSpan(gh2.A04()), i10, i11, 33);
        }
        if (gh2.A0L() != null) {
            spannableStringBuilder.setSpan(new TypefaceSpan(gh2.A0L()), i10, i11, 33);
        }
        if (gh2.A08() != null) {
            spannableStringBuilder.setSpan(new AlignmentSpan.Standard(gh2.A08()), i10, i11, 33);
        }
        switch (gh2.A06()) {
            case 1:
                spannableStringBuilder.setSpan(new AbsoluteSizeSpan((int) gh2.A03(), true), i10, i11, 33);
                return;
            case 2:
                spannableStringBuilder.setSpan(new RelativeSizeSpan(gh2.A03()), i10, i11, 33);
                return;
            case 3:
                spannableStringBuilder.setSpan(new RelativeSizeSpan(gh2.A03() / 100.0f), i10, i11, 33);
                return;
            default:
                return;
        }
