...
public final class GX implements Comparable<GX> {
    ...
    public GX(Format format, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, int i10) {
        ...
        this.A05 = C0504Bo.A0H(i10, false) ? 1 : 0;
        this.A03 = C0504Bo.A0K(format, defaultTrackSelector$Parameters.A07) ? 1 : 0;
    ...
    public final int compareTo(GX gx) {
        ...
        int i11 = gx.A05;
        if (i10 != i11) {
            A015 = C0504Bo.A01(i10, i11);
            return A015;
        }
        int i12 = this.A03;
        int i13 = gx.A03;
        if (i12 != i13) {
            A014 = C0504Bo.A01(i12, i13);
            return A014;
        }
        int i14 = this.A02;
        int i15 = gx.A02;
        if (i14 != i15) {
            A013 = C0504Bo.A01(i14, i15);
            return A013;
        }
        if (this.A06.A0D) {
            A012 = C0504Bo.A01(gx.A00, this.A00);
            return A012;
        }
        ...
        if (i17 != resultSign3) {
            A01 = C0504Bo.A01(i17, resultSign3);
            int i18 = A01 * i16;
            String[] strArr = A07;
        ...
        if (i19 != resultSign4) {
            resultSign2 = C0504Bo.A01(i19, resultSign4);
            return resultSign2 * i16;
        }
        resultSign = C0504Bo.A01(this.A00, gx.A00);
