...
public final class JZ {
    ...
    public JZ(C03987f c03987f, JX jx) {
        int nativeViewabilityHistorySamplingRate = Ij.A0D(c03987f);
        if (nativeViewabilityHistorySamplingRate < 1) {
            this.A0F = false;
        } else {
            this.A0F = c03987f.A08().A00() < 1.0d / ((double) nativeViewabilityHistorySamplingRate);
        }
        this.A0B = jx;
    }
    ...
    public final void A0C(C03987f c03987f, String str) {
        if (!this.A0F) {
            return;
        }
        A03(new JY(A01(), 103, A00(), null));
        ExecutorC0742Lt.A06.execute(new JW(this, str, c03987f));
    }
}
