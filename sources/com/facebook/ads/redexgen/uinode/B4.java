...
public abstract class B4 extends TS {
    ...
    public final AbstractC0814On A0E;
    public final O7 A0F;
    public final NX A0G;
    public final MV A0H;
    ...
    public abstract void A19(C1070Yn c1070Yn);

    public B4(OP op, boolean z10, String str, C0906Sb c0906Sb) {
        super(op, z10);
        this.A09 = new Path();
        this.A0A = new RectF();
    ...
    public void setImageUrl(String str) {
        ...
        new AsyncTaskC0947Tq(this.A01, this.A0B).A04().A06(new TR(this, null)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC0817Oq interfaceC0817Oq) {
        this.A02 = interfaceC0817Oq;
    }

    public void setUpImageView(C1070Yn c1070Yn) {
        this.A01 = new MZ(c1070Yn);
        if (C0659Ih.A16(c1070Yn)) {
            AbstractC0786Nl.A00(this.A01, C0659Ih.A17(c1070Yn), new ViewOnClickListenerC0822Ov(this));
        }
        A05(this.A01);
    }
    ...
    public void setUpMediaContainer(C1070Yn c1070Yn) {
        ...
        A05(relativeLayout);
        if (this.A0C.A04().A0l() && C0659Ih.A2N(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC0821Ou(this));
        }
    }

    public void setUpVideoView(C1070Yn c1070Yn) {
        this.A04 = new C0844Pr(c1070Yn, new JA(this.A0I, getAdEventManager()));
        if (C0659Ih.A18(c1070Yn)) {
            AbstractC0786Nl.A00(this.A04, C0659Ih.A19(c1070Yn), new ViewOnClickListenerC0823Ow(this));
        }
        A05(this.A04);
        String[] strArr = A0J;
