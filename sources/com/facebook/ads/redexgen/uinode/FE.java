...
public final class FE extends AbstractC1142aa {
    ...
    public static C1124aI A00(C2F c2f) {
        return new C1124aI(c2f);
    }

    @Override // com.facebook.ads.redexgen.uinode.AbstractC1142aa
    ...
    public final void A09() {
        C1132aQ c1132aQ = new C1132aQ(this.A01, this, A04());
        this.A00 = c1132aQ;
        c1132aQ.A0J(this.A01.A05, this.A01.A02, this.A01.A08);
    }
    ...
    public final void A0D(Ad ad2, String str, AdExperienceType adExperienceType, boolean z10) {
        ...
        C1132aQ c1132aQ = this.A00;
        if (c1132aQ != null) {
            c1132aQ.A0J(str, adExperienceType, z10);
            String[] strArr = A02;
        ...
        this.A01.A08 = z10;
        if (AbstractC0661Ik.A07(this.A02) && AbstractC0661Ik.A09(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final boolean A0F() {
        ...
        return this.A01.A01 > 0 && C0728Lf.A00() > this.A01.A01;
    }
    ...
    public final boolean A0H(Ad ad2, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int A00 = ((C03725z) rewardedVideoShowAdConfig).A00();
        long A01 = ((C03725z) rewardedVideoShowAdConfig).A01();
        if (super.A00.A5e()) {
            return false;
        }
        this.A01.A03(ad2);
        ...
        C1132aQ c1132aQ = this.A00;
        if (c1132aQ != null) {
            return c1132aQ.A0M(A00, A01);
        }
        C1132aQ c1132aQ2 = new C1132aQ(this.A01, this, A04());
        this.A00 = c1132aQ2;
        c1132aQ2.A0M(A00, A01);
        return false;
    }
}
