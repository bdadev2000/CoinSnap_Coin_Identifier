...
public class C1070Yn extends C03987f {
    ...
    public final C03957c A02;
    public final AtomicReference<Object> A03;
    public final AtomicReference<Object> A04;
    public final AtomicReference<C0S> A05;

    public C1070Yn(Activity activity, InterfaceC03997h interfaceC03997h, C0S c0s) {
        super(activity.getApplicationContext(), interfaceC03997h);
        ...
        this.A02 = new C03957c();
        this.A04 = new AtomicReference<>();
        atomicReference.set(c0s);
        this.A00 = new WeakReference<>(activity);
    }

    public C1070Yn(Context context, InterfaceC03997h interfaceC03997h, C0S c0s) {
        super(context.getApplicationContext(), interfaceC03997h);
        this.A01 = new WeakHashMap<>();
        AtomicReference<C0S> atomicReference = new AtomicReference<>();
        this.A05 = atomicReference;
        this.A03 = new AtomicReference<>();
    ...
    public static Activity A00(Context context) {
        while (true) {
            ...
            if (z10) {
                ...
                if ((context instanceof C1070Yn) && ((C1070Yn) context).A0D() != null) {
                    return ((C1070Yn) context).A0D();
                }
    ...
    public final void A0K(C1070Yn c1070Yn) {
        c1070Yn.A01.putAll(this.A01);
        this.A01 = c1070Yn.A01;
    }
