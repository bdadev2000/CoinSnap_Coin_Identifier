...
public final class H7<T extends H8> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C0998Vq A09;
    ...
    public final void handleMessage(Message message) {
        ...
        long j3 = elapsedRealtime - this.A04;
        if (this.A07) {
            this.A01.ABz(this.A05, elapsedRealtime, j3, false);
            return;
        }
        switch (message.what) {
            case 1:
            ...
            case 2:
                try {
                    this.A01.AC1(this.A05, elapsedRealtime, j3);
                    return;
            ...
            case 3:
                ...
                int AC2 = this.A01.AC2(this.A05, elapsedRealtime, j3, iOException);
                if (AC2 == 3) {
    ...
    public H7(C0998Vq c0998Vq, Looper looper, T loadable, H6<T> h62, int i10, long j3) {
        super(looper);
        this.A09 = c0998Vq;
        this.A05 = loadable;
        this.A01 = h62;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.H7 != com.facebook.ads.internal.exoplayer2.thirdparty.upstream.Loader$LoadTask<T extends com.facebook.ads.redexgen.X.H8> */
    public final void A06(long j3) {
        H7 h72;
        h72 = this.A09.A00;
        AbstractC0626Ha.A04(h72 == null);
        this.A09.A00 = this;
        if (j3 > 0) {
                ...
                try {
                    try {
                        try {
                            ...
                            Log.e(A01, A01(46, 31, 117), e2);
                            if (!this.A08) {
                                obtainMessage(4, e2).sendToTarget();
                            }
                            throw e2;
                        } catch (InterruptedException unused) {
                            AbstractC0626Ha.A04(this.A07);
                            if (!this.A08) {
                                sendEmptyMessage(2);
                            }
                        }
                    } catch (Exception e10) {
                        Log.e(A01, A01(121, 35, 10), e10);
                        if (!this.A08) {
