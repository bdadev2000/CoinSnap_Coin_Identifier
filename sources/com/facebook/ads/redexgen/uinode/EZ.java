...
public final class EZ extends ZG {
    ...
    public final void A04(C1070Yn c1070Yn, NativeBannerAd nativeBannerAd, JR jr, NativeAdLayout nativeAdLayout) {
        ...
        this.A00 = new SI(c1070Yn, nativeBannerAd, jr, V2.A0L(nativeBannerAd.getInternalNativeAd()).A17(), mediaView, adOptionsView);
