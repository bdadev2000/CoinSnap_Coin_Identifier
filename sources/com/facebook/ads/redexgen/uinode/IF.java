...
public abstract class IF {
    ...
    static {
        ...
        A04 = append.append(A0J).append(str3).append(A0J).append(str2).append(A0J).append(i10).toString();
    ...
    public static int A07(long j3, long j10) {
        if (j3 < j10) {
            return -1;
        }
        return j3 == j10 ? 0 : 1;
    ...
    */
    public static int A0A(long[] r4, long r5, boolean r7, boolean r8) {
        ...
        L1e:
            ...
            goto L8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.IF.A0A(long[], long, boolean, boolean):int");
    }
    ...
    */
    public static int A0B(long[] r4, long r5, boolean r7, boolean r8) {
        ...
        L1c:
            ...
            goto L9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.IF.A0B(long[], long, boolean, boolean):int");
    }

    public static long A0C(long j3, float f10) {
        if (f10 == 1.0f) {
            return j3;
        }
        double d10 = j3 * f10;
    ...
    public static long A0D(long j3, float f10) {
        if (f10 == 1.0f) {
            return j3;
        }
        return Math.round(j3 / f10);
    }

    public static long A0E(long j3, long j10, long j11) {
        return Math.max(j10, Math.min(j3, j11));
    }

    public static long A0F(long j3, long j10, long j11) {
    ...
    public static long A0G(long j3, long j10, long j11) {
        long j12 = j3 + j10;
        if (((j3 ^ j12) & (j10 ^ j12)) < 0) {
            return j11;
        }
    ...
    public static long A0H(long j3, long j10, long j11) {
        long j12 = j3 - j10;
        if (((j3 ^ j10) & (j3 ^ j12)) < 0) {
            return j11;
        }
    ...
    */
    ...
    public static void A0W(InterfaceC0621Gu interfaceC0621Gu) {
    ...
    public static void A0a(long[] jArr, long j3, long j10) {
        if (j10 >= j3) {
            long j11 = j10 % j3;
            String[] strArr = A01;
    ...
    public static <T> T[] A0k(T[] tArr, int i10) {
        AbstractC0626Ha.A03(i10 <= tArr.length);
