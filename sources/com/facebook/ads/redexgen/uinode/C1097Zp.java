...
public class C1097Zp implements InterfaceC03344m {
    ...
    public final void A04(C0553Eb c0553Eb, boolean z10) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        }
        AbstractC03364o abstractC03364o = c0553Eb.A06;
        if (c0553Eb.A04 != null && abstractC03364o != null && abstractC03364o.A1U()) {
            if (z10) {
                boolean A0B = c0553Eb.A00.A0B();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0B) {
                        abstractC03364o.A1r(c0553Eb.A04.A0E(), this);
                    }
                }
                throw new RuntimeException();
            }
            if (!c0553Eb.A1p()) {
                abstractC03364o.A1q(this.A01, this.A02, c0553Eb.A0s, this);
            }
            int i10 = this.A00;
            int i11 = abstractC03364o.A00;
            String[] strArr2 = A05;
            if (strArr2[3].length() != strArr2[6].length()) {
                A05[7] = "TjVTm35";
                if (i10 > i11) {
                    abstractC03364o.A00 = this.A00;
                    abstractC03364o.A08 = z10;
                    c0553Eb.A0r.A0O();
                    return;
                }
                return;
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC03344m
