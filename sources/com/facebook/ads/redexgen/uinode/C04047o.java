...
public final class C04047o {
    public static byte[] A04;
    public static String[] A05 = {"qJOvsPrm5BQkhL6wLJahauzjA45r7dQz", "hfx8x2hkXgxq19RSFkkqiaOe1zMy03Qo", "bV5o7GaQth4ZZOPd4LFtWwXjKNVB8lua", "1EyYFmGpmEhL9EWyl0I1ptwRPtnJxpez", "F", i.a, "plO80lk7YnGQvaXazMopbLIwOg8MB0TR", "EzLFA06L6a2SQhX4934tm7serJXXg4XA"};
    ...
    public final C1067Yk A03 = new C1067Yk(this);
    public final C1068Yl A02 = new C1068Yl(this);
    ...
    static {
        A07();
        StringBuilder append = new StringBuilder().append(A05(107, 14, 91)).append(C1067Yk.A02.A01);
        ...
        StringBuilder append4 = append3.append(A054).append(C1067Yk.A01.A01).append(A052);
        String A055 = A05(136, 6, 111);
        A06 = append4.append(A055).append(A054).append(C1068Yl.A04.A01).append(A052).append(A055).append(A054).append(C1068Yl.A05.A01).append(A052).append(A055).append(A054).append(C1068Yl.A0A.A01).append(A052).append(A055).append(A054).append(C1068Yl.A08.A01).append(A052).append(A055).append(A054).append(C1068Yl.A07.A01).append(A052).append(A055).append(A054).append(C1068Yl.A06.A01).append(A052).append(A055).append(A054).append(C1068Yl.A03.A01).append(A052).append(A055).append(A054).append(C1068Yl.A02.A01).append(A05(11, 6, 42)).append(A055).append(A05(17, 6, 65)).append(A053).append(A05(30, 4, 3)).append(A055).append(A054).append(C1068Yl.A09.A01).append(A05(0, 3, 78)).append(A053).append(A054).append(C1067Yk.A02.A01).append(A05(34, 10, 74)).append(A055).append(A054).append(C1068Yl.A08.A01).append(A05(7, 4, 98)).toString();
    ...
    public C04047o(C1069Ym c1069Ym) {
        this.A01 = c1069Ym;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            final C1069Ym c1069Ym = this.A01;
            this.A00 = new SQLiteOpenHelper(c1069Ym, this) { // from class: com.facebook.ads.redexgen.X.7p
                ...
                static {
                    A02();
                    A03 = C04057p.class.getSimpleName();
                }

                {
                    super(c1069Ym, A01(c1069Ym), (SQLiteDatabase.CursorFactory) null, 4);
                    if (this != null) {
                        this.A00 = this;
                        return;
                    }
                ...
                public static String A01(C1069Ym c1069Ym2) {
                    Locale locale = Locale.US;
                    Object[] objArr = {A00(0, 0, 95)};
                    String processName = A00(126, 8, 81);
                    String format = String.format(locale, processName, objArr);
                    if (!C0659Ih.A2C(c1069Ym2)) {
                        return format;
                    }
                    String defaultDbName = c1069Ym2.getPackageName();
                    String processName2 = ProcessUtils.getProcessName(c1069Ym2);
                ...
                public final void onCreate(SQLiteDatabase sQLiteDatabase) {
                    for (AbstractC04077s abstractC04077s : this.A00.A0M()) {
                        abstractC04077s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
                    for (AbstractC04077s abstractC04077s : this.A00.A0M()) {
                        abstractC04077s.A08(sQLiteDatabase);
                        abstractC04077s.A07(sQLiteDatabase);
                    }
                }
                ...
                public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
                    ...
                    if (i10 <= 3 && i11 >= 4) {
                        C04037m c04037m = C1068Yl.A02;
                        sQLiteDatabase.execSQL(A00(11, 30, 61) + c04037m.A01 + A00(0, 1, 125) + c04037m.A02 + A00(1, 10, 109));
                    }
                }
            };
        }
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A07().A9a(A05(128, 8, 84), C8A.A0v, new C8B(e2));
        throw e2;
        return A00();
    }
    ...
    public final int A08(int i10) {
        ...
        lock.lock();
        try {
            int delete = A0E().delete(A05(136, 6, 111), C1068Yl.A02.A01 + A05(3, 4, 28), new String[]{String.valueOf(i10 - 1)});
            lock.unlock();
            return delete;
        } catch (Throwable th2) {
            A08.unlock();
    ...
    public final <T> AsyncTask A0F(final AbstractC04067r<T> abstractC04067r, final AbstractC04338t<T> abstractC04338t) {
        Executor executor = ExecutorC0742Lt.A07;
        final C1069Ym c1069Ym = this.A01;
        return AbstractC0739Lq.A00(executor, new AsyncTask<Void, Void, T>(c1069Ym, abstractC04067r, abstractC04338t) { // from class: com.facebook.ads.redexgen.X.7n
            public static byte[] A04;
            ...
            public C7q A00;
            public final C1069Ym A01;
            public final AbstractC04067r<T> A02;
            public final AbstractC04338t<T> A03;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.8t != com.facebook.ads.internal.eventstorage.AdEventStorageCallback<T> */
            {
                this.A02 = abstractC04067r;
                this.A03 = abstractC04338t;
                this.A01 = c1069Ym;
            }
    ...
    public final AsyncTask A0G(String str, int i10, String str2, double d10, double d11, String str3, Map<String, String> data, AbstractC04338t<String> abstractC04338t) {
        return A0F(new EP(this, str2, str, i10, d10, d11, str3, data), abstractC04338t);
    }
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb2.append(A05(121, 7, 95)).append(A05(136, 6, 111)).append(A05(44, 5, 67)).append(C1068Yl.A02.A01).append(A05(61, 1, 83)).append(C1068Yl.A02.A01).append(A05(56, 2, 49)).append(A05(49, 7, 11)).append(C1068Yl.A04.A01).append(A05(62, 2, 26));
    ...
    public final AbstractC04077s[] A0M() {
        return new AbstractC04077s[]{this.A03, this.A02};
    }
}
