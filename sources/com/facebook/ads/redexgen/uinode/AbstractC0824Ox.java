...
public abstract class AbstractC0824Ox {
    public static B4 A00(final OP op, int i10, final String str, final C0906Sb c0906Sb) {
        if (i10 == 1) {
            return new B4(op, str, c0906Sb) { // from class: com.facebook.ads.redexgen.X.3Q
                ...
                public final void A19(C1070Yn c1070Yn) {
                    ...
                    AbstractC0737Lo.A0S(linearLayout, new ColorDrawable(-1));
        ...
        return new B4(op, str, c0906Sb) { // from class: com.facebook.ads.redexgen.X.3b
            ...
            public final void A19(C1070Yn c1070Yn) {
                ...
                AbstractC0737Lo.A0R(titleDescContainer, getAdContextWrapper());
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
                layoutParams.addRule(3, getMediaContainer().getId());
