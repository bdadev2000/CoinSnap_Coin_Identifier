...
public final class C1045Xo implements C1 {
    ...
    public C1045Xo(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j3) {
        return IF.A0B(this.A04, j3, true, true);
    }
    ...
    public final C0 A7t(long j3) {
        ...
        if (c22.A01 < j3) {
            ...
            if (A00 != chunkIndex - 1) {
                ...
                C2 seekPoint = new C2(j10, this.A03[chunkIndex3]);
