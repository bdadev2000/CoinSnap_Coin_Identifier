...
public final class C0675Iz {
    ...
    public C0675Iz(C03987f c03987f, String str, double d10, String str2, Map<String, String> map, J4 j42, J5 j52, boolean z10) {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = j42;
        ...
        if (z10) {
            hashMap.put(A00(27, 24, 34), String.valueOf(z10));
        }
        String A01 = JC.A01(str);
        if (!TextUtils.isEmpty(A01) && (z10 || j52 == J5.A0C)) {
            hashMap.put(A00(6, 21, 61), A01);
        }
        if (A0B()) {
            Map<String, String> extraData = c03987f.A03().A61();
