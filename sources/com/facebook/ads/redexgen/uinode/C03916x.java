...
public final class C03916x implements InterfaceC0635Hj, InterfaceC0893Ro {
    ...
    public final InterfaceC04107w A01;
    public final RK A02;
    public final InterfaceC0894Rp A03;
    public final C0902Rx A04;
    public final InterfaceC0903Ry A05;
    public final String A06;
    public final Map<EnumC0889Rk, C0648Hw> A09 = new HashMap();
    public final Map<EnumC0889Rk, AnonymousClass74> A08 = new HashMap();
    ...
    private void A04() throws Throwable {
        ...
        synchronized (this) {
            for (C0648Hw c0648Hw : this.A09.values()) {
                if (c0648Hw.A9C()) {
                    hashMap.put(c0648Hw, S5.A04);
                } else {
                    hashMap.put(c0648Hw, S5.A03);
                }
            }
            new AtomicReference();
            new AtomicReference();
            ...
            while (it.hasNext()) {
                it.next();
                InterfaceC0888Rj interfaceC0888Rj = null;
                if (interfaceC0888Rj.A9C()) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0635Hj
    public final synchronized InterfaceC0888Rj A4i(EnumC0889Rk enumC0889Rk) {
        if (enumC0889Rk.A02() != EnumC0891Rm.A03) {
            throw new IllegalArgumentException(A01(47, 59, 118));
        }
        if (this.A09.containsKey(enumC0889Rk)) {
            return this.A09.get(enumC0889Rk);
        }
        C0648Hw c0648Hw = new C0648Hw(enumC0889Rk);
        this.A09.put(enumC0889Rk, c0648Hw);
        Iterator<S2> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            throw new NullPointerException(A01(377, 24, 105));
        }
        String.format(Locale.US, A01(153, 35, 82), enumC0889Rk);
        return c0648Hw;
    }
    ...
    public C03916x(C03987f c03987f, InterfaceC04107w interfaceC04107w, RK rk, String str, InterfaceC0903Ry interfaceC0903Ry, C0902Rx c0902Rx, InterfaceC0892Rn interfaceC0892Rn) {
        this.A00 = c03987f;
        this.A01 = interfaceC04107w;
        this.A02 = rk;
        this.A06 = str;
        this.A05 = interfaceC0903Ry;
        this.A04 = c0902Rx;
        this.A03 = interfaceC0892Rn.A4V(this);
    }
    ...
    private Set<S1> A02(JSONObject jSONObject) throws JSONException {
        ...
        for (final C0648Hw c0648Hw : this.A09.values()) {
            switch (S0.A01[S6.A00(jSONObject2.getString(c0648Hw.A7A().A03())).ordinal()]) {
                case 1:
                    final JSONObject data = jSONObject3.getJSONObject(c0648Hw.A7A().A03()).getJSONObject(A01(312, 4, 17));
                    final JSONObject responseObject = jSONObject3.getJSONObject(c0648Hw.A7A().A03()).optJSONObject(A01(316, 11, 48));
                    hashSet.add(new HN(c0648Hw, data, responseObject) { // from class: com.facebook.ads.redexgen.X.70
                        ...
                        public final void A3Z(Map<InterfaceC0888Rj, S6> map, Map<SyncModifiableBundle, EnumC0898Rt> map2) {
                    ...
                    break;
                case 2:
                    hashSet.add(new HN(c0648Hw) { // from class: com.facebook.ads.redexgen.X.6z
                        {
                            S6 s62 = S6.A04;
                        }
                    });
        ...
        while (it.hasNext()) {
            ...
            switch (S0.A00[EnumC0898Rt.A00(jSONObject2.getString(anonymousClass74.A7A().A03())).ordinal()]) {
                case 1:
                    hashSet.add(new HT(anonymousClass74) { // from class: com.facebook.ads.redexgen.X.73
                        {
                            EnumC0898Rt enumC0898Rt = EnumC0898Rt.A04;
                        }
                    });
                    break;
                case 2:
                    hashSet.add(new HT(anonymousClass74) { // from class: com.facebook.ads.redexgen.X.6y
                        ...
                        {
                            EnumC0898Rt enumC0898Rt = EnumC0898Rt.A05;
                        }
    ...
    private JSONObject A03(Map<InterfaceC0888Rj, S5> map, Map<SyncModifiableBundle, EnumC0897Rs> map2, Map<SyncModifiableBundle, JSONObject> clientBundleData, Map<SyncModifiableBundle, JSONObject> clientBundleFingerprint) throws JSONException {
        String A01;
        JSONObject jSONObject = new JSONObject();
        for (Map.Entry<InterfaceC0888Rj, S5> entry : map.entrySet()) {
            jSONObject.put(entry.getKey().A7A().A03(), entry.getValue().A02());
        }
        for (Map.Entry<SyncModifiableBundle, EnumC0897Rs> entry2 : map2.entrySet()) {
            entry2.getKey();
            InterfaceC0888Rj interfaceC0888Rj = null;
            jSONObject.put(interfaceC0888Rj.A7A().A03(), entry2.getValue().A02());
        }
        JSONObject jSONObject2 = new JSONObject();
        Iterator<Map.Entry<InterfaceC0888Rj, S5>> it = map.entrySet().iterator();
        while (true) {
            ...
            Map.Entry<InterfaceC0888Rj, S5> next = it.next();
            if (next.getValue() == S5.A04) {
                JSONObject bundles = new JSONObject();
                InterfaceC0888Rj key = next.getKey();
        ...
        for (Map.Entry<SyncModifiableBundle, EnumC0897Rs> entry3 : map2.entrySet()) {
            JSONObject updateData = new JSONObject();
            InterfaceC0888Rj key2 = entry3.getKey();
            JSONObject request2 = clientBundleFingerprint.get(entry3.getKey());
            updateData.put(A01, request2);
            if (entry3.getValue() == EnumC0897Rs.A05) {
    ...
    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0635Hj, com.facebook.ads.redexgen.uinode.InterfaceC04027l
    public final void A5m() {
        this.A03.A5l();
    }

    @Override // com.facebook.ads.redexgen.uinode.InterfaceC0893Ro
    public final void AFP() {
        ...
        try {
            if (!C0659Ih.A1e(this.A00) || this.A00.A03().A94()) {
                A04();
                return;
            }
