...
public abstract class AQ {
     ...
     */
    public static Format A07(C0651Hz c0651Hz, String str, String str2, DrmInitData drmInitData) {
        int i10 = A05[(c0651Hz.A0E() & PsExtractor.AUDIO_STREAM) >> 6];
        int A0E = c0651Hz.A0E();
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 14 out of bounds for length 13
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static Format A08(C0651Hz c0651Hz, String str, String str2, DrmInitData drmInitData) {
        c0651Hz.A0Z(2);
        int i10 = A05[(c0651Hz.A0E() & PsExtractor.AUDIO_STREAM) >> 6];
        int A0E = c0651Hz.A0E();
        ...
        if (((c0651Hz.A0E() & 30) >> 1) > 0 && (c0651Hz.A0E() & 2) != 0) {
            i11 += 2;
        }
        String A0A = A0A(9, 10, 48);
        if (c0651Hz.A04() > 0 && (c0651Hz.A0E() & 1) != 0) {
            A0A = A0A(19, 14, 124);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:123:0x028c, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.AQ.A01[6].charAt(31) == 'Q') goto L166;
     */
    ...
    */
    public static com.facebook.ads.redexgen.uinode.AP A09(com.facebook.ads.redexgen.uinode.C0650Hy r18) {
        /*
    ...
    public static int A03(ByteBuffer byteBuffer) {
        ...
        int fscod2 = i10 * NotificationCompat.FLAG_LOCAL_ONLY;
        return fscod2;
    }

    public static int A04(ByteBuffer byteBuffer, int i10) {
        boolean isMlp = (byteBuffer.get((byteBuffer.position() + i10) + 7) & UByte.MAX_VALUE) == 187;
