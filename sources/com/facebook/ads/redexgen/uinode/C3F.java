...
public final class C3F extends AbstractC03816j {
     ...
     */
    public static Point A02(DG dg2, Format format) throws DP {
        ...
        for (int i12 : A0f) {
            ...
            if (IF.A02 >= 21) {
                ...
                Point A0E = dg2.A0E(i14, i12);
                if (dg2.A0H(A0E.x, A0E.y, format.A01)) {
                    return A0E;
                }
            } else {
                int A04 = IF.A04(i12, 16) * 16;
                int A042 = IF.A04(i13, 16) * 16;
                if (A04 * A042 <= DR.A00()) {
    ...
    public C3F(Context context, DM dm, long j3, InterfaceC0492Bc<FrameworkMediaCrypto> interfaceC0492Bc, boolean z10, Handler handler, InterfaceC0655Id interfaceC0655Id, int i10) {
        super(2, dm, interfaceC0492Bc, z10);
        this.A0U = j3;
        this.A0T = i10;
        Context applicationContext = context.getApplicationContext();
        this.A0V = applicationContext;
        this.A0W = new IT(applicationContext);
        this.A0X = new C0654Ic(handler, interfaceC0655Id);
        this.A0Y = A0M();
    ...
    public static int A00(DG dg2, Format format) {
        if (format.A09 != -1) {
            int i10 = 0;
        ...
        return A01(dg2, format.A0O, format.A0F, format.A08);
    }
    ...
    */
    ...
    private final IP A04(DG dg2, Format format, Format[] formatArr) throws DP {
        int maxWidth;
        int i10 = format.A0F;
        int i11 = format.A08;
        int A00 = A00(dg2, format);
        int maxHeight = formatArr.length;
        if (maxHeight == 1) {
            return new IP(i10, i11, A00);
        }
        int i12 = 0;
        for (Format format2 : formatArr) {
            if (A0V(dg2.A03, format, format2)) {
                ...
                int maxWidth62 = A00(dg2, format2);
        ...
        if (i12 != 0) {
            ...
            Log.w(A052, sb2);
            Point A02 = A02(dg2, format);
            if (A02 != null) {
                int maxWidth7 = A02.x;
                i10 = Math.max(i10, maxWidth7);
                int maxWidth8 = A02.y;
                i11 = Math.max(i11, maxWidth8);
                int maxWidth9 = A01(dg2, format.A0O, i10, i11);
    ...
    private void A0C() {
        long j3;
        if (this.A0U > 0) {
            j3 = SystemClock.elapsedRealtime() + this.A0U;
        } else {
            j3 = C.TIME_UNSET;
        }
        this.A0J = j3;
    ...
    private final void A0F(MediaCodec mediaCodec, int i10, long j3) {
    ...
    private final void A0G(MediaCodec mediaCodec, int i10, long j3) {
        A09();
    ...
    private final void A0H(MediaCodec mediaCodec, int i10, long j3) {
    ...
    private final void A0I(MediaCodec mediaCodec, int i10, long j3, long j10) {
        A09();
        IC.A02(A05(1161, 19, 109));
    ...
    private void A0L(Surface surface) throws C04419c {
        if (surface == null) {
            if (this.A0N != null) {
                surface = this.A0N;
            } else {
    ...
    public static boolean A0N(long j3) {
        return j3 < -30000;
    }

    public static boolean A0O(long j3) {
        return j3 < -500000;
    }

    private final boolean A0P(long j3, long j10) {
        return A0O(j3);
    }

    private final boolean A0Q(long j3, long j10) {
        return A0N(j3);
    }

    private final boolean A0R(long j3, long j10) {
        return A0N(j3) && j10 > 100000;
    }

    private final boolean A0S(MediaCodec mediaCodec, int i10, long j3, long j10) throws C04419c {
        int A10 = A10(j10);
        if (A10 == 0) {
            return false;
        }
    ...
    private boolean A0T(DG dg2) {
        return IF.A02 >= 23 && !this.A0S && !A0U(dg2.A02) && (!dg2.A05 || DummySurface.A05(this.A0V));
    }
                ...
                switch (str2.hashCode()) {
                    ...
                    case 2564:
                        if (str2.equals(A05(670, 2, 127))) {
                            c11 = AbstractJsonLexerKt.STRING_ESC;
                            break;
                        }
                        c11 = 65535;
                        break;
                    ...
                    case 88274:
                        if (str2.equals(A05(852, 3, 13))) {
                            c11 = AbstractJsonLexerKt.UNICODE_ESC;
                            break;
                        }
                        c11 = 65535;
                        break;
                    ...
                    case 76404911:
                        if (str2.equals(A05(665, 5, 112))) {
                            c11 = AbstractJsonLexerKt.BEGIN_LIST;
                            break;
                        }
                        c11 = 65535;
                        break;
                    ...
                    case 1060579533:
                        ...
                        break;
                    case 1150207623:
                        if (str2.equals(A05(PglCryptUtils.LOAD_SO_FAILED, 7, 17))) {
                            c11 = ';';
                            break;
                        }
                        c11 = 65535;
    ...
    public final int A1B(MediaCodec mediaCodec, DG dg2, Format format, Format format2) {
        if (A0V(dg2.A03, format, format2) && format2.A0F <= this.A0P.A02 && format2.A08 <= this.A0P.A00 && A00(dg2, format2) <= this.A0P.A01) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x00ab, code lost:
        ...
        if (r5 <= com.facebook.ads.redexgen.uinode.DR.A00()) goto L50;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00b0, code lost:
        ...
        r0 = A05(856, 3, 89);
        r1 = r5.append(r0);
        r0 = com.facebook.ads.redexgen.uinode.IF.A04;
        r5 = r1.append(r0);
        r0 = A05(855, 1, 29);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int A1C(com.facebook.ads.redexgen.uinode.DM r10, com.facebook.ads.redexgen.uinode.InterfaceC0492Bc<com.facebook.ads.internal.exoplayer2.thirdparty.drm.FrameworkMediaCrypto> r11, com.facebook.ads.internal.exoplayer2.thirdparty.Format r12) throws com.facebook.ads.redexgen.uinode.DP {
        /*
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC03816j
    public final void A1G() throws C04419c {
        super.A1G();
        this.A04 = 0;
    }
    ...
    */
    ...
    public final void A1N(C1048Xr c1048Xr) {
        this.A04++;
        this.A0K = Math.max(c1048Xr.A00, this.A0K);
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC03816j
    public final void A1O(DG dg2, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws DP {
        IP A04 = A04(dg2, format, A1A());
        this.A0P = A04;
        MediaFormat A03 = A03(format, A04, this.A0Y, this.A0G);
        if (this.A0O == null) {
            AbstractC0626Ha.A04(A0T(dg2));
            if (this.A0N == null) {
                this.A0N = DummySurface.A01(this.A0V, dg2.A05);
            }
            this.A0O = this.A0N;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final boolean A1Q(long r32, long r34, android.media.MediaCodec r36, java.nio.ByteBuffer r37, int r38, int r39, long r40, boolean r42) throws com.facebook.ads.redexgen.uinode.C04419c {
        /*
    ...
    @Override // com.facebook.ads.redexgen.uinode.AbstractC03816j
    public final boolean A1R(DG dg2) {
        return this.A0O != null || A0T(dg2);
    }
