...
public final class FF extends AbstractC1142aa {
    ...
    public static final AnonymousClass27 A03 = new C1130aO();
    public C1135aT A00;
    ...
    public final void A09() {
        C1135aT c1135aT = new C1135aT(this.A01, this, A04());
        this.A00 = c1135aT;
        c1135aT.A0G(this.A01.A0B(), this.A01.A07());
    }
    ...
    public final void A0D(InterstitialAd interstitialAd, EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        C1135aT c1135aT = this.A00;
        if (c1135aT != null) {
            c1135aT.A0G(cacheFlags, str);
            return;
        }
        this.A01.A0K(cacheFlags);
        this.A01.A0H(str);
        if (AbstractC0661Ik.A07(this.A02) && AbstractC0661Ik.A08(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final boolean A0H(InterstitialAd interstitialAd, InterstitialAd.InterstitialShowAdConfig interstitialShowAdConfig) {
        ...
        C1135aT c1135aT2 = new C1135aT(this.A01, this, A04());
        this.A00 = c1135aT2;
        c1135aT2.A0J();
        return false;
    }
