...
public final class C0651Hz {
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < copyOfRange.length; i13++) {
            ...
            copyOfRange[i13] = (byte) ((b3 - i12) - 116);
        }
    ...
    public C0651Hz(int i10) {
        this.A00 = new byte[i10];
        this.A01 = i10;
    }

    public C0651Hz(byte[] bArr) {
        this.A00 = bArr;
        this.A01 = bArr.length;
    }

    public C0651Hz(byte[] bArr, int i10) {
        this.A00 = bArr;
        this.A01 = i10;
    }
    ...
    public final long A0J() {
        ...
        int i12 = i11 + 1;
        this.A02 = i12;
        long j3 = (bArr[r0] & 255) | ((bArr[i10] & 255) << 8) | ((bArr[i11] & 255) << 16);
        int i13 = i12 + 1;
        this.A02 = i13;
        long j10 = j3 | ((bArr[i12] & 255) << 24);
        int i14 = i13 + 1;
        this.A02 = i14;
        long j11 = j10 | ((bArr[i13] & 255) << 32);
        int i15 = i14 + 1;
        this.A02 = i15;
        long j12 = j11 | ((bArr[i14] & 255) << 40);
        int i16 = i15 + 1;
        this.A02 = i16;
        long j13 = j12 | ((bArr[i15] & 255) << 48);
        this.A02 = i16 + 1;
        return ((bArr[i16] & 255) << 56) | j13;
    }
    ...
    public final long A0L() {
        ...
        int i11 = i10 + 1;
        this.A02 = i11;
        long j3 = ((bArr[r0] & 255) << 56) | ((bArr[i10] & 255) << 48);
        int i12 = i11 + 1;
        this.A02 = i12;
        long j10 = j3 | ((bArr[i11] & 255) << 40);
        int i13 = i12 + 1;
        this.A02 = i13;
    ...
    public final long A0M() {
        ...
        int i11 = i10 + 1;
        this.A02 = i11;
        long j3 = ((bArr[r0] & 255) << 24) | ((bArr[i10] & 255) << 16);
        int i12 = i11 + 1;
        this.A02 = i12;
        long j10 = j3 | ((bArr[i11] & 255) << 8);
        this.A02 = i12 + 1;
    ...
    public final long A0O() {
        ...
        if (i10 != 0) {
            for (int i12 = 1; i12 < i10; i12++) {
                ...
                A04[2] = "bgE5KGMxqsO";
                byte b3 = bArr2[i13 + i12];
                if ((b3 & 192) == 128) {
                    int length4 = b3 & 63;
                    j3 = (j3 << 6) | length4;
                } else {
                    throw new NumberFormatException(A00(0, 42, 117) + j3);
                }
            }
        ...
        throw new NumberFormatException(A00(42, 35, 108) + j3);
    }
    ...
    */
    public final java.lang.String A0P() {
        ...
        L5d:
            int r3 = r6.A02
            java.lang.String[] r1 = com.facebook.ads.redexgen.uinode.C0651Hz.A04
            r0 = 0
            r1 = r1[r0]
            r0 = 27
            ...
            if (r1 == r0) goto La5
            java.lang.String[] r2 = com.facebook.ads.redexgen.uinode.C0651Hz.A04
        ...
        La5:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0651Hz.A0P():java.lang.String");
    }
    ...
    */
    public final java.lang.String A0Q() {
        ...
        L2b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.uinode.C0651Hz.A0Q():java.lang.String");
    }
    ...
    public final String A0R(int i10) {
        ...
        String A0R = IF.A0R(this.A00, lastIndex, i11);
        String[] strArr = A04;
        String str = strArr[6];
    ...
    public final void A0X(int i10) {
        AbstractC0626Ha.A03(i10 >= 0 && i10 <= this.A00.length);
        this.A01 = i10;
    }

    public final void A0Y(int i10) {
        AbstractC0626Ha.A03(i10 >= 0 && i10 <= this.A01);
        this.A02 = i10;
    }
    ...
    public final void A0a(C0650Hy c0650Hy, int i10) {
        A0c(c0650Hy.A00, 0, i10);
        c0650Hy.A07(0);
    }
