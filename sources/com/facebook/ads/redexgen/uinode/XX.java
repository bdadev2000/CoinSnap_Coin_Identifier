...
public final class XX implements InterfaceC0508Bs {
    ...
    public static final InterfaceC0511Bv A0r;
    ...
    public final C0651Hz A0j;
    public final C0651Hz A0k;
    public final C0651Hz A0l;
    public final C0651Hz A0m;
    public final C0651Hz A0n;
    ...
    */
    private void A08(com.facebook.ads.redexgen.uinode.InterfaceC0509Bt r11, com.facebook.ads.redexgen.uinode.CE r12, int r13) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    public XX(CA ca2, int i10) {
        ...
        this.A0k = new C0651Hz(4);
        this.A0n = new C0651Hz(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new C0651Hz(4);
        this.A0i = new C0651Hz(AbstractC0647Hv.A03);
        this.A0h = new C0651Hz(4);
        this.A0j = new C0651Hz();
        this.A0m = new C0651Hz();
        this.A0f = new C0651Hz(8);
        this.A0g = new C0651Hz();
    }

    private int A00(InterfaceC0509Bt interfaceC0509Bt, C4 c42, int i10) throws IOException, InterruptedException {
        int bytesRead;
        ...
        if (strippedBytesLeft > 0) {
            ...
            bytesRead = c42.AFQ(interfaceC0509Bt, i10, false);
        }
        this.A07 += bytesRead;
        this.A08 += bytesRead;
        return bytesRead;
    ...
    private long A01(long j3) throws C04599v {
        long j10 = this.A0M;
        if (j10 != C.TIME_UNSET) {
            return IF.A0F(j3, j10, 1000L);
        }
        throw new C04599v(A03(PsExtractor.PRIVATE_STREAM_1, 54, 68));
    }
    ...
    */
    ...
    private void A07(InterfaceC0509Bt interfaceC0509Bt, int i10) throws IOException, InterruptedException {
        if (this.A0k.A07() >= i10) {
            return;
        }
        if (this.A0k.A05() < i10) {
            C0651Hz c0651Hz = this.A0k;
            c0651Hz.A0b(Arrays.copyOf(c0651Hz.A00, Math.max(this.A0k.A00.length * 2, i10)), this.A0k.A07());
        }
        ...
        interfaceC0509Bt.readFully(bArr, A07, i10 - this.A0k.A07());
        this.A0k.A0X(i10);
    }

    private void A09(InterfaceC0509Bt interfaceC0509Bt, byte[] bArr, int i10) throws IOException, InterruptedException {
        ...
        interfaceC0509Bt.readFully(bArr2, sizeWithPrefix3, i10);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC0509Bt interfaceC0509Bt, byte[] bArr, int i10, int i11) throws IOException, InterruptedException {
        int min = Math.min(i11, this.A0j.A04());
        int pendingStrippedBytes = i11 - min;
        interfaceC0509Bt.readFully(bArr, i10 + min, pendingStrippedBytes);
        if (min > 0) {
    ...
    private void A0B(CE ce2, long j3) {
        if (ce2.A0X != null) {
            CF cf2 = ce2.A0X;
            if (A0q[6].length() != 27) {
                throw new RuntimeException();
            ...
            if (A03(843, 11, 89).equals(ce2.A0Y)) {
                A0C(ce2, A03(33, 19, 7), 19, 1000L, A0x);
            } else if (A03(833, 10, 57).equals(ce2.A0Y)) {
                A0C(ce2, A03(14, 19, 109), 21, 10000L, A0v);
            }
            ce2.A0W.AFS(j3, this.A01, this.A08, 0, ce2.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0C(CE ce2, String str, int i10, long j3, byte[] bArr) {
        A0D(this.A0m.A00, this.A0C, str, i10, j3, bArr);
        C4 c42 = ce2.A0W;
        C0651Hz c0651Hz = this.A0m;
        c42.AFR(c0651Hz, c0651Hz.A07());
        this.A08 += this.A0m.A07();
    }

    public static void A0D(byte[] bArr, long j3, String str, int i10, long j10, byte[] bArr2) {
        byte[] timeCodeData;
        if (j3 == C.TIME_UNSET) {
            timeCodeData = bArr2;
        } else {
            ...
            int minutes = i12 * 60;
            long j12 = j11 - (minutes * 1000000);
            int lastValue = (int) (j12 / 1000000);
            int seconds = (int) ((j12 - (lastValue * 1000000)) / j10);
    ...
    private boolean A0E(C0513Bz c0513Bz, long j3) {
        if (this.A0Y) {
            this.A0J = j3;
            c0513Bz.A00 = this.A0F;
            this.A0Y = false;
            return true;
        }
    ...
    public final void A0I(int i10) throws C04599v {
        switch (i10) {
            case 160:
                if (this.A04 != 2) {
                    return;
            ...
            case 19899:
                ...
                throw new C04599v(A03(667, 50, 26));
            case 25152:
                if (!this.A0O.A0c) {
                    return;
                }
                if (this.A0O.A0V != null) {
                    this.A0O.A0U = new DrmInitData(new DrmInitData.SchemeData(C9W.A04, A03(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY, 10, 63), this.A0O.A0V.A03));
                    return;
                }
                throw new C04599v(A03(449, 55, 115));
            case 28032:
                if (!this.A0O.A0c || this.A0O.A0f == null) {
                    return;
                } else {
                    throw new C04599v(A03(243, 53, 10));
                }
            case 357149030:
            ...
            case 374648427:
                ...
                throw new C04599v(A03(756, 26, 64));
            case 475249515:
                if (this.A0a) {
                    return;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:103:0x0322, code lost:
        ...
        if (com.facebook.ads.redexgen.uinode.XX.A0q[7].charAt(2) == 'J') goto L109;
     */
    /* JADX WARN: Code restructure failed: missing block: B:104:0x0324, code lost:
    
        r10 = com.facebook.ads.redexgen.uinode.XX.A0q;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x0372, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C04599v(A03(396, 37, 107));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0382, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C04599v(A03(782, 33, 29));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:128:0x03a3, code lost:
        ...
        throw new com.facebook.ads.redexgen.uinode.C04599v(A03(877, 25, 30) + r11);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x0242, code lost:
        ...
        r11 = r11 + 1;
        A07(r22, r11);
        r3 = r19.A0k.A00[r11 - 1] & kotlin.UByte.MAX_VALUE;
        r1 = r19.A0b;
        r0 = r1[r12] + r3;
        r1[r12] = r0;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0273, code lost:
        ...
        r19.A0b[r11] = r2;
        r2 = com.facebook.ads.redexgen.uinode.XX.A0q;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x0291, code lost:
        ...
        com.facebook.ads.redexgen.uinode.XX.A0q[6] = "AJCSp0dPwFu9XZoKvCoy3nlmL9O";
        r12 = r12 + 1;
        A07(r22, r12);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x02f3, code lost:
        ...
        com.facebook.ads.redexgen.uinode.XX.A0q[7] = "JvemuAcSz5vc2l4QyutSma8u3cOiXxC4";
        r10 = 1;
     */
    /* JADX WARN: Code restructure failed: missing block: B:94:0x02ba, code lost:
        ...
        A07(r22, r12);
        r1 = r2 + 1;
        r2 = (r19.A0k.A00[r2] & kotlin.UByte.MAX_VALUE) & (r10 ^ (-1));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:96:0x02cf, code lost:
        ...
        r2 = (r2 << 8) | (r19.A0k.A00[r1] & kotlin.UByte.MAX_VALUE);
        r1 = r1 + 1;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0K(int r20, int r21, com.facebook.ads.redexgen.uinode.InterfaceC0509Bt r22) throws java.io.IOException, java.lang.InterruptedException {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0L(int r11, long r12) throws com.facebook.ads.redexgen.uinode.C04599v {
        /*
    ...
    public final void A0M(int i10, long j3, long j10) throws C04599v {
        switch (i10) {
            case 160:
                this.A0W = false;
                return;
            ...
            case 408125543:
                ...
                throw new C04599v(A03(717, 39, 113));
            case 475249515:
                this.A0Q = new C0641Hp();
                this.A0P = new C0641Hp();
                return;
            case 524531317:
                if (this.A0a) {
                    return;
                ...
                if (this.A0o && this.A0F != -1) {
                    ...
                    this.A0N.AFi(new C1040Xj(this.A0H));
                    this.A0a = true;
                    return;
                }
        }
    ...
    public final void A0N(int i10, String str) throws C04599v {
        switch (i10) {
            case 134:
                this.A0O.A0Y = str;
                return;
            case 17026:
                if (A03(1034, 4, 113).equals(str) || A03(1016, 8, 122).equals(str)) {
                    ...
                    throw new C04599v(A03(369, 8, 117) + str + A03(0, 14, 21));
                }
            case 2274716:
                CE.A02(this.A0O, str);
                return;
    ...
    public final int AEH(InterfaceC0509Bt interfaceC0509Bt, C0513Bz c0513Bz) throws IOException, InterruptedException {
        ...
        boolean z10 = true;
        while (z10 && !this.A0V) {
            z10 = this.A0d.AEJ(interfaceC0509Bt);
            if (z10 && A0E(c0513Bz, interfaceC0509Bt.A7i())) {
                return 1;
            }
        }
        if (z10) {
    ...
    */
    ...
    public final boolean AGR(InterfaceC0509Bt interfaceC0509Bt) throws IOException, InterruptedException {
        return new CG().A01(interfaceC0509Bt);
    }
}
