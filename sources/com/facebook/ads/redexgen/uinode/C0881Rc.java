...
public final class C0881Rc {
    ...
    public static RK A00(C03987f c03987f) {
        return A03(true, c03987f);
    }

    public static RK A01(C03987f c03987f) {
        return A02(true, c03987f);
    }

    public static RK A02(boolean z10, C03987f c03987f) {
        RO ro = new RO();
        RR A042 = A04(c03987f);
        if (!A0B(c03987f)) {
            ro.A02(A04);
        ...
        return A002.A00(networkModuleConfigurationBuilder.A03(z10).A04(c03987f.A04().A8z()).A05(), c03987f.A07(), ExecutorC0742Lt.A01());
    }

    public static RK A03(boolean z10, C03987f c03987f) {
        return RM.A00().A00(new RO().A03(z10).A00(A04(c03987f).A09()).A04(c03987f.A04().A8z()).A05(), c03987f.A07(), ExecutorC0742Lt.A01());
    }

    public static RR A04(C03987f c03987f) {
        A08(c03987f);
        RR rr = new RR();
        if (A0B(c03987f) || L0.A04()) {
            rr.A02(360000).A04(120000);
        } else {
            rr.A02(C0659Ih.A08(c03987f)).A04(C0659Ih.A0A(c03987f));
        }
        rr.A03(C0659Ih.A09(c03987f)).A05(C0659Ih.A0B(c03987f)).A06(C0659Ih.A0C(c03987f));
        synchronized (C0881Rc.class) {
            RI ri = A00;
    ...
    public static void A08(C03987f c03987f) {
        if (!A05.get()) {
            c03987f.A07().A9a(A05(161, 7, 81), C8A.A21, new C8B(A05(93, 23, 29)));
        }
    }
    ...
    public static boolean A0A(C03987f c03987f) {
        ...
        if (i10 < 17) {
            return Settings.System.getInt(c03987f.getContentResolver(), A052, 0) != 0;
        }
        int i11 = Settings.Global.getInt(c03987f.getContentResolver(), A052, 0);
        if (A02[0].length() != 1) {
            throw new RuntimeException();
        }
        String[] strArr = A02;
