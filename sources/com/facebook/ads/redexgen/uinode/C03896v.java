...
public class C03896v<E> extends AbstractC03886u<E>.IteratorImpl implements ListIterator<E> {
    public static byte[] A01;
    public final /* synthetic */ AbstractC03886u<E> A00;
    ...
    public C03896v(AbstractC03886u abstractC03886u, int i10) {
        super(abstractC03886u);
        this.A00 = abstractC03886u;
        AbstractC03886u.A02.A04(i10, abstractC03886u.size());
        A05(i10);
    }
    ...
    public final E previous() {
        if (hasPrevious()) {
            AbstractC03886u<E> abstractC03886u = this.A00;
            A05(getA00() - 1);
            return abstractC03886u.get(getA00());
        }
