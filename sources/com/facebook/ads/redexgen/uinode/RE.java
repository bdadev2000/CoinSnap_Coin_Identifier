...
public final class RE {
    ...
    */
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static RF A0E(View view, int i10, C1070Yn c1070Yn) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new RF(C0Q.A08);
        }
        boolean A2H = C0659Ih.A2H(c1070Yn);
        ...
        if (A0H[4].charAt(15) == 'A') {
            ...
            try {
                ...
                if (A0H[1].length() == 16) {
                    ...
                    if (i11 >= 17) {
                        ((WindowManager) c1070Yn.getSystemService(A0H(594, 6, 109))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                    } else {
                    ...
                    Map<String, String> A012 = M6.A01(c1070Yn);
                    if (C0738Lp.A04(A012)) {
                        A0N(view, false, A0H(156, 29, 77));
                        return new RF(C0Q.A0A, A082);
                    }
                    if (C0659Ih.A1d(c1070Yn) && C0738Lp.A03(A012)) {
    ...
    public RE(View view, int i10, int i11, boolean z10, WeakReference<RD> weakReference, C1070Yn c1070Yn) {
    ...
    public RE(View view, int i10, WeakReference<RD> weakReference, C1070Yn c1070Yn) {
        this(view, i10, 0, false, weakReference, c1070Yn);
    }

    public RE(View view, int i10, boolean z10, WeakReference<RD> weakReference, C1070Yn c1070Yn) {
        this(view, i10, 0, z10, weakReference, c1070Yn);
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            boolean z10 = true;
            boolean z11 = !(childAt instanceof C0850Px);
    ...
    public static void A0N(View view, boolean z10, String str) {
        if (BuildConfigApi.isDebug()) {
            String str2 = A0H(PsExtractor.VIDEO_STREAM_MASK, 5, 110) + view + A0H(9, 4, 108) + (z10 ? A0H(579, 8, 81) : A0H(565, 12, 121)) + A0H(13, 14, 76) + str;
        }
    }
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(592, 2, 68), C0728Lf.A05(this.A03));
