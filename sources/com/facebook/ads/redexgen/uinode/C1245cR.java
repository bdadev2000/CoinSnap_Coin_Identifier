...
public final class C1245cR {
    ...
    public final SU A05;
    public final InterfaceC1255cc A06;
    public final C1247cT A07;
    public final HB A08;
    public final Runnable A09;
    public final List<Rect> A0A;
    public final List<DspViewableNode> A0B;

    public C1245cR(InterfaceC1255cc interfaceC1255cc, SU su, HB hb2, C1247cT c1247cT, Handler handler) {
        this(interfaceC1255cc, su, hb2, c1247cT, handler, 100);
    }

    public C1245cR(InterfaceC1255cc interfaceC1255cc, SU su, HB hb2, C1247cT c1247cT, Handler handler, int i10) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        this.A0B = new ArrayList();
        this.A0A = new ArrayList();
        this.A01 = false;
        this.A06 = interfaceC1255cc;
        this.A05 = su;
        this.A08 = hb2;
        this.A07 = c1247cT;
        this.A04 = handler;
        this.A09 = new RunnableC1246cS(this, i10, new Exception());
    }

    private void A03(long j3) {
        if (this.A0B.isEmpty()) {
            this.A06.A8O(this.A0A);
            this.A08.A41(j3, this.A0A);
            this.A08.A5Z();
            return;
        }
        ...
        if (this.A0B.isEmpty()) {
            ...
            loop0: while (true) {
                if (it.hasNext()) {
                    ...
                    C1253ca A00 = this.A07.A00(next);
                    Iterator<Rect> it2 = this.A0A.iterator();
                    while (it2.hasNext()) {
                        if (next.A8N(this.A03, this.A02, it2.next()) && A00 != C1253ca.A08) {
                            HB hb2 = this.A08;
                            ...
                            hb2.A3V(A00, containerRect, rect);
                        }
                    }
                } else {
                    this.A08.A5Z();
                    InterfaceC1249cV interfaceC1249cV = this.A00;
                    if (interfaceC1249cV != null) {
                        interfaceC1249cV.AD2();
                    }
                    this.A0B.clear();
                    String[] strArr = A0C;
    ...
    public final void A0A(InterfaceC1249cV interfaceC1249cV) {
        this.A00 = interfaceC1249cV;
    }
}
