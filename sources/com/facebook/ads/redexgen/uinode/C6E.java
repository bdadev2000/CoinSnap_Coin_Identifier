...
public abstract class C6E {
    ...
    */
    public static com.facebook.ads.redexgen.uinode.C6C A01(com.facebook.ads.redexgen.uinode.C03987f r5, com.facebook.ads.redexgen.uinode.C6C r6) {
        /*
            if (r6 == 0) goto Lc
    ...
    public static C6C A02(C03987f c03987f, C6C c6c, C6D c6d) {
        C6F c6f = null;
        try {
            if (AbstractC0658Ig.A06(c03987f) && (c6c == null || TextUtils.isEmpty(c6c.A03()))) {
                c6f = C6G.A00(c03987f.getContentResolver());
            }
        } catch (Throwable th2) {
            c03987f.A07().A9a(A04(12, 7, 6), C8A.A1S, new C8B(th2));
        }
    ...
    public static void A07(C03987f c03987f) {
        long j3;
        C6C A022;
        try {
            C6D c6d = new C6D(c03987f);
            A06(c6d);
            if (A08()) {
                return;
            }
            ...
            if (j3 > 0) {
                ...
                if (cacheTS - j3 < AbstractC0658Ig.A00(c03987f)) {
                    return;
                }
            }
            if (AbstractC0658Ig.A07(c03987f)) {
                A022 = A01(c03987f, A02(c03987f, null, c6d));
            } else {
                A022 = A02(c03987f, A01(c03987f, null), c6d);
            }
            ...
            c03987f.A07().A9a(A04(12, 7, 6), C8A.A1R, new C8B(t5));
        }
    }
