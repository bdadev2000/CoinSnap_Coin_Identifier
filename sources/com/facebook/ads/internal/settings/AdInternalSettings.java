...
public class AdInternalSettings {
    ...
    public static void setDebugBuild(boolean z8) {
        ...
        if (dynamicLoader != null && z8) {
            dynamicLoader.createAdSettingsApi().turnOnDebugger();
        }
        sSettingsBundle.putBoolean(BOOL_DEBUG_BUILD_KEY, z8);
    }
    ...
    public static void setTestMode(boolean z8) {
        sSettingsBundle.putBoolean(BOOL_EXPLICIT_TEST_MODE_KEY, z8);
    }
    ...
    public static void setVideoAutoplay(boolean z8) {
        sSettingsBundle.putBoolean(BOOL_VIDEO_AUTOPLAY_KEY, z8);
    }

    public static void setVideoAutoplayOnMobile(boolean z8) {
        sSettingsBundle.putBoolean(BOOL_AUTOPLAY_ON_MOBILE_KEY, z8);
    }

    public static void setVisibleAnimation(boolean z8) {
        sSettingsBundle.putBoolean(BOOL_VISIBLE_ANIMATION_KEY, z8);
    }
