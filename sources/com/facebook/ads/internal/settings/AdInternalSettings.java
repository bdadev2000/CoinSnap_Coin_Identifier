...
public class AdInternalSettings {
    ...
    public static void setDebugBuild(boolean z2) {
        ...
        if (dynamicLoader != null && z2) {
            dynamicLoader.createAdSettingsApi().turnOnDebugger();
        }
        sSettingsBundle.putBoolean(BOOL_DEBUG_BUILD_KEY, z2);
    }
    ...
    public static void setTestMode(boolean z2) {
        sSettingsBundle.putBoolean(BOOL_EXPLICIT_TEST_MODE_KEY, z2);
    }
    ...
    public static void setVideoAutoplay(boolean z2) {
        sSettingsBundle.putBoolean(BOOL_VIDEO_AUTOPLAY_KEY, z2);
    }

    public static void setVideoAutoplayOnMobile(boolean z2) {
        sSettingsBundle.putBoolean(BOOL_AUTOPLAY_ON_MOBILE_KEY, z2);
    }

    public static void setVisibleAnimation(boolean z2) {
        sSettingsBundle.putBoolean(BOOL_VISIBLE_ANIMATION_KEY, z2);
    }
