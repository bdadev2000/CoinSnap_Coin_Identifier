...
import com.meta.analytics.dsp.uinode.C1225Ih;
import com.meta.analytics.dsp.uinode.C1278Kp;
import com.meta.analytics.dsp.uinode.C1635Ym;
...
import com.meta.analytics.dsp.uinode.ExecutorC1297Li;
import com.meta.analytics.dsp.uinode.InterfaceC1276Kl;
import com.meta.analytics.dsp.uinode.RunnableC1275Kk;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final C1278Kp A05;
    public static final List<InterfaceC1276Kl> A06;
     ...
     */
    public static synchronized void A04(C1635Ym c1635Ym, Class<? extends Activity> cls) {
        synchronized (ActivityUtils.class) {
            A02 = c1635Ym;
            Context applicationContext = c1635Ym.getApplicationContext();
                ...
                if (aNActivityLifecycleCallbacksListener != null) {
                    ...
                    synchronized (activityStateMap) {
                        try {
                            ...
                            c1635Ym.A07().A9a(A01(208, 8, 114), C8A.A02, new C8B(A01(72, 80, 103)));
                        }
                    }
                    ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1635Ym);
                }
                ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
            } else {
                c1635Ym.A07().A9a(A01(216, 3, 105), C8A.A0d, new C8B(A01(42, 30, 122)));
            }
        }
    }
    ...
    */
    public static synchronized android.app.Activity A00() {
        ...
        L3b:
            if (r1 == 0) goto L41
            android.app.Activity r5 = com.meta.analytics.dsp.uinode.AbstractC1273Ki.A00()     // Catch: java.lang.Throwable -> La1
        L41:
            ...
            int r1 = com.meta.analytics.dsp.uinode.C8A.A03     // Catch: java.lang.Throwable -> La1
    ...
    public static void A03(C1636Yn c1636Yn) {
        if (!C1225Ih.A1N(c1636Yn) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC1275Kk runnableC1275Kk = new RunnableC1275Kk(c1636Yn);
        List<Runnable> list = A07;
        synchronized (list) {
            list.add(runnableC1275Kk);
        }
        ExecutorC1297Li.A01.A01().postDelayed(runnableC1275Kk, AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC1276Kl> it = A06.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (activity.getClass() != this.A00) {
            ...
            while (it.hasNext()) {
                ExecutorC1297Li.A01.A01().removeCallbacks((Runnable) it.next());
            }
        }
        A05.A01();
    }
