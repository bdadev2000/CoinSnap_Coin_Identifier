...
import com.facebook.ads.redexgen.uinode.C0545Dp;
import com.facebook.ads.redexgen.uinode.C0546Dq;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceInsertCommand> CREATOR = new C0545Dp();
     ...
     */
    public SpliceInsertCommand(long j3, boolean z10, boolean z11, boolean z12, boolean z13, long j10, long j11, List<C0546Dq> list, boolean z14, long j12, int i10, int i11, int i12) {
        this.A06 = j3;
        this.A0B = z10;
        this.A09 = z11;
        this.A0A = z12;
    ...
    public SpliceInsertCommand(Parcel parcel) {
        ...
        for (int i10 = 0; i10 < readInt; i10++) {
            arrayList.add(C0546Dq.A00(parcel));
        }
    ...
    public /* synthetic */ SpliceInsertCommand(Parcel parcel, C0545Dp c0545Dp) {
        this(parcel);
    }

    public static SpliceInsertCommand A00(C0651Hz c0651Hz, long j3, IB ib2) {
        ...
        if (!z10) {
            ...
            if (outOfNetworkIndicator && !z12) {
                j10 = TimeSignalCommand.A00(c0651Hz, j3);
            }
            if (!outOfNetworkIndicator) {
                int componentCount = c0651Hz.A0E();
                emptyList = new ArrayList(componentCount);
                for (int i13 = 0; i13 < componentCount; i13++) {
                    int componentTag = c0651Hz.A0E();
                    long j12 = C.TIME_UNSET;
                    if (!z12) {
                        j12 = TimeSignalCommand.A00(c0651Hz, j3);
                    }
                    emptyList.add(new C0546Dq(componentTag, j12, ib2.A07(j12), null));
                }
            }
            if (autoReturn) {
                long A0E2 = c0651Hz.A0E();
                z13 = (A0E2 & 128) != 0;
                j11 = (1000 * (((A0E2 & 1) << 32) | c0651Hz.A0M())) / 90;
            }
            i10 = c0651Hz.A0I();
            i11 = c0651Hz.A0E();
            i12 = c0651Hz.A0E();
        }
        return new SpliceInsertCommand(A0M, z10, z11, outOfNetworkIndicator, z12, j10, ib2.A07(j10), emptyList, z13, j11, i10, i11, i12);
    }
