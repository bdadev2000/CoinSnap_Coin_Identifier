...
import com.meta.analytics.dsp.uinode.C1104De;
...
public final class ChapterFrame extends Id3Frame {
    ...
    public static void A01() {
        A06 = new byte[]{Ascii.DLE, Ascii.NAK, Ascii.SO, Ascii.GS};
    }
    ...
    public ChapterFrame(Parcel parcel) {
        ...
        for (int i9 = 0; i9 < readInt; i9++) {
            this.A05[i9] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }

    public ChapterFrame(String str, int i9, int i10, long j7, long j9, Id3Frame[] id3FrameArr) {
        super(A00(0, 4, 102));
        this.A04 = str;
        this.A01 = i9;
        this.A00 = i10;
    ...
    public final int hashCode() {
        int result = this.A01;
        int i9 = ((((17 * 31) + result) * 31) + this.A00) * 31;
        int result2 = (int) this.A03;
        int result3 = (((i9 + result2) * 31) + ((int) this.A02)) * 31;
        String str = this.A04;
