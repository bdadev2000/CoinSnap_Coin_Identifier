...
public final class Format implements Parcelable {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 39 out of bounds for length 39
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static Format A09(String str, String str2, String str3, int i2, int i3, String str4, int i4, DrmInitData drmInitData, long j2, List<byte[]> list) {
    ...
    public static Format A00(String str, String str2, int i2, String str3) {
        return A01(str, str2, i2, str3, null);
    }

    public static Format A01(String str, String str2, int i2, String str3, DrmInitData drmInitData) {
    ...
    public static Format A03(String str, String str2, String str3, int i2, int i3, int i4, int i5, float f2, List<byte[]> initializationData, int i6, float f3, DrmInitData drmInitData) {
        return A04(str, str2, str3, i2, i3, i4, i5, f2, initializationData, i6, f3, null, -1, null, drmInitData);
    }

    public static Format A04(String str, String str2, String str3, int i2, int i3, int i4, int i5, float f2, List<byte[]> list, int i6, float f3, byte[] bArr, int i7, ColorInfo colorInfo, DrmInitData drmInitData) {
    ...
    public static Format A05(String str, String str2, String str3, int i2, int i3, int i4, int i5, int i6, int i7, int i8, List<byte[]> list, DrmInitData drmInitData, int i9, String str4, Metadata metadata) {
    ...
    public static Format A06(String str, String str2, String str3, int i2, int i3, int i4, int i5, int i6, List<byte[]> initializationData, DrmInitData drmInitData, int i7, String str4) {
        return A05(str, str2, str3, i2, i3, i4, i5, i6, -1, -1, initializationData, drmInitData, i7, str4, null);
    }

    public static Format A07(String str, String str2, String str3, int i2, int i3, int i4, int i5, List<byte[]> initializationData, DrmInitData drmInitData, int i6, String str4) {
        return A06(str, str2, str3, i2, i3, i4, i5, -1, initializationData, drmInitData, i6, str4);
    }

    public static Format A08(String str, String str2, String str3, int i2, int i3, String str4, int i4, DrmInitData drmInitData) {
        return A09(str, str2, str3, i2, i3, str4, i4, drmInitData, Long.MAX_VALUE, Collections.emptyList());
    }

    public static Format A0A(String str, String str2, String str3, int i2, int i3, List<byte[]> list, String str4, DrmInitData drmInitData) {
    ...
    public static Format A0B(String str, String str2, String str3, int i2, DrmInitData drmInitData) {
    ...
    */
    ...
    public final int hashCode() {
        ...
        if (this.A00 == 0) {
            ...
            int result2 = (((i2 + result) * 31) + (this.A0L == null ? 0 : this.A0L.hashCode())) * 31;
    ...
    public final String toString() {
        ...
        String A0C = A0C(0, 2, Opcodes.LSHL);
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        while (i3 < initializationDataSize) {
