...
import com.meta.analytics.dsp.uinode.C1117Dz;
...
public abstract class DownloadAction {
    ...
    public static abstract class Deserializer {
        ...
        public abstract DownloadAction A01(int i9, DataInputStream dataInputStream) throws IOException;

        public Deserializer(String str, int i9) {
            this.A01 = str;
            this.A00 = i9;
        }
    }

    public DownloadAction(String str, int i9, Uri uri, boolean z8, byte[] bArr) {
        this.A02 = str;
        this.A00 = i9;
        this.A01 = uri;
        this.A03 = z8;
