...
import com.instagram.common.viewpoint.core.AbstractC02804o;
...
public class RecyclerView$SavedState extends AbsSavedState {
    ...
    public RecyclerView$SavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.A00 = parcel.readParcelable(classLoader == null ? AbstractC02804o.class.getClassLoader() : classLoader);
    }
