...
public class AdViewConstructorParams {
    ...
    public AdViewConstructorParams(Context context, AttributeSet attributeSet, int i9) {
    ...
    public AdViewConstructorParams(Context context, AttributeSet attributeSet, int i9, int i10) {
