...
import com.meta.analytics.dsp.uinode.C09145b;
import com.meta.analytics.dsp.uinode.C09155c;
import com.meta.analytics.dsp.uinode.C09175e;
import com.meta.analytics.dsp.uinode.C09205h;
import com.meta.analytics.dsp.uinode.C09215i;
import com.meta.analytics.dsp.uinode.C09225j;
import com.meta.analytics.dsp.uinode.C09255m;
import com.meta.analytics.dsp.uinode.C09325t;
import com.meta.analytics.dsp.uinode.C09365x;
import com.meta.analytics.dsp.uinode.C1237Iv;
import com.meta.analytics.dsp.uinode.C1238Iw;
import com.meta.analytics.dsp.uinode.C1243Jc;
...
import com.meta.analytics.dsp.uinode.EnumC1244Je;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new InitApi() { // from class: com.facebook.ads.redexgen.X.5d
        ...
        public final void initialize(Context context, MultithreadedBundleWrapper multithreadedBundleWrapper, AudienceNetworkAds.InitListener initListener, int i9) {
            C8Y.A0G(C09155c.A09(context), multithreadedBundleWrapper, initListener, i9);
        }
        ...
        public final void onAdLoadInvoked(Context context) {
            C8Y.A08(C09155c.A09(context));
        }

        @Override // com.facebook.ads.internal.api.InitApi
        public final void onContentProviderCreated(Context context) {
            C8Y.A09(C09155c.A09(context));
        }
    };

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i9, AdOptionsView adOptionsView) {
        return new ZX(context, nativeAdBase, nativeAdLayout, orientation, i9, adOptionsView);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public AdSizeApi createAdSizeApi(int i9) {
        final EnumC1244Je A022 = L3.A02(i9);
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(final AudienceNetworkActivity audienceNetworkActivity, final AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        return new AudienceNetworkActivityApi(audienceNetworkActivity, audienceNetworkActivityApi, c5v) { // from class: com.facebook.ads.redexgen.X.5W
            ...
            private void A02(Throwable th) {
                ...
                this.A02.A0L();
                finish(8);
                C09647f logContext = this.A02.A0K();
                if (logContext != null) {
            ...
            public final void onActivityResult(int i9, int i10, Intent intent) {
                ...
                if (this.A00) {
                    this.A01.onActivityResult(i9, i10, intent);
                } else {
                    this.A02.onActivityResult(i9, i10, intent);
                    this.A01.onActivityResult(i9, i10, intent);
                }
            }
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) C5M.A00(new C09175e(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C09215i createNativeAdApi(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C09215i(nativeAd, nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C09215i createNativeAdApi(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C09215i(nativeAdBase, nativeAd, nativeAdBaseApi);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i9, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10) {
        return new C09225j(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i9, type, nativeAdViewAttributes, i10);
    }
    ...
    public NativeAdViewApi createNativeAdViewApi() {
        if (A02 == null) {
            A02 = new NativeAdViewApi() { // from class: com.facebook.ads.redexgen.X.5k
                ...
                public static View A00(C1636Yn c1636Yn, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    ...
                    ER er = new ER();
                    NativeAdLayout mediumRectTemplateLayout = new NativeAdLayout(c1636Yn, er);
                    er.A04(mediumRectTemplateLayout, c1636Yn, nativeAd, jr);
                ...
                public static View A01(C1636Yn c1636Yn, NativeAd nativeAd, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    ...
                    A0L.A1W(jr);
                    ER er = new ER();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1636Yn, er);
                    er.A04(nativeAdLayout, c1636Yn, nativeAd, jr);
                ...
                public final View render(Context context, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    try {
                        return A00(C09155c.A03(context), nativeAd, type, nativeAdViewAttributes);
                    } catch (Throwable th) {
                        C1636Yn A032 = C09155c.A03(context);
                        if (A00[1].length() == 17) {
                            Throwable t9 = new RuntimeException();
                            throw t9;
                        }
                        String[] strArr = A00;
                ...
                public final View render(Context context, NativeAd nativeAd, NativeAdViewAttributes nativeAdViewAttributes) {
                    C1636Yn contextWrapper;
                    try {
                        if (context instanceof C1636Yn) {
                            contextWrapper = (C1636Yn) context;
                        } else {
                            contextWrapper = C09155c.A03(context);
                        }
                        return A01(contextWrapper, nativeAd, nativeAdViewAttributes);
                    } catch (Throwable th) {
                        return MR.A00(C09155c.A03(context), th);
                    }
                }
            };
        }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdViewTypeApi createNativeAdViewTypeApi(final int i9) {
        return new NativeAdViewTypeApi(i9) { // from class: com.facebook.ads.redexgen.X.5l
            public final JS A00;
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i9) {
        return (NativeAdsManagerApi) C5M.A00(new C09255m(context, str, i9), NativeAdsManagerApi.class);
    }
        ...
        return new NativeBannerAdApi(nativeAdBaseApi) { // from class: com.facebook.ads.redexgen.X.5q
            ...
            private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi2) {
                ...
                if (adIcon != null) {
                    ...
                    C1636Yn A032 = C09155c.A03(imageView.getContext());
                    if (preloadedBitmap != null) {
                        ...
                        Z9 z92 = null;
                        new AsyncTaskC09265n(A032, z9, A0L.A1d(), z92).execute(new C09285p(adIcon.getUrl(), A0L.A1C(), z92));
                        return;
                    }
                }
                V1 A15 = A0L.A15();
                ...
                if (A15 != null) {
                    A15.ABR(C1242Jb.A00(adErrorType));
                }
    ...
    public NativeBannerAdViewApi createNativeBannerAdViewApi() {
        if (A03 == null) {
            A03 = new NativeBannerAdViewApi() { // from class: com.facebook.ads.redexgen.X.5r
                public static View A00(C1636Yn c1636Yn, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    V2.A0L(nativeBannerAd.getInternalNativeAd()).A1X(JS.A00(type.getEnumCode()));
                    EZ bannerTemplateLayoutApi = new EZ();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1636Yn, bannerTemplateLayoutApi);
                    bannerTemplateLayoutApi.A04(c1636Yn, nativeBannerAd, (JR) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
                ...
                public final View render(Context context, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    try {
                        return A00(C09155c.A03(context), nativeBannerAd, type, nativeAdViewAttributes);
                    } catch (Throwable th) {
                        return MR.A00(C09155c.A03(context), th);
                    }
                }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) C5M.A00(new C09325t(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) C5M.A00(new C09365x(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C09145b getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C09145b();
        }
        C09145b c09145b = A04;
