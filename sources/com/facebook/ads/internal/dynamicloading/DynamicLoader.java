...
public interface DynamicLoader {
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @Nullable NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i9, AdOptionsView adOptionsView);
    ...
    AdSizeApi createAdSizeApi(int i9);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @Nullable NativeAdScrollView.AdViewProvider adViewProvider, int i9, @Nullable NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10);

    NativeAdViewApi createNativeAdViewApi();

    NativeAdViewAttributesApi createNativeAdViewAttributesApi();

    NativeAdViewTypeApi createNativeAdViewTypeApi(int i9);

    NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i9);
