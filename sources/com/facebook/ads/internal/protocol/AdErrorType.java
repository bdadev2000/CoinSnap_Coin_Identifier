...
public enum AdErrorType {
    ...
    AdErrorType(int i9, String str, boolean z8) {
        this.A00 = i9;
        this.A01 = str;
        this.A02 = z8;
    }

    public static AdErrorType adErrorTypeFromCode(int i9) {
        return adErrorTypeFromCode(i9, UNKNOWN_ERROR);
    }

    public static AdErrorType adErrorTypeFromCode(int i9, AdErrorType adErrorType) {
        for (AdErrorType adErrorType2 : valuesCustom()) {
            if (adErrorType2.getErrorCode() == i9) {
                return adErrorType2;
            }
        }
        return adErrorType;
