...
public class DaemonRequest {
    ...
    private GraphResponse executeAndWait(int i2) throws ExecutionException, InterruptedException, TimeoutException {
        return createRequest().get(i2, TimeUnit.SECONDS);
    }
    ...
    public static GraphResponse executeAndWait(Context context, @Nullable JSONObject jSONObject, SDKMessageEnum sDKMessageEnum, int i2) {
        ...
        try {
            ...
            return new DaemonRequest(context, put, null).executeAndWait(i2);
