...
public class CloudGameLoginHandler {
    ...
    private static boolean isCloudEnvReady(Context context, int i2) {
        GraphResponse executeAndWait = DaemonRequest.executeAndWait(context, null, SDKMessageEnum.IS_ENV_READY, i2);
    ...
    @Nullable
    public static synchronized AccessToken init(Context context, int i2) throws FacebookException {
