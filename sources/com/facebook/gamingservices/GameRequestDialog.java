...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public class FacebookAppHandler extends FacebookDialogBase<GameRequestContent, Result>.ModeHandler {
        ...
        public boolean canShow(GameRequestContent gameRequestContent, boolean z2) {
            ...
            AccessToken currentAccessToken = AccessToken.getCurrentAccessToken();
            return z3 && (currentAccessToken != null && currentAccessToken.getGraphDomain() != null && FacebookSdk.GAMING.equals(currentAccessToken.getGraphDomain()));
        }
        ...
        public AppCall createAppCall(GameRequestContent gameRequestContent) {
            ...
            intent.setType("text/plain");
            AccessToken currentAccessToken = AccessToken.getCurrentAccessToken();
            Bundle c2 = androidx.compose.foundation.text.input.a.c(SDKConstants.PARAM_TOURNAMENTS_DEEPLINK, "GAME_REQUESTS");
            if (currentAccessToken != null) {
                c2.putString("app_id", currentAccessToken.getApplicationId());
            } else {
                c2.putString("app_id", FacebookSdk.getApplicationId());
            }
            c2.putString(SDKConstants.PARAM_GAME_REQUESTS_ACTION_TYPE, gameRequestContent.getActionType() != null ? gameRequestContent.getActionType().name() : null);
            c2.putString("message", gameRequestContent.getMessage());
            c2.putString("title", gameRequestContent.getTitle());
            c2.putString("data", gameRequestContent.getData());
            c2.putString(SDKConstants.PARAM_GAME_REQUESTS_CTA, gameRequestContent.getCta());
            ...
            c2.putString("to", jSONArray.toString());
