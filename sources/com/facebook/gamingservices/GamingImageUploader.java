...
public class GamingImageUploader {
    ...
    public void uploadToMediaLibrary(String str, Bitmap bitmap, boolean z2, GraphRequest.Callback callback) {
        GraphRequest.newUploadPhotoRequest(AccessToken.getCurrentAccessToken(), photoUploadEdge, bitmap, str, (Bundle) null, z2 ? new OpenGamingMediaDialog(this.context, callback) : callback).executeAsync();
    }
    ...
    public void uploadToMediaLibrary(String str, File file, boolean z2, GraphRequest.Callback callback) throws FileNotFoundException {
        GraphRequest.newUploadPhotoRequest(AccessToken.getCurrentAccessToken(), photoUploadEdge, file, str, (Bundle) null, z2 ? new OpenGamingMediaDialog(this.context, callback) : callback).executeAsync();
    }
    ...
    public void uploadToMediaLibrary(String str, Uri uri, boolean z2, GraphRequest.Callback callback) throws FileNotFoundException {
        GraphRequest.newUploadPhotoRequest(AccessToken.getCurrentAccessToken(), photoUploadEdge, uri, str, (Bundle) null, z2 ? new OpenGamingMediaDialog(this.context, callback) : callback).executeAsync();
    }
}
