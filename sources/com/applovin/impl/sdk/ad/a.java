...
public final class a extends b {
    ...
    public /* synthetic */ void w(ql qlVar) {
        qlVar.b("html", this.l);
        qlVar.b("stream_url", this.f10740n);
    }
    ...
    public void J0() {
        ...
        synchronized (this.adObjectLock) {
            ...
            JsonUtils.putString(this.adObject, "stream_url", this.f10740n);
        }
    }
    ...
    public JSONObject getOriginalFullResponse() {
        ...
        if (jSONArray.length() > 0) {
            ...
            JsonUtils.putString(jSONObject2, "html", this.l);
            JsonUtils.putString(jSONObject2, MimeTypes.BASE_TYPE_VIDEO, this.m);
            JsonUtils.putString(jSONObject2, "stream_url", this.f10740n);
        }
        return jSONObject;
    }
