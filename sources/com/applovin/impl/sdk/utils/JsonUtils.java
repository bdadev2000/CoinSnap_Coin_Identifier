...
public class JsonUtils {
    ...
    public static boolean containsJSONObjectContainingInt(JSONArray jSONArray, int i2, String str) {
        if (jSONArray != null && jSONArray.length() != 0) {
            for (int i3 = 0; i3 < jSONArray.length(); i3++) {
                ...
                if (optJSONObject != null && optJSONObject.optInt(str) == i2) {
                    return true;
                }
            }
        }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i2, Object obj) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve object at index " + i2 + " for JSON array", e);
            return obj;
        }
    }
    ...
    @Nullable
    public static Float getFloat(JSONObject jSONObject, String str, @Nullable Float f2) {
        if (jSONObject == null || !jSONObject.has(str)) {
            return f2;
        }
        try {
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i2, JSONObject jSONObject) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve JSON object from array for index = " + i2, e);
            return jSONObject;
        }
    }
    ...
    public static JSONArray deepCopy(JSONArray jSONArray) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                ...
                n.l("JsonUtils", "Failed to copy over item at index " + i2 + " to JSONArray deep copy");
            }
        }
        return jSONArray2;
    }
