...
public class NativeCrashReporter {
    ...
    private static boolean f10719a;
    private static boolean b;

    /* renamed from: c, reason: collision with root package name */
    private static final NativeCrashReporter f10720c = new NativeCrashReporter();
    ...
    public static void a(k kVar) {
        ...
        if (!((Boolean) kVar.a(oj.f9551A4)).booleanValue() && !zp.i(k.k())) {
            if (b) {
                try {
                    f10720c.disable();
                    return;
        ...
        if (a()) {
            List c9 = kVar.c(oj.f9559B4);
            int[] iArr = new int[c9.size()];
            for (int i9 = 0; i9 < c9.size(); i9++) {
                try {
                    iArr[i9] = Integer.parseInt((String) c9.get(i9));
            ...
            try {
                f10720c.enable(file.getAbsolutePath(), iArr);
            } catch (Throwable th2) {
                kVar.L();
                if (t.a()) {
