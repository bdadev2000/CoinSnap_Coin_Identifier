...
final class jk {
    ...
    private long a(j8 j8Var) {
        int i10 = 0;
        j8Var.c(this.a.c(), 0, 1);
        int i11 = this.a.c()[0] & UByte.MAX_VALUE;
        if (i11 == 0) {
        ...
        int i14 = i11 & (~i12);
        j8Var.c(this.a.c(), 1, i13);
        while (i10 < i13) {
            i10++;
            i14 = (this.a.c()[i10] & UByte.MAX_VALUE) + (i14 << 8);
        }
        this.f5522b = i13 + 1 + this.f5522b;
        return i14;
    }
