...
public class sr extends com.applovin.impl.sdk.x {
    ...
    private final com.applovin.impl.sdk.t f11247a;
    ...
    private void a(WebView webView, String str) {
        if (com.applovin.impl.sdk.t.a()) {
            this.f11247a.d("WebViewButtonClient", "Processing click on ad URL \"" + str + "\"");
        }
        ...
        if ("applovin".equalsIgnoreCase(scheme) && AppLovinMediationAdapter.APPLOVIN_SDK_ERROR_DOMAIN.equalsIgnoreCase(host) && aVar != null) {
            ...
            if (com.applovin.impl.sdk.t.a()) {
                this.f11247a.k("WebViewButtonClient", "Unknown URL: ".concat(str));
            }
            if (com.applovin.impl.sdk.t.a()) {
                this.f11247a.k("WebViewButtonClient", "Path: " + path);
            }
        }
    }
}
