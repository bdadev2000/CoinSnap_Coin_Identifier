...
public abstract class ve {
    ...
    private static final List f8504b;

    /* renamed from: c, reason: collision with root package name */
    private static JSONArray f8505c;

    /* renamed from: d, reason: collision with root package name */
    private static final Object f8506d = new Object();

    /* renamed from: e, reason: collision with root package name */
    private static final Map f8507e = Collections.synchronizedMap(new HashMap(1));
    ...
    static {
        ...
        f8504b = new ArrayList(treeMap.keySet());
    }
    ...
    private static void b(com.applovin.impl.sdk.k kVar) {
        MaxAdapter a10;
        for (int i10 = 0; i10 < f8505c.length(); i10++) {
            JSONObject jSONObject = JsonUtils.getJSONObject(f8505c, i10, (JSONObject) null);
    ...
    public static boolean a(JSONObject jSONObject, String str, com.applovin.impl.sdk.k kVar) {
        ...
        String e2 = vd.e.e("invalid_or_disabled_ad_unit_id", str);
        kVar.B().a(o.b.INTEGRATION_ERROR, "invalid_or_disabled_ad_unit_id", CollectionUtils.hashMap("ad_unit_id", str), e2);
        return true;
    }
    ...
    public static JSONArray a(com.applovin.impl.sdk.k kVar) {
        ...
        f8505c = new JSONArray();
        for (String str : f8504b) {
