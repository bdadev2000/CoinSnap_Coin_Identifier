...
public class MaxErrorImpl implements MaxError {
    ...
    public void setRequestLatencyMillis(long j7) {
        this.requestLatencyMillis = j7;
    }
    ...
    public MaxErrorImpl(int i9, String str) {
        this(i9, str, -1, "");
    }

    public MaxErrorImpl(int i9, String str, int i10, String str2) {
        this.errorCode = i9;
