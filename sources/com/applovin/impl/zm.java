...
public abstract class zm extends xl {
    ...
    private static JSONObject f9472o;

    /* renamed from: p, reason: collision with root package name */
    private static JSONObject f9473p;

    /* renamed from: q, reason: collision with root package name */
    private static JSONObject f9474q;

    /* renamed from: h, reason: collision with root package name */
    protected final JSONObject f9475h;

    /* renamed from: i, reason: collision with root package name */
    protected final MaxAdapterResponseParameters f9476i;

    /* renamed from: j, reason: collision with root package name */
    protected final MaxAdFormat f9477j;

    /* renamed from: k, reason: collision with root package name */
    protected final com.applovin.impl.sdk.k f9478k;

    /* renamed from: l, reason: collision with root package name */
    private final AppLovinAdSize f9479l;

    /* renamed from: m, reason: collision with root package name */
    private final AppLovinAdType f9480m;

    /* renamed from: n, reason: collision with root package name */
    protected String f9481n;
    ...
    public zm(String str, JSONObject jSONObject, MaxAdapterResponseParameters maxAdapterResponseParameters, MaxAdFormat maxAdFormat, com.applovin.impl.sdk.k kVar) {
        super(str, kVar);
        this.f9475h = jSONObject;
        this.f9476i = maxAdapterResponseParameters;
        this.f9477j = maxAdFormat;
        this.f9478k = kVar;
        this.f9479l = a(maxAdFormat);
        this.f9480m = b(maxAdFormat);
    }
    ...
    private JSONObject e() {
        JSONObject jSONObject = f9472o;
        if (jSONObject != null) {
            return jSONObject;
        }
        JSONObject jSONObject2 = new JSONObject();
        JsonUtils.putInt(jSONObject2, "ad_id", 0);
        JsonUtils.putString(jSONObject2, "base_url", bh.z.FILE_SCHEME);
    ...
    public JSONObject a(String str, JSONObject jSONObject, JSONObject jSONObject2) {
        JSONObject e2 = e();
        JsonUtils.putAll(e2, JsonUtils.deserialize(this.f9476i.getServerParameters().getString("ad_object")));
        JsonUtils.putString(e2, "html", str);
        JsonUtils.putJSONObject(e2, "click_tracking_urls", jSONObject);
        JsonUtils.putJSONObject(e2, "imp_urls", jSONObject2);
        return e2;
    }

    public JSONObject a(pg pgVar) {
        JSONObject f10 = f();
        JsonUtils.putAll(f10, JsonUtils.deserialize(this.f9476i.getServerParameters().getString("ad_object")));
    ...
    public JSONObject a(JSONObject jSONObject) {
        JSONObject jSONObject2 = new JSONObject();
        JsonUtils.putString(jSONObject2, "ad_size", this.f9479l.toString());
        JsonUtils.putString(jSONObject2, "ad_type", this.f9480m.toString());
        JsonUtils.putString(jSONObject2, "dsp_name", this.f9481n);
