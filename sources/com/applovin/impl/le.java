...
public abstract class le extends c4 {
    ...
    private static final String[] f5860e = {com.mbridge.msdk.foundation.entity.b.JSON_KEY_ADS, "settings", "auto_init_adapters", "test_mode_idfas", "test_mode_auto_init_adapters", "ad_unit_signal_providers"};

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f5861f = {com.mbridge.msdk.foundation.entity.b.JSON_KEY_ADS, "settings", "signal_providers", "ad_unit_signal_providers"};
    ...
    public static void e(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        ...
        JsonUtils.removeObjectsForKeys(shallowCopy, f5861f);
        kVar.b(qj.G, shallowCopy.toString());
    }

    public static void f(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        if (JsonUtils.valueExists(jSONObject, "signal_providers")) {
            JSONObject shallowCopy = JsonUtils.shallowCopy(jSONObject);
            JsonUtils.removeObjectsForKeys(shallowCopy, f5860e);
            kVar.b(qj.F, shallowCopy.toString());
            em.a(shallowCopy);
        }
    }
