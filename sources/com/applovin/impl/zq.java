...
public abstract class zq {
    ...
    public class a implements Animation.AnimationListener {
        ...
        final /* synthetic */ View f28386a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Runnable f28387b;

        public a(View view, Runnable runnable) {
            this.f28386a = view;
            this.f28387b = runnable;
        }

        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
            Runnable runnable = this.f28387b;
            if (runnable != null) {
                runnable.run();
            }
        }
    ...
    public class b implements Animation.AnimationListener {
        ...
        public b(View view, Runnable runnable) {
            this.f28388a = view;
            this.f28389b = runnable;
        }

        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
            this.f28388a.setVisibility(4);
            Runnable runnable = this.f28389b;
            if (runnable != null) {
                runnable.run();
            }
        }
