...
public class j4 {
    ...
    public String b() {
        return JsonUtils.getString(this.f5434b, NotificationCompat.CATEGORY_EVENT, null);
    }

    public a c() {
        String string = JsonUtils.getString(this.f5434b, TtmlNode.TAG_STYLE, null);
    ...
    public String d() {
        JSONObject jSONObject = JsonUtils.getJSONObject(this.f5434b, CampaignEx.JSON_KEY_TITLE, (JSONObject) null);
    ...
    public String a() {
        return JsonUtils.getString(this.f5434b, "destination_state_id", null);
    }
}
