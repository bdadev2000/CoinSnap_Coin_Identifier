...
public abstract class z9 {
    ...
    public static boolean c() {
        ...
        if (yp.a < 17 || (eglQueryString = EGL14.eglQueryString(EGL14.eglGetDisplay(0), 12373)) == null || !eglQueryString.contains("EGL_KHR_surfaceless_context")) {
            return false;
        }
        return true;
    }
    ...
    public static boolean a(Context context) {
        ...
        if (i10 >= 26 || !(Constants.REFERRER_API_SAMSUNG.equals(yp.f9254c) || "XT1650".equals(yp.f9255d))) {
