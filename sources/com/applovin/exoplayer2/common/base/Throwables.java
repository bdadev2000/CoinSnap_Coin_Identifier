...
public final class Throwables {
    ...
    public class a extends AbstractList {
        ...
        final /* synthetic */ Throwable f22507a;
        ...
        public int size() {
            return ((Integer) Throwables.invokeAccessibleNonThrowingMethod(Throwables.getStackTraceDepthMethod, Throwables.jla, this.f22507a)).intValue();
        }

        @Override // java.util.AbstractList, java.util.List
        public StackTraceElement get(int i2) {
            return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod(Throwables.getStackTraceElementMethod, Throwables.jla, this.f22507a, Integer.valueOf(i2));
        }
    }
