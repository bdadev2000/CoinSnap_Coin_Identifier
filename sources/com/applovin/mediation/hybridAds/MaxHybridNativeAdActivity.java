...
public class MaxHybridNativeAdActivity extends wc {
    ...
    private MaxNativeAdView f12706f;

    /* loaded from: classes.dex */
    public class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MaxNativeAd f12707a;

        public a(MaxNativeAd maxNativeAd) {
            this.f12707a = maxNativeAd;
        }

        @Override // java.lang.Runnable
        public void run() {
            if (!this.f12707a.prepareForInteraction(MaxHybridNativeAdActivity.this.f12706f.getClickableViews(), MaxHybridNativeAdActivity.this.f12706f)) {
                this.f12707a.prepareViewForInteraction(MaxHybridNativeAdActivity.this.f12706f);
            }
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        a(this.f12706f, "MaxHybridNativeAdActivity");
    }
}
