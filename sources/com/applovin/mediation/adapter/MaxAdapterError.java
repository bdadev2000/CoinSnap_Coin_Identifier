...
public class MaxAdapterError extends MaxErrorImpl {
    ...
    public MaxAdapterError(int i9) {
        this(i9, "", 0, "");
    }

    public MaxAdapterError(int i9, int i10) {
        this(i9, "", i10, "");
    }

    public MaxAdapterError(int i9, String str) {
        this(i9, str, 0, "");
    }

    public MaxAdapterError(MaxAdapterError maxAdapterError, int i9, String str) {
        this(maxAdapterError.getErrorCode(), maxAdapterError.getErrorMessage(), i9, str);
    }

    public MaxAdapterError(int i9, String str, int i10, String str2) {
