...
public class MaxRewardedAd implements MaxFullscreenAdImpl.b {
    ...
    private static final Map f9520b = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    private static final Object f9521c = new Object();

    /* renamed from: d, reason: collision with root package name */
    private static WeakReference f9522d = new WeakReference(null);
    ...
    public void destroy() {
        ...
        synchronized (f9521c) {
            f9520b.remove(this.a.getAdUnitId());
        }
        this.a.destroy();
    }
        ...
        if (str != null) {
            ...
            if (appLovinSdk != null) {
                if (context instanceof Activity) {
                    f9522d = new WeakReference((Activity) context);
                }
                synchronized (f9521c) {
                    Map map = f9520b;
