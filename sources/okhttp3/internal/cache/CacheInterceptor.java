...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isEndToEnd(String str) {
        return ("Connection".equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.KEEP_ALIVE.equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.PROXY_AUTHENTICATE.equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.PROXY_AUTHORIZATION.equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.TE.equalsIgnoreCase(str) || "Trailers".equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.TRANSFER_ENCODING.equalsIgnoreCase(str) || com.google.common.net.HttpHeaders.UPGRADE.equalsIgnoreCase(str)) ? false : true;
    }
