...
public abstract class y {
    ...
    public static final Lock f22456b;
    ...
    public static Bitmap b(h4.d dVar, Bitmap bitmap, int i10, int i11) {
        ...
        Bitmap b3 = dVar.b(width, height, config);
        b3.setHasAlpha(bitmap.hasAlpha());
        if (Log.isLoggable("TransformationUtils", 2)) {
            Log.v("TransformationUtils", "request: " + i10 + "x" + i11);
            Log.v("TransformationUtils", "toFit:   " + bitmap.getWidth() + "x" + bitmap.getHeight());
            Log.v("TransformationUtils", "toReuse: " + b3.getWidth() + "x" + b3.getHeight());
