...
public abstract class l {
    ...
    public static final String a(String str) {
        ...
        try {
            ...
            G7.j.d(bigInteger, "BigInteger(1, md.digest()).toString(16)");
            android.support.v4.media.session.a.f(bufferedInputStream, null);
            return bigInteger;
        } finally {
        }
    }
    ...
    public static final String b(Context context) {
        ...
        for (int i9 = 0; i9 < 2; i9++) {
            arrayList.add(certificateFactory.generateCertificate(new ByteArrayInputStream(Base64.decode(strArr[i9], 0))));
        }
        ArrayList U8 = AbstractC2816g.U(arrayList);
        ?? obj = new Object();
