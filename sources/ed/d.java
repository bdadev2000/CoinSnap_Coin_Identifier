...
public abstract class d {
    ...
    public static String a(int i10, String str) {
        ...
        if (i13 >= 0) {
            int[] iArr3 = f17312b[i13];
            char[] cArr = new char[i10];
            for (int i14 = 0; i14 < i10; i14++) {
                cArr[i14] = 0;
            }
            for (int i15 = 0; i15 < 0 + length; i15++) {
                int i16 = i10 - 1;
