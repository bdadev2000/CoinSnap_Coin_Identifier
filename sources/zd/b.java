...
public abstract class b {
    ...
    public static final String[] f28744b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    public static float f28745c = Resources.getSystem().getDisplayMetrics().density;

    public static JSONObject a(int i10, int i11, int i12, int i13) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("x", i10 / f28745c);
            jSONObject.put("y", i11 / f28745c);
            jSONObject.put("width", i12 / f28745c);
            jSONObject.put("height", i13 / f28745c);
        } catch (JSONException e2) {
            i.b("Error with creating viewStateObject", e2);
        }
        return jSONObject;
    }
    ...
    public static void b(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            i.b("JSONException during JSONObject.put for name [" + str + "]", e2);
        }
    }
