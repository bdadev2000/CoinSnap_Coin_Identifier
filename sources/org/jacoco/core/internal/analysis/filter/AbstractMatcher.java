...
abstract class AbstractMatcher {
    ...
    public final void nextIsField(int i2, String str, String str2, String str3) {
        nextIs(i2);
        AbstractInsnNode abstractInsnNode = this.cursor;
        if (abstractInsnNode == null) {
            return;
    ...
    public final void nextIsInvoke(int i2, String str, String str2, String str3) {
        nextIs(i2);
        AbstractInsnNode abstractInsnNode = this.cursor;
        if (abstractInsnNode == null) {
            return;
    ...
    public final void nextIsType(int i2, String str) {
        nextIs(i2);
        AbstractInsnNode abstractInsnNode = this.cursor;
    ...
    public final void nextIsVar(int i2, String str) {
        nextIs(i2);
        AbstractInsnNode abstractInsnNode = this.cursor;
        if (abstractInsnNode == null) {
            return;
