...
public final class FinallyFilter implements IFilter {
    private static boolean isSame(int i2, AbstractInsnNode abstractInsnNode, AbstractInsnNode abstractInsnNode2) {
    ...
    private static void merge(IFilterOutput iFilterOutput, int i2, AbstractInsnNode abstractInsnNode, AbstractInsnNode abstractInsnNode2) {
        if (isSame(i2, abstractInsnNode, abstractInsnNode2)) {
