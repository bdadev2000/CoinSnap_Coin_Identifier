...
public abstract class AdviceAdapter extends GeneratorAdapter implements Opcodes {
    ...
    public AdviceAdapter(int i2, MethodVisitor methodVisitor, int i3, String str, String str2) {
    ...
    public void visitFieldInsn(int i2, String str, String str2, String str3) {
        ...
        switch (i2) {
            ...
            case Opcodes.PUTFIELD /* 181 */:
                ...
                return;
            default:
                throw new IllegalArgumentException(d.i(INVALID_OPCODE, i2));
        }
    }
    ...
    */
    ...
    public void visitIntInsn(int i2, int i3) {
        ...
        if (!this.isConstructor || this.superClassConstructorCalled || i2 == 188) {
            return;
        }
        pushValue(OTHER);
    }
    ...
    public void visitMethodInsn(int i2, String str, String str2, String str3, boolean z2) {
        if (this.api < 327680 && (i2 & 256) == 0) {
            ...
            super.visitMethodInsn(i2, str, str2, str3, z2);
            doVisitMethodInsn(i2 & (-257), str2, str3);
        }
    }
    ...
    public void visitTypeInsn(int i2, String str) {
        ...
        if (this.isConstructor && !this.superClassConstructorCalled && i2 == 187) {
            pushValue(OTHER);
        }
    }
    ...
    public void visitVarInsn(int i2, int i3) {
        ...
        switch (i2) {
            ...
            case 24:
                ...
                return;
            case 25:
                pushValue(i3 == 0 ? UNINITIALIZED_THIS : OTHER);
                return;
            default:
                switch (i2) {
                    case 54:
