...
public final class ScopeSetExtKt$viewModel$1 extends r implements p {
    public static final ScopeSetExtKt$viewModel$1 INSTANCE = null;
    ...
    public final ViewModel invoke(@NotNull Scope scope, @NotNull ParametersHolder parametersHolder) {
        okio.a.b(scope, "$this$factory", parametersHolder, "it");
        throw null;
    }
}
